...
class MemoryRevisions(_api_module.BaseModule):
    ...
    def get(
        ...
        *,
        ...
        """
        Gets an Runtime memory revision.

        Args:
            name (str): Required. The name of the Runtime memory revision to get. Format:
            ...
            config (GetRuntimeMemoryRevisionConfig):
                Optional. Additional configurations for getting the Runtime memory revision.

        Returns:
            RuntimeMemoryRevision: The requested Runtime memory revision.
    ...
    def _list(
        ...
        *,
        ...
        """
        Lists Runtime memory revisions.

        Args:
            name (str): Required. The name of the Runtime memory to list revisions for. Format:
            ...
            config (ListRuntimeMemoryRevisionsConfig):
                Optional. Additional configurations for listing the Runtime memory revisions.

        Returns:
            ListRuntimeMemoryRevisionsResponse: The requested Runtime memory revisions.
