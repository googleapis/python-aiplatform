...
class Sandboxes(_api_module.BaseModule):
    ...
    def _create(
        ...
        *,
        ...
        """
        Creates a new sandbox in the Runtime.
        """
    ...
    def _delete(
        ...
        *,
        ...
        """
        Delete an Runtime sandbox.

        Args:
            name (str):
                Required. The name of the Runtime sandbox to be deleted. Format:
    ...
    def _execute_code(
        ...
        *,
        ...
        """
        Execute code in an Runtime sandbox.
        """
    ...
    def _list(
        ...
        *,
        ...
        """
        Lists Runtime sandboxes.

        Args:
            name (str): Required. The name of the Runtime to list sessions for. Format:
                `projects/{project}/locations/{location}/reasoningEngines/{resource_id}`.
            config (ListRuntimeSandboxesConfig):
                Optional. Additional configurations for listing the Runtime sandboxes.

        Returns:
            ListReasoningEnginesSandboxesResponse: The requested Runtime sandboxes.
    ...
    def create(
        ...
        *,
        ...
        Args:
            name (str):
                Required. The name of the Runtime to create sandbox for.
                projects/{project}/locations/{location}/reasoningEngines/{resource_id}
    ...
    def list(
        ...
        *,
        ...
        Args:
            name (str):
                Required. The name of the Runtime to list sandboxes for.
        ...
        Returns:
            Iterable[SandboxEnvironment]: An iterable of Runtime sandboxes.
        """
        return Pager(
    ...
    def execute_code(
        ...
        *,
        ...
        """Executes code in the Runtime sandbox.

        Args:
            name (str):
                Required. The name of the Runtime sandbox to run code in.
                projects/{project}/locations/{location}/reasoningEngines/{resource_id}/SandboxEnvironments/{sandbox_id}
            input_data (dict[str, Any]):
