...
class AsyncClient:
    ...
    @property
    def runtimes(self) -> "agent_engines_module.AsyncAgentEngines":
        ...
        return self._runtimes.AsyncAgentEngines(self._api_client)  # type: ignore[no-any-return]
...
class Client:
    ...
    @property
    def runtimes(self) -> "agent_engines_module.AgentEngines":
        if self._runtimes is None:
            try:
                # We need to lazy load the agent_engines module to handle the
                # possibility of ImportError when dependencies are not installed.
        ...
        return self._runtimes.AgentEngines(self._api_client)  # type: ignore[no-any-return]
