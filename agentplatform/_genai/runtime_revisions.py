...
class RuntimeRevisions(_api_module.BaseModule):
    ...
    def _get(
        ...
        *,
        ...
        """
        Get a runtime revision instance.
        """
    ...
    def _delete(
        ...
        *,
        ...
        """
        Delete an Runtime revision.

        Args:
            name (str): Required. The name of the Runtime revision to be deleted. Format:
        ...
        Returns:
            DeleteRuntimeRevisionOperation: The operation for deleting the Runtime revision.
    ...
    def get(
        ...
        *,
        ...
        """Gets an runtime revision.

        Args:
            name (str): Required. The name of the Runtime revision to get. Format:
                `projects/{project}/locations/{location}/reasoningEngines/{resource_id}/runtimeRevisions/{runtime_revision_id}`.
            config (GetRuntimeRevisionConfigOrDict):
                Optional. Additional configurations for getting the Runtime revision.

        Returns:
            RuntimeRevision: The requested Runtime revision instance.
        """
        api_resource = self._get(name=name, config=config)
        runtime_revision = types.RuntimeRevision(
            api_client=self,
            api_async_client=AsyncRuntimeRevisions(api_client_=self._api_client),
            api_resource=api_resource,
        )
        if api_resource.spec:
            self._register_api_methods(runtime_revision=runtime_revision)
    ...
    def _register_api_methods(
        ...
        *,
        ...
        """Registers the API methods for the Runtime revision."""
        try:
