...
class A2aTaskEvents(_api_module.BaseModule):
    ...
    def append(
        ...
        *,
        ...
        """
        Adds events to an Runtime task.

        Args:
            name (str): Required. The name of the Runtime task to append the events to. Format:
    ...
    def _list(
        ...
        *,
        ...
        """
        Lists Runtime task events.

        Args:
            name (str): Required. The name of the Runtime task to list events for. Format:
                `projects/{project}/locations/{location}/reasoningEngines/{resource_id}/a2aTasks/{a2a_task_id}`.
            config (ListRuntimeTaskEventsConfig):
                Optional. Additional configurations for listing the Runtime tasks.

        Returns:
            ListRuntimeTaskEventsResponse: The requested Runtime tasks.
    ...
    def list(
        ...
        *,
        ...
        """Lists the A2A tasks of an Runtime.

        Args:
            name (str):
                Required. The name of the Runtime to list tasks for.
            config (List):
