...
class SandboxSnapshots(_api_module.BaseModule):
    ...
    def list(
        ...
        *,
        ...
        """Lists Runtime sandbox snapshots.

        Args:
            name (str):
                Required. The name of the Runtime to list sandbox snapshots for.
        ...
        Returns:
            Iterable[SandboxEnvironmentSnapshot]: An iterable of Runtime sandbox snapshots.
        """
        return Pager(
    ...
    def get(
        ...
        *,
        ...
        """Gets a sandbox snapshot in the Runtime.
        Args:
          name (str):
    ...
    def delete(
        ...
        *,
        ...
        """Deletes a sandbox snapshot in the Runtime.
        Args:
            name (str):
