...
class Runtimes(_api_module.BaseModule):
    ...
    def cancel_query_job(
        ...
        *,
        ...
        """
        Cancels a long-running query job on an Agent Runtime.
    ...
    def _run_query_job(
        ...
        *,
        ...
        """
        Run a query job on an agent runtime.
        """
    ...
    def _delete(
        ...
        *,
        ...
        Args:
            name (str):
                Required. The name of the Agent Runtime to be deleted. Format:
            ...
            force (bool):
                ...
                the Agent Runtime has undeleted child resources. Defaults to False.
    ...
    def revisions(self) -> "runtime_revisions_module.RuntimeRevisions":
        if self._revisions is None:
            try:
                ...
                raise ImportError(
                    "The 'runtimes.revisions' module requires additional "
    ...
    def check_query_job(
        ...
        *,
        ...
        """Checks a query job on an agent runtime and optionally returns the results.

        Args:
            name (str):
                Required. A fully-qualified resource name or ID.
            config (CheckQueryJobRuntimeConfigOrDict):
        ...
        if config is None:
            config = types.CheckQueryJobRuntimeConfig()
        elif isinstance(config, dict):
            config = types.CheckQueryJobRuntimeConfig(**config)
    ...
    def _is_lightweight_creation(
        self, agent: Any, config: types.AgentRuntimeConfig
    ) -> bool:
        if (
            agent
    ...
    def run_query_job(
        ...
        *,
        name: str,
        config: Optional[types.RunQueryJobRuntimeConfigOrDict] = None,
    ) -> types.RunQueryJobResult:
        """Launches a long-running query job on an Agent Runtime

        Args:
            name (str):
                Required. A fully-qualified resource name or ID.
            config (RunQueryJobRuntimeConfigOrDict):
                Optional. The configuration for the async query. If not provided,
                the default configuration will be used. This can be used to specify
                the following fields:
                  - query: The query to send to the agent runtime.
        ...
        if config is None:
            config = types.RunQueryJobRuntimeConfig()
        elif isinstance(config, dict):
            config = types.RunQueryJobRuntimeConfig(**config)
        ...
        new_config = types._RunQueryJobRuntimeConfig(
    ...
    def get(
        ...
        *,
        name: str,
        config: Optional[types.GetRuntimeConfigOrDict] = None,
    ) -> types.Runtime:
        """Gets an agent runtime.
    ...
    def create(
        ...
        *,
        runtime: Any = None,
        agent: Any = None,
        config: Optional[types.AgentRuntimeConfigOrDict] = None,
    ) -> types.Runtime:
        """Creates an agent runtime.

        The Agent Runtime will be an instance of the `runtime` that
        ...
        To build an Agent Runtime with the above files, run:
        ...
        Args:
            ...
            config (AgentRuntimeConfig):
                Optional. The configurations to use for creating the Agent Runtime.

        Returns:
            Runtime: The created Agent Runtime instance.
        ...
        if isinstance(config, dict):
            config = types.AgentRuntimeConfig.model_validate(config)
        elif not isinstance(config, types.AgentRuntimeConfig):
            raise TypeError(
                f"config must be a dict or AgentRuntimeConfig, but got {type(config)}."
            )
        ...
        if not self._is_lightweight_creation(agent, config):
            ...
            poll_interval_seconds = 1  # Lightweight agent runtime resource creation.
        ...
        if runtime.api_resource:
            logger.info("Agent Runtime created. To use it in another session:")
            logger.info(
    ...
    def _set_source_code_spec(
        ...
        *,
        ...
        """Sets source_code_spec for agent runtime inside the `spec`."""
    ...
    def _set_package_spec(
        ...
        *,
        ...
        """Sets package spec for agent runtime."""
        project = self._api_client.project
        if project is None:
        ...
        # Prepares the Agent Runtime for creation/update in Vertex AI. This
    ...
    def _create_config(
        ...
        *,
        ...
        config: types.UpdateRuntimeConfigDict = {}
        update_masks = []
    ...
    def _register_api_methods(
        ...
        *,
        ...
        """Registers the API methods for the agent runtime."""
        try:
    ...
    def list(
        ...
        """List all instances of Agent Runtime matching the filter.
        ...
        Args:
            config (ListRuntimeConfig):
                Optional. The config (e.g. filter) for the agents to be listed.

        Returns:
            Iterable[Runtime]: An iterable of Agent Runtimes matching the filter.
        """
    ...
    def update(
        ...
        *,
        ...
        agent: Any = None,
        runtime: Any = None,
        config: types.AgentRuntimeConfigOrDict,
    ) -> types.Runtime:
        """Updates an existing Agent Runtime.

        This method updates the configuration of an existing Agent Runtime running
        ...
        Args:
            ...
            agent (Any):
                Optional. The instance to be used as the updated Agent Runtime.
                If it is not specified, the existing instance will be used.
            runtime (Any):
                Optional. This is deprecated. Please use `agent` instead.
            config (AgentRuntimeConfig):
                Optional. The configurations to use for updating the Agent Runtime.

        Returns:
            Runtime: The updated Agent Runtime.
        ...
        if runtime.api_resource:
            logger.info("Agent Runtime updated. To use it in another session:")
            logger.info(
                f"runtime=client.runtimes.get(name='{runtime.api_resource.name}')"
            )
        elif operation.error:
    ...
    async def _async_stream_query(
        ...
        *,
        name: str,
        config: Optional[types.QueryRuntimeConfigOrDict] = None,
    ) -> AsyncIterator[Any]:
        """Streams the response of the agent runtime asynchronously."""
        parameter_model = types._QueryRuntimeRequestParameters(
            name=name,
            config=config,
        )
