...
def _CancelQueryJobRuntimeConfig_to_vertex(
...
def _CancelQueryJobRuntimeRequestParameters_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
    ...
    if getv(from_object, ["config"]) is not None:
        setv(
            to_object,
            ["config"],
            _CancelQueryJobRuntimeConfig_to_vertex(
...
def _CheckQueryJobRuntimeConfig_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
...
def _CheckQueryJobRuntimeRequestParameters_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
    ...
    if getv(from_object, ["config"]) is not None:
        setv(
            to_object,
            ["config"],
            _CheckQueryJobRuntimeConfig_to_vertex(
                getv(from_object, ["config"]), to_object
            ),
        )
...
def _CreateRuntimeConfig_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
...
def _CreateRuntimeRequestParameters_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
    if getv(from_object, ["config"]) is not None:
        _CreateRuntimeConfig_to_vertex(getv(from_object, ["config"]), to_object)

    return to_object


def _DeleteRuntimeRequestParameters_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
...
def _GetRuntimeOperationParameters_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
...
def _GetRuntimeRequestParameters_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
...
def _ListRuntimeConfig_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
...
def _ListRuntimeRequestParameters_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
    if getv(from_object, ["config"]) is not None:
        _ListRuntimeConfig_to_vertex(getv(from_object, ["config"]), to_object)

    return to_object


def _QueryRuntimeConfig_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
...
def _QueryRuntimeRequestParameters_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
    ...
    if getv(from_object, ["config"]) is not None:
        _QueryRuntimeConfig_to_vertex(getv(from_object, ["config"]), to_object)
...
def _RunQueryJobRuntimeConfig_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
...
def _RunQueryJobRuntimeRequestParameters_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
    ...
    if getv(from_object, ["config"]) is not None:
        setv(
            to_object,
            ["config"],
            _RunQueryJobRuntimeConfig_to_vertex(
                getv(from_object, ["config"]), to_object
            ),
        )
...
def _RuntimeOperation_from_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
...
def _UpdateRuntimeConfig_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
...
def _UpdateRuntimeRequestParameters_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
    ...
    if getv(from_object, ["config"]) is not None:
        _UpdateRuntimeConfig_to_vertex(getv(from_object, ["config"]), to_object)
...
class Runtimes(_api_module.BaseModule):
    ...
    def cancel_query_job(
        ...
        *,
        name: str,
        config: Optional[types.CancelQueryJobRuntimeConfigOrDict] = None,
    ) -> types.CancelQueryJobResult:
        """
        Cancels a long-running query job on an Runtime.

        Args:
            name (str):
                Required. The reasoning engine resource name.
            config (CancelQueryJobRuntimeConfigOrDict):
                Optional. The configuration for the cancel_query_job.

        """

        parameter_model = types._CancelQueryJobRuntimeRequestParameters(
            name=name,
            config=config,
        )
        ...
        if not self._api_client.vertexai:
            ...
            request_dict = _CancelQueryJobRuntimeRequestParameters_to_vertex(
                parameter_model
            )
    ...
    def _check_query_job(
        ...
        *,
        name: str,
        config: Optional[types.CheckQueryJobRuntimeConfigOrDict] = None,
    ) -> types.CheckQueryJobResult:
        """
        Query an Runtime asynchronously.
        """
        ...
        if not self._api_client.vertexai:
            ...
            request_dict = _CheckQueryJobRuntimeRequestParameters_to_vertex(
                parameter_model
            )
            request_url_dict = request_dict.get("_url")
            if request_url_dict:
    ...
    def _run_query_job(
        ...
        *,
        name: str,
        config: Optional[types._RunQueryJobRuntimeConfigOrDict] = None,
    ) -> types.RuntimeOperation:
        """
        Run a query job on an Runtime.
        """

        parameter_model = types._RunQueryJobRuntimeRequestParameters(
            name=name,
            config=config,
        )
        ...
        if not self._api_client.vertexai:
            ...
            request_dict = _RunQueryJobRuntimeRequestParameters_to_vertex(
                parameter_model
            )
            request_url_dict = request_dict.get("_url")
            if request_url_dict:
        ...
        if self._api_client.vertexai:
            response_dict = _RuntimeOperation_from_vertex(response_dict)

        return_value = types.RuntimeOperation._from_response(
            response=response_dict,
            kwargs=(
                {
                    "config": {
    ...
    def _create(
        self, *, config: Optional[types.CreateRuntimeConfigOrDict] = None
    ) -> types.RuntimeOperation:
        """
        Creates a new Runtime.
        """

        parameter_model = types._CreateRuntimeRequestParameters(
            config=config,
        )
        ...
        if not self._api_client.vertexai:
            ...
            request_dict = _CreateRuntimeRequestParameters_to_vertex(parameter_model)
            request_url_dict = request_dict.get("_url")
            if request_url_dict:
    ...
    def _delete(
        ...
        *,
        ...
        config: Optional[types.DeleteRuntimeConfigOrDict] = None,
    ) -> types.DeleteRuntimeOperation:
        """
        Delete an Runtime resource.

        Args:
            name (str):
                Required. The name of the Runtime to be deleted. Format:
        ...
        parameter_model = types._DeleteRuntimeRequestParameters(
            name=name,
            force=force,
            config=config,
        )
        ...
        if not self._api_client.vertexai:
            ...
            request_dict = _DeleteRuntimeRequestParameters_to_vertex(parameter_model)
            request_url_dict = request_dict.get("_url")
            if request_url_dict:
        ...
        return_value = types.DeleteRuntimeOperation._from_response(
            response=response_dict,
            kwargs=(
                {
                    "config": {
    ...
    def _get(
        self, *, name: str, config: Optional[types.GetRuntimeConfigOrDict] = None
    ) -> types.ReasoningEngine:
        """
        Get an Runtime instance.
        """

        parameter_model = types._GetRuntimeRequestParameters(
            name=name,
            config=config,
        )
        ...
        if not self._api_client.vertexai:
            ...
            request_dict = _GetRuntimeRequestParameters_to_vertex(parameter_model)
            request_url_dict = request_dict.get("_url")
            if request_url_dict:
                path = "{name}".format_map(request_url_dict)
            else:
    ...
    def _list(
        self, *, config: Optional[types.ListRuntimeConfigOrDict] = None
    ) -> types.ListReasoningEnginesResponse:
        """
        Lists Runtimes.
        """

        parameter_model = types._ListRuntimeRequestParameters(
            config=config,
        )
        ...
        if not self._api_client.vertexai:
            ...
            request_dict = _ListRuntimeRequestParameters_to_vertex(parameter_model)
            request_url_dict = request_dict.get("_url")
            if request_url_dict:
                path = "reasoningEngines".format_map(request_url_dict)
            else:
    ...
    def _get_agent_operation(
        ...
        *,
        ...
        parameter_model = types._GetRuntimeOperationParameters(
        ...
        if not self._api_client.vertexai:
            ...
            request_dict = _GetRuntimeOperationParameters_to_vertex(parameter_model)
            request_url_dict = request_dict.get("_url")
            if request_url_dict:
    ...
    def _query(
        self, *, name: str, config: Optional[types.QueryRuntimeConfigOrDict] = None
    ) -> types.QueryReasoningEngineResponse:
        """
        Query an Runtime.
        """

        parameter_model = types._QueryRuntimeRequestParameters(
            name=name,
            config=config,
        )
        ...
        if not self._api_client.vertexai:
            ...
            request_dict = _QueryRuntimeRequestParameters_to_vertex(parameter_model)
            request_url_dict = request_dict.get("_url")
            if request_url_dict:
    ...
    def _update(
        self, *, name: str, config: Optional[types.UpdateRuntimeConfigOrDict] = None
    ) -> types.RuntimeOperation:
        """
        Updates an Runtime.
        """

        parameter_model = types._UpdateRuntimeRequestParameters(
            name=name,
            config=config,
        )
        ...
        if not self._api_client.vertexai:
            ...
            request_dict = _UpdateRuntimeRequestParameters_to_vertex(parameter_model)
            request_url_dict = request_dict.get("_url")
            if request_url_dict:
                path = "{name}".format_map(request_url_dict)
            else:
    ...
    def revisions(self) -> "runtime_revisions_module.RuntimeRevisions":
        if self._runtime_revisions is None:
            try:
                ...
                raise ImportError(
                    "The 'runtimes.runtime_revisions' module requires additional "
    ...
    def a2a_tasks(self) -> "a2a_tasks_module.A2aTasks":
        if self._a2a_tasks is None:
            try:
                ...
                raise ImportError(
                    "The 'runtimes.a2a_tasks' module requires additional "
                    "packages. Please install them using pip install "
                    "google-cloud-aiplatform[runtimes]"
                ) from e
    ...
    def memories(self) -> "memories_module.Memories":
        if self._memories is None:
            try:
                ...
                raise ImportError(
                    "The 'runtimes.memories' module requires additional "
                    "packages. Please install them using pip install "
                    "google-cloud-aiplatform[runtimes]"
                ) from e
    ...
    def sandboxes(self) -> Any:
        if self._sandboxes is None:
            try:
                ...
                raise ImportError(
                    "The runtimes.sandboxes module requires additional packages. "
    ...
    def sessions(self) -> "sessions_module.Sessions":
        if self._sessions is None:
            try:
                ...
                raise ImportError(
                    "The runtimes.sessions module requires additional packages. "
                    "Please install them using pip install "
                    "google-cloud-aiplatform[runtimes]"
                ) from e
    ...
    def _list_pager(
        self, *, config: Optional[types.ListRuntimeConfigurationOrDict] = None
    ...
    def check_query_job(
        ...
        *,
        name: str,
        config: Optional[types.CheckQueryJobRuntimeConfigurationOrDict] = None,
    ) -> types.CheckQueryJobResult:
        """Checks a query job on a Runtime and optionally returns the results.

        Args:
            name (str):
                Required. A fully-qualified resource name or ID.
            config (CheckQueryJobRuntimeConfigurationOrDict):
        ...
        if config is None:
            config = types.CheckQueryJobRuntimeConfiguration()
        elif isinstance(config, dict):
            config = types.CheckQueryJobRuntimeConfiguration(**config)
    ...
    def _is_lightweight_creation(
        self, agent: Any, config: types.RuntimeConfiguration
    ) -> bool:
        if (
            agent
    ...
    def run_query_job(
        ...
        *,
        name: str,
        config: Optional[types.RunQueryJobRuntimeConfigurationOrDict] = None,
    ) -> types.RunQueryJobResult:
        """Launches a long-running query job on a Runtime

        Args:
            name (str):
                Required. A fully-qualified resource name or ID.
            config (RunQueryJobRuntimeConfigurationOrDict):
                Optional. The configuration for the async query. If not provided,
                the default configuration will be used. This can be used to specify
                the following fields:
                  - query: The query to send to the runtime.
        ...
        if config is None:
            config = types.RunQueryJobRuntimeConfiguration()
        elif isinstance(config, dict):
            config = types.RunQueryJobRuntimeConfiguration(**config)
        ...
        new_config = types._RunQueryJobRuntimeConfiguration(
    ...
    def get(
        ...
        *,
        name: str,
        config: Optional[types.GetRuntimeConfigurationOrDict] = None,
    ) -> types.Runtime:
        """Gets an runtime.
        ...
        runtime = types.Runtime(
            api_client=self,
            api_async_client=AsyncRuntimes(api_client_=self._api_client),
    ...
    def delete(
        ...
        *,
        name: str,
        force: Optional[bool] = None,
        config: Optional[types.DeleteRuntimeConfigurationOrDict] = None,
    ) -> types.DeleteRuntimeOperation:
        """
        ...
        Args:
            ...
            force (bool):
                ...
                Otherwise, the request will fail with FAILED_PRECONDITION error when
                the Runtime has undeleted child resources. Defaults to False.
            config (DeleteRuntimeConfiguration):
                Optional. Additional configurations for deleting the Runtime.

        """
        logger.info(f"Deleting Runtime resource: {name}")
        operation = self._delete(name=name, force=force, config=config)
        logger.info(f"Started Runtime delete operation: {operation.name}")
        return operation
    ...
    def create(
        ...
        *,
        runtime: Any = None,
        agent: Any = None,
        config: Optional[types.RuntimeConfigurationOrDict] = None,
    ) -> types.Runtime:
        """Creates a runtime.

        The Runtime will be an instance of the `runtime` that
        ...
        To build a Runtime with the above files, run:
            ...
            remote_agent = client.runtimes.create(
                ...
                config=dict(
                    requirements=[
                        ...
                        "google-cloud-aiplatform[runtimes,adk]",
                        ...
                    ],
                    extra_packages=[
        ...
        Args:
            ...
            config (RuntimeConfiguration):
                Optional. The configurations to use for creating the Runtime.

        Returns:
            Runtime: The created Runtime instance.
        ...
        if isinstance(config, dict):
            config = types.RuntimeConfiguration.model_validate(config)
        elif not isinstance(config, types.RuntimeConfiguration):
            raise TypeError(
                f"config must be a dict or RuntimeConfiguration, but got {type(config)}."
            )
        ...
        if agent and runtime:
            raise ValueError("Please specify only one of `agent` or `runtime`.")
        elif runtime:
            raise DeprecationWarning(
                "The `runtime` argument is deprecated. Please use `agent` instead."
            )
        ...
        if not self._is_lightweight_creation(agent, config):
            ...
            poll_interval_seconds = 1  # Lightweight runtime resource creation.
        ...
        if runtime.api_resource:
            logger.info("Runtime created. To use it in another session:")
            logger.info(
                f"runtime=client.runtimes.get(name='{runtime.api_resource.name}')"
            )
        elif operation.error:
            raise RuntimeError(f"Failed to create Runtime: {operation.error}")
        else:
            logger.warning("The operation returned an empty response.")
        if not self._is_lightweight_creation(agent, config):
            # If the user did not provide an runtime (e.g. lightweight
            # provisioning), it will not have any API methods registered.
            runtime = self._register_api_methods(runtime=runtime)
    ...
    def _set_source_code_spec(
        ...
        *,
        ...
        """Sets source_code_spec for runtime inside the `spec`."""
        source_code_spec = types.ReasoningEngineSpecSourceCodeSpecDict()
        if source_packages and not agent_config_source:
            source_packages = _runtimes_utils._validate_packages_or_raise(
            ...
            source_code_spec["inline_source"] = {  # type: ignore[typeddict-item]
                "source_archive": _runtimes_utils._create_base64_encoded_tarball(
        ...
        if class_methods is not None:
            ...
            class_methods_spec_list = (
                _runtimes_utils._class_methods_to_class_methods_spec(
                    class_methods=class_methods
                )
            )
            spec["class_methods"] = [
                _runtimes_utils._to_dict(class_method_spec)
    ...
    def _set_package_spec(
        ...
        *,
        ...
        gcs_dir_name = gcs_dir_name or _runtimes_utils._DEFAULT_GCS_DIR_NAME
        staging_bucket = _runtimes_utils._validate_staging_bucket_or_raise(
            staging_bucket=staging_bucket,
        )
        requirements = _runtimes_utils._validate_requirements_or_raise(
            agent=agent,
            requirements=requirements,
        )
        extra_packages = _runtimes_utils._validate_packages_or_raise(
            packages=extra_packages,
            build_options=build_options,
        )
        # Prepares the Runtime for creation/update in Vertex AI. This
        # involves packaging and uploading the artifacts for runtime,
        ...
        package_spec: types.ReasoningEngineSpecPackageSpecDict = {
            ...
            "pickle_object_gcs_uri": "{}/{}/{}".format(
                staging_bucket,
                gcs_dir_name,
                _runtimes_utils._BLOB_FILENAME,
            ),
        }
        if extra_packages:
            ...
            package_spec["dependency_files_gcs_uri"] = "{}/{}/{}".format(
                staging_bucket,
                gcs_dir_name,
                _runtimes_utils._EXTRA_PACKAGES_FILE,
            )
        if requirements:
            ...
            package_spec["requirements_gcs_uri"] = "{}/{}/{}".format(
                staging_bucket,
                gcs_dir_name,
                _runtimes_utils._REQUIREMENTS_FILE,
            )
        ...
        if class_methods is not None:
            ...
            class_methods_spec_list = (
                _runtimes_utils._generate_class_methods_spec_or_raise(
                    agent=agent,
                    operations=_runtimes_utils._get_registered_operations(agent=agent),
                )
            )
        spec["class_methods"] = [
            _runtimes_utils._to_dict(class_method_spec)
    ...
    def _create_config(
        ...
        *,
    ...
    ) -> types.UpdateRuntimeConfigurationDict:
        import sys

        config: types.UpdateRuntimeConfigurationDict = {}
        update_masks = []
        ...
        if agent_framework == "google-adk":
            env_vars = _runtimes_utils._add_telemetry_enablement_env(env_vars)
        ...
        if agent:
            if source_packages:
                raise ValueError(
                    ...
                    "do not specify `agent` in `runtimes.create()` or "
                    "`runtimes.update()`."
                )
        ...
        if agent:
            runtime_spec = {}
            agent = _runtimes_utils._validate_agent_or_raise(agent=agent)
            if _runtimes_utils._is_adk_agent(agent):
                env_vars = _runtimes_utils._add_telemetry_enablement_env(env_vars)
            ...
            if class_methods is not None:
                ...
                runtime_spec["class_methods"] = [
                    _runtimes_utils._to_dict(class_method_spec)
                    for class_method_spec in class_methods_spec_list
                ]
            update_masks.append("spec.container_spec")
            runtime_spec["container_spec"] = container_spec
        ...
        if runtime_spec is None and is_deployment_spec_updated:
            raise ValueError(
        ...
        if runtime_spec is not None:
            if is_deployment_spec_updated:
                ...
                runtime_spec["deployment_spec"] = deployment_spec

            if agent_server_mode:
                if not runtime_spec.get("deployment_spec"):
                    runtime_spec["deployment_spec"] = (
                        types.ReasoningEngineSpecDeploymentSpecDict()
                    )
                runtime_spec["deployment_spec"]["agent_server_mode"] = agent_server_mode

            runtime_spec["agent_framework"] = _runtimes_utils._get_agent_framework(
    ...
    def _generate_deployment_spec_or_raise(
        ...
        *,
        ...
        if resource_limits:
            _runtimes_utils._validate_resource_limits_or_raise(
                resource_limits=resource_limits
            )
    ...
    def _register_api_methods(
        ...
        *,
        ...
        """Registers the API methods for the runtime."""
        try:
    ...
    def list(
        self, *, config: Optional[types.ListRuntimeConfigurationOrDict] = None
    ) -> Iterator[types.Runtime]:
        """List all instances of Runtimes matching the filter.
        ...
        Args:
            config (ListRuntimeConfiguration):
                Optional. The config (e.g. filter) for the agents to be listed.

        Returns:
            Iterable[Runtime]: An iterable of Runtimes matching the filter.
        """
    ...
    def update(
        ...
        *,
        ...
        agent: Any = None,
        runtime: Any = None,
        config: types.RuntimeConfigurationOrDict,
    ) -> types.Runtime:
        """Updates an existing Runtime.

        This method updates the configuration of an existing Runtime running
        ...
        Args:
            ...
            agent (Any):
                Optional. The instance to be used as the updated Runtime.
                If it is not specified, the existing instance will be used.
            runtime (Any):
                Optional. This is deprecated. Please use `agent` instead.
            config (RuntimeConfiguration):
                Optional. The configurations to use for updating the Runtime.
        ...
        Raises:
          ValueError: If the `project` was not set using `client.Client`.
          ValueError: If the `location` was not set using `client.Client`.
          ValueError: If `config.staging_bucket` was not set when `runtime`
          is specified.
          ValueError: If `config.staging_bucket` does not start with "gs://".
          ValueError: If `config.extra_packages` is specified but `runtime`
          is None.
          ValueError: If `config.requirements` is specified but `runtime` is
          None.
          ValueError: If `config.env_vars` has a dictionary entry that does not
          correspond to an environment variable value or a SecretRef.
          TypeError: If `config.env_vars` is not a dictionary.
        ...
        if runtime.api_resource:
            logger.info("Runtime updated. To use it in another session:")
            logger.info(
                f"runtime=client.runtimes.get(name='{runtime.api_resource.name}')"
            )
        elif operation.error:
            raise RuntimeError(f"Failed to update Runtime: {operation.error}")
    ...
    def _stream_query(
        ...
        *,
        name: str,
        config: Optional[types.QueryRuntimeConfigurationOrDict] = None,
    ) -> Iterator[Any]:
        """Streams the response of the runtime."""
        parameter_model = types._QueryRuntimeRequestParameters(
            name=name,
            config=config,
        )
    ...
    async def _async_stream_query(
        ...
        *,
        ...
        """Streams the response of the runtime asynchronously."""
        parameter_model = types._QueryRuntimeRequestParameters(
            name=name,
            config=config,
        )
    ...
    def create_memory(
        ...
        *,
        ...
        """Deprecated. Use runtimes.memories.create instead."""
        warnings.warn(
            (
                "runtimes.create_memory is deprecated. "
                "Use runtimes.memories.create instead."
            ),
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def delete_memory(
        ...
        *,
        ...
        """Deprecated. Use runtimes.memories.delete instead."""
        warnings.warn(
            (
                "runtimes.delete_memory is deprecated. "
                "Use runtimes.memories.delete instead."
            ),
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def generate_memories(
        ...
        *,
        ...
        """Deprecated. Use runtimes.memories.generate instead."""
        warnings.warn(
            (
                "runtimes.generate_memories is deprecated. "
                "Use runtimes.memories.generate instead."
            ),
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def get_memory(
        ...
        *,
        name: str,
        config: Optional[types.GetRuntimeMemoryConfigOrDict] = None,
    ) -> types.Memory:
        """Deprecated. Use runtimes.memories.get instead."""
        warnings.warn(
            (
                "runtimes.get_memory is deprecated. "
                "Use runtimes.memories.get instead."
            ),
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def list_memories(
        ...
        *,
        ...
        """Deprecated. Use runtimes.memories.list instead."""
        warnings.warn(
            (
                "runtimes.list_memories is deprecated. "
                "Use runtimes.memories.list instead."
            ),
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def retrieve_memories(
        ...
        *,
        ...
        """Deprecated. Use runtimes.memories.retrieve instead."""
        warnings.warn(
            (
                "runtimes.retrieve_memories is deprecated. "
                "Use runtimes.memories.retrieve instead."
            ),
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def create_session(
        ...
        *,
        ...
        """Deprecated. Use runtimes.sessions.create instead."""
        warnings.warn(
            (
                "runtimes.create_session is deprecated. "
                "Use runtimes.sessions.create instead."
            ),
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def delete_session(
        ...
        *,
        ...
        """Deprecated. Use runtimes.sessions.delete instead."""
        warnings.warn(
            (
                "runtimes.delete_session is deprecated. "
                "Use runtimes.sessions.delete instead."
            ),
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def get_session(
        ...
        *,
        name: str,
        config: Optional[types.GetRuntimeSessionConfigOrDict] = None,
    ) -> types.Session:
        """Deprecated. Use runtimes.sessions.get instead."""
        warnings.warn(
            (
                "runtimes.get_session is deprecated. "
                "Use runtimes.sessions.get instead."
            ),
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def list_sessions(
        ...
        *,
        ...
        """Deprecated. Use runtimes.sessions.list instead."""
        warnings.warn(
            (
                "runtimes.list_sessions is deprecated. "
                "Use runtimes.sessions.list instead."
            ),
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def append_session_event(
        ...
        *,
        ...
        """Deprecated. Use runtimes.sessions.events.append instead."""
        warnings.warn(
            (
                "runtimes.append_session_event is deprecated. "
                "Use runtimes.sessions.events.append instead."
            ),
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def list_session_events(
        ...
        *,
        ...
        """Deprecated. Use runtimes.sessions.events.list instead."""
        warnings.warn(
            (
                "runtimes.list_session_events is deprecated. "
                "Use runtimes.sessions.events.list instead."
            ),
            DeprecationWarning,
            stacklevel=2,
        )
