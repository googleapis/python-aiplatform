...
def _ReasoningEngineContextSpec_from_vertex(
    ...
    if getv(from_object, ["exampleStoreConfig"]) is not None:
        setv(
            to_object,
            ["example_store_config"],
            getv(from_object, ["exampleStoreConfig"]),
        )
...
def _ReasoningEngineContextSpec_to_vertex(
    ...
    if getv(from_object, ["example_store_config"]) is not None:
        setv(
            to_object,
            ["exampleStoreConfig"],
            getv(from_object, ["example_store_config"]),
        )
...
def _ReasoningEngine_from_vertex(
    ...
    if getv(from_object, ["experimentConfig"]) is not None:
        setv(to_object, ["experiment_config"], getv(from_object, ["experimentConfig"]))
    ...
    if getv(from_object, ["url"]) is not None:
        setv(to_object, ["url"], getv(from_object, ["url"]))
...
class Runtimes(_api_module.BaseModule):
    ...
    def _is_lightweight_creation(self, agent: Any, config: types.RuntimeConfig) -> bool:
        if (
            agent
    ...
    def create(
        ...
        *,
        ...
        agent: Any = None,
        config: Optional[types.RuntimeConfigOrDict] = None,
    ) -> types.Runtime:
        """Creates an agent runtime.

        The Agent Runtime will be an instance of the `agent_engine` that
        ...
        if isinstance(config, dict):
            config = types.RuntimeConfig.model_validate(config)
        elif not isinstance(config, types.RuntimeConfig):
            raise TypeError(
                f"config must be a dict or RuntimeConfig, but got {type(config)}."
            )
        ...
        if agent_engine.api_resource:
            ...
            logger.info(
                f"agent_engine=client.runtimes.get(name='{agent_engine.api_resource.name}')"
            )
    ...
    def _create_config(
        ...
        *,
        ...
        if agent_engine_spec is not None:
            ...
            agent_engine_spec["agent_framework"] = _runtimes_utils._get_agent_framework(
    ...
    def update(
        ...
        *,
        ...
        agent: Any = None,
        agent_engine: Any = None,
        config: types.RuntimeConfigOrDict,
    ) -> types.Runtime:
