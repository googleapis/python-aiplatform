...
def _CreateRuntimesTaskConfig_to_vertex(
...
def _CreateRuntimesTaskRequestParameters_to_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    to_object: dict[str, Any] = {}
    ...
    if getv(from_object, ["config"]) is not None:
        _CreateRuntimesTaskConfig_to_vertex(getv(from_object, ["config"]), to_object)
...
class A2aTasks(_api_module.BaseModule):
    ...
    def delete(
        ...
        """
        Deletes an Runtime task.

        Args:
            name (str): Required. The name of the Runtime task to delete. Format:
                `projects/{project}/locations/{location}/reasoningEngines/{resource_id}/a2aTasks/{task_id}`.
            config (DeleteRuntimeTaskConfig):
                Optional. Additional configurations for deleting the Runtime task.
    ...
    def get(
        ...
        """
        Gets an Runtime task.

        Args:
            name (str): Required. The name of the Runtime task to get. Format:
                `projects/{project}/locations/{location}/reasoningEngines/{resource_id}/a2aTasks/{task_id}`.
            config (GetRuntimeTaskConfig):
                Optional. Additional configurations for getting the Runtime task.

        Returns:
            RuntimeTask: The requested Runtime task.
    ...
    def _list(
        ...
        Args:
            name (str): Required. The name of the Runtime to list tasks for. Format:
                `projects/{project}/locations/{location}/reasoningEngines/{resource_id}`.
            config (ListRuntimeTasksConfig):
                Optional. Additional configurations for listing the Runtime tasks.

        Returns:
            ListRuntimeTasksResponse: The requested Runtime tasks.
    ...
    def create(
        ...
        *,
        name: str,
        a2a_task_id: str,
        config: Optional[types.CreateRuntimesTaskConfigOrDict] = None,
    ) -> types.A2aTask:
        """
        Creates a new task in the Runtime.

        Args:
            name (str): Required. The name of the Runtime to create the task under. Format:
                `projects/{project}/locations/{location}/reasoningEngines/{resource_id}`.
            a2a_task_id (str): Required. The user ID of the task.
            context_id (str): Required. The ID of the context to use for the task.
            config (CreateRuntimesTaskConfig):
                Optional. Additional configurations for creating the Runtime task.

        Returns:
            A2aTask: The created Runtime task.

        """

        parameter_model = types._CreateRuntimesTaskRequestParameters(
            name=name,
        ...
        if not self._api_client.vertexai:
            ...
            request_dict = _CreateRuntimesTaskRequestParameters_to_vertex(
                parameter_model
            )
            request_url_dict = request_dict.get("_url")
            if request_url_dict:
