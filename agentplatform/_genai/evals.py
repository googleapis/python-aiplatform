        ...
        *,
        ...
        Args:
          ...
          agent: This field is experimental and may change in future versions
                The runtime used or local agent to run agent, optional for non-agent evaluations.
              - runtime resource name in str type, with format
                `projects/{project}/locations/{location}/reasoningEngines/{reasoning_engine_id}`,
                run_inference will fetch the runtime from the resource name.
        ...
        agent_instance = None
        if agent:
            if isinstance(agent, str) or isinstance(agent, types.Runtime):
        ...
        *,
        ...
        Args:
          ...
          agent_info: The agent info to evaluate. Mutually exclusive with
              `inference_configs`.
          agent: The Runtime resource name in str type, with format
              `projects/{project}/locations/{location}/reasoningEngines/{reasoning_engine_id}`.
