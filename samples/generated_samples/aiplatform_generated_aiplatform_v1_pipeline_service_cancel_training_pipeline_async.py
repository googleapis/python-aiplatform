...
# [START aiplatform_generated_aiplatform_v1_PipelineService_CancelTrainingPipeline_async]
...
async def sample_cancel_training_pipeline():
  ...
  request = aiplatform_v1.CancelTrainingPipelineRequest(name="name_value",)
