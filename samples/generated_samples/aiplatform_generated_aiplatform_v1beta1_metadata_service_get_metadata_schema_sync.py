...
# [START aiplatform_generated_aiplatform_v1beta1_MetadataService_GetMetadataSchema_sync]
...
def sample_get_metadata_schema():
  ...
  request = aiplatform_v1beta1.GetMetadataSchemaRequest(name="name_value",)
