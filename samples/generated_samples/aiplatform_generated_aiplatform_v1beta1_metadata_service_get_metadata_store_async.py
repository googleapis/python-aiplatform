...
# [START aiplatform_generated_aiplatform_v1beta1_MetadataService_GetMetadataStore_async]
...
async def sample_get_metadata_store():
  ...
  request = aiplatform_v1beta1.GetMetadataStoreRequest(name="name_value",)
