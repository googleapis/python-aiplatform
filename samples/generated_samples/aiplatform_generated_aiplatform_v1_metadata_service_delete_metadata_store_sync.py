...
#
# Snippet for DeleteMetadataStore
...
# [START aiplatform_generated_aiplatform_v1_MetadataService_DeleteMetadataStore_sync]
...
def sample_delete_metadata_store():
  ...
  request = aiplatform_v1.DeleteMetadataStoreRequest(name="name_value",)
