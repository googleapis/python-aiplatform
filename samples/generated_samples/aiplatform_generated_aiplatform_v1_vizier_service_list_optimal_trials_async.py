...
# [START aiplatform_generated_aiplatform_v1_VizierService_ListOptimalTrials_async]
...
async def sample_list_optimal_trials():
  ...
  request = aiplatform_v1.ListOptimalTrialsRequest(parent="parent_value",)
