...
# [START aiplatform_generated_aiplatform_v1beta1_FeaturestoreService_DeleteEntityType_async]
...
async def sample_delete_entity_type():
  ...
  request = aiplatform_v1beta1.DeleteEntityTypeRequest(name="name_value",)
