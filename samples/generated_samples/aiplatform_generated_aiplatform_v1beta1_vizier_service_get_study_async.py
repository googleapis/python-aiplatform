...
# [START aiplatform_generated_aiplatform_v1beta1_VizierService_GetStudy_async]
...
async def sample_get_study():
  ...
  request = aiplatform_v1beta1.GetStudyRequest(name="name_value",)
