...
# [START aiplatform_generated_aiplatform_v1_JobService_CancelBatchPredictionJob_async]
...
async def sample_cancel_batch_prediction_job():
  ...
  request = aiplatform_v1.CancelBatchPredictionJobRequest(name="name_value",)
