...
# [START aiplatform_generated_aiplatform_v1_PipelineService_DeleteTrainingPipeline_sync]
...
def sample_delete_training_pipeline():
  ...
  request = aiplatform_v1.DeleteTrainingPipelineRequest(name="name_value",)
