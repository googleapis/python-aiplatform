...
# [START aiplatform_generated_aiplatform_v1beta1_TensorboardService_DeleteTensorboardRun_async]
...
async def sample_delete_tensorboard_run():
  ...
  request = aiplatform_v1beta1.DeleteTensorboardRunRequest(name="name_value",)
