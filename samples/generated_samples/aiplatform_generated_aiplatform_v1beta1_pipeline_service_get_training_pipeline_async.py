...
# [START aiplatform_generated_aiplatform_v1beta1_PipelineService_GetTrainingPipeline_async]
...
async def sample_get_training_pipeline():
  ...
  request = aiplatform_v1beta1.GetTrainingPipelineRequest(name="name_value",)
