...
# [START aiplatform_generated_aiplatform_v1beta1_PipelineService_DeleteTrainingPipeline_async]
...
async def sample_delete_training_pipeline():
  ...
  request = aiplatform_v1beta1.DeleteTrainingPipelineRequest(name="name_value",)
