...
import create_featurestore_sample_v1beta1
import delete_featurestore_sample_v1beta1
import pytest
...
def setup_test(capsys, featurestore_id):
    create_featurestore_sample_v1beta1.create_featurestore_sample(
...
def test_ucaip_generated_delete_featurestore_sample_vision(capsys, shared_state):
    ...
    delete_featurestore_sample_v1beta1.delete_featurestore_sample(
