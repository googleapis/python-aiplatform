...
def create_dataset(shared_state, dataset_client):
  ...
  def create(project,
             location,
             metadata_schema_uri,
             test_name="temp_import_dataset_test"):
...
def teardown_featurestore(shared_state, featurestore_client):
  ...
  featurestore_client.delete_featurestore(
      request=force_delete_featurestore_request)
...
def teardown_entity_type(shared_state, featurestore_client):
  ...
  featurestore_client.delete_entity_type(
      request=force_delete_entity_type_request)
