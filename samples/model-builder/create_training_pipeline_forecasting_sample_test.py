...
def test_create_training_pipeline_forecasting_sample(
  ...
  create_training_pipeline_forecasting_sample.create_training_pipeline_forecasting_sample(
      ...
      export_evaluated_data_items_bigquery_destination_uri=constants
      .EXPORT_EVALUATED_DATA_ITEMS_BIGQUERY_DESTINATION_URI,
      export_evaluated_data_items_override_destination=constants
  ...
  mock_run_automl_forecasting_training_job.assert_called_once_with(
      ...
      time_series_identifier_column=constants
      .FORECASTNG_TIME_SERIES_IDENTIFIER_COLUMN,
      unavailable_at_forecast_columns=constants
      .FORECASTNG_UNAVAILABLE_AT_FORECAST_COLUMNS,
      available_at_forecast_columns=constants
