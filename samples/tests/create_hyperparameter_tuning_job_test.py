...
from samples import cancel_hyperparameter_tuning_job_sample
from samples import create_hyperparameter_tuning_job_sample
from samples import delete_hyperparameter_tuning_job_sample
...
def test_ucaip_generated_create_hyperparameter_tuning_job(capsys, shared_state):
    ...
    shared_state["hyperparameter_tuning_job_name"] = out.split("name:")[1].split("\n")[
        0
    ]
