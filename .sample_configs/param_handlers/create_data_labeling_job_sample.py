...
def make_data_labeling_job(display_name: str, dataset_name: str, instruction_uri: str, inputs_schema_uri: str, annotation_spec: str) -> google.cloud.aiplatform_v1alpha1.types.data_labeling_job.DataLabelingJob:
    inputs_dict = {
