...
@pytest.mark.asyncio
async def test_find_neighbors_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    ...
    with mock.patch.object(
        ...
        response = await client.find_neighbors()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == match_service.FindNeighborsRequest()
...
async def test_find_neighbors_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.find_neighbors] = mock_object
...
@pytest.mark.asyncio
async def test_read_index_datapoints_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MatchServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        response = await client.read_index_datapoints()
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == match_service.ReadIndexDatapointsRequest()
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.read_index_datapoints] = mock_object
...
def test_find_neighbors_rest(request_type):
    client = MatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_find_neighbors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = match_service.FindNeighborsResponse.to_json(match_service.FindNeighborsResponse())
...
def test_find_neighbors_rest_bad_request(transport: str = 'rest', request_type=match_service.FindNeighborsRequest):
    client = MatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_find_neighbors_rest_error():
    client = MatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_read_index_datapoints_rest(request_type):
    client = MatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_read_index_datapoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = match_service.ReadIndexDatapointsResponse.to_json(match_service.ReadIndexDatapointsResponse())
...
def test_read_index_datapoints_rest_bad_request(transport: str = 'rest', request_type=match_service.ReadIndexDatapointsRequest):
    client = MatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_index_datapoints_rest_error():
    client = MatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
