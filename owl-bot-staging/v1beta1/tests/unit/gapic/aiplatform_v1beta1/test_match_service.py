...
from google.cloud.aiplatform_v1beta1.services.match_service import MatchServiceAsyncClient
...
def test__get_default_mtls_endpoint():
    ...
    assert MatchServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert MatchServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert MatchServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert MatchServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert MatchServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    assert MatchServiceClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert MatchServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert MatchServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert MatchServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert MatchServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert MatchServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                MatchServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert MatchServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert MatchServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert MatchServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert MatchServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(MatchServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MatchServiceClient))
@mock.patch.object(MatchServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MatchServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = MatchServiceClient._DEFAULT_UNIVERSE
    default_endpoint = MatchServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = MatchServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert MatchServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert MatchServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == MatchServiceClient.DEFAULT_MTLS_ENDPOINT
    assert MatchServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert MatchServiceClient._get_api_endpoint(None, None, default_universe, "always") == MatchServiceClient.DEFAULT_MTLS_ENDPOINT
    assert MatchServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == MatchServiceClient.DEFAULT_MTLS_ENDPOINT
    assert MatchServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert MatchServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        MatchServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert MatchServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert MatchServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert MatchServiceClient._get_universe_domain(None, None) == MatchServiceClient._DEFAULT_UNIVERSE
...
def test_match_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (MatchServiceAsyncClient, transports.MatchServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (MatchServiceClient, transports.MatchServiceRestTransport, "rest"),
])
@mock.patch.object(MatchServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MatchServiceClient))
@mock.patch.object(MatchServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MatchServiceAsyncClient))
def test_match_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (MatchServiceAsyncClient, transports.MatchServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (MatchServiceClient, transports.MatchServiceGrpcTransport, "grpc", "false"),
    (MatchServiceAsyncClient, transports.MatchServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
...
def test_match_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    MatchServiceClient, MatchServiceAsyncClient
])
@mock.patch.object(MatchServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(MatchServiceClient))
@mock.patch.object(MatchServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(MatchServiceAsyncClient))
...
def test_match_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (MatchServiceClient, transports.MatchServiceGrpcTransport, "grpc", grpc_helpers),
    (MatchServiceAsyncClient, transports.MatchServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (MatchServiceClient, transports.MatchServiceRestTransport, "rest", None),
])
def test_match_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_match_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1beta1.services.match_service.transports.MatchServiceGrpcTransport.__init__') as grpc_transport:
...
def test_match_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_find_neighbors(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.find_neighbors),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_find_neighbors_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.find_neighbors in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.find_neighbors] = mock_rpc
...
@pytest.mark.asyncio
async def test_find_neighbors_async(transport: str = 'grpc_asyncio', request_type=match_service.FindNeighborsRequest):
    client = MatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_read_index_datapoints(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.read_index_datapoints),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_read_index_datapoints_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.read_index_datapoints in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.read_index_datapoints] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_read_index_datapoints_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = MatchServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.read_index_datapoints in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.read_index_datapoints] = mock_rpc
...
@pytest.mark.asyncio
async def test_read_index_datapoints_async(transport: str = 'grpc_asyncio', request_type=match_service.ReadIndexDatapointsRequest):
    client = MatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(match_service.ReadIndexDatapointsResponse(
        ))
...
def test_find_neighbors_rest_required_fields(request_type=match_service.FindNeighborsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).find_neighbors._get_unset_required_fields(jsonified_request)
...
def test_find_neighbors_rest_unset_required_fields():
    transport = transports.MatchServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_read_index_datapoints_rest_required_fields(request_type=match_service.ReadIndexDatapointsRequest):
    transport_class = transports.MatchServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).read_index_datapoints._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_find_neighbors_rest_bad_request(request_type=match_service.FindNeighborsRequest):
    client = MatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_find_neighbors_rest_interceptors(null_interceptor):
    transport = transports.MatchServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.MatchServiceRestInterceptor(),
        )
    client = MatchServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MatchServiceRestInterceptor, "post_find_neighbors") as post, \
        mock.patch.object(transports.MatchServiceRestInterceptor, "post_find_neighbors_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MatchServiceRestInterceptor, "pre_find_neighbors") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = match_service.FindNeighborsRequest.pb(match_service.FindNeighborsRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = match_service.FindNeighborsResponse.to_json(match_service.FindNeighborsResponse())
        ...
        post_with_metadata.return_value = match_service.FindNeighborsResponse(), metadata

        client.find_neighbors(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_read_index_datapoints_rest_bad_request(request_type=match_service.ReadIndexDatapointsRequest):
    client = MatchServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_read_index_datapoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.MatchServiceRestInterceptor, "post_read_index_datapoints") as post, \
        mock.patch.object(transports.MatchServiceRestInterceptor, "post_read_index_datapoints_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.MatchServiceRestInterceptor, "pre_read_index_datapoints") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = match_service.ReadIndexDatapointsRequest.pb(match_service.ReadIndexDatapointsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = match_service.ReadIndexDatapointsResponse.to_json(match_service.ReadIndexDatapointsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = match_service.ReadIndexDatapointsResponse(), metadata

        client.read_index_datapoints(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_find_neighbors_rest_asyncio_bad_request(request_type=match_service.FindNeighborsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_find_neighbors_rest_asyncio_interceptors(null_interceptor):
    ...
    transport = transports.AsyncMatchServiceRestTransport(
        credentials=async_anonymous_credentials(),
        interceptor=None if null_interceptor else transports.AsyncMatchServiceRestInterceptor(),
        )
    client = MatchServiceAsyncClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncMatchServiceRestInterceptor, "post_find_neighbors") as post, \
        mock.patch.object(transports.AsyncMatchServiceRestInterceptor, "post_find_neighbors_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncMatchServiceRestInterceptor, "pre_find_neighbors") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = match_service.FindNeighborsRequest.pb(match_service.FindNeighborsRequest())
        ...
        await client.find_neighbors(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_read_index_datapoints_rest_asyncio_bad_request(request_type=match_service.ReadIndexDatapointsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = MatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_read_index_datapoints_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncMatchServiceRestInterceptor, "post_read_index_datapoints") as post, \
        mock.patch.object(transports.AsyncMatchServiceRestInterceptor, "post_read_index_datapoints_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncMatchServiceRestInterceptor, "pre_read_index_datapoints") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = match_service.ReadIndexDatapointsRequest.pb(match_service.ReadIndexDatapointsRequest())
        ...
        await client.read_index_datapoints(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_match_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1beta1.services.match_service.transports.MatchServiceTransport.__init__') as Transport:
...
def test_match_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1beta1.services.match_service.transports.MatchServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_match_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1beta1.services.match_service.transports.MatchServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.MatchServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.MatchServiceGrpcTransport, transports.MatchServiceGrpcAsyncIOTransport])
def test_match_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.MatchServiceGrpcTransport, transports.MatchServiceGrpcAsyncIOTransport])
def test_match_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.MatchServiceGrpcTransport, transports.MatchServiceGrpcAsyncIOTransport])
def test_match_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.MatchServiceTransport, '_prep_wrapped_messages') as prep:
        client = MatchServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
