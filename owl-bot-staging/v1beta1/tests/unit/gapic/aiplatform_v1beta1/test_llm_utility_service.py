...
from google.cloud.aiplatform_v1beta1.services.llm_utility_service import LlmUtilityServiceAsyncClient
from google.cloud.aiplatform_v1beta1.services.llm_utility_service import LlmUtilityServiceClient
...
def test_llm_utility_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1beta1.services.llm_utility_service.transports.LlmUtilityServiceGrpcTransport.__init__') as grpc_transport:
...
def test_compute_tokens_empty_call():
...
async def test_compute_tokens_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.compute_tokens] = mock_object
...
@pytest.mark.asyncio
async def test_compute_tokens_async(transport: str = 'grpc_asyncio', request_type=llm_utility_service.ComputeTokensRequest):
    client = LlmUtilityServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_compute_tokens_rest(request_type):
    client = LlmUtilityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_compute_tokens_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = llm_utility_service.ComputeTokensResponse.to_json(llm_utility_service.ComputeTokensResponse())
...
def test_compute_tokens_rest_bad_request(transport: str = 'rest', request_type=llm_utility_service.ComputeTokensRequest):
    client = LlmUtilityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_compute_tokens_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{endpoint=projects/*/locations/*/endpoints/*}:computeTokens" % client.transport._host, args[1])
...
def test_compute_tokens_rest_error():
    client = LlmUtilityServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_transport_kind(transport_name):
    transport = LlmUtilityServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_llm_utility_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1beta1.services.llm_utility_service.transports.LlmUtilityServiceTransport.__init__') as Transport:
...
def test_llm_utility_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1beta1.services.llm_utility_service.transports.LlmUtilityServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_llm_utility_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1beta1.services.llm_utility_service.transports.LlmUtilityServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.LlmUtilityServiceTransport()
        adc.assert_called_once()
