...
def test_create_schedule_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = gca_schedule.Schedule.to_json(gca_schedule.Schedule())
...
def test_create_schedule_rest_bad_request(transport: str = 'rest', request_type=schedule_service.CreateScheduleRequest):
    client = ScheduleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_schedule_rest_bad_request(transport: str = 'rest', request_type=schedule_service.DeleteScheduleRequest):
    client = ScheduleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_schedule_rest_bad_request(transport: str = 'rest', request_type=schedule_service.GetScheduleRequest):
    client = ScheduleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_schedules_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = schedule_service.ListSchedulesResponse.to_json(schedule_service.ListSchedulesResponse())
...
def test_list_schedules_rest_bad_request(transport: str = 'rest', request_type=schedule_service.ListSchedulesRequest):
    client = ScheduleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_pause_schedule_rest_bad_request(transport: str = 'rest', request_type=schedule_service.PauseScheduleRequest):
    client = ScheduleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resume_schedule_rest_bad_request(transport: str = 'rest', request_type=schedule_service.ResumeScheduleRequest):
    client = ScheduleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_schedule_rest_bad_request(transport: str = 'rest', request_type=schedule_service.UpdateScheduleRequest):
    client = ScheduleServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
