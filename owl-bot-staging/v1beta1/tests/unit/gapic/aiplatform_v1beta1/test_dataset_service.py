...
def test__get_default_mtls_endpoint():
    ...
    assert DatasetServiceClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
def test_create_dataset_version_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_dataset_version in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_dataset_version] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_dataset_version_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DatasetServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_dataset_version in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_dataset_version] = mock_rpc
...
async def test_create_dataset_version_async(request_type, transport: str = 'grpc_asyncio'):
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_dataset_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_dataset_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_dataset_version_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_dataset_version in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_dataset_version] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_dataset_version_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DatasetServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_dataset_version in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_dataset_version] = mock_rpc
...
async def test_update_dataset_version_async(request_type, transport: str = 'grpc_asyncio'):
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gca_dataset_version.DatasetVersion(
            name='name_value',
            etag='etag_value',
            big_query_dataset_name='big_query_dataset_name_value',
            display_name='display_name_value',
...
async def test_delete_dataset_version_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_dataset_version] = mock_rpc
...
async def test_delete_dataset_version_async(request_type, transport: str = 'grpc_asyncio'):
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_dataset_version_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_dataset_version in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_dataset_version] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_dataset_version_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DatasetServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_dataset_version in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_dataset_version] = mock_rpc
...
async def test_get_dataset_version_async(request_type, transport: str = 'grpc_asyncio'):
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_dataset_versions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_dataset_versions] = mock_rpc
...
async def test_list_dataset_versions_async(request_type, transport: str = 'grpc_asyncio'):
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_restore_dataset_version_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.restore_dataset_version in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.restore_dataset_version] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_restore_dataset_version_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DatasetServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.restore_dataset_version in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.restore_dataset_version] = mock_rpc
...
async def test_restore_dataset_version_async(request_type, transport: str = 'grpc_asyncio'):
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_search_data_items_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DatasetServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.search_data_items in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.search_data_items] = mock_rpc
...
async def test_search_data_items_async(request_type, transport: str = 'grpc_asyncio'):
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_assess_data(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.assess_data),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_assess_data_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DatasetServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.assess_data in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.assess_data] = mock_rpc
...
async def test_assess_data_async(request_type, transport: str = 'grpc_asyncio'):
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_assemble_data(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.assemble_data),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_assemble_data_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = DatasetServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.assemble_data in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.assemble_data] = mock_rpc
...
async def test_assemble_data_async(request_type, transport: str = 'grpc_asyncio'):
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_dataset_rest_required_fields(request_type=dataset_service.CreateDatasetRequest):
...
def test_create_dataset_rest_unset_required_fields():
    transport = transports.DatasetServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_get_dataset_rest_required_fields(request_type=dataset_service.GetDatasetRequest):
    transport_class = transports.DatasetServiceRestTransport
...
def test_update_dataset_rest_required_fields(request_type=dataset_service.UpdateDatasetRequest):
    transport_class = transports.DatasetServiceRestTransport
...
def test_list_datasets_rest_required_fields(request_type=dataset_service.ListDatasetsRequest):
    transport_class = transports.DatasetServiceRestTransport
...
def test_list_datasets_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(dataset_service.ListDatasetsResponse.to_json(x) for x in response)
...
def test_delete_dataset_rest_required_fields(request_type=dataset_service.DeleteDatasetRequest):
    transport_class = transports.DatasetServiceRestTransport
...
def test_import_data_rest_required_fields(request_type=dataset_service.ImportDataRequest):
    transport_class = transports.DatasetServiceRestTransport
...
def test_import_data_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "importConfigs", )))
...
def test_import_data_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/datasets/*}:import" % client.transport._host, args[1])
...
def test_export_data_rest_required_fields(request_type=dataset_service.ExportDataRequest):
    transport_class = transports.DatasetServiceRestTransport
...
def test_export_data_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/datasets/*}:export" % client.transport._host, args[1])
...
def test_create_dataset_version_rest_required_fields(request_type=dataset_service.CreateDatasetVersionRequest):
    transport_class = transports.DatasetServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_dataset_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_dataset_version_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "datasetVersion", )))
...
def test_create_dataset_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/datasets/*}/datasetVersions" % client.transport._host, args[1])
...
def test_update_dataset_version_rest_required_fields(request_type=dataset_service.UpdateDatasetVersionRequest):
    transport_class = transports.DatasetServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_dataset_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_dataset_version_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("datasetVersion", "updateMask", )))
...
def test_update_dataset_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'dataset_version': {'name': 'projects/sample1/locations/sample2/datasets/sample3/datasetVersions/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{dataset_version.name=projects/*/locations/*/datasets/*/datasetVersions/*}" % client.transport._host, args[1])
...
def test_delete_dataset_version_rest_required_fields(request_type=dataset_service.DeleteDatasetVersionRequest):
    transport_class = transports.DatasetServiceRestTransport
...
def test_delete_dataset_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/datasets/sample3/datasetVersions/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/datasets/*/datasetVersions/*}" % client.transport._host, args[1])
...
def test_get_dataset_version_rest_required_fields(request_type=dataset_service.GetDatasetVersionRequest):
    transport_class = transports.DatasetServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_dataset_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_dataset_versions_rest_required_fields(request_type=dataset_service.ListDatasetVersionsRequest):
    transport_class = transports.DatasetServiceRestTransport
...
def test_list_dataset_versions_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(dataset_service.ListDatasetVersionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_restore_dataset_version_rest_required_fields(request_type=dataset_service.RestoreDatasetVersionRequest):
    transport_class = transports.DatasetServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).restore_dataset_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_restore_dataset_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/datasets/*/datasetVersions/*}:restore" % client.transport._host, args[1])
...
def test_list_data_items_rest_required_fields(request_type=dataset_service.ListDataItemsRequest):
    transport_class = transports.DatasetServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_data_items._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_data_items_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/datasets/*}/dataItems" % client.transport._host, args[1])
...
def test_list_data_items_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(dataset_service.ListDataItemsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_search_data_items_rest_required_fields(request_type=dataset_service.SearchDataItemsRequest):
    transport_class = transports.DatasetServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_data_items._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_data_items._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("annotation_filters", "annotations_filter", "annotations_limit", "data_item_filter", "data_labeling_job", "field_mask", "order_by", "order_by_annotation", "order_by_data_item", "page_size", "page_token", "saved_query", ))
    jsonified_request.update(unset_fields)
...
def test_search_data_items_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("annotationFilters", "annotationsFilter", "annotationsLimit", "dataItemFilter", "dataLabelingJob", "fieldMask", "orderBy", "orderByAnnotation", "orderByDataItem", "pageSize", "pageToken", "savedQuery", )) & set(("dataset", )))
...
def test_search_data_items_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(dataset_service.SearchDataItemsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        sample_request = {'dataset': 'projects/sample1/locations/sample2/datasets/sample3'}
...
def test_list_saved_queries_rest_required_fields(request_type=dataset_service.ListSavedQueriesRequest):
    transport_class = transports.DatasetServiceRestTransport
...
def test_list_saved_queries_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/datasets/*}/savedQueries" % client.transport._host, args[1])
...
def test_list_saved_queries_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(dataset_service.ListSavedQueriesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_delete_saved_query_rest_required_fields(request_type=dataset_service.DeleteSavedQueryRequest):
    transport_class = transports.DatasetServiceRestTransport
...
def test_delete_saved_query_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/datasets/sample3/savedQueries/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/datasets/*/savedQueries/*}" % client.transport._host, args[1])
...
def test_get_annotation_spec_rest_required_fields(request_type=dataset_service.GetAnnotationSpecRequest):
    transport_class = transports.DatasetServiceRestTransport
...
def test_list_annotations_rest_required_fields(request_type=dataset_service.ListAnnotationsRequest):
    transport_class = transports.DatasetServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_annotations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_annotations_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/datasets/sample3/dataItems/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/datasets/*/dataItems/*}/annotations" % client.transport._host, args[1])
...
def test_list_annotations_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(dataset_service.ListAnnotationsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_assess_data_rest_required_fields(request_type=dataset_service.AssessDataRequest):
    transport_class = transports.DatasetServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).assess_data._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_assemble_data_rest_required_fields(request_type=dataset_service.AssembleDataRequest):
    transport_class = transports.DatasetServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).assemble_data._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_dataset_rest_bad_request(request_type=dataset_service.CreateDatasetRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_create_dataset") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_create_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_create_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.CreateDatasetRequest.pb(dataset_service.CreateDatasetRequest())
...
def test_get_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_get_dataset") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_get_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_get_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.GetDatasetRequest.pb(dataset_service.GetDatasetRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_dataset_rest_bad_request(request_type=dataset_service.UpdateDatasetRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_dataset_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'dataset': {'name': 'projects/sample1/locations/sample2/datasets/sample3'}}
    request_init["dataset"] = {'name': 'projects/sample1/locations/sample2/datasets/sample3', 'display_name': 'display_name_value', 'description': 'description_value', 'metadata_schema_uri': 'metadata_schema_uri_value', 'metadata': {'null_value': 0, 'number_value': 0.1285, 'string_value': 'string_value_value', 'bool_value': True, 'struct_value': {'fields': {}}, 'list_value': {'values': {}}}, 'data_item_count': 1584, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'etag': 'etag_value', 'labels': {}, 'saved_queries': [{'name': 'name_value', 'display_name': 'display_name_value', 'metadata': {}, 'create_time': {}, 'update_time': {}, 'annotation_filter': 'annotation_filter_value', 'problem_type': 'problem_type_value', 'annotation_spec_count': 2253, 'etag': 'etag_value', 'support_automl_training': True}], 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}, 'metadata_artifact': 'metadata_artifact_value', 'model_reference': 'model_reference_value', 'satisfies_pzs': True, 'satisfies_pzi': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_update_dataset") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_update_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_update_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.UpdateDatasetRequest.pb(dataset_service.UpdateDatasetRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_datasets_rest_bad_request(request_type=dataset_service.ListDatasetsRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_datasets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_list_datasets") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_list_datasets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_list_datasets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.ListDatasetsRequest.pb(dataset_service.ListDatasetsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dataset_service.ListDatasetsResponse.to_json(dataset_service.ListDatasetsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = dataset_service.ListDatasetsResponse(), metadata
...
def test_delete_dataset_rest_bad_request(request_type=dataset_service.DeleteDatasetRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_dataset_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_delete_dataset") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_delete_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_delete_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.DeleteDatasetRequest.pb(dataset_service.DeleteDatasetRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_import_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_import_data") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_import_data_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_import_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.ImportDataRequest.pb(dataset_service.ImportDataRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_export_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_export_data") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_export_data_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_export_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.ExportDataRequest.pb(dataset_service.ExportDataRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_dataset_version_rest_bad_request(request_type=dataset_service.CreateDatasetVersionRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_dataset_version_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/datasets/sample3'}
    request_init["dataset_version"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'etag': 'etag_value', 'big_query_dataset_name': 'big_query_dataset_name_value', 'display_name': 'display_name_value', 'metadata': {'null_value': 0, 'number_value': 0.1285, 'string_value': 'string_value_value', 'bool_value': True, 'struct_value': {'fields': {}}, 'list_value': {'values': {}}}, 'model_reference': 'model_reference_value', 'satisfies_pzs': True, 'satisfies_pzi': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = dataset_service.CreateDatasetVersionRequest.meta.fields["dataset_version"]
...
def test_create_dataset_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_create_dataset_version") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_create_dataset_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_create_dataset_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.CreateDatasetVersionRequest.pb(dataset_service.CreateDatasetVersionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_dataset_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_dataset_version_rest_bad_request(request_type=dataset_service.UpdateDatasetVersionRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'dataset_version': {'name': 'projects/sample1/locations/sample2/datasets/sample3/datasetVersions/sample4'}}
    request = request_type(**request_init)
...
def test_update_dataset_version_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'dataset_version': {'name': 'projects/sample1/locations/sample2/datasets/sample3/datasetVersions/sample4'}}
    request_init["dataset_version"] = {'name': 'projects/sample1/locations/sample2/datasets/sample3/datasetVersions/sample4', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'etag': 'etag_value', 'big_query_dataset_name': 'big_query_dataset_name_value', 'display_name': 'display_name_value', 'metadata': {'null_value': 0, 'number_value': 0.1285, 'string_value': 'string_value_value', 'bool_value': True, 'struct_value': {'fields': {}}, 'list_value': {'values': {}}}, 'model_reference': 'model_reference_value', 'satisfies_pzs': True, 'satisfies_pzi': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = dataset_service.UpdateDatasetVersionRequest.meta.fields["dataset_version"]
...
def test_update_dataset_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_update_dataset_version") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_update_dataset_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_update_dataset_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.UpdateDatasetVersionRequest.pb(dataset_service.UpdateDatasetVersionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gca_dataset_version.DatasetVersion.to_json(gca_dataset_version.DatasetVersion())
        req.return_value.content = return_value
        ...
        client.update_dataset_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_dataset_version_rest_bad_request(request_type=dataset_service.DeleteDatasetVersionRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/datasets/sample3/datasetVersions/sample4'}
    request = request_type(**request_init)
...
def test_delete_dataset_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_delete_dataset_version") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_delete_dataset_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_delete_dataset_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.DeleteDatasetVersionRequest.pb(dataset_service.DeleteDatasetVersionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_dataset_version_rest_bad_request(request_type=dataset_service.GetDatasetVersionRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_dataset_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_get_dataset_version") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_get_dataset_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_get_dataset_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.GetDatasetVersionRequest.pb(dataset_service.GetDatasetVersionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dataset_version.DatasetVersion.to_json(dataset_version.DatasetVersion())
        req.return_value.content = return_value
        ...
        client.get_dataset_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_dataset_versions_rest_bad_request(request_type=dataset_service.ListDatasetVersionsRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_dataset_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_list_dataset_versions") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_list_dataset_versions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_list_dataset_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.ListDatasetVersionsRequest.pb(dataset_service.ListDatasetVersionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dataset_service.ListDatasetVersionsResponse.to_json(dataset_service.ListDatasetVersionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = dataset_service.ListDatasetVersionsResponse(), metadata
...
def test_restore_dataset_version_rest_bad_request(request_type=dataset_service.RestoreDatasetVersionRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_restore_dataset_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_restore_dataset_version") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_restore_dataset_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_restore_dataset_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.RestoreDatasetVersionRequest.pb(dataset_service.RestoreDatasetVersionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.restore_dataset_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_data_items_rest_bad_request(request_type=dataset_service.ListDataItemsRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_data_items_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_list_data_items") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_list_data_items_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_list_data_items") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.ListDataItemsRequest.pb(dataset_service.ListDataItemsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dataset_service.ListDataItemsResponse.to_json(dataset_service.ListDataItemsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = dataset_service.ListDataItemsResponse(), metadata

        client.list_data_items(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_search_data_items_rest_bad_request(request_type=dataset_service.SearchDataItemsRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_search_data_items_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_search_data_items") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_search_data_items_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_search_data_items") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.SearchDataItemsRequest.pb(dataset_service.SearchDataItemsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dataset_service.SearchDataItemsResponse.to_json(dataset_service.SearchDataItemsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = dataset_service.SearchDataItemsResponse(), metadata

        client.search_data_items(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_saved_queries_rest_bad_request(request_type=dataset_service.ListSavedQueriesRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_saved_queries_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_list_saved_queries") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_list_saved_queries_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_list_saved_queries") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.ListSavedQueriesRequest.pb(dataset_service.ListSavedQueriesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dataset_service.ListSavedQueriesResponse.to_json(dataset_service.ListSavedQueriesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = dataset_service.ListSavedQueriesResponse(), metadata
...
def test_delete_saved_query_rest_bad_request(request_type=dataset_service.DeleteSavedQueryRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/datasets/sample3/savedQueries/sample4'}
    request = request_type(**request_init)
...
def test_delete_saved_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_delete_saved_query") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_delete_saved_query_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_delete_saved_query") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.DeleteSavedQueryRequest.pb(dataset_service.DeleteSavedQueryRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_annotation_spec_rest_bad_request(request_type=dataset_service.GetAnnotationSpecRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_annotation_spec_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_get_annotation_spec") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_get_annotation_spec_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_get_annotation_spec") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.GetAnnotationSpecRequest.pb(dataset_service.GetAnnotationSpecRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_annotations_rest_bad_request(request_type=dataset_service.ListAnnotationsRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/datasets/sample3/dataItems/sample4'}
    request = request_type(**request_init)
...
def test_list_annotations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_list_annotations") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_list_annotations_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_list_annotations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.ListAnnotationsRequest.pb(dataset_service.ListAnnotationsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = dataset_service.ListAnnotationsResponse.to_json(dataset_service.ListAnnotationsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = dataset_service.ListAnnotationsResponse(), metadata
...
def test_assess_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_assess_data") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_assess_data_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_assess_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.AssessDataRequest.pb(dataset_service.AssessDataRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.assess_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_assemble_data_rest_bad_request(request_type=dataset_service.AssembleDataRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_assemble_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_assemble_data") as post, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "post_assemble_data_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DatasetServiceRestInterceptor, "pre_assemble_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.AssembleDataRequest.pb(dataset_service.AssembleDataRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.assemble_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_create_dataset_rest_asyncio_bad_request(request_type=dataset_service.CreateDatasetRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_dataset_rest_asyncio_interceptors(null_interceptor):
    ...
    transport = transports.AsyncDatasetServiceRestTransport(
        credentials=async_anonymous_credentials(),
        interceptor=None if null_interceptor else transports.AsyncDatasetServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_create_dataset") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_create_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_create_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.CreateDatasetRequest.pb(dataset_service.CreateDatasetRequest())
        ...
        await client.create_dataset(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_dataset_rest_asyncio_bad_request(request_type=dataset_service.GetDatasetRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_dataset_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_get_dataset") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_get_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_get_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.GetDatasetRequest.pb(dataset_service.GetDatasetRequest())
        ...
        await client.get_dataset(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_update_dataset_rest_asyncio_bad_request(request_type=dataset_service.UpdateDatasetRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_update_dataset_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_update_dataset") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_update_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_update_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.UpdateDatasetRequest.pb(dataset_service.UpdateDatasetRequest())
        ...
        await client.update_dataset(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_datasets_rest_asyncio_bad_request(request_type=dataset_service.ListDatasetsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_datasets_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_list_datasets") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_list_datasets_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_list_datasets") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.ListDatasetsRequest.pb(dataset_service.ListDatasetsRequest())
        ...
        await client.list_datasets(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_dataset_rest_asyncio_bad_request(request_type=dataset_service.DeleteDatasetRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_dataset_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_delete_dataset") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_delete_dataset_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_delete_dataset") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.DeleteDatasetRequest.pb(dataset_service.DeleteDatasetRequest())
        ...
        await client.delete_dataset(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_import_data_rest_asyncio_bad_request(request_type=dataset_service.ImportDataRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_import_data_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_import_data") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_import_data_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_import_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.ImportDataRequest.pb(dataset_service.ImportDataRequest())
        ...
        await client.import_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_export_data_rest_asyncio_bad_request(request_type=dataset_service.ExportDataRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_export_data_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_export_data") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_export_data_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_export_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.ExportDataRequest.pb(dataset_service.ExportDataRequest())
        ...
        await client.export_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_create_dataset_version_rest_asyncio_bad_request(request_type=dataset_service.CreateDatasetVersionRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_dataset_version_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_create_dataset_version") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_create_dataset_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_create_dataset_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.CreateDatasetVersionRequest.pb(dataset_service.CreateDatasetVersionRequest())
        ...
        await client.create_dataset_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_update_dataset_version_rest_asyncio_bad_request(request_type=dataset_service.UpdateDatasetVersionRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_update_dataset_version_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_update_dataset_version") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_update_dataset_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_update_dataset_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.UpdateDatasetVersionRequest.pb(dataset_service.UpdateDatasetVersionRequest())
        ...
        await client.update_dataset_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_dataset_version_rest_asyncio_bad_request(request_type=dataset_service.DeleteDatasetVersionRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_dataset_version_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_delete_dataset_version") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_delete_dataset_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_delete_dataset_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.DeleteDatasetVersionRequest.pb(dataset_service.DeleteDatasetVersionRequest())
        ...
        await client.delete_dataset_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_dataset_version_rest_asyncio_bad_request(request_type=dataset_service.GetDatasetVersionRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_dataset_version_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_get_dataset_version") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_get_dataset_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_get_dataset_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.GetDatasetVersionRequest.pb(dataset_service.GetDatasetVersionRequest())
        ...
        await client.get_dataset_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_dataset_versions_rest_asyncio_bad_request(request_type=dataset_service.ListDatasetVersionsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_dataset_versions_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_list_dataset_versions") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_list_dataset_versions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_list_dataset_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.ListDatasetVersionsRequest.pb(dataset_service.ListDatasetVersionsRequest())
        ...
        await client.list_dataset_versions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_restore_dataset_version_rest_asyncio_bad_request(request_type=dataset_service.RestoreDatasetVersionRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_restore_dataset_version_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_restore_dataset_version") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_restore_dataset_version_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_restore_dataset_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.RestoreDatasetVersionRequest.pb(dataset_service.RestoreDatasetVersionRequest())
        ...
        await client.restore_dataset_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_data_items_rest_asyncio_bad_request(request_type=dataset_service.ListDataItemsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_data_items_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_list_data_items") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_list_data_items_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_list_data_items") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.ListDataItemsRequest.pb(dataset_service.ListDataItemsRequest())
        ...
        await client.list_data_items(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_search_data_items_rest_asyncio_bad_request(request_type=dataset_service.SearchDataItemsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_search_data_items_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_search_data_items") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_search_data_items_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_search_data_items") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.SearchDataItemsRequest.pb(dataset_service.SearchDataItemsRequest())
        ...
        await client.search_data_items(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_saved_queries_rest_asyncio_bad_request(request_type=dataset_service.ListSavedQueriesRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_saved_queries_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_list_saved_queries") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_list_saved_queries_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_list_saved_queries") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.ListSavedQueriesRequest.pb(dataset_service.ListSavedQueriesRequest())
        ...
        await client.list_saved_queries(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_saved_query_rest_asyncio_bad_request(request_type=dataset_service.DeleteSavedQueryRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_saved_query_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_delete_saved_query") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_delete_saved_query_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_delete_saved_query") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.DeleteSavedQueryRequest.pb(dataset_service.DeleteSavedQueryRequest())
        ...
        await client.delete_saved_query(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_annotation_spec_rest_asyncio_bad_request(request_type=dataset_service.GetAnnotationSpecRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_annotation_spec_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_get_annotation_spec") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_get_annotation_spec_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_get_annotation_spec") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.GetAnnotationSpecRequest.pb(dataset_service.GetAnnotationSpecRequest())
        ...
        await client.get_annotation_spec(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_annotations_rest_asyncio_bad_request(request_type=dataset_service.ListAnnotationsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_annotations_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_list_annotations") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_list_annotations_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_list_annotations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.ListAnnotationsRequest.pb(dataset_service.ListAnnotationsRequest())
        ...
        await client.list_annotations(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_assess_data_rest_asyncio_bad_request(request_type=dataset_service.AssessDataRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_assess_data_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_assess_data") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_assess_data_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_assess_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.AssessDataRequest.pb(dataset_service.AssessDataRequest())
        ...
        await client.assess_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_assemble_data_rest_asyncio_bad_request(request_type=dataset_service.AssembleDataRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_assemble_data_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_assemble_data") as post, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "post_assemble_data_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDatasetServiceRestInterceptor, "pre_assemble_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = dataset_service.AssembleDataRequest.pb(dataset_service.AssembleDataRequest())
        ...
        await client.assemble_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
