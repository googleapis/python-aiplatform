...
def test_create_dataset_rest_bad_request(transport: str = 'rest', request_type=dataset_service.CreateDatasetRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_dataset_rest_bad_request(transport: str = 'rest', request_type=dataset_service.GetDatasetRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_dataset_rest_bad_request(transport: str = 'rest', request_type=dataset_service.UpdateDatasetRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_datasets_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataset_service.ListDatasetsResponse.to_json(dataset_service.ListDatasetsResponse())
...
def test_list_datasets_rest_bad_request(transport: str = 'rest', request_type=dataset_service.ListDatasetsRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_dataset_rest_bad_request(transport: str = 'rest', request_type=dataset_service.DeleteDatasetRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_data_rest_bad_request(transport: str = 'rest', request_type=dataset_service.ImportDataRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_export_data_rest_bad_request(transport: str = 'rest', request_type=dataset_service.ExportDataRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_dataset_version_rest_bad_request(transport: str = 'rest', request_type=dataset_service.CreateDatasetVersionRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_dataset_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_dataset_version.DatasetVersion.to_json(gca_dataset_version.DatasetVersion())
...
def test_update_dataset_version_rest_bad_request(transport: str = 'rest', request_type=dataset_service.UpdateDatasetVersionRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_dataset_version_rest_bad_request(transport: str = 'rest', request_type=dataset_service.DeleteDatasetVersionRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_dataset_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataset_version.DatasetVersion.to_json(dataset_version.DatasetVersion())
...
def test_get_dataset_version_rest_bad_request(transport: str = 'rest', request_type=dataset_service.GetDatasetVersionRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_dataset_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataset_service.ListDatasetVersionsResponse.to_json(dataset_service.ListDatasetVersionsResponse())
...
def test_list_dataset_versions_rest_bad_request(transport: str = 'rest', request_type=dataset_service.ListDatasetVersionsRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_restore_dataset_version_rest_bad_request(transport: str = 'rest', request_type=dataset_service.RestoreDatasetVersionRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_data_items_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataset_service.ListDataItemsResponse.to_json(dataset_service.ListDataItemsResponse())
...
def test_list_data_items_rest_bad_request(transport: str = 'rest', request_type=dataset_service.ListDataItemsRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_search_data_items_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataset_service.SearchDataItemsResponse.to_json(dataset_service.SearchDataItemsResponse())
...
def test_search_data_items_rest_bad_request(transport: str = 'rest', request_type=dataset_service.SearchDataItemsRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_saved_queries_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataset_service.ListSavedQueriesResponse.to_json(dataset_service.ListSavedQueriesResponse())
...
def test_list_saved_queries_rest_bad_request(transport: str = 'rest', request_type=dataset_service.ListSavedQueriesRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_saved_query_rest_bad_request(transport: str = 'rest', request_type=dataset_service.DeleteSavedQueryRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_annotation_spec_rest_bad_request(transport: str = 'rest', request_type=dataset_service.GetAnnotationSpecRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_annotations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = dataset_service.ListAnnotationsResponse.to_json(dataset_service.ListAnnotationsResponse())
...
def test_list_annotations_rest_bad_request(transport: str = 'rest', request_type=dataset_service.ListAnnotationsRequest):
    client = DatasetServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
