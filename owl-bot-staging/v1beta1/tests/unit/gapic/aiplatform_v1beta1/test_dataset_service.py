...
@pytest.mark.asyncio
async def test_update_dataset_version_async(transport: str = 'grpc_asyncio', request_type=dataset_service.UpdateDatasetVersionRequest):
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_assess_data_async(transport: str = 'grpc_asyncio', request_type=dataset_service.AssessDataRequest):
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_assemble_data_async(transport: str = 'grpc_asyncio', request_type=dataset_service.AssembleDataRequest):
    client = DatasetServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
