...
from google.cloud.aiplatform_v1beta1.services.feature_registry_service import FeatureRegistryServiceAsyncClient
from google.cloud.aiplatform_v1beta1.services.feature_registry_service import FeatureRegistryServiceClient
...
def test_feature_registry_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1beta1.services.feature_registry_service.transports.FeatureRegistryServiceGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.asyncio
async def test_create_feature_group_async(transport: str = 'grpc_asyncio', request_type=feature_registry_service.CreateFeatureGroupRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_feature_group(request_type, transport: str = 'grpc'):
    ...
    assert response.service_agent_type == feature_group.FeatureGroup.ServiceAgentType.SERVICE_AGENT_TYPE_PROJECT
...
@pytest.mark.asyncio
async def test_get_feature_group_async(transport: str = 'grpc_asyncio', request_type=feature_registry_service.GetFeatureGroupRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_feature_groups_async(transport: str = 'grpc_asyncio', request_type=feature_registry_service.ListFeatureGroupsRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_feature_group_async(transport: str = 'grpc_asyncio', request_type=feature_registry_service.UpdateFeatureGroupRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_feature_group_async(transport: str = 'grpc_asyncio', request_type=feature_registry_service.DeleteFeatureGroupRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_feature_async(transport: str = 'grpc_asyncio', request_type=featurestore_service.CreateFeatureRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_batch_create_features_async(transport: str = 'grpc_asyncio', request_type=featurestore_service.BatchCreateFeaturesRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_feature_async(transport: str = 'grpc_asyncio', request_type=featurestore_service.GetFeatureRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_features_async(transport: str = 'grpc_asyncio', request_type=featurestore_service.ListFeaturesRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_feature_async(transport: str = 'grpc_asyncio', request_type=featurestore_service.UpdateFeatureRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_feature_async(transport: str = 'grpc_asyncio', request_type=featurestore_service.DeleteFeatureRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_feature_monitor(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_feature_monitor),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_feature_monitor_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_feature_monitor in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_feature_monitor] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_feature_monitor_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeatureRegistryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_feature_monitor in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_feature_monitor] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_feature_monitor_async(transport: str = 'grpc_asyncio', request_type=feature_registry_service.CreateFeatureMonitorRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_feature_monitor(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_feature_monitor),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_feature_monitor_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_feature_monitor in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_feature_monitor] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_feature_monitor_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeatureRegistryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_feature_monitor in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_feature_monitor] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_feature_monitor_async(transport: str = 'grpc_asyncio', request_type=feature_registry_service.GetFeatureMonitorRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(feature_monitor.FeatureMonitor(
            name='name_value',
            etag='etag_value',
            description='description_value',
        ))
...
def test_list_feature_monitors_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_feature_monitors in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_feature_monitors] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_feature_monitors_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeatureRegistryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_feature_monitors in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_feature_monitors] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_feature_monitors_async(transport: str = 'grpc_asyncio', request_type=feature_registry_service.ListFeatureMonitorsRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(feature_registry_service.ListFeatureMonitorsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_feature_monitors_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, feature_monitor.FeatureMonitor)
                   for i in results)
...
async def test_list_feature_monitors_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_feature_monitors(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_update_feature_monitor(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_feature_monitor),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_feature_monitor_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_feature_monitor in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_feature_monitor] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_feature_monitor_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeatureRegistryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_feature_monitor in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_feature_monitor] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_feature_monitor_async(transport: str = 'grpc_asyncio', request_type=feature_registry_service.UpdateFeatureMonitorRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_feature_monitor(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_feature_monitor),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_feature_monitor_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_feature_monitor in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_feature_monitor] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_feature_monitor_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeatureRegistryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_feature_monitor in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_feature_monitor] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_feature_monitor_async(transport: str = 'grpc_asyncio', request_type=feature_registry_service.DeleteFeatureMonitorRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_feature_monitor_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_feature_monitor_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.trigger_type == gca_feature_monitor_job.FeatureMonitorJob.FeatureMonitorJobTrigger.FEATURE_MONITOR_JOB_TRIGGER_PERIODIC
...
def test_create_feature_monitor_job_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_feature_monitor_job in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_feature_monitor_job] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_feature_monitor_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeatureRegistryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_feature_monitor_job in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_feature_monitor_job] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_feature_monitor_job_async(transport: str = 'grpc_asyncio', request_type=feature_registry_service.CreateFeatureMonitorJobRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gca_feature_monitor_job.FeatureMonitorJob(
            name='name_value',
            description='description_value',
            drift_base_feature_monitor_job_id=3467,
            trigger_type=gca_feature_monitor_job.FeatureMonitorJob.FeatureMonitorJobTrigger.FEATURE_MONITOR_JOB_TRIGGER_PERIODIC,
...
def test_create_feature_monitor_job_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_feature_monitor_job(
            parent='parent_value',
            feature_monitor_job=gca_feature_monitor_job.FeatureMonitorJob(name='name_value'),
...
def test_get_feature_monitor_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_feature_monitor_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.description == 'description_value'
    assert response.drift_base_feature_monitor_job_id == 3467
    assert response.trigger_type == feature_monitor_job.FeatureMonitorJob.FeatureMonitorJobTrigger.FEATURE_MONITOR_JOB_TRIGGER_PERIODIC
...
def test_get_feature_monitor_job_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_feature_monitor_job in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_feature_monitor_job] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_feature_monitor_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeatureRegistryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_feature_monitor_job in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_feature_monitor_job] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_feature_monitor_job_async(transport: str = 'grpc_asyncio', request_type=feature_registry_service.GetFeatureMonitorJobRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(feature_monitor_job.FeatureMonitorJob(
            name='name_value',
            description='description_value',
            drift_base_feature_monitor_job_id=3467,
            trigger_type=feature_monitor_job.FeatureMonitorJob.FeatureMonitorJobTrigger.FEATURE_MONITOR_JOB_TRIGGER_PERIODIC,
...
def test_list_feature_monitor_jobs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_feature_monitor_jobs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_feature_monitor_jobs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_feature_monitor_jobs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeatureRegistryServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_feature_monitor_jobs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_feature_monitor_jobs] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_feature_monitor_jobs_async(transport: str = 'grpc_asyncio', request_type=feature_registry_service.ListFeatureMonitorJobsRequest):
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(feature_registry_service.ListFeatureMonitorJobsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_feature_monitor_jobs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_feature_monitor_jobs(request={}, retry=retry, timeout=timeout)
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, feature_monitor_job.FeatureMonitorJob)
                   for i in results)
...
async def test_list_feature_monitor_jobs_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_feature_monitor_jobs(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_create_feature_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/featureGroups" % client.transport._host, args[1])
...
def test_get_feature_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/featureGroups/*}" % client.transport._host, args[1])
...
def test_update_feature_group_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{feature_group.name=projects/*/locations/*/featureGroups/*}" % client.transport._host, args[1])
...
def test_create_feature_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/featureGroups/*}/features" % client.transport._host, args[1])
...
def test_batch_create_features_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/featureGroups/*}/features:batchCreate" % client.transport._host, args[1])
...
def test_get_feature_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/featureGroups/*/features/*}" % client.transport._host, args[1])
...
def test_update_feature_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{feature.name=projects/*/locations/*/featureGroups/*/features/*}" % client.transport._host, args[1])
...
def test_create_feature_monitor_rest_required_fields(request_type=feature_registry_service.CreateFeatureMonitorRequest):
    transport_class = transports.FeatureRegistryServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_feature_monitor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_feature_monitor_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("featureMonitorId", )) & set(("parent", "featureMonitor", "featureMonitorId", )))
...
def test_create_feature_monitor_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/featureGroups/*}/featureMonitors" % client.transport._host, args[1])
...
def test_get_feature_monitor_rest_required_fields(request_type=feature_registry_service.GetFeatureMonitorRequest):
    transport_class = transports.FeatureRegistryServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_feature_monitor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_feature_monitor_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/featureGroups/sample3/featureMonitors/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/featureGroups/*/featureMonitors/*}" % client.transport._host, args[1])
...
def test_list_feature_monitors_rest_required_fields(request_type=feature_registry_service.ListFeatureMonitorsRequest):
    transport_class = transports.FeatureRegistryServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_feature_monitors._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = feature_registry_service.ListFeatureMonitorsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_feature_monitors_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(feature_registry_service.ListFeatureMonitorsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_update_feature_monitor_rest_required_fields(request_type=feature_registry_service.UpdateFeatureMonitorRequest):
    transport_class = transports.FeatureRegistryServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_feature_monitor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_feature_monitor_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'feature_monitor': {'name': 'projects/sample1/locations/sample2/featureGroups/sample3/featureMonitors/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{feature_monitor.name=projects/*/locations/*/featureGroups/*/featureMonitors/*}" % client.transport._host, args[1])
...
def test_delete_feature_monitor_rest_required_fields(request_type=feature_registry_service.DeleteFeatureMonitorRequest):
    transport_class = transports.FeatureRegistryServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_feature_monitor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_feature_monitor_job_rest_required_fields(request_type=feature_registry_service.CreateFeatureMonitorJobRequest):
    transport_class = transports.FeatureRegistryServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_feature_monitor_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_feature_monitor_job_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("featureMonitorJobId", )) & set(("parent", "featureMonitorJob", )))
...
def test_create_feature_monitor_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/featureGroups/sample3/featureMonitors/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/featureGroups/*/featureMonitors/*}/featureMonitorJobs" % client.transport._host, args[1])
...
def test_get_feature_monitor_job_rest_required_fields(request_type=feature_registry_service.GetFeatureMonitorJobRequest):
    transport_class = transports.FeatureRegistryServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_feature_monitor_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_feature_monitor_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/featureGroups/sample3/featureMonitors/sample4/featureMonitorJobs/sample5'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/featureGroups/*/featureMonitors/*/featureMonitorJobs/*}" % client.transport._host, args[1])
...
def test_list_feature_monitor_jobs_rest_required_fields(request_type=feature_registry_service.ListFeatureMonitorJobsRequest):
    transport_class = transports.FeatureRegistryServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_feature_monitor_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = feature_registry_service.ListFeatureMonitorJobsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_feature_monitor_jobs_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(feature_registry_service.ListFeatureMonitorJobsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_update_feature_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'feature': {'name': 'projects/sample1/locations/sample2/featureGroups/sample3/features/sample4'}}
    request_init["feature"] = {'name': 'projects/sample1/locations/sample2/featureGroups/sample3/features/sample4', 'description': 'description_value', 'value_type': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'etag': 'etag_value', 'monitoring_config': {'snapshot_analysis': {'disabled': True, 'monitoring_interval': {'seconds': 751, 'nanos': 543}, 'monitoring_interval_days': 2586, 'staleness_days': 1506}, 'import_features_analysis': {'state': 1, 'anomaly_detection_baseline': 1}, 'numerical_threshold_config': {'value': 0.541}, 'categorical_threshold_config': {}}, 'disable_monitoring': True, 'monitoring_stats': [{'score': 0.54, 'stats_uri': 'stats_uri_value', 'anomaly_uri': 'anomaly_uri_value', 'distribution_deviation': 0.23700000000000002, 'anomaly_detection_threshold': 0.28750000000000003, 'start_time': {}, 'end_time': {}}], 'monitoring_stats_anomalies': [{'objective': 1, 'feature_stats_anomaly': {}}], 'feature_stats_and_anomaly': [{'feature_id': 'feature_id_value', 'feature_stats': {'null_value': 0, 'number_value': 0.1285, 'string_value': 'string_value_value', 'bool_value': True, 'struct_value': {'fields': {}}, 'list_value': {'values': {}}}, 'distribution_deviation': 0.23700000000000002, 'drift_detection_threshold': 0.2659, 'drift_detected': True, 'stats_time': {}, 'feature_monitor_job_id': 2329, 'feature_monitor_id': 'feature_monitor_id_value'}], 'version_column_name': 'version_column_name_value', 'point_of_contact': 'point_of_contact_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_feature_monitor_rest_bad_request(request_type=feature_registry_service.CreateFeatureMonitorRequest):
    client = FeatureRegistryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_feature_monitor_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/featureGroups/sample3'}
    request_init["feature_monitor"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'etag': 'etag_value', 'labels': {}, 'description': 'description_value', 'schedule_config': {'cron': 'cron_value'}, 'feature_selection_config': {'feature_configs': [{'feature_id': 'feature_id_value', 'drift_threshold': 0.1605}]}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = feature_registry_service.CreateFeatureMonitorRequest.meta.fields["feature_monitor"]
...
def test_create_feature_monitor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_create_feature_monitor") as post, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_create_feature_monitor_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "pre_create_feature_monitor") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.CreateFeatureMonitorRequest.pb(feature_registry_service.CreateFeatureMonitorRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_feature_monitor(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_feature_monitor_rest_bad_request(request_type=feature_registry_service.GetFeatureMonitorRequest):
    client = FeatureRegistryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/featureGroups/sample3/featureMonitors/sample4'}
    request = request_type(**request_init)
...
def test_get_feature_monitor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_get_feature_monitor") as post, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_get_feature_monitor_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "pre_get_feature_monitor") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.GetFeatureMonitorRequest.pb(feature_registry_service.GetFeatureMonitorRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = feature_monitor.FeatureMonitor.to_json(feature_monitor.FeatureMonitor())
        req.return_value.content = return_value
        ...
        client.get_feature_monitor(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_feature_monitors_rest_bad_request(request_type=feature_registry_service.ListFeatureMonitorsRequest):
    client = FeatureRegistryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_feature_monitors_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_list_feature_monitors") as post, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_list_feature_monitors_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "pre_list_feature_monitors") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.ListFeatureMonitorsRequest.pb(feature_registry_service.ListFeatureMonitorsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = feature_registry_service.ListFeatureMonitorsResponse.to_json(feature_registry_service.ListFeatureMonitorsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = feature_registry_service.ListFeatureMonitorsResponse(), metadata

        client.list_feature_monitors(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_feature_monitor_rest_bad_request(request_type=feature_registry_service.UpdateFeatureMonitorRequest):
    client = FeatureRegistryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'feature_monitor': {'name': 'projects/sample1/locations/sample2/featureGroups/sample3/featureMonitors/sample4'}}
    request = request_type(**request_init)
...
def test_update_feature_monitor_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'feature_monitor': {'name': 'projects/sample1/locations/sample2/featureGroups/sample3/featureMonitors/sample4'}}
    request_init["feature_monitor"] = {'name': 'projects/sample1/locations/sample2/featureGroups/sample3/featureMonitors/sample4', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'etag': 'etag_value', 'labels': {}, 'description': 'description_value', 'schedule_config': {'cron': 'cron_value'}, 'feature_selection_config': {'feature_configs': [{'feature_id': 'feature_id_value', 'drift_threshold': 0.1605}]}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = feature_registry_service.UpdateFeatureMonitorRequest.meta.fields["feature_monitor"]
...
def test_update_feature_monitor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_update_feature_monitor") as post, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_update_feature_monitor_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "pre_update_feature_monitor") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.UpdateFeatureMonitorRequest.pb(feature_registry_service.UpdateFeatureMonitorRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_feature_monitor(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_feature_monitor_rest_bad_request(request_type=feature_registry_service.DeleteFeatureMonitorRequest):
    client = FeatureRegistryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_feature_monitor_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_delete_feature_monitor") as post, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_delete_feature_monitor_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "pre_delete_feature_monitor") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.DeleteFeatureMonitorRequest.pb(feature_registry_service.DeleteFeatureMonitorRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_feature_monitor(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_feature_monitor_job_rest_bad_request(request_type=feature_registry_service.CreateFeatureMonitorJobRequest):
    client = FeatureRegistryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/featureGroups/sample3/featureMonitors/sample4'}
    request = request_type(**request_init)
...
def test_create_feature_monitor_job_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/featureGroups/sample3/featureMonitors/sample4'}
    request_init["feature_monitor_job"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'final_status': {'code': 411, 'message': 'message_value', 'details': [{'type_url': 'type.googleapis.com/google.protobuf.Duration', 'value': b'\x08\x0c\x10\xdb\x07'}]}, 'job_summary': {'total_slot_ms': 1412, 'feature_stats_and_anomalies': [{'feature_id': 'feature_id_value', 'feature_stats': {'null_value': 0, 'number_value': 0.1285, 'string_value': 'string_value_value', 'bool_value': True, 'struct_value': {'fields': {}}, 'list_value': {'values': {}}}, 'distribution_deviation': 0.23700000000000002, 'drift_detection_threshold': 0.2659, 'drift_detected': True, 'stats_time': {}, 'feature_monitor_job_id': 2329, 'feature_monitor_id': 'feature_monitor_id_value'}]}, 'labels': {}, 'description': 'description_value', 'drift_base_feature_monitor_job_id': 3467, 'drift_base_snapshot_time': {}, 'feature_selection_config': {'feature_configs': [{'feature_id': 'feature_id_value', 'drift_threshold': 0.1605}]}, 'trigger_type': 1}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = feature_registry_service.CreateFeatureMonitorJobRequest.meta.fields["feature_monitor_job"]
...
def test_create_feature_monitor_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_create_feature_monitor_job") as post, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_create_feature_monitor_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "pre_create_feature_monitor_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.CreateFeatureMonitorJobRequest.pb(feature_registry_service.CreateFeatureMonitorJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gca_feature_monitor_job.FeatureMonitorJob.to_json(gca_feature_monitor_job.FeatureMonitorJob())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = gca_feature_monitor_job.FeatureMonitorJob(), metadata

        client.create_feature_monitor_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_feature_monitor_job_rest_bad_request(request_type=feature_registry_service.GetFeatureMonitorJobRequest):
    client = FeatureRegistryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/featureGroups/sample3/featureMonitors/sample4/featureMonitorJobs/sample5'}
    request = request_type(**request_init)
...
def test_get_feature_monitor_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_get_feature_monitor_job") as post, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_get_feature_monitor_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "pre_get_feature_monitor_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.GetFeatureMonitorJobRequest.pb(feature_registry_service.GetFeatureMonitorJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = feature_monitor_job.FeatureMonitorJob.to_json(feature_monitor_job.FeatureMonitorJob())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = feature_monitor_job.FeatureMonitorJob(), metadata

        client.get_feature_monitor_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_feature_monitor_jobs_rest_bad_request(request_type=feature_registry_service.ListFeatureMonitorJobsRequest):
    client = FeatureRegistryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_feature_monitor_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_list_feature_monitor_jobs") as post, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "post_list_feature_monitor_jobs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeatureRegistryServiceRestInterceptor, "pre_list_feature_monitor_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.ListFeatureMonitorJobsRequest.pb(feature_registry_service.ListFeatureMonitorJobsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = feature_registry_service.ListFeatureMonitorJobsResponse.to_json(feature_registry_service.ListFeatureMonitorJobsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = feature_registry_service.ListFeatureMonitorJobsResponse(), metadata

        client.list_feature_monitor_jobs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_create_feature_monitor_rest_asyncio_bad_request(request_type=feature_registry_service.CreateFeatureMonitorRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_feature_monitor_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_create_feature_monitor") as post, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_create_feature_monitor_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "pre_create_feature_monitor") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.CreateFeatureMonitorRequest.pb(feature_registry_service.CreateFeatureMonitorRequest())
        ...
        await client.create_feature_monitor(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_feature_monitor_rest_asyncio_bad_request(request_type=feature_registry_service.GetFeatureMonitorRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_feature_monitor_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_get_feature_monitor") as post, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_get_feature_monitor_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "pre_get_feature_monitor") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.GetFeatureMonitorRequest.pb(feature_registry_service.GetFeatureMonitorRequest())
        ...
        await client.get_feature_monitor(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_feature_monitors_rest_asyncio_bad_request(request_type=feature_registry_service.ListFeatureMonitorsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_feature_monitors_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_list_feature_monitors") as post, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_list_feature_monitors_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "pre_list_feature_monitors") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.ListFeatureMonitorsRequest.pb(feature_registry_service.ListFeatureMonitorsRequest())
        ...
        await client.list_feature_monitors(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_update_feature_monitor_rest_asyncio_bad_request(request_type=feature_registry_service.UpdateFeatureMonitorRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_update_feature_monitor_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_update_feature_monitor") as post, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_update_feature_monitor_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "pre_update_feature_monitor") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.UpdateFeatureMonitorRequest.pb(feature_registry_service.UpdateFeatureMonitorRequest())
        ...
        await client.update_feature_monitor(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_feature_monitor_rest_asyncio_bad_request(request_type=feature_registry_service.DeleteFeatureMonitorRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_feature_monitor_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_delete_feature_monitor") as post, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_delete_feature_monitor_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "pre_delete_feature_monitor") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.DeleteFeatureMonitorRequest.pb(feature_registry_service.DeleteFeatureMonitorRequest())
        ...
        await client.delete_feature_monitor(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_create_feature_monitor_job_rest_asyncio_bad_request(request_type=feature_registry_service.CreateFeatureMonitorJobRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_feature_monitor_job_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_create_feature_monitor_job") as post, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_create_feature_monitor_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "pre_create_feature_monitor_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.CreateFeatureMonitorJobRequest.pb(feature_registry_service.CreateFeatureMonitorJobRequest())
        ...
        await client.create_feature_monitor_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_feature_monitor_job_rest_asyncio_bad_request(request_type=feature_registry_service.GetFeatureMonitorJobRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_feature_monitor_job_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_get_feature_monitor_job") as post, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_get_feature_monitor_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "pre_get_feature_monitor_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.GetFeatureMonitorJobRequest.pb(feature_registry_service.GetFeatureMonitorJobRequest())
        ...
        await client.get_feature_monitor_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_feature_monitor_jobs_rest_asyncio_bad_request(request_type=feature_registry_service.ListFeatureMonitorJobsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeatureRegistryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_feature_monitor_jobs_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_list_feature_monitor_jobs") as post, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "post_list_feature_monitor_jobs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeatureRegistryServiceRestInterceptor, "pre_list_feature_monitor_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_registry_service.ListFeatureMonitorJobsRequest.pb(feature_registry_service.ListFeatureMonitorJobsRequest())
        ...
        await client.list_feature_monitor_jobs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_feature_registry_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1beta1.services.feature_registry_service.transports.FeatureRegistryServiceTransport.__init__') as Transport:
...
def test_feature_registry_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1beta1.services.feature_registry_service.transports.FeatureRegistryServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_feature_registry_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1beta1.services.feature_registry_service.transports.FeatureRegistryServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.FeatureRegistryServiceTransport()
        adc.assert_called_once()
...
def test_feature_monitor_path():
    ...
    expected = "projects/{project}/locations/{location}/featureGroups/{feature_group}/featureMonitors/{feature_monitor}".format(project=project, location=location, feature_group=feature_group, feature_monitor=feature_monitor, )
    actual = FeatureRegistryServiceClient.feature_monitor_path(project, location, feature_group, feature_monitor)
    assert expected == actual
...
def test_feature_monitor_job_path():
    ...
    expected = "projects/{project}/locations/{location}/featureGroups/{feature_group}/featureMonitors/{feature_monitor}/featureMonitorJobs/{feature_monitor_job}".format(project=project, location=location, feature_group=feature_group, feature_monitor=feature_monitor, feature_monitor_job=feature_monitor_job, )
    actual = FeatureRegistryServiceClient.feature_monitor_job_path(project, location, feature_group, feature_monitor, feature_monitor_job)
    assert expected == actual
