...
def test_create_feature_group_rest_required_fields(request_type=feature_registry_service.CreateFeatureGroupRequest):
    ...
    default_values = getattr(
        transport_class._BaseCreateFeatureGroup,
    ...
    assert not set(unset_fields) - set(("featureGroupId", ))
...
def test_get_feature_group_rest_required_fields(request_type=feature_registry_service.GetFeatureGroupRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetFeatureGroup,
...
def test_list_feature_groups_rest_required_fields(request_type=feature_registry_service.ListFeatureGroupsRequest):
    ...
    default_values = getattr(
        transport_class._BaseListFeatureGroups,
...
def test_update_feature_group_rest_required_fields(request_type=feature_registry_service.UpdateFeatureGroupRequest):
    ...
    default_values = getattr(
        transport_class._BaseUpdateFeatureGroup,
...
def test_delete_feature_group_rest_required_fields(request_type=feature_registry_service.DeleteFeatureGroupRequest):
    ...
    default_values = getattr(
        transport_class._BaseDeleteFeatureGroup,
...
def test_create_feature_monitor_rest_required_fields(request_type=feature_registry_service.CreateFeatureMonitorRequest):
    ...
    default_values = getattr(
        transport_class._BaseCreateFeatureMonitor,
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("featureMonitorId", ))
...
def test_get_feature_monitor_rest_required_fields(request_type=feature_registry_service.GetFeatureMonitorRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetFeatureMonitor,
...
def test_list_feature_monitors_rest_required_fields(request_type=feature_registry_service.ListFeatureMonitorsRequest):
    ...
    default_values = getattr(
        transport_class._BaseListFeatureMonitors,
...
def test_update_feature_monitor_rest_required_fields(request_type=feature_registry_service.UpdateFeatureMonitorRequest):
    ...
    default_values = getattr(
        transport_class._BaseUpdateFeatureMonitor,
...
def test_delete_feature_monitor_rest_required_fields(request_type=feature_registry_service.DeleteFeatureMonitorRequest):
    ...
    default_values = getattr(
        transport_class._BaseDeleteFeatureMonitor,
...
def test_create_feature_monitor_job_rest_required_fields(request_type=feature_registry_service.CreateFeatureMonitorJobRequest):
    ...
    default_values = getattr(
        transport_class._BaseCreateFeatureMonitorJob,
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("featureMonitorJobId", ))
...
def test_get_feature_monitor_job_rest_required_fields(request_type=feature_registry_service.GetFeatureMonitorJobRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetFeatureMonitorJob,
...
def test_list_feature_monitor_jobs_rest_required_fields(request_type=feature_registry_service.ListFeatureMonitorJobsRequest):
    ...
    default_values = getattr(
        transport_class._BaseListFeatureMonitorJobs,
