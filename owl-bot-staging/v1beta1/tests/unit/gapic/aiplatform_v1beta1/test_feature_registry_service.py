...
def test_update_feature_group_rest(request_type):
    ...
    request_init["feature_group"] = {'big_query': {'big_query_source': {'input_uri': 'input_uri_value'}, 'entity_id_columns': ['entity_id_columns_value1', 'entity_id_columns_value2'], 'time_series': {'timestamp_column': 'timestamp_column_value'}}, 'name': 'projects/sample1/locations/sample2/featureGroups/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'etag': 'etag_value', 'labels': {}, 'description': 'description_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
