...
@pytest.mark.asyncio
async def test_create_memory_async(transport: str = 'grpc_asyncio', request_type=memory_bank_service.CreateMemoryRequest):
    client = MemoryBankServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_memory_async(transport: str = 'grpc_asyncio', request_type=memory_bank_service.GetMemoryRequest):
    client = MemoryBankServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_memory_async(transport: str = 'grpc_asyncio', request_type=memory_bank_service.UpdateMemoryRequest):
    client = MemoryBankServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_memories_async(transport: str = 'grpc_asyncio', request_type=memory_bank_service.ListMemoriesRequest):
    client = MemoryBankServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_memory_async(transport: str = 'grpc_asyncio', request_type=memory_bank_service.DeleteMemoryRequest):
    client = MemoryBankServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_generate_memories_async(transport: str = 'grpc_asyncio', request_type=memory_bank_service.GenerateMemoriesRequest):
    client = MemoryBankServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_retrieve_memories_async(transport: str = 'grpc_asyncio', request_type=memory_bank_service.RetrieveMemoriesRequest):
    client = MemoryBankServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_memory_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "memory", )))
...
def test_create_memory_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/reasoningEngines/sample3'}
    request_init["memory"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'fact': 'fact_value', 'scope': {}}
...
def test_update_memory_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'memory': {'name': 'projects/sample1/locations/sample2/reasoningEngines/sample3/memories/sample4'}}
    request_init["memory"] = {'name': 'projects/sample1/locations/sample2/reasoningEngines/sample3/memories/sample4', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'fact': 'fact_value', 'scope': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
