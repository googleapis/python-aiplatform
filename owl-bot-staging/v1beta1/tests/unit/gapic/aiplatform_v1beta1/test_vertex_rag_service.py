...
def test_retrieve_contexts_empty_call():
...
@pytest.mark.asyncio
async def test_retrieve_contexts_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
...
async def test_retrieve_contexts_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.retrieve_contexts] = mock_object
...
def test_retrieve_contexts_rest(request_type):
    client = VertexRagServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_retrieve_contexts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = vertex_rag_service.RetrieveContextsResponse.to_json(vertex_rag_service.RetrieveContextsResponse())
...
def test_retrieve_contexts_rest_bad_request(transport: str = 'rest', request_type=vertex_rag_service.RetrieveContextsRequest):
    client = VertexRagServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transport_kind(transport_name):
    transport = VertexRagServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
