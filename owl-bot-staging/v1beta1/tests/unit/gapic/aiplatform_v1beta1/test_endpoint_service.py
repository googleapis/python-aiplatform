...
def test_set_publisher_model_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.set_publisher_model_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_set_publisher_model_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.set_publisher_model_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.set_publisher_model_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_set_publisher_model_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EndpointServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.set_publisher_model_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.set_publisher_model_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_set_publisher_model_config_async(transport: str = 'grpc_asyncio', request_type=endpoint_service.SetPublisherModelConfigRequest):
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_set_publisher_model_config_flattened():
    ...
    with mock.patch.object(
        ...
        client.set_publisher_model_config(
            name='name_value',
            publisher_model_config=endpoint.PublisherModelConfig(logging_config=endpoint.PredictRequestResponseLoggingConfig(enabled=True)),
        )
        ...
        mock_val = endpoint.PublisherModelConfig(logging_config=endpoint.PredictRequestResponseLoggingConfig(enabled=True))
        assert arg == mock_val
...
def test_fetch_publisher_model_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_publisher_model_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_fetch_publisher_model_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.fetch_publisher_model_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.fetch_publisher_model_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_fetch_publisher_model_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EndpointServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.fetch_publisher_model_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.fetch_publisher_model_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_fetch_publisher_model_config_async(transport: str = 'grpc_asyncio', request_type=endpoint_service.FetchPublisherModelConfigRequest):
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/endpoints" % client.transport._host, args[1])
...
def test_get_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/endpoints/*}" % client.transport._host, args[1])
...
def test_update_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{endpoint.name=projects/*/locations/*/endpoints/*}" % client.transport._host, args[1])
...
def test_update_endpoint_long_running_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{endpoint.name=projects/*/locations/*/endpoints/*}:update" % client.transport._host, args[1])
...
def test_deploy_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{endpoint=projects/*/locations/*/endpoints/*}:deployModel" % client.transport._host, args[1])
...
def test_undeploy_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{endpoint=projects/*/locations/*/endpoints/*}:undeployModel" % client.transport._host, args[1])
...
def test_mutate_deployed_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{endpoint=projects/*/locations/*/endpoints/*}:mutateDeployedModel" % client.transport._host, args[1])
...
def test_set_publisher_model_config_rest_required_fields(request_type=endpoint_service.SetPublisherModelConfigRequest):
    transport_class = transports.EndpointServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).set_publisher_model_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_set_publisher_model_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "publisherModelConfig", )))
...
def test_set_publisher_model_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/publishers/sample3/models/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/publishers/*/models/*}:setPublisherModelConfig" % client.transport._host, args[1])
...
def test_fetch_publisher_model_config_rest_required_fields(request_type=endpoint_service.FetchPublisherModelConfigRequest):
    transport_class = transports.EndpointServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).fetch_publisher_model_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_fetch_publisher_model_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/publishers/*/models/*}:fetchPublisherModelConfig" % client.transport._host, args[1])
...
def test_set_publisher_model_config_rest_bad_request(request_type=endpoint_service.SetPublisherModelConfigRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/publishers/sample3/models/sample4'}
    request = request_type(**request_init)
...
def test_set_publisher_model_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_set_publisher_model_config") as post, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_set_publisher_model_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "pre_set_publisher_model_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.SetPublisherModelConfigRequest.pb(endpoint_service.SetPublisherModelConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.set_publisher_model_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_fetch_publisher_model_config_rest_bad_request(request_type=endpoint_service.FetchPublisherModelConfigRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_fetch_publisher_model_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_fetch_publisher_model_config") as post, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_fetch_publisher_model_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "pre_fetch_publisher_model_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.FetchPublisherModelConfigRequest.pb(endpoint_service.FetchPublisherModelConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = endpoint.PublisherModelConfig.to_json(endpoint.PublisherModelConfig())
        req.return_value.content = return_value
        ...
        client.fetch_publisher_model_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_set_publisher_model_config_rest_asyncio_bad_request(request_type=endpoint_service.SetPublisherModelConfigRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_set_publisher_model_config_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_set_publisher_model_config") as post, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_set_publisher_model_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "pre_set_publisher_model_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.SetPublisherModelConfigRequest.pb(endpoint_service.SetPublisherModelConfigRequest())
        ...
        await client.set_publisher_model_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_fetch_publisher_model_config_rest_asyncio_bad_request(request_type=endpoint_service.FetchPublisherModelConfigRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_fetch_publisher_model_config_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_fetch_publisher_model_config") as post, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_fetch_publisher_model_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "pre_fetch_publisher_model_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.FetchPublisherModelConfigRequest.pb(endpoint_service.FetchPublisherModelConfigRequest())
        ...
        await client.fetch_publisher_model_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
