...
async def test_set_publisher_model_config_async(request_type, transport: str = 'grpc_asyncio'):
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_fetch_publisher_model_config_async(request_type, transport: str = 'grpc_asyncio'):
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
