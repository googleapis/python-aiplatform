...
def test_gen_ai_cache_service_client_get_transport_class():
    transport = GenAiCacheServiceClient.get_transport_class()
...
async def test_create_cached_content_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.create_cached_content] = mock_object
...
@pytest.mark.asyncio
async def test_create_cached_content_async(transport: str = 'grpc_asyncio', request_type=gen_ai_cache_service.CreateCachedContentRequest):
    client = GenAiCacheServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_create_cached_content_field_headers_async():
    client = GenAiCacheServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_cached_content] = mock_object
...
@pytest.mark.asyncio
async def test_get_cached_content_async(transport: str = 'grpc_asyncio', request_type=gen_ai_cache_service.GetCachedContentRequest):
    client = GenAiCacheServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_cached_content] = mock_object
...
@pytest.mark.asyncio
async def test_update_cached_content_async(transport: str = 'grpc_asyncio', request_type=gen_ai_cache_service.UpdateCachedContentRequest):
    client = GenAiCacheServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_cached_content] = mock_object
...
@pytest.mark.asyncio
async def test_delete_cached_content_async(transport: str = 'grpc_asyncio', request_type=gen_ai_cache_service.DeleteCachedContentRequest):
    client = GenAiCacheServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.list_cached_contents] = mock_object
...
@pytest.mark.asyncio
async def test_list_cached_contents_async(transport: str = 'grpc_asyncio', request_type=gen_ai_cache_service.ListCachedContentsRequest):
    client = GenAiCacheServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_cached_contents_field_headers_async():
    client = GenAiCacheServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_list_cached_contents_flattened_error():
    client = GenAiCacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_create_cached_content_rest(request_type):
    ...
    request_init["cached_content"] = {'expire_time': {'seconds': 751, 'nanos': 543}, 'ttl': {'seconds': 751, 'nanos': 543}, 'name': 'name_value', 'model': 'model_value', 'system_instruction': {'role': 'role_value', 'parts': [{'text': 'text_value', 'inline_data': {'mime_type': 'mime_type_value', 'data': b'data_blob'}, 'file_data': {'mime_type': 'mime_type_value', 'file_uri': 'file_uri_value'}, 'function_call': {'name': 'name_value', 'args': {'fields': {}}}, 'function_response': {'name': 'name_value', 'response': {}}, 'video_metadata': {'start_offset': {}, 'end_offset': {}}}]}, 'contents': {}, 'tools': [{'function_declarations': [{'name': 'name_value', 'description': 'description_value', 'parameters': {'type_': 1, 'format_': 'format__value', 'title': 'title_value', 'description': 'description_value', 'nullable': True, 'default': {'null_value': 0, 'number_value': 0.1285, 'string_value': 'string_value_value', 'bool_value': True, 'struct_value': {}, 'list_value': {'values': {}}}, 'items': {}, 'min_items': 965, 'max_items': 967, 'enum': ['enum_value1', 'enum_value2'], 'properties': {}, 'required': ['required_value1', 'required_value2'], 'min_properties': 1520, 'max_properties': 1522, 'minimum': 0.764, 'maximum': 0.766, 'min_length': 1061, 'max_length': 1063, 'pattern': 'pattern_value', 'example': {}}, 'response': {}}], 'retrieval': {'vertex_ai_search': {'datastore': 'datastore_value'}, 'vertex_rag_store': {'rag_corpora': ['rag_corpora_value1', 'rag_corpora_value2'], 'rag_resources': [{'rag_corpus': 'rag_corpus_value', 'rag_file_ids': ['rag_file_ids_value1', 'rag_file_ids_value2']}], 'similarity_top_k': 1731, 'vector_distance_threshold': 0.2665}, 'disable_attribution': True}, 'google_search_retrieval': {'disable_attribution': True}}], 'tool_config': {'function_calling_config': {'mode': 1, 'allowed_function_names': ['allowed_function_names_value1', 'allowed_function_names_value2']}}, 'create_time': {}, 'update_time': {}}
...
def test_create_cached_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = gca_cached_content.CachedContent.to_json(gca_cached_content.CachedContent())
...
def test_create_cached_content_rest_bad_request(transport: str = 'rest', request_type=gen_ai_cache_service.CreateCachedContentRequest):
    client = GenAiCacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_cached_content_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cached_content.CachedContent.to_json(cached_content.CachedContent())
...
def test_get_cached_content_rest_bad_request(transport: str = 'rest', request_type=gen_ai_cache_service.GetCachedContentRequest):
    client = GenAiCacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_cached_content_rest_bad_request(transport: str = 'rest', request_type=gen_ai_cache_service.UpdateCachedContentRequest):
    client = GenAiCacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_cached_content_rest_bad_request(transport: str = 'rest', request_type=gen_ai_cache_service.DeleteCachedContentRequest):
    client = GenAiCacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_cached_contents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gen_ai_cache_service.ListCachedContentsResponse.to_json(gen_ai_cache_service.ListCachedContentsResponse())
...
def test_list_cached_contents_rest_bad_request(transport: str = 'rest', request_type=gen_ai_cache_service.ListCachedContentsRequest):
    client = GenAiCacheServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transport_kind(transport_name):
    transport = GenAiCacheServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_gen_ai_cache_service_client_transport_session_collision(transport_name):
    ...
    client1 = GenAiCacheServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = GenAiCacheServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_parse_cached_content_path():
    ...
    path = GenAiCacheServiceClient.cached_content_path(**expected)
...
def test_parse_rag_corpus_path():
    ...
    path = GenAiCacheServiceClient.rag_corpus_path(**expected)
...
def test_parse_common_billing_account_path():
    ...
    path = GenAiCacheServiceClient.common_billing_account_path(**expected)
...
def test_parse_common_folder_path():
    ...
    path = GenAiCacheServiceClient.common_folder_path(**expected)
...
def test_parse_common_organization_path():
    ...
    path = GenAiCacheServiceClient.common_organization_path(**expected)
...
def test_parse_common_project_path():
    ...
    path = GenAiCacheServiceClient.common_project_path(**expected)
...
def test_parse_common_location_path():
    ...
    path = GenAiCacheServiceClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = GenAiCacheServiceClient.parse_common_location_path(path)
    assert expected == actual
