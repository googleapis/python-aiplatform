...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (TensorboardServiceClient, transports.TensorboardServiceRestTransport, "rest", "true"),
    (TensorboardServiceClient, transports.TensorboardServiceRestTransport, "rest", "false"),
])
@mock.patch.object(TensorboardServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TensorboardServiceClient))
@mock.patch.object(TensorboardServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(TensorboardServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (TensorboardServiceClient, transports.TensorboardServiceRestTransport, "rest", None),
])
...
def test_create_tensorboard_rest(request_type):
    ...
    request_init["tensorboard"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}, 'blob_storage_path_prefix': 'blob_storage_path_prefix_value', 'run_count': 989, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'etag': 'etag_value', 'is_default': True}
...
def test_create_tensorboard_rest_required_fields(request_type=tensorboard_service.CreateTensorboardRequest):
...
def test_create_tensorboard_rest_interceptors(null_interceptor):
    transport = transports.TensorboardServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.TensorboardServiceRestInterceptor(),
        )
    client = TensorboardServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_create_tensorboard") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_create_tensorboard") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.CreateTensorboardRequest.pb(tensorboard_service.CreateTensorboardRequest())
        ...
        client.create_tensorboard(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_tensorboard_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.CreateTensorboardRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_tensorboard_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/tensorboards" % client.transport._host, args[1])
...
def test_get_tensorboard_rest_required_fields(request_type=tensorboard_service.GetTensorboardRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_get_tensorboard_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_get_tensorboard") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_get_tensorboard") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.GetTensorboardRequest.pb(tensorboard_service.GetTensorboardRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard.Tensorboard.to_json(tensorboard.Tensorboard())
        ...
        client.get_tensorboard(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_tensorboard_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.GetTensorboardRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_tensorboard_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/tensorboards/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/tensorboards/*}" % client.transport._host, args[1])
...
def test_update_tensorboard_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'tensorboard': {'name': 'projects/sample1/locations/sample2/tensorboards/sample3'}}
    request_init["tensorboard"] = {'name': 'projects/sample1/locations/sample2/tensorboards/sample3', 'display_name': 'display_name_value', 'description': 'description_value', 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}, 'blob_storage_path_prefix': 'blob_storage_path_prefix_value', 'run_count': 989, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'etag': 'etag_value', 'is_default': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_tensorboard_rest_required_fields(request_type=tensorboard_service.UpdateTensorboardRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_update_tensorboard_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_update_tensorboard") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_update_tensorboard") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.UpdateTensorboardRequest.pb(tensorboard_service.UpdateTensorboardRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_tensorboard(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_tensorboard_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.UpdateTensorboardRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_tensorboard_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'tensorboard': {'name': 'projects/sample1/locations/sample2/tensorboards/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{tensorboard.name=projects/*/locations/*/tensorboards/*}" % client.transport._host, args[1])
...
def test_list_tensorboards_rest_required_fields(request_type=tensorboard_service.ListTensorboardsRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_list_tensorboards_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_list_tensorboards") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_list_tensorboards") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.ListTensorboardsRequest.pb(tensorboard_service.ListTensorboardsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_service.ListTensorboardsResponse.to_json(tensorboard_service.ListTensorboardsResponse())
        ...
        client.list_tensorboards(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_tensorboards_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.ListTensorboardsRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_tensorboards_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(tensorboard_service.ListTensorboardsResponse.to_json(x) for x in response)
...
def test_delete_tensorboard_rest_required_fields(request_type=tensorboard_service.DeleteTensorboardRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_delete_tensorboard_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_delete_tensorboard") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_delete_tensorboard") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.DeleteTensorboardRequest.pb(tensorboard_service.DeleteTensorboardRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_tensorboard(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_tensorboard_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.DeleteTensorboardRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_tensorboard_usage_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'tensorboard': 'projects/sample1/locations/sample2/tensorboards/sample3'}
    request = request_type(**request_init)
...
def test_read_tensorboard_usage_rest_required_fields(request_type=tensorboard_service.ReadTensorboardUsageRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_read_tensorboard_usage_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_read_tensorboard_usage") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_read_tensorboard_usage") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.ReadTensorboardUsageRequest.pb(tensorboard_service.ReadTensorboardUsageRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_service.ReadTensorboardUsageResponse.to_json(tensorboard_service.ReadTensorboardUsageResponse())
        ...
        client.read_tensorboard_usage(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_read_tensorboard_usage_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.ReadTensorboardUsageRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_tensorboard_usage_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'tensorboard': 'projects/sample1/locations/sample2/tensorboards/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{tensorboard=projects/*/locations/*/tensorboards/*}:readUsage" % client.transport._host, args[1])
...
def test_read_tensorboard_size_rest_required_fields(request_type=tensorboard_service.ReadTensorboardSizeRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_read_tensorboard_size_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_read_tensorboard_size") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_read_tensorboard_size") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.ReadTensorboardSizeRequest.pb(tensorboard_service.ReadTensorboardSizeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_service.ReadTensorboardSizeResponse.to_json(tensorboard_service.ReadTensorboardSizeResponse())
        ...
        client.read_tensorboard_size(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_read_tensorboard_size_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.ReadTensorboardSizeRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_tensorboard_size_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{tensorboard=projects/*/locations/*/tensorboards/*}:readSize" % client.transport._host, args[1])
...
def test_create_tensorboard_experiment_rest(request_type):
    ...
    request_init["tensorboard_experiment"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'etag': 'etag_value', 'source': 'source_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = tensorboard_service.CreateTensorboardExperimentRequest.meta.fields["tensorboard_experiment"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["tensorboard_experiment"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_create_tensorboard_experiment_rest_required_fields(request_type=tensorboard_service.CreateTensorboardExperimentRequest):
    transport_class = transports.TensorboardServiceRestTransport
    ...
    assert jsonified_request["tensorboardExperimentId"] == request_init["tensorboard_experiment_id"]
    ...
    assert jsonified_request["parent"] == 'parent_value'
    assert "tensorboardExperimentId" in jsonified_request
    assert jsonified_request["tensorboardExperimentId"] == 'tensorboard_experiment_id_value'
...
def test_create_tensorboard_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_create_tensorboard_experiment") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_create_tensorboard_experiment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.CreateTensorboardExperimentRequest.pb(tensorboard_service.CreateTensorboardExperimentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_tensorboard_experiment.TensorboardExperiment.to_json(gca_tensorboard_experiment.TensorboardExperiment())
        ...
        client.create_tensorboard_experiment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_tensorboard_experiment_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.CreateTensorboardExperimentRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_tensorboard_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/tensorboards/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/tensorboards/*}/experiments" % client.transport._host, args[1])
...
def test_get_tensorboard_experiment_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4'}
    request = request_type(**request_init)
...
def test_get_tensorboard_experiment_rest_required_fields(request_type=tensorboard_service.GetTensorboardExperimentRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_get_tensorboard_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_get_tensorboard_experiment") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_get_tensorboard_experiment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.GetTensorboardExperimentRequest.pb(tensorboard_service.GetTensorboardExperimentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_experiment.TensorboardExperiment.to_json(tensorboard_experiment.TensorboardExperiment())
        ...
        client.get_tensorboard_experiment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_tensorboard_experiment_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.GetTensorboardExperimentRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_tensorboard_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/tensorboards/*/experiments/*}" % client.transport._host, args[1])
...
def test_update_tensorboard_experiment_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'tensorboard_experiment': {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4'}}
    request_init["tensorboard_experiment"] = {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'etag': 'etag_value', 'source': 'source_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = tensorboard_service.UpdateTensorboardExperimentRequest.meta.fields["tensorboard_experiment"]
...
def test_update_tensorboard_experiment_rest_required_fields(request_type=tensorboard_service.UpdateTensorboardExperimentRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_update_tensorboard_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_update_tensorboard_experiment") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_update_tensorboard_experiment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.UpdateTensorboardExperimentRequest.pb(tensorboard_service.UpdateTensorboardExperimentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_tensorboard_experiment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_tensorboard_experiment_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.UpdateTensorboardExperimentRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_tensorboard_experiment_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'tensorboard_experiment': {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{tensorboard_experiment.name=projects/*/locations/*/tensorboards/*/experiments/*}" % client.transport._host, args[1])
...
def test_list_tensorboard_experiments_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = tensorboard_service.ListTensorboardExperimentsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_list_tensorboard_experiments_rest_required_fields(request_type=tensorboard_service.ListTensorboardExperimentsRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_list_tensorboard_experiments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_list_tensorboard_experiments") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_list_tensorboard_experiments") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.ListTensorboardExperimentsRequest.pb(tensorboard_service.ListTensorboardExperimentsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_service.ListTensorboardExperimentsResponse.to_json(tensorboard_service.ListTensorboardExperimentsResponse())
        ...
        client.list_tensorboard_experiments(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_tensorboard_experiments_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.ListTensorboardExperimentsRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_tensorboard_experiments_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(tensorboard_service.ListTensorboardExperimentsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_delete_tensorboard_experiment_rest_required_fields(request_type=tensorboard_service.DeleteTensorboardExperimentRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_delete_tensorboard_experiment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_delete_tensorboard_experiment") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_delete_tensorboard_experiment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.DeleteTensorboardExperimentRequest.pb(tensorboard_service.DeleteTensorboardExperimentRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_tensorboard_experiment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_tensorboard_experiment_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.DeleteTensorboardExperimentRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_tensorboard_run_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4'}
    request_init["tensorboard_run"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'etag': 'etag_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = tensorboard_service.CreateTensorboardRunRequest.meta.fields["tensorboard_run"]
...
def test_create_tensorboard_run_rest_required_fields(request_type=tensorboard_service.CreateTensorboardRunRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_create_tensorboard_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_create_tensorboard_run") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_create_tensorboard_run") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.CreateTensorboardRunRequest.pb(tensorboard_service.CreateTensorboardRunRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_tensorboard_run.TensorboardRun.to_json(gca_tensorboard_run.TensorboardRun())
        ...
        client.create_tensorboard_run(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_tensorboard_run_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.CreateTensorboardRunRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_tensorboard_run_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/tensorboards/*/experiments/*}/runs" % client.transport._host, args[1])
...
def test_batch_create_tensorboard_runs_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = tensorboard_service.BatchCreateTensorboardRunsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_batch_create_tensorboard_runs_rest_required_fields(request_type=tensorboard_service.BatchCreateTensorboardRunsRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_batch_create_tensorboard_runs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_batch_create_tensorboard_runs") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_batch_create_tensorboard_runs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.BatchCreateTensorboardRunsRequest.pb(tensorboard_service.BatchCreateTensorboardRunsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_service.BatchCreateTensorboardRunsResponse.to_json(tensorboard_service.BatchCreateTensorboardRunsResponse())
        ...
        client.batch_create_tensorboard_runs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_batch_create_tensorboard_runs_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.BatchCreateTensorboardRunsRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_create_tensorboard_runs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/tensorboards/*/experiments/*}/runs:batchCreate" % client.transport._host, args[1])
...
def test_get_tensorboard_run_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5'}
    request = request_type(**request_init)
...
def test_get_tensorboard_run_rest_required_fields(request_type=tensorboard_service.GetTensorboardRunRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_get_tensorboard_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_get_tensorboard_run") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_get_tensorboard_run") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.GetTensorboardRunRequest.pb(tensorboard_service.GetTensorboardRunRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_run.TensorboardRun.to_json(tensorboard_run.TensorboardRun())
        ...
        client.get_tensorboard_run(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_tensorboard_run_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.GetTensorboardRunRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_tensorboard_run_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/tensorboards/*/experiments/*/runs/*}" % client.transport._host, args[1])
...
def test_update_tensorboard_run_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'tensorboard_run': {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5'}}
    request_init["tensorboard_run"] = {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'etag': 'etag_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = tensorboard_service.UpdateTensorboardRunRequest.meta.fields["tensorboard_run"]
...
def test_update_tensorboard_run_rest_required_fields(request_type=tensorboard_service.UpdateTensorboardRunRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_update_tensorboard_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_update_tensorboard_run") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_update_tensorboard_run") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.UpdateTensorboardRunRequest.pb(tensorboard_service.UpdateTensorboardRunRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_tensorboard_run(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_tensorboard_run_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.UpdateTensorboardRunRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_tensorboard_run_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'tensorboard_run': {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{tensorboard_run.name=projects/*/locations/*/tensorboards/*/experiments/*/runs/*}" % client.transport._host, args[1])
...
def test_list_tensorboard_runs_rest_required_fields(request_type=tensorboard_service.ListTensorboardRunsRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_list_tensorboard_runs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_list_tensorboard_runs") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_list_tensorboard_runs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.ListTensorboardRunsRequest.pb(tensorboard_service.ListTensorboardRunsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_service.ListTensorboardRunsResponse.to_json(tensorboard_service.ListTensorboardRunsResponse())
        ...
        client.list_tensorboard_runs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_tensorboard_runs_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.ListTensorboardRunsRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_tensorboard_runs_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(tensorboard_service.ListTensorboardRunsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_delete_tensorboard_run_rest_required_fields(request_type=tensorboard_service.DeleteTensorboardRunRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_delete_tensorboard_run_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_delete_tensorboard_run") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_delete_tensorboard_run") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.DeleteTensorboardRunRequest.pb(tensorboard_service.DeleteTensorboardRunRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_tensorboard_run(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_tensorboard_run_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.DeleteTensorboardRunRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_create_tensorboard_time_series_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = tensorboard_service.BatchCreateTensorboardTimeSeriesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_batch_create_tensorboard_time_series_rest_required_fields(request_type=tensorboard_service.BatchCreateTensorboardTimeSeriesRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_batch_create_tensorboard_time_series_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_batch_create_tensorboard_time_series") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_batch_create_tensorboard_time_series") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.BatchCreateTensorboardTimeSeriesRequest.pb(tensorboard_service.BatchCreateTensorboardTimeSeriesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_service.BatchCreateTensorboardTimeSeriesResponse.to_json(tensorboard_service.BatchCreateTensorboardTimeSeriesResponse())
        ...
        pre.return_value = request, metadata
        post.return_value = tensorboard_service.BatchCreateTensorboardTimeSeriesResponse()

        client.batch_create_tensorboard_time_series(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_batch_create_tensorboard_time_series_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.BatchCreateTensorboardTimeSeriesRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_create_tensorboard_time_series_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/tensorboards/*/experiments/*}:batchCreate" % client.transport._host, args[1])


def test_batch_create_tensorboard_time_series_rest_flattened_error(transport: str = 'rest'):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_tensorboard_time_series_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5'}
    request_init["tensorboard_time_series"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'value_type': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'etag': 'etag_value', 'plugin_name': 'plugin_name_value', 'plugin_data': b'plugin_data_blob', 'metadata': {'max_step': 865, 'max_wall_time': {}, 'max_blob_sequence_length': 2525}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = tensorboard_service.CreateTensorboardTimeSeriesRequest.meta.fields["tensorboard_time_series"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["tensorboard_time_series"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = gca_tensorboard_time_series.TensorboardTimeSeries.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_create_tensorboard_time_series_rest_required_fields(request_type=tensorboard_service.CreateTensorboardTimeSeriesRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_create_tensorboard_time_series_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_create_tensorboard_time_series") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_create_tensorboard_time_series") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.CreateTensorboardTimeSeriesRequest.pb(tensorboard_service.CreateTensorboardTimeSeriesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_tensorboard_time_series.TensorboardTimeSeries.to_json(gca_tensorboard_time_series.TensorboardTimeSeries())
        ...
        client.create_tensorboard_time_series(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_tensorboard_time_series_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.CreateTensorboardTimeSeriesRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_tensorboard_time_series_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/tensorboards/*/experiments/*/runs/*}/timeSeries" % client.transport._host, args[1])
...
def test_get_tensorboard_time_series_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5/timeSeries/sample6'}
    request = request_type(**request_init)
...
def test_get_tensorboard_time_series_rest_required_fields(request_type=tensorboard_service.GetTensorboardTimeSeriesRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_get_tensorboard_time_series_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_get_tensorboard_time_series") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_get_tensorboard_time_series") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.GetTensorboardTimeSeriesRequest.pb(tensorboard_service.GetTensorboardTimeSeriesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_time_series.TensorboardTimeSeries.to_json(tensorboard_time_series.TensorboardTimeSeries())
        ...
        client.get_tensorboard_time_series(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_tensorboard_time_series_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.GetTensorboardTimeSeriesRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_tensorboard_time_series_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5/timeSeries/sample6'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/tensorboards/*/experiments/*/runs/*/timeSeries/*}" % client.transport._host, args[1])
...
def test_update_tensorboard_time_series_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'tensorboard_time_series': {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5/timeSeries/sample6'}}
    request_init["tensorboard_time_series"] = {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5/timeSeries/sample6', 'display_name': 'display_name_value', 'description': 'description_value', 'value_type': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'etag': 'etag_value', 'plugin_name': 'plugin_name_value', 'plugin_data': b'plugin_data_blob', 'metadata': {'max_step': 865, 'max_wall_time': {}, 'max_blob_sequence_length': 2525}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = tensorboard_service.UpdateTensorboardTimeSeriesRequest.meta.fields["tensorboard_time_series"]
...
def test_update_tensorboard_time_series_rest_required_fields(request_type=tensorboard_service.UpdateTensorboardTimeSeriesRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_update_tensorboard_time_series_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_update_tensorboard_time_series") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_update_tensorboard_time_series") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.UpdateTensorboardTimeSeriesRequest.pb(tensorboard_service.UpdateTensorboardTimeSeriesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_tensorboard_time_series(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_tensorboard_time_series_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.UpdateTensorboardTimeSeriesRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_tensorboard_time_series_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'tensorboard_time_series': {'name': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5/timeSeries/sample6'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{tensorboard_time_series.name=projects/*/locations/*/tensorboards/*/experiments/*/runs/*/timeSeries/*}" % client.transport._host, args[1])
...
def test_list_tensorboard_time_series_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = tensorboard_service.ListTensorboardTimeSeriesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_list_tensorboard_time_series_rest_required_fields(request_type=tensorboard_service.ListTensorboardTimeSeriesRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_list_tensorboard_time_series_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_list_tensorboard_time_series") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_list_tensorboard_time_series") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.ListTensorboardTimeSeriesRequest.pb(tensorboard_service.ListTensorboardTimeSeriesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_service.ListTensorboardTimeSeriesResponse.to_json(tensorboard_service.ListTensorboardTimeSeriesResponse())
        ...
        client.list_tensorboard_time_series(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_tensorboard_time_series_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.ListTensorboardTimeSeriesRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_tensorboard_time_series_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(tensorboard_service.ListTensorboardTimeSeriesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_delete_tensorboard_time_series_rest_required_fields(request_type=tensorboard_service.DeleteTensorboardTimeSeriesRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_delete_tensorboard_time_series_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_delete_tensorboard_time_series") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_delete_tensorboard_time_series") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.DeleteTensorboardTimeSeriesRequest.pb(tensorboard_service.DeleteTensorboardTimeSeriesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_tensorboard_time_series(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_tensorboard_time_series_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.DeleteTensorboardTimeSeriesRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_read_tensorboard_time_series_data_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = tensorboard_service.BatchReadTensorboardTimeSeriesDataResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_batch_read_tensorboard_time_series_data_rest_required_fields(request_type=tensorboard_service.BatchReadTensorboardTimeSeriesDataRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_batch_read_tensorboard_time_series_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_batch_read_tensorboard_time_series_data") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_batch_read_tensorboard_time_series_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.BatchReadTensorboardTimeSeriesDataRequest.pb(tensorboard_service.BatchReadTensorboardTimeSeriesDataRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_service.BatchReadTensorboardTimeSeriesDataResponse.to_json(tensorboard_service.BatchReadTensorboardTimeSeriesDataResponse())
        ...
        pre.return_value = request, metadata
        post.return_value = tensorboard_service.BatchReadTensorboardTimeSeriesDataResponse()

        client.batch_read_tensorboard_time_series_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_batch_read_tensorboard_time_series_data_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.BatchReadTensorboardTimeSeriesDataRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_read_tensorboard_time_series_data_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{tensorboard=projects/*/locations/*/tensorboards/*}:batchRead" % client.transport._host, args[1])


def test_batch_read_tensorboard_time_series_data_rest_flattened_error(transport: str = 'rest'):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_tensorboard_time_series_data_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'tensorboard_time_series': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5/timeSeries/sample6'}
    request = request_type(**request_init)
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = tensorboard_service.ReadTensorboardTimeSeriesDataResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_read_tensorboard_time_series_data_rest_required_fields(request_type=tensorboard_service.ReadTensorboardTimeSeriesDataRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_read_tensorboard_time_series_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_read_tensorboard_time_series_data") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_read_tensorboard_time_series_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.ReadTensorboardTimeSeriesDataRequest.pb(tensorboard_service.ReadTensorboardTimeSeriesDataRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_service.ReadTensorboardTimeSeriesDataResponse.to_json(tensorboard_service.ReadTensorboardTimeSeriesDataResponse())
        ...
        client.read_tensorboard_time_series_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_read_tensorboard_time_series_data_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.ReadTensorboardTimeSeriesDataRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_tensorboard_time_series_data_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{tensorboard_time_series=projects/*/locations/*/tensorboards/*/experiments/*/runs/*/timeSeries/*}:read" % client.transport._host, args[1])


def test_read_tensorboard_time_series_data_rest_flattened_error(transport: str = 'rest'):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_tensorboard_blob_data_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'time_series': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5/timeSeries/sample6'}
    request = request_type(**request_init)
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = tensorboard_service.ReadTensorboardBlobDataResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_read_tensorboard_blob_data_rest_required_fields(request_type=tensorboard_service.ReadTensorboardBlobDataRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_read_tensorboard_blob_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_read_tensorboard_blob_data") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_read_tensorboard_blob_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.ReadTensorboardBlobDataRequest.pb(tensorboard_service.ReadTensorboardBlobDataRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_service.ReadTensorboardBlobDataResponse.to_json(tensorboard_service.ReadTensorboardBlobDataResponse())
        ...
        client.read_tensorboard_blob_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_read_tensorboard_blob_data_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.ReadTensorboardBlobDataRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_tensorboard_blob_data_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'time_series': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5/timeSeries/sample6'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{time_series=projects/*/locations/*/tensorboards/*/experiments/*/runs/*/timeSeries/*}:readBlobData" % client.transport._host, args[1])
...
def test_write_tensorboard_experiment_data_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'tensorboard_experiment': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4'}
    request = request_type(**request_init)
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = tensorboard_service.WriteTensorboardExperimentDataResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_write_tensorboard_experiment_data_rest_required_fields(request_type=tensorboard_service.WriteTensorboardExperimentDataRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_write_tensorboard_experiment_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_write_tensorboard_experiment_data") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_write_tensorboard_experiment_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.WriteTensorboardExperimentDataRequest.pb(tensorboard_service.WriteTensorboardExperimentDataRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_service.WriteTensorboardExperimentDataResponse.to_json(tensorboard_service.WriteTensorboardExperimentDataResponse())
        ...
        client.write_tensorboard_experiment_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_write_tensorboard_experiment_data_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.WriteTensorboardExperimentDataRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_write_tensorboard_experiment_data_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'tensorboard_experiment': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{tensorboard_experiment=projects/*/locations/*/tensorboards/*/experiments/*}:write" % client.transport._host, args[1])


def test_write_tensorboard_experiment_data_rest_flattened_error(transport: str = 'rest'):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_write_tensorboard_run_data_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'tensorboard_run': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5'}
    request = request_type(**request_init)
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = tensorboard_service.WriteTensorboardRunDataResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_write_tensorboard_run_data_rest_required_fields(request_type=tensorboard_service.WriteTensorboardRunDataRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_write_tensorboard_run_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_write_tensorboard_run_data") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_write_tensorboard_run_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.WriteTensorboardRunDataRequest.pb(tensorboard_service.WriteTensorboardRunDataRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_service.WriteTensorboardRunDataResponse.to_json(tensorboard_service.WriteTensorboardRunDataResponse())
        ...
        client.write_tensorboard_run_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_write_tensorboard_run_data_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.WriteTensorboardRunDataRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_write_tensorboard_run_data_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'tensorboard_run': 'projects/sample1/locations/sample2/tensorboards/sample3/experiments/sample4/runs/sample5'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{tensorboard_run=projects/*/locations/*/tensorboards/*/experiments/*/runs/*}:write" % client.transport._host, args[1])
...
def test_export_tensorboard_time_series_data_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = tensorboard_service.ExportTensorboardTimeSeriesDataResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_export_tensorboard_time_series_data_rest_required_fields(request_type=tensorboard_service.ExportTensorboardTimeSeriesDataRequest):
    transport_class = transports.TensorboardServiceRestTransport
...
def test_export_tensorboard_time_series_data_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "post_export_tensorboard_time_series_data") as post, \
         mock.patch.object(transports.TensorboardServiceRestInterceptor, "pre_export_tensorboard_time_series_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = tensorboard_service.ExportTensorboardTimeSeriesDataRequest.pb(tensorboard_service.ExportTensorboardTimeSeriesDataRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = tensorboard_service.ExportTensorboardTimeSeriesDataResponse.to_json(tensorboard_service.ExportTensorboardTimeSeriesDataResponse())
        ...
        pre.return_value = request, metadata
        post.return_value = tensorboard_service.ExportTensorboardTimeSeriesDataResponse()

        client.export_tensorboard_time_series_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_export_tensorboard_time_series_data_rest_bad_request(transport: str = 'rest', request_type=tensorboard_service.ExportTensorboardTimeSeriesDataRequest):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_export_tensorboard_time_series_data_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{tensorboard_time_series=projects/*/locations/*/tensorboards/*/experiments/*/runs/*/timeSeries/*}:exportTensorboardTimeSeries" % client.transport._host, args[1])


def test_export_tensorboard_time_series_data_rest_flattened_error(transport: str = 'rest'):
    client = TensorboardServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_export_tensorboard_time_series_data_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(tensorboard_service.ExportTensorboardTimeSeriesDataResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pages = list(client.export_tensorboard_time_series_data(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
