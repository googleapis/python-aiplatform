...
async def test_create_reasoning_engine_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.create_reasoning_engine] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.get_reasoning_engine] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.list_reasoning_engines] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_reasoning_engine] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_reasoning_engine] = mock_object
...
def test_create_reasoning_engine_rest_bad_request(transport: str = 'rest', request_type=reasoning_engine_service.CreateReasoningEngineRequest):
    client = ReasoningEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_reasoning_engine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = reasoning_engine.ReasoningEngine.to_json(reasoning_engine.ReasoningEngine())
...
def test_get_reasoning_engine_rest_bad_request(transport: str = 'rest', request_type=reasoning_engine_service.GetReasoningEngineRequest):
    client = ReasoningEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_reasoning_engines_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = reasoning_engine_service.ListReasoningEnginesResponse.to_json(reasoning_engine_service.ListReasoningEnginesResponse())
...
def test_list_reasoning_engines_rest_bad_request(transport: str = 'rest', request_type=reasoning_engine_service.ListReasoningEnginesRequest):
    client = ReasoningEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_reasoning_engine_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("reasoningEngine", "updateMask", )))
...
def test_update_reasoning_engine_rest_bad_request(transport: str = 'rest', request_type=reasoning_engine_service.UpdateReasoningEngineRequest):
    client = ReasoningEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_reasoning_engine_rest_bad_request(transport: str = 'rest', request_type=reasoning_engine_service.DeleteReasoningEngineRequest):
    client = ReasoningEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
