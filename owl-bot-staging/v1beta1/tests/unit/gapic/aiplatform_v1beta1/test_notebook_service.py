...
async def test_create_notebook_runtime_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.create_notebook_runtime_template] = mock_object
...
async def test_get_notebook_runtime_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_notebook_runtime_template] = mock_object
...
async def test_list_notebook_runtime_templates_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_notebook_runtime_templates] = mock_object
...
async def test_delete_notebook_runtime_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_notebook_runtime_template] = mock_object
...
async def test_update_notebook_runtime_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_notebook_runtime_template] = mock_object
...
async def test_assign_notebook_runtime_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.assign_notebook_runtime] = mock_object
...
async def test_get_notebook_runtime_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_notebook_runtime] = mock_object
...
async def test_list_notebook_runtimes_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_notebook_runtimes] = mock_object
...
async def test_delete_notebook_runtime_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_notebook_runtime] = mock_object
...
async def test_upgrade_notebook_runtime_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.upgrade_notebook_runtime] = mock_object
...
async def test_start_notebook_runtime_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.start_notebook_runtime] = mock_object
...
async def test_create_notebook_execution_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.create_notebook_execution_job] = mock_object
...
async def test_get_notebook_execution_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_notebook_execution_job] = mock_object
...
async def test_list_notebook_execution_jobs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_notebook_execution_jobs] = mock_object
...
async def test_delete_notebook_execution_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_notebook_execution_job] = mock_object
...
def test_create_notebook_runtime_template_rest_bad_request(transport: str = 'rest', request_type=notebook_service.CreateNotebookRuntimeTemplateRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_notebook_runtime_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = notebook_runtime.NotebookRuntimeTemplate.to_json(notebook_runtime.NotebookRuntimeTemplate())
...
def test_get_notebook_runtime_template_rest_bad_request(transport: str = 'rest', request_type=notebook_service.GetNotebookRuntimeTemplateRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_notebook_runtime_templates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = notebook_service.ListNotebookRuntimeTemplatesResponse.to_json(notebook_service.ListNotebookRuntimeTemplatesResponse())
...
def test_list_notebook_runtime_templates_rest_bad_request(transport: str = 'rest', request_type=notebook_service.ListNotebookRuntimeTemplatesRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_notebook_runtime_template_rest_bad_request(transport: str = 'rest', request_type=notebook_service.DeleteNotebookRuntimeTemplateRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_notebook_runtime_template_rest_bad_request(transport: str = 'rest', request_type=notebook_service.UpdateNotebookRuntimeTemplateRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_assign_notebook_runtime_rest_bad_request(transport: str = 'rest', request_type=notebook_service.AssignNotebookRuntimeRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_notebook_runtime_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = notebook_runtime.NotebookRuntime.to_json(notebook_runtime.NotebookRuntime())
...
def test_get_notebook_runtime_rest_bad_request(transport: str = 'rest', request_type=notebook_service.GetNotebookRuntimeRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_notebook_runtimes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = notebook_service.ListNotebookRuntimesResponse.to_json(notebook_service.ListNotebookRuntimesResponse())
...
def test_list_notebook_runtimes_rest_bad_request(transport: str = 'rest', request_type=notebook_service.ListNotebookRuntimesRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_notebook_runtime_rest_bad_request(transport: str = 'rest', request_type=notebook_service.DeleteNotebookRuntimeRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_upgrade_notebook_runtime_rest_bad_request(transport: str = 'rest', request_type=notebook_service.UpgradeNotebookRuntimeRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_start_notebook_runtime_rest_bad_request(transport: str = 'rest', request_type=notebook_service.StartNotebookRuntimeRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_notebook_execution_job_rest_bad_request(transport: str = 'rest', request_type=notebook_service.CreateNotebookExecutionJobRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_notebook_execution_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = notebook_execution_job.NotebookExecutionJob.to_json(notebook_execution_job.NotebookExecutionJob())
...
def test_get_notebook_execution_job_rest_bad_request(transport: str = 'rest', request_type=notebook_service.GetNotebookExecutionJobRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_notebook_execution_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = notebook_service.ListNotebookExecutionJobsResponse.to_json(notebook_service.ListNotebookExecutionJobsResponse())
...
def test_list_notebook_execution_jobs_rest_bad_request(transport: str = 'rest', request_type=notebook_service.ListNotebookExecutionJobsRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_notebook_execution_job_rest_bad_request(transport: str = 'rest', request_type=notebook_service.DeleteNotebookExecutionJobRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
