...
from google.cloud.aiplatform_v1beta1.services.notebook_service import NotebookServiceAsyncClient
from google.cloud.aiplatform_v1beta1.services.notebook_service import NotebookServiceClient
...
from google.cloud.aiplatform_v1beta1.types import notebook_execution_job as gca_notebook_execution_job
...
from google.cloud.aiplatform_v1beta1.types import notebook_runtime as gca_notebook_runtime
...
def test__get_default_mtls_endpoint():
    ...
    assert NotebookServiceClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert NotebookServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert NotebookServiceClient._use_client_cert_effective() is False
...
def test_notebook_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1beta1.services.notebook_service.transports.NotebookServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_notebook_runtime_template(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_notebook_runtime_template),
            '__call__') as call:
...
def test_create_notebook_runtime_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_notebook_runtime_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_notebook_runtime_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_notebook_runtime_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_notebook_runtime_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_notebook_runtime_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_notebook_runtime_template_async(transport: str = 'grpc_asyncio', request_type=notebook_service.CreateNotebookRuntimeTemplateRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_notebook_runtime_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_notebook_runtime_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.notebook_runtime_type == notebook_runtime.NotebookRuntimeType.USER_DEFINED
...
def test_get_notebook_runtime_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_notebook_runtime_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_notebook_runtime_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_notebook_runtime_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_notebook_runtime_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_notebook_runtime_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_notebook_runtime_template_async(transport: str = 'grpc_asyncio', request_type=notebook_service.GetNotebookRuntimeTemplateRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(notebook_runtime.NotebookRuntimeTemplate(
            name='name_value',
            display_name='display_name_value',
            description='description_value',
            is_default=True,
...
def test_list_notebook_runtime_templates_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_notebook_runtime_templates in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_notebook_runtime_templates] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_notebook_runtime_templates_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_notebook_runtime_templates in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_notebook_runtime_templates] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_notebook_runtime_templates_async(transport: str = 'grpc_asyncio', request_type=notebook_service.ListNotebookRuntimeTemplatesRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(notebook_service.ListNotebookRuntimeTemplatesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_notebook_runtime_templates_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_notebook_runtime_templates(request={}, retry=retry, timeout=timeout)
...
def test_delete_notebook_runtime_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_notebook_runtime_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_notebook_runtime_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_notebook_runtime_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_notebook_runtime_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_notebook_runtime_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_notebook_runtime_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_notebook_runtime_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_notebook_runtime_template_async(transport: str = 'grpc_asyncio', request_type=notebook_service.DeleteNotebookRuntimeTemplateRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_notebook_runtime_template(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_notebook_runtime_template),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = notebook_runtime.NotebookRuntimeTemplate(
            name='name_value',
...
def test_update_notebook_runtime_template_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_notebook_runtime_template in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_notebook_runtime_template] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_notebook_runtime_template_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_notebook_runtime_template in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_notebook_runtime_template] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_notebook_runtime_template_async(transport: str = 'grpc_asyncio', request_type=notebook_service.UpdateNotebookRuntimeTemplateRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_assign_notebook_runtime(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.assign_notebook_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_assign_notebook_runtime_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.assign_notebook_runtime in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.assign_notebook_runtime] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_assign_notebook_runtime_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.assign_notebook_runtime in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.assign_notebook_runtime] = mock_rpc
...
@pytest.mark.asyncio
async def test_assign_notebook_runtime_async(transport: str = 'grpc_asyncio', request_type=notebook_service.AssignNotebookRuntimeRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_notebook_runtime(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_notebook_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.description == 'description_value'
    assert response.service_account == 'service_account_value'
    assert response.runtime_state == notebook_runtime.NotebookRuntime.RuntimeState.RUNNING
...
def test_get_notebook_runtime_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_notebook_runtime in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_notebook_runtime] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_notebook_runtime_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_notebook_runtime in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_notebook_runtime] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_notebook_runtime_async(transport: str = 'grpc_asyncio', request_type=notebook_service.GetNotebookRuntimeRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(notebook_runtime.NotebookRuntime(
            name='name_value',
            runtime_user='runtime_user_value',
            proxy_uri='proxy_uri_value',
            health_state=notebook_runtime.NotebookRuntime.HealthState.HEALTHY,
...
def test_list_notebook_runtimes_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_notebook_runtimes in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_notebook_runtimes] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_notebook_runtimes_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_notebook_runtimes in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_notebook_runtimes] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_notebook_runtimes_async(transport: str = 'grpc_asyncio', request_type=notebook_service.ListNotebookRuntimesRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_notebook_runtime(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_notebook_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_notebook_runtime_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_notebook_runtime in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_notebook_runtime] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_notebook_runtime_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_notebook_runtime in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_notebook_runtime] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_notebook_runtime_async(transport: str = 'grpc_asyncio', request_type=notebook_service.DeleteNotebookRuntimeRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_upgrade_notebook_runtime(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.upgrade_notebook_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_upgrade_notebook_runtime_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.upgrade_notebook_runtime in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.upgrade_notebook_runtime] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_upgrade_notebook_runtime_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.upgrade_notebook_runtime in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.upgrade_notebook_runtime] = mock_rpc
...
@pytest.mark.asyncio
async def test_upgrade_notebook_runtime_async(transport: str = 'grpc_asyncio', request_type=notebook_service.UpgradeNotebookRuntimeRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_start_notebook_runtime(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.start_notebook_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_start_notebook_runtime_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.start_notebook_runtime in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.start_notebook_runtime] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_start_notebook_runtime_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.start_notebook_runtime in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.start_notebook_runtime] = mock_rpc
...
@pytest.mark.asyncio
async def test_start_notebook_runtime_async(transport: str = 'grpc_asyncio', request_type=notebook_service.StartNotebookRuntimeRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_stop_notebook_runtime(request_type, transport: str = 'grpc'):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.stop_notebook_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_stop_notebook_runtime_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.stop_notebook_runtime(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == notebook_service.StopNotebookRuntimeRequest(
            name='name_value',
        )

def test_stop_notebook_runtime_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NotebookServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.stop_notebook_runtime in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.stop_notebook_runtime] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_stop_notebook_runtime_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.stop_notebook_runtime in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.stop_notebook_runtime] = mock_rpc
...
@pytest.mark.asyncio
async def test_stop_notebook_runtime_async(transport: str = 'grpc_asyncio', request_type=notebook_service.StopNotebookRuntimeRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_stop_notebook_runtime_async_from_dict():
    await test_stop_notebook_runtime_async(request_type=dict)

def test_stop_notebook_runtime_field_headers():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_stop_notebook_runtime_field_headers_async():
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_stop_notebook_runtime_flattened():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_stop_notebook_runtime_flattened_error():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
@pytest.mark.asyncio
async def test_stop_notebook_runtime_flattened_async():
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.stop_notebook_runtime(
            name='name_value',
        )
...
@pytest.mark.asyncio
async def test_stop_notebook_runtime_flattened_error_async():
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
    )
...
def test_create_notebook_execution_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_notebook_execution_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_notebook_execution_job_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.create_notebook_execution_job in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_notebook_execution_job] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_notebook_execution_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.create_notebook_execution_job in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_notebook_execution_job] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_notebook_execution_job_async(transport: str = 'grpc_asyncio', request_type=notebook_service.CreateNotebookExecutionJobRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_notebook_execution_job_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_notebook_execution_job(
            parent='parent_value',
            notebook_execution_job=gca_notebook_execution_job.NotebookExecutionJob(dataform_repository_source=gca_notebook_execution_job.NotebookExecutionJob.DataformRepositorySource(dataform_repository_resource_name='dataform_repository_resource_name_value')),
            notebook_execution_job_id='notebook_execution_job_id_value',
        )
        ...
        mock_val = gca_notebook_execution_job.NotebookExecutionJob(dataform_repository_source=gca_notebook_execution_job.NotebookExecutionJob.DataformRepositorySource(dataform_repository_resource_name='dataform_repository_resource_name_value'))
        assert arg == mock_val
...
def test_get_notebook_execution_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_notebook_execution_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_notebook_execution_job_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_notebook_execution_job in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_notebook_execution_job] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_notebook_execution_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_notebook_execution_job in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_notebook_execution_job] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_notebook_execution_job_async(transport: str = 'grpc_asyncio', request_type=notebook_service.GetNotebookExecutionJobRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(notebook_execution_job.NotebookExecutionJob(
            name='name_value',
            display_name='display_name_value',
            schedule_resource_name='schedule_resource_name_value',
            job_state=job_state.JobState.JOB_STATE_QUEUED,
...
def test_list_notebook_execution_jobs_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_notebook_execution_jobs in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_notebook_execution_jobs] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_notebook_execution_jobs_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_notebook_execution_jobs in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_notebook_execution_jobs] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_notebook_execution_jobs_async(transport: str = 'grpc_asyncio', request_type=notebook_service.ListNotebookExecutionJobsRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(notebook_service.ListNotebookExecutionJobsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_notebook_execution_jobs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        pager = client.list_notebook_execution_jobs(request={}, retry=retry, timeout=timeout)
...
def test_delete_notebook_execution_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_notebook_execution_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_notebook_execution_job_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_notebook_execution_job in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_notebook_execution_job] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_notebook_execution_job_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = NotebookServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_notebook_execution_job in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_notebook_execution_job] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_notebook_execution_job_async(transport: str = 'grpc_asyncio', request_type=notebook_service.DeleteNotebookExecutionJobRequest):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_notebook_runtime_template_rest_required_fields(request_type=notebook_service.CreateNotebookRuntimeTemplateRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_notebook_runtime_template._get_unset_required_fields(jsonified_request)
...
def test_create_notebook_runtime_template_rest_unset_required_fields():
    ...
    unset_fields = transport.create_notebook_runtime_template._get_unset_required_fields({})
    assert set(unset_fields) == (set(("notebookRuntimeTemplateId", )) & set(("parent", "notebookRuntimeTemplate", )))
...
def test_create_notebook_runtime_template_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/notebookRuntimeTemplates" % client.transport._host, args[1])
...
def test_get_notebook_runtime_template_rest_required_fields(request_type=notebook_service.GetNotebookRuntimeTemplateRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_notebook_runtime_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_notebook_runtime_template_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/notebookRuntimeTemplates/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/notebookRuntimeTemplates/*}" % client.transport._host, args[1])
...
def test_list_notebook_runtime_templates_rest_required_fields(request_type=notebook_service.ListNotebookRuntimeTemplatesRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_notebook_runtime_templates._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = notebook_service.ListNotebookRuntimeTemplatesResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_notebook_runtime_templates_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(notebook_service.ListNotebookRuntimeTemplatesResponse.to_json(x) for x in response)
        ...
        pages = list(client.list_notebook_runtime_templates(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_delete_notebook_runtime_template_rest_required_fields(request_type=notebook_service.DeleteNotebookRuntimeTemplateRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_notebook_runtime_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_notebook_runtime_template_rest_unset_required_fields():
    ...
    unset_fields = transport.delete_notebook_runtime_template._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))
...
def test_update_notebook_runtime_template_rest_required_fields(request_type=notebook_service.UpdateNotebookRuntimeTemplateRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_notebook_runtime_template._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_notebook_runtime_template_rest_unset_required_fields():
    ...
    unset_fields = transport.update_notebook_runtime_template._get_unset_required_fields({})
    assert set(unset_fields) == (set(("updateMask", )) & set(("notebookRuntimeTemplate", "updateMask", )))
...
def test_update_notebook_runtime_template_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'notebook_runtime_template': {'name': 'projects/sample1/locations/sample2/notebookRuntimeTemplates/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{notebook_runtime_template.name=projects/*/locations/*/notebookRuntimeTemplates/*}" % client.transport._host, args[1])
...
def test_assign_notebook_runtime_rest_required_fields(request_type=notebook_service.AssignNotebookRuntimeRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).assign_notebook_runtime._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    assert jsonified_request["notebookRuntimeTemplate"] == 'notebook_runtime_template_value'
...
def test_assign_notebook_runtime_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "notebookRuntimeTemplate", "notebookRuntime", )))
...
def test_assign_notebook_runtime_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/notebookRuntimes:assign" % client.transport._host, args[1])
...
def test_get_notebook_runtime_rest_required_fields(request_type=notebook_service.GetNotebookRuntimeRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_notebook_runtime._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_notebook_runtime_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/notebookRuntimes/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/notebookRuntimes/*}" % client.transport._host, args[1])
...
def test_list_notebook_runtimes_rest_required_fields(request_type=notebook_service.ListNotebookRuntimesRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_notebook_runtimes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_notebook_runtimes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/notebookRuntimes" % client.transport._host, args[1])
...
def test_list_notebook_runtimes_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(notebook_service.ListNotebookRuntimesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_delete_notebook_runtime_rest_required_fields(request_type=notebook_service.DeleteNotebookRuntimeRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_notebook_runtime._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_upgrade_notebook_runtime_rest_required_fields(request_type=notebook_service.UpgradeNotebookRuntimeRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).upgrade_notebook_runtime._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_upgrade_notebook_runtime_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/notebookRuntimes/*}:upgrade" % client.transport._host, args[1])
...
def test_start_notebook_runtime_rest_required_fields(request_type=notebook_service.StartNotebookRuntimeRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).start_notebook_runtime._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_start_notebook_runtime_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/notebookRuntimes/*}:start" % client.transport._host, args[1])
...
def test_stop_notebook_runtime_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = NotebookServiceClient(
...
def test_stop_notebook_runtime_rest_required_fields(request_type=notebook_service.StopNotebookRuntimeRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).stop_notebook_runtime._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_stop_notebook_runtime_rest_unset_required_fields():
    transport = transports.NotebookServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.stop_notebook_runtime._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))


def test_stop_notebook_runtime_rest_flattened():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/notebookRuntimes/*}:stop" % client.transport._host, args[1])


def test_stop_notebook_runtime_rest_flattened_error(transport: str = 'rest'):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_notebook_execution_job_rest_required_fields(request_type=notebook_service.CreateNotebookExecutionJobRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_notebook_execution_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_notebook_execution_job_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("notebookExecutionJobId", )) & set(("parent", "notebookExecutionJob", )))
...
def test_create_notebook_execution_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/notebookExecutionJobs" % client.transport._host, args[1])
...
def test_get_notebook_execution_job_rest_required_fields(request_type=notebook_service.GetNotebookExecutionJobRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_notebook_execution_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_notebook_execution_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/notebookExecutionJobs/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/notebookExecutionJobs/*}" % client.transport._host, args[1])
...
def test_list_notebook_execution_jobs_rest_required_fields(request_type=notebook_service.ListNotebookExecutionJobsRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_notebook_execution_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = notebook_service.ListNotebookExecutionJobsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_notebook_execution_jobs_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(notebook_service.ListNotebookExecutionJobsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_delete_notebook_execution_job_rest_required_fields(request_type=notebook_service.DeleteNotebookExecutionJobRequest):
    transport_class = transports.NotebookServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_notebook_execution_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_stop_notebook_runtime_empty_call_grpc():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.stop_notebook_runtime(request=None)

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = notebook_service.StopNotebookRuntimeRequest()
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_stop_notebook_runtime_empty_call_grpc_asyncio():
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.stop_notebook_runtime(request=None)
...
def test_create_notebook_runtime_template_rest_bad_request(request_type=notebook_service.CreateNotebookRuntimeTemplateRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_notebook_runtime_template_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["notebook_runtime_template"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'is_default': True, 'machine_spec': {'machine_type': 'machine_type_value', 'accelerator_type': 1, 'accelerator_count': 1805, 'gpu_partition_size': 'gpu_partition_size_value', 'tpu_topology': 'tpu_topology_value', 'multihost_gpu_node_count': 2593, 'reservation_affinity': {'reservation_affinity_type': 1, 'key': 'key_value', 'values': ['values_value1', 'values_value2']}, 'min_gpu_driver_version': 'min_gpu_driver_version_value'}, 'data_persistent_disk_spec': {'disk_type': 'disk_type_value', 'disk_size_gb': 1261}, 'network_spec': {'enable_internet_access': True, 'network': 'network_value', 'subnetwork': 'subnetwork_value'}, 'service_account': 'service_account_value', 'etag': 'etag_value', 'labels': {}, 'idle_shutdown_config': {'idle_timeout': {'seconds': 751, 'nanos': 543}, 'idle_shutdown_disabled': True}, 'euc_config': {'euc_disabled': True, 'bypass_actas_check': True}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'notebook_runtime_type': 1, 'shielded_vm_config': {'enable_secure_boot': True}, 'network_tags': ['network_tags_value1', 'network_tags_value2'], 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}, 'software_config': {'colab_image': {'release_name': 'release_name_value', 'description': 'description_value'}, 'env': [{'name': 'name_value', 'value': 'value_value'}], 'post_startup_script_config': {'post_startup_script': 'post_startup_script_value', 'post_startup_script_url': 'post_startup_script_url_value', 'post_startup_script_behavior': 1}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = notebook_service.CreateNotebookRuntimeTemplateRequest.meta.fields["notebook_runtime_template"]
    ...
    for field, value in request_init["notebook_runtime_template"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["notebook_runtime_template"][field])):
...
def test_create_notebook_runtime_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_create_notebook_runtime_template") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_create_notebook_runtime_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_create_notebook_runtime_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.CreateNotebookRuntimeTemplateRequest.pb(notebook_service.CreateNotebookRuntimeTemplateRequest())
        ...
        client.create_notebook_runtime_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_notebook_runtime_template_rest_bad_request(request_type=notebook_service.GetNotebookRuntimeTemplateRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/notebookRuntimeTemplates/sample3'}
    request = request_type(**request_init)
...
def test_get_notebook_runtime_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_get_notebook_runtime_template") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_get_notebook_runtime_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_get_notebook_runtime_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.GetNotebookRuntimeTemplateRequest.pb(notebook_service.GetNotebookRuntimeTemplateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = notebook_runtime.NotebookRuntimeTemplate.to_json(notebook_runtime.NotebookRuntimeTemplate())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = notebook_runtime.NotebookRuntimeTemplate(), metadata

        client.get_notebook_runtime_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_notebook_runtime_templates_rest_bad_request(request_type=notebook_service.ListNotebookRuntimeTemplatesRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_notebook_runtime_templates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_list_notebook_runtime_templates") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_list_notebook_runtime_templates_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_list_notebook_runtime_templates") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.ListNotebookRuntimeTemplatesRequest.pb(notebook_service.ListNotebookRuntimeTemplatesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = notebook_service.ListNotebookRuntimeTemplatesResponse.to_json(notebook_service.ListNotebookRuntimeTemplatesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = notebook_service.ListNotebookRuntimeTemplatesResponse(), metadata

        client.list_notebook_runtime_templates(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_notebook_runtime_template_rest_bad_request(request_type=notebook_service.DeleteNotebookRuntimeTemplateRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_notebook_runtime_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_delete_notebook_runtime_template") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_delete_notebook_runtime_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_delete_notebook_runtime_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.DeleteNotebookRuntimeTemplateRequest.pb(notebook_service.DeleteNotebookRuntimeTemplateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_notebook_runtime_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_notebook_runtime_template_rest_bad_request(request_type=notebook_service.UpdateNotebookRuntimeTemplateRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_notebook_runtime_template_rest_call_success(request_type):
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = notebook_service.UpdateNotebookRuntimeTemplateRequest.meta.fields["notebook_runtime_template"]
...
def test_update_notebook_runtime_template_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_update_notebook_runtime_template") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_update_notebook_runtime_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_update_notebook_runtime_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.UpdateNotebookRuntimeTemplateRequest.pb(notebook_service.UpdateNotebookRuntimeTemplateRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_notebook_runtime_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_assign_notebook_runtime_rest_bad_request(request_type=notebook_service.AssignNotebookRuntimeRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_assign_notebook_runtime_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_assign_notebook_runtime") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_assign_notebook_runtime_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_assign_notebook_runtime") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.AssignNotebookRuntimeRequest.pb(notebook_service.AssignNotebookRuntimeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.assign_notebook_runtime(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_notebook_runtime_rest_bad_request(request_type=notebook_service.GetNotebookRuntimeRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/notebookRuntimes/sample3'}
    request = request_type(**request_init)
...
def test_get_notebook_runtime_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_get_notebook_runtime") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_get_notebook_runtime_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_get_notebook_runtime") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.GetNotebookRuntimeRequest.pb(notebook_service.GetNotebookRuntimeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = notebook_runtime.NotebookRuntime.to_json(notebook_runtime.NotebookRuntime())
        req.return_value.content = return_value
        ...
        client.get_notebook_runtime(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_notebook_runtimes_rest_bad_request(request_type=notebook_service.ListNotebookRuntimesRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_notebook_runtimes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_list_notebook_runtimes") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_list_notebook_runtimes_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_list_notebook_runtimes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.ListNotebookRuntimesRequest.pb(notebook_service.ListNotebookRuntimesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = notebook_service.ListNotebookRuntimesResponse.to_json(notebook_service.ListNotebookRuntimesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = notebook_service.ListNotebookRuntimesResponse(), metadata

        client.list_notebook_runtimes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_notebook_runtime_rest_bad_request(request_type=notebook_service.DeleteNotebookRuntimeRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_notebook_runtime_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_delete_notebook_runtime") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_delete_notebook_runtime_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_delete_notebook_runtime") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.DeleteNotebookRuntimeRequest.pb(notebook_service.DeleteNotebookRuntimeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_notebook_runtime(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_upgrade_notebook_runtime_rest_bad_request(request_type=notebook_service.UpgradeNotebookRuntimeRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_upgrade_notebook_runtime_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_upgrade_notebook_runtime") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_upgrade_notebook_runtime_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_upgrade_notebook_runtime") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.UpgradeNotebookRuntimeRequest.pb(notebook_service.UpgradeNotebookRuntimeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.upgrade_notebook_runtime(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_start_notebook_runtime_rest_bad_request(request_type=notebook_service.StartNotebookRuntimeRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_start_notebook_runtime_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_start_notebook_runtime") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_start_notebook_runtime_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_start_notebook_runtime") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.StartNotebookRuntimeRequest.pb(notebook_service.StartNotebookRuntimeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.start_notebook_runtime(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_stop_notebook_runtime_rest_bad_request(request_type=notebook_service.StopNotebookRuntimeRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_stop_notebook_runtime_rest_call_success(request_type):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_stop_notebook_runtime_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_stop_notebook_runtime") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_stop_notebook_runtime_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_stop_notebook_runtime") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.StopNotebookRuntimeRequest.pb(notebook_service.StopNotebookRuntimeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.stop_notebook_runtime(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_notebook_execution_job_rest_bad_request(request_type=notebook_service.CreateNotebookExecutionJobRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_notebook_execution_job_rest_call_success(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["notebook_execution_job"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_create_notebook_execution_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_create_notebook_execution_job") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_create_notebook_execution_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_create_notebook_execution_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.CreateNotebookExecutionJobRequest.pb(notebook_service.CreateNotebookExecutionJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_notebook_execution_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_notebook_execution_job_rest_bad_request(request_type=notebook_service.GetNotebookExecutionJobRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/notebookExecutionJobs/sample3'}
    request = request_type(**request_init)
...
def test_get_notebook_execution_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_get_notebook_execution_job") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_get_notebook_execution_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_get_notebook_execution_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.GetNotebookExecutionJobRequest.pb(notebook_service.GetNotebookExecutionJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = notebook_execution_job.NotebookExecutionJob.to_json(notebook_execution_job.NotebookExecutionJob())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = notebook_execution_job.NotebookExecutionJob(), metadata

        client.get_notebook_execution_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_notebook_execution_jobs_rest_bad_request(request_type=notebook_service.ListNotebookExecutionJobsRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_notebook_execution_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_list_notebook_execution_jobs") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_list_notebook_execution_jobs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_list_notebook_execution_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.ListNotebookExecutionJobsRequest.pb(notebook_service.ListNotebookExecutionJobsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = notebook_service.ListNotebookExecutionJobsResponse.to_json(notebook_service.ListNotebookExecutionJobsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = notebook_service.ListNotebookExecutionJobsResponse(), metadata

        client.list_notebook_execution_jobs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_notebook_execution_job_rest_bad_request(request_type=notebook_service.DeleteNotebookExecutionJobRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_notebook_execution_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_delete_notebook_execution_job") as post, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "post_delete_notebook_execution_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.NotebookServiceRestInterceptor, "pre_delete_notebook_execution_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.DeleteNotebookExecutionJobRequest.pb(notebook_service.DeleteNotebookExecutionJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_notebook_execution_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_stop_notebook_runtime_empty_call_rest():
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_transport_kind_rest_asyncio():
    ...
    transport = NotebookServiceAsyncClient.get_transport_class("rest_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
@pytest.mark.asyncio
async def test_create_notebook_runtime_template_rest_asyncio_bad_request(request_type=notebook_service.CreateNotebookRuntimeTemplateRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_notebook_runtime_template_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_create_notebook_runtime_template_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
        interceptor=None if null_interceptor else transports.AsyncNotebookServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_create_notebook_runtime_template") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_create_notebook_runtime_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_create_notebook_runtime_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.CreateNotebookRuntimeTemplateRequest.pb(notebook_service.CreateNotebookRuntimeTemplateRequest())
        ...
        await client.create_notebook_runtime_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_notebook_runtime_template_rest_asyncio_bad_request(request_type=notebook_service.GetNotebookRuntimeTemplateRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_notebook_runtime_template_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_get_notebook_runtime_template_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_get_notebook_runtime_template") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_get_notebook_runtime_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_get_notebook_runtime_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.GetNotebookRuntimeTemplateRequest.pb(notebook_service.GetNotebookRuntimeTemplateRequest())
        ...
        await client.get_notebook_runtime_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_notebook_runtime_templates_rest_asyncio_bad_request(request_type=notebook_service.ListNotebookRuntimeTemplatesRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_notebook_runtime_templates_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_list_notebook_runtime_templates_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_list_notebook_runtime_templates") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_list_notebook_runtime_templates_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_list_notebook_runtime_templates") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.ListNotebookRuntimeTemplatesRequest.pb(notebook_service.ListNotebookRuntimeTemplatesRequest())
        ...
        await client.list_notebook_runtime_templates(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_notebook_runtime_template_rest_asyncio_bad_request(request_type=notebook_service.DeleteNotebookRuntimeTemplateRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_notebook_runtime_template_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_delete_notebook_runtime_template_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_delete_notebook_runtime_template") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_delete_notebook_runtime_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_delete_notebook_runtime_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.DeleteNotebookRuntimeTemplateRequest.pb(notebook_service.DeleteNotebookRuntimeTemplateRequest())
        ...
        await client.delete_notebook_runtime_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_update_notebook_runtime_template_rest_asyncio_bad_request(request_type=notebook_service.UpdateNotebookRuntimeTemplateRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_update_notebook_runtime_template_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_update_notebook_runtime_template_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_update_notebook_runtime_template") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_update_notebook_runtime_template_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_update_notebook_runtime_template") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.UpdateNotebookRuntimeTemplateRequest.pb(notebook_service.UpdateNotebookRuntimeTemplateRequest())
        ...
        await client.update_notebook_runtime_template(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_assign_notebook_runtime_rest_asyncio_bad_request(request_type=notebook_service.AssignNotebookRuntimeRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_assign_notebook_runtime_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_assign_notebook_runtime_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_assign_notebook_runtime") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_assign_notebook_runtime_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_assign_notebook_runtime") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.AssignNotebookRuntimeRequest.pb(notebook_service.AssignNotebookRuntimeRequest())
        ...
        await client.assign_notebook_runtime(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_notebook_runtime_rest_asyncio_bad_request(request_type=notebook_service.GetNotebookRuntimeRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_notebook_runtime_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_get_notebook_runtime_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_get_notebook_runtime") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_get_notebook_runtime_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_get_notebook_runtime") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.GetNotebookRuntimeRequest.pb(notebook_service.GetNotebookRuntimeRequest())
        ...
        await client.get_notebook_runtime(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_notebook_runtimes_rest_asyncio_bad_request(request_type=notebook_service.ListNotebookRuntimesRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_notebook_runtimes_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_list_notebook_runtimes_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_list_notebook_runtimes") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_list_notebook_runtimes_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_list_notebook_runtimes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.ListNotebookRuntimesRequest.pb(notebook_service.ListNotebookRuntimesRequest())
        ...
        await client.list_notebook_runtimes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_notebook_runtime_rest_asyncio_bad_request(request_type=notebook_service.DeleteNotebookRuntimeRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_notebook_runtime_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_delete_notebook_runtime_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_delete_notebook_runtime") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_delete_notebook_runtime_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_delete_notebook_runtime") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.DeleteNotebookRuntimeRequest.pb(notebook_service.DeleteNotebookRuntimeRequest())
        ...
        await client.delete_notebook_runtime(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_upgrade_notebook_runtime_rest_asyncio_bad_request(request_type=notebook_service.UpgradeNotebookRuntimeRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_upgrade_notebook_runtime_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_upgrade_notebook_runtime_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_upgrade_notebook_runtime") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_upgrade_notebook_runtime_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_upgrade_notebook_runtime") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.UpgradeNotebookRuntimeRequest.pb(notebook_service.UpgradeNotebookRuntimeRequest())
        ...
        await client.upgrade_notebook_runtime(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_start_notebook_runtime_rest_asyncio_bad_request(request_type=notebook_service.StartNotebookRuntimeRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_start_notebook_runtime_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_start_notebook_runtime_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_start_notebook_runtime") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_start_notebook_runtime_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_start_notebook_runtime") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.StartNotebookRuntimeRequest.pb(notebook_service.StartNotebookRuntimeRequest())
        ...
        await client.start_notebook_runtime(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_stop_notebook_runtime_rest_asyncio_bad_request(request_type=notebook_service.StopNotebookRuntimeRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_stop_notebook_runtime_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_stop_notebook_runtime_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_stop_notebook_runtime") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_stop_notebook_runtime_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_stop_notebook_runtime") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.StopNotebookRuntimeRequest.pb(notebook_service.StopNotebookRuntimeRequest())
        ...
        await client.stop_notebook_runtime(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_create_notebook_execution_job_rest_asyncio_bad_request(request_type=notebook_service.CreateNotebookExecutionJobRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_notebook_execution_job_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_create_notebook_execution_job_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_create_notebook_execution_job") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_create_notebook_execution_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_create_notebook_execution_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.CreateNotebookExecutionJobRequest.pb(notebook_service.CreateNotebookExecutionJobRequest())
        ...
        await client.create_notebook_execution_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_notebook_execution_job_rest_asyncio_bad_request(request_type=notebook_service.GetNotebookExecutionJobRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_notebook_execution_job_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_get_notebook_execution_job_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_get_notebook_execution_job") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_get_notebook_execution_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_get_notebook_execution_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.GetNotebookExecutionJobRequest.pb(notebook_service.GetNotebookExecutionJobRequest())
        ...
        await client.get_notebook_execution_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_notebook_execution_jobs_rest_asyncio_bad_request(request_type=notebook_service.ListNotebookExecutionJobsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_notebook_execution_jobs_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_list_notebook_execution_jobs_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_list_notebook_execution_jobs") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_list_notebook_execution_jobs_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_list_notebook_execution_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.ListNotebookExecutionJobsRequest.pb(notebook_service.ListNotebookExecutionJobsRequest())
        ...
        await client.list_notebook_execution_jobs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_notebook_execution_job_rest_asyncio_bad_request(request_type=notebook_service.DeleteNotebookExecutionJobRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_notebook_execution_job_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_delete_notebook_execution_job_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncNotebookServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_delete_notebook_execution_job") as post, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "post_delete_notebook_execution_job_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncNotebookServiceRestInterceptor, "pre_delete_notebook_execution_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = notebook_service.DeleteNotebookExecutionJobRequest.pb(notebook_service.DeleteNotebookExecutionJobRequest())
        ...
        await client.delete_notebook_execution_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_notebook_runtime_template_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_notebook_runtime_template_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_notebook_runtime_templates_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_notebook_runtime_template_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_notebook_runtime_template_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_assign_notebook_runtime_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_notebook_runtime_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_notebook_runtimes_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_notebook_runtime_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_upgrade_notebook_runtime_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_start_notebook_runtime_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_stop_notebook_runtime_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_notebook_execution_job_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_notebook_execution_job_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_notebook_execution_jobs_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_notebook_execution_job_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
def test_notebook_service_rest_asyncio_lro_client():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
def test_notebook_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1beta1.services.notebook_service.transports.NotebookServiceTransport.__init__') as Transport:
...
def test_notebook_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1beta1.services.notebook_service.transports.NotebookServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_notebook_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1beta1.services.notebook_service.transports.NotebookServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NotebookServiceTransport()
        adc.assert_called_once()
...
def test_notebook_service_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.stop_notebook_runtime._session
    session2 = client2.transport.stop_notebook_runtime._session
    assert session1 != session2
...
def test_notebook_execution_job_path():
    ...
    expected = "projects/{project}/locations/{location}/notebookExecutionJobs/{notebook_execution_job}".format(project=project, location=location, notebook_execution_job=notebook_execution_job, )
    actual = NotebookServiceClient.notebook_execution_job_path(project, location, notebook_execution_job)
    assert expected == actual
...
def test_notebook_runtime_path():
    ...
    expected = "projects/{project}/locations/{location}/notebookRuntimes/{notebook_runtime}".format(project=project, location=location, notebook_runtime=notebook_runtime, )
    actual = NotebookServiceClient.notebook_runtime_path(project, location, notebook_runtime)
    assert expected == actual
...
def test_notebook_runtime_template_path():
    ...
    actual = NotebookServiceClient.notebook_runtime_template_path(project, location, notebook_runtime_template)
    assert expected == actual
