...
@pytest.mark.asyncio
async def test_create_tuning_job_async(transport: str = 'grpc_asyncio', request_type=genai_tuning_service.CreateTuningJobRequest):
    client = GenAiTuningServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_get_tuning_job_async(transport: str = 'grpc_asyncio', request_type=genai_tuning_service.GetTuningJobRequest):
    client = GenAiTuningServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_tuning_jobs_async(transport: str = 'grpc_asyncio', request_type=genai_tuning_service.ListTuningJobsRequest):
    client = GenAiTuningServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_cancel_tuning_job_async(transport: str = 'grpc_asyncio', request_type=genai_tuning_service.CancelTuningJobRequest):
    client = GenAiTuningServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_rebase_tuned_model_async(transport: str = 'grpc_asyncio', request_type=genai_tuning_service.RebaseTunedModelRequest):
    client = GenAiTuningServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_tuning_job_rest(request_type):
    ...
    request_init["tuning_job"] = {'base_model': 'base_model_value', 'supervised_tuning_spec': {'training_dataset_uri': 'training_dataset_uri_value', 'validation_dataset_uri': 'validation_dataset_uri_value', 'hyper_parameters': {'epoch_count': 1175, 'learning_rate_multiplier': 0.2561, 'adapter_size': 1}}, 'distillation_spec': {'base_teacher_model': 'base_teacher_model_value', 'tuned_teacher_model_source': 'tuned_teacher_model_source_value', 'training_dataset_uri': 'training_dataset_uri_value', 'validation_dataset_uri': 'validation_dataset_uri_value', 'hyper_parameters': {'epoch_count': 1175, 'learning_rate_multiplier': 0.2561, 'adapter_size': 1}, 'student_model': 'student_model_value', 'pipeline_root_directory': 'pipeline_root_directory_value'}, 'partner_model_tuning_spec': {'training_dataset_uri': 'training_dataset_uri_value', 'validation_dataset_uri': 'validation_dataset_uri_value', 'hyper_parameters': {}}, 'name': 'name_value', 'tuned_model_display_name': 'tuned_model_display_name_value', 'description': 'description_value', 'state': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'start_time': {}, 'end_time': {}, 'update_time': {}, 'error': {'code': 411, 'message': 'message_value', 'details': [{'type_url': 'type.googleapis.com/google.protobuf.Duration', 'value': b'\x08\x0c\x10\xdb\x07'}]}, 'labels': {}, 'experiment': 'experiment_value', 'tuned_model': {'model': 'model_value', 'endpoint': 'endpoint_value'}, 'tuning_data_stats': {'supervised_tuning_data_stats': {'tuning_dataset_example_count': 2989, 'total_tuning_character_count': 2988, 'total_billable_character_count': 3150, 'total_billable_token_count': 2754, 'tuning_step_count': 1848, 'user_input_token_distribution': {'sum': 341, 'billable_sum': 1259, 'min_': 0.419, 'max_': 0.421, 'mean': 0.417, 'median': 0.622, 'p5': 0.165, 'p95': 0.222, 'buckets': [{'count': 0.553, 'left': 0.427, 'right': 0.542}]}, 'user_output_token_distribution': {}, 'user_message_per_example_distribution': {}, 'user_dataset_examples': [{'role': 'role_value', 'parts': [{'text': 'text_value', 'inline_data': {'mime_type': 'mime_type_value', 'data': b'data_blob'}, 'file_data': {'mime_type': 'mime_type_value', 'file_uri': 'file_uri_value'}, 'function_call': {'name': 'name_value', 'args': {'fields': {}}}, 'function_response': {'name': 'name_value', 'response': {}}, 'video_metadata': {'start_offset': {'seconds': 751, 'nanos': 543}, 'end_offset': {}}}]}], 'total_truncated_example_count': 3104, 'truncated_example_indices': [2644, 2645]}, 'distillation_data_stats': {'training_dataset_stats': {'tuning_dataset_example_count': 2989, 'total_tuning_character_count': 2988, 'total_billable_character_count': 3150, 'tuning_step_count': 1848, 'user_input_token_distribution': {'sum': 0.341, 'min_': 0.419, 'max_': 0.421, 'mean': 0.417, 'median': 0.622, 'p5': 0.165, 'p95': 0.222, 'buckets': [{'count': 553, 'left': 0.427, 'right': 0.542}]}, 'user_output_token_distribution': {}, 'user_message_per_example_distribution': {}, 'user_dataset_examples': {}}}}, 'pipeline_job': 'pipeline_job_value', 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}}
...
def test_create_tuning_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = gca_tuning_job.TuningJob.to_json(gca_tuning_job.TuningJob())
...
def test_create_tuning_job_rest_bad_request(transport: str = 'rest', request_type=genai_tuning_service.CreateTuningJobRequest):
    client = GenAiTuningServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_tuning_job_rest_bad_request(transport: str = 'rest', request_type=genai_tuning_service.GetTuningJobRequest):
    client = GenAiTuningServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_tuning_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = genai_tuning_service.ListTuningJobsResponse.to_json(genai_tuning_service.ListTuningJobsResponse())
...
def test_list_tuning_jobs_rest_bad_request(transport: str = 'rest', request_type=genai_tuning_service.ListTuningJobsRequest):
    client = GenAiTuningServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_rebase_tuned_model_rest_bad_request(transport: str = 'rest', request_type=genai_tuning_service.RebaseTunedModelRequest):
    client = GenAiTuningServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
