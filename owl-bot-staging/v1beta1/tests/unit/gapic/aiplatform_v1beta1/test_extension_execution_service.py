...
def test_extension_execution_service_client_get_transport_class():
    transport = ExtensionExecutionServiceClient.get_transport_class()
...
def test_execute_extension_empty_call():
...
def test_execute_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.execute_extension in client._transport._wrapped_methods
...
@pytest.mark.asyncio
async def test_execute_extension_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
...
async def test_execute_extension_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.execute_extension] = mock_object
...
@pytest.mark.asyncio
async def test_execute_extension_async(transport: str = 'grpc_asyncio', request_type=extension_execution_service.ExecuteExtensionRequest):
    client = ExtensionExecutionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_execute_extension_field_headers_async():
    client = ExtensionExecutionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_execute_extension_flattened_error():
    client = ExtensionExecutionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_query_extension_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = ExtensionExecutionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_query_extension_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.query_extension in client._transport._wrapped_methods
...
@pytest.mark.asyncio
async def test_query_extension_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = ExtensionExecutionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.query_extension] = mock_object
...
@pytest.mark.asyncio
async def test_query_extension_async(transport: str = 'grpc_asyncio', request_type=extension_execution_service.QueryExtensionRequest):
    client = ExtensionExecutionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_query_extension_field_headers_async():
    client = ExtensionExecutionServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_query_extension_flattened_error():
    client = ExtensionExecutionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_execute_extension_rest(request_type):
    client = ExtensionExecutionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_execute_extension_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ExtensionExecutionServiceClient(
...
def test_execute_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = extension_execution_service.ExecuteExtensionResponse.to_json(extension_execution_service.ExecuteExtensionResponse())
...
def test_execute_extension_rest_bad_request(transport: str = 'rest', request_type=extension_execution_service.ExecuteExtensionRequest):
    client = ExtensionExecutionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_execute_extension_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.execute_extension(**mock_args)
...
def test_execute_extension_rest_error():
    client = ExtensionExecutionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_query_extension_rest(request_type):
    client = ExtensionExecutionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_query_extension_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = ExtensionExecutionServiceClient(
...
def test_query_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = extension_execution_service.QueryExtensionResponse.to_json(extension_execution_service.QueryExtensionResponse())
...
def test_query_extension_rest_bad_request(transport: str = 'rest', request_type=extension_execution_service.QueryExtensionRequest):
    client = ExtensionExecutionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_extension_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.query_extension(**mock_args)
...
def test_query_extension_rest_error():
    client = ExtensionExecutionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_transport_kind(transport_name):
    transport = ExtensionExecutionServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_extension_execution_service_client_transport_session_collision(transport_name):
    ...
    client1 = ExtensionExecutionServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = ExtensionExecutionServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
    session1 = client1.transport.execute_extension._session
    session2 = client2.transport.execute_extension._session
...
def test_parse_extension_path():
    ...
    path = ExtensionExecutionServiceClient.extension_path(**expected)
...
def test_parse_secret_version_path():
    ...
    path = ExtensionExecutionServiceClient.secret_version_path(**expected)
...
def test_parse_common_billing_account_path():
    ...
    path = ExtensionExecutionServiceClient.common_billing_account_path(**expected)
...
def test_parse_common_folder_path():
    ...
    path = ExtensionExecutionServiceClient.common_folder_path(**expected)
...
def test_parse_common_organization_path():
    ...
    path = ExtensionExecutionServiceClient.common_organization_path(**expected)
...
def test_parse_common_project_path():
    ...
    path = ExtensionExecutionServiceClient.common_project_path(**expected)
...
def test_parse_common_location_path():
    ...
    path = ExtensionExecutionServiceClient.common_location_path(**expected)

    # Check that the path construction is reversible.
    actual = ExtensionExecutionServiceClient.parse_common_location_path(path)
    assert expected == actual
