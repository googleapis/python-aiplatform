...
def test_update_deployment_resource_pool_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'deployment_resource_pool': {'name': 'projects/sample1/locations/sample2/deploymentResourcePools/sample3'}}
    request_init["deployment_resource_pool"] = {'name': 'projects/sample1/locations/sample2/deploymentResourcePools/sample3', 'dedicated_resources': {'machine_spec': {'machine_type': 'machine_type_value', 'accelerator_type': 1, 'accelerator_count': 1805, 'tpu_topology': 'tpu_topology_value', 'multihost_gpu_node_count': 2593, 'reservation_affinity': {'reservation_affinity_type': 1, 'key': 'key_value', 'values': ['values_value1', 'values_value2']}}, 'min_replica_count': 1803, 'max_replica_count': 1805, 'required_replica_count': 2344, 'autoscaling_metric_specs': [{'metric_name': 'metric_name_value', 'target': 647}], 'spot': True, 'flex_start': {'max_runtime_duration': {'seconds': 751, 'nanos': 543}}}, 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}, 'service_account': 'service_account_value', 'disable_container_logging': True, 'create_time': {'seconds': 751, 'nanos': 543}, 'satisfies_pzs': True, 'satisfies_pzi': True}
