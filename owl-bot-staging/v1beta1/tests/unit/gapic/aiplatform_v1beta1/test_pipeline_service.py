...
def test_create_training_pipeline_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = gca_training_pipeline.TrainingPipeline.to_json(gca_training_pipeline.TrainingPipeline())
...
def test_create_training_pipeline_rest_bad_request(transport: str = 'rest', request_type=pipeline_service.CreateTrainingPipelineRequest):
    client = PipelineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_training_pipeline_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = training_pipeline.TrainingPipeline.to_json(training_pipeline.TrainingPipeline())
...
def test_get_training_pipeline_rest_bad_request(transport: str = 'rest', request_type=pipeline_service.GetTrainingPipelineRequest):
    client = PipelineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_training_pipelines_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = pipeline_service.ListTrainingPipelinesResponse.to_json(pipeline_service.ListTrainingPipelinesResponse())
...
def test_list_training_pipelines_rest_bad_request(transport: str = 'rest', request_type=pipeline_service.ListTrainingPipelinesRequest):
    client = PipelineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_training_pipeline_rest_bad_request(transport: str = 'rest', request_type=pipeline_service.DeleteTrainingPipelineRequest):
    client = PipelineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_training_pipeline_rest_bad_request(transport: str = 'rest', request_type=pipeline_service.CancelTrainingPipelineRequest):
    client = PipelineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_pipeline_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_pipeline_job.PipelineJob.to_json(gca_pipeline_job.PipelineJob())
...
def test_create_pipeline_job_rest_bad_request(transport: str = 'rest', request_type=pipeline_service.CreatePipelineJobRequest):
    client = PipelineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_pipeline_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = pipeline_job.PipelineJob.to_json(pipeline_job.PipelineJob())
...
def test_get_pipeline_job_rest_bad_request(transport: str = 'rest', request_type=pipeline_service.GetPipelineJobRequest):
    client = PipelineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_pipeline_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = pipeline_service.ListPipelineJobsResponse.to_json(pipeline_service.ListPipelineJobsResponse())
...
def test_list_pipeline_jobs_rest_bad_request(transport: str = 'rest', request_type=pipeline_service.ListPipelineJobsRequest):
    client = PipelineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_pipeline_job_rest_bad_request(transport: str = 'rest', request_type=pipeline_service.DeletePipelineJobRequest):
    client = PipelineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_delete_pipeline_jobs_rest_bad_request(transport: str = 'rest', request_type=pipeline_service.BatchDeletePipelineJobsRequest):
    client = PipelineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_pipeline_job_rest_bad_request(transport: str = 'rest', request_type=pipeline_service.CancelPipelineJobRequest):
    client = PipelineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_cancel_pipeline_jobs_rest_bad_request(transport: str = 'rest', request_type=pipeline_service.BatchCancelPipelineJobsRequest):
    client = PipelineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
