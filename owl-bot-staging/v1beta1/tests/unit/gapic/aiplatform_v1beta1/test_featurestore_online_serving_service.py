...
async def test_read_feature_values_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.read_feature_values] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.streaming_read_feature_values] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.write_feature_values] = mock_object
...
def test_read_feature_values_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = featurestore_online_service.ReadFeatureValuesResponse.to_json(featurestore_online_service.ReadFeatureValuesResponse())
...
def test_read_feature_values_rest_bad_request(transport: str = 'rest', request_type=featurestore_online_service.ReadFeatureValuesRequest):
    client = FeaturestoreOnlineServingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_feature_values_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{entity_type=projects/*/locations/*/featurestores/*/entityTypes/*}:readFeatureValues" % client.transport._host, args[1])
...
def test_streaming_read_feature_values_rest_bad_request(transport: str = 'rest', request_type=featurestore_online_service.StreamingReadFeatureValuesRequest):
    client = FeaturestoreOnlineServingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_streaming_read_feature_values_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{entity_type=projects/*/locations/*/featurestores/*/entityTypes/*}:streamingReadFeatureValues" % client.transport._host, args[1])
...
def test_write_feature_values_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = featurestore_online_service.WriteFeatureValuesResponse.to_json(featurestore_online_service.WriteFeatureValuesResponse())
...
def test_write_feature_values_rest_bad_request(transport: str = 'rest', request_type=featurestore_online_service.WriteFeatureValuesRequest):
    client = FeaturestoreOnlineServingServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_write_feature_values_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{entity_type=projects/*/locations/*/featurestores/*/entityTypes/*}:writeFeatureValues" % client.transport._host, args[1])
