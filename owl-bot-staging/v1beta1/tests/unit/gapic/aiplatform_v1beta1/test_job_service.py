...
@pytest.mark.parametrize("client_class", [
    JobServiceClient, JobServiceAsyncClient
])
...
def test_create_hyperparameter_tuning_job_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = gca_hyperparameter_tuning_job.HyperparameterTuningJob(name='name_value')
        assert arg == mock_val
...
def test_create_nas_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_nas_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_nas_job_async(transport: str = 'grpc_asyncio', request_type=job_service.CreateNasJobRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_nas_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_nas_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_nas_job_async(transport: str = 'grpc_asyncio', request_type=job_service.GetNasJobRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_nas_jobs(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_nas_jobs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_nas_jobs_async(transport: str = 'grpc_asyncio', request_type=job_service.ListNasJobsRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(job_service.ListNasJobsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_delete_nas_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_nas_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_nas_job_async(transport: str = 'grpc_asyncio', request_type=job_service.DeleteNasJobRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_nas_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.cancel_nas_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_cancel_nas_job_async(transport: str = 'grpc_asyncio', request_type=job_service.CancelNasJobRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_nas_trial_detail(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_nas_trial_detail),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_nas_trial_detail_async(transport: str = 'grpc_asyncio', request_type=job_service.GetNasTrialDetailRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(nas_job.NasTrialDetail(
            name='name_value',
            parameters='parameters_value',
        ))
...
@pytest.mark.asyncio
async def test_list_nas_trial_details_async(transport: str = 'grpc_asyncio', request_type=job_service.ListNasTrialDetailsRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(job_service.ListNasTrialDetailsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_create_model_deployment_monitoring_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_model_deployment_monitoring_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_model_deployment_monitoring_job_async(transport: str = 'grpc_asyncio', request_type=job_service.CreateModelDeploymentMonitoringJobRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gca_model_deployment_monitoring_job.ModelDeploymentMonitoringJob(
            name='name_value',
            display_name='display_name_value',
            endpoint='endpoint_value',
            state=job_state.JobState.JOB_STATE_QUEUED,
...
def test_create_model_deployment_monitoring_job_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_model_deployment_monitoring_job(
            parent='parent_value',
            model_deployment_monitoring_job=gca_model_deployment_monitoring_job.ModelDeploymentMonitoringJob(name='name_value'),
        )
        ...
        mock_val = gca_model_deployment_monitoring_job.ModelDeploymentMonitoringJob(name='name_value')
        assert arg == mock_val
...
def test_search_model_deployment_monitoring_stats_anomalies(request_type, transport: str = 'grpc'):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.SearchModelDeploymentMonitoringStatsAnomaliesPager)
    assert response.next_page_token == 'next_page_token_value'
...
@pytest.mark.asyncio
async def test_search_model_deployment_monitoring_stats_anomalies_async(transport: str = 'grpc_asyncio', request_type=job_service.SearchModelDeploymentMonitoringStatsAnomaliesRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.search_model_deployment_monitoring_stats_anomalies(request)
...
async def test_search_model_deployment_monitoring_stats_anomalies_async_from_dict():
    await test_search_model_deployment_monitoring_stats_anomalies_async(request_type=dict)
...
def test_search_model_deployment_monitoring_stats_anomalies_pager(transport_name: str = "grpc"):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, gca_model_deployment_monitoring_job.ModelMonitoringStatsAnomalies)
                   for i in results)
def test_search_model_deployment_monitoring_stats_anomalies_pages(transport_name: str = "grpc"):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.search_model_deployment_monitoring_stats_anomalies(request={}).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_model_deployment_monitoring_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_model_deployment_monitoring_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, model_deployment_monitoring_job.ModelDeploymentMonitoringJob)
    assert response.name == 'name_value'
    assert response.display_name == 'display_name_value'
    assert response.endpoint == 'endpoint_value'
    assert response.state == job_state.JobState.JOB_STATE_QUEUED
...
@pytest.mark.asyncio
async def test_get_model_deployment_monitoring_job_async(transport: str = 'grpc_asyncio', request_type=job_service.GetModelDeploymentMonitoringJobRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(model_deployment_monitoring_job.ModelDeploymentMonitoringJob(
            name='name_value',
            display_name='display_name_value',
            endpoint='endpoint_value',
            state=job_state.JobState.JOB_STATE_QUEUED,
...
@pytest.mark.asyncio
async def test_list_model_deployment_monitoring_jobs_async(transport: str = 'grpc_asyncio', request_type=job_service.ListModelDeploymentMonitoringJobsRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(job_service.ListModelDeploymentMonitoringJobsResponse(
            next_page_token='next_page_token_value',
        ))
...
@pytest.mark.asyncio
async def test_update_model_deployment_monitoring_job_async(transport: str = 'grpc_asyncio', request_type=job_service.UpdateModelDeploymentMonitoringJobRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_model_deployment_monitoring_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_model_deployment_monitoring_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_model_deployment_monitoring_job_async(transport: str = 'grpc_asyncio', request_type=job_service.DeleteModelDeploymentMonitoringJobRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_pause_model_deployment_monitoring_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.pause_model_deployment_monitoring_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_pause_model_deployment_monitoring_job_async(transport: str = 'grpc_asyncio', request_type=job_service.PauseModelDeploymentMonitoringJobRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resume_model_deployment_monitoring_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.resume_model_deployment_monitoring_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_resume_model_deployment_monitoring_job_async(transport: str = 'grpc_asyncio', request_type=job_service.ResumeModelDeploymentMonitoringJobRequest):
    client = JobServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_custom_job_rest_required_fields(request_type=job_service.CreateCustomJobRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_custom_job._get_unset_required_fields(jsonified_request)
...
def test_create_custom_job_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "customJob", )))
...
def test_create_custom_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.JobServiceRestInterceptor, "post_create_custom_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_create_custom_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.CreateCustomJobRequest.pb(job_service.CreateCustomJobRequest())
        ...
        req.return_value._content = gca_custom_job.CustomJob.to_json(gca_custom_job.CustomJob())
        ...
        client.create_custom_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_custom_job_rest_bad_request(transport: str = 'rest', request_type=job_service.CreateCustomJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_custom_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/customJobs" % client.transport._host, args[1])
...
def test_get_custom_job_rest_required_fields(request_type=job_service.GetCustomJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_custom_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_custom_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_get_custom_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_get_custom_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.GetCustomJobRequest.pb(job_service.GetCustomJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_custom_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_custom_job_rest_bad_request(transport: str = 'rest', request_type=job_service.GetCustomJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_custom_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/customJobs/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/customJobs/*}" % client.transport._host, args[1])
...
def test_list_custom_jobs_rest_required_fields(request_type=job_service.ListCustomJobsRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_custom_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_custom_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_list_custom_jobs") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_list_custom_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.ListCustomJobsRequest.pb(job_service.ListCustomJobsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = job_service.ListCustomJobsResponse.to_json(job_service.ListCustomJobsResponse())
        ...
        client.list_custom_jobs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_custom_jobs_rest_bad_request(transport: str = 'rest', request_type=job_service.ListCustomJobsRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_custom_jobs_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(job_service.ListCustomJobsResponse.to_json(x) for x in response)
...
def test_delete_custom_job_rest_required_fields(request_type=job_service.DeleteCustomJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_custom_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_custom_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.JobServiceRestInterceptor, "post_delete_custom_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_delete_custom_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.DeleteCustomJobRequest.pb(job_service.DeleteCustomJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_custom_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_custom_job_rest_bad_request(transport: str = 'rest', request_type=job_service.DeleteCustomJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_custom_job_rest_required_fields(request_type=job_service.CancelCustomJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).cancel_custom_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_custom_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_cancel_custom_job") as pre:
        pre.assert_not_called()
        pb_message = job_service.CancelCustomJobRequest.pb(job_service.CancelCustomJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.cancel_custom_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_cancel_custom_job_rest_bad_request(transport: str = 'rest', request_type=job_service.CancelCustomJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_custom_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/customJobs/*}:cancel" % client.transport._host, args[1])
...
def test_create_data_labeling_job_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["data_labeling_job"] = {'name': 'name_value', 'display_name': 'display_name_value', 'datasets': ['datasets_value1', 'datasets_value2'], 'annotation_labels': {}, 'labeler_count': 1375, 'instruction_uri': 'instruction_uri_value', 'inputs_schema_uri': 'inputs_schema_uri_value', 'inputs': {'null_value': 0, 'number_value': 0.1285, 'string_value': 'string_value_value', 'bool_value': True, 'struct_value': {'fields': {}}, 'list_value': {'values': {}}}, 'state': 1, 'labeling_progress': 1810, 'current_spend': {'currency_code': 'currency_code_value', 'units': 563, 'nanos': 543}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'error': {'code': 411, 'message': 'message_value', 'details': [{'type_url': 'type.googleapis.com/google.protobuf.Duration', 'value': b'\x08\x0c\x10\xdb\x07'}]}, 'labels': {}, 'specialist_pools': ['specialist_pools_value1', 'specialist_pools_value2'], 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}, 'active_learning_config': {'max_data_item_count': 2005, 'max_data_item_percentage': 2506, 'sample_config': {'initial_batch_sample_percentage': 3241, 'following_batch_sample_percentage': 3472, 'sample_strategy': 1}, 'training_config': {'timeout_training_milli_hours': 3016}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = job_service.CreateDataLabelingJobRequest.meta.fields["data_labeling_job"]
...
def test_create_data_labeling_job_rest_required_fields(request_type=job_service.CreateDataLabelingJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_data_labeling_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_data_labeling_job_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "dataLabelingJob", )))
...
def test_create_data_labeling_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_create_data_labeling_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_create_data_labeling_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.CreateDataLabelingJobRequest.pb(job_service.CreateDataLabelingJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_data_labeling_job.DataLabelingJob.to_json(gca_data_labeling_job.DataLabelingJob())
        ...
        client.create_data_labeling_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_data_labeling_job_rest_bad_request(transport: str = 'rest', request_type=job_service.CreateDataLabelingJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_data_labeling_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/dataLabelingJobs" % client.transport._host, args[1])
...
def test_get_data_labeling_job_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/dataLabelingJobs/sample3'}
    request = request_type(**request_init)
...
def test_get_data_labeling_job_rest_required_fields(request_type=job_service.GetDataLabelingJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_data_labeling_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_data_labeling_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_get_data_labeling_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_get_data_labeling_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.GetDataLabelingJobRequest.pb(job_service.GetDataLabelingJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = data_labeling_job.DataLabelingJob.to_json(data_labeling_job.DataLabelingJob())
        ...
        client.get_data_labeling_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_data_labeling_job_rest_bad_request(transport: str = 'rest', request_type=job_service.GetDataLabelingJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_data_labeling_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/dataLabelingJobs/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/dataLabelingJobs/*}" % client.transport._host, args[1])
...
def test_list_data_labeling_jobs_rest_required_fields(request_type=job_service.ListDataLabelingJobsRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_data_labeling_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_data_labeling_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_list_data_labeling_jobs") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_list_data_labeling_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.ListDataLabelingJobsRequest.pb(job_service.ListDataLabelingJobsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = job_service.ListDataLabelingJobsResponse.to_json(job_service.ListDataLabelingJobsResponse())
        ...
        client.list_data_labeling_jobs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_data_labeling_jobs_rest_bad_request(transport: str = 'rest', request_type=job_service.ListDataLabelingJobsRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_data_labeling_jobs_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(job_service.ListDataLabelingJobsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_delete_data_labeling_job_rest_required_fields(request_type=job_service.DeleteDataLabelingJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_data_labeling_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_data_labeling_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_delete_data_labeling_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_delete_data_labeling_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.DeleteDataLabelingJobRequest.pb(job_service.DeleteDataLabelingJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_data_labeling_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_data_labeling_job_rest_bad_request(transport: str = 'rest', request_type=job_service.DeleteDataLabelingJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_data_labeling_job_rest_required_fields(request_type=job_service.CancelDataLabelingJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).cancel_data_labeling_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_data_labeling_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_cancel_data_labeling_job") as pre:
        pre.assert_not_called()
        pb_message = job_service.CancelDataLabelingJobRequest.pb(job_service.CancelDataLabelingJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.cancel_data_labeling_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_cancel_data_labeling_job_rest_bad_request(transport: str = 'rest', request_type=job_service.CancelDataLabelingJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_data_labeling_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/dataLabelingJobs/*}:cancel" % client.transport._host, args[1])
...
def test_create_hyperparameter_tuning_job_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["hyperparameter_tuning_job"] = {'name': 'name_value', 'display_name': 'display_name_value', 'study_spec': {'decay_curve_stopping_spec': {'use_elapsed_duration': True}, 'median_automated_stopping_spec': {'use_elapsed_duration': True}, 'convex_stop_config': {'max_num_steps': 1411, 'min_num_steps': 1409, 'autoregressive_order': 2163, 'learning_rate_parameter_name': 'learning_rate_parameter_name_value', 'use_seconds': True}, 'convex_automated_stopping_spec': {'max_step_count': 1513, 'min_step_count': 1511, 'min_measurement_count': 2257, 'learning_rate_parameter_name': 'learning_rate_parameter_name_value', 'use_elapsed_duration': True, 'update_all_stopped_trials': True}, 'metrics': [{'metric_id': 'metric_id_value', 'goal': 1, 'safety_config': {'safety_threshold': 0.17200000000000001, 'desired_min_safe_trials_fraction': 0.33640000000000003}}], 'parameters': [{'double_value_spec': {'min_value': 0.96, 'max_value': 0.962, 'default_value': 0.13770000000000002}, 'integer_value_spec': {'min_value': 960, 'max_value': 962, 'default_value': 1377}, 'categorical_value_spec': {'values': ['values_value1', 'values_value2'], 'default_value': 'default_value_value'}, 'discrete_value_spec': {'values': [0.657, 0.658], 'default_value': 0.13770000000000002}, 'parameter_id': 'parameter_id_value', 'scale_type': 1, 'conditional_parameter_specs': [{'parent_discrete_values': {'values': [0.657, 0.658]}, 'parent_int_values': {'values': [657, 658]}, 'parent_categorical_values': {'values': ['values_value1', 'values_value2']}, 'parameter_spec': {}}]}], 'algorithm': 2, 'observation_noise': 1, 'measurement_selection_type': 1, 'transfer_learning_config': {'disable_transfer_learning': True, 'prior_study_names': ['prior_study_names_value1', 'prior_study_names_value2']}, 'study_stopping_config': {'should_stop_asap': {'value': True}, 'minimum_runtime_constraint': {'max_duration': {'seconds': 751, 'nanos': 543}, 'end_time': {'seconds': 751, 'nanos': 543}}, 'maximum_runtime_constraint': {}, 'min_num_trials': {'value': 541}, 'max_num_trials': {}, 'max_num_trials_no_progress': {}, 'max_duration_no_progress': {}}}, 'max_trial_count': 1609, 'parallel_trial_count': 2128, 'max_failed_trial_count': 2317, 'trial_job_spec': {'persistent_resource_id': 'persistent_resource_id_value', 'worker_pool_specs': [{'container_spec': {'image_uri': 'image_uri_value', 'command': ['command_value1', 'command_value2'], 'args': ['args_value1', 'args_value2'], 'env': [{'name': 'name_value', 'value': 'value_value'}]}, 'python_package_spec': {'executor_image_uri': 'executor_image_uri_value', 'package_uris': ['package_uris_value1', 'package_uris_value2'], 'python_module': 'python_module_value', 'args': ['args_value1', 'args_value2'], 'env': {}}, 'machine_spec': {'machine_type': 'machine_type_value', 'accelerator_type': 1, 'accelerator_count': 1805, 'tpu_topology': 'tpu_topology_value'}, 'replica_count': 1384, 'nfs_mounts': [{'server': 'server_value', 'path': 'path_value', 'mount_point': 'mount_point_value'}], 'disk_spec': {'boot_disk_type': 'boot_disk_type_value', 'boot_disk_size_gb': 1792}}], 'scheduling': {'timeout': {}, 'restart_job_on_worker_restart': True, 'disable_retries': True}, 'service_account': 'service_account_value', 'network': 'network_value', 'reserved_ip_ranges': ['reserved_ip_ranges_value1', 'reserved_ip_ranges_value2'], 'base_output_directory': {'output_uri_prefix': 'output_uri_prefix_value'}, 'protected_artifact_location_id': 'protected_artifact_location_id_value', 'tensorboard': 'tensorboard_value', 'enable_web_access': True, 'enable_dashboard_access': True, 'experiment': 'experiment_value', 'experiment_run': 'experiment_run_value', 'models': ['models_value1', 'models_value2']}, 'trials': [{'name': 'name_value', 'id': 'id_value', 'state': 1, 'parameters': [{'parameter_id': 'parameter_id_value', 'value': {'null_value': 0, 'number_value': 0.1285, 'string_value': 'string_value_value', 'bool_value': True, 'struct_value': {'fields': {}}, 'list_value': {'values': {}}}}], 'final_measurement': {'elapsed_duration': {}, 'step_count': 1092, 'metrics': [{'metric_id': 'metric_id_value', 'value': 0.541}]}, 'measurements': {}, 'start_time': {}, 'end_time': {}, 'client_id': 'client_id_value', 'infeasible_reason': 'infeasible_reason_value', 'custom_job': 'custom_job_value', 'web_access_uris': {}}], 'state': 1, 'create_time': {}, 'start_time': {}, 'end_time': {}, 'update_time': {}, 'error': {'code': 411, 'message': 'message_value', 'details': [{'type_url': 'type.googleapis.com/google.protobuf.Duration', 'value': b'\x08\x0c\x10\xdb\x07'}]}, 'labels': {}, 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = job_service.CreateHyperparameterTuningJobRequest.meta.fields["hyperparameter_tuning_job"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["hyperparameter_tuning_job"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["hyperparameter_tuning_job"][field])):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = gca_hyperparameter_tuning_job.HyperparameterTuningJob.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_create_hyperparameter_tuning_job_rest_required_fields(request_type=job_service.CreateHyperparameterTuningJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_hyperparameter_tuning_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_hyperparameter_tuning_job_rest_unset_required_fields():
    ...
    unset_fields = transport.create_hyperparameter_tuning_job._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("parent", "hyperparameterTuningJob", )))
...
def test_create_hyperparameter_tuning_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_create_hyperparameter_tuning_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_create_hyperparameter_tuning_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.CreateHyperparameterTuningJobRequest.pb(job_service.CreateHyperparameterTuningJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_hyperparameter_tuning_job.HyperparameterTuningJob.to_json(gca_hyperparameter_tuning_job.HyperparameterTuningJob())
        ...
        client.create_hyperparameter_tuning_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_hyperparameter_tuning_job_rest_bad_request(transport: str = 'rest', request_type=job_service.CreateHyperparameterTuningJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_hyperparameter_tuning_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/hyperparameterTuningJobs" % client.transport._host, args[1])
...
def test_get_hyperparameter_tuning_job_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/hyperparameterTuningJobs/sample3'}
    request = request_type(**request_init)
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = hyperparameter_tuning_job.HyperparameterTuningJob.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_get_hyperparameter_tuning_job_rest_required_fields(request_type=job_service.GetHyperparameterTuningJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_hyperparameter_tuning_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_hyperparameter_tuning_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_get_hyperparameter_tuning_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_get_hyperparameter_tuning_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.GetHyperparameterTuningJobRequest.pb(job_service.GetHyperparameterTuningJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = hyperparameter_tuning_job.HyperparameterTuningJob.to_json(hyperparameter_tuning_job.HyperparameterTuningJob())
        ...
        client.get_hyperparameter_tuning_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_hyperparameter_tuning_job_rest_bad_request(transport: str = 'rest', request_type=job_service.GetHyperparameterTuningJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_hyperparameter_tuning_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/hyperparameterTuningJobs/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/hyperparameterTuningJobs/*}" % client.transport._host, args[1])
...
def test_list_hyperparameter_tuning_jobs_rest_required_fields(request_type=job_service.ListHyperparameterTuningJobsRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_hyperparameter_tuning_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_hyperparameter_tuning_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_list_hyperparameter_tuning_jobs") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_list_hyperparameter_tuning_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.ListHyperparameterTuningJobsRequest.pb(job_service.ListHyperparameterTuningJobsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = job_service.ListHyperparameterTuningJobsResponse.to_json(job_service.ListHyperparameterTuningJobsResponse())
        ...
        client.list_hyperparameter_tuning_jobs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_hyperparameter_tuning_jobs_rest_bad_request(transport: str = 'rest', request_type=job_service.ListHyperparameterTuningJobsRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_hyperparameter_tuning_jobs_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(job_service.ListHyperparameterTuningJobsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pages = list(client.list_hyperparameter_tuning_jobs(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_delete_hyperparameter_tuning_job_rest_required_fields(request_type=job_service.DeleteHyperparameterTuningJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_hyperparameter_tuning_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_hyperparameter_tuning_job_rest_unset_required_fields():
    ...
    unset_fields = transport.delete_hyperparameter_tuning_job._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))
...
def test_delete_hyperparameter_tuning_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_delete_hyperparameter_tuning_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_delete_hyperparameter_tuning_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.DeleteHyperparameterTuningJobRequest.pb(job_service.DeleteHyperparameterTuningJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_hyperparameter_tuning_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_hyperparameter_tuning_job_rest_bad_request(transport: str = 'rest', request_type=job_service.DeleteHyperparameterTuningJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_hyperparameter_tuning_job_rest_required_fields(request_type=job_service.CancelHyperparameterTuningJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).cancel_hyperparameter_tuning_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_hyperparameter_tuning_job_rest_unset_required_fields():
    ...
    unset_fields = transport.cancel_hyperparameter_tuning_job._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))
...
def test_cancel_hyperparameter_tuning_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_cancel_hyperparameter_tuning_job") as pre:
        pre.assert_not_called()
        pb_message = job_service.CancelHyperparameterTuningJobRequest.pb(job_service.CancelHyperparameterTuningJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.cancel_hyperparameter_tuning_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_cancel_hyperparameter_tuning_job_rest_bad_request(transport: str = 'rest', request_type=job_service.CancelHyperparameterTuningJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_hyperparameter_tuning_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/hyperparameterTuningJobs/*}:cancel" % client.transport._host, args[1])
...
def test_create_nas_job_rest_required_fields(request_type=job_service.CreateNasJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_nas_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_nas_job_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "nasJob", )))
...
def test_create_nas_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_create_nas_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_create_nas_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.CreateNasJobRequest.pb(job_service.CreateNasJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_nas_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_nas_job_rest_bad_request(transport: str = 'rest', request_type=job_service.CreateNasJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_nas_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/nasJobs" % client.transport._host, args[1])
...
def test_get_nas_job_rest_required_fields(request_type=job_service.GetNasJobRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_nas_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_nas_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_get_nas_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_get_nas_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_nas_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_nas_job_rest_bad_request(transport: str = 'rest', request_type=job_service.GetNasJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_nas_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/nasJobs/*}" % client.transport._host, args[1])
...
def test_list_nas_jobs_rest_required_fields(request_type=job_service.ListNasJobsRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_nas_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_nas_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_list_nas_jobs") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_list_nas_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = job_service.ListNasJobsResponse.to_json(job_service.ListNasJobsResponse())
        ...
        client.list_nas_jobs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_nas_jobs_rest_bad_request(transport: str = 'rest', request_type=job_service.ListNasJobsRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_nas_job_rest_required_fields(request_type=job_service.DeleteNasJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_nas_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_nas_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_delete_nas_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_delete_nas_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.DeleteNasJobRequest.pb(job_service.DeleteNasJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_nas_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_nas_job_rest_bad_request(transport: str = 'rest', request_type=job_service.DeleteNasJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_nas_job_rest_required_fields(request_type=job_service.CancelNasJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).cancel_nas_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_nas_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_cancel_nas_job") as pre:
        pre.assert_not_called()
        pb_message = job_service.CancelNasJobRequest.pb(job_service.CancelNasJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.cancel_nas_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_cancel_nas_job_rest_bad_request(transport: str = 'rest', request_type=job_service.CancelNasJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_nas_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/nasJobs/*}:cancel" % client.transport._host, args[1])
...
def test_get_nas_trial_detail_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/nasJobs/sample3/nasTrialDetails/sample4'}
    request = request_type(**request_init)
...
def test_get_nas_trial_detail_rest_required_fields(request_type=job_service.GetNasTrialDetailRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_nas_trial_detail._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_nas_trial_detail_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_get_nas_trial_detail") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_get_nas_trial_detail") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.GetNasTrialDetailRequest.pb(job_service.GetNasTrialDetailRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = nas_job.NasTrialDetail.to_json(nas_job.NasTrialDetail())
        ...
        client.get_nas_trial_detail(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_nas_trial_detail_rest_bad_request(transport: str = 'rest', request_type=job_service.GetNasTrialDetailRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_nas_trial_detail_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/nasJobs/sample3/nasTrialDetails/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/nasJobs/*/nasTrialDetails/*}" % client.transport._host, args[1])
...
def test_list_nas_trial_details_rest_required_fields(request_type=job_service.ListNasTrialDetailsRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_nas_trial_details._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_nas_trial_details_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_list_nas_trial_details") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_list_nas_trial_details") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.ListNasTrialDetailsRequest.pb(job_service.ListNasTrialDetailsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = job_service.ListNasTrialDetailsResponse.to_json(job_service.ListNasTrialDetailsResponse())
        ...
        client.list_nas_trial_details(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_nas_trial_details_rest_bad_request(transport: str = 'rest', request_type=job_service.ListNasTrialDetailsRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_nas_trial_details_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/nasJobs/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/nasJobs/*}/nasTrialDetails" % client.transport._host, args[1])
...
def test_list_nas_trial_details_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(job_service.ListNasTrialDetailsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_create_batch_prediction_job_rest(request_type):
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["batch_prediction_job"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
...
def test_create_batch_prediction_job_rest_required_fields(request_type=job_service.CreateBatchPredictionJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_batch_prediction_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_batch_prediction_job_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "batchPredictionJob", )))
...
def test_create_batch_prediction_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_create_batch_prediction_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_create_batch_prediction_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.CreateBatchPredictionJobRequest.pb(job_service.CreateBatchPredictionJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_batch_prediction_job.BatchPredictionJob.to_json(gca_batch_prediction_job.BatchPredictionJob())
        ...
        client.create_batch_prediction_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_batch_prediction_job_rest_bad_request(transport: str = 'rest', request_type=job_service.CreateBatchPredictionJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_batch_prediction_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/batchPredictionJobs" % client.transport._host, args[1])
...
def test_get_batch_prediction_job_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/batchPredictionJobs/sample3'}
    request = request_type(**request_init)
...
def test_get_batch_prediction_job_rest_required_fields(request_type=job_service.GetBatchPredictionJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_batch_prediction_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_batch_prediction_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_get_batch_prediction_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_get_batch_prediction_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.GetBatchPredictionJobRequest.pb(job_service.GetBatchPredictionJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = batch_prediction_job.BatchPredictionJob.to_json(batch_prediction_job.BatchPredictionJob())
        ...
        client.get_batch_prediction_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_batch_prediction_job_rest_bad_request(transport: str = 'rest', request_type=job_service.GetBatchPredictionJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_batch_prediction_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/batchPredictionJobs/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/batchPredictionJobs/*}" % client.transport._host, args[1])
...
def test_list_batch_prediction_jobs_rest_required_fields(request_type=job_service.ListBatchPredictionJobsRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_batch_prediction_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_batch_prediction_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_list_batch_prediction_jobs") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_list_batch_prediction_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.ListBatchPredictionJobsRequest.pb(job_service.ListBatchPredictionJobsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = job_service.ListBatchPredictionJobsResponse.to_json(job_service.ListBatchPredictionJobsResponse())
        ...
        client.list_batch_prediction_jobs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_batch_prediction_jobs_rest_bad_request(transport: str = 'rest', request_type=job_service.ListBatchPredictionJobsRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_batch_prediction_jobs_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(job_service.ListBatchPredictionJobsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_delete_batch_prediction_job_rest_required_fields(request_type=job_service.DeleteBatchPredictionJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_batch_prediction_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_batch_prediction_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_delete_batch_prediction_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_delete_batch_prediction_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.DeleteBatchPredictionJobRequest.pb(job_service.DeleteBatchPredictionJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_batch_prediction_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_batch_prediction_job_rest_bad_request(transport: str = 'rest', request_type=job_service.DeleteBatchPredictionJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_batch_prediction_job_rest_required_fields(request_type=job_service.CancelBatchPredictionJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).cancel_batch_prediction_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_batch_prediction_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_cancel_batch_prediction_job") as pre:
        pre.assert_not_called()
        pb_message = job_service.CancelBatchPredictionJobRequest.pb(job_service.CancelBatchPredictionJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.cancel_batch_prediction_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_cancel_batch_prediction_job_rest_bad_request(transport: str = 'rest', request_type=job_service.CancelBatchPredictionJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_batch_prediction_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/batchPredictionJobs/*}:cancel" % client.transport._host, args[1])
...
def test_create_model_deployment_monitoring_job_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["model_deployment_monitoring_job"] = {'name': 'name_value', 'display_name': 'display_name_value', 'endpoint': 'endpoint_value', 'state': 1, 'schedule_state': 1, 'latest_monitoring_pipeline_metadata': {'run_time': {'seconds': 751, 'nanos': 543}, 'status': {'code': 411, 'message': 'message_value', 'details': [{'type_url': 'type.googleapis.com/google.protobuf.Duration', 'value': b'\x08\x0c\x10\xdb\x07'}]}}, 'model_deployment_monitoring_objective_configs': [{'deployed_model_id': 'deployed_model_id_value', 'objective_config': {'training_dataset': {'dataset': 'dataset_value', 'gcs_source': {'uris': ['uris_value1', 'uris_value2']}, 'bigquery_source': {'input_uri': 'input_uri_value'}, 'data_format': 'data_format_value', 'target_field': 'target_field_value', 'logging_sampling_strategy': {'random_sample_config': {'sample_rate': 0.1165}}}, 'training_prediction_skew_detection_config': {'skew_thresholds': {}, 'attribution_score_skew_thresholds': {}, 'default_skew_threshold': {'value': 0.541}}, 'prediction_drift_detection_config': {'drift_thresholds': {}, 'attribution_score_drift_thresholds': {}, 'default_drift_threshold': {}}, 'explanation_config': {'enable_feature_attributes': True, 'explanation_baseline': {'gcs': {'output_uri_prefix': 'output_uri_prefix_value'}, 'bigquery': {'output_uri': 'output_uri_value'}, 'prediction_format': 2}}}}], 'model_deployment_monitoring_schedule_config': {'monitor_interval': {'seconds': 751, 'nanos': 543}, 'monitor_window': {}}, 'logging_sampling_strategy': {}, 'model_monitoring_alert_config': {'email_alert_config': {'user_emails': ['user_emails_value1', 'user_emails_value2']}, 'enable_logging': True, 'notification_channels': ['notification_channels_value1', 'notification_channels_value2']}, 'predict_instance_schema_uri': 'predict_instance_schema_uri_value', 'sample_predict_instance': {'null_value': 0, 'number_value': 0.1285, 'string_value': 'string_value_value', 'bool_value': True, 'struct_value': {'fields': {}}, 'list_value': {'values': {}}}, 'analysis_instance_schema_uri': 'analysis_instance_schema_uri_value', 'bigquery_tables': [{'log_source': 1, 'log_type': 1, 'bigquery_table_path': 'bigquery_table_path_value', 'request_response_logging_schema_version': 'request_response_logging_schema_version_value'}], 'log_ttl': {}, 'labels': {}, 'create_time': {}, 'update_time': {}, 'next_schedule_time': {}, 'stats_anomalies_base_directory': {}, 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}, 'enable_monitoring_pipeline_logs': True, 'error': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = job_service.CreateModelDeploymentMonitoringJobRequest.meta.fields["model_deployment_monitoring_job"]
    ...
    # For each item in the sample request, create a list of sub fields which are not present at runtime
    # Add `# pragma: NO COVER` because this test code will not run if all subfields are present at runtime
    for field, value in request_init["model_deployment_monitoring_job"].items(): # pragma: NO COVER
        result = None
        is_repeated = False
        # For repeated fields
        if isinstance(value, list) and len(value):
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["model_deployment_monitoring_job"][field])):
                    del request_init["model_deployment_monitoring_job"][field][i][subfield]
            else:
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = gca_model_deployment_monitoring_job.ModelDeploymentMonitoringJob.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_create_model_deployment_monitoring_job_rest_required_fields(request_type=job_service.CreateModelDeploymentMonitoringJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_model_deployment_monitoring_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_model_deployment_monitoring_job_rest_unset_required_fields():
    ...
    unset_fields = transport.create_model_deployment_monitoring_job._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("parent", "modelDeploymentMonitoringJob", )))
...
def test_create_model_deployment_monitoring_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_create_model_deployment_monitoring_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_create_model_deployment_monitoring_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.CreateModelDeploymentMonitoringJobRequest.pb(job_service.CreateModelDeploymentMonitoringJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_model_deployment_monitoring_job.ModelDeploymentMonitoringJob.to_json(gca_model_deployment_monitoring_job.ModelDeploymentMonitoringJob())
        ...
        pre.return_value = request, metadata
        post.return_value = gca_model_deployment_monitoring_job.ModelDeploymentMonitoringJob()

        client.create_model_deployment_monitoring_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_model_deployment_monitoring_job_rest_bad_request(transport: str = 'rest', request_type=job_service.CreateModelDeploymentMonitoringJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_model_deployment_monitoring_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/modelDeploymentMonitoringJobs" % client.transport._host, args[1])


def test_create_model_deployment_monitoring_job_rest_flattened_error(transport: str = 'rest'):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_search_model_deployment_monitoring_stats_anomalies_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'model_deployment_monitoring_job': 'projects/sample1/locations/sample2/modelDeploymentMonitoringJobs/sample3'}
    request = request_type(**request_init)
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = job_service.SearchModelDeploymentMonitoringStatsAnomaliesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_search_model_deployment_monitoring_stats_anomalies_rest_required_fields(request_type=job_service.SearchModelDeploymentMonitoringStatsAnomaliesRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).search_model_deployment_monitoring_stats_anomalies._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)

    # verify required fields with default values are now present

    jsonified_request["modelDeploymentMonitoringJob"] = 'model_deployment_monitoring_job_value'
    ...
    assert jsonified_request["modelDeploymentMonitoringJob"] == 'model_deployment_monitoring_job_value'
...
def test_search_model_deployment_monitoring_stats_anomalies_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("modelDeploymentMonitoringJob", "deployedModelId", "objectives", )))


@pytest.mark.parametrize("null_interceptor", [True, False])
def test_search_model_deployment_monitoring_stats_anomalies_rest_interceptors(null_interceptor):
    transport = transports.JobServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.JobServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_search_model_deployment_monitoring_stats_anomalies") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_search_model_deployment_monitoring_stats_anomalies") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.SearchModelDeploymentMonitoringStatsAnomaliesRequest.pb(job_service.SearchModelDeploymentMonitoringStatsAnomaliesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = job_service.SearchModelDeploymentMonitoringStatsAnomaliesResponse.to_json(job_service.SearchModelDeploymentMonitoringStatsAnomaliesResponse())
        ...
        pre.return_value = request, metadata
        post.return_value = job_service.SearchModelDeploymentMonitoringStatsAnomaliesResponse()

        client.search_model_deployment_monitoring_stats_anomalies(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_search_model_deployment_monitoring_stats_anomalies_rest_bad_request(transport: str = 'rest', request_type=job_service.SearchModelDeploymentMonitoringStatsAnomaliesRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_search_model_deployment_monitoring_stats_anomalies_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'model_deployment_monitoring_job': 'projects/sample1/locations/sample2/modelDeploymentMonitoringJobs/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{model_deployment_monitoring_job=projects/*/locations/*/modelDeploymentMonitoringJobs/*}:searchModelDeploymentMonitoringStatsAnomalies" % client.transport._host, args[1])


def test_search_model_deployment_monitoring_stats_anomalies_rest_flattened_error(transport: str = 'rest'):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_search_model_deployment_monitoring_stats_anomalies_rest_pager(transport: str = 'rest'):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(job_service.SearchModelDeploymentMonitoringStatsAnomaliesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pages = list(client.search_model_deployment_monitoring_stats_anomalies(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_model_deployment_monitoring_job_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/modelDeploymentMonitoringJobs/sample3'}
    request = request_type(**request_init)
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = model_deployment_monitoring_job.ModelDeploymentMonitoringJob.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_get_model_deployment_monitoring_job_rest_required_fields(request_type=job_service.GetModelDeploymentMonitoringJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_model_deployment_monitoring_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_model_deployment_monitoring_job_rest_unset_required_fields():
    ...
    unset_fields = transport.get_model_deployment_monitoring_job._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))
...
def test_get_model_deployment_monitoring_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_get_model_deployment_monitoring_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_get_model_deployment_monitoring_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.GetModelDeploymentMonitoringJobRequest.pb(job_service.GetModelDeploymentMonitoringJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = model_deployment_monitoring_job.ModelDeploymentMonitoringJob.to_json(model_deployment_monitoring_job.ModelDeploymentMonitoringJob())
        ...
        pre.return_value = request, metadata
        post.return_value = model_deployment_monitoring_job.ModelDeploymentMonitoringJob()

        client.get_model_deployment_monitoring_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_model_deployment_monitoring_job_rest_bad_request(transport: str = 'rest', request_type=job_service.GetModelDeploymentMonitoringJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_model_deployment_monitoring_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/modelDeploymentMonitoringJobs/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/modelDeploymentMonitoringJobs/*}" % client.transport._host, args[1])


def test_get_model_deployment_monitoring_job_rest_flattened_error(transport: str = 'rest'):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_model_deployment_monitoring_jobs_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = job_service.ListModelDeploymentMonitoringJobsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_list_model_deployment_monitoring_jobs_rest_required_fields(request_type=job_service.ListModelDeploymentMonitoringJobsRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_model_deployment_monitoring_jobs._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_model_deployment_monitoring_jobs_rest_unset_required_fields():
    ...
    unset_fields = transport.list_model_deployment_monitoring_jobs._get_unset_required_fields({})
    assert set(unset_fields) == (set(("filter", "pageSize", "pageToken", "readMask", )) & set(("parent", )))
...
def test_list_model_deployment_monitoring_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_list_model_deployment_monitoring_jobs") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_list_model_deployment_monitoring_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.ListModelDeploymentMonitoringJobsRequest.pb(job_service.ListModelDeploymentMonitoringJobsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = job_service.ListModelDeploymentMonitoringJobsResponse.to_json(job_service.ListModelDeploymentMonitoringJobsResponse())
        ...
        client.list_model_deployment_monitoring_jobs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_model_deployment_monitoring_jobs_rest_bad_request(transport: str = 'rest', request_type=job_service.ListModelDeploymentMonitoringJobsRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_model_deployment_monitoring_jobs_rest_flattened_error(transport: str = 'rest'):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_model_deployment_monitoring_jobs_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(job_service.ListModelDeploymentMonitoringJobsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
        ...
        pages = list(client.list_model_deployment_monitoring_jobs(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_update_model_deployment_monitoring_job_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'model_deployment_monitoring_job': {'name': 'projects/sample1/locations/sample2/modelDeploymentMonitoringJobs/sample3'}}
    request_init["model_deployment_monitoring_job"] = {'name': 'projects/sample1/locations/sample2/modelDeploymentMonitoringJobs/sample3', 'display_name': 'display_name_value', 'endpoint': 'endpoint_value', 'state': 1, 'schedule_state': 1, 'latest_monitoring_pipeline_metadata': {'run_time': {'seconds': 751, 'nanos': 543}, 'status': {'code': 411, 'message': 'message_value', 'details': [{'type_url': 'type.googleapis.com/google.protobuf.Duration', 'value': b'\x08\x0c\x10\xdb\x07'}]}}, 'model_deployment_monitoring_objective_configs': [{'deployed_model_id': 'deployed_model_id_value', 'objective_config': {'training_dataset': {'dataset': 'dataset_value', 'gcs_source': {'uris': ['uris_value1', 'uris_value2']}, 'bigquery_source': {'input_uri': 'input_uri_value'}, 'data_format': 'data_format_value', 'target_field': 'target_field_value', 'logging_sampling_strategy': {'random_sample_config': {'sample_rate': 0.1165}}}, 'training_prediction_skew_detection_config': {'skew_thresholds': {}, 'attribution_score_skew_thresholds': {}, 'default_skew_threshold': {'value': 0.541}}, 'prediction_drift_detection_config': {'drift_thresholds': {}, 'attribution_score_drift_thresholds': {}, 'default_drift_threshold': {}}, 'explanation_config': {'enable_feature_attributes': True, 'explanation_baseline': {'gcs': {'output_uri_prefix': 'output_uri_prefix_value'}, 'bigquery': {'output_uri': 'output_uri_value'}, 'prediction_format': 2}}}}], 'model_deployment_monitoring_schedule_config': {'monitor_interval': {'seconds': 751, 'nanos': 543}, 'monitor_window': {}}, 'logging_sampling_strategy': {}, 'model_monitoring_alert_config': {'email_alert_config': {'user_emails': ['user_emails_value1', 'user_emails_value2']}, 'enable_logging': True, 'notification_channels': ['notification_channels_value1', 'notification_channels_value2']}, 'predict_instance_schema_uri': 'predict_instance_schema_uri_value', 'sample_predict_instance': {'null_value': 0, 'number_value': 0.1285, 'string_value': 'string_value_value', 'bool_value': True, 'struct_value': {'fields': {}}, 'list_value': {'values': {}}}, 'analysis_instance_schema_uri': 'analysis_instance_schema_uri_value', 'bigquery_tables': [{'log_source': 1, 'log_type': 1, 'bigquery_table_path': 'bigquery_table_path_value', 'request_response_logging_schema_version': 'request_response_logging_schema_version_value'}], 'log_ttl': {}, 'labels': {}, 'create_time': {}, 'update_time': {}, 'next_schedule_time': {}, 'stats_anomalies_base_directory': {}, 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}, 'enable_monitoring_pipeline_logs': True, 'error': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = job_service.UpdateModelDeploymentMonitoringJobRequest.meta.fields["model_deployment_monitoring_job"]
...
def test_update_model_deployment_monitoring_job_rest_required_fields(request_type=job_service.UpdateModelDeploymentMonitoringJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_model_deployment_monitoring_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_model_deployment_monitoring_job_rest_unset_required_fields():
    ...
    unset_fields = transport.update_model_deployment_monitoring_job._get_unset_required_fields({})
    assert set(unset_fields) == (set(("updateMask", )) & set(("modelDeploymentMonitoringJob", "updateMask", )))
...
def test_update_model_deployment_monitoring_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_update_model_deployment_monitoring_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_update_model_deployment_monitoring_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.UpdateModelDeploymentMonitoringJobRequest.pb(job_service.UpdateModelDeploymentMonitoringJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_model_deployment_monitoring_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_model_deployment_monitoring_job_rest_bad_request(transport: str = 'rest', request_type=job_service.UpdateModelDeploymentMonitoringJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_model_deployment_monitoring_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'model_deployment_monitoring_job': {'name': 'projects/sample1/locations/sample2/modelDeploymentMonitoringJobs/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{model_deployment_monitoring_job.name=projects/*/locations/*/modelDeploymentMonitoringJobs/*}" % client.transport._host, args[1])


def test_update_model_deployment_monitoring_job_rest_flattened_error(transport: str = 'rest'):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_model_deployment_monitoring_job_rest_required_fields(request_type=job_service.DeleteModelDeploymentMonitoringJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_model_deployment_monitoring_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_model_deployment_monitoring_job_rest_unset_required_fields():
    ...
    unset_fields = transport.delete_model_deployment_monitoring_job._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))
...
def test_delete_model_deployment_monitoring_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.JobServiceRestInterceptor, "post_delete_model_deployment_monitoring_job") as post, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_delete_model_deployment_monitoring_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = job_service.DeleteModelDeploymentMonitoringJobRequest.pb(job_service.DeleteModelDeploymentMonitoringJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_model_deployment_monitoring_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_model_deployment_monitoring_job_rest_bad_request(transport: str = 'rest', request_type=job_service.DeleteModelDeploymentMonitoringJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_model_deployment_monitoring_job_rest_flattened_error(transport: str = 'rest'):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_pause_model_deployment_monitoring_job_rest_required_fields(request_type=job_service.PauseModelDeploymentMonitoringJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).pause_model_deployment_monitoring_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_pause_model_deployment_monitoring_job_rest_unset_required_fields():
    ...
    unset_fields = transport.pause_model_deployment_monitoring_job._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))
...
def test_pause_model_deployment_monitoring_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_pause_model_deployment_monitoring_job") as pre:
        pre.assert_not_called()
        pb_message = job_service.PauseModelDeploymentMonitoringJobRequest.pb(job_service.PauseModelDeploymentMonitoringJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.pause_model_deployment_monitoring_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_pause_model_deployment_monitoring_job_rest_bad_request(transport: str = 'rest', request_type=job_service.PauseModelDeploymentMonitoringJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_pause_model_deployment_monitoring_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/modelDeploymentMonitoringJobs/*}:pause" % client.transport._host, args[1])


def test_pause_model_deployment_monitoring_job_rest_flattened_error(transport: str = 'rest'):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resume_model_deployment_monitoring_job_rest_required_fields(request_type=job_service.ResumeModelDeploymentMonitoringJobRequest):
    transport_class = transports.JobServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).resume_model_deployment_monitoring_job._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_resume_model_deployment_monitoring_job_rest_unset_required_fields():
    ...
    unset_fields = transport.resume_model_deployment_monitoring_job._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", )))
...
def test_resume_model_deployment_monitoring_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.JobServiceRestInterceptor, "pre_resume_model_deployment_monitoring_job") as pre:
        pre.assert_not_called()
        pb_message = job_service.ResumeModelDeploymentMonitoringJobRequest.pb(job_service.ResumeModelDeploymentMonitoringJobRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.resume_model_deployment_monitoring_job(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_resume_model_deployment_monitoring_job_rest_bad_request(transport: str = 'rest', request_type=job_service.ResumeModelDeploymentMonitoringJobRequest):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resume_model_deployment_monitoring_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/modelDeploymentMonitoringJobs/*}:resume" % client.transport._host, args[1])


def test_resume_model_deployment_monitoring_job_rest_flattened_error(transport: str = 'rest'):
    client = JobServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_job_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1beta1.services.job_service.transports.JobServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_job_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1beta1.services.job_service.transports.JobServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.JobServiceTransport()
        adc.assert_called_once()
...
def test_job_service_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.search_model_deployment_monitoring_stats_anomalies._session
    session2 = client2.transport.search_model_deployment_monitoring_stats_anomalies._session
    assert session1 != session2
...
def test_model_deployment_monitoring_job_path():
    ...
    actual = JobServiceClient.model_deployment_monitoring_job_path(project, location, model_deployment_monitoring_job)
    assert expected == actual
...
def test_nas_job_path():
    ...
    location = "nautilus"
    nas_job = "scallop"
    expected = "projects/{project}/locations/{location}/nasJobs/{nas_job}".format(project=project, location=location, nas_job=nas_job, )
...
def test_nas_trial_detail_path():
    ...
    expected = "projects/{project}/locations/{location}/nasJobs/{nas_job}/nasTrialDetails/{nas_trial_detail}".format(project=project, location=location, nas_job=nas_job, nas_trial_detail=nas_trial_detail, )
    actual = JobServiceClient.nas_trial_detail_path(project, location, nas_job, nas_trial_detail)
    assert expected == actual
...
def test_persistent_resource_path():
    ...
    actual = JobServiceClient.persistent_resource_path(project, location, persistent_resource)
    assert expected == actual
