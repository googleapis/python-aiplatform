...
def test_create_rag_corpus_empty_call():
...
@pytest.mark.asyncio
async def test_create_rag_corpus_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
...
def test_create_rag_corpus_rest(request_type):
    ...
    request_init["rag_corpus"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'rag_embedding_model_config': {'vertex_prediction_endpoint': {'endpoint': 'endpoint_value', 'model': 'model_value', 'model_version_id': 'model_version_id_value'}, 'hybrid_search_config': {'sparse_embedding_config': {'bm25': {'multilingual': True, 'k1': 0.156, 'b': 0.98}}, 'dense_embedding_model_prediction_endpoint': {}}}, 'rag_vector_db_config': {'rag_managed_db': {}, 'weaviate': {'http_endpoint': 'http_endpoint_value', 'collection_name': 'collection_name_value'}, 'vertex_feature_store': {'feature_view_resource_name': 'feature_view_resource_name_value'}, 'api_auth': {'api_key_config': {'api_key_secret_version': 'api_key_secret_version_value'}}}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'corpus_status': {'state': 1, 'error_status': 'error_status_value'}}
...
def test_create_rag_corpus_rest_bad_request(transport: str = 'rest', request_type=vertex_rag_data_service.CreateRagCorpusRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_rag_corpus_rest_bad_request(transport: str = 'rest', request_type=vertex_rag_data_service.UpdateRagCorpusRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_rag_corpus_rest(request_type):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_rag_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = vertex_rag_data.RagCorpus.to_json(vertex_rag_data.RagCorpus())
...
def test_get_rag_corpus_rest_bad_request(transport: str = 'rest', request_type=vertex_rag_data_service.GetRagCorpusRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_rag_corpora_rest(request_type):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_list_rag_corpora_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = vertex_rag_data_service.ListRagCorporaResponse.to_json(vertex_rag_data_service.ListRagCorporaResponse())
...
def test_list_rag_corpora_rest_bad_request(transport: str = 'rest', request_type=vertex_rag_data_service.ListRagCorporaRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rag_corpus_rest(request_type):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_delete_rag_corpus_rest_bad_request(transport: str = 'rest', request_type=vertex_rag_data_service.DeleteRagCorpusRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rag_corpus_rest_error():
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_upload_rag_file_rest(request_type):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_upload_rag_file_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = vertex_rag_data_service.UploadRagFileResponse.to_json(vertex_rag_data_service.UploadRagFileResponse())
...
def test_upload_rag_file_rest_bad_request(transport: str = 'rest', request_type=vertex_rag_data_service.UploadRagFileRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_upload_rag_file_rest_error():
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_import_rag_files_rest(request_type):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_import_rag_files_rest_bad_request(transport: str = 'rest', request_type=vertex_rag_data_service.ImportRagFilesRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_rag_files_rest_error():
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_get_rag_file_rest(request_type):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_rag_file_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = vertex_rag_data.RagFile.to_json(vertex_rag_data.RagFile())
...
def test_get_rag_file_rest_bad_request(transport: str = 'rest', request_type=vertex_rag_data_service.GetRagFileRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_rag_file_rest_error():
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_list_rag_files_rest(request_type):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_list_rag_files_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = vertex_rag_data_service.ListRagFilesResponse.to_json(vertex_rag_data_service.ListRagFilesResponse())
...
def test_list_rag_files_rest_bad_request(transport: str = 'rest', request_type=vertex_rag_data_service.ListRagFilesRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_rag_file_rest(request_type):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_delete_rag_file_rest_bad_request(transport: str = 'rest', request_type=vertex_rag_data_service.DeleteRagFileRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_transport_kind(transport_name):
    transport = VertexRagDataServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
