...
from google.cloud.aiplatform_v1beta1.services.vertex_rag_data_service import VertexRagDataServiceAsyncClient
from google.cloud.aiplatform_v1beta1.services.vertex_rag_data_service import VertexRagDataServiceClient
...
def test__get_default_mtls_endpoint():
    ...
    assert VertexRagDataServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert VertexRagDataServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert VertexRagDataServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert VertexRagDataServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert VertexRagDataServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

def test__read_environment_variables():
    assert VertexRagDataServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert VertexRagDataServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert VertexRagDataServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert VertexRagDataServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert VertexRagDataServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert VertexRagDataServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert VertexRagDataServiceClient._use_client_cert_effective() is False
...
def test__get_client_cert_source():
    ...
    assert VertexRagDataServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert VertexRagDataServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert VertexRagDataServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert VertexRagDataServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(VertexRagDataServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VertexRagDataServiceClient))
@mock.patch.object(VertexRagDataServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VertexRagDataServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = VertexRagDataServiceClient._DEFAULT_UNIVERSE
    default_endpoint = VertexRagDataServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = VertexRagDataServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert VertexRagDataServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert VertexRagDataServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == VertexRagDataServiceClient.DEFAULT_MTLS_ENDPOINT
    assert VertexRagDataServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert VertexRagDataServiceClient._get_api_endpoint(None, None, default_universe, "always") == VertexRagDataServiceClient.DEFAULT_MTLS_ENDPOINT
    assert VertexRagDataServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == VertexRagDataServiceClient.DEFAULT_MTLS_ENDPOINT
    assert VertexRagDataServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert VertexRagDataServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        VertexRagDataServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert VertexRagDataServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert VertexRagDataServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert VertexRagDataServiceClient._get_universe_domain(None, None) == VertexRagDataServiceClient._DEFAULT_UNIVERSE
...
def test_vertex_rag_data_service_client_from_service_account_info(client_class, transport_name):
...
def test_vertex_rag_data_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_vertex_rag_data_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (VertexRagDataServiceClient, transports.VertexRagDataServiceGrpcTransport, "grpc"),
    (VertexRagDataServiceAsyncClient, transports.VertexRagDataServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (VertexRagDataServiceClient, transports.VertexRagDataServiceRestTransport, "rest"),
])
@mock.patch.object(VertexRagDataServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VertexRagDataServiceClient))
@mock.patch.object(VertexRagDataServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VertexRagDataServiceAsyncClient))
def test_vertex_rag_data_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (VertexRagDataServiceClient, transports.VertexRagDataServiceGrpcTransport, "grpc", "true"),
    (VertexRagDataServiceAsyncClient, transports.VertexRagDataServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (VertexRagDataServiceClient, transports.VertexRagDataServiceGrpcTransport, "grpc", "false"),
    (VertexRagDataServiceAsyncClient, transports.VertexRagDataServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (VertexRagDataServiceClient, transports.VertexRagDataServiceRestTransport, "rest", "true"),
    (VertexRagDataServiceClient, transports.VertexRagDataServiceRestTransport, "rest", "false"),
])
@mock.patch.object(VertexRagDataServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VertexRagDataServiceClient))
@mock.patch.object(VertexRagDataServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(VertexRagDataServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_vertex_rag_data_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    VertexRagDataServiceClient, VertexRagDataServiceAsyncClient
])
@mock.patch.object(VertexRagDataServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(VertexRagDataServiceClient))
@mock.patch.object(VertexRagDataServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(VertexRagDataServiceAsyncClient))
...
def test_vertex_rag_data_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (VertexRagDataServiceClient, transports.VertexRagDataServiceGrpcTransport, "grpc", grpc_helpers),
    (VertexRagDataServiceAsyncClient, transports.VertexRagDataServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (VertexRagDataServiceClient, transports.VertexRagDataServiceRestTransport, "rest", None),
])
def test_vertex_rag_data_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_vertex_rag_data_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1beta1.services.vertex_rag_data_service.transports.VertexRagDataServiceGrpcTransport.__init__') as grpc_transport:
...
def test_vertex_rag_data_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_create_rag_corpus(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_rag_corpus),
            '__call__') as call:
...
def test_create_rag_corpus_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.create_rag_corpus] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_rag_corpus_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_rag_corpus in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_rag_corpus] = mock_rpc
...
@pytest.mark.asyncio
async def test_create_rag_corpus_async(transport: str = 'grpc_asyncio', request_type=vertex_rag_data_service.CreateRagCorpusRequest):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_rag_corpus_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_rag_corpus(
            parent='parent_value',
            rag_corpus=vertex_rag_data.RagCorpus(vector_db_config=vertex_rag_data.RagVectorDbConfig(rag_managed_db=vertex_rag_data.RagVectorDbConfig.RagManagedDb(knn=None))),
        )
        ...
        mock_val = vertex_rag_data.RagCorpus(vector_db_config=vertex_rag_data.RagVectorDbConfig(rag_managed_db=vertex_rag_data.RagVectorDbConfig.RagManagedDb(knn=None)))
        assert arg == mock_val
...
def test_update_rag_corpus(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_rag_corpus),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_update_rag_corpus_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VertexRagDataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_rag_corpus in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_rag_corpus] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_rag_corpus_async(transport: str = 'grpc_asyncio', request_type=vertex_rag_data_service.UpdateRagCorpusRequest):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_rag_corpus(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_rag_corpus),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_rag_corpus_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VertexRagDataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_rag_corpus in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_rag_corpus] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_rag_corpus_async(transport: str = 'grpc_asyncio', request_type=vertex_rag_data_service.GetRagCorpusRequest):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(vertex_rag_data.RagCorpus(
            name='name_value',
            display_name='display_name_value',
            description='description_value',
            rag_files_count=1588,
...
def test_list_rag_corpora(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_rag_corpora),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_rag_corpora_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_rag_corpora] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_rag_corpora_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VertexRagDataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_rag_corpora in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_rag_corpora] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_rag_corpora_async(transport: str = 'grpc_asyncio', request_type=vertex_rag_data_service.ListRagCorporaRequest):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(vertex_rag_data_service.ListRagCorporaResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_delete_rag_corpus(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_rag_corpus),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_rag_corpus_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_rag_corpus] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_rag_corpus_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VertexRagDataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_rag_corpus in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_rag_corpus] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_rag_corpus_async(transport: str = 'grpc_asyncio', request_type=vertex_rag_data_service.DeleteRagCorpusRequest):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_upload_rag_file(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.upload_rag_file),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_upload_rag_file_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VertexRagDataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.upload_rag_file in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.upload_rag_file] = mock_rpc
...
@pytest.mark.asyncio
async def test_upload_rag_file_async(transport: str = 'grpc_asyncio', request_type=vertex_rag_data_service.UploadRagFileRequest):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(vertex_rag_data_service.UploadRagFileResponse(
        ))
...
def test_upload_rag_file_flattened():
    ...
    with mock.patch.object(
        ...
        client.upload_rag_file(
            parent='parent_value',
            rag_file=vertex_rag_data.RagFile(gcs_source=io.GcsSource(uris=['uris_value'])),
            upload_rag_file_config=vertex_rag_data.UploadRagFileConfig(rag_file_chunking_config=vertex_rag_data.RagFileChunkingConfig(fixed_length_chunking=vertex_rag_data.RagFileChunkingConfig.FixedLengthChunking(chunk_size=1075))),
        )
        ...
        mock_val = vertex_rag_data.UploadRagFileConfig(rag_file_chunking_config=vertex_rag_data.RagFileChunkingConfig(fixed_length_chunking=vertex_rag_data.RagFileChunkingConfig.FixedLengthChunking(chunk_size=1075)))
        assert arg == mock_val
...
def test_import_rag_files(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.import_rag_files),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_import_rag_files_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.import_rag_files] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_import_rag_files_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VertexRagDataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_rag_files in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_rag_files] = mock_rpc
...
@pytest.mark.asyncio
async def test_import_rag_files_async(transport: str = 'grpc_asyncio', request_type=vertex_rag_data_service.ImportRagFilesRequest):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_import_rag_files_flattened():
    ...
    with mock.patch.object(
        ...
        client.import_rag_files(
            parent='parent_value',
            import_rag_files_config=vertex_rag_data.ImportRagFilesConfig(gcs_source=io.GcsSource(uris=['uris_value'])),
        )
        ...
        mock_val = vertex_rag_data.ImportRagFilesConfig(gcs_source=io.GcsSource(uris=['uris_value']))
        assert arg == mock_val
...
def test_get_rag_file(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_rag_file),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.rag_file_type == vertex_rag_data.RagFile.RagFileType.RAG_FILE_TYPE_TXT
...
@pytest.mark.asyncio
async def test_get_rag_file_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VertexRagDataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_rag_file in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_rag_file] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_rag_file_async(transport: str = 'grpc_asyncio', request_type=vertex_rag_data_service.GetRagFileRequest):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(vertex_rag_data.RagFile(
            name='name_value',
            display_name='display_name_value',
            description='description_value',
            size_bytes=1089,
...
def test_list_rag_files(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_rag_files),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_rag_files_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VertexRagDataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_rag_files in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_rag_files] = mock_rpc
...
@pytest.mark.asyncio
async def test_list_rag_files_async(transport: str = 'grpc_asyncio', request_type=vertex_rag_data_service.ListRagFilesRequest):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(vertex_rag_data_service.ListRagFilesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_delete_rag_file(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_rag_file),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_delete_rag_file_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VertexRagDataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_rag_file in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_rag_file] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_rag_file_async(transport: str = 'grpc_asyncio', request_type=vertex_rag_data_service.DeleteRagFileRequest):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_rag_engine_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_rag_engine_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_rag_engine_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_rag_engine_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_rag_engine_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_rag_engine_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VertexRagDataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_rag_engine_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_rag_engine_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_rag_engine_config_async(transport: str = 'grpc_asyncio', request_type=vertex_rag_data_service.UpdateRagEngineConfigRequest):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_rag_engine_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_rag_engine_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_rag_engine_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_rag_engine_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_rag_engine_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_rag_engine_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = VertexRagDataServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_rag_engine_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_rag_engine_config] = mock_rpc
...
@pytest.mark.asyncio
async def test_get_rag_engine_config_async(transport: str = 'grpc_asyncio', request_type=vertex_rag_data_service.GetRagEngineConfigRequest):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_rag_corpus_rest_required_fields(request_type=vertex_rag_data_service.CreateRagCorpusRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_rag_corpus._get_unset_required_fields(jsonified_request)
...
def test_create_rag_corpus_rest_unset_required_fields():
    transport = transports.VertexRagDataServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_rag_corpus._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("parent", "ragCorpus", )))
...
def test_create_rag_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/ragCorpora" % client.transport._host, args[1])
...
def test_update_rag_corpus_rest_required_fields(request_type=vertex_rag_data_service.UpdateRagCorpusRequest):
    transport_class = transports.VertexRagDataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_rag_corpus._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_rag_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'rag_corpus': {'name': 'projects/sample1/locations/sample2/ragCorpora/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{rag_corpus.name=projects/*/locations/*/ragCorpora/*}" % client.transport._host, args[1])
...
def test_get_rag_corpus_rest_required_fields(request_type=vertex_rag_data_service.GetRagCorpusRequest):
    transport_class = transports.VertexRagDataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_rag_corpus._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_rag_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/ragCorpora/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/ragCorpora/*}" % client.transport._host, args[1])
...
def test_list_rag_corpora_rest_required_fields(request_type=vertex_rag_data_service.ListRagCorporaRequest):
    transport_class = transports.VertexRagDataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_rag_corpora._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_rag_corpora_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(vertex_rag_data_service.ListRagCorporaResponse.to_json(x) for x in response)
...
def test_delete_rag_corpus_rest_required_fields(request_type=vertex_rag_data_service.DeleteRagCorpusRequest):
    transport_class = transports.VertexRagDataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_rag_corpus._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_rag_corpus._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("force", "force_delete", ))
    jsonified_request.update(unset_fields)
...
def test_delete_rag_corpus_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("force", "forceDelete", )) & set(("name", )))
...
def test_upload_rag_file_rest_required_fields(request_type=vertex_rag_data_service.UploadRagFileRequest):
    transport_class = transports.VertexRagDataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).upload_rag_file._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_upload_rag_file_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "ragFile", "uploadRagFileConfig", )))
...
def test_upload_rag_file_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles:upload" % client.transport._host, args[1])
...
def test_import_rag_files_rest_required_fields(request_type=vertex_rag_data_service.ImportRagFilesRequest):
    transport_class = transports.VertexRagDataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_rag_files._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_rag_files_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "importRagFilesConfig", )))
...
def test_import_rag_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles:import" % client.transport._host, args[1])
...
def test_get_rag_file_rest_required_fields(request_type=vertex_rag_data_service.GetRagFileRequest):
    transport_class = transports.VertexRagDataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_rag_file._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_rag_file_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/ragCorpora/sample3/ragFiles/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/ragCorpora/*/ragFiles/*}" % client.transport._host, args[1])
...
def test_list_rag_files_rest_required_fields(request_type=vertex_rag_data_service.ListRagFilesRequest):
    transport_class = transports.VertexRagDataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_rag_files._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_rag_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles" % client.transport._host, args[1])
...
def test_list_rag_files_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(vertex_rag_data_service.ListRagFilesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_delete_rag_file_rest_required_fields(request_type=vertex_rag_data_service.DeleteRagFileRequest):
    transport_class = transports.VertexRagDataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_rag_file._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_rag_engine_config_rest_required_fields(request_type=vertex_rag_data_service.UpdateRagEngineConfigRequest):
    transport_class = transports.VertexRagDataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_rag_engine_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_rag_engine_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'rag_engine_config': {'name': 'projects/sample1/locations/sample2/ragEngineConfig'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{rag_engine_config.name=projects/*/locations/*/ragEngineConfig}" % client.transport._host, args[1])
...
def test_get_rag_engine_config_rest_required_fields(request_type=vertex_rag_data_service.GetRagEngineConfigRequest):
    transport_class = transports.VertexRagDataServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_rag_engine_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_rag_engine_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/ragEngineConfig}" % client.transport._host, args[1])
...
def test_create_rag_corpus_rest_bad_request(request_type=vertex_rag_data_service.CreateRagCorpusRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_rag_corpus_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["rag_corpus"] = {'vector_db_config': {'rag_managed_db': {'knn': {}, 'ann': {'tree_depth': 1060, 'leaf_count': 1056}}, 'weaviate': {'http_endpoint': 'http_endpoint_value', 'collection_name': 'collection_name_value'}, 'pinecone': {'index_name': 'index_name_value'}, 'vertex_feature_store': {'feature_view_resource_name': 'feature_view_resource_name_value'}, 'vertex_vector_search': {'index_endpoint': 'index_endpoint_value', 'index': 'index_value'}, 'rag_managed_vertex_vector_search': {'collection_name': 'collection_name_value'}, 'api_auth': {'api_key_config': {'api_key_secret_version': 'api_key_secret_version_value'}}, 'rag_embedding_model_config': {'vertex_prediction_endpoint': {'endpoint': 'endpoint_value', 'model': 'model_value', 'model_version_id': 'model_version_id_value'}, 'hybrid_search_config': {'sparse_embedding_config': {'bm25': {'multilingual': True, 'k1': 0.156, 'b': 0.98}}, 'dense_embedding_model_prediction_endpoint': {}}}}, 'vertex_ai_search_config': {'serving_config': 'serving_config_value'}, 'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'rag_embedding_model_config': {}, 'rag_vector_db_config': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'corpus_status': {'state': 1, 'error_status': 'error_status_value'}, 'rag_files_count': 1588, 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}, 'corpus_type_config': {'document_corpus': {}, 'memory_corpus': {'llm_parser': {'model_name': 'model_name_value', 'max_parsing_requests_per_min': 3005, 'global_max_parsing_requests_per_min': 3725, 'custom_parsing_prompt': 'custom_parsing_prompt_value'}}}, 'satisfies_pzs': True, 'satisfies_pzi': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = vertex_rag_data_service.CreateRagCorpusRequest.meta.fields["rag_corpus"]
...
def test_create_rag_corpus_rest_interceptors(null_interceptor):
    transport = transports.VertexRagDataServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.VertexRagDataServiceRestInterceptor(),
        )
    client = VertexRagDataServiceClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_create_rag_corpus") as post, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_create_rag_corpus_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "pre_create_rag_corpus") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.CreateRagCorpusRequest.pb(vertex_rag_data_service.CreateRagCorpusRequest())
        ...
        client.create_rag_corpus(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_rag_corpus_rest_bad_request(request_type=vertex_rag_data_service.UpdateRagCorpusRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'rag_corpus': {'name': 'projects/sample1/locations/sample2/ragCorpora/sample3'}}
    request = request_type(**request_init)
...
def test_update_rag_corpus_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'rag_corpus': {'name': 'projects/sample1/locations/sample2/ragCorpora/sample3'}}
    request_init["rag_corpus"] = {'vector_db_config': {'rag_managed_db': {'knn': {}, 'ann': {'tree_depth': 1060, 'leaf_count': 1056}}, 'weaviate': {'http_endpoint': 'http_endpoint_value', 'collection_name': 'collection_name_value'}, 'pinecone': {'index_name': 'index_name_value'}, 'vertex_feature_store': {'feature_view_resource_name': 'feature_view_resource_name_value'}, 'vertex_vector_search': {'index_endpoint': 'index_endpoint_value', 'index': 'index_value'}, 'rag_managed_vertex_vector_search': {'collection_name': 'collection_name_value'}, 'api_auth': {'api_key_config': {'api_key_secret_version': 'api_key_secret_version_value'}}, 'rag_embedding_model_config': {'vertex_prediction_endpoint': {'endpoint': 'endpoint_value', 'model': 'model_value', 'model_version_id': 'model_version_id_value'}, 'hybrid_search_config': {'sparse_embedding_config': {'bm25': {'multilingual': True, 'k1': 0.156, 'b': 0.98}}, 'dense_embedding_model_prediction_endpoint': {}}}}, 'vertex_ai_search_config': {'serving_config': 'serving_config_value'}, 'name': 'projects/sample1/locations/sample2/ragCorpora/sample3', 'display_name': 'display_name_value', 'description': 'description_value', 'rag_embedding_model_config': {}, 'rag_vector_db_config': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'corpus_status': {'state': 1, 'error_status': 'error_status_value'}, 'rag_files_count': 1588, 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}, 'corpus_type_config': {'document_corpus': {}, 'memory_corpus': {'llm_parser': {'model_name': 'model_name_value', 'max_parsing_requests_per_min': 3005, 'global_max_parsing_requests_per_min': 3725, 'custom_parsing_prompt': 'custom_parsing_prompt_value'}}}, 'satisfies_pzs': True, 'satisfies_pzi': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = vertex_rag_data_service.UpdateRagCorpusRequest.meta.fields["rag_corpus"]
...
def test_update_rag_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_update_rag_corpus") as post, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_update_rag_corpus_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "pre_update_rag_corpus") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.UpdateRagCorpusRequest.pb(vertex_rag_data_service.UpdateRagCorpusRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_rag_corpus(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_rag_corpus_rest_bad_request(request_type=vertex_rag_data_service.GetRagCorpusRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_rag_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_get_rag_corpus") as post, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_get_rag_corpus_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "pre_get_rag_corpus") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.GetRagCorpusRequest.pb(vertex_rag_data_service.GetRagCorpusRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_rag_corpus(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_rag_corpora_rest_bad_request(request_type=vertex_rag_data_service.ListRagCorporaRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_rag_corpora_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_list_rag_corpora") as post, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_list_rag_corpora_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "pre_list_rag_corpora") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.ListRagCorporaRequest.pb(vertex_rag_data_service.ListRagCorporaRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = vertex_rag_data_service.ListRagCorporaResponse.to_json(vertex_rag_data_service.ListRagCorporaResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = vertex_rag_data_service.ListRagCorporaResponse(), metadata

        client.list_rag_corpora(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_rag_corpus_rest_bad_request(request_type=vertex_rag_data_service.DeleteRagCorpusRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rag_corpus_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_delete_rag_corpus") as post, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_delete_rag_corpus_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "pre_delete_rag_corpus") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.DeleteRagCorpusRequest.pb(vertex_rag_data_service.DeleteRagCorpusRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_rag_corpus(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_upload_rag_file_rest_bad_request(request_type=vertex_rag_data_service.UploadRagFileRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_upload_rag_file_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_upload_rag_file") as post, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_upload_rag_file_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "pre_upload_rag_file") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.UploadRagFileRequest.pb(vertex_rag_data_service.UploadRagFileRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = vertex_rag_data_service.UploadRagFileResponse.to_json(vertex_rag_data_service.UploadRagFileResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = vertex_rag_data_service.UploadRagFileResponse(), metadata

        client.upload_rag_file(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_import_rag_files_rest_bad_request(request_type=vertex_rag_data_service.ImportRagFilesRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_import_rag_files_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_import_rag_files") as post, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_import_rag_files_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "pre_import_rag_files") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.ImportRagFilesRequest.pb(vertex_rag_data_service.ImportRagFilesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.import_rag_files(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_rag_file_rest_bad_request(request_type=vertex_rag_data_service.GetRagFileRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/ragCorpora/sample3/ragFiles/sample4'}
    request = request_type(**request_init)
...
def test_get_rag_file_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_get_rag_file") as post, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_get_rag_file_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "pre_get_rag_file") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.GetRagFileRequest.pb(vertex_rag_data_service.GetRagFileRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_rag_file(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_rag_files_rest_bad_request(request_type=vertex_rag_data_service.ListRagFilesRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_rag_files_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_list_rag_files") as post, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_list_rag_files_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "pre_list_rag_files") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.ListRagFilesRequest.pb(vertex_rag_data_service.ListRagFilesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = vertex_rag_data_service.ListRagFilesResponse.to_json(vertex_rag_data_service.ListRagFilesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = vertex_rag_data_service.ListRagFilesResponse(), metadata

        client.list_rag_files(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_rag_file_rest_bad_request(request_type=vertex_rag_data_service.DeleteRagFileRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_rag_file_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_delete_rag_file") as post, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_delete_rag_file_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "pre_delete_rag_file") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.DeleteRagFileRequest.pb(vertex_rag_data_service.DeleteRagFileRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_rag_file(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_rag_engine_config_rest_bad_request(request_type=vertex_rag_data_service.UpdateRagEngineConfigRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'rag_engine_config': {'name': 'projects/sample1/locations/sample2/ragEngineConfig'}}
    request = request_type(**request_init)
...
def test_update_rag_engine_config_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'rag_engine_config': {'name': 'projects/sample1/locations/sample2/ragEngineConfig'}}
    request_init["rag_engine_config"] = {'name': 'projects/sample1/locations/sample2/ragEngineConfig', 'rag_managed_db_config': {'enterprise': {}, 'scaled': {}, 'basic': {}, 'unprovisioned': {}, 'serverless': {}, 'spanner': {'scaled': {}, 'basic': {}, 'unprovisioned': {}}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = vertex_rag_data_service.UpdateRagEngineConfigRequest.meta.fields["rag_engine_config"]
...
def test_update_rag_engine_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_update_rag_engine_config") as post, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_update_rag_engine_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "pre_update_rag_engine_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.UpdateRagEngineConfigRequest.pb(vertex_rag_data_service.UpdateRagEngineConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_rag_engine_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_rag_engine_config_rest_bad_request(request_type=vertex_rag_data_service.GetRagEngineConfigRequest):
    client = VertexRagDataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_rag_engine_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_get_rag_engine_config") as post, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "post_get_rag_engine_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.VertexRagDataServiceRestInterceptor, "pre_get_rag_engine_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.GetRagEngineConfigRequest.pb(vertex_rag_data_service.GetRagEngineConfigRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = vertex_rag_data.RagEngineConfig.to_json(vertex_rag_data.RagEngineConfig())
        req.return_value.content = return_value
        ...
        client.get_rag_engine_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_create_rag_corpus_rest_asyncio_bad_request(request_type=vertex_rag_data_service.CreateRagCorpusRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_rag_corpus_rest_asyncio_interceptors(null_interceptor):
    ...
    transport = transports.AsyncVertexRagDataServiceRestTransport(
        credentials=async_anonymous_credentials(),
        interceptor=None if null_interceptor else transports.AsyncVertexRagDataServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_create_rag_corpus") as post, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_create_rag_corpus_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "pre_create_rag_corpus") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.CreateRagCorpusRequest.pb(vertex_rag_data_service.CreateRagCorpusRequest())
        ...
        await client.create_rag_corpus(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_update_rag_corpus_rest_asyncio_bad_request(request_type=vertex_rag_data_service.UpdateRagCorpusRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_update_rag_corpus_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_update_rag_corpus") as post, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_update_rag_corpus_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "pre_update_rag_corpus") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.UpdateRagCorpusRequest.pb(vertex_rag_data_service.UpdateRagCorpusRequest())
        ...
        await client.update_rag_corpus(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_rag_corpus_rest_asyncio_bad_request(request_type=vertex_rag_data_service.GetRagCorpusRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_rag_corpus_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_get_rag_corpus") as post, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_get_rag_corpus_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "pre_get_rag_corpus") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.GetRagCorpusRequest.pb(vertex_rag_data_service.GetRagCorpusRequest())
        ...
        await client.get_rag_corpus(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_rag_corpora_rest_asyncio_bad_request(request_type=vertex_rag_data_service.ListRagCorporaRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_rag_corpora_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_list_rag_corpora") as post, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_list_rag_corpora_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "pre_list_rag_corpora") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.ListRagCorporaRequest.pb(vertex_rag_data_service.ListRagCorporaRequest())
        ...
        await client.list_rag_corpora(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_rag_corpus_rest_asyncio_bad_request(request_type=vertex_rag_data_service.DeleteRagCorpusRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_rag_corpus_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_delete_rag_corpus") as post, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_delete_rag_corpus_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "pre_delete_rag_corpus") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.DeleteRagCorpusRequest.pb(vertex_rag_data_service.DeleteRagCorpusRequest())
        ...
        await client.delete_rag_corpus(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_upload_rag_file_rest_asyncio_bad_request(request_type=vertex_rag_data_service.UploadRagFileRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_upload_rag_file_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_upload_rag_file") as post, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_upload_rag_file_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "pre_upload_rag_file") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.UploadRagFileRequest.pb(vertex_rag_data_service.UploadRagFileRequest())
        ...
        await client.upload_rag_file(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_import_rag_files_rest_asyncio_bad_request(request_type=vertex_rag_data_service.ImportRagFilesRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_import_rag_files_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_import_rag_files") as post, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_import_rag_files_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "pre_import_rag_files") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.ImportRagFilesRequest.pb(vertex_rag_data_service.ImportRagFilesRequest())
        ...
        await client.import_rag_files(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_rag_file_rest_asyncio_bad_request(request_type=vertex_rag_data_service.GetRagFileRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_rag_file_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_get_rag_file") as post, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_get_rag_file_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "pre_get_rag_file") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.GetRagFileRequest.pb(vertex_rag_data_service.GetRagFileRequest())
        ...
        await client.get_rag_file(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_rag_files_rest_asyncio_bad_request(request_type=vertex_rag_data_service.ListRagFilesRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_rag_files_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_list_rag_files") as post, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_list_rag_files_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "pre_list_rag_files") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.ListRagFilesRequest.pb(vertex_rag_data_service.ListRagFilesRequest())
        ...
        await client.list_rag_files(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_rag_file_rest_asyncio_bad_request(request_type=vertex_rag_data_service.DeleteRagFileRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_rag_file_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_delete_rag_file") as post, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_delete_rag_file_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "pre_delete_rag_file") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.DeleteRagFileRequest.pb(vertex_rag_data_service.DeleteRagFileRequest())
        ...
        await client.delete_rag_file(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_update_rag_engine_config_rest_asyncio_bad_request(request_type=vertex_rag_data_service.UpdateRagEngineConfigRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_update_rag_engine_config_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_update_rag_engine_config") as post, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_update_rag_engine_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "pre_update_rag_engine_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.UpdateRagEngineConfigRequest.pb(vertex_rag_data_service.UpdateRagEngineConfigRequest())
        ...
        await client.update_rag_engine_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_rag_engine_config_rest_asyncio_bad_request(request_type=vertex_rag_data_service.GetRagEngineConfigRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_rag_engine_config_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_get_rag_engine_config") as post, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "post_get_rag_engine_config_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncVertexRagDataServiceRestInterceptor, "pre_get_rag_engine_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = vertex_rag_data_service.GetRagEngineConfigRequest.pb(vertex_rag_data_service.GetRagEngineConfigRequest())
        ...
        await client.get_rag_engine_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_vertex_rag_data_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1beta1.services.vertex_rag_data_service.transports.VertexRagDataServiceTransport.__init__') as Transport:
...
def test_vertex_rag_data_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1beta1.services.vertex_rag_data_service.transports.VertexRagDataServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_vertex_rag_data_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1beta1.services.vertex_rag_data_service.transports.VertexRagDataServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.VertexRagDataServiceTransport()
        adc.assert_called_once()
...
def test_vertex_rag_data_service_transport_create_channel(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
@pytest.mark.parametrize("transport_class", [transports.VertexRagDataServiceGrpcTransport, transports.VertexRagDataServiceGrpcAsyncIOTransport])
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.VertexRagDataServiceGrpcTransport, transports.VertexRagDataServiceGrpcAsyncIOTransport])
def test_vertex_rag_data_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_rag_engine_config_path():
    project = "cuttlefish"
    location = "mussel"
    expected = "projects/{project}/locations/{location}/ragEngineConfig".format(project=project, location=location, )
...
def test_rag_file_path():
    ...
    rag_corpus = "squid"
    rag_file = "clam"
    expected = "projects/{project}/locations/{location}/ragCorpora/{rag_corpus}/ragFiles/{rag_file}".format(project=project, location=location, rag_corpus=rag_corpus, rag_file=rag_file, )
    actual = VertexRagDataServiceClient.rag_file_path(project, location, rag_corpus, rag_file)
    assert expected == actual
...
def test_secret_version_path():
    ...
    actual = VertexRagDataServiceClient.secret_version_path(project, secret, secret_version)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.VertexRagDataServiceTransport, '_prep_wrapped_messages') as prep:
        client = VertexRagDataServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (VertexRagDataServiceAsyncClient, transports.VertexRagDataServiceGrpcAsyncIOTransport),
])
