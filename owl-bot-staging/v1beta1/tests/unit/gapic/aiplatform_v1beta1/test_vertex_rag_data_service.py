...
def test_create_rag_corpus_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["rag_corpus"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'rag_embedding_model_config': {'vertex_prediction_endpoint': {'endpoint': 'endpoint_value', 'model': 'model_value', 'model_version_id': 'model_version_id_value'}, 'hybrid_search_config': {'sparse_embedding_config': {'bm25': {'multilingual': True, 'k1': 0.156, 'b': 0.98}}, 'dense_embedding_model_prediction_endpoint': {}}}, 'rag_vector_db_config': {'rag_managed_db': {}, 'weaviate': {'http_endpoint': 'http_endpoint_value', 'collection_name': 'collection_name_value'}, 'pinecone': {'index_name': 'index_name_value'}, 'vertex_feature_store': {'feature_view_resource_name': 'feature_view_resource_name_value'}, 'vertex_vector_search': {'index_endpoint': 'index_endpoint_value', 'index': 'index_value'}, 'api_auth': {'api_key_config': {'api_key_secret_version': 'api_key_secret_version_value'}}, 'rag_embedding_model_config': {}}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'corpus_status': {'state': 1, 'error_status': 'error_status_value'}, 'vector_db_config': {}, 'vertex_ai_search_config': {'serving_config': 'serving_config_value'}, 'rag_files_count': 1588}
