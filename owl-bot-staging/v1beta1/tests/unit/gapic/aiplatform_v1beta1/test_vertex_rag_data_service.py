...
def test_upload_rag_file_flattened():
    ...
    with mock.patch.object(
        ...
        client.upload_rag_file(
            ...
            upload_rag_file_config=vertex_rag_data.UploadRagFileConfig(rag_file_chunking_config=vertex_rag_data.RagFileChunkingConfig(chunk_size=1075)),
        )
        ...
        mock_val = vertex_rag_data.UploadRagFileConfig(rag_file_chunking_config=vertex_rag_data.RagFileChunkingConfig(chunk_size=1075))
        assert arg == mock_val
