...
def test_import_extension_rest_bad_request(transport: str = 'rest', request_type=extension_registry_service.ImportExtensionRequest):
    client = ExtensionRegistryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_extension_rest_bad_request(transport: str = 'rest', request_type=extension_registry_service.GetExtensionRequest):
    client = ExtensionRegistryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_extensions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = extension_registry_service.ListExtensionsResponse.to_json(extension_registry_service.ListExtensionsResponse())
...
def test_list_extensions_rest_bad_request(transport: str = 'rest', request_type=extension_registry_service.ListExtensionsRequest):
    client = ExtensionRegistryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_extension.Extension.to_json(gca_extension.Extension())
...
def test_update_extension_rest_bad_request(transport: str = 'rest', request_type=extension_registry_service.UpdateExtensionRequest):
    client = ExtensionRegistryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_extension_rest_bad_request(transport: str = 'rest', request_type=extension_registry_service.DeleteExtensionRequest):
    client = ExtensionRegistryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
