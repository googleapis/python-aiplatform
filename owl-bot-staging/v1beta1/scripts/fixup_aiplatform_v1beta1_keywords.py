...
class aiplatformCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'generate_content': ('model', 'contents', 'tools', 'tool_config', 'safety_settings', 'generation_config', ),
        ...
        'query_reasoning_engine': ('name', 'input', ),
        ...
        'stream_generate_content': ('model', 'contents', 'tools', 'tool_config', 'safety_settings', 'generation_config', ),
