...
class aiplatformCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'assemble_data': ('name', 'gemini_request_read_config', ),
        'assess_data': ('name', 'tuning_validation_assessment_config', 'tuning_resource_usage_assessment_config', 'batch_prediction_validation_assessment_config', 'batch_prediction_resource_usage_assessment_config', 'gemini_request_read_config', ),
        ...
        'delete_rag_file': ('name', 'force_delete', ),
