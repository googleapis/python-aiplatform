...
class aiplatformCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        'accept_publisher_model_eula': ('parent', 'publisher_model', ),
        ...
        'assemble_data': ('name', 'gemini_template_config', 'request_column_name', 'gemini_request_read_config', ),
        'assess_data': ('name', 'tuning_validation_assessment_config', 'tuning_resource_usage_assessment_config', 'batch_prediction_validation_assessment_config', 'batch_prediction_resource_usage_assessment_config', 'gemini_template_config', 'request_column_name', 'gemini_request_read_config', ),
        ...
        'check_publisher_model_eula_acceptance': ('parent', 'publisher_model', ),
        ...
        'create_example_store': ('parent', 'example_store', ),
        ...
        'export_publisher_model': ('name', 'destination', 'parent', ),
        ...
        'fetch_examples': ('example_store', 'stored_contents_example_filter', 'page_size', 'page_token', 'example_ids', ),
        ...
        'generate_memories': ('parent', 'vertex_session_source', 'direct_contents_source', 'disable_consolidation', 'scope', ),
        ...
        'get_publisher_model': ('name', 'language_code', 'view', 'is_hugging_face_model', 'hugging_face_token', 'include_equivalent_model_garden_model_deployment_configs', ),
        'get_rag_corpus': ('name', ),
        ...
        'import_index': ('name', 'config', 'is_complete_overwrite', ),
        ...
        'list_events': ('parent', 'page_size', 'page_token', ),
        'list_example_stores': ('parent', 'filter', 'page_size', 'page_token', ),
        ...
        'list_memories': ('parent', 'filter', 'page_size', 'page_token', ),
        ...
        'remove_examples': ('example_store', 'stored_contents_example_filter', 'example_ids', ),
        ...
        'retrieve_memories': ('parent', 'scope', 'similarity_search_params', 'simple_retrieval_params', ),
        ...
        'search_examples': ('example_store', 'stored_contents_example_parameters', 'top_k', ),
        ...
        'set_publisher_model_config': ('name', 'publisher_model_config', ),
        ...
        'update_example_store': ('example_store', 'update_mask', ),
        ...
        'update_feature_monitor': ('feature_monitor', 'update_mask', ),
        ...
        'update_memory': ('memory', 'update_mask', ),
        ...
        'upsert_examples': ('example_store', 'examples', 'overwrite', ),
