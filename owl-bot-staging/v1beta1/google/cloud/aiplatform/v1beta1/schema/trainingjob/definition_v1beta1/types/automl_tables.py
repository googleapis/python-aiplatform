...
class AutoMlTablesInputs(proto.Message):
    ...
    class Transformation(proto.Message):
        ...
        numeric: 'AutoMlTablesInputs.Transformation.NumericTransformation' = proto.Field(
            proto.MESSAGE,
            number=2,
            oneof='transformation_detail',
            message='AutoMlTablesInputs.Transformation.NumericTransformation',
        )
        categorical: 'AutoMlTablesInputs.Transformation.CategoricalTransformation' = proto.Field(
            proto.MESSAGE,
            number=3,
            oneof='transformation_detail',
            message='AutoMlTablesInputs.Transformation.CategoricalTransformation',
        )
        timestamp: 'AutoMlTablesInputs.Transformation.TimestampTransformation' = proto.Field(
            proto.MESSAGE,
            number=4,
            oneof='transformation_detail',
        ...
        repeated_text: 'AutoMlTablesInputs.Transformation.TextArrayTransformation' = proto.Field(
            proto.MESSAGE,
            number=8,
            oneof='transformation_detail',
