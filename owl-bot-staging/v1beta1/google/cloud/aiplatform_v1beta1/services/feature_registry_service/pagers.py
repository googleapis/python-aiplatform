...
class ListFeatureMonitorsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[feature_registry_service.ListFeatureMonitorsResponse]],
            request: feature_registry_service.ListFeatureMonitorsRequest,
            response: feature_registry_service.ListFeatureMonitorsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[feature_registry_service.ListFeatureMonitorsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListFeatureMonitorJobsPager:
    ...
    @property
    def pages(self) -> Iterator[feature_registry_service.ListFeatureMonitorJobsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListFeatureMonitorJobsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[feature_registry_service.ListFeatureMonitorJobsResponse]],
            request: feature_registry_service.ListFeatureMonitorJobsRequest,
            response: feature_registry_service.ListFeatureMonitorJobsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[feature_registry_service.ListFeatureMonitorJobsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
