...
class FeatureRegistryServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[FeatureRegistryServiceTransport]]
...
class FeatureRegistryServiceClient(metaclass=FeatureRegistryServiceClientMeta):
    ...
    @staticmethod
    def feature_group_path(project: str,location: str,feature_group: str,) -> str:
        """Returns a fully-qualified feature_group string."""
        return "projects/{project}/locations/{location}/featureGroups/{feature_group}".format(project=project, location=location, feature_group=feature_group, )

    @staticmethod
    def parse_feature_group_path(path: str) -> Dict[str,str]:
        """Parses a feature_group path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/featureGroups/(?P<feature_group>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def feature_monitor_path(project: str,location: str,feature_group: str,feature_monitor: str,) -> str:
        """Returns a fully-qualified feature_monitor string."""
        return "projects/{project}/locations/{location}/featureGroups/{feature_group}/featureMonitors/{feature_monitor}".format(project=project, location=location, feature_group=feature_group, feature_monitor=feature_monitor, )

    @staticmethod
    def parse_feature_monitor_path(path: str) -> Dict[str,str]:
        """Parses a feature_monitor path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/featureGroups/(?P<feature_group>.+?)/featureMonitors/(?P<feature_monitor>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def feature_monitor_job_path(project: str,location: str,feature_group: str,feature_monitor: str,feature_monitor_job: str,) -> str:
        """Returns a fully-qualified feature_monitor_job string."""
        return "projects/{project}/locations/{location}/featureGroups/{feature_group}/featureMonitors/{feature_monitor}/featureMonitorJobs/{feature_monitor_job}".format(project=project, location=location, feature_group=feature_group, feature_monitor=feature_monitor, feature_monitor_job=feature_monitor_job, )

    @staticmethod
    def parse_feature_monitor_job_path(path: str) -> Dict[str,str]:
        """Parses a feature_monitor_job path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/featureGroups/(?P<feature_group>.+?)/featureMonitors/(?P<feature_monitor>.+?)/featureMonitorJobs/(?P<feature_monitor_job>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = FeatureRegistryServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, FeatureRegistryServiceTransport, Callable[..., FeatureRegistryServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = FeatureRegistryServiceClient._read_environment_variables()
        self._client_cert_source = FeatureRegistryServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = FeatureRegistryServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            transport_init: Union[Type[FeatureRegistryServiceTransport], Callable[..., FeatureRegistryServiceTransport]] = (
    ...
    def create_feature_monitor(self,
            request: Optional[Union[feature_registry_service.CreateFeatureMonitorRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_registry_service.CreateFeatureMonitorRequest):
    ...
    def get_feature_monitor(self,
            request: Optional[Union[feature_registry_service.GetFeatureMonitorRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_feature_monitors(self,
            request: Optional[Union[feature_registry_service.ListFeatureMonitorsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def update_feature_monitor(self,
            request: Optional[Union[feature_registry_service.UpdateFeatureMonitorRequest, dict]] = None,
            *,
            feature_monitor: Optional[gca_feature_monitor.FeatureMonitor] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_registry_service.UpdateFeatureMonitorRequest):
    ...
    def delete_feature_monitor(self,
            request: Optional[Union[feature_registry_service.DeleteFeatureMonitorRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_registry_service.DeleteFeatureMonitorRequest):
    ...
    def create_feature_monitor_job(self,
            request: Optional[Union[feature_registry_service.CreateFeatureMonitorJobRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, feature_monitor_job, feature_monitor_job_id])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_registry_service.CreateFeatureMonitorJobRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_feature_monitor_job]
    ...
    def get_feature_monitor_job(self,
            request: Optional[Union[feature_registry_service.GetFeatureMonitorJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_registry_service.GetFeatureMonitorJobRequest):
    ...
    def list_feature_monitor_jobs(self,
            request: Optional[Union[feature_registry_service.ListFeatureMonitorJobsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_registry_service.ListFeatureMonitorJobsRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_feature_monitor_jobs]
