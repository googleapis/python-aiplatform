...
class PersistentResourceServiceRestTransport(_BasePersistentResourceServiceRestTransport):
    ...
    class _GetIamPolicy(_BasePersistentResourceServiceRestTransport._BaseGetIamPolicy, PersistentResourceServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BasePersistentResourceServiceRestTransport._BaseTestIamPermissions, PersistentResourceServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
