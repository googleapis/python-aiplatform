...
class PersistentResourceServiceGrpcAsyncIOTransport(PersistentResourceServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_persistent_resource: gapic_v1.method_async.wrap_method(
                self.create_persistent_resource,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_persistent_resource: gapic_v1.method_async.wrap_method(
                self.get_persistent_resource,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_persistent_resources: gapic_v1.method_async.wrap_method(
                self.list_persistent_resources,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_persistent_resource: gapic_v1.method_async.wrap_method(
                self.delete_persistent_resource,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_persistent_resource: gapic_v1.method_async.wrap_method(
                self.update_persistent_resource,
                default_timeout=None,
                client_info=client_info,
            ),
            self.reboot_persistent_resource: gapic_v1.method_async.wrap_method(
