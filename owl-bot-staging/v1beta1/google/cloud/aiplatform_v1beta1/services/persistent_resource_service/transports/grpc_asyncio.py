...
class PersistentResourceServiceGrpcAsyncIOTransport(PersistentResourceServiceTransport):
    ...
    def create_persistent_resource(self) -> Callable[
        ...
        if 'create_persistent_resource' not in self._stubs:
            self._stubs['create_persistent_resource'] = self._logged_channel.unary_unary(
    ...
    def delete_persistent_resource(self) -> Callable[
        ...
        if 'delete_persistent_resource' not in self._stubs:
            self._stubs['delete_persistent_resource'] = self._logged_channel.unary_unary(
    ...
    def update_persistent_resource(self) -> Callable[
        ...
        if 'update_persistent_resource' not in self._stubs:
            self._stubs['update_persistent_resource'] = self._logged_channel.unary_unary(
    ...
    def reboot_persistent_resource(self) -> Callable[
        ...
        if 'reboot_persistent_resource' not in self._stubs:
            self._stubs['reboot_persistent_resource'] = self._logged_channel.unary_unary(
