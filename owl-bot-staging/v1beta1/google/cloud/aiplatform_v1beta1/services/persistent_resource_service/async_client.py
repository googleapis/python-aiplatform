...
class PersistentResourceServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = PersistentResourceServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    network_attachment_path = staticmethod(PersistentResourceServiceClient.network_attachment_path)
    parse_network_attachment_path = staticmethod(PersistentResourceServiceClient.parse_network_attachment_path)
    notebook_runtime_template_path = staticmethod(PersistentResourceServiceClient.notebook_runtime_template_path)
    parse_notebook_runtime_template_path = staticmethod(PersistentResourceServiceClient.parse_notebook_runtime_template_path)
    ...
    parse_common_folder_path = staticmethod(PersistentResourceServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(PersistentResourceServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(PersistentResourceServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(PersistentResourceServiceClient.common_project_path)
    parse_common_project_path = staticmethod(PersistentResourceServiceClient.parse_common_project_path)
    common_location_path = staticmethod(PersistentResourceServiceClient.common_location_path)
    parse_common_location_path = staticmethod(PersistentResourceServiceClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(PersistentResourceServiceClient).get_transport_class, type(PersistentResourceServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, PersistentResourceServiceTransport, Callable[..., PersistentResourceServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_persistent_resource(self,
    ...
    async def get_persistent_resource(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_persistent_resource]
    ...
    async def list_persistent_resources(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_persistent_resources]
    ...
    async def delete_persistent_resource(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_persistent_resource]
    ...
    async def update_persistent_resource(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_persistent_resource]
    ...
    async def reboot_persistent_resource(self,
