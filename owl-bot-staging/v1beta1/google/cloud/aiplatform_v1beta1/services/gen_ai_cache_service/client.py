...
class GenAiCacheServiceClient(metaclass=GenAiCacheServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = GenAiCacheServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            GenAiCacheServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, GenAiCacheServiceTransport, Callable[..., GenAiCacheServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = GenAiCacheServiceClient._read_environment_variables()
        self._client_cert_source = GenAiCacheServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = GenAiCacheServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[GenAiCacheServiceTransport], Callable[..., GenAiCacheServiceTransport]] = (
    ...
    def create_cached_content(self,
            request: Optional[Union[gen_ai_cache_service.CreateCachedContentRequest, dict]] = None,
            *,
        ...
        has_flattened_params = any([parent, cached_content])
    ...
    def get_cached_content(self,
            request: Optional[Union[gen_ai_cache_service.GetCachedContentRequest, dict]] = None,
            *,
    ...
    def update_cached_content(self,
            request: Optional[Union[gen_ai_cache_service.UpdateCachedContentRequest, dict]] = None,
            *,
            cached_content: Optional[gca_cached_content.CachedContent] = None,
    ...
    def delete_cached_content(self,
            request: Optional[Union[gen_ai_cache_service.DeleteCachedContentRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_cached_contents(self,
            request: Optional[Union[gen_ai_cache_service.ListCachedContentsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
