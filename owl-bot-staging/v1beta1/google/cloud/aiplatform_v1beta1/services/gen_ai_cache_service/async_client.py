...
class GenAiCacheServiceAsyncClient:
    ...
    parse_cached_content_path = staticmethod(GenAiCacheServiceClient.parse_cached_content_path)
    ...
    common_billing_account_path = staticmethod(GenAiCacheServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(GenAiCacheServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(GenAiCacheServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(GenAiCacheServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(GenAiCacheServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(GenAiCacheServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(GenAiCacheServiceClient.common_project_path)
    parse_common_project_path = staticmethod(GenAiCacheServiceClient.parse_common_project_path)
    common_location_path = staticmethod(GenAiCacheServiceClient.common_location_path)
    parse_common_location_path = staticmethod(GenAiCacheServiceClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(GenAiCacheServiceClient).get_transport_class, type(GenAiCacheServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Optional[Union[str, GenAiCacheServiceTransport, Callable[..., GenAiCacheServiceTransport]]] = "grpc_asyncio",
