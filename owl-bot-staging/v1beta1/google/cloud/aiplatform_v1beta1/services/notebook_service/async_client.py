...
class NotebookServiceAsyncClient:
    ...
    notebook_execution_job_path = staticmethod(NotebookServiceClient.notebook_execution_job_path)
    parse_notebook_execution_job_path = staticmethod(NotebookServiceClient.parse_notebook_execution_job_path)
    notebook_runtime_path = staticmethod(NotebookServiceClient.notebook_runtime_path)
    parse_notebook_runtime_path = staticmethod(NotebookServiceClient.parse_notebook_runtime_path)
    notebook_runtime_template_path = staticmethod(NotebookServiceClient.notebook_runtime_template_path)
    parse_notebook_runtime_template_path = staticmethod(NotebookServiceClient.parse_notebook_runtime_template_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, NotebookServiceTransport, Callable[..., NotebookServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_notebook_runtime_template(self,
            request: Optional[Union[notebook_service.CreateNotebookRuntimeTemplateRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            notebook_runtime_template: Optional[notebook_runtime.NotebookRuntimeTemplate] = None,
        ...
        .. code-block:: python
            ...
            async def sample_create_notebook_runtime_template():
                ...
                # Make the request
                operation = await client.create_notebook_runtime_template(request=request)
        ...
        if not isinstance(request, notebook_service.CreateNotebookRuntimeTemplateRequest):
    ...
    async def get_notebook_runtime_template(self,
            request: Optional[Union[notebook_service.GetNotebookRuntimeTemplateRequest, dict]] = None,
            *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_notebook_runtime_template]
    ...
    async def list_notebook_runtime_templates(self,
            request: Optional[Union[notebook_service.ListNotebookRuntimeTemplatesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, notebook_service.ListNotebookRuntimeTemplatesRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_notebook_runtime_templates]
    ...
    async def delete_notebook_runtime_template(self,
            request: Optional[Union[notebook_service.DeleteNotebookRuntimeTemplateRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_notebook_runtime_template():
                ...
                # Make the request
                operation = await client.delete_notebook_runtime_template(request=request)
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, notebook_service.DeleteNotebookRuntimeTemplateRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_notebook_runtime_template]
    ...
    async def update_notebook_runtime_template(self,
            request: Optional[Union[notebook_service.UpdateNotebookRuntimeTemplateRequest, dict]] = None,
            *,
            notebook_runtime_template: Optional[notebook_runtime.NotebookRuntimeTemplate] = None,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, notebook_service.UpdateNotebookRuntimeTemplateRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_notebook_runtime_template]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("notebook_runtime_template.name", request.notebook_runtime_template.name),
            )),
        )
    ...
    async def assign_notebook_runtime(self,
            request: Optional[Union[notebook_service.AssignNotebookRuntimeRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            async def sample_assign_notebook_runtime():
                ...
                # Make the request
                operation = await client.assign_notebook_runtime(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.assign_notebook_runtime]
    ...
    async def get_notebook_runtime(self,
            request: Optional[Union[notebook_service.GetNotebookRuntimeRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_notebook_runtime]
    ...
    async def list_notebook_runtimes(self,
            request: Optional[Union[notebook_service.ListNotebookRuntimesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    async def delete_notebook_runtime(self,
            request: Optional[Union[notebook_service.DeleteNotebookRuntimeRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_notebook_runtime():
                ...
                # Make the request
                operation = await client.delete_notebook_runtime(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_notebook_runtime]
    ...
    async def upgrade_notebook_runtime(self,
            request: Optional[Union[notebook_service.UpgradeNotebookRuntimeRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_upgrade_notebook_runtime():
                ...
                # Make the request
                operation = await client.upgrade_notebook_runtime(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.upgrade_notebook_runtime]
    ...
    async def start_notebook_runtime(self,
            request: Optional[Union[notebook_service.StartNotebookRuntimeRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_start_notebook_runtime():
                ...
                # Make the request
                operation = await client.start_notebook_runtime(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.start_notebook_runtime]
    ...
    async def stop_notebook_runtime(self,
            request: Optional[Union[notebook_service.StopNotebookRuntimeRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_stop_notebook_runtime():
                ...
                # Make the request
                operation = await client.stop_notebook_runtime(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.stop_notebook_runtime]
    ...
    async def create_notebook_execution_job(self,
            request: Optional[Union[notebook_service.CreateNotebookExecutionJobRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            notebook_execution_job: Optional[gca_notebook_execution_job.NotebookExecutionJob] = None,
        ...
        .. code-block:: python
            ...
            async def sample_create_notebook_execution_job():
                ...
                # Make the request
                operation = await client.create_notebook_execution_job(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_notebook_execution_job]
    ...
    async def get_notebook_execution_job(self,
            request: Optional[Union[notebook_service.GetNotebookExecutionJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_notebook_execution_job]
    ...
    async def list_notebook_execution_jobs(self,
            request: Optional[Union[notebook_service.ListNotebookExecutionJobsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_notebook_execution_jobs]
    ...
    async def delete_notebook_execution_job(self,
            request: Optional[Union[notebook_service.DeleteNotebookExecutionJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_notebook_execution_job():
                ...
                # Make the request
                operation = await client.delete_notebook_execution_job(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_notebook_execution_job]
