...
class NotebookServiceGrpcTransport(NotebookServiceTransport):
    ...
    def create_notebook_runtime_template(self) -> Callable[
        ...
        if 'create_notebook_runtime_template' not in self._stubs:
            self._stubs['create_notebook_runtime_template'] = self._logged_channel.unary_unary(
    ...
    def get_notebook_runtime_template(self) -> Callable[
        ...
        if 'get_notebook_runtime_template' not in self._stubs:
            self._stubs['get_notebook_runtime_template'] = self._logged_channel.unary_unary(
    ...
    def list_notebook_runtime_templates(self) -> Callable[
        ...
        if 'list_notebook_runtime_templates' not in self._stubs:
            self._stubs['list_notebook_runtime_templates'] = self._logged_channel.unary_unary(
    ...
    def delete_notebook_runtime_template(self) -> Callable[
        ...
        if 'delete_notebook_runtime_template' not in self._stubs:
            self._stubs['delete_notebook_runtime_template'] = self._logged_channel.unary_unary(
    ...
    def update_notebook_runtime_template(self) -> Callable[
        ...
        if 'update_notebook_runtime_template' not in self._stubs:
            self._stubs['update_notebook_runtime_template'] = self._logged_channel.unary_unary(
    ...
    def create_notebook_execution_job(self) -> Callable[
        ...
        if 'create_notebook_execution_job' not in self._stubs:
            self._stubs['create_notebook_execution_job'] = self._logged_channel.unary_unary(
    ...
    def get_notebook_execution_job(self) -> Callable[
        ...
        if 'get_notebook_execution_job' not in self._stubs:
            self._stubs['get_notebook_execution_job'] = self._logged_channel.unary_unary(
    ...
    def list_notebook_execution_jobs(self) -> Callable[
        ...
        if 'list_notebook_execution_jobs' not in self._stubs:
            self._stubs['list_notebook_execution_jobs'] = self._logged_channel.unary_unary(
    ...
    def delete_notebook_execution_job(self) -> Callable[
        ...
        if 'delete_notebook_execution_job' not in self._stubs:
            self._stubs['delete_notebook_execution_job'] = self._logged_channel.unary_unary(
