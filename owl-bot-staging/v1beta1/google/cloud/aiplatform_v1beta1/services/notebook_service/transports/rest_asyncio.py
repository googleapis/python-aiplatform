...
class AsyncNotebookServiceRestTransport(_BaseNotebookServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseNotebookServiceRestTransport._BaseGetIamPolicy, AsyncNotebookServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncNotebookServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseNotebookServiceRestTransport._BaseTestIamPermissions, AsyncNotebookServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncNotebookServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
