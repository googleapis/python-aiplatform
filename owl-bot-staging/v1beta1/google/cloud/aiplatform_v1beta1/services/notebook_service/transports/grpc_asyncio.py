...
class NotebookServiceGrpcAsyncIOTransport(NotebookServiceTransport):
    ...
    def create_notebook_runtime_template(self) -> Callable[
        ...
        if 'create_notebook_runtime_template' not in self._stubs:
            self._stubs['create_notebook_runtime_template'] = self.grpc_channel.unary_unary(
    ...
    def get_notebook_runtime_template(self) -> Callable[
        ...
        if 'get_notebook_runtime_template' not in self._stubs:
            self._stubs['get_notebook_runtime_template'] = self.grpc_channel.unary_unary(
    ...
    def list_notebook_runtime_templates(self) -> Callable[
        ...
        if 'list_notebook_runtime_templates' not in self._stubs:
            self._stubs['list_notebook_runtime_templates'] = self.grpc_channel.unary_unary(
    ...
    def delete_notebook_runtime_template(self) -> Callable[
        ...
        if 'delete_notebook_runtime_template' not in self._stubs:
            self._stubs['delete_notebook_runtime_template'] = self.grpc_channel.unary_unary(
    ...
    def update_notebook_runtime_template(self) -> Callable[
        ...
        if 'update_notebook_runtime_template' not in self._stubs:
            self._stubs['update_notebook_runtime_template'] = self.grpc_channel.unary_unary(
    ...
    def create_notebook_execution_job(self) -> Callable[
        ...
        if 'create_notebook_execution_job' not in self._stubs:
            self._stubs['create_notebook_execution_job'] = self.grpc_channel.unary_unary(
    ...
    def delete_notebook_execution_job(self) -> Callable[
        ...
        if 'delete_notebook_execution_job' not in self._stubs:
            self._stubs['delete_notebook_execution_job'] = self.grpc_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_notebook_runtime_template: gapic_v1.method_async.wrap_method(
                self.create_notebook_runtime_template,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_notebook_runtime_template: gapic_v1.method_async.wrap_method(
                self.get_notebook_runtime_template,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_notebook_runtime_templates: gapic_v1.method_async.wrap_method(
            ...
            self.get_notebook_runtime: gapic_v1.method_async.wrap_method(
                self.get_notebook_runtime,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_notebook_runtimes: gapic_v1.method_async.wrap_method(
                self.list_notebook_runtimes,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_notebook_runtime: gapic_v1.method_async.wrap_method(
                self.delete_notebook_runtime,
                default_timeout=None,
                client_info=client_info,
            ),
            self.upgrade_notebook_runtime: gapic_v1.method_async.wrap_method(
