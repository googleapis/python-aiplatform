    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomEvaluationServiceInterceptor(EvaluationServiceRestInterceptor):
            ...
            async def pre_generate_instance_rubrics(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_generate_instance_rubrics(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    """
    async def pre_evaluate_dataset(self, request: evaluation_service.EvaluateDatasetRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[evaluation_service.EvaluateDatasetRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_evaluate_dataset(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    async def post_evaluate_dataset_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for evaluate_dataset
    ...
    async def pre_evaluate_instances(self, request: evaluation_service.EvaluateInstancesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[evaluation_service.EvaluateInstancesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_evaluate_instances(self, response: evaluation_service.EvaluateInstancesResponse) -> evaluation_service.EvaluateInstancesResponse:
    ...
    async def post_evaluate_instances_with_metadata(self, response: evaluation_service.EvaluateInstancesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[evaluation_service.EvaluateInstancesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for evaluate_instances
    ...
    async def pre_generate_instance_rubrics(self, request: evaluation_service.GenerateInstanceRubricsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[evaluation_service.GenerateInstanceRubricsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_generate_instance_rubrics(self, response: evaluation_service.GenerateInstanceRubricsResponse) -> evaluation_service.GenerateInstanceRubricsResponse:
    ...
    async def post_generate_instance_rubrics_with_metadata(self, response: evaluation_service.GenerateInstanceRubricsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[evaluation_service.GenerateInstanceRubricsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for generate_instance_rubrics
...
class AsyncEvaluationServiceRestTransport(_BaseEvaluationServiceRestTransport):
    ...
    def __init__(self,
        ...
        Args:
            ...
            interceptor (Optional[AsyncEvaluationServiceRestInterceptor]): Interceptor used
    ...
    class _EvaluateDataset(_BaseEvaluationServiceRestTransport._BaseEvaluateDataset, AsyncEvaluationServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseEvaluationServiceRestTransport._BaseEvaluateDataset._get_http_options()

            request, metadata = await self._interceptor.pre_evaluate_dataset(request, metadata)
            transcoded_request = _BaseEvaluationServiceRestTransport._BaseEvaluateDataset._get_transcoded_request(http_options, request)

            body = _BaseEvaluationServiceRestTransport._BaseEvaluateDataset._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseEvaluationServiceRestTransport._BaseEvaluateDataset._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncEvaluationServiceRestTransport._EvaluateDataset._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp, _ = await self._interceptor.post_evaluate_dataset_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _EvaluateInstances(_BaseEvaluationServiceRestTransport._BaseEvaluateInstances, AsyncEvaluationServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            request, metadata = await self._interceptor.pre_evaluate_instances(request, metadata)
            ...
            # Send the request
            response = await AsyncEvaluationServiceRestTransport._EvaluateInstances._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_evaluate_instances_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = evaluation_service.EvaluateInstancesResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
    ...
    class _GenerateInstanceRubrics(_BaseEvaluationServiceRestTransport._BaseGenerateInstanceRubrics, AsyncEvaluationServiceRestStub):
        def __hash__(self):
            return hash("AsyncEvaluationServiceRestTransport.GenerateInstanceRubrics")
        ...
        async def __call__(self,
            ...
            http_options = _BaseEvaluationServiceRestTransport._BaseGenerateInstanceRubrics._get_http_options()

            request, metadata = await self._interceptor.pre_generate_instance_rubrics(request, metadata)
            transcoded_request = _BaseEvaluationServiceRestTransport._BaseGenerateInstanceRubrics._get_transcoded_request(http_options, request)

            body = _BaseEvaluationServiceRestTransport._BaseGenerateInstanceRubrics._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseEvaluationServiceRestTransport._BaseGenerateInstanceRubrics._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncEvaluationServiceRestTransport._GenerateInstanceRubrics._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_generate_instance_rubrics(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_generate_instance_rubrics_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = evaluation_service.GenerateInstanceRubricsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.EvaluationServiceAsyncClient.generate_instance_rubrics",
                    extra = {
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
                        "rpcName": "GenerateInstanceRubrics",
                        "metadata": http_response["headers"],
    ...
    @property
    def evaluate_dataset(self) -> Callable[
    ...
    @property
    def generate_instance_rubrics(self) -> Callable[
    ...
    class _GetLocation(_BaseEvaluationServiceRestTransport._BaseGetLocation, AsyncEvaluationServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncEvaluationServiceRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseEvaluationServiceRestTransport._BaseListLocations, AsyncEvaluationServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncEvaluationServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetIamPolicy(_BaseEvaluationServiceRestTransport._BaseGetIamPolicy, AsyncEvaluationServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncEvaluationServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _SetIamPolicy(_BaseEvaluationServiceRestTransport._BaseSetIamPolicy, AsyncEvaluationServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncEvaluationServiceRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseEvaluationServiceRestTransport._BaseTestIamPermissions, AsyncEvaluationServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncEvaluationServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CancelOperation(_BaseEvaluationServiceRestTransport._BaseCancelOperation, AsyncEvaluationServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncEvaluationServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseEvaluationServiceRestTransport._BaseDeleteOperation, AsyncEvaluationServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncEvaluationServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseEvaluationServiceRestTransport._BaseGetOperation, AsyncEvaluationServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncEvaluationServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseEvaluationServiceRestTransport._BaseListOperations, AsyncEvaluationServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncEvaluationServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _WaitOperation(_BaseEvaluationServiceRestTransport._BaseWaitOperation, AsyncEvaluationServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncEvaluationServiceRestTransport._WaitOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
