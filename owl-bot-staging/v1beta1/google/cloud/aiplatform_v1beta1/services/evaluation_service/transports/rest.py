...
class EvaluationServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_evaluate_dataset(self, request: evaluation_service.EvaluateDatasetRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[evaluation_service.EvaluateDatasetRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_evaluate_dataset(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    def post_evaluate_dataset_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for evaluate_dataset
    ...
    def pre_evaluate_instances(self, request: evaluation_service.EvaluateInstancesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[evaluation_service.EvaluateInstancesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_evaluate_instances_with_metadata(self, response: evaluation_service.EvaluateInstancesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[evaluation_service.EvaluateInstancesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for evaluate_instances
    ...
    def pre_generate_instance_rubrics(self, request: evaluation_service.GenerateInstanceRubricsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[evaluation_service.GenerateInstanceRubricsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_generate_instance_rubrics(self, response: evaluation_service.GenerateInstanceRubricsResponse) -> evaluation_service.GenerateInstanceRubricsResponse:
    ...
    def post_generate_instance_rubrics_with_metadata(self, response: evaluation_service.GenerateInstanceRubricsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[evaluation_service.GenerateInstanceRubricsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for generate_instance_rubrics
...
class EvaluationServiceRestTransport(_BaseEvaluationServiceRestTransport):
    ...
    class _EvaluateDataset(_BaseEvaluationServiceRestTransport._BaseEvaluateDataset, EvaluationServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            request, metadata = self._interceptor.pre_evaluate_dataset(request, metadata)
            ...
            # Send the request
            response = EvaluationServiceRestTransport._EvaluateDataset._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp, _ = self._interceptor.post_evaluate_dataset_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _EvaluateInstances(_BaseEvaluationServiceRestTransport._BaseEvaluateInstances, EvaluationServiceRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_evaluate_instances_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _GenerateInstanceRubrics(_BaseEvaluationServiceRestTransport._BaseGenerateInstanceRubrics, EvaluationServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            request, metadata = self._interceptor.pre_generate_instance_rubrics(request, metadata)
            ...
            # Send the request
            response = EvaluationServiceRestTransport._GenerateInstanceRubrics._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_generate_instance_rubrics_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
