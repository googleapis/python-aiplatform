...
class EvaluationServiceAsyncClient:
    ...
    rag_corpus_path = staticmethod(EvaluationServiceClient.rag_corpus_path)
    parse_rag_corpus_path = staticmethod(EvaluationServiceClient.parse_rag_corpus_path)
    ...
    async def evaluate_instances(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.evaluate_instances]
    ...
    async def evaluate_dataset(self,
            request: Optional[Union[evaluation_service.EvaluateDatasetRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            async def sample_evaluate_dataset():
                ...
                # Make the request
                operation = await client.evaluate_dataset(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.evaluate_dataset]
    ...
    async def generate_instance_rubrics(self,
            request: Optional[Union[evaluation_service.GenerateInstanceRubricsRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            async def sample_generate_instance_rubrics():
                # Create a client
                client = aiplatform_v1beta1.EvaluationServiceAsyncClient()
                ...
                # Make the request
                response = await client.generate_instance_rubrics(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.GenerateInstanceRubricsRequest, dict]]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.generate_instance_rubrics]
