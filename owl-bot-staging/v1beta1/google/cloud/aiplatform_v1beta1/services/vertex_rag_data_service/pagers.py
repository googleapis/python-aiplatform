...
class ListRagCorporaAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[vertex_rag_data_service.ListRagCorporaResponse]],
            request: vertex_rag_data_service.ListRagCorporaRequest,
            response: vertex_rag_data_service.ListRagCorporaResponse,
            *,
    ...
    @property
    async def pages(self) -> AsyncIterator[vertex_rag_data_service.ListRagCorporaResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
...
class ListRagFilesAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[vertex_rag_data_service.ListRagFilesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListRagDataSchemasAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[vertex_rag_data_service.ListRagDataSchemasResponse]],
            request: vertex_rag_data_service.ListRagDataSchemasRequest,
            response: vertex_rag_data_service.ListRagDataSchemasResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[vertex_rag_data_service.ListRagDataSchemasResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListRagMetadataAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[vertex_rag_data_service.ListRagMetadataResponse]],
            request: vertex_rag_data_service.ListRagMetadataRequest,
            response: vertex_rag_data_service.ListRagMetadataResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[vertex_rag_data_service.ListRagMetadataResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
