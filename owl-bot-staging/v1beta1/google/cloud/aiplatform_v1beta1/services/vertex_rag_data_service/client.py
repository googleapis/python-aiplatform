...
class VertexRagDataServiceClient(metaclass=VertexRagDataServiceClientMeta):
    ...
    @staticmethod
    def rag_data_schema_path(project: str,location: str,rag_corpus: str,rag_data_schema: str,) -> str:
        """Returns a fully-qualified rag_data_schema string."""
        return "projects/{project}/locations/{location}/ragCorpora/{rag_corpus}/ragDataSchemas/{rag_data_schema}".format(project=project, location=location, rag_corpus=rag_corpus, rag_data_schema=rag_data_schema, )

    @staticmethod
    def parse_rag_data_schema_path(path: str) -> Dict[str,str]:
        """Parses a rag_data_schema path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/ragCorpora/(?P<rag_corpus>.+?)/ragDataSchemas/(?P<rag_data_schema>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def rag_metadata_path(project: str,location: str,rag_corpus: str,rag_file: str,rag_metadata: str,) -> str:
        """Returns a fully-qualified rag_metadata string."""
        return "projects/{project}/locations/{location}/ragCorpora/{rag_corpus}/ragFiles/{rag_file}/ragMetadata/{rag_metadata}".format(project=project, location=location, rag_corpus=rag_corpus, rag_file=rag_file, rag_metadata=rag_metadata, )

    @staticmethod
    def parse_rag_metadata_path(path: str) -> Dict[str,str]:
        """Parses a rag_metadata path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/ragCorpora/(?P<rag_corpus>.+?)/ragFiles/(?P<rag_file>.+?)/ragMetadata/(?P<rag_metadata>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def create_rag_data_schema(self,
    ...
    def batch_create_rag_data_schemas(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_create_rag_data_schemas]
    ...
    def list_rag_data_schemas(self,
    ...
    def delete_rag_data_schema(self,
    ...
    def batch_delete_rag_data_schemas(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_delete_rag_data_schemas]
    ...
    def batch_create_rag_metadata(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_create_rag_metadata]
    ...
    def batch_delete_rag_metadata(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_delete_rag_metadata]
