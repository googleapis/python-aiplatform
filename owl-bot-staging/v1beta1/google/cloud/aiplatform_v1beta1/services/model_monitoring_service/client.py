...
try:
    from .transports.rest_asyncio import AsyncModelMonitoringServiceRestTransport
...
class ModelMonitoringServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ModelMonitoringServiceTransport]]
...
class ModelMonitoringServiceClient(metaclass=ModelMonitoringServiceClientMeta):
    ...
    @staticmethod
    def model_monitor_path(project: str,location: str,model_monitor: str,) -> str:
        """Returns a fully-qualified model_monitor string."""
        return "projects/{project}/locations/{location}/modelMonitors/{model_monitor}".format(project=project, location=location, model_monitor=model_monitor, )

    @staticmethod
    def parse_model_monitor_path(path: str) -> Dict[str,str]:
        """Parses a model_monitor path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/modelMonitors/(?P<model_monitor>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def model_monitoring_job_path(project: str,location: str,model_monitor: str,model_monitoring_job: str,) -> str:
        """Returns a fully-qualified model_monitoring_job string."""
        return "projects/{project}/locations/{location}/modelMonitors/{model_monitor}/modelMonitoringJobs/{model_monitoring_job}".format(project=project, location=location, model_monitor=model_monitor, model_monitoring_job=model_monitoring_job, )

    @staticmethod
    def parse_model_monitoring_job_path(path: str) -> Dict[str,str]:
        """Parses a model_monitoring_job path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/modelMonitors/(?P<model_monitor>.+?)/modelMonitoringJobs/(?P<model_monitoring_job>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ModelMonitoringServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ModelMonitoringServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ModelMonitoringServiceTransport, Callable[..., ModelMonitoringServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ModelMonitoringServiceClient._read_environment_variables()
        self._client_cert_source = ModelMonitoringServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ModelMonitoringServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            transport_init: Union[Type[ModelMonitoringServiceTransport], Callable[..., ModelMonitoringServiceTransport]] = (
    ...
    def create_model_monitor(self,
            request: Optional[Union[model_monitoring_service.CreateModelMonitorRequest, dict]] = None,
            *,
    ...
    def update_model_monitor(self,
            request: Optional[Union[model_monitoring_service.UpdateModelMonitorRequest, dict]] = None,
            *,
            model_monitor: Optional[gca_model_monitor.ModelMonitor] = None,
    ...
    def get_model_monitor(self,
            request: Optional[Union[model_monitoring_service.GetModelMonitorRequest, dict]] = None,
            *,
    ...
    def list_model_monitors(self,
            request: Optional[Union[model_monitoring_service.ListModelMonitorsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def delete_model_monitor(self,
            request: Optional[Union[model_monitoring_service.DeleteModelMonitorRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def create_model_monitoring_job(self,
            request: Optional[Union[model_monitoring_service.CreateModelMonitoringJobRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            model_monitoring_job: Optional[gca_model_monitoring_job.ModelMonitoringJob] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, model_monitoring_service.CreateModelMonitoringJobRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_model_monitoring_job]
    ...
    def get_model_monitoring_job(self,
            request: Optional[Union[model_monitoring_service.GetModelMonitoringJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, model_monitoring_service.GetModelMonitoringJobRequest):
    ...
    def list_model_monitoring_jobs(self,
            request: Optional[Union[model_monitoring_service.ListModelMonitoringJobsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, model_monitoring_service.ListModelMonitoringJobsRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_model_monitoring_jobs]
    ...
    def delete_model_monitoring_job(self,
            request: Optional[Union[model_monitoring_service.DeleteModelMonitoringJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, model_monitoring_service.DeleteModelMonitoringJobRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_model_monitoring_job]
    ...
    def search_model_monitoring_stats(self,
            request: Optional[Union[model_monitoring_service.SearchModelMonitoringStatsRequest, dict]] = None,
            *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, model_monitoring_service.SearchModelMonitoringStatsRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_model_monitoring_stats]
    ...
    def search_model_monitoring_alerts(self,
            request: Optional[Union[model_monitoring_service.SearchModelMonitoringAlertsRequest, dict]] = None,
            *,
            model_monitor: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, model_monitoring_service.SearchModelMonitoringAlertsRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.search_model_monitoring_alerts]
