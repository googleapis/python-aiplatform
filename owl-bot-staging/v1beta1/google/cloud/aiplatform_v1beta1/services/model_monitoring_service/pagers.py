...
class ListModelMonitorsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[model_monitoring_service.ListModelMonitorsResponse]],
            request: model_monitoring_service.ListModelMonitorsRequest,
            response: model_monitoring_service.ListModelMonitorsResponse,
            *,
    ...
    @property
    async def pages(self) -> AsyncIterator[model_monitoring_service.ListModelMonitorsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
...
class ListModelMonitoringJobsPager:
    ...
    @property
    def pages(self) -> Iterator[model_monitoring_service.ListModelMonitoringJobsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListModelMonitoringJobsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[model_monitoring_service.ListModelMonitoringJobsResponse]],
            request: model_monitoring_service.ListModelMonitoringJobsRequest,
            response: model_monitoring_service.ListModelMonitoringJobsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[model_monitoring_service.ListModelMonitoringJobsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class SearchModelMonitoringStatsPager:
    ...
    """
    def __init__(self,
            method: Callable[..., model_monitoring_service.SearchModelMonitoringStatsResponse],
        ...
        """
        self._method = method
        self._request = model_monitoring_service.SearchModelMonitoringStatsRequest(request)
        self._response = response
        self._retry = retry
        self._timeout = timeout
        self._metadata = metadata
    ...
    @property
    def pages(self) -> Iterator[model_monitoring_service.SearchModelMonitoringStatsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class SearchModelMonitoringStatsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[model_monitoring_service.SearchModelMonitoringStatsResponse]],
            request: model_monitoring_service.SearchModelMonitoringStatsRequest,
            response: model_monitoring_service.SearchModelMonitoringStatsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[model_monitoring_service.SearchModelMonitoringStatsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class SearchModelMonitoringAlertsPager:
    ...
    """
    def __init__(self,
            method: Callable[..., model_monitoring_service.SearchModelMonitoringAlertsResponse],
        ...
        """
        self._method = method
        self._request = model_monitoring_service.SearchModelMonitoringAlertsRequest(request)
        self._response = response
        self._retry = retry
        self._timeout = timeout
        self._metadata = metadata
    ...
    @property
    def pages(self) -> Iterator[model_monitoring_service.SearchModelMonitoringAlertsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class SearchModelMonitoringAlertsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[model_monitoring_service.SearchModelMonitoringAlertsResponse]],
            request: model_monitoring_service.SearchModelMonitoringAlertsRequest,
            response: model_monitoring_service.SearchModelMonitoringAlertsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[model_monitoring_service.SearchModelMonitoringAlertsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
