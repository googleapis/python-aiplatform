...
class ModelMonitoringServiceTransport(abc.ABC):
    ...
    @property
    def create_model_monitor(self) -> Callable[
    ...
    @property
    def update_model_monitor(self) -> Callable[
    ...
    @property
    def get_model_monitor(self) -> Callable[
    ...
    @property
    def list_model_monitors(self) -> Callable[
    ...
    @property
    def delete_model_monitor(self) -> Callable[
    ...
    @property
    def create_model_monitoring_job(self) -> Callable[
    ...
    @property
    def get_model_monitoring_job(self) -> Callable[
    ...
    @property
    def list_model_monitoring_jobs(self) -> Callable[
    ...
    @property
    def delete_model_monitoring_job(self) -> Callable[
    ...
    @property
    def search_model_monitoring_stats(self) -> Callable[
    ...
    @property
    def search_model_monitoring_alerts(self) -> Callable[
