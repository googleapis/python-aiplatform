...
class ModelMonitoringServiceGrpcAsyncIOTransport(ModelMonitoringServiceTransport):
    ...
    def create_model_monitoring_job(self) -> Callable[
        ...
        if 'create_model_monitoring_job' not in self._stubs:
            self._stubs['create_model_monitoring_job'] = self._logged_channel.unary_unary(
    ...
    def list_model_monitoring_jobs(self) -> Callable[
        ...
        if 'list_model_monitoring_jobs' not in self._stubs:
            self._stubs['list_model_monitoring_jobs'] = self._logged_channel.unary_unary(
    ...
    def delete_model_monitoring_job(self) -> Callable[
        ...
        if 'delete_model_monitoring_job' not in self._stubs:
            self._stubs['delete_model_monitoring_job'] = self._logged_channel.unary_unary(
    ...
    def search_model_monitoring_stats(self) -> Callable[
        ...
        if 'search_model_monitoring_stats' not in self._stubs:
            self._stubs['search_model_monitoring_stats'] = self._logged_channel.unary_unary(
    ...
    def search_model_monitoring_alerts(self) -> Callable[
        ...
        if 'search_model_monitoring_alerts' not in self._stubs:
            self._stubs['search_model_monitoring_alerts'] = self._logged_channel.unary_unary(
