...
class LlmUtilityServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(LlmUtilityServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(LlmUtilityServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(LlmUtilityServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(LlmUtilityServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(LlmUtilityServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(LlmUtilityServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(LlmUtilityServiceClient.common_project_path)
    parse_common_project_path = staticmethod(LlmUtilityServiceClient.parse_common_project_path)
    common_location_path = staticmethod(LlmUtilityServiceClient.common_location_path)
    parse_common_location_path = staticmethod(LlmUtilityServiceClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(LlmUtilityServiceClient).get_transport_class, type(LlmUtilityServiceClient))
    ...
    async def compute_tokens(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.compute_tokens]
