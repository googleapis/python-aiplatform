...
class FeaturestoreServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = FeaturestoreServiceClient.from_service_account_info.__func__  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            FeaturestoreServiceAsyncClient: The constructed client.
        """
        sa_file_func = FeaturestoreServiceClient.from_service_account_file.__func__  # type: ignore
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, FeaturestoreServiceTransport, Callable[..., FeaturestoreServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_featurestore(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_featurestore]
    ...
    async def list_featurestores(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_featurestores]
    ...
    async def update_featurestore(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_featurestore]
    ...
    async def import_feature_values(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.import_feature_values]
    ...
    async def batch_read_feature_values(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_read_feature_values]
    ...
    async def export_feature_values(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_feature_values]
    ...
    async def delete_feature_values(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_feature_values]
    ...
    async def search_features(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_features]
