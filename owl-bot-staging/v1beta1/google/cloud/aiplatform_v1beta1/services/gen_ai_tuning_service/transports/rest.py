...
class GenAiTuningServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_cancel_tuning_job(self, request: genai_tuning_service.CancelTuningJobRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[genai_tuning_service.CancelTuningJobRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_create_tuning_job(self, request: genai_tuning_service.CreateTuningJobRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[genai_tuning_service.CreateTuningJobRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_tuning_job_with_metadata(self, response: gca_tuning_job.TuningJob, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gca_tuning_job.TuningJob, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_tuning_job
    ...
    def pre_get_tuning_job(self, request: genai_tuning_service.GetTuningJobRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[genai_tuning_service.GetTuningJobRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_tuning_job_with_metadata(self, response: tuning_job.TuningJob, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[tuning_job.TuningJob, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_tuning_job
    ...
    def pre_list_tuning_jobs(self, request: genai_tuning_service.ListTuningJobsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[genai_tuning_service.ListTuningJobsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_tuning_jobs_with_metadata(self, response: genai_tuning_service.ListTuningJobsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[genai_tuning_service.ListTuningJobsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_tuning_jobs
    ...
    def pre_rebase_tuned_model(self, request: genai_tuning_service.RebaseTunedModelRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[genai_tuning_service.RebaseTunedModelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_rebase_tuned_model_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for rebase_tuned_model
...
class GenAiTuningServiceRestTransport(_BaseGenAiTuningServiceRestTransport):
    ...
    def __init__(self, *,
        ...
        Args:
            ...
            interceptor (Optional[GenAiTuningServiceRestInterceptor]): Interceptor used
    ...
    class _CreateTuningJob(_BaseGenAiTuningServiceRestTransport._BaseCreateTuningJob, GenAiTuningServiceRestStub):
        ...
        def __call__(self,
            ...
            resp, _ = self._interceptor.post_create_tuning_job_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _GetTuningJob(_BaseGenAiTuningServiceRestTransport._BaseGetTuningJob, GenAiTuningServiceRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_get_tuning_job_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _ListTuningJobs(_BaseGenAiTuningServiceRestTransport._BaseListTuningJobs, GenAiTuningServiceRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_tuning_jobs_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = genai_tuning_service.ListTuningJobsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _RebaseTunedModel(_BaseGenAiTuningServiceRestTransport._BaseRebaseTunedModel, GenAiTuningServiceRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_rebase_tuned_model_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _GetIamPolicy(_BaseGenAiTuningServiceRestTransport._BaseGetIamPolicy, GenAiTuningServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GenAiTuningServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseGenAiTuningServiceRestTransport._BaseTestIamPermissions, GenAiTuningServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = GenAiTuningServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
