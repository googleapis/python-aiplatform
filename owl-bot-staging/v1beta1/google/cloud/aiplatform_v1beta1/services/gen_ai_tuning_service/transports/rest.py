...
from .base import GenAiTuningServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class GenAiTuningServiceRestTransport(GenAiTuningServiceTransport):
    ...
    class _RebaseTunedModel(GenAiTuningServiceRestStub):
        def __hash__(self):
            return hash("RebaseTunedModel")
