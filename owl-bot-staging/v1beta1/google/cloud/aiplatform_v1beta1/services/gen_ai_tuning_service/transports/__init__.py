...
try:
    ...
    ASYNC_REST_CLASSES = ('AsyncGenAiTuningServiceRestTransport', 'AsyncGenAiTuningServiceRestInterceptor')
    HAS_REST_ASYNC = True
...
_transport_registry = OrderedDict()  # type: Dict[str, Type[GenAiTuningServiceTransport]]
