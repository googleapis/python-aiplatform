...
class _BaseOnlineEvaluatorServiceRestTransport(OnlineEvaluatorServiceTransport):
    """Base REST backend transport for OnlineEvaluatorService.
    ...
    class _BaseActivateOnlineEvaluator:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta1/{name=projects/*/locations/*/onlineEvaluators/*}:activate',
                'body': '*',
            },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = online_evaluator_service.ActivateOnlineEvaluatorRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseOnlineEvaluatorServiceRestTransport._BaseActivateOnlineEvaluator._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseCreateOnlineEvaluator:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = online_evaluator_service.CreateOnlineEvaluatorRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseOnlineEvaluatorServiceRestTransport._BaseCreateOnlineEvaluator._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseDeleteOnlineEvaluator:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = online_evaluator_service.DeleteOnlineEvaluatorRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseOnlineEvaluatorServiceRestTransport._BaseDeleteOnlineEvaluator._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseGetOnlineEvaluator:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = online_evaluator_service.GetOnlineEvaluatorRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseOnlineEvaluatorServiceRestTransport._BaseGetOnlineEvaluator._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseListOnlineEvaluators:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = online_evaluator_service.ListOnlineEvaluatorsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseOnlineEvaluatorServiceRestTransport._BaseListOnlineEvaluators._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseSuspendOnlineEvaluator:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta1/{name=projects/*/locations/*/onlineEvaluators/*}:suspend',
                'body': '*',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = online_evaluator_service.SuspendOnlineEvaluatorRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseOnlineEvaluatorServiceRestTransport._BaseSuspendOnlineEvaluator._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseUpdateOnlineEvaluator:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v1beta1/{online_evaluator.name=projects/*/locations/*/onlineEvaluators/*}',
                'body': 'online_evaluator',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = online_evaluator_service.UpdateOnlineEvaluatorRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseOnlineEvaluatorServiceRestTransport._BaseUpdateOnlineEvaluator._get_unset_required_fields(query_params))
