...
class OnlineEvaluatorServiceTransport(abc.ABC):
    """Abstract transport class for OnlineEvaluatorService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_online_evaluator: gapic_v1.method.wrap_method(
                self.create_online_evaluator,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_online_evaluator: gapic_v1.method.wrap_method(
                self.get_online_evaluator,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_online_evaluator: gapic_v1.method.wrap_method(
                self.update_online_evaluator,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_online_evaluator: gapic_v1.method.wrap_method(
                self.delete_online_evaluator,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_online_evaluators: gapic_v1.method.wrap_method(
                self.list_online_evaluators,
                default_timeout=None,
                client_info=client_info,
            ),
            self.activate_online_evaluator: gapic_v1.method.wrap_method(
                self.activate_online_evaluator,
                default_timeout=None,
                client_info=client_info,
            ),
            self.suspend_online_evaluator: gapic_v1.method.wrap_method(
