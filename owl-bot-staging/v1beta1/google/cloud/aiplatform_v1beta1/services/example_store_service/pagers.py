...
class ListExampleStoresAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[example_store_service.ListExampleStoresResponse]],
            request: example_store_service.ListExampleStoresRequest,
            response: example_store_service.ListExampleStoresResponse,
            *,
    ...
    @property
    async def pages(self) -> AsyncIterator[example_store_service.ListExampleStoresResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
