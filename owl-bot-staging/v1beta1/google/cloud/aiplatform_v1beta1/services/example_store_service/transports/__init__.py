...
try:
    ...
    ASYNC_REST_CLASSES = ('AsyncExampleStoreServiceRestTransport', 'AsyncExampleStoreServiceRestInterceptor')
    HAS_REST_ASYNC = True
...
_transport_registry = OrderedDict()  # type: Dict[str, Type[ExampleStoreServiceTransport]]
