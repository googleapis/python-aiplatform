...
class FeatureOnlineStoreServiceClient(metaclass=FeatureOnlineStoreServiceClientMeta):
    ...
    def streaming_fetch_feature_values(self,
            requests: Optional[Iterator[feature_online_store_service.StreamingFetchFeatureValuesRequest]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.streaming_fetch_feature_values]
