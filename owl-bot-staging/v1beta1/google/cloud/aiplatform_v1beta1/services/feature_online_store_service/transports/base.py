...
class FeatureOnlineStoreServiceTransport(abc.ABC):
    ...
    @property
    def fetch_feature_values(self) -> Callable[
    ...
    @property
    def streaming_fetch_feature_values(self) -> Callable[
    ...
    @property
    def search_nearest_entities(self) -> Callable[
    ...
    @property
    def feature_view_direct_write(self) -> Callable[
    ...
    @property
    def generate_fetch_access_token(self) -> Callable[
