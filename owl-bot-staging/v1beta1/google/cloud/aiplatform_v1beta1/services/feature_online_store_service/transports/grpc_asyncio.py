...
class FeatureOnlineStoreServiceGrpcAsyncIOTransport(FeatureOnlineStoreServiceTransport):
    ...
    def streaming_fetch_feature_values(self) -> Callable[
        ...
        if 'streaming_fetch_feature_values' not in self._stubs:
            self._stubs['streaming_fetch_feature_values'] = self._logged_channel.stream_stream(
    ...
    def feature_view_direct_write(self) -> Callable[
        ...
        if 'feature_view_direct_write' not in self._stubs:
            self._stubs['feature_view_direct_write'] = self._logged_channel.stream_stream(
    ...
    def generate_fetch_access_token(self) -> Callable[
        ...
        if 'generate_fetch_access_token' not in self._stubs:
            self._stubs['generate_fetch_access_token'] = self._logged_channel.unary_unary(
