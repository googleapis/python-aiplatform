...
class FeatureOnlineStoreServiceGrpcAsyncIOTransport(FeatureOnlineStoreServiceTransport):
    ...
    def streaming_fetch_feature_values(self) -> Callable[
        ...
        if 'streaming_fetch_feature_values' not in self._stubs:
            self._stubs['streaming_fetch_feature_values'] = self.grpc_channel.stream_stream(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.fetch_feature_values: gapic_v1.method_async.wrap_method(
                self.fetch_feature_values,
                default_timeout=None,
                client_info=client_info,
            ),
            self.streaming_fetch_feature_values: gapic_v1.method_async.wrap_method(
                self.streaming_fetch_feature_values,
                default_timeout=None,
                client_info=client_info,
            ),
            self.search_nearest_entities: gapic_v1.method_async.wrap_method(
