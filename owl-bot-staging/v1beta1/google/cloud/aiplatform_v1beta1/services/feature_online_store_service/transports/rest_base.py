...
class _BaseFeatureOnlineStoreServiceRestTransport(FeatureOnlineStoreServiceTransport):
    ...
    class _BaseFetchFeatureValues:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseFeatureOnlineStoreServiceRestTransport._BaseFetchFeatureValues._get_unset_required_fields(query_params))
    ...
    class _BaseGenerateFetchAccessToken:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = feature_online_store_service.GenerateFetchAccessTokenRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
    ...
    class _BaseSearchNearestEntities:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseFeatureOnlineStoreServiceRestTransport._BaseSearchNearestEntities._get_unset_required_fields(query_params))
