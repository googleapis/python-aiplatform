...
from .base import FeatureOnlineStoreServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class FeatureOnlineStoreServiceRestTransport(FeatureOnlineStoreServiceTransport):
    ...
    class _FetchFeatureValues(FeatureOnlineStoreServiceRestStub):
        ...
        def __call__(self,
            ...
            pb_request = feature_online_store_service.FetchFeatureValuesRequest.pb(request)
    ...
    class _SearchNearestEntities(FeatureOnlineStoreServiceRestStub):
        ...
        def __call__(self,
            ...
            pb_request = feature_online_store_service.SearchNearestEntitiesRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
