...
class FeatureOnlineStoreServiceAsyncClient:
    ...
    def streaming_fetch_feature_values(self,
            requests: Optional[AsyncIterator[feature_online_store_service.StreamingFetchFeatureValuesRequest]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> Awaitable[AsyncIterable[feature_online_store_service.StreamingFetchFeatureValuesResponse]]:
