...
class VertexRagServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(VertexRagServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(VertexRagServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(VertexRagServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(VertexRagServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(VertexRagServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(VertexRagServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(VertexRagServiceClient.common_project_path)
    parse_common_project_path = staticmethod(VertexRagServiceClient.parse_common_project_path)
    common_location_path = staticmethod(VertexRagServiceClient.common_location_path)
    parse_common_location_path = staticmethod(VertexRagServiceClient.parse_common_location_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, VertexRagServiceTransport, Callable[..., VertexRagServiceTransport]]] = "grpc_asyncio",
    ...
    async def retrieve_contexts(self,
            request: Optional[Union[vertex_rag_service.RetrieveContextsRequest, dict]] = None,
            *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.retrieve_contexts]
    ...
    async def augment_prompt(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.augment_prompt]
    ...
    async def corroborate_content(self,
            request: Optional[Union[vertex_rag_service.CorroborateContentRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.corroborate_content]
    ...
    async def ask_contexts(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.ask_contexts]
    ...
    async def async_retrieve_contexts(self,
            request: Optional[Union[vertex_rag_service.AsyncRetrieveContextsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            query: Optional[vertex_rag_service.RagQuery] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_async_retrieve_contexts():
                ...
                # Make the request
                operation = await client.async_retrieve_contexts(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.async_retrieve_contexts]
