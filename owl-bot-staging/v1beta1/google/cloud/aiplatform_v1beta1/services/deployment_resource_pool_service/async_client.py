...
class DeploymentResourcePoolServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = DeploymentResourcePoolServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = DeploymentResourcePoolServiceClient._DEFAULT_UNIVERSE

    deployment_resource_pool_path = staticmethod(DeploymentResourcePoolServiceClient.deployment_resource_pool_path)
    parse_deployment_resource_pool_path = staticmethod(DeploymentResourcePoolServiceClient.parse_deployment_resource_pool_path)
    ...
    parse_common_folder_path = staticmethod(DeploymentResourcePoolServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(DeploymentResourcePoolServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(DeploymentResourcePoolServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(DeploymentResourcePoolServiceClient.common_project_path)
    parse_common_project_path = staticmethod(DeploymentResourcePoolServiceClient.parse_common_project_path)
    common_location_path = staticmethod(DeploymentResourcePoolServiceClient.common_location_path)
    parse_common_location_path = staticmethod(DeploymentResourcePoolServiceClient.parse_common_location_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        return sa_info_func(DeploymentResourcePoolServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        return sa_file_func(DeploymentResourcePoolServiceAsyncClient, filename, *args, **kwargs)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DeploymentResourcePoolServiceTransport, Callable[..., DeploymentResourcePoolServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_deployment_resource_pool(self,
        ...
        .. code-block:: python
            ...
            async def sample_create_deployment_resource_pool():
                ...
                # Make the request
                operation = await client.create_deployment_resource_pool(request=request)
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_deployment_resource_pool]
    ...
    async def get_deployment_resource_pool(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_deployment_resource_pool]
    ...
    async def list_deployment_resource_pools(self,
    ...
    async def update_deployment_resource_pool(self,
        ...
        .. code-block:: python
            ...
            async def sample_update_deployment_resource_pool():
                ...
                # Make the request
                operation = await client.update_deployment_resource_pool(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_deployment_resource_pool]
    ...
    async def delete_deployment_resource_pool(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_deployment_resource_pool():
                ...
                # Make the request
                operation = await client.delete_deployment_resource_pool(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_deployment_resource_pool]
    ...
    async def query_deployed_models(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.query_deployed_models]
