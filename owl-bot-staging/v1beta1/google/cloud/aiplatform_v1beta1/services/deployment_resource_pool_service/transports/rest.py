...
from .base import DeploymentResourcePoolServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class DeploymentResourcePoolServiceRestTransport(DeploymentResourcePoolServiceTransport):
    ...
    class _CreateDeploymentResourcePool(DeploymentResourcePoolServiceRestStub):
        ...
        resource pool method over HTTP.
            ...
            pb_request = deployment_resource_pool_service.CreateDeploymentResourcePoolRequest.pb(request)
    ...
    class _DeleteDeploymentResourcePool(DeploymentResourcePoolServiceRestStub):
        ...
        resource pool method over HTTP.
            ...
            pb_request = deployment_resource_pool_service.DeleteDeploymentResourcePoolRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetDeploymentResourcePool(DeploymentResourcePoolServiceRestStub):
        ...
        pool method over HTTP.
            ...
            pb_request = deployment_resource_pool_service.GetDeploymentResourcePoolRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListDeploymentResourcePools(DeploymentResourcePoolServiceRestStub):
        ...
        pools method over HTTP.
            ...
            pb_request = deployment_resource_pool_service.ListDeploymentResourcePoolsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _QueryDeployedModels(DeploymentResourcePoolServiceRestStub):
        ...
        def __call__(self,
            ...
            pb_request = deployment_resource_pool_service.QueryDeployedModelsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _UpdateDeploymentResourcePool(DeploymentResourcePoolServiceRestStub):
        def __hash__(self):
            return hash("UpdateDeploymentResourcePool")
        ...
        resource pool method over HTTP.
            ...
            pb_request = deployment_resource_pool_service.UpdateDeploymentResourcePoolRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
