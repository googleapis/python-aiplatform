...
class DeploymentResourcePoolServiceGrpcAsyncIOTransport(DeploymentResourcePoolServiceTransport):
    ...
    def create_deployment_resource_pool(self) -> Callable[
        ...
        if 'create_deployment_resource_pool' not in self._stubs:
            self._stubs['create_deployment_resource_pool'] = self._logged_channel.unary_unary(
    ...
    def get_deployment_resource_pool(self) -> Callable[
        ...
        if 'get_deployment_resource_pool' not in self._stubs:
            self._stubs['get_deployment_resource_pool'] = self._logged_channel.unary_unary(
    ...
    def list_deployment_resource_pools(self) -> Callable[
        ...
        if 'list_deployment_resource_pools' not in self._stubs:
            self._stubs['list_deployment_resource_pools'] = self._logged_channel.unary_unary(
    ...
    def update_deployment_resource_pool(self) -> Callable[
        ...
        if 'update_deployment_resource_pool' not in self._stubs:
            self._stubs['update_deployment_resource_pool'] = self._logged_channel.unary_unary(
    ...
    def delete_deployment_resource_pool(self) -> Callable[
        ...
        if 'delete_deployment_resource_pool' not in self._stubs:
            self._stubs['delete_deployment_resource_pool'] = self._logged_channel.unary_unary(
