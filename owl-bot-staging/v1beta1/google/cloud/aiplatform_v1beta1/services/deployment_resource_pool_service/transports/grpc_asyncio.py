...
class DeploymentResourcePoolServiceGrpcAsyncIOTransport(DeploymentResourcePoolServiceTransport):
    ...
    def create_deployment_resource_pool(self) -> Callable[
        ...
        if 'create_deployment_resource_pool' not in self._stubs:
            self._stubs['create_deployment_resource_pool'] = self.grpc_channel.unary_unary(
    ...
    def list_deployment_resource_pools(self) -> Callable[
        ...
        if 'list_deployment_resource_pools' not in self._stubs:
            self._stubs['list_deployment_resource_pools'] = self.grpc_channel.unary_unary(
    ...
    def update_deployment_resource_pool(self) -> Callable[
        ...
        if 'update_deployment_resource_pool' not in self._stubs:
            self._stubs['update_deployment_resource_pool'] = self.grpc_channel.unary_unary(
    ...
    def delete_deployment_resource_pool(self) -> Callable[
        ...
        if 'delete_deployment_resource_pool' not in self._stubs:
            self._stubs['delete_deployment_resource_pool'] = self.grpc_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_deployment_resource_pool: gapic_v1.method_async.wrap_method(
                self.create_deployment_resource_pool,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_deployment_resource_pool: gapic_v1.method_async.wrap_method(
            ...
            self.delete_deployment_resource_pool: gapic_v1.method_async.wrap_method(
                self.delete_deployment_resource_pool,
                default_timeout=None,
                client_info=client_info,
            ),
            self.query_deployed_models: gapic_v1.method_async.wrap_method(
