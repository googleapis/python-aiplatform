...
class EndpointServiceAsyncClient:
    ...
    deployment_resource_pool_path = staticmethod(EndpointServiceClient.deployment_resource_pool_path)
    parse_deployment_resource_pool_path = staticmethod(EndpointServiceClient.parse_deployment_resource_pool_path)
    ...
    model_deployment_monitoring_job_path = staticmethod(EndpointServiceClient.model_deployment_monitoring_job_path)
    parse_model_deployment_monitoring_job_path = staticmethod(EndpointServiceClient.parse_model_deployment_monitoring_job_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, EndpointServiceTransport, Callable[..., EndpointServiceTransport]]] = "grpc_asyncio",
    ...
    async def mutate_deployed_model(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.mutate_deployed_model]
    ...
    async def set_publisher_model_config(self,
        ...
        .. code-block:: python
            ...
            async def sample_set_publisher_model_config():
                ...
                # Make the request
                operation = await client.set_publisher_model_config(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.set_publisher_model_config]
    ...
    async def fetch_publisher_model_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.fetch_publisher_model_config]
