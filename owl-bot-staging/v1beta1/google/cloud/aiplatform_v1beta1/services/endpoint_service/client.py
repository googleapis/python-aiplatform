...
class EndpointServiceClient(metaclass=EndpointServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, EndpointServiceTransport, Callable[..., EndpointServiceTransport]]] = None,
        ...
        self._client_cert_source = EndpointServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=EndpointServiceClient._DEFAULT_UNIVERSE)
        ...
        self._api_endpoint = (self._api_endpoint or
            get_api_endpoint(
                ...
                default_endpoint_template=EndpointServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if not transport_provided:
            transport_init: Union[Type[EndpointServiceTransport], Callable[..., EndpointServiceTransport]] = (
    ...
    def mutate_deployed_model(self,
            request: Optional[Union[endpoint_service.MutateDeployedModelRequest, dict]] = None,
            *,
            endpoint: Optional[str] = None,
            deployed_model: Optional[gca_endpoint.DeployedModel] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
    ...
    def set_publisher_model_config(self,
            request: Optional[Union[endpoint_service.SetPublisherModelConfigRequest, dict]] = None,
            *,
            name: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.set_publisher_model_config]
    ...
    def fetch_publisher_model_config(self,
            request: Optional[Union[endpoint_service.FetchPublisherModelConfigRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_publisher_model_config]
