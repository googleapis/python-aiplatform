...
class JobServiceRestTransport(_BaseJobServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseJobServiceRestTransport._BaseGetIamPolicy, JobServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = JobServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseJobServiceRestTransport._BaseTestIamPermissions, JobServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = JobServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
