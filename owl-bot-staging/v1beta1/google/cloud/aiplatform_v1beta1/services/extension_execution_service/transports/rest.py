...
from .base import ExtensionExecutionServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ExtensionExecutionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_execute_extension(self, request: extension_execution_service.ExecuteExtensionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[extension_execution_service.ExecuteExtensionRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_execute_extension(self, response: extension_execution_service.ExecuteExtensionResponse) -> extension_execution_service.ExecuteExtensionResponse:
        ...
        """
        return response
    def pre_query_extension(self, request: extension_execution_service.QueryExtensionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[extension_execution_service.QueryExtensionRequest, Sequence[Tuple[str, str]]]:
