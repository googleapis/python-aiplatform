...
class ExtensionExecutionServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ExtensionExecutionServiceTransport]]
...
class ExtensionExecutionServiceClient(metaclass=ExtensionExecutionServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ExtensionExecutionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ExtensionExecutionServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ExtensionExecutionServiceTransport, Callable[..., ExtensionExecutionServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ExtensionExecutionServiceClient._read_environment_variables()
        self._client_cert_source = ExtensionExecutionServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ExtensionExecutionServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            transport_init: Union[Type[ExtensionExecutionServiceTransport], Callable[..., ExtensionExecutionServiceTransport]] = (
