...
class ExtensionExecutionServiceClient(metaclass=ExtensionExecutionServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=ExtensionExecutionServiceClient._DEFAULT_UNIVERSE)
        ...
        self._api_endpoint = (self._api_endpoint or
            get_api_endpoint(
                ...
                default_endpoint_template=ExtensionExecutionServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
