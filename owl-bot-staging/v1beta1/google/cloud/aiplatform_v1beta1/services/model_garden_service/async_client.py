...
class ModelGardenServiceAsyncClient:
    ...
    parse_publisher_model_path = staticmethod(ModelGardenServiceClient.parse_publisher_model_path)
    reservation_path = staticmethod(ModelGardenServiceClient.reservation_path)
    parse_reservation_path = staticmethod(ModelGardenServiceClient.parse_reservation_path)
    common_billing_account_path = staticmethod(ModelGardenServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ModelGardenServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(ModelGardenServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(ModelGardenServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(ModelGardenServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(ModelGardenServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(ModelGardenServiceClient.common_project_path)
    parse_common_project_path = staticmethod(ModelGardenServiceClient.parse_common_project_path)
    common_location_path = staticmethod(ModelGardenServiceClient.common_location_path)
    parse_common_location_path = staticmethod(ModelGardenServiceClient.parse_common_location_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ModelGardenServiceTransport, Callable[..., ModelGardenServiceTransport]]] = "grpc_asyncio",
    ...
    async def get_publisher_model(self,
            request: Optional[Union[model_garden_service.GetPublisherModelRequest, dict]] = None,
            *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_publisher_model]
    ...
    async def list_publisher_models(self,
            request: Optional[Union[model_garden_service.ListPublisherModelsRequest, dict]] = None,
            *,
    ...
    async def deploy(self,
        ...
        .. code-block:: python
            ...
            async def sample_deploy():
                ...
                # Make the request
                operation = await client.deploy(request=request)
    ...
    async def deploy_publisher_model(self,
            request: Optional[Union[model_garden_service.DeployPublisherModelRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            async def sample_deploy_publisher_model():
                ...
                # Make the request
                operation = await client.deploy_publisher_model(request=request)
        ...
        """
        warnings.warn("ModelGardenServiceAsyncClient.deploy_publisher_model is deprecated",
            DeprecationWarning)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.deploy_publisher_model]
    ...
    async def export_publisher_model(self,
            request: Optional[Union[model_garden_service.ExportPublisherModelRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.export_publisher_model]
    ...
    async def check_publisher_model_eula_acceptance(self,
            request: Optional[Union[model_garden_service.CheckPublisherModelEulaAcceptanceRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, model_garden_service.CheckPublisherModelEulaAcceptanceRequest):
            request = model_garden_service.CheckPublisherModelEulaAcceptanceRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.check_publisher_model_eula_acceptance]
    ...
    async def accept_publisher_model_eula(self,
            request: Optional[Union[model_garden_service.AcceptPublisherModelEulaRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            publisher_model: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, model_garden_service.AcceptPublisherModelEulaRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.accept_publisher_model_eula]
