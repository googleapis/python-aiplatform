...
class AsyncModelGardenServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    async def pre_accept_publisher_model_eula(self, request: model_garden_service.AcceptPublisherModelEulaRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_garden_service.AcceptPublisherModelEulaRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_accept_publisher_model_eula(self, response: model_garden_service.PublisherModelEulaAcceptance) -> model_garden_service.PublisherModelEulaAcceptance:
    ...
    async def post_accept_publisher_model_eula_with_metadata(self, response: model_garden_service.PublisherModelEulaAcceptance, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_garden_service.PublisherModelEulaAcceptance, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for accept_publisher_model_eula
    ...
    async def pre_check_publisher_model_eula_acceptance(self, request: model_garden_service.CheckPublisherModelEulaAcceptanceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_garden_service.CheckPublisherModelEulaAcceptanceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_check_publisher_model_eula_acceptance(self, response: model_garden_service.PublisherModelEulaAcceptance) -> model_garden_service.PublisherModelEulaAcceptance:
    ...
    async def post_check_publisher_model_eula_acceptance_with_metadata(self, response: model_garden_service.PublisherModelEulaAcceptance, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_garden_service.PublisherModelEulaAcceptance, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for check_publisher_model_eula_acceptance
    ...
    async def pre_deploy(self, request: model_garden_service.DeployRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_garden_service.DeployRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_deploy(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    async def post_deploy_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for deploy
    ...
    async def pre_deploy_publisher_model(self, request: model_garden_service.DeployPublisherModelRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_garden_service.DeployPublisherModelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_deploy_publisher_model(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    async def post_deploy_publisher_model_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for deploy_publisher_model
    ...
    async def pre_export_publisher_model(self, request: model_garden_service.ExportPublisherModelRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_garden_service.ExportPublisherModelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_export_publisher_model(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    async def post_export_publisher_model_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for export_publisher_model
    ...
    async def pre_get_publisher_model(self, request: model_garden_service.GetPublisherModelRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_garden_service.GetPublisherModelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_get_publisher_model(self, response: publisher_model.PublisherModel) -> publisher_model.PublisherModel:
    ...
    async def post_get_publisher_model_with_metadata(self, response: publisher_model.PublisherModel, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[publisher_model.PublisherModel, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_publisher_model
    ...
    async def pre_list_publisher_models(self, request: model_garden_service.ListPublisherModelsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_garden_service.ListPublisherModelsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_list_publisher_models(self, response: model_garden_service.ListPublisherModelsResponse) -> model_garden_service.ListPublisherModelsResponse:
    ...
    async def post_list_publisher_models_with_metadata(self, response: model_garden_service.ListPublisherModelsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_garden_service.ListPublisherModelsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_publisher_models
...
class AsyncModelGardenServiceRestTransport(_BaseModelGardenServiceRestTransport):
    ...
    def __init__(self,
        ...
        Args:
            ...
            interceptor (Optional[AsyncModelGardenServiceRestInterceptor]): Interceptor used
    ...
    class _AcceptPublisherModelEula(_BaseModelGardenServiceRestTransport._BaseAcceptPublisherModelEula, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        eula method over HTTP.
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseAcceptPublisherModelEula._get_http_options()

            request, metadata = await self._interceptor.pre_accept_publisher_model_eula(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseAcceptPublisherModelEula._get_transcoded_request(http_options, request)

            body = _BaseModelGardenServiceRestTransport._BaseAcceptPublisherModelEula._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseAcceptPublisherModelEula._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._AcceptPublisherModelEula._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp, _ = await self._interceptor.post_accept_publisher_model_eula_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = model_garden_service.PublisherModelEulaAcceptance.to_json(response)
                except:
    ...
    class _CheckPublisherModelEulaAcceptance(_BaseModelGardenServiceRestTransport._BaseCheckPublisherModelEulaAcceptance, AsyncModelGardenServiceRestStub):
        def __hash__(self):
            return hash("AsyncModelGardenServiceRestTransport.CheckPublisherModelEulaAcceptance")
        ...
        eula acceptance method over HTTP.
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseCheckPublisherModelEulaAcceptance._get_http_options()

            request, metadata = await self._interceptor.pre_check_publisher_model_eula_acceptance(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseCheckPublisherModelEulaAcceptance._get_transcoded_request(http_options, request)

            body = _BaseModelGardenServiceRestTransport._BaseCheckPublisherModelEulaAcceptance._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseCheckPublisherModelEulaAcceptance._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._CheckPublisherModelEulaAcceptance._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_check_publisher_model_eula_acceptance(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_check_publisher_model_eula_acceptance_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = model_garden_service.PublisherModelEulaAcceptance.to_json(response)
                except:
    ...
    class _Deploy(_BaseModelGardenServiceRestTransport._BaseDeploy, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseDeploy._get_http_options()

            request, metadata = await self._interceptor.pre_deploy(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseDeploy._get_transcoded_request(http_options, request)

            body = _BaseModelGardenServiceRestTransport._BaseDeploy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseDeploy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._Deploy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_deploy_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _DeployPublisherModel(_BaseModelGardenServiceRestTransport._BaseDeployPublisherModel, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseDeployPublisherModel._get_http_options()

            request, metadata = await self._interceptor.pre_deploy_publisher_model(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseDeployPublisherModel._get_transcoded_request(http_options, request)

            body = _BaseModelGardenServiceRestTransport._BaseDeployPublisherModel._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseDeployPublisherModel._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._DeployPublisherModel._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_deploy_publisher_model_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
    ...
    class _ExportPublisherModel(_BaseModelGardenServiceRestTransport._BaseExportPublisherModel, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseExportPublisherModel._get_http_options()

            request, metadata = await self._interceptor.pre_export_publisher_model(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseExportPublisherModel._get_transcoded_request(http_options, request)

            body = _BaseModelGardenServiceRestTransport._BaseExportPublisherModel._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseExportPublisherModel._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._ExportPublisherModel._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_export_publisher_model_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
    ...
    class _GetPublisherModel(_BaseModelGardenServiceRestTransport._BaseGetPublisherModel, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseGetPublisherModel._get_http_options()

            request, metadata = await self._interceptor.pre_get_publisher_model(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseGetPublisherModel._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseGetPublisherModel._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._GetPublisherModel._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_get_publisher_model_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _ListPublisherModels(_BaseModelGardenServiceRestTransport._BaseListPublisherModels, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseListPublisherModels._get_http_options()

            request, metadata = await self._interceptor.pre_list_publisher_models(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseListPublisherModels._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseListPublisherModels._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._ListPublisherModels._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_list_publisher_models_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = model_garden_service.ListPublisherModelsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
    ...
    @property
    def accept_publisher_model_eula(self) -> Callable[
    ...
    @property
    def check_publisher_model_eula_acceptance(self) -> Callable[
    ...
    @property
    def export_publisher_model(self) -> Callable[
    ...
    @property
    def get_publisher_model(self) -> Callable[
    ...
    @property
    def list_publisher_models(self) -> Callable[
    ...
    class _GetLocation(_BaseModelGardenServiceRestTransport._BaseGetLocation, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseGetLocation._get_http_options()

            request, metadata = await self._interceptor.pre_get_location(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseGetLocation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseGetLocation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseModelGardenServiceRestTransport._BaseListLocations, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseListLocations._get_http_options()

            request, metadata = await self._interceptor.pre_list_locations(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseListLocations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseListLocations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetIamPolicy(_BaseModelGardenServiceRestTransport._BaseGetIamPolicy, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseGetIamPolicy._get_http_options()

            request, metadata = await self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseGetIamPolicy._get_transcoded_request(http_options, request)

            body = _BaseModelGardenServiceRestTransport._BaseGetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseGetIamPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _SetIamPolicy(_BaseModelGardenServiceRestTransport._BaseSetIamPolicy, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseModelGardenServiceRestTransport._BaseTestIamPermissions, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = await self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseModelGardenServiceRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CancelOperation(_BaseModelGardenServiceRestTransport._BaseCancelOperation, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseCancelOperation._get_http_options()

            request, metadata = await self._interceptor.pre_cancel_operation(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseCancelOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseCancelOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseModelGardenServiceRestTransport._BaseDeleteOperation, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseDeleteOperation._get_http_options()

            request, metadata = await self._interceptor.pre_delete_operation(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseDeleteOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseDeleteOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseModelGardenServiceRestTransport._BaseGetOperation, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseGetOperation._get_http_options()

            request, metadata = await self._interceptor.pre_get_operation(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseModelGardenServiceRestTransport._BaseListOperations, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseListOperations._get_http_options()

            request, metadata = await self._interceptor.pre_list_operations(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseListOperations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseListOperations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _WaitOperation(_BaseModelGardenServiceRestTransport._BaseWaitOperation, AsyncModelGardenServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseModelGardenServiceRestTransport._BaseWaitOperation._get_http_options()

            request, metadata = await self._interceptor.pre_wait_operation(request, metadata)
            transcoded_request = _BaseModelGardenServiceRestTransport._BaseWaitOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseModelGardenServiceRestTransport._BaseWaitOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncModelGardenServiceRestTransport._WaitOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
