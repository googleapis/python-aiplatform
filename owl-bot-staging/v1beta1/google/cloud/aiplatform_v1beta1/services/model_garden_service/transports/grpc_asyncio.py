...
class ModelGardenServiceGrpcAsyncIOTransport(ModelGardenServiceTransport):
    ...
    def check_publisher_model_eula_acceptance(self) -> Callable[
        ...
        if 'check_publisher_model_eula_acceptance' not in self._stubs:
            self._stubs['check_publisher_model_eula_acceptance'] = self._logged_channel.unary_unary(
    ...
    def accept_publisher_model_eula(self) -> Callable[
        ...
        if 'accept_publisher_model_eula' not in self._stubs:
            self._stubs['accept_publisher_model_eula'] = self._logged_channel.unary_unary(
