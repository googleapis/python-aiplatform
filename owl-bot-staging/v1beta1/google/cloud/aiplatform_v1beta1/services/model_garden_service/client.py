...
class ModelGardenServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ModelGardenServiceTransport]]
...
class ModelGardenServiceClient(metaclass=ModelGardenServiceClientMeta):
    ...
    @staticmethod
    def publisher_model_path(publisher: str,model: str,) -> str:
        """Returns a fully-qualified publisher_model string."""
        return "publishers/{publisher}/models/{model}".format(publisher=publisher, model=model, )
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ModelGardenServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ModelGardenServiceTransport, Callable[..., ModelGardenServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ModelGardenServiceClient._read_environment_variables()
        self._client_cert_source = ModelGardenServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ModelGardenServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            transport_init: Union[Type[ModelGardenServiceTransport], Callable[..., ModelGardenServiceTransport]] = (
    ...
    def list_publisher_models(self,
    ...
    def deploy_publisher_model(self,
        ...
        """
        warnings.warn("ModelGardenServiceClient.deploy_publisher_model is deprecated",
            DeprecationWarning)
    ...
    def export_publisher_model(self,
    ...
    def check_publisher_model_eula_acceptance(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.check_publisher_model_eula_acceptance]
    ...
    def accept_publisher_model_eula(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.accept_publisher_model_eula]
