...
class ListPublisherModelsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[model_garden_service.ListPublisherModelsResponse]],
            request: model_garden_service.ListPublisherModelsRequest,
            response: model_garden_service.ListPublisherModelsResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[model_garden_service.ListPublisherModelsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
