...
class ReasoningEngineServiceAsyncClient:
    ...
    git_repository_link_path = staticmethod(ReasoningEngineServiceClient.git_repository_link_path)
    parse_git_repository_link_path = staticmethod(ReasoningEngineServiceClient.parse_git_repository_link_path)
    network_attachment_path = staticmethod(ReasoningEngineServiceClient.network_attachment_path)
    parse_network_attachment_path = staticmethod(ReasoningEngineServiceClient.parse_network_attachment_path)
    reasoning_engine_path = staticmethod(ReasoningEngineServiceClient.reasoning_engine_path)
    parse_reasoning_engine_path = staticmethod(ReasoningEngineServiceClient.parse_reasoning_engine_path)
    reasoning_engine_runtime_revision_path = staticmethod(ReasoningEngineServiceClient.reasoning_engine_runtime_revision_path)
    parse_reasoning_engine_runtime_revision_path = staticmethod(ReasoningEngineServiceClient.parse_reasoning_engine_runtime_revision_path)
    common_billing_account_path = staticmethod(ReasoningEngineServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ReasoningEngineServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(ReasoningEngineServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(ReasoningEngineServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(ReasoningEngineServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(ReasoningEngineServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(ReasoningEngineServiceClient.common_project_path)
    parse_common_project_path = staticmethod(ReasoningEngineServiceClient.parse_common_project_path)
    common_location_path = staticmethod(ReasoningEngineServiceClient.common_location_path)
    parse_common_location_path = staticmethod(ReasoningEngineServiceClient.parse_common_location_path)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        return sa_file_func(ReasoningEngineServiceAsyncClient, filename, *args, **kwargs)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ReasoningEngineServiceTransport, Callable[..., ReasoningEngineServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_reasoning_engine(self,
            request: Optional[Union[reasoning_engine_service.CreateReasoningEngineRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            async def sample_create_reasoning_engine():
                ...
                # Make the request
                operation = await client.create_reasoning_engine(request=request)
        ...
        if not isinstance(request, reasoning_engine_service.CreateReasoningEngineRequest):
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_reasoning_engine]
    ...
    async def get_reasoning_engine(self,
            request: Optional[Union[reasoning_engine_service.GetReasoningEngineRequest, dict]] = None,
            *,
    ...
    async def list_reasoning_engines(self,
            request: Optional[Union[reasoning_engine_service.ListReasoningEnginesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, reasoning_engine_service.ListReasoningEnginesRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_reasoning_engines]
    ...
    async def update_reasoning_engine(self,
            request: Optional[Union[reasoning_engine_service.UpdateReasoningEngineRequest, dict]] = None,
            *,
            reasoning_engine: Optional[gca_reasoning_engine.ReasoningEngine] = None,
        ...
        .. code-block:: python
            ...
            async def sample_update_reasoning_engine():
                ...
                # Make the request
                operation = await client.update_reasoning_engine(request=request)
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, reasoning_engine_service.UpdateReasoningEngineRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_reasoning_engine]
    ...
    async def delete_reasoning_engine(self,
            request: Optional[Union[reasoning_engine_service.DeleteReasoningEngineRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_reasoning_engine():
                ...
                # Make the request
                operation = await client.delete_reasoning_engine(request=request)
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, reasoning_engine_service.DeleteReasoningEngineRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_reasoning_engine]
