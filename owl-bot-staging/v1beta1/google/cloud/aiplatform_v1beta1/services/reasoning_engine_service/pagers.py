...
class ListReasoningEnginesAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[reasoning_engine_service.ListReasoningEnginesResponse]],
            request: reasoning_engine_service.ListReasoningEnginesRequest,
            response: reasoning_engine_service.ListReasoningEnginesResponse,
            *,
            metadata: Sequence[Tuple[str, str]] = ()):
    ...
    @property
    async def pages(self) -> AsyncIterator[reasoning_engine_service.ListReasoningEnginesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
