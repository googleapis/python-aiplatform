...
try:
    from .transports.rest_asyncio import AsyncReasoningEngineServiceRestTransport
...
class ReasoningEngineServiceClient(metaclass=ReasoningEngineServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint) -> str:
        ...
        if api_override is not None:
            ...
            api_endpoint = ReasoningEngineServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ReasoningEngineServiceTransport, Callable[..., ReasoningEngineServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ReasoningEngineServiceClient._read_environment_variables()
        self._client_cert_source = ReasoningEngineServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ReasoningEngineServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            transport_init: Union[Type[ReasoningEngineServiceTransport], Callable[..., ReasoningEngineServiceTransport]] = (
    ...
    def update_reasoning_engine(self,
    ...
    def delete_reasoning_engine(self,
