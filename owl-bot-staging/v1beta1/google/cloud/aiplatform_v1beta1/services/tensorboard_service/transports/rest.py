...
class TensorboardServiceRestTransport(_BaseTensorboardServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseTensorboardServiceRestTransport._BaseGetIamPolicy, TensorboardServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TensorboardServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseTensorboardServiceRestTransport._BaseTestIamPermissions, TensorboardServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = TensorboardServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
