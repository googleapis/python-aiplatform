...
class IndexServiceAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, IndexServiceTransport, Callable[..., IndexServiceTransport]]] = "grpc_asyncio",
    ...
    async def import_index(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.import_index]
    ...
    async def update_index(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_index]
    ...
    async def upsert_datapoints(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.upsert_datapoints]
    ...
    async def remove_datapoints(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.remove_datapoints]
