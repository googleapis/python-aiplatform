...
class ExtensionRegistryServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = ExtensionRegistryServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    parse_extension_path = staticmethod(ExtensionRegistryServiceClient.parse_extension_path)
    secret_version_path = staticmethod(ExtensionRegistryServiceClient.secret_version_path)
    parse_secret_version_path = staticmethod(ExtensionRegistryServiceClient.parse_secret_version_path)
    ...
    common_billing_account_path = staticmethod(ExtensionRegistryServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ExtensionRegistryServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(ExtensionRegistryServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(ExtensionRegistryServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(ExtensionRegistryServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(ExtensionRegistryServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(ExtensionRegistryServiceClient.common_project_path)
    parse_common_project_path = staticmethod(ExtensionRegistryServiceClient.parse_common_project_path)
    common_location_path = staticmethod(ExtensionRegistryServiceClient.common_location_path)
    parse_common_location_path = staticmethod(ExtensionRegistryServiceClient.parse_common_location_path)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        return sa_file_func(ExtensionRegistryServiceAsyncClient, filename, *args, **kwargs)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ExtensionRegistryServiceTransport, Callable[..., ExtensionRegistryServiceTransport]]] = "grpc_asyncio",
    ...
    async def import_extension(self,
        ...
        .. code-block:: python
            ...
            async def sample_import_extension():
                ...
                # Make the request
                operation = await client.import_extension(request=request)
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.import_extension]
    ...
    async def get_extension(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_extension]
    ...
    async def list_extensions(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_extensions]
    ...
    async def update_extension(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_extension]
    ...
    async def delete_extension(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_extension():
                ...
                # Make the request
                operation = await client.delete_extension(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_extension]
