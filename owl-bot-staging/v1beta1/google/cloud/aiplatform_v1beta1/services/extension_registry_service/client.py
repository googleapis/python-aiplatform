...
class ExtensionRegistryServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ExtensionRegistryServiceTransport]]
...
class ExtensionRegistryServiceClient(metaclass=ExtensionRegistryServiceClientMeta):
    ...
    @staticmethod
    def extension_path(project: str,location: str,extension: str,) -> str:
        """Returns a fully-qualified extension string."""
        return "projects/{project}/locations/{location}/extensions/{extension}".format(project=project, location=location, extension=extension, )

    @staticmethod
    def parse_extension_path(path: str) -> Dict[str,str]:
        """Parses a extension path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/extensions/(?P<extension>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = ExtensionRegistryServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ExtensionRegistryServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ExtensionRegistryServiceTransport, Callable[..., ExtensionRegistryServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ExtensionRegistryServiceClient._read_environment_variables()
        self._client_cert_source = ExtensionRegistryServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ExtensionRegistryServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[ExtensionRegistryServiceTransport], Callable[..., ExtensionRegistryServiceTransport]] = (
    ...
    def import_extension(self,
            request: Optional[Union[extension_registry_service.ImportExtensionRequest, dict]] = None,
            *,
    ...
    def get_extension(self,
            request: Optional[Union[extension_registry_service.GetExtensionRequest, dict]] = None,
            *,
    ...
    def list_extensions(self,
            request: Optional[Union[extension_registry_service.ListExtensionsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def update_extension(self,
            request: Optional[Union[extension_registry_service.UpdateExtensionRequest, dict]] = None,
            *,
            extension: Optional[gca_extension.Extension] = None,
    ...
    def delete_extension(self,
            request: Optional[Union[extension_registry_service.DeleteExtensionRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
