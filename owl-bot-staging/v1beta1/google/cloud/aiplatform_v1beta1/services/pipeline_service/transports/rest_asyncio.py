...
class AsyncPipelineServiceRestTransport(_BasePipelineServiceRestTransport):
    ...
    class _GetIamPolicy(_BasePipelineServiceRestTransport._BaseGetIamPolicy, AsyncPipelineServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncPipelineServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BasePipelineServiceRestTransport._BaseTestIamPermissions, AsyncPipelineServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncPipelineServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
