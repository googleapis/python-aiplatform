...
class SpecialistPoolServiceRestTransport(_BaseSpecialistPoolServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseSpecialistPoolServiceRestTransport._BaseGetIamPolicy, SpecialistPoolServiceRestStub):
        ...
        def __call__(self,
            ...
            body = _BaseSpecialistPoolServiceRestTransport._BaseGetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseGetIamPolicy._get_query_params_json(transcoded_request)

            # Send the request
            response = SpecialistPoolServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseSpecialistPoolServiceRestTransport._BaseTestIamPermissions, SpecialistPoolServiceRestStub):
        ...
        def __call__(self,
            ...
            body = _BaseSpecialistPoolServiceRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)

            # Send the request
            response = SpecialistPoolServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
