...
class SpecialistPoolServiceGrpcAsyncIOTransport(SpecialistPoolServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_specialist_pool: gapic_v1.method_async.wrap_method(
                self.create_specialist_pool,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.get_specialist_pool: gapic_v1.method_async.wrap_method(
                self.get_specialist_pool,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.list_specialist_pools: gapic_v1.method_async.wrap_method(
                self.list_specialist_pools,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.delete_specialist_pool: gapic_v1.method_async.wrap_method(
                self.delete_specialist_pool,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.update_specialist_pool: gapic_v1.method_async.wrap_method(
