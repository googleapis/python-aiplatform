...
class SessionServiceAsyncClient:
    ...
    parse_reasoning_engine_path = staticmethod(SessionServiceClient.parse_reasoning_engine_path)
    ...
    parse_session_event_path = staticmethod(SessionServiceClient.parse_session_event_path)
    ...
    async def append_event(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.append_event]
