...
class FeaturestoreOnlineServingServiceAsyncClient:
    ...
    async def write_feature_values(self,
            request: Union[featurestore_online_service.WriteFeatureValuesRequest, dict] = None,
            *,
            entity_type: str = None,
            payloads: Sequence[featurestore_online_service.WriteFeatureValuesPayload] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
