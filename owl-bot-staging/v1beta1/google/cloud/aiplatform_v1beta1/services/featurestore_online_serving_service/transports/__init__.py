...
try:
    ...
    ASYNC_REST_CLASSES = ('AsyncFeaturestoreOnlineServingServiceRestTransport', 'AsyncFeaturestoreOnlineServingServiceRestInterceptor')
    HAS_REST_ASYNC = True
...
if HAS_REST_ASYNC:  # pragma: NO COVER
    _transport_registry['rest_asyncio'] = AsyncFeaturestoreOnlineServingServiceRestTransport
