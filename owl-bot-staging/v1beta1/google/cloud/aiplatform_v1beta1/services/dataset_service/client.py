...
class DatasetServiceClient(metaclass=DatasetServiceClientMeta):
    ...
    @staticmethod
    def annotation_path(project: str,location: str,dataset: str,data_item: str,annotation: str,) -> str:
        """Returns a fully-qualified annotation string."""
        return "projects/{project}/locations/{location}/datasets/{dataset}/dataItems/{data_item}/annotations/{annotation}".format(project=project, location=location, dataset=dataset, data_item=data_item, annotation=annotation, )

    @staticmethod
    def parse_annotation_path(path: str) -> Dict[str,str]:
        """Parses a annotation path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/datasets/(?P<dataset>.+?)/dataItems/(?P<data_item>.+?)/annotations/(?P<annotation>.+?)$", path)
    ...
    @staticmethod
    def cached_content_path(project: str,location: str,cached_content: str,) -> str:
        """Returns a fully-qualified cached_content string."""
        return "projects/{project}/locations/{location}/cachedContents/{cached_content}".format(project=project, location=location, cached_content=cached_content, )

    @staticmethod
    def parse_cached_content_path(path: str) -> Dict[str,str]:
        """Parses a cached_content path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/cachedContents/(?P<cached_content>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def data_item_path(project: str,location: str,dataset: str,data_item: str,) -> str:
        """Returns a fully-qualified data_item string."""
        return "projects/{project}/locations/{location}/datasets/{dataset}/dataItems/{data_item}".format(project=project, location=location, dataset=dataset, data_item=data_item, )

    @staticmethod
    def parse_data_item_path(path: str) -> Dict[str,str]:
        """Parses a data_item path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/datasets/(?P<dataset>.+?)/dataItems/(?P<data_item>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def dataset_version_path(project: str,location: str,dataset: str,dataset_version: str,) -> str:
        """Returns a fully-qualified dataset_version string."""
        return "projects/{project}/locations/{location}/datasets/{dataset}/datasetVersions/{dataset_version}".format(project=project, location=location, dataset=dataset, dataset_version=dataset_version, )

    @staticmethod
    def parse_dataset_version_path(path: str) -> Dict[str,str]:
        """Parses a dataset_version path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/datasets/(?P<dataset>.+?)/datasetVersions/(?P<dataset_version>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def saved_query_path(project: str,location: str,dataset: str,saved_query: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/datasets/{dataset}/savedQueries/{saved_query}".format(project=project, location=location, dataset=dataset, saved_query=saved_query, )

    @staticmethod
    def parse_saved_query_path(path: str) -> Dict[str,str]:
        """Parses a saved_query path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/datasets/(?P<dataset>.+?)/savedQueries/(?P<saved_query>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def template_path(project: str,location: str,template: str,) -> str:
        """Returns a fully-qualified template string."""
        return "projects/{project}/locations/{location}/templates/{template}".format(project=project, location=location, template=template, )
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DatasetServiceTransport, Callable[..., DatasetServiceTransport]]] = None,
        ...
        self._client_cert_source = DatasetServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=DatasetServiceClient._DEFAULT_UNIVERSE)
        ...
        self._api_endpoint = (self._api_endpoint or
            get_api_endpoint(
                ...
                default_endpoint_template=DatasetServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
        ...
        if not transport_provided:
            transport_init: Union[Type[DatasetServiceTransport], Callable[..., DatasetServiceTransport]] = (
    ...
    def create_dataset_version(self,
            request: Optional[Union[dataset_service.CreateDatasetVersionRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def update_dataset_version(self,
            request: Optional[Union[dataset_service.UpdateDatasetVersionRequest, dict]] = None,
            *,
            dataset_version: Optional[gca_dataset_version.DatasetVersion] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def delete_dataset_version(self,
            request: Optional[Union[dataset_service.DeleteDatasetVersionRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_dataset_versions(self,
            request: Optional[Union[dataset_service.ListDatasetVersionsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def restore_dataset_version(self,
            request: Optional[Union[dataset_service.RestoreDatasetVersionRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
