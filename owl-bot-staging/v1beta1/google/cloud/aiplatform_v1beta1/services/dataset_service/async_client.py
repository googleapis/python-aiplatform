...
class DatasetServiceAsyncClient:
    ...
    parse_cached_content_path = staticmethod(DatasetServiceClient.parse_cached_content_path)
    ...
    async def assess_data(self,
        ...
        .. code-block:: python
            ...
            async def sample_assess_data():
                ...
                # Make the request
                operation = await client.assess_data(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.assess_data]
    ...
    async def assemble_data(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.assemble_data]
