...
class MigrationServiceAsyncClient:
    ...
    auto_ml_dataset_path = staticmethod(MigrationServiceClient.auto_ml_dataset_path)
    parse_auto_ml_dataset_path = staticmethod(MigrationServiceClient.parse_auto_ml_dataset_path)
    auto_ml_model_path = staticmethod(MigrationServiceClient.auto_ml_model_path)
    parse_auto_ml_model_path = staticmethod(MigrationServiceClient.parse_auto_ml_model_path)
    data_labeling_dataset_path = staticmethod(MigrationServiceClient.data_labeling_dataset_path)
    parse_data_labeling_dataset_path = staticmethod(MigrationServiceClient.parse_data_labeling_dataset_path)
    ...
    async def search_migratable_resources(self,
            request: Optional[Union[migration_service.SearchMigratableResourcesRequest, dict]] = None,
            *,
    ...
    async def batch_migrate_resources(self,
            request: Optional[Union[migration_service.BatchMigrateResourcesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            migrate_resource_requests: Optional[MutableSequence[migration_service.MigrateResourceRequest]] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            async def sample_batch_migrate_resources():
                ...
                # Make the request
                operation = await client.batch_migrate_resources(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_migrate_resources]
