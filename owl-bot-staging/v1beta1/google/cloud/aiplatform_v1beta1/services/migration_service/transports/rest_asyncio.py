...
class AsyncMigrationServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    async def pre_batch_migrate_resources(self, request: migration_service.BatchMigrateResourcesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[migration_service.BatchMigrateResourcesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_batch_migrate_resources_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for batch_migrate_resources
    ...
    async def pre_search_migratable_resources(self, request: migration_service.SearchMigratableResourcesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[migration_service.SearchMigratableResourcesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_search_migratable_resources_with_metadata(self, response: migration_service.SearchMigratableResourcesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[migration_service.SearchMigratableResourcesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for search_migratable_resources
...
class AsyncMigrationServiceRestTransport(_BaseMigrationServiceRestTransport):
    ...
    def __init__(self,
        ...
        Args:
            ...
            interceptor (Optional[AsyncMigrationServiceRestInterceptor]): Interceptor used
    ...
    class _BatchMigrateResources(_BaseMigrationServiceRestTransport._BaseBatchMigrateResources, AsyncMigrationServiceRestStub):
        ...
        async def __call__(self,
            ...
            resp, _ = await self._interceptor.post_batch_migrate_resources_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _SearchMigratableResources(_BaseMigrationServiceRestTransport._BaseSearchMigratableResources, AsyncMigrationServiceRestStub):
        ...
        resources method over HTTP.
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_search_migratable_resources_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _GetIamPolicy(_BaseMigrationServiceRestTransport._BaseGetIamPolicy, AsyncMigrationServiceRestStub):
        ...
        async def __call__(self,
            ...
            body = _BaseMigrationServiceRestTransport._BaseGetIamPolicy._get_request_body_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncMigrationServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseMigrationServiceRestTransport._BaseTestIamPermissions, AsyncMigrationServiceRestStub):
        ...
        async def __call__(self,
            ...
            body = _BaseMigrationServiceRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncMigrationServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
