...
class MigrationServiceRestTransport(_BaseMigrationServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseMigrationServiceRestTransport._BaseGetIamPolicy, MigrationServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MigrationServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseMigrationServiceRestTransport._BaseTestIamPermissions, MigrationServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MigrationServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
