...
class MigrationServiceClient(metaclass=MigrationServiceClientMeta):
    ...
    @staticmethod
    def auto_ml_dataset_path(project: str,location: str,dataset: str,) -> str:
    ...
    @staticmethod
    def auto_ml_model_path(project: str,location: str,model: str,) -> str:
    ...
    @staticmethod
    def data_labeling_dataset_path(project: str,dataset: str,) -> str:
    ...
    def __init__(self, *,
        ...
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=MigrationServiceClient._DEFAULT_UNIVERSE)
