...
class ScheduleServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_schedule(self, request: schedule_service.CreateScheduleRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schedule_service.CreateScheduleRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_schedule(self, response: gca_schedule.Schedule) -> gca_schedule.Schedule:
    ...
    def post_create_schedule_with_metadata(self, response: gca_schedule.Schedule, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gca_schedule.Schedule, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_schedule
    ...
    def pre_delete_schedule(self, request: schedule_service.DeleteScheduleRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schedule_service.DeleteScheduleRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_schedule(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    def post_delete_schedule_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_schedule
    ...
    def pre_get_schedule(self, request: schedule_service.GetScheduleRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schedule_service.GetScheduleRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_schedule_with_metadata(self, response: schedule.Schedule, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schedule.Schedule, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_schedule
    ...
    def pre_list_schedules(self, request: schedule_service.ListSchedulesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schedule_service.ListSchedulesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_schedules(self, response: schedule_service.ListSchedulesResponse) -> schedule_service.ListSchedulesResponse:
    ...
    def post_list_schedules_with_metadata(self, response: schedule_service.ListSchedulesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schedule_service.ListSchedulesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_schedules
    ...
    def pre_pause_schedule(self, request: schedule_service.PauseScheduleRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schedule_service.PauseScheduleRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_resume_schedule(self, request: schedule_service.ResumeScheduleRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schedule_service.ResumeScheduleRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_update_schedule(self, request: schedule_service.UpdateScheduleRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schedule_service.UpdateScheduleRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_schedule(self, response: gca_schedule.Schedule) -> gca_schedule.Schedule:
    ...
    def post_update_schedule_with_metadata(self, response: gca_schedule.Schedule, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gca_schedule.Schedule, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_schedule
...
class ScheduleServiceRestTransport(_BaseScheduleServiceRestTransport):
    ...
    def __init__(self, *,
        ...
        Args:
            ...
            interceptor (Optional[ScheduleServiceRestInterceptor]): Interceptor used
    ...
    class _CreateSchedule(_BaseScheduleServiceRestTransport._BaseCreateSchedule, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseCreateSchedule._get_http_options()

            request, metadata = self._interceptor.pre_create_schedule(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseCreateSchedule._get_transcoded_request(http_options, request)

            body = _BaseScheduleServiceRestTransport._BaseCreateSchedule._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseCreateSchedule._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._CreateSchedule._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp, _ = self._interceptor.post_create_schedule_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _DeleteSchedule(_BaseScheduleServiceRestTransport._BaseDeleteSchedule, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseDeleteSchedule._get_http_options()

            request, metadata = self._interceptor.pre_delete_schedule(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseDeleteSchedule._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseDeleteSchedule._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._DeleteSchedule._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_delete_schedule_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _GetSchedule(_BaseScheduleServiceRestTransport._BaseGetSchedule, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseGetSchedule._get_http_options()

            request, metadata = self._interceptor.pre_get_schedule(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseGetSchedule._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseGetSchedule._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._GetSchedule._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_get_schedule_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _ListSchedules(_BaseScheduleServiceRestTransport._BaseListSchedules, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseListSchedules._get_http_options()

            request, metadata = self._interceptor.pre_list_schedules(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseListSchedules._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseListSchedules._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._ListSchedules._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_schedules_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = schedule_service.ListSchedulesResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _PauseSchedule(_BaseScheduleServiceRestTransport._BasePauseSchedule, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BasePauseSchedule._get_http_options()

            request, metadata = self._interceptor.pre_pause_schedule(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BasePauseSchedule._get_transcoded_request(http_options, request)

            body = _BaseScheduleServiceRestTransport._BasePauseSchedule._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BasePauseSchedule._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._PauseSchedule._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ResumeSchedule(_BaseScheduleServiceRestTransport._BaseResumeSchedule, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseResumeSchedule._get_http_options()

            request, metadata = self._interceptor.pre_resume_schedule(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseResumeSchedule._get_transcoded_request(http_options, request)

            body = _BaseScheduleServiceRestTransport._BaseResumeSchedule._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseResumeSchedule._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._ResumeSchedule._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _UpdateSchedule(_BaseScheduleServiceRestTransport._BaseUpdateSchedule, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseUpdateSchedule._get_http_options()

            request, metadata = self._interceptor.pre_update_schedule(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseUpdateSchedule._get_transcoded_request(http_options, request)

            body = _BaseScheduleServiceRestTransport._BaseUpdateSchedule._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseUpdateSchedule._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._UpdateSchedule._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_update_schedule_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = gca_schedule.Schedule.to_json(response)
                except:
    ...
    @property
    def create_schedule(self) -> Callable[
    ...
    @property
    def delete_schedule(self) -> Callable[
    ...
    @property
    def get_schedule(self) -> Callable[
    ...
    @property
    def list_schedules(self) -> Callable[
    ...
    @property
    def pause_schedule(self) -> Callable[
    ...
    @property
    def resume_schedule(self) -> Callable[
    ...
    @property
    def update_schedule(self) -> Callable[
    ...
    class _GetLocation(_BaseScheduleServiceRestTransport._BaseGetLocation, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseGetLocation._get_http_options()

            request, metadata = self._interceptor.pre_get_location(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseGetLocation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseGetLocation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseScheduleServiceRestTransport._BaseListLocations, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseListLocations._get_http_options()

            request, metadata = self._interceptor.pre_list_locations(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseListLocations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseListLocations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetIamPolicy(_BaseScheduleServiceRestTransport._BaseGetIamPolicy, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseGetIamPolicy._get_http_options()

            request, metadata = self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseGetIamPolicy._get_transcoded_request(http_options, request)

            body = _BaseScheduleServiceRestTransport._BaseGetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseGetIamPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _SetIamPolicy(_BaseScheduleServiceRestTransport._BaseSetIamPolicy, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseSetIamPolicy._get_http_options()

            request, metadata = self._interceptor.pre_set_iam_policy(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseSetIamPolicy._get_transcoded_request(http_options, request)

            body = _BaseScheduleServiceRestTransport._BaseSetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseSetIamPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseScheduleServiceRestTransport._BaseTestIamPermissions, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseScheduleServiceRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CancelOperation(_BaseScheduleServiceRestTransport._BaseCancelOperation, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseCancelOperation._get_http_options()

            request, metadata = self._interceptor.pre_cancel_operation(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseCancelOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseCancelOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseScheduleServiceRestTransport._BaseDeleteOperation, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseDeleteOperation._get_http_options()

            request, metadata = self._interceptor.pre_delete_operation(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseDeleteOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseDeleteOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseScheduleServiceRestTransport._BaseGetOperation, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseGetOperation._get_http_options()

            request, metadata = self._interceptor.pre_get_operation(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseScheduleServiceRestTransport._BaseListOperations, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseListOperations._get_http_options()

            request, metadata = self._interceptor.pre_list_operations(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseListOperations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseListOperations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _WaitOperation(_BaseScheduleServiceRestTransport._BaseWaitOperation, ScheduleServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseScheduleServiceRestTransport._BaseWaitOperation._get_http_options()

            request, metadata = self._interceptor.pre_wait_operation(request, metadata)
            transcoded_request = _BaseScheduleServiceRestTransport._BaseWaitOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseWaitOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ScheduleServiceRestTransport._WaitOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
