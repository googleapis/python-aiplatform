...
class AsyncScheduleServiceRestTransport(_BaseScheduleServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseScheduleServiceRestTransport._BaseGetIamPolicy, AsyncScheduleServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncScheduleServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseScheduleServiceRestTransport._BaseTestIamPermissions, AsyncScheduleServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncScheduleServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
