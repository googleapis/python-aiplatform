...
class ScheduleServiceGrpcAsyncIOTransport(ScheduleServiceTransport):
    ...
    def create_schedule(self) -> Callable[
            ...
            Awaitable[gca_schedule.Schedule]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_schedule: gapic_v1.method_async.wrap_method(
                self.create_schedule,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_schedule: gapic_v1.method_async.wrap_method(
                self.delete_schedule,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_schedule: gapic_v1.method_async.wrap_method(
                self.get_schedule,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_schedules: gapic_v1.method_async.wrap_method(
                self.list_schedules,
                default_timeout=None,
                client_info=client_info,
            ),
            self.pause_schedule: gapic_v1.method_async.wrap_method(
                self.pause_schedule,
                default_timeout=None,
                client_info=client_info,
            ),
            self.resume_schedule: gapic_v1.method_async.wrap_method(
                self.resume_schedule,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_schedule: gapic_v1.method_async.wrap_method(
