...
class ScheduleServiceAsyncClient:
    ...
    batch_prediction_job_path = staticmethod(ScheduleServiceClient.batch_prediction_job_path)
    parse_batch_prediction_job_path = staticmethod(ScheduleServiceClient.parse_batch_prediction_job_path)
    ...
    parse_model_monitor_path = staticmethod(ScheduleServiceClient.parse_model_monitor_path)
    model_monitoring_job_path = staticmethod(ScheduleServiceClient.model_monitoring_job_path)
    parse_model_monitoring_job_path = staticmethod(ScheduleServiceClient.parse_model_monitoring_job_path)
    ...
    network_attachment_path = staticmethod(ScheduleServiceClient.network_attachment_path)
    parse_network_attachment_path = staticmethod(ScheduleServiceClient.parse_network_attachment_path)
    notebook_execution_job_path = staticmethod(ScheduleServiceClient.notebook_execution_job_path)
    parse_notebook_execution_job_path = staticmethod(ScheduleServiceClient.parse_notebook_execution_job_path)
    notebook_runtime_template_path = staticmethod(ScheduleServiceClient.notebook_runtime_template_path)
    parse_notebook_runtime_template_path = staticmethod(ScheduleServiceClient.parse_notebook_runtime_template_path)
    pipeline_job_path = staticmethod(ScheduleServiceClient.pipeline_job_path)
    parse_pipeline_job_path = staticmethod(ScheduleServiceClient.parse_pipeline_job_path)
    ...
    async def create_schedule(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_schedule]
    ...
    async def delete_schedule(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_schedule():
                ...
                # Make the request
                operation = await client.delete_schedule(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_schedule]
    ...
    async def list_schedules(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_schedules]
    ...
    async def pause_schedule(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.pause_schedule]
    ...
    async def resume_schedule(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.resume_schedule]
