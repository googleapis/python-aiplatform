...
from .transports.base import FeatureOnlineStoreAdminServiceTransport, DEFAULT_CLIENT_INFO
...
class FeatureOnlineStoreAdminServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = FeatureOnlineStoreAdminServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = FeatureOnlineStoreAdminServiceClient._DEFAULT_UNIVERSE

    feature_online_store_path = staticmethod(FeatureOnlineStoreAdminServiceClient.feature_online_store_path)
    parse_feature_online_store_path = staticmethod(FeatureOnlineStoreAdminServiceClient.parse_feature_online_store_path)
    feature_view_path = staticmethod(FeatureOnlineStoreAdminServiceClient.feature_view_path)
    parse_feature_view_path = staticmethod(FeatureOnlineStoreAdminServiceClient.parse_feature_view_path)
    feature_view_sync_path = staticmethod(FeatureOnlineStoreAdminServiceClient.feature_view_sync_path)
    parse_feature_view_sync_path = staticmethod(FeatureOnlineStoreAdminServiceClient.parse_feature_view_sync_path)
    common_billing_account_path = staticmethod(FeatureOnlineStoreAdminServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(FeatureOnlineStoreAdminServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(FeatureOnlineStoreAdminServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(FeatureOnlineStoreAdminServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(FeatureOnlineStoreAdminServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(FeatureOnlineStoreAdminServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(FeatureOnlineStoreAdminServiceClient.common_project_path)
    parse_common_project_path = staticmethod(FeatureOnlineStoreAdminServiceClient.parse_common_project_path)
    common_location_path = staticmethod(FeatureOnlineStoreAdminServiceClient.common_location_path)
    parse_common_location_path = staticmethod(FeatureOnlineStoreAdminServiceClient.parse_common_location_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        return sa_info_func(FeatureOnlineStoreAdminServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        return sa_file_func(FeatureOnlineStoreAdminServiceAsyncClient, filename, *args, **kwargs)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, FeatureOnlineStoreAdminServiceTransport, Callable[..., FeatureOnlineStoreAdminServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_feature_online_store(self,
            request: Optional[Union[feature_online_store_admin_service.CreateFeatureOnlineStoreRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            feature_online_store: Optional[gca_feature_online_store.FeatureOnlineStore] = None,
        ...
        .. code-block:: python
            ...
            async def sample_create_feature_online_store():
                ...
                # Make the request
                operation = await client.create_feature_online_store(request=request)
        ...
        if not isinstance(request, feature_online_store_admin_service.CreateFeatureOnlineStoreRequest):
            request = feature_online_store_admin_service.CreateFeatureOnlineStoreRequest(request)
    ...
    async def get_feature_online_store(self,
            request: Optional[Union[feature_online_store_admin_service.GetFeatureOnlineStoreRequest, dict]] = None,
            *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_online_store_admin_service.GetFeatureOnlineStoreRequest):
            request = feature_online_store_admin_service.GetFeatureOnlineStoreRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_feature_online_store]
    ...
    async def list_feature_online_stores(self,
            request: Optional[Union[feature_online_store_admin_service.ListFeatureOnlineStoresRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_online_store_admin_service.ListFeatureOnlineStoresRequest):
            request = feature_online_store_admin_service.ListFeatureOnlineStoresRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_feature_online_stores]
    ...
    async def update_feature_online_store(self,
            request: Optional[Union[feature_online_store_admin_service.UpdateFeatureOnlineStoreRequest, dict]] = None,
            *,
            feature_online_store: Optional[gca_feature_online_store.FeatureOnlineStore] = None,
        ...
        .. code-block:: python
            ...
            async def sample_update_feature_online_store():
                ...
                # Make the request
                operation = await client.update_feature_online_store(request=request)
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_online_store_admin_service.UpdateFeatureOnlineStoreRequest):
            request = feature_online_store_admin_service.UpdateFeatureOnlineStoreRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_feature_online_store]
    ...
    async def delete_feature_online_store(self,
            request: Optional[Union[feature_online_store_admin_service.DeleteFeatureOnlineStoreRequest, dict]] = None,
            *,
            name: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            async def sample_delete_feature_online_store():
                ...
                # Make the request
                operation = await client.delete_feature_online_store(request=request)
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_online_store_admin_service.DeleteFeatureOnlineStoreRequest):
            request = feature_online_store_admin_service.DeleteFeatureOnlineStoreRequest(request)
    ...
    async def create_feature_view(self,
            request: Optional[Union[feature_online_store_admin_service.CreateFeatureViewRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            async def sample_create_feature_view():
                ...
                # Make the request
                operation = await client.create_feature_view(request=request)
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_online_store_admin_service.CreateFeatureViewRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_feature_view]
    ...
    async def get_feature_view(self,
            request: Optional[Union[feature_online_store_admin_service.GetFeatureViewRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_online_store_admin_service.GetFeatureViewRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_feature_view]
    ...
    async def list_feature_views(self,
            request: Optional[Union[feature_online_store_admin_service.ListFeatureViewsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_online_store_admin_service.ListFeatureViewsRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_feature_views]
    ...
    async def update_feature_view(self,
            request: Optional[Union[feature_online_store_admin_service.UpdateFeatureViewRequest, dict]] = None,
            *,
            feature_view: Optional[gca_feature_view.FeatureView] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_update_feature_view():
                ...
                # Make the request
                operation = await client.update_feature_view(request=request)
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_online_store_admin_service.UpdateFeatureViewRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_feature_view]
    ...
    async def delete_feature_view(self,
            request: Optional[Union[feature_online_store_admin_service.DeleteFeatureViewRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_feature_view():
                ...
                # Make the request
                operation = await client.delete_feature_view(request=request)
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_online_store_admin_service.DeleteFeatureViewRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_feature_view]
    ...
    async def sync_feature_view(self,
            request: Optional[Union[feature_online_store_admin_service.SyncFeatureViewRequest, dict]] = None,
            *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_online_store_admin_service.SyncFeatureViewRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.sync_feature_view]
    ...
    async def get_feature_view_sync(self,
            request: Optional[Union[feature_online_store_admin_service.GetFeatureViewSyncRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_online_store_admin_service.GetFeatureViewSyncRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_feature_view_sync]
    ...
    async def list_feature_view_syncs(self,
            request: Optional[Union[feature_online_store_admin_service.ListFeatureViewSyncsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_online_store_admin_service.ListFeatureViewSyncsRequest):
            request = feature_online_store_admin_service.ListFeatureViewSyncsRequest(request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_feature_view_syncs]
