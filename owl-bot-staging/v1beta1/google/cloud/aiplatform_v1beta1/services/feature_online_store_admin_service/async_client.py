...
class FeatureOnlineStoreAdminServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(FeatureOnlineStoreAdminServiceClient).get_transport_class, type(FeatureOnlineStoreAdminServiceClient))
    ...
    async def create_feature_online_store(self,
        ...
        has_flattened_params = any([parent, feature_online_store, feature_online_store_id])
