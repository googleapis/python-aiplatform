...
class FeatureOnlineStoreAdminServiceRestTransport(_BaseFeatureOnlineStoreAdminServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseFeatureOnlineStoreAdminServiceRestTransport._BaseGetIamPolicy, FeatureOnlineStoreAdminServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeatureOnlineStoreAdminServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseFeatureOnlineStoreAdminServiceRestTransport._BaseTestIamPermissions, FeatureOnlineStoreAdminServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeatureOnlineStoreAdminServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
