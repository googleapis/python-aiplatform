...
class FeatureOnlineStoreAdminServiceGrpcAsyncIOTransport(FeatureOnlineStoreAdminServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_feature_online_store: gapic_v1.method_async.wrap_method(
                self.create_feature_online_store,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.get_feature_online_store: gapic_v1.method_async.wrap_method(
                self.get_feature_online_store,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.list_feature_online_stores: gapic_v1.method_async.wrap_method(
                self.list_feature_online_stores,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.update_feature_online_store: gapic_v1.method_async.wrap_method(
                self.update_feature_online_store,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.delete_feature_online_store: gapic_v1.method_async.wrap_method(
                self.delete_feature_online_store,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.create_feature_view: gapic_v1.method_async.wrap_method(
                self.create_feature_view,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.get_feature_view: gapic_v1.method_async.wrap_method(
                self.get_feature_view,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.list_feature_views: gapic_v1.method_async.wrap_method(
                self.list_feature_views,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.update_feature_view: gapic_v1.method_async.wrap_method(
                self.update_feature_view,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.delete_feature_view: gapic_v1.method_async.wrap_method(
                self.delete_feature_view,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.sync_feature_view: gapic_v1.method_async.wrap_method(
                self.sync_feature_view,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_feature_view_sync: gapic_v1.method_async.wrap_method(
                self.get_feature_view_sync,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_feature_view_syncs: gapic_v1.method_async.wrap_method(
