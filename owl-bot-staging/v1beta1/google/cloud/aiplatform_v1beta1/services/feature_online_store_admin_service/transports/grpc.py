...
class FeatureOnlineStoreAdminServiceGrpcTransport(FeatureOnlineStoreAdminServiceTransport):
    ...
    def create_feature_online_store(self) -> Callable[
        ...
        if 'create_feature_online_store' not in self._stubs:
            self._stubs['create_feature_online_store'] = self._logged_channel.unary_unary(
    ...
    def list_feature_online_stores(self) -> Callable[
        ...
        if 'list_feature_online_stores' not in self._stubs:
            self._stubs['list_feature_online_stores'] = self._logged_channel.unary_unary(
    ...
    def update_feature_online_store(self) -> Callable[
        ...
        if 'update_feature_online_store' not in self._stubs:
            self._stubs['update_feature_online_store'] = self._logged_channel.unary_unary(
    ...
    def delete_feature_online_store(self) -> Callable[
        ...
        if 'delete_feature_online_store' not in self._stubs:
            self._stubs['delete_feature_online_store'] = self._logged_channel.unary_unary(
