...
try:
    from .transports.rest_asyncio import AsyncFeatureOnlineStoreAdminServiceRestTransport
...
class FeatureOnlineStoreAdminServiceClient(metaclass=FeatureOnlineStoreAdminServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, FeatureOnlineStoreAdminServiceTransport, Callable[..., FeatureOnlineStoreAdminServiceTransport]]] = None,
        ...
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=FeatureOnlineStoreAdminServiceClient._DEFAULT_UNIVERSE)
        ...
        if not transport_provided:
            transport_init: Union[Type[FeatureOnlineStoreAdminServiceTransport], Callable[..., FeatureOnlineStoreAdminServiceTransport]] = (
                FeatureOnlineStoreAdminServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., FeatureOnlineStoreAdminServiceTransport], transport)
            )
