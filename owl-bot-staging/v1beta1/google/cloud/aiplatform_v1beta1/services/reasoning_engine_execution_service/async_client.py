...
from .transports.base import ReasoningEngineExecutionServiceTransport, DEFAULT_CLIENT_INFO
...
class ReasoningEngineExecutionServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = ReasoningEngineExecutionServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = ReasoningEngineExecutionServiceClient._DEFAULT_UNIVERSE

    reasoning_engine_path = staticmethod(ReasoningEngineExecutionServiceClient.reasoning_engine_path)
    parse_reasoning_engine_path = staticmethod(ReasoningEngineExecutionServiceClient.parse_reasoning_engine_path)
    common_billing_account_path = staticmethod(ReasoningEngineExecutionServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ReasoningEngineExecutionServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(ReasoningEngineExecutionServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(ReasoningEngineExecutionServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(ReasoningEngineExecutionServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(ReasoningEngineExecutionServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(ReasoningEngineExecutionServiceClient.common_project_path)
    parse_common_project_path = staticmethod(ReasoningEngineExecutionServiceClient.parse_common_project_path)
    common_location_path = staticmethod(ReasoningEngineExecutionServiceClient.common_location_path)
    parse_common_location_path = staticmethod(ReasoningEngineExecutionServiceClient.parse_common_location_path)
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        return sa_info_func(ReasoningEngineExecutionServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        return sa_file_func(ReasoningEngineExecutionServiceAsyncClient, filename, *args, **kwargs)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ReasoningEngineExecutionServiceTransport, Callable[..., ReasoningEngineExecutionServiceTransport]]] = "grpc_asyncio",
    ...
    async def query_reasoning_engine(self,
            request: Optional[Union[reasoning_engine_execution_service.QueryReasoningEngineRequest, dict]] = None,
            *,
        ...
        if not isinstance(request, reasoning_engine_execution_service.QueryReasoningEngineRequest):
            request = reasoning_engine_execution_service.QueryReasoningEngineRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.query_reasoning_engine]
    ...
    def stream_query_reasoning_engine(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.stream_query_reasoning_engine]
    ...
    async def async_query_reasoning_engine(self,
            request: Optional[Union[reasoning_engine_execution_service.AsyncQueryReasoningEngineRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            async def sample_async_query_reasoning_engine():
                ...
                # Make the request
                operation = await client.async_query_reasoning_engine(request=request)
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, reasoning_engine_execution_service.AsyncQueryReasoningEngineRequest):
            request = reasoning_engine_execution_service.AsyncQueryReasoningEngineRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.async_query_reasoning_engine]
    ...
    async def cancel_async_query_reasoning_engine(self,
            request: Optional[Union[reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            async def sample_cancel_async_query_reasoning_engine():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.CancelAsyncQueryReasoningEngineRequest(
                    name="name_value",
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.CancelAsyncQueryReasoningEngineRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.aiplatform_v1beta1.types.CancelAsyncQueryReasoningEngineResponse:
                Response message for
                   [ReasoningEngineExecutionService.CancelAsyncQueryReasoningEngine][google.cloud.aiplatform.v1beta1.ReasoningEngineExecutionService.CancelAsyncQueryReasoningEngine].
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineRequest):
            request = reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.cancel_async_query_reasoning_engine]
