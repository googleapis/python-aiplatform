...
class _BaseReasoningEngineExecutionServiceRestTransport(ReasoningEngineExecutionServiceTransport):
    ...
    class _BaseAsyncQueryReasoningEngine:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta1/{name=projects/*/locations/*/reasoningEngines/*}:asyncQuery',
                'body': '*',
            },
        {
                'method': 'post',
                'uri': '/v1beta1/{name=reasoningEngines/*}:asyncQuery',
                'body': '*',
            },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = reasoning_engine_execution_service.AsyncQueryReasoningEngineRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseReasoningEngineExecutionServiceRestTransport._BaseAsyncQueryReasoningEngine._get_unset_required_fields(query_params))

            query_params["$alt"] = "json;enum-encoding=int"
            return query_params

    class _BaseCancelAsyncQueryReasoningEngine:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta1/{name=projects/*/locations/*/reasoningEngines/*}:cancelAsyncQuery',
                'body': '*',
            },
        {
                'method': 'post',
                'uri': '/v1beta1/{name=reasoningEngines/*}:cancelAsyncQuery',
                'body': '*',
            },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseReasoningEngineExecutionServiceRestTransport._BaseCancelAsyncQueryReasoningEngine._get_unset_required_fields(query_params))
    ...
    class _BaseQueryReasoningEngine:
        ...
        {
                'method': 'post',
                'uri': '/v1beta1/{name=projects/*/locations/*/reasoningEngines/*/runtimeRevisions/*}:query',
                'body': '*',
            },
        {
                'method': 'post',
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = reasoning_engine_execution_service.QueryReasoningEngineRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseReasoningEngineExecutionServiceRestTransport._BaseQueryReasoningEngine._get_unset_required_fields(query_params))
    ...
    class _BaseStreamQueryReasoningEngine:
        ...
        {
                'method': 'post',
                'uri': '/v1beta1/{name=projects/*/locations/*/reasoningEngines/*/runtimeRevisions/*}:streamQuery',
                'body': '*',
            },
        {
                'method': 'post',
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = reasoning_engine_execution_service.StreamQueryReasoningEngineRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseReasoningEngineExecutionServiceRestTransport._BaseStreamQueryReasoningEngine._get_unset_required_fields(query_params))
