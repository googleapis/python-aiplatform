    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomReasoningEngineExecutionServiceInterceptor(ReasoningEngineExecutionServiceRestInterceptor):
            async def pre_async_query_reasoning_engine(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_async_query_reasoning_engine(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_cancel_async_query_reasoning_engine(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_cancel_async_query_reasoning_engine(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    """
    async def pre_async_query_reasoning_engine(self, request: reasoning_engine_execution_service.AsyncQueryReasoningEngineRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[reasoning_engine_execution_service.AsyncQueryReasoningEngineRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for async_query_reasoning_engine
    ...
    async def post_async_query_reasoning_engine(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        """Post-rpc interceptor for async_query_reasoning_engine

        DEPRECATED. Please use the `post_async_query_reasoning_engine_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the ReasoningEngineExecutionService server but before
        it is returned to user code. This `post_async_query_reasoning_engine` interceptor runs
        before the `post_async_query_reasoning_engine_with_metadata` interceptor.
        """
        return response

    async def post_async_query_reasoning_engine_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for async_query_reasoning_engine

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the ReasoningEngineExecutionService server but before it is returned to user code.

        We recommend only using this `post_async_query_reasoning_engine_with_metadata`
        interceptor in new development instead of the `post_async_query_reasoning_engine` interceptor.
        When both interceptors are used, this `post_async_query_reasoning_engine_with_metadata` interceptor runs after the
    ...
    async def pre_cancel_async_query_reasoning_engine(self, request: reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_cancel_async_query_reasoning_engine(self, response: reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineResponse) -> reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineResponse:
    ...
    async def post_cancel_async_query_reasoning_engine_with_metadata(self, response: reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for cancel_async_query_reasoning_engine
    ...
    async def pre_query_reasoning_engine(self, request: reasoning_engine_execution_service.QueryReasoningEngineRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[reasoning_engine_execution_service.QueryReasoningEngineRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_query_reasoning_engine(self, response: reasoning_engine_execution_service.QueryReasoningEngineResponse) -> reasoning_engine_execution_service.QueryReasoningEngineResponse:
    ...
    async def post_query_reasoning_engine_with_metadata(self, response: reasoning_engine_execution_service.QueryReasoningEngineResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[reasoning_engine_execution_service.QueryReasoningEngineResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for query_reasoning_engine
    ...
    async def pre_stream_query_reasoning_engine(self, request: reasoning_engine_execution_service.StreamQueryReasoningEngineRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[reasoning_engine_execution_service.StreamQueryReasoningEngineRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_stream_query_reasoning_engine(self, response: rest_streaming_async.AsyncResponseIterator) -> rest_streaming_async.AsyncResponseIterator:
    ...
    async def post_stream_query_reasoning_engine_with_metadata(self, response: rest_streaming_async.AsyncResponseIterator, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[rest_streaming_async.AsyncResponseIterator, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for stream_query_reasoning_engine
...
class AsyncReasoningEngineExecutionServiceRestTransport(_BaseReasoningEngineExecutionServiceRestTransport):
    ...
    def __init__(self,
            *,
            ...
            interceptor: Optional[AsyncReasoningEngineExecutionServiceRestInterceptor] = None,
            ) -> None:
        ...
        Args:
            ...
            interceptor (Optional[AsyncReasoningEngineExecutionServiceRestInterceptor]): Interceptor used
        ...
        self._interceptor = interceptor or AsyncReasoningEngineExecutionServiceRestInterceptor()
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.cancel_async_query_reasoning_engine: self._wrap_method(
    ...
    class _AsyncQueryReasoningEngine(_BaseReasoningEngineExecutionServiceRestTransport._BaseAsyncQueryReasoningEngine, AsyncReasoningEngineExecutionServiceRestStub):
        def __hash__(self):
            return hash("AsyncReasoningEngineExecutionServiceRestTransport.AsyncQueryReasoningEngine")
        ...
        async def __call__(self,
            ...
            r"""Call the async query reasoning
        engine method over HTTP.
            ...
            http_options = _BaseReasoningEngineExecutionServiceRestTransport._BaseAsyncQueryReasoningEngine._get_http_options()

            request, metadata = await self._interceptor.pre_async_query_reasoning_engine(request, metadata)
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseAsyncQueryReasoningEngine._get_transcoded_request(http_options, request)

            body = _BaseReasoningEngineExecutionServiceRestTransport._BaseAsyncQueryReasoningEngine._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseAsyncQueryReasoningEngine._get_query_params_json(transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.ReasoningEngineExecutionServiceClient.AsyncQueryReasoningEngine",
                    extra = {
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineExecutionService",
                        "rpcName": "AsyncQueryReasoningEngine",
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._AsyncQueryReasoningEngine._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp = await self._interceptor.post_async_query_reasoning_engine(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_async_query_reasoning_engine_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ReasoningEngineExecutionServiceAsyncClient.async_query_reasoning_engine",
                    extra = {
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineExecutionService",
                        "rpcName": "AsyncQueryReasoningEngine",
    ...
    class _CancelAsyncQueryReasoningEngine(_BaseReasoningEngineExecutionServiceRestTransport._BaseCancelAsyncQueryReasoningEngine, AsyncReasoningEngineExecutionServiceRestStub):
        def __hash__(self):
            return hash("AsyncReasoningEngineExecutionServiceRestTransport.CancelAsyncQueryReasoningEngine")
        ...
        reasoning engine method over HTTP.
            ...
            http_options = _BaseReasoningEngineExecutionServiceRestTransport._BaseCancelAsyncQueryReasoningEngine._get_http_options()

            request, metadata = await self._interceptor.pre_cancel_async_query_reasoning_engine(request, metadata)
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseCancelAsyncQueryReasoningEngine._get_transcoded_request(http_options, request)

            body = _BaseReasoningEngineExecutionServiceRestTransport._BaseCancelAsyncQueryReasoningEngine._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseCancelAsyncQueryReasoningEngine._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._CancelAsyncQueryReasoningEngine._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            # Return the response
            resp = reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineResponse()
            pb_resp = reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineResponse.pb(resp)
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_cancel_async_query_reasoning_engine(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_cancel_async_query_reasoning_engine_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ReasoningEngineExecutionServiceAsyncClient.cancel_async_query_reasoning_engine",
                    extra = {
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineExecutionService",
                        "rpcName": "CancelAsyncQueryReasoningEngine",
                        "metadata": http_response["headers"],
    ...
    class _QueryReasoningEngine(_BaseReasoningEngineExecutionServiceRestTransport._BaseQueryReasoningEngine, AsyncReasoningEngineExecutionServiceRestStub):
        def __hash__(self):
            return hash("AsyncReasoningEngineExecutionServiceRestTransport.QueryReasoningEngine")
        ...
        async def __call__(self,
            ...
            http_options = _BaseReasoningEngineExecutionServiceRestTransport._BaseQueryReasoningEngine._get_http_options()

            request, metadata = await self._interceptor.pre_query_reasoning_engine(request, metadata)
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseQueryReasoningEngine._get_transcoded_request(http_options, request)

            body = _BaseReasoningEngineExecutionServiceRestTransport._BaseQueryReasoningEngine._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseQueryReasoningEngine._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._QueryReasoningEngine._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            pb_resp = reasoning_engine_execution_service.QueryReasoningEngineResponse.pb(resp)
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_query_reasoning_engine(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_query_reasoning_engine_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = reasoning_engine_execution_service.QueryReasoningEngineResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
    ...
    class _StreamQueryReasoningEngine(_BaseReasoningEngineExecutionServiceRestTransport._BaseStreamQueryReasoningEngine, AsyncReasoningEngineExecutionServiceRestStub):
        def __hash__(self):
            return hash("AsyncReasoningEngineExecutionServiceRestTransport.StreamQueryReasoningEngine")
        ...
        engine method over HTTP.
            ...
            http_options = _BaseReasoningEngineExecutionServiceRestTransport._BaseStreamQueryReasoningEngine._get_http_options()

            request, metadata = await self._interceptor.pre_stream_query_reasoning_engine(request, metadata)
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseStreamQueryReasoningEngine._get_transcoded_request(http_options, request)

            body = _BaseReasoningEngineExecutionServiceRestTransport._BaseStreamQueryReasoningEngine._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseStreamQueryReasoningEngine._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._StreamQueryReasoningEngine._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_stream_query_reasoning_engine_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                http_response = {
                    "headers":  dict(response.headers),
                    "status": "OK", # need to obtain this properly
    ...
    @property
    def async_query_reasoning_engine(self) -> Callable[
    ...
    @property
    def cancel_async_query_reasoning_engine(self) -> Callable[
    ...
    @property
    def query_reasoning_engine(self) -> Callable[
    ...
    class _GetLocation(_BaseReasoningEngineExecutionServiceRestTransport._BaseGetLocation, AsyncReasoningEngineExecutionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseReasoningEngineExecutionServiceRestTransport._BaseGetLocation._get_http_options()

            request, metadata = await self._interceptor.pre_get_location(request, metadata)
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseGetLocation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseGetLocation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseReasoningEngineExecutionServiceRestTransport._BaseListLocations, AsyncReasoningEngineExecutionServiceRestStub):
        def __hash__(self):
            return hash("AsyncReasoningEngineExecutionServiceRestTransport.ListLocations")
        ...
        async def __call__(self,
            ...
            http_options = _BaseReasoningEngineExecutionServiceRestTransport._BaseListLocations._get_http_options()

            request, metadata = await self._interceptor.pre_list_locations(request, metadata)
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseListLocations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseListLocations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetIamPolicy(_BaseReasoningEngineExecutionServiceRestTransport._BaseGetIamPolicy, AsyncReasoningEngineExecutionServiceRestStub):
        def __hash__(self):
            return hash("AsyncReasoningEngineExecutionServiceRestTransport.GetIamPolicy")
        ...
        async def __call__(self,
            ...
            http_options = _BaseReasoningEngineExecutionServiceRestTransport._BaseGetIamPolicy._get_http_options()

            request, metadata = await self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseGetIamPolicy._get_transcoded_request(http_options, request)

            body = _BaseReasoningEngineExecutionServiceRestTransport._BaseGetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseGetIamPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _SetIamPolicy(_BaseReasoningEngineExecutionServiceRestTransport._BaseSetIamPolicy, AsyncReasoningEngineExecutionServiceRestStub):
        def __hash__(self):
            return hash("AsyncReasoningEngineExecutionServiceRestTransport.SetIamPolicy")
        ...
        async def __call__(self,
            ...
            http_options = _BaseReasoningEngineExecutionServiceRestTransport._BaseSetIamPolicy._get_http_options()

            request, metadata = await self._interceptor.pre_set_iam_policy(request, metadata)
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseSetIamPolicy._get_transcoded_request(http_options, request)

            body = _BaseReasoningEngineExecutionServiceRestTransport._BaseSetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseSetIamPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseReasoningEngineExecutionServiceRestTransport._BaseTestIamPermissions, AsyncReasoningEngineExecutionServiceRestStub):
        def __hash__(self):
            return hash("AsyncReasoningEngineExecutionServiceRestTransport.TestIamPermissions")
        ...
        async def __call__(self,
            ...
            http_options = _BaseReasoningEngineExecutionServiceRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = await self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            body = _BaseReasoningEngineExecutionServiceRestTransport._BaseTestIamPermissions._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _CancelOperation(_BaseReasoningEngineExecutionServiceRestTransport._BaseCancelOperation, AsyncReasoningEngineExecutionServiceRestStub):
        def __hash__(self):
            return hash("AsyncReasoningEngineExecutionServiceRestTransport.CancelOperation")
        ...
        async def __call__(self,
            ...
            http_options = _BaseReasoningEngineExecutionServiceRestTransport._BaseCancelOperation._get_http_options()

            request, metadata = await self._interceptor.pre_cancel_operation(request, metadata)
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseCancelOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseCancelOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseReasoningEngineExecutionServiceRestTransport._BaseDeleteOperation, AsyncReasoningEngineExecutionServiceRestStub):
        def __hash__(self):
            return hash("AsyncReasoningEngineExecutionServiceRestTransport.DeleteOperation")
        ...
        async def __call__(self,
            ...
            http_options = _BaseReasoningEngineExecutionServiceRestTransport._BaseDeleteOperation._get_http_options()

            request, metadata = await self._interceptor.pre_delete_operation(request, metadata)
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseDeleteOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseDeleteOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseReasoningEngineExecutionServiceRestTransport._BaseGetOperation, AsyncReasoningEngineExecutionServiceRestStub):
        def __hash__(self):
            return hash("AsyncReasoningEngineExecutionServiceRestTransport.GetOperation")
        ...
        async def __call__(self,
            ...
            http_options = _BaseReasoningEngineExecutionServiceRestTransport._BaseGetOperation._get_http_options()

            request, metadata = await self._interceptor.pre_get_operation(request, metadata)
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseReasoningEngineExecutionServiceRestTransport._BaseListOperations, AsyncReasoningEngineExecutionServiceRestStub):
        def __hash__(self):
            return hash("AsyncReasoningEngineExecutionServiceRestTransport.ListOperations")
        ...
        async def __call__(self,
            ...
            http_options = _BaseReasoningEngineExecutionServiceRestTransport._BaseListOperations._get_http_options()

            request, metadata = await self._interceptor.pre_list_operations(request, metadata)
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseListOperations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseListOperations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _WaitOperation(_BaseReasoningEngineExecutionServiceRestTransport._BaseWaitOperation, AsyncReasoningEngineExecutionServiceRestStub):
        def __hash__(self):
            return hash("AsyncReasoningEngineExecutionServiceRestTransport.WaitOperation")
        ...
        async def __call__(self,
            ...
            http_options = _BaseReasoningEngineExecutionServiceRestTransport._BaseWaitOperation._get_http_options()

            request, metadata = await self._interceptor.pre_wait_operation(request, metadata)
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseWaitOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseWaitOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._WaitOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
