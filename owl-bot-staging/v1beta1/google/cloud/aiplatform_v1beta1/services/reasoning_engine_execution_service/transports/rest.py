...
from .base import ReasoningEngineExecutionServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ReasoningEngineExecutionServiceRestTransport(ReasoningEngineExecutionServiceTransport):
