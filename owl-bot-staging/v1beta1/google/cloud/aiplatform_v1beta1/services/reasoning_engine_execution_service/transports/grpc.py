...
class ReasoningEngineExecutionServiceGrpcTransport(ReasoningEngineExecutionServiceTransport):
    ...
    def stream_query_reasoning_engine(self) -> Callable[
        ...
        if 'stream_query_reasoning_engine' not in self._stubs:
            self._stubs['stream_query_reasoning_engine'] = self._logged_channel.unary_stream(
    ...
    def async_query_reasoning_engine(self) -> Callable[
        ...
        if 'async_query_reasoning_engine' not in self._stubs:
            self._stubs['async_query_reasoning_engine'] = self._logged_channel.unary_unary(
    ...
    def cancel_async_query_reasoning_engine(self) -> Callable[
        ...
        if 'cancel_async_query_reasoning_engine' not in self._stubs:
            self._stubs['cancel_async_query_reasoning_engine'] = self._logged_channel.unary_unary(
