...
try:
    from .transports.rest_asyncio import AsyncReasoningEngineExecutionServiceRestTransport
...
class ReasoningEngineExecutionServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ReasoningEngineExecutionServiceTransport]]
    _transport_registry["grpc"] = ReasoningEngineExecutionServiceGrpcTransport
    _transport_registry["grpc_asyncio"] = ReasoningEngineExecutionServiceGrpcAsyncIOTransport
    _transport_registry["rest"] = ReasoningEngineExecutionServiceRestTransport
    if HAS_ASYNC_REST_DEPENDENCIES:  # pragma: NO COVER
        _transport_registry["rest_asyncio"] = AsyncReasoningEngineExecutionServiceRestTransport
...
class ReasoningEngineExecutionServiceClient(metaclass=ReasoningEngineExecutionServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = ReasoningEngineExecutionServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint) -> str:
        ...
        if api_override is not None:
            ...
            api_endpoint = ReasoningEngineExecutionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ReasoningEngineExecutionServiceTransport, Callable[..., ReasoningEngineExecutionServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = ReasoningEngineExecutionServiceClient._read_environment_variables()
        self._client_cert_source = ReasoningEngineExecutionServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = ReasoningEngineExecutionServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, ReasoningEngineExecutionServiceTransport)
        ...
        if not transport_provided:
            transport_init: Union[Type[ReasoningEngineExecutionServiceTransport], Callable[..., ReasoningEngineExecutionServiceTransport]] = (
                ReasoningEngineExecutionServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., ReasoningEngineExecutionServiceTransport], transport)
            )
    ...
    def async_query_reasoning_engine(self,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.AsyncQueryReasoningEngineRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.async_query_reasoning_engine]
    ...
    def cancel_async_query_reasoning_engine(self,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.CancelAsyncQueryReasoningEngineRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.cancel_async_query_reasoning_engine]
