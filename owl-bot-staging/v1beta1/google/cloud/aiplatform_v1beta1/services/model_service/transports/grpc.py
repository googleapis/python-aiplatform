...
class ModelServiceGrpcTransport(ModelServiceTransport):
    ...
    def list_model_version_checkpoints(self) -> Callable[
        ...
        if 'list_model_version_checkpoints' not in self._stubs:
            self._stubs['list_model_version_checkpoints'] = self._logged_channel.unary_unary(
    ...
    def update_explanation_dataset(self) -> Callable[
        ...
        if 'update_explanation_dataset' not in self._stubs:
            self._stubs['update_explanation_dataset'] = self._logged_channel.unary_unary(
    ...
    def batch_import_model_evaluation_slices(self) -> Callable[
        ...
        if 'batch_import_model_evaluation_slices' not in self._stubs:
            self._stubs['batch_import_model_evaluation_slices'] = self._logged_channel.unary_unary(
    ...
    def batch_import_evaluated_annotations(self) -> Callable[
        ...
        if 'batch_import_evaluated_annotations' not in self._stubs:
            self._stubs['batch_import_evaluated_annotations'] = self._logged_channel.unary_unary(
    ...
    def get_model_evaluation_slice(self) -> Callable[
        ...
        if 'get_model_evaluation_slice' not in self._stubs:
            self._stubs['get_model_evaluation_slice'] = self._logged_channel.unary_unary(
    ...
    def list_model_evaluation_slices(self) -> Callable[
        ...
        if 'list_model_evaluation_slices' not in self._stubs:
            self._stubs['list_model_evaluation_slices'] = self._logged_channel.unary_unary(
