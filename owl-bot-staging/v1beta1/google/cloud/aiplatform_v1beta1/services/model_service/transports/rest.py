...
class ModelServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_recommend_spec(self, request: model_service.RecommendSpecRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_service.RecommendSpecRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_recommend_spec(self, response: model_service.RecommendSpecResponse) -> model_service.RecommendSpecResponse:
    ...
    def post_recommend_spec_with_metadata(self, response: model_service.RecommendSpecResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[model_service.RecommendSpecResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for recommend_spec
...
class ModelServiceRestTransport(_BaseModelServiceRestTransport):
    ...
    class _RecommendSpec(_BaseModelServiceRestTransport._BaseRecommendSpec, ModelServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ModelServiceRestTransport._RecommendSpec._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_recommend_spec_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _GetIamPolicy(_BaseModelServiceRestTransport._BaseGetIamPolicy, ModelServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ModelServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseModelServiceRestTransport._BaseTestIamPermissions, ModelServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ModelServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
