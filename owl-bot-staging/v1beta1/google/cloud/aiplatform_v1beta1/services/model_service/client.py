...
class ModelServiceClient(metaclass=ModelServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=ModelServiceClient._DEFAULT_UNIVERSE)
    ...
    def list_model_version_checkpoints(self,
            request: Optional[Union[model_service.ListModelVersionCheckpointsRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_model_version_checkpoints]
    ...
    def update_explanation_dataset(self,
            request: Optional[Union[model_service.UpdateExplanationDatasetRequest, dict]] = None,
            *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_explanation_dataset]
    ...
    def merge_version_aliases(self,
    ...
    def import_model_evaluation(self,
            request: Optional[Union[model_service.ImportModelEvaluationRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def batch_import_model_evaluation_slices(self,
            request: Optional[Union[model_service.BatchImportModelEvaluationSlicesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            model_evaluation_slices: Optional[MutableSequence[model_evaluation_slice.ModelEvaluationSlice]] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, model_service.BatchImportModelEvaluationSlicesRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_import_model_evaluation_slices]
    ...
    def batch_import_evaluated_annotations(self,
            request: Optional[Union[model_service.BatchImportEvaluatedAnnotationsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            evaluated_annotations: Optional[MutableSequence[evaluated_annotation.EvaluatedAnnotation]] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, model_service.BatchImportEvaluatedAnnotationsRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_import_evaluated_annotations]
    ...
    def list_model_evaluations(self,
            request: Optional[Union[model_service.ListModelEvaluationsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def get_model_evaluation_slice(self,
            request: Optional[Union[model_service.GetModelEvaluationSliceRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_model_evaluation_slices(self,
            request: Optional[Union[model_service.ListModelEvaluationSlicesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
