...
class ModelServiceClient(metaclass=ModelServiceClientMeta):
    ...
    def batch_import_model_evaluation_slices(self,
            request: Union[model_service.BatchImportModelEvaluationSlicesRequest, dict] = None,
            *,
            parent: str = None,
            model_evaluation_slices: Sequence[model_evaluation_slice.ModelEvaluationSlice] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
            metadata: Sequence[Tuple[str, str]] = (),
