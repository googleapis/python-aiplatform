...
class CreateDeploymentResourcePoolRequest(proto.Message):
    ...
    deployment_resource_pool: gca_deployment_resource_pool.DeploymentResourcePool = proto.Field(
        proto.MESSAGE,
        number=2,
...
class ListDeploymentResourcePoolsResponse(proto.Message):
    ...
    deployment_resource_pools: MutableSequence[gca_deployment_resource_pool.DeploymentResourcePool] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_deployment_resource_pool.DeploymentResourcePool,
    )
...
class QueryDeployedModelsResponse(proto.Message):
    ...
    deployed_model_refs: MutableSequence[deployed_model_ref.DeployedModelRef] = proto.RepeatedField(
        proto.MESSAGE,
        number=3,
