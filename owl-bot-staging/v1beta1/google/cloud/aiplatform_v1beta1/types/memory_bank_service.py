...
class GenerateMemoriesRequest(proto.Message):
    ...
    class DirectContentsSource(proto.Message):
        ...
        events: MutableSequence['GenerateMemoriesRequest.DirectContentsSource.Event'] = proto.RepeatedField(
            proto.MESSAGE,
            number=1,
    ...
    class DirectMemoriesSource(proto.Message):
        ...
        direct_memories: MutableSequence['GenerateMemoriesRequest.DirectMemoriesSource.DirectMemory'] = proto.RepeatedField(
            proto.MESSAGE,
            number=1,
