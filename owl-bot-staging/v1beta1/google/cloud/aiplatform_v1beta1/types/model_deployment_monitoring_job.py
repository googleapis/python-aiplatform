...
class ModelDeploymentMonitoringJob(proto.Message):
    ...
    model_deployment_monitoring_objective_configs: MutableSequence['ModelDeploymentMonitoringObjectiveConfig'] = proto.RepeatedField(
        proto.MESSAGE,
        number=6,
    ...
    model_monitoring_alert_config: model_monitoring.ModelMonitoringAlertConfig = proto.Field(
        proto.MESSAGE,
        number=15,
    ...
    bigquery_tables: MutableSequence['ModelDeploymentMonitoringBigQueryTable'] = proto.RepeatedField(
        proto.MESSAGE,
        number=10,
...
class ModelMonitoringStatsAnomalies(proto.Message):
    ...
    class FeatureHistoricStatsAnomalies(proto.Message):
        ...
        prediction_stats: MutableSequence[feature_monitoring_stats.FeatureStatsAnomaly] = proto.RepeatedField(
            proto.MESSAGE,
            number=5,
            message=feature_monitoring_stats.FeatureStatsAnomaly,
        )
