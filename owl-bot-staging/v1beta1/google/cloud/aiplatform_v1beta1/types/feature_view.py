...
class FeatureView(proto.Message):
    ...
    class VectorSearchConfig(proto.Message):
        ...
        brute_force_config: 'FeatureView.VectorSearchConfig.BruteForceConfig' = proto.Field(
            proto.MESSAGE,
            number=9,
            oneof='algorithm_config',
        ...
        distance_measure_type: 'FeatureView.VectorSearchConfig.DistanceMeasureType' = proto.Field(
            proto.ENUM,
            number=7,
    ...
    class IndexConfig(proto.Message):
        ...
        distance_measure_type: 'FeatureView.IndexConfig.DistanceMeasureType' = proto.Field(
            proto.ENUM,
            number=5,
    ...
    class FeatureRegistrySource(proto.Message):
        ...
        feature_groups: MutableSequence['FeatureView.FeatureRegistrySource.FeatureGroup'] = proto.RepeatedField(
            proto.MESSAGE,
            number=1,
