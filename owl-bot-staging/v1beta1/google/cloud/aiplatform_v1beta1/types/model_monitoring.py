...
class ModelMonitoringConfig(proto.Message):
    ...
    objective_configs: MutableSequence['ModelMonitoringObjectiveConfig'] = proto.RepeatedField(
        proto.MESSAGE,
        number=3,
...
class ModelMonitoringObjectiveConfig(proto.Message):
    ...
    class TrainingPredictionSkewDetectionConfig(proto.Message):
        ...
        attribution_score_skew_thresholds: MutableMapping[str, 'ThresholdConfig'] = proto.MapField(
            proto.STRING,
            proto.MESSAGE,
            number=2,
            message='ThresholdConfig',
    ...
    class PredictionDriftDetectionConfig(proto.Message):
        ...
        attribution_score_drift_thresholds: MutableMapping[str, 'ThresholdConfig'] = proto.MapField(
            proto.STRING,
            proto.MESSAGE,
            number=2,
            message='ThresholdConfig',
    ...
    training_prediction_skew_detection_config: TrainingPredictionSkewDetectionConfig = proto.Field(
        proto.MESSAGE,
        number=2,
