...
class CreateNotebookRuntimeTemplateRequest(proto.Message):
    ...
    notebook_runtime_template: gca_notebook_runtime.NotebookRuntimeTemplate = proto.Field(
        proto.MESSAGE,
        number=2,
...
class ListNotebookRuntimeTemplatesResponse(proto.Message):
    ...
    notebook_runtime_templates: MutableSequence[gca_notebook_runtime.NotebookRuntimeTemplate] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_notebook_runtime.NotebookRuntimeTemplate,
    )
...
class ListNotebookRuntimesResponse(proto.Message):
    ...
    notebook_runtimes: MutableSequence[gca_notebook_runtime.NotebookRuntime] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_notebook_runtime.NotebookRuntime,
    )
...
class CreateNotebookExecutionJobRequest(proto.Message):
    ...
    notebook_execution_job: gca_notebook_execution_job.NotebookExecutionJob = proto.Field(
        proto.MESSAGE,
        number=2,
...
class ListNotebookExecutionJobsResponse(proto.Message):
    ...
    notebook_execution_jobs: MutableSequence[gca_notebook_execution_job.NotebookExecutionJob] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_notebook_execution_job.NotebookExecutionJob,
    )
