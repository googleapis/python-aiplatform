...
from google.cloud.aiplatform_v1beta1.types import unmanaged_container_model as gca_unmanaged_container_model
...
class BatchPredictionJob(proto.Message):
    ...
    class InputConfig(proto.Message):
        ...
        vertex_multimodal_dataset_source: io.VertexMultimodalDatasetSource = proto.Field(
            proto.MESSAGE,
            number=4,
            oneof='source',
    ...
    class OutputConfig(proto.Message):
        ...
        vertex_multimodal_dataset_destination: io.VertexMultimodalDatasetDestination = proto.Field(
            proto.MESSAGE,
            number=6,
            oneof='destination',
    ...
    unmanaged_container_model: gca_unmanaged_container_model.UnmanagedContainerModel = proto.Field(
        proto.MESSAGE,
        number=28,
    ...
    model_monitoring_stats_anomalies: MutableSequence[model_deployment_monitoring_job.ModelMonitoringStatsAnomalies] = proto.RepeatedField(
        proto.MESSAGE,
        number=31,
