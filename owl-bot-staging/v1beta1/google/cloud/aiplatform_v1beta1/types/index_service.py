...
class ImportIndexRequest(proto.Message):
    ...
    class ConnectorConfig(proto.Message):
        ...
        class DatapointFieldMapping(proto.Message):
            ...
            restricts: MutableSequence['ImportIndexRequest.ConnectorConfig.DatapointFieldMapping.Restrict'] = proto.RepeatedField(
                proto.MESSAGE,
                number=3,
                message='ImportIndexRequest.ConnectorConfig.DatapointFieldMapping.Restrict',
            )
            numeric_restricts: MutableSequence['ImportIndexRequest.ConnectorConfig.DatapointFieldMapping.NumericRestrict'] = proto.RepeatedField(
                proto.MESSAGE,
                number=4,
...
class NearestNeighborSearchOperationMetadata(proto.Message):
    ...
    class ContentValidationStats(proto.Message):
        ...
        partial_errors: MutableSequence['NearestNeighborSearchOperationMetadata.RecordError'] = proto.RepeatedField(
            proto.MESSAGE,
            number=4,
    ...
    content_validation_stats: MutableSequence[ContentValidationStats] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
