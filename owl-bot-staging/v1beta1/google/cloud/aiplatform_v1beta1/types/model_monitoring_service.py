...
class ListModelMonitorsResponse(proto.Message):
    ...
    model_monitors: MutableSequence[gca_model_monitor.ModelMonitor] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_model_monitor.ModelMonitor,
    )
...
class ListModelMonitoringJobsResponse(proto.Message):
    ...
    model_monitoring_jobs: MutableSequence[gca_model_monitoring_job.ModelMonitoringJob] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_model_monitoring_job.ModelMonitoringJob,
    )
...
class SearchModelMonitoringStatsResponse(proto.Message):
    ...
    monitoring_stats: MutableSequence[model_monitoring_stats.ModelMonitoringStats] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class SearchModelMonitoringAlertsResponse(proto.Message):
    ...
    model_monitoring_alerts: MutableSequence[model_monitoring_alert.ModelMonitoringAlert] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
