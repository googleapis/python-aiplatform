...
class ListExampleStoresResponse(proto.Message):
    ...
    example_stores: MutableSequence[gca_example_store.ExampleStore] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_example_store.ExampleStore,
    )
...
class RemoveExamplesRequest(proto.Message):
    ...
    stored_contents_example_filter: gca_example_store.StoredContentsExampleFilter = proto.Field(
        proto.MESSAGE,
        number=8,
