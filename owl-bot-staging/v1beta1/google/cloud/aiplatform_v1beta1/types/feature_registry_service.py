...
class ListFeatureMonitorsResponse(proto.Message):
    ...
    feature_monitors: MutableSequence[gca_feature_monitor.FeatureMonitor] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_feature_monitor.FeatureMonitor,
    )
...
class ListFeatureMonitorJobsResponse(proto.Message):
    ...
    feature_monitor_jobs: MutableSequence[gca_feature_monitor_job.FeatureMonitorJob] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_feature_monitor_job.FeatureMonitorJob,
    )
