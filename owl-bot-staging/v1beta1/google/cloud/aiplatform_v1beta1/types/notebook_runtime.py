...
from google.cloud.aiplatform_v1beta1.types import notebook_runtime_template_ref as gca_notebook_runtime_template_ref
...
class NotebookRuntimeTemplate(proto.Message):
    ...
    idle_shutdown_config: notebook_idle_shutdown_config.NotebookIdleShutdownConfig = proto.Field(
        proto.MESSAGE,
        number=17,
