...
class SearchMigratableResourcesResponse(proto.Message):
    ...
    migratable_resources: MutableSequence[gca_migratable_resource.MigratableResource] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class BatchMigrateResourcesRequest(proto.Message):
    ...
    migrate_resource_requests: MutableSequence['MigrateResourceRequest'] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
...
class MigrateResourceRequest(proto.Message):
    ...
    class MigrateDataLabelingDatasetConfig(proto.Message):
        ...
        migrate_data_labeling_annotated_dataset_configs: MutableSequence['MigrateResourceRequest.MigrateDataLabelingDatasetConfig.MigrateDataLabelingAnnotatedDatasetConfig'] = proto.RepeatedField(
            proto.MESSAGE,
            number=3,
            message='MigrateResourceRequest.MigrateDataLabelingDatasetConfig.MigrateDataLabelingAnnotatedDatasetConfig',
        )

    migrate_ml_engine_model_version_config: MigrateMlEngineModelVersionConfig = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof='request',
    ...
    migrate_data_labeling_dataset_config: MigrateDataLabelingDatasetConfig = proto.Field(
        proto.MESSAGE,
        number=4,
        oneof='request',
...
class BatchMigrateResourcesResponse(proto.Message):
    ...
    migrate_resource_responses: MutableSequence['MigrateResourceResponse'] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
