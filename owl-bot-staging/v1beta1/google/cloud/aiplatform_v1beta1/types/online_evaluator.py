...
class OnlineEvaluator(proto.Message):
    ...
    class CloudObservability(proto.Message):
        ...
        class NumericPredicate(proto.Message):
            ...
            comparison_operator: 'OnlineEvaluator.CloudObservability.NumericPredicate.ComparisonOperator' = proto.Field(
                proto.ENUM,
                number=1,
        ...
        class TraceScope(proto.Message):
            ...
            class Predicate(proto.Message):
                ...
                duration: 'OnlineEvaluator.CloudObservability.NumericPredicate' = proto.Field(
                    proto.MESSAGE,
                    number=1,
                    oneof='predicate',
                    message='OnlineEvaluator.CloudObservability.NumericPredicate',
                )
                total_token_usage: 'OnlineEvaluator.CloudObservability.NumericPredicate' = proto.Field(
                    proto.MESSAGE,
                    number=2,
                    oneof='predicate',
                    message='OnlineEvaluator.CloudObservability.NumericPredicate',
            ...
            filter: MutableSequence['OnlineEvaluator.CloudObservability.TraceScope.Predicate'] = proto.RepeatedField(
                proto.MESSAGE,
                number=1,
        ...
        open_telemetry: 'OnlineEvaluator.CloudObservability.OpenTelemetry' = proto.Field(
            proto.MESSAGE,
            number=4,
            oneof='convention',
    ...
    metric_sources: MutableSequence[evaluation_service.MetricSource] = proto.RepeatedField(
        proto.MESSAGE,
        number=3,
