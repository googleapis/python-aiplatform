...
class PublisherModel(proto.Message):
    ...
    class CallToAction(proto.Message):
        ...
        class RegionalResourceReferences(proto.Message):
            ...
            references: MutableMapping[str, 'PublisherModel.ResourceReference'] = proto.MapField(
                proto.STRING,
                proto.MESSAGE,
                number=1,
                message='PublisherModel.ResourceReference',
        ...
        class ViewRestApi(proto.Message):
            ...
            documentations: MutableSequence['PublisherModel.Documentation'] = proto.RepeatedField(
                proto.MESSAGE,
                number=1,
        ...
        class OpenNotebooks(proto.Message):
            ...
            notebooks: MutableSequence['PublisherModel.CallToAction.RegionalResourceReferences'] = proto.RepeatedField(
                proto.MESSAGE,
                number=1,
        ...
        class OpenFineTuningPipelines(proto.Message):
            ...
            fine_tuning_pipelines: MutableSequence['PublisherModel.CallToAction.RegionalResourceReferences'] = proto.RepeatedField(
                proto.MESSAGE,
                number=1,
                message='PublisherModel.CallToAction.RegionalResourceReferences',
            )
        ...
        class DeployVertex(proto.Message):
            ...
            multi_deploy_vertex: MutableSequence['PublisherModel.CallToAction.Deploy'] = proto.RepeatedField(
                proto.MESSAGE,
                number=1,
        ...
        class Deploy(proto.Message):
            ...
            deploy_metadata: 'PublisherModel.CallToAction.Deploy.DeployMetadata' = proto.Field(
                proto.MESSAGE,
                number=11,
                optional=True,
        ...
        open_notebook: 'PublisherModel.CallToAction.RegionalResourceReferences' = proto.Field(
            proto.MESSAGE,
            number=2,
            message='PublisherModel.CallToAction.RegionalResourceReferences',
        )
        ...
        create_application: 'PublisherModel.CallToAction.RegionalResourceReferences' = proto.Field(
            proto.MESSAGE,
            number=3,
            message='PublisherModel.CallToAction.RegionalResourceReferences',
        )
        ...
        open_genie: 'PublisherModel.CallToAction.RegionalResourceReferences' = proto.Field(
            proto.MESSAGE,
            number=6,
            message='PublisherModel.CallToAction.RegionalResourceReferences',
        )
        ...
        request_access: 'PublisherModel.CallToAction.RegionalResourceReferences' = proto.Field(
            proto.MESSAGE,
            number=9,
            message='PublisherModel.CallToAction.RegionalResourceReferences',
        )
