...
class Model(proto.Message):
    ...
    class ExportFormat(proto.Message):
        ...
        exportable_contents: MutableSequence['Model.ExportFormat.ExportableContent'] = proto.RepeatedField(
            proto.ENUM,
            number=2,
    ...
    supported_deployment_resources_types: MutableSequence[DeploymentResourcesType] = proto.RepeatedField(
        proto.ENUM,
        number=10,
    ...
    deployed_models: MutableSequence[deployed_model_ref.DeployedModelRef] = proto.RepeatedField(
        proto.MESSAGE,
        number=15,
