...
class ListDatasetVersionsResponse(proto.Message):
    ...
    dataset_versions: MutableSequence[gca_dataset_version.DatasetVersion] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_dataset_version.DatasetVersion,
    )
...
class AssessDataRequest(proto.Message):
    ...
    tuning_resource_usage_assessment_config: TuningResourceUsageAssessmentConfig = proto.Field(
        proto.MESSAGE,
        number=3,
        oneof='assessment_config',
...
class AssessDataResponse(proto.Message):
    ...
    tuning_resource_usage_assessment_result: TuningResourceUsageAssessmentResult = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof='assessment_result',
