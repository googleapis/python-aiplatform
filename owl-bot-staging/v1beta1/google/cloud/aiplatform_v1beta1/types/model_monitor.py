...
class ModelMonitor(proto.Message):
    ...
    class ModelMonitoringTarget(proto.Message):
        ...
        vertex_model: 'ModelMonitor.ModelMonitoringTarget.VertexModelSource' = proto.Field(
            proto.MESSAGE,
            number=1,
            oneof='source',
    ...
    notification_spec: model_monitoring_spec.ModelMonitoringNotificationSpec = proto.Field(
        proto.MESSAGE,
        number=12,
