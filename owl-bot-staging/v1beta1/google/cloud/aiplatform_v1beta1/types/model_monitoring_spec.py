...
class ModelMonitoringObjectiveSpec(proto.Message):
    ...
    class DataDriftSpec(proto.Message):
        ...
        feature_alert_conditions: MutableMapping[str, model_monitoring_alert.ModelMonitoringAlertCondition] = proto.MapField(
            proto.STRING,
            proto.MESSAGE,
            number=6,
            message=model_monitoring_alert.ModelMonitoringAlertCondition,
    ...
    class TabularObjective(proto.Message):
        ...
        prediction_output_drift_spec: 'ModelMonitoringObjectiveSpec.DataDriftSpec' = proto.Field(
            proto.MESSAGE,
            number=11,
            message='ModelMonitoringObjectiveSpec.DataDriftSpec',
        )
...
class ModelMonitoringNotificationSpec(proto.Message):
    ...
    notification_channel_configs: MutableSequence[NotificationChannelConfig] = proto.RepeatedField(
        proto.MESSAGE,
        number=3,
