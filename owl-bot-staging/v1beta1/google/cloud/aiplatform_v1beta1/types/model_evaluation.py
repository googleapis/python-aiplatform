...
class ModelEvaluation(proto.Message):
    ...
    class BiasConfig(proto.Message):
        ...
        bias_slices: model_evaluation_slice.ModelEvaluationSlice.Slice.SliceSpec = proto.Field(
            proto.MESSAGE,
            number=1,
    ...
    explanation_specs: MutableSequence[ModelEvaluationExplanationSpec] = proto.RepeatedField(
        proto.MESSAGE,
        number=9,
