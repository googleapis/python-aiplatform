...
class ReasoningEngineSpec(proto.Message):
    ...
    class SourceCodeSpec(proto.Message):
        ...
        class DeveloperConnectSource(proto.Message):
            ...
            config: 'ReasoningEngineSpec.SourceCodeSpec.DeveloperConnectConfig' = proto.Field(
                proto.MESSAGE,
                number=1,
        ...
        developer_connect_source: 'ReasoningEngineSpec.SourceCodeSpec.DeveloperConnectSource' = proto.Field(
            proto.MESSAGE,
            number=3,
            oneof='source',
...
class ReasoningEngine(proto.Message):
    ...
    class TrafficConfig(proto.Message):
        ...
        class TrafficSplitManual(proto.Message):
            ...
            targets: MutableSequence['ReasoningEngine.TrafficConfig.TrafficSplitManual.Target'] = proto.RepeatedField(
                proto.MESSAGE,
                number=1,
        ...
        traffic_split_manual: 'ReasoningEngine.TrafficConfig.TrafficSplitManual' = proto.Field(
            proto.MESSAGE,
            number=18,
            oneof='traffic_split',
            message='ReasoningEngine.TrafficConfig.TrafficSplitManual',
        )
        traffic_split_always_latest: 'ReasoningEngine.TrafficConfig.TrafficSplitAlwaysLatest' = proto.Field(
            proto.MESSAGE,
            number=19,
            oneof='traffic_split',
...
class ReasoningEngineContextSpec(proto.Message):
    ...
    class MemoryBankConfig(proto.Message):
        ...
        ttl_config: 'ReasoningEngineContextSpec.MemoryBankConfig.TtlConfig' = proto.Field(
            proto.MESSAGE,
            number=5,
