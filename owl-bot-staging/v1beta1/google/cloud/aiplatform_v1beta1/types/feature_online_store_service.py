...
class FetchFeatureValuesResponse(proto.Message):
    ...
    class FeatureNameValuePairList(proto.Message):
        ...
        features: MutableSequence['FetchFeatureValuesResponse.FeatureNameValuePairList.FeatureNameValuePair'] = proto.RepeatedField(
            proto.MESSAGE,
            number=1,
...
class FeatureViewDirectWriteRequest(proto.Message):
    ...
    class DataKeyAndFeatureValues(proto.Message):
        ...
        features: MutableSequence['FeatureViewDirectWriteRequest.DataKeyAndFeatureValues.Feature'] = proto.RepeatedField(
            proto.MESSAGE,
            number=2,
    ...
    data_key_and_feature_values: MutableSequence[DataKeyAndFeatureValues] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
