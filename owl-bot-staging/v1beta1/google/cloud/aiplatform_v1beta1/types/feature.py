...
class Feature(proto.Message):
    ...
    class MonitoringStatsAnomaly(proto.Message):
        ...
        feature_stats_anomaly: feature_monitoring_stats.FeatureStatsAnomaly = proto.Field(
            proto.MESSAGE,
            number=2,
    ...
    monitoring_stats: MutableSequence[feature_monitoring_stats.FeatureStatsAnomaly] = proto.RepeatedField(
        proto.MESSAGE,
        number=10,
        message=feature_monitoring_stats.FeatureStatsAnomaly,
    )
    monitoring_stats_anomalies: MutableSequence[MonitoringStatsAnomaly] = proto.RepeatedField(
        proto.MESSAGE,
        number=11,
        message=MonitoringStatsAnomaly,
    )
    feature_stats_and_anomaly: MutableSequence[feature_monitor.FeatureStatsAndAnomaly] = proto.RepeatedField(
        proto.MESSAGE,
        number=13,
