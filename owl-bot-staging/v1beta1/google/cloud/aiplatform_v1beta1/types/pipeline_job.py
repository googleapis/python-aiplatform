...
class PipelineJob(proto.Message):
    ...
    pipeline_task_rerun_configs: MutableSequence['PipelineTaskRerunConfig'] = proto.RepeatedField(
        proto.MESSAGE,
        number=30,
...
class PipelineTaskRerunConfig(proto.Message):
    ...
    class ArtifactList(proto.Message):
        ...
        artifacts: MutableSequence[ui_pipeline_spec.RuntimeArtifact] = proto.RepeatedField(
            proto.MESSAGE,
            number=1,
    ...
    class Inputs(proto.Message):
        ...
        artifacts: MutableMapping[str, 'PipelineTaskRerunConfig.ArtifactList'] = proto.MapField(
            proto.STRING,
            proto.MESSAGE,
            number=1,
