...
from google.cloud.aiplatform_v1beta1.types import feature_view_sync as gca_feature_view_sync
...
class ListFeatureOnlineStoresResponse(proto.Message):
    ...
    feature_online_stores: MutableSequence[gca_feature_online_store.FeatureOnlineStore] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_feature_online_store.FeatureOnlineStore,
    )
...
class ListFeatureViewSyncsResponse(proto.Message):
    ...
    feature_view_syncs: MutableSequence[gca_feature_view_sync.FeatureViewSync] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
