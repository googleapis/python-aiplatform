...
class ListMetadataStoresResponse(proto.Message):
    ...
    metadata_stores: MutableSequence[gca_metadata_store.MetadataStore] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_metadata_store.MetadataStore,
    )
...
class ListMetadataSchemasResponse(proto.Message):
    ...
    metadata_schemas: MutableSequence[gca_metadata_schema.MetadataSchema] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_metadata_schema.MetadataSchema,
    )
