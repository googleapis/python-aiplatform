...
class VertexRagDataServiceClient(metaclass=VertexRagDataServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = VertexRagDataServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = VertexRagDataServiceClient._read_environment_variables()
        ...
        self._universe_domain = VertexRagDataServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
