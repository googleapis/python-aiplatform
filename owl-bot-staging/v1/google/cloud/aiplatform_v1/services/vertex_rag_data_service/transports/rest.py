...
class VertexRagDataServiceRestTransport(_BaseVertexRagDataServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseVertexRagDataServiceRestTransport._BaseGetIamPolicy, VertexRagDataServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = VertexRagDataServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseVertexRagDataServiceRestTransport._BaseTestIamPermissions, VertexRagDataServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = VertexRagDataServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
