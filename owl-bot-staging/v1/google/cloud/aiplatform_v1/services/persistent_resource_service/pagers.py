...
class ListPersistentResourcesPager:
    ...
    """
    def __init__(self,
            method: Callable[..., persistent_resource_service.ListPersistentResourcesResponse],
        ...
        """
        self._method = method
        self._request = persistent_resource_service.ListPersistentResourcesRequest(request)
    ...
    @property
    def pages(self) -> Iterator[persistent_resource_service.ListPersistentResourcesResponse]:
...
class ListPersistentResourcesAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[persistent_resource_service.ListPersistentResourcesResponse]],
            request: persistent_resource_service.ListPersistentResourcesRequest,
            response: persistent_resource_service.ListPersistentResourcesResponse,
            *,
    ...
    @property
    async def pages(self) -> AsyncIterator[persistent_resource_service.ListPersistentResourcesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
