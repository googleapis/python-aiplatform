...
class PersistentResourceServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[PersistentResourceServiceTransport]]
...
class PersistentResourceServiceClient(metaclass=PersistentResourceServiceClientMeta):
    ...
    def persistent_resource_path(project: str,location: str,persistent_resource: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/persistentResources/{persistent_resource}".format(project=project, location=location, persistent_resource=persistent_resource, )

    @staticmethod
    def parse_persistent_resource_path(path: str) -> Dict[str,str]:
        """Parses a persistent_resource path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/persistentResources/(?P<persistent_resource>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = PersistentResourceServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            PersistentResourceServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, PersistentResourceServiceTransport, Callable[..., PersistentResourceServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = PersistentResourceServiceClient._read_environment_variables()
        self._client_cert_source = PersistentResourceServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = PersistentResourceServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[PersistentResourceServiceTransport], Callable[..., PersistentResourceServiceTransport]] = (
    ...
    def create_persistent_resource(self,
            request: Optional[Union[persistent_resource_service.CreatePersistentResourceRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            persistent_resource: Optional[gca_persistent_resource.PersistentResource] = None,
        ...
        has_flattened_params = any([parent, persistent_resource, persistent_resource_id])
        ...
        if not isinstance(request, persistent_resource_service.CreatePersistentResourceRequest):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_persistent_resource]
    ...
    def get_persistent_resource(self,
            request: Optional[Union[persistent_resource_service.GetPersistentResourceRequest, dict]] = None,
            *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, persistent_resource_service.GetPersistentResourceRequest):
    ...
    def list_persistent_resources(self,
            request: Optional[Union[persistent_resource_service.ListPersistentResourcesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, persistent_resource_service.ListPersistentResourcesRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_persistent_resources]
    ...
    def delete_persistent_resource(self,
            request: Optional[Union[persistent_resource_service.DeletePersistentResourceRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, persistent_resource_service.DeletePersistentResourceRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_persistent_resource]
    ...
    def update_persistent_resource(self,
            request: Optional[Union[persistent_resource_service.UpdatePersistentResourceRequest, dict]] = None,
            *,
            persistent_resource: Optional[gca_persistent_resource.PersistentResource] = None,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, persistent_resource_service.UpdatePersistentResourceRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_persistent_resource]
    ...
    def reboot_persistent_resource(self,
            request: Optional[Union[persistent_resource_service.RebootPersistentResourceRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, persistent_resource_service.RebootPersistentResourceRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.reboot_persistent_resource]
