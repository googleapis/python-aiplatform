...
class AsyncPersistentResourceServiceRestTransport(_BasePersistentResourceServiceRestTransport):
    ...
    class _GetIamPolicy(_BasePersistentResourceServiceRestTransport._BaseGetIamPolicy, AsyncPersistentResourceServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncPersistentResourceServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BasePersistentResourceServiceRestTransport._BaseTestIamPermissions, AsyncPersistentResourceServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncPersistentResourceServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
