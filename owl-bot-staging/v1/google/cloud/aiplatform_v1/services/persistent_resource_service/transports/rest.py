...
from .base import PersistentResourceServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class PersistentResourceServiceRestTransport(PersistentResourceServiceTransport):
    ...
    class _CreatePersistentResource(PersistentResourceServiceRestStub):
        ...
        resource method over HTTP.
            ...
            pb_request = persistent_resource_service.CreatePersistentResourceRequest.pb(request)
    ...
    class _DeletePersistentResource(PersistentResourceServiceRestStub):
        ...
        resource method over HTTP.
            ...
            pb_request = persistent_resource_service.DeletePersistentResourceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetPersistentResource(PersistentResourceServiceRestStub):
        ...
        def __call__(self,
            ...
            pb_request = persistent_resource_service.GetPersistentResourceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListPersistentResources(PersistentResourceServiceRestStub):
        ...
        def __call__(self,
            ...
            pb_request = persistent_resource_service.ListPersistentResourcesRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _RebootPersistentResource(PersistentResourceServiceRestStub):
        ...
        resource method over HTTP.
            ...
            pb_request = persistent_resource_service.RebootPersistentResourceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _UpdatePersistentResource(PersistentResourceServiceRestStub):
        ...
        resource method over HTTP.
            ...
            pb_request = persistent_resource_service.UpdatePersistentResourceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
