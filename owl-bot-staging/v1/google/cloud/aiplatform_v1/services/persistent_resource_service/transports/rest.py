...
class PersistentResourceServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_persistent_resource(self, request: persistent_resource_service.CreatePersistentResourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[persistent_resource_service.CreatePersistentResourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_persistent_resource(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    def post_create_persistent_resource_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_persistent_resource
    ...
    def pre_delete_persistent_resource(self, request: persistent_resource_service.DeletePersistentResourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[persistent_resource_service.DeletePersistentResourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_persistent_resource(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    def post_delete_persistent_resource_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_persistent_resource
    ...
    def pre_get_persistent_resource(self, request: persistent_resource_service.GetPersistentResourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[persistent_resource_service.GetPersistentResourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_persistent_resource(self, response: persistent_resource.PersistentResource) -> persistent_resource.PersistentResource:
    ...
    def post_get_persistent_resource_with_metadata(self, response: persistent_resource.PersistentResource, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[persistent_resource.PersistentResource, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_persistent_resource
    ...
    def pre_list_persistent_resources(self, request: persistent_resource_service.ListPersistentResourcesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[persistent_resource_service.ListPersistentResourcesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_persistent_resources(self, response: persistent_resource_service.ListPersistentResourcesResponse) -> persistent_resource_service.ListPersistentResourcesResponse:
    ...
    def post_list_persistent_resources_with_metadata(self, response: persistent_resource_service.ListPersistentResourcesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[persistent_resource_service.ListPersistentResourcesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_persistent_resources
    ...
    def pre_reboot_persistent_resource(self, request: persistent_resource_service.RebootPersistentResourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[persistent_resource_service.RebootPersistentResourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_reboot_persistent_resource(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    def post_reboot_persistent_resource_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for reboot_persistent_resource
    ...
    def pre_update_persistent_resource(self, request: persistent_resource_service.UpdatePersistentResourceRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[persistent_resource_service.UpdatePersistentResourceRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_persistent_resource(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    def post_update_persistent_resource_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_persistent_resource
...
class PersistentResourceServiceRestTransport(_BasePersistentResourceServiceRestTransport):
    ...
    def __init__(self, *,
        ...
        Args:
            ...
            interceptor (Optional[PersistentResourceServiceRestInterceptor]): Interceptor used
    ...
    class _CreatePersistentResource(_BasePersistentResourceServiceRestTransport._BaseCreatePersistentResource, PersistentResourceServiceRestStub):
        def __hash__(self):
            return hash("PersistentResourceServiceRestTransport.CreatePersistentResource")
        ...
        resource method over HTTP.
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseCreatePersistentResource._get_http_options()

            request, metadata = self._interceptor.pre_create_persistent_resource(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseCreatePersistentResource._get_transcoded_request(http_options, request)

            body = _BasePersistentResourceServiceRestTransport._BaseCreatePersistentResource._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseCreatePersistentResource._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._CreatePersistentResource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp, _ = self._interceptor.post_create_persistent_resource_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _DeletePersistentResource(_BasePersistentResourceServiceRestTransport._BaseDeletePersistentResource, PersistentResourceServiceRestStub):
        def __hash__(self):
            return hash("PersistentResourceServiceRestTransport.DeletePersistentResource")
        ...
        resource method over HTTP.
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseDeletePersistentResource._get_http_options()

            request, metadata = self._interceptor.pre_delete_persistent_resource(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseDeletePersistentResource._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseDeletePersistentResource._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._DeletePersistentResource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_delete_persistent_resource_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
    ...
    class _GetPersistentResource(_BasePersistentResourceServiceRestTransport._BaseGetPersistentResource, PersistentResourceServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseGetPersistentResource._get_http_options()

            request, metadata = self._interceptor.pre_get_persistent_resource(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseGetPersistentResource._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseGetPersistentResource._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._GetPersistentResource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_get_persistent_resource_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = persistent_resource.PersistentResource.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _ListPersistentResources(_BasePersistentResourceServiceRestTransport._BaseListPersistentResources, PersistentResourceServiceRestStub):
        def __hash__(self):
            return hash("PersistentResourceServiceRestTransport.ListPersistentResources")
        ...
        def __call__(self,
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseListPersistentResources._get_http_options()

            request, metadata = self._interceptor.pre_list_persistent_resources(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseListPersistentResources._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseListPersistentResources._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._ListPersistentResources._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            pb_resp = persistent_resource_service.ListPersistentResourcesResponse.pb(resp)

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)

            resp = self._interceptor.post_list_persistent_resources(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_persistent_resources_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = persistent_resource_service.ListPersistentResourcesResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _RebootPersistentResource(_BasePersistentResourceServiceRestTransport._BaseRebootPersistentResource, PersistentResourceServiceRestStub):
        def __hash__(self):
            return hash("PersistentResourceServiceRestTransport.RebootPersistentResource")
        ...
        resource method over HTTP.
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseRebootPersistentResource._get_http_options()

            request, metadata = self._interceptor.pre_reboot_persistent_resource(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseRebootPersistentResource._get_transcoded_request(http_options, request)

            body = _BasePersistentResourceServiceRestTransport._BaseRebootPersistentResource._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseRebootPersistentResource._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._RebootPersistentResource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_reboot_persistent_resource_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
    ...
    class _UpdatePersistentResource(_BasePersistentResourceServiceRestTransport._BaseUpdatePersistentResource, PersistentResourceServiceRestStub):
        def __hash__(self):
            return hash("PersistentResourceServiceRestTransport.UpdatePersistentResource")
        ...
        resource method over HTTP.
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseUpdatePersistentResource._get_http_options()

            request, metadata = self._interceptor.pre_update_persistent_resource(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseUpdatePersistentResource._get_transcoded_request(http_options, request)

            body = _BasePersistentResourceServiceRestTransport._BaseUpdatePersistentResource._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseUpdatePersistentResource._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._UpdatePersistentResource._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_update_persistent_resource_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
    ...
    @property
    def create_persistent_resource(self) -> Callable[
    ...
    @property
    def delete_persistent_resource(self) -> Callable[
    ...
    @property
    def get_persistent_resource(self) -> Callable[
    ...
    @property
    def list_persistent_resources(self) -> Callable[
    ...
    @property
    def reboot_persistent_resource(self) -> Callable[
    ...
    @property
    def update_persistent_resource(self) -> Callable[
    ...
    class _GetLocation(_BasePersistentResourceServiceRestTransport._BaseGetLocation, PersistentResourceServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseGetLocation._get_http_options()

            request, metadata = self._interceptor.pre_get_location(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseGetLocation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseGetLocation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BasePersistentResourceServiceRestTransport._BaseListLocations, PersistentResourceServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseListLocations._get_http_options()

            request, metadata = self._interceptor.pre_list_locations(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseListLocations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseListLocations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetIamPolicy(_BasePersistentResourceServiceRestTransport._BaseGetIamPolicy, PersistentResourceServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseGetIamPolicy._get_http_options()

            request, metadata = self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseGetIamPolicy._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseGetIamPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetIamPolicy(_BasePersistentResourceServiceRestTransport._BaseSetIamPolicy, PersistentResourceServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseSetIamPolicy._get_http_options()

            request, metadata = self._interceptor.pre_set_iam_policy(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseSetIamPolicy._get_transcoded_request(http_options, request)

            body = _BasePersistentResourceServiceRestTransport._BaseSetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseSetIamPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BasePersistentResourceServiceRestTransport._BaseTestIamPermissions, PersistentResourceServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _CancelOperation(_BasePersistentResourceServiceRestTransport._BaseCancelOperation, PersistentResourceServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseCancelOperation._get_http_options()

            request, metadata = self._interceptor.pre_cancel_operation(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseCancelOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseCancelOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BasePersistentResourceServiceRestTransport._BaseDeleteOperation, PersistentResourceServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseDeleteOperation._get_http_options()

            request, metadata = self._interceptor.pre_delete_operation(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseDeleteOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseDeleteOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BasePersistentResourceServiceRestTransport._BaseGetOperation, PersistentResourceServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseGetOperation._get_http_options()

            request, metadata = self._interceptor.pre_get_operation(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BasePersistentResourceServiceRestTransport._BaseListOperations, PersistentResourceServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseListOperations._get_http_options()

            request, metadata = self._interceptor.pre_list_operations(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseListOperations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseListOperations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _WaitOperation(_BasePersistentResourceServiceRestTransport._BaseWaitOperation, PersistentResourceServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BasePersistentResourceServiceRestTransport._BaseWaitOperation._get_http_options()

            request, metadata = self._interceptor.pre_wait_operation(request, metadata)
            transcoded_request = _BasePersistentResourceServiceRestTransport._BaseWaitOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BasePersistentResourceServiceRestTransport._BaseWaitOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = PersistentResourceServiceRestTransport._WaitOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
