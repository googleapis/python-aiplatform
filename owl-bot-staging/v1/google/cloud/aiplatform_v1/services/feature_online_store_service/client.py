...
class FeatureOnlineStoreServiceClient(metaclass=FeatureOnlineStoreServiceClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, FeatureOnlineStoreServiceTransport, Callable[..., FeatureOnlineStoreServiceTransport]]] = None,
        ...
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=FeatureOnlineStoreServiceClient._DEFAULT_UNIVERSE)
        ...
        if not transport_provided:
            transport_init: Union[Type[FeatureOnlineStoreServiceTransport], Callable[..., FeatureOnlineStoreServiceTransport]] = (
    ...
    def search_nearest_entities(self,
    ...
    def feature_view_direct_write(self,
            requests: Optional[Iterator[feature_online_store_service.FeatureViewDirectWriteRequest]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.feature_view_direct_write]
    ...
    def generate_fetch_access_token(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_fetch_access_token]
