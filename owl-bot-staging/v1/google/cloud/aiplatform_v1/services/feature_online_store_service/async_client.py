...
class FeatureOnlineStoreServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = FeatureOnlineStoreServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    parse_feature_view_path = staticmethod(FeatureOnlineStoreServiceClient.parse_feature_view_path)
    common_billing_account_path = staticmethod(FeatureOnlineStoreServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(FeatureOnlineStoreServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(FeatureOnlineStoreServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(FeatureOnlineStoreServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(FeatureOnlineStoreServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(FeatureOnlineStoreServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(FeatureOnlineStoreServiceClient.common_project_path)
    parse_common_project_path = staticmethod(FeatureOnlineStoreServiceClient.parse_common_project_path)
    common_location_path = staticmethod(FeatureOnlineStoreServiceClient.common_location_path)
    parse_common_location_path = staticmethod(FeatureOnlineStoreServiceClient.parse_common_location_path)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        return sa_file_func(FeatureOnlineStoreServiceAsyncClient, filename, *args, **kwargs)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, FeatureOnlineStoreServiceTransport, Callable[..., FeatureOnlineStoreServiceTransport]]] = "grpc_asyncio",
    ...
    async def fetch_feature_values(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.fetch_feature_values]
    ...
    async def search_nearest_entities(self,
            request: Optional[Union[feature_online_store_service.SearchNearestEntitiesRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_online_store_service.SearchNearestEntitiesRequest):
            request = feature_online_store_service.SearchNearestEntitiesRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_nearest_entities]
    ...
    def feature_view_direct_write(self,
            requests: Optional[AsyncIterator[feature_online_store_service.FeatureViewDirectWriteRequest]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> Awaitable[AsyncIterable[feature_online_store_service.FeatureViewDirectWriteResponse]]:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.feature_view_direct_write]
    ...
    async def generate_fetch_access_token(self,
            request: Optional[Union[feature_online_store_service.GenerateFetchAccessTokenRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, feature_online_store_service.GenerateFetchAccessTokenRequest):
            request = feature_online_store_service.GenerateFetchAccessTokenRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.generate_fetch_access_token]
