...
try:
    ...
    ASYNC_REST_CLASSES = ('AsyncReasoningEngineServiceRestTransport', 'AsyncReasoningEngineServiceRestInterceptor')
    HAS_REST_ASYNC = True
...
_transport_registry = OrderedDict()  # type: Dict[str, Type[ReasoningEngineServiceTransport]]
