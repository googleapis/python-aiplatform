...
class AsyncReasoningEngineServiceRestTransport(_BaseReasoningEngineServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseReasoningEngineServiceRestTransport._BaseGetIamPolicy, AsyncReasoningEngineServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncReasoningEngineServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseReasoningEngineServiceRestTransport._BaseTestIamPermissions, AsyncReasoningEngineServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncReasoningEngineServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
