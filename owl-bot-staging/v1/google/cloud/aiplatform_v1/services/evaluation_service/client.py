...
class EvaluationServiceClient(metaclass=EvaluationServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=EvaluationServiceClient._DEFAULT_UNIVERSE)
    ...
    def evaluate_instances(self,
            request: Optional[Union[evaluation_service.EvaluateInstancesRequest, dict]] = None,
            *,
