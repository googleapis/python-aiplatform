...
class GenAiTuningServiceClient(metaclass=GenAiTuningServiceClientMeta):
    ...
    @staticmethod
    def tuning_job_path(project: str,location: str,tuning_job: str,) -> str:
        """Returns a fully-qualified tuning_job string."""
        return "projects/{project}/locations/{location}/tuningJobs/{tuning_job}".format(project=project, location=location, tuning_job=tuning_job, )

    @staticmethod
    def parse_tuning_job_path(path: str) -> Dict[str,str]:
        """Parses a tuning_job path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/tuningJobs/(?P<tuning_job>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = GenAiTuningServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            GenAiTuningServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, GenAiTuningServiceTransport, Callable[..., GenAiTuningServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = GenAiTuningServiceClient._read_environment_variables()
        self._client_cert_source = GenAiTuningServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = GenAiTuningServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            transport_init: Union[Type[GenAiTuningServiceTransport], Callable[..., GenAiTuningServiceTransport]] = (
    ...
    def create_tuning_job(self,
            request: Optional[Union[genai_tuning_service.CreateTuningJobRequest, dict]] = None,
            *,
    ...
    def list_tuning_jobs(self,
            request: Optional[Union[genai_tuning_service.ListTuningJobsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def cancel_tuning_job(self,
            request: Optional[Union[genai_tuning_service.CancelTuningJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def rebase_tuned_model(self,
            request: Optional[Union[genai_tuning_service.RebaseTunedModelRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
