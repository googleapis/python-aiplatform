...
class AsyncGenAiTuningServiceRestTransport(_BaseGenAiTuningServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseGenAiTuningServiceRestTransport._BaseGetIamPolicy, AsyncGenAiTuningServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncGenAiTuningServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseGenAiTuningServiceRestTransport._BaseTestIamPermissions, AsyncGenAiTuningServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncGenAiTuningServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
