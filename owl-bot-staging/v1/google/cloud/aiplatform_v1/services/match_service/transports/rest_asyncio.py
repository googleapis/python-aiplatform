...
class AsyncMatchServiceRestTransport(_BaseMatchServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseMatchServiceRestTransport._BaseGetIamPolicy, AsyncMatchServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncMatchServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseMatchServiceRestTransport._BaseTestIamPermissions, AsyncMatchServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncMatchServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
