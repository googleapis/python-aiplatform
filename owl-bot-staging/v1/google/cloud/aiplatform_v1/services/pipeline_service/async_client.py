...
class PipelineServiceAsyncClient:
    ...
    network_attachment_path = staticmethod(PipelineServiceClient.network_attachment_path)
    parse_network_attachment_path = staticmethod(PipelineServiceClient.parse_network_attachment_path)
    ...
    async def create_training_pipeline(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_training_pipeline]
    ...
    async def get_training_pipeline(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_training_pipeline]
    ...
    async def delete_training_pipeline(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_training_pipeline():
                ...
                # Make the request
                operation = await client.delete_training_pipeline(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_training_pipeline]
    ...
    async def cancel_training_pipeline(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.cancel_training_pipeline]
    ...
    async def create_pipeline_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_pipeline_job]
    ...
    async def get_pipeline_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_pipeline_job]
    ...
    async def list_pipeline_jobs(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_pipeline_jobs]
    ...
    async def delete_pipeline_job(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_pipeline_job():
                ...
                # Make the request
                operation = await client.delete_pipeline_job(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_pipeline_job]
    ...
    async def batch_delete_pipeline_jobs(self,
        ...
        .. code-block:: python
            ...
            async def sample_batch_delete_pipeline_jobs():
                ...
                # Make the request
                operation = await client.batch_delete_pipeline_jobs(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_delete_pipeline_jobs]
    ...
    async def cancel_pipeline_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.cancel_pipeline_job]
    ...
    async def batch_cancel_pipeline_jobs(self,
        ...
        .. code-block:: python
            ...
            async def sample_batch_cancel_pipeline_jobs():
                ...
                # Make the request
                operation = await client.batch_cancel_pipeline_jobs(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.batch_cancel_pipeline_jobs]
