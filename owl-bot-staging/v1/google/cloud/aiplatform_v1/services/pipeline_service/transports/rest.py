...
class PipelineServiceRestTransport(_BasePipelineServiceRestTransport):
    ...
    class _GetIamPolicy(_BasePipelineServiceRestTransport._BaseGetIamPolicy, PipelineServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PipelineServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BasePipelineServiceRestTransport._BaseTestIamPermissions, PipelineServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PipelineServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
