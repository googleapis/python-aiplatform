...
class PipelineServiceGrpcAsyncIOTransport(PipelineServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_training_pipeline: gapic_v1.method_async.wrap_method(
                self.create_training_pipeline,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_training_pipeline: gapic_v1.method_async.wrap_method(
                self.get_training_pipeline,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_training_pipelines: gapic_v1.method_async.wrap_method(
                self.list_training_pipelines,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_training_pipeline: gapic_v1.method_async.wrap_method(
                self.delete_training_pipeline,
                default_timeout=None,
                client_info=client_info,
            ),
            self.cancel_training_pipeline: gapic_v1.method_async.wrap_method(
                self.cancel_training_pipeline,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_pipeline_job: gapic_v1.method_async.wrap_method(
                self.create_pipeline_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_pipeline_job: gapic_v1.method_async.wrap_method(
                self.get_pipeline_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_pipeline_jobs: gapic_v1.method_async.wrap_method(
                self.list_pipeline_jobs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_pipeline_job: gapic_v1.method_async.wrap_method(
                self.delete_pipeline_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_delete_pipeline_jobs: gapic_v1.method_async.wrap_method(
                self.batch_delete_pipeline_jobs,
                default_timeout=None,
                client_info=client_info,
            ),
            self.cancel_pipeline_job: gapic_v1.method_async.wrap_method(
                self.cancel_pipeline_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.batch_cancel_pipeline_jobs: gapic_v1.method_async.wrap_method(
