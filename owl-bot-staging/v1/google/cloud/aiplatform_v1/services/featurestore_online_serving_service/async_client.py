...
class FeaturestoreOnlineServingServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = FeaturestoreOnlineServingServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        return sa_info_func(FeaturestoreOnlineServingServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            FeaturestoreOnlineServingServiceAsyncClient: The constructed client.
        """
        sa_file_func = FeaturestoreOnlineServingServiceClient.from_service_account_file.__func__  # type: ignore
        return sa_file_func(FeaturestoreOnlineServingServiceAsyncClient, filename, *args, **kwargs)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, FeaturestoreOnlineServingServiceTransport, Callable[..., FeaturestoreOnlineServingServiceTransport]]] = "grpc_asyncio",
    ...
    async def read_feature_values(self,
            request: Optional[Union[featurestore_online_service.ReadFeatureValuesRequest, dict]] = None,
            *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.read_feature_values]
    ...
    def streaming_read_feature_values(self,
            request: Optional[Union[featurestore_online_service.StreamingReadFeatureValuesRequest, dict]] = None,
            *,
            entity_type: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    async def write_feature_values(self,
            request: Optional[Union[featurestore_online_service.WriteFeatureValuesRequest, dict]] = None,
            *,
            entity_type: Optional[str] = None,
            payloads: Optional[MutableSequence[featurestore_online_service.WriteFeatureValuesPayload]] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, featurestore_online_service.WriteFeatureValuesRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.write_feature_values]
