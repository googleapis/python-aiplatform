...
class FeaturestoreOnlineServingServiceAsyncClient:
    ...
    async def read_feature_values(self,
        ...
        Args:
            request (:class:`google.cloud.aiplatform_v1.types.ReadFeatureValuesRequest`):
    ...
    def streaming_read_feature_values(self,
        ...
        Args:
            request (:class:`google.cloud.aiplatform_v1.types.StreamingReadFeatureValuesRequest`):
                The request object. Request message for
