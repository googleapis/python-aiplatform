...
class _BaseFeaturestoreOnlineServingServiceRestTransport(FeaturestoreOnlineServingServiceTransport):
    ...
    class _BaseReadFeatureValues:
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = featurestore_online_service.ReadFeatureValuesRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseReadFeatureValues._get_unset_required_fields(query_params))
    ...
    class _BaseStreamingReadFeatureValues:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = featurestore_online_service.StreamingReadFeatureValuesRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseStreamingReadFeatureValues._get_unset_required_fields(query_params))
    ...
    class _BaseWriteFeatureValues:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = featurestore_online_service.WriteFeatureValuesRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseWriteFeatureValues._get_unset_required_fields(query_params))
