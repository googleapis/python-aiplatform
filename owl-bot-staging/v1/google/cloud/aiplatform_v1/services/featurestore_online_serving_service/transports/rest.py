...
class FeaturestoreOnlineServingServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_read_feature_values(self, request: featurestore_online_service.ReadFeatureValuesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[featurestore_online_service.ReadFeatureValuesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_read_feature_values(self, response: featurestore_online_service.ReadFeatureValuesResponse) -> featurestore_online_service.ReadFeatureValuesResponse:
    ...
    def post_read_feature_values_with_metadata(self, response: featurestore_online_service.ReadFeatureValuesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[featurestore_online_service.ReadFeatureValuesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for read_feature_values
    ...
    def pre_streaming_read_feature_values(self, request: featurestore_online_service.StreamingReadFeatureValuesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[featurestore_online_service.StreamingReadFeatureValuesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_streaming_read_feature_values(self, response: rest_streaming.ResponseIterator) -> rest_streaming.ResponseIterator:
    ...
    def post_streaming_read_feature_values_with_metadata(self, response: rest_streaming.ResponseIterator, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[rest_streaming.ResponseIterator, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for streaming_read_feature_values
    ...
    def pre_write_feature_values(self, request: featurestore_online_service.WriteFeatureValuesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[featurestore_online_service.WriteFeatureValuesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_write_feature_values(self, response: featurestore_online_service.WriteFeatureValuesResponse) -> featurestore_online_service.WriteFeatureValuesResponse:
    ...
    def post_write_feature_values_with_metadata(self, response: featurestore_online_service.WriteFeatureValuesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[featurestore_online_service.WriteFeatureValuesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for write_feature_values
...
class FeaturestoreOnlineServingServiceRestTransport(_BaseFeaturestoreOnlineServingServiceRestTransport):
    ...
    def __init__(self, *,
        ...
        self._interceptor = interceptor or FeaturestoreOnlineServingServiceRestInterceptor()
        self._prep_wrapped_messages(client_info)

    class _ReadFeatureValues(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseReadFeatureValues, FeaturestoreOnlineServingServiceRestStub):
        def __hash__(self):
            return hash("FeaturestoreOnlineServingServiceRestTransport.ReadFeatureValues")
        ...
        def __call__(self,
            ...
            request, metadata = self._interceptor.pre_read_feature_values(request, metadata)
            ...
            # Send the request
            response = FeaturestoreOnlineServingServiceRestTransport._ReadFeatureValues._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp, _ = self._interceptor.post_read_feature_values_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _StreamingReadFeatureValues(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseStreamingReadFeatureValues, FeaturestoreOnlineServingServiceRestStub):
        def __hash__(self):
            return hash("FeaturestoreOnlineServingServiceRestTransport.StreamingReadFeatureValues")
        ...
        values method over HTTP.
            ...
            request, metadata = self._interceptor.pre_streaming_read_feature_values(request, metadata)
            ...
            # Send the request
            response = FeaturestoreOnlineServingServiceRestTransport._StreamingReadFeatureValues._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            # Return the response
            resp = rest_streaming.ResponseIterator(response, featurestore_online_service.ReadFeatureValuesResponse)

            resp = self._interceptor.post_streaming_read_feature_values(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_streaming_read_feature_values_with_metadata(resp, response_metadata)
            return resp

    class _WriteFeatureValues(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseWriteFeatureValues, FeaturestoreOnlineServingServiceRestStub):
        def __hash__(self):
            return hash("FeaturestoreOnlineServingServiceRestTransport.WriteFeatureValues")
        ...
        def __call__(self,
            ...
            request, metadata = self._interceptor.pre_write_feature_values(request, metadata)
            ...
            # Send the request
            response = FeaturestoreOnlineServingServiceRestTransport._WriteFeatureValues._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_write_feature_values_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _GetLocation(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseGetLocation, FeaturestoreOnlineServingServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeaturestoreOnlineServingServiceRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseListLocations, FeaturestoreOnlineServingServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeaturestoreOnlineServingServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetIamPolicy(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseGetIamPolicy, FeaturestoreOnlineServingServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeaturestoreOnlineServingServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetIamPolicy(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseSetIamPolicy, FeaturestoreOnlineServingServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeaturestoreOnlineServingServiceRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseTestIamPermissions, FeaturestoreOnlineServingServiceRestStub):
        def __hash__(self):
            return hash("FeaturestoreOnlineServingServiceRestTransport.TestIamPermissions")
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeaturestoreOnlineServingServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _CancelOperation(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseCancelOperation, FeaturestoreOnlineServingServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeaturestoreOnlineServingServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseDeleteOperation, FeaturestoreOnlineServingServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeaturestoreOnlineServingServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseGetOperation, FeaturestoreOnlineServingServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeaturestoreOnlineServingServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseListOperations, FeaturestoreOnlineServingServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeaturestoreOnlineServingServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _WaitOperation(_BaseFeaturestoreOnlineServingServiceRestTransport._BaseWaitOperation, FeaturestoreOnlineServingServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeaturestoreOnlineServingServiceRestTransport._WaitOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
