...
from .base import FeaturestoreOnlineServingServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class FeaturestoreOnlineServingServiceRestTransport(FeaturestoreOnlineServingServiceTransport):
