...
class FeaturestoreOnlineServingServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_read_feature_values(self, request: featurestore_online_service.ReadFeatureValuesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[featurestore_online_service.ReadFeatureValuesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_streaming_read_feature_values(self, request: featurestore_online_service.StreamingReadFeatureValuesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[featurestore_online_service.StreamingReadFeatureValuesRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_write_feature_values(self, request: featurestore_online_service.WriteFeatureValuesRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[featurestore_online_service.WriteFeatureValuesRequest, Sequence[Tuple[str, str]]]:
