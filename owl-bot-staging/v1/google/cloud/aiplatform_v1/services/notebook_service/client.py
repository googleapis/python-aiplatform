...
class NotebookServiceClient(metaclass=NotebookServiceClientMeta):
    ...
    @staticmethod
    def notebook_runtime_path(project: str,location: str,notebook_runtime: str,) -> str:
        """Returns a fully-qualified notebook_runtime string."""
        return "projects/{project}/locations/{location}/notebookRuntimes/{notebook_runtime}".format(project=project, location=location, notebook_runtime=notebook_runtime, )

    @staticmethod
    def parse_notebook_runtime_path(path: str) -> Dict[str,str]:
        """Parses a notebook_runtime path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/notebookRuntimes/(?P<notebook_runtime>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def __init__(self, *,
        ...
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=NotebookServiceClient._DEFAULT_UNIVERSE)
    ...
    def create_notebook_runtime_template(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_notebook_runtime_template]
    ...
    def get_notebook_runtime_template(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_notebook_runtime_template]
    ...
    def list_notebook_runtime_templates(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_notebook_runtime_templates]
    ...
    def delete_notebook_runtime_template(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_notebook_runtime_template]
    ...
    def update_notebook_runtime_template(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_notebook_runtime_template]
    ...
    def assign_notebook_runtime(self,
    ...
    def list_notebook_runtimes(self,
    ...
    def delete_notebook_runtime(self,
    ...
    def upgrade_notebook_runtime(self,
    ...
    def start_notebook_runtime(self,
    ...
    def stop_notebook_runtime(self,
    ...
    def create_notebook_execution_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_notebook_execution_job]
    ...
    def get_notebook_execution_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_notebook_execution_job]
    ...
    def list_notebook_execution_jobs(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_notebook_execution_jobs]
    ...
    def delete_notebook_execution_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_notebook_execution_job]
