...
class NotebookServiceRestTransport(_BaseNotebookServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseNotebookServiceRestTransport._BaseGetIamPolicy, NotebookServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = NotebookServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseNotebookServiceRestTransport._BaseTestIamPermissions, NotebookServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = NotebookServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
