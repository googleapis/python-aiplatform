...
class ListNotebookRuntimeTemplatesAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[notebook_service.ListNotebookRuntimeTemplatesResponse]],
            request: notebook_service.ListNotebookRuntimeTemplatesRequest,
            response: notebook_service.ListNotebookRuntimeTemplatesResponse,
            *,
    ...
    @property
    async def pages(self) -> AsyncIterator[notebook_service.ListNotebookRuntimeTemplatesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
...
class ListNotebookRuntimesAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[notebook_service.ListNotebookRuntimesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListNotebookExecutionJobsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[notebook_service.ListNotebookExecutionJobsResponse]],
            request: notebook_service.ListNotebookExecutionJobsRequest,
            response: notebook_service.ListNotebookExecutionJobsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[notebook_service.ListNotebookExecutionJobsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
