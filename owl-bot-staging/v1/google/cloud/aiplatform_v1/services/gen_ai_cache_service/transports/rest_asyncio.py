...
class AsyncGenAiCacheServiceRestTransport(_BaseGenAiCacheServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseGenAiCacheServiceRestTransport._BaseGetIamPolicy, AsyncGenAiCacheServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncGenAiCacheServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseGenAiCacheServiceRestTransport._BaseTestIamPermissions, AsyncGenAiCacheServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncGenAiCacheServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
