...
class ListCachedContentsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[gen_ai_cache_service.ListCachedContentsResponse]],
            request: gen_ai_cache_service.ListCachedContentsRequest,
            response: gen_ai_cache_service.ListCachedContentsResponse,
            *,
    ...
    @property
    async def pages(self) -> AsyncIterator[gen_ai_cache_service.ListCachedContentsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
