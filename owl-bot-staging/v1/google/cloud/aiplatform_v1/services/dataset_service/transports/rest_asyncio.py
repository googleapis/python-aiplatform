...
class AsyncDatasetServiceRestTransport(_BaseDatasetServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseDatasetServiceRestTransport._BaseGetIamPolicy, AsyncDatasetServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncDatasetServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseDatasetServiceRestTransport._BaseTestIamPermissions, AsyncDatasetServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncDatasetServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
