...
class DatasetServiceAsyncClient:
    ...
    parse_dataset_version_path = staticmethod(DatasetServiceClient.parse_dataset_version_path)
    ...
    async def create_dataset_version(self,
        ...
        .. code-block:: python
            ...
            async def sample_create_dataset_version():
                ...
                # Make the request
                operation = await client.create_dataset_version(request=request)
    ...
    async def update_dataset_version(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_dataset_version]
    ...
    async def delete_dataset_version(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_dataset_version():
                ...
                # Make the request
                operation = await client.delete_dataset_version(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_dataset_version]
    ...
    async def get_dataset_version(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_dataset_version]
    ...
    async def list_dataset_versions(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_dataset_versions]
    ...
    async def restore_dataset_version(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.restore_dataset_version]
    ...
    async def list_data_items(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_data_items]
    ...
    async def search_data_items(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.search_data_items]
    ...
    async def delete_saved_query(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_saved_query():
                ...
                # Make the request
                operation = await client.delete_saved_query(request=request)
