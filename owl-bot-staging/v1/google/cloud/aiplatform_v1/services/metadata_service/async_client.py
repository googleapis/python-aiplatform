...
class MetadataServiceAsyncClient:
    ...
    async def create_metadata_store(self,
            request: Optional[Union[metadata_service.CreateMetadataStoreRequest, dict]] = None,
            *,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_metadata_store]
    ...
    async def get_metadata_store(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_metadata_store]
    ...
    async def list_metadata_stores(self,
            request: Optional[Union[metadata_service.ListMetadataStoresRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_metadata_stores]
    ...
    async def delete_metadata_store(self,
            request: Optional[Union[metadata_service.DeleteMetadataStoreRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_metadata_store():
                ...
                # Make the request
                operation = await client.delete_metadata_store(request=request)
    ...
    async def update_artifact(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_artifact]
    ...
    async def delete_artifact(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_artifact():
                ...
                # Make the request
                operation = await client.delete_artifact(request=request)
    ...
    async def purge_artifacts(self,
        ...
        .. code-block:: python
            ...
            async def sample_purge_artifacts():
                ...
                # Make the request
                operation = await client.purge_artifacts(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.purge_artifacts]
    ...
    async def delete_context(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_context():
                ...
                # Make the request
                operation = await client.delete_context(request=request)
    ...
    async def purge_contexts(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.purge_contexts]
    ...
    async def add_context_artifacts_and_executions(self,
            request: Optional[Union[metadata_service.AddContextArtifactsAndExecutionsRequest, dict]] = None,
            *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.add_context_artifacts_and_executions]
    ...
    async def add_context_children(self,
            request: Optional[Union[metadata_service.AddContextChildrenRequest, dict]] = None,
            *,
            context: Optional[str] = None,
    ...
    async def remove_context_children(self,
            request: Optional[Union[metadata_service.RemoveContextChildrenRequest, dict]] = None,
            *,
            context: Optional[str] = None,
            child_contexts: Optional[MutableSequence[str]] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.remove_context_children]
    ...
    async def query_context_lineage_subgraph(self,
            request: Optional[Union[metadata_service.QueryContextLineageSubgraphRequest, dict]] = None,
            *,
            context: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.query_context_lineage_subgraph]
    ...
    async def update_execution(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_execution]
    ...
    async def purge_executions(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.purge_executions]
    ...
    async def add_execution_events(self,
            request: Optional[Union[metadata_service.AddExecutionEventsRequest, dict]] = None,
            *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.add_execution_events]
    ...
    async def query_execution_inputs_and_outputs(self,
            request: Optional[Union[metadata_service.QueryExecutionInputsAndOutputsRequest, dict]] = None,
            *,
            execution: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.query_execution_inputs_and_outputs]
    ...
    async def create_metadata_schema(self,
            request: Optional[Union[metadata_service.CreateMetadataSchemaRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_metadata_schema]
    ...
    async def get_metadata_schema(self,
            request: Optional[Union[metadata_service.GetMetadataSchemaRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    async def list_metadata_schemas(self,
            request: Optional[Union[metadata_service.ListMetadataSchemasRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_metadata_schemas]
    ...
    async def query_artifact_lineage_subgraph(self,
            request: Optional[Union[metadata_service.QueryArtifactLineageSubgraphRequest, dict]] = None,
            *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.query_artifact_lineage_subgraph]
