...
class MetadataServiceRestTransport(_BaseMetadataServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseMetadataServiceRestTransport._BaseGetIamPolicy, MetadataServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MetadataServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseMetadataServiceRestTransport._BaseTestIamPermissions, MetadataServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = MetadataServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
