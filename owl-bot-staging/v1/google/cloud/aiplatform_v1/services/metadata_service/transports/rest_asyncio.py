...
class AsyncMetadataServiceRestTransport(_BaseMetadataServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseMetadataServiceRestTransport._BaseGetIamPolicy, AsyncMetadataServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncMetadataServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseMetadataServiceRestTransport._BaseTestIamPermissions, AsyncMetadataServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncMetadataServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
