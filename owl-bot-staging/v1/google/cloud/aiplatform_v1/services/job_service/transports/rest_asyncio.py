...
class AsyncJobServiceRestTransport(_BaseJobServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseJobServiceRestTransport._BaseGetIamPolicy, AsyncJobServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncJobServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseJobServiceRestTransport._BaseTestIamPermissions, AsyncJobServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncJobServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
