...
class JobServiceAsyncClient:
    ...
    parse_nas_trial_detail_path = staticmethod(JobServiceClient.parse_nas_trial_detail_path)
    ...
    parse_network_attachment_path = staticmethod(JobServiceClient.parse_network_attachment_path)
    ...
    parse_persistent_resource_path = staticmethod(JobServiceClient.parse_persistent_resource_path)
    ...
    async def create_custom_job(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_custom_job]
    ...
    async def get_custom_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_custom_job]
    ...
    async def list_custom_jobs(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_custom_jobs]
    ...
    async def delete_custom_job(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_custom_job():
                ...
                # Make the request
                operation = await client.delete_custom_job(request=request)
    ...
    async def cancel_custom_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.cancel_custom_job]
    ...
    async def create_data_labeling_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_data_labeling_job]
    ...
    async def get_data_labeling_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_data_labeling_job]
    ...
    async def list_data_labeling_jobs(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_data_labeling_jobs]
    ...
    async def delete_data_labeling_job(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_data_labeling_job():
                ...
                # Make the request
                operation = await client.delete_data_labeling_job(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_data_labeling_job]
    ...
    async def cancel_data_labeling_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.cancel_data_labeling_job]
    ...
    async def create_hyperparameter_tuning_job(self,
            request: Optional[Union[job_service.CreateHyperparameterTuningJobRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            hyperparameter_tuning_job: Optional[gca_hyperparameter_tuning_job.HyperparameterTuningJob] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_hyperparameter_tuning_job]
    ...
    async def get_hyperparameter_tuning_job(self,
            request: Optional[Union[job_service.GetHyperparameterTuningJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_hyperparameter_tuning_job]
    ...
    async def list_hyperparameter_tuning_jobs(self,
            request: Optional[Union[job_service.ListHyperparameterTuningJobsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    async def delete_hyperparameter_tuning_job(self,
            request: Optional[Union[job_service.DeleteHyperparameterTuningJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_hyperparameter_tuning_job():
                ...
                # Make the request
                operation = await client.delete_hyperparameter_tuning_job(request=request)
    ...
    async def cancel_hyperparameter_tuning_job(self,
            request: Optional[Union[job_service.CancelHyperparameterTuningJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.cancel_hyperparameter_tuning_job]
    ...
    async def create_nas_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_nas_job]
    ...
    async def get_nas_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_nas_job]
    ...
    async def list_nas_jobs(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_nas_jobs]
    ...
    async def delete_nas_job(self,
        ...
        .. code-block:: python
            ...
            async def sample_delete_nas_job():
                ...
                # Make the request
                operation = await client.delete_nas_job(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_nas_job]
    ...
    async def cancel_nas_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.cancel_nas_job]
    ...
    async def get_nas_trial_detail(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_nas_trial_detail]
    ...
    async def list_nas_trial_details(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_nas_trial_details]
    ...
    async def create_batch_prediction_job(self,
            request: Optional[Union[job_service.CreateBatchPredictionJobRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            batch_prediction_job: Optional[gca_batch_prediction_job.BatchPredictionJob] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ...
    async def get_batch_prediction_job(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_batch_prediction_job]
    ...
    async def list_batch_prediction_jobs(self,
            request: Optional[Union[job_service.ListBatchPredictionJobsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_batch_prediction_jobs]
    ...
    async def delete_batch_prediction_job(self,
            request: Optional[Union[job_service.DeleteBatchPredictionJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_batch_prediction_job():
                ...
                # Make the request
                operation = await client.delete_batch_prediction_job(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_batch_prediction_job]
    ...
    async def cancel_batch_prediction_job(self,
            request: Optional[Union[job_service.CancelBatchPredictionJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.cancel_batch_prediction_job]
    ...
    async def create_model_deployment_monitoring_job(self,
            request: Optional[Union[job_service.CreateModelDeploymentMonitoringJobRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            model_deployment_monitoring_job: Optional[gca_model_deployment_monitoring_job.ModelDeploymentMonitoringJob] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_model_deployment_monitoring_job]
    ...
    async def search_model_deployment_monitoring_stats_anomalies(self,
            request: Optional[Union[job_service.SearchModelDeploymentMonitoringStatsAnomaliesRequest, dict]] = None,
            *,
    ...
    async def get_model_deployment_monitoring_job(self,
            request: Optional[Union[job_service.GetModelDeploymentMonitoringJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_model_deployment_monitoring_job]
    ...
    async def list_model_deployment_monitoring_jobs(self,
            request: Optional[Union[job_service.ListModelDeploymentMonitoringJobsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_model_deployment_monitoring_jobs]
    ...
    async def update_model_deployment_monitoring_job(self,
            request: Optional[Union[job_service.UpdateModelDeploymentMonitoringJobRequest, dict]] = None,
            *,
            model_deployment_monitoring_job: Optional[gca_model_deployment_monitoring_job.ModelDeploymentMonitoringJob] = None,
        ...
        .. code-block:: python
            ...
            async def sample_update_model_deployment_monitoring_job():
                ...
                # Make the request
                operation = await client.update_model_deployment_monitoring_job(request=request)
    ...
    async def delete_model_deployment_monitoring_job(self,
            request: Optional[Union[job_service.DeleteModelDeploymentMonitoringJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_model_deployment_monitoring_job():
                ...
                # Make the request
                operation = await client.delete_model_deployment_monitoring_job(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_model_deployment_monitoring_job]
    ...
    async def pause_model_deployment_monitoring_job(self,
            request: Optional[Union[job_service.PauseModelDeploymentMonitoringJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.pause_model_deployment_monitoring_job]
    ...
    async def resume_model_deployment_monitoring_job(self,
            request: Optional[Union[job_service.ResumeModelDeploymentMonitoringJobRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.resume_model_deployment_monitoring_job]
