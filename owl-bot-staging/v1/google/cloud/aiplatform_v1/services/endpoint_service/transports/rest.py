...
class EndpointServiceRestTransport(_BaseEndpointServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseEndpointServiceRestTransport._BaseGetIamPolicy, EndpointServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EndpointServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseEndpointServiceRestTransport._BaseTestIamPermissions, EndpointServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = EndpointServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
