...
class ModelGardenServiceRestTransport(_BaseModelGardenServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseModelGardenServiceRestTransport._BaseGetIamPolicy, ModelGardenServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ModelGardenServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseModelGardenServiceRestTransport._BaseTestIamPermissions, ModelGardenServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = ModelGardenServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
