...
class _BaseModelGardenServiceRestTransport(ModelGardenServiceTransport):
    ...
    class _BaseDeploy:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseModelGardenServiceRestTransport._BaseDeploy._get_unset_required_fields(query_params))
    ...
    class _BaseGetPublisherModel:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseModelGardenServiceRestTransport._BaseGetPublisherModel._get_unset_required_fields(query_params))
