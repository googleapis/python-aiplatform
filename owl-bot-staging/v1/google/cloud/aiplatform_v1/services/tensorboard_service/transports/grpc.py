...
class TensorboardServiceGrpcTransport(TensorboardServiceTransport):
    ...
    def create_tensorboard_experiment(self) -> Callable[
        ...
        if 'create_tensorboard_experiment' not in self._stubs:
            self._stubs['create_tensorboard_experiment'] = self._logged_channel.unary_unary(
    ...
    def get_tensorboard_experiment(self) -> Callable[
        ...
        if 'get_tensorboard_experiment' not in self._stubs:
            self._stubs['get_tensorboard_experiment'] = self._logged_channel.unary_unary(
    ...
    def update_tensorboard_experiment(self) -> Callable[
        ...
        if 'update_tensorboard_experiment' not in self._stubs:
            self._stubs['update_tensorboard_experiment'] = self._logged_channel.unary_unary(
    ...
    def list_tensorboard_experiments(self) -> Callable[
        ...
        if 'list_tensorboard_experiments' not in self._stubs:
            self._stubs['list_tensorboard_experiments'] = self._logged_channel.unary_unary(
    ...
    def delete_tensorboard_experiment(self) -> Callable[
        ...
        if 'delete_tensorboard_experiment' not in self._stubs:
            self._stubs['delete_tensorboard_experiment'] = self._logged_channel.unary_unary(
    ...
    def batch_create_tensorboard_runs(self) -> Callable[
        ...
        if 'batch_create_tensorboard_runs' not in self._stubs:
            self._stubs['batch_create_tensorboard_runs'] = self._logged_channel.unary_unary(
    ...
    def batch_create_tensorboard_time_series(self) -> Callable[
        ...
        if 'batch_create_tensorboard_time_series' not in self._stubs:
            self._stubs['batch_create_tensorboard_time_series'] = self._logged_channel.unary_unary(
    ...
    def create_tensorboard_time_series(self) -> Callable[
        ...
        if 'create_tensorboard_time_series' not in self._stubs:
            self._stubs['create_tensorboard_time_series'] = self._logged_channel.unary_unary(
    ...
    def get_tensorboard_time_series(self) -> Callable[
        ...
        if 'get_tensorboard_time_series' not in self._stubs:
            self._stubs['get_tensorboard_time_series'] = self._logged_channel.unary_unary(
    ...
    def update_tensorboard_time_series(self) -> Callable[
        ...
        if 'update_tensorboard_time_series' not in self._stubs:
            self._stubs['update_tensorboard_time_series'] = self._logged_channel.unary_unary(
    ...
    def list_tensorboard_time_series(self) -> Callable[
        ...
        if 'list_tensorboard_time_series' not in self._stubs:
            self._stubs['list_tensorboard_time_series'] = self._logged_channel.unary_unary(
    ...
    def delete_tensorboard_time_series(self) -> Callable[
        ...
        if 'delete_tensorboard_time_series' not in self._stubs:
            self._stubs['delete_tensorboard_time_series'] = self._logged_channel.unary_unary(
    ...
    def batch_read_tensorboard_time_series_data(self) -> Callable[
        ...
        if 'batch_read_tensorboard_time_series_data' not in self._stubs:
            self._stubs['batch_read_tensorboard_time_series_data'] = self._logged_channel.unary_unary(
    ...
    def read_tensorboard_time_series_data(self) -> Callable[
        ...
        if 'read_tensorboard_time_series_data' not in self._stubs:
            self._stubs['read_tensorboard_time_series_data'] = self._logged_channel.unary_unary(
    ...
    def read_tensorboard_blob_data(self) -> Callable[
        ...
        if 'read_tensorboard_blob_data' not in self._stubs:
            self._stubs['read_tensorboard_blob_data'] = self._logged_channel.unary_stream(
    ...
    def write_tensorboard_experiment_data(self) -> Callable[
        ...
        if 'write_tensorboard_experiment_data' not in self._stubs:
            self._stubs['write_tensorboard_experiment_data'] = self._logged_channel.unary_unary(
    ...
    def write_tensorboard_run_data(self) -> Callable[
        ...
        if 'write_tensorboard_run_data' not in self._stubs:
            self._stubs['write_tensorboard_run_data'] = self._logged_channel.unary_unary(
    ...
    def export_tensorboard_time_series_data(self) -> Callable[
        ...
        if 'export_tensorboard_time_series_data' not in self._stubs:
            self._stubs['export_tensorboard_time_series_data'] = self._logged_channel.unary_unary(
