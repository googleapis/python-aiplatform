...
class AsyncPredictionServiceRestTransport(_BasePredictionServiceRestTransport):
    ...
    class _GetIamPolicy(_BasePredictionServiceRestTransport._BaseGetIamPolicy, AsyncPredictionServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncPredictionServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BasePredictionServiceRestTransport._BaseTestIamPermissions, AsyncPredictionServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncPredictionServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
