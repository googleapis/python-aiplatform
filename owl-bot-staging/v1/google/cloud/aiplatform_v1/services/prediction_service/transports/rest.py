...
class PredictionServiceRestTransport(_BasePredictionServiceRestTransport):
    ...
    class _GetIamPolicy(_BasePredictionServiceRestTransport._BaseGetIamPolicy, PredictionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PredictionServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BasePredictionServiceRestTransport._BaseTestIamPermissions, PredictionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = PredictionServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
