...
class DeploymentResourcePoolServiceClient(metaclass=DeploymentResourcePoolServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[client_options_lib.ClientOptions] = None):
        ...
        use_client_cert = DeploymentResourcePoolServiceClient._use_client_cert_effective()
    ...
    def create_deployment_resource_pool(self,
        ...
        flattened_params = [parent, deployment_resource_pool, deployment_resource_pool_id]
