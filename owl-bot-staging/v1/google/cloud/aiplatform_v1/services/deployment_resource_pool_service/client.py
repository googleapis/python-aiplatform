...
from google.cloud.aiplatform_v1._compat import get_universe_domain, get_api_endpoint, get_default_mtls_endpoint, should_use_client_cert, read_environment_variables
...
class DeploymentResourcePoolServiceClient(metaclass=DeploymentResourcePoolServiceClientMeta):
    ...
    def __init__(self, *,
        ...
        self._universe_domain = get_universe_domain(universe_domain_opt, self._universe_domain_env, default_universe=DeploymentResourcePoolServiceClient._DEFAULT_UNIVERSE)
        ...
        self._api_endpoint = (self._api_endpoint or
            get_api_endpoint(
                ...
                default_endpoint_template=DeploymentResourcePoolServiceClient._DEFAULT_ENDPOINT_TEMPLATE,
