...
class DeploymentResourcePoolServiceClientMeta(type):
    ...
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[DeploymentResourcePoolServiceTransport]]
    ...
    if HAS_ASYNC_REST_DEPENDENCIES:  # pragma: NO COVER
        _transport_registry["rest_asyncio"] = AsyncDeploymentResourcePoolServiceRestTransport
...
class DeploymentResourcePoolServiceClient(metaclass=DeploymentResourcePoolServiceClientMeta):
    ...
    @staticmethod
    def deployment_resource_pool_path(project: str,location: str,deployment_resource_pool: str,) -> str:
        """Returns a fully-qualified deployment_resource_pool string."""
        return "projects/{project}/locations/{location}/deploymentResourcePools/{deployment_resource_pool}".format(project=project, location=location, deployment_resource_pool=deployment_resource_pool, )
    ...
    def parse_deployment_resource_pool_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/deploymentResourcePools/(?P<deployment_resource_pool>.+?)$", path)
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = DeploymentResourcePoolServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            DeploymentResourcePoolServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DeploymentResourcePoolServiceTransport, Callable[..., DeploymentResourcePoolServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DeploymentResourcePoolServiceClient._read_environment_variables()
        self._client_cert_source = DeploymentResourcePoolServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = DeploymentResourcePoolServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        transport_provided = isinstance(transport, DeploymentResourcePoolServiceTransport)
        ...
        if not transport_provided:
            transport_init: Union[Type[DeploymentResourcePoolServiceTransport], Callable[..., DeploymentResourcePoolServiceTransport]] = (
                DeploymentResourcePoolServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., DeploymentResourcePoolServiceTransport], transport)
            )
    ...
    def create_deployment_resource_pool(self,
            request: Optional[Union[deployment_resource_pool_service.CreateDeploymentResourcePoolRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            deployment_resource_pool: Optional[gca_deployment_resource_pool.DeploymentResourcePool] = None,
        ...
        has_flattened_params = any([parent, deployment_resource_pool, deployment_resource_pool_id])
        ...
        if not isinstance(request, deployment_resource_pool_service.CreateDeploymentResourcePoolRequest):
            request = deployment_resource_pool_service.CreateDeploymentResourcePoolRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_deployment_resource_pool]
    ...
    def get_deployment_resource_pool(self,
            request: Optional[Union[deployment_resource_pool_service.GetDeploymentResourcePoolRequest, dict]] = None,
            *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, deployment_resource_pool_service.GetDeploymentResourcePoolRequest):
            request = deployment_resource_pool_service.GetDeploymentResourcePoolRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_deployment_resource_pool]
    ...
    def list_deployment_resource_pools(self,
            request: Optional[Union[deployment_resource_pool_service.ListDeploymentResourcePoolsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, deployment_resource_pool_service.ListDeploymentResourcePoolsRequest):
            request = deployment_resource_pool_service.ListDeploymentResourcePoolsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_deployment_resource_pools]
    ...
    def update_deployment_resource_pool(self,
            request: Optional[Union[deployment_resource_pool_service.UpdateDeploymentResourcePoolRequest, dict]] = None,
            *,
            deployment_resource_pool: Optional[gca_deployment_resource_pool.DeploymentResourcePool] = None,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, deployment_resource_pool_service.UpdateDeploymentResourcePoolRequest):
            request = deployment_resource_pool_service.UpdateDeploymentResourcePoolRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if deployment_resource_pool is not None:
                request.deployment_resource_pool = deployment_resource_pool
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_deployment_resource_pool]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("deployment_resource_pool.name", request.deployment_resource_pool.name),
            )),
        )
    ...
    def delete_deployment_resource_pool(self,
            request: Optional[Union[deployment_resource_pool_service.DeleteDeploymentResourcePoolRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, deployment_resource_pool_service.DeleteDeploymentResourcePoolRequest):
            request = deployment_resource_pool_service.DeleteDeploymentResourcePoolRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_deployment_resource_pool]
    ...
    def query_deployed_models(self,
            request: Optional[Union[deployment_resource_pool_service.QueryDeployedModelsRequest, dict]] = None,
            *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, deployment_resource_pool_service.QueryDeployedModelsRequest):
