...
class ListDeploymentResourcePoolsPager:
    ...
    """
    def __init__(self,
            method: Callable[..., deployment_resource_pool_service.ListDeploymentResourcePoolsResponse],
        ...
        """
        self._method = method
        self._request = deployment_resource_pool_service.ListDeploymentResourcePoolsRequest(request)
    ...
    @property
    def pages(self) -> Iterator[deployment_resource_pool_service.ListDeploymentResourcePoolsResponse]:
...
class ListDeploymentResourcePoolsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[deployment_resource_pool_service.ListDeploymentResourcePoolsResponse]],
            request: deployment_resource_pool_service.ListDeploymentResourcePoolsRequest,
            response: deployment_resource_pool_service.ListDeploymentResourcePoolsResponse,
            *,
    ...
    @property
    async def pages(self) -> AsyncIterator[deployment_resource_pool_service.ListDeploymentResourcePoolsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
            yield self._response
    def __aiter__(self) -> AsyncIterator[deployment_resource_pool.DeploymentResourcePool]:
...
class QueryDeployedModelsPager:
    ...
    """
    def __init__(self,
            method: Callable[..., deployment_resource_pool_service.QueryDeployedModelsResponse],
        ...
        """
        self._method = method
        self._request = deployment_resource_pool_service.QueryDeployedModelsRequest(request)
        self._response = response
        self._retry = retry
        self._timeout = timeout
        self._metadata = metadata
    ...
    @property
    def pages(self) -> Iterator[deployment_resource_pool_service.QueryDeployedModelsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class QueryDeployedModelsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[deployment_resource_pool_service.QueryDeployedModelsResponse]],
            request: deployment_resource_pool_service.QueryDeployedModelsRequest,
            response: deployment_resource_pool_service.QueryDeployedModelsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[deployment_resource_pool_service.QueryDeployedModelsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
