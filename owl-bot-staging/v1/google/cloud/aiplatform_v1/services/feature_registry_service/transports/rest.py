...
class FeatureRegistryServiceRestTransport(_BaseFeatureRegistryServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseFeatureRegistryServiceRestTransport._BaseGetIamPolicy, FeatureRegistryServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeatureRegistryServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseFeatureRegistryServiceRestTransport._BaseTestIamPermissions, FeatureRegistryServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeatureRegistryServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
