...
class AsyncFeatureRegistryServiceRestTransport(_BaseFeatureRegistryServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseFeatureRegistryServiceRestTransport._BaseGetIamPolicy, AsyncFeatureRegistryServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncFeatureRegistryServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseFeatureRegistryServiceRestTransport._BaseTestIamPermissions, AsyncFeatureRegistryServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncFeatureRegistryServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
