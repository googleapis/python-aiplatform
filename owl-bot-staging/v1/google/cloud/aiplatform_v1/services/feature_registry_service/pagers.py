...
class ListFeatureGroupsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[feature_registry_service.ListFeatureGroupsResponse]],
            request: feature_registry_service.ListFeatureGroupsRequest,
            response: feature_registry_service.ListFeatureGroupsResponse,
            *,
    ...
    @property
    async def pages(self) -> AsyncIterator[feature_registry_service.ListFeatureGroupsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
