...
class FeatureRegistryServiceAsyncClient:
    ...
    parse_feature_group_path = staticmethod(FeatureRegistryServiceClient.parse_feature_group_path)
    common_billing_account_path = staticmethod(FeatureRegistryServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(FeatureRegistryServiceClient.parse_common_billing_account_path)
    common_folder_path = staticmethod(FeatureRegistryServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(FeatureRegistryServiceClient.parse_common_folder_path)
    common_organization_path = staticmethod(FeatureRegistryServiceClient.common_organization_path)
    parse_common_organization_path = staticmethod(FeatureRegistryServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(FeatureRegistryServiceClient.common_project_path)
    parse_common_project_path = staticmethod(FeatureRegistryServiceClient.parse_common_project_path)
    common_location_path = staticmethod(FeatureRegistryServiceClient.common_location_path)
    parse_common_location_path = staticmethod(FeatureRegistryServiceClient.parse_common_location_path)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        return sa_file_func(FeatureRegistryServiceAsyncClient, filename, *args, **kwargs)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, FeatureRegistryServiceTransport, Callable[..., FeatureRegistryServiceTransport]]] = "grpc_asyncio",
    ...
    async def create_feature_group(self,
            request: Optional[Union[feature_registry_service.CreateFeatureGroupRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            async def sample_create_feature_group():
                ...
                # Make the request
                operation = await client.create_feature_group(request=request)
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_feature_group]
    ...
    async def get_feature_group(self,
            request: Optional[Union[feature_registry_service.GetFeatureGroupRequest, dict]] = None,
            *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_feature_group]
    ...
    async def list_feature_groups(self,
            request: Optional[Union[feature_registry_service.ListFeatureGroupsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_feature_groups]
    ...
    async def update_feature_group(self,
            request: Optional[Union[feature_registry_service.UpdateFeatureGroupRequest, dict]] = None,
            *,
            feature_group: Optional[gca_feature_group.FeatureGroup] = None,
        ...
        .. code-block:: python
            ...
            async def sample_update_feature_group():
                ...
                # Make the request
                operation = await client.update_feature_group(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_feature_group]
    ...
    async def delete_feature_group(self,
            request: Optional[Union[feature_registry_service.DeleteFeatureGroupRequest, dict]] = None,
            *,
            name: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            async def sample_delete_feature_group():
                ...
                # Make the request
                operation = await client.delete_feature_group(request=request)
    ...
    async def create_feature(self,
            request: Optional[Union[featurestore_service.CreateFeatureRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_feature]
    ...
    async def batch_create_features(self,
            request: Optional[Union[featurestore_service.BatchCreateFeaturesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            requests: Optional[MutableSequence[featurestore_service.CreateFeatureRequest]] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> operation_async.AsyncOperation:
        ...
        .. code-block:: python
            ...
            async def sample_batch_create_features():
                ...
                # Make the request
                operation = await client.batch_create_features(request=request)
    ...
    async def get_feature(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_feature]
    ...
    async def list_features(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_features]
    ...
    async def update_feature(self,
            request: Optional[Union[featurestore_service.UpdateFeatureRequest, dict]] = None,
            *,
            feature: Optional[gca_feature.Feature] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_feature]
    ...
    async def delete_feature(self,
            request: Optional[Union[featurestore_service.DeleteFeatureRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_feature]
