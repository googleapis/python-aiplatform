...
class SpecialistPoolServiceAsyncClient:
    ...
    async def create_specialist_pool(self,
            request: Optional[Union[specialist_pool_service.CreateSpecialistPoolRequest, dict]] = None,
            *,
        ...
        .. code-block:: python
            ...
            async def sample_create_specialist_pool():
                ...
                # Make the request
                operation = await client.create_specialist_pool(request=request)
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_specialist_pool]
    ...
    async def get_specialist_pool(self,
            request: Optional[Union[specialist_pool_service.GetSpecialistPoolRequest, dict]] = None,
            *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_specialist_pool]
    ...
    async def list_specialist_pools(self,
            request: Optional[Union[specialist_pool_service.ListSpecialistPoolsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_specialist_pools]
    ...
    async def delete_specialist_pool(self,
            request: Optional[Union[specialist_pool_service.DeleteSpecialistPoolRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            async def sample_delete_specialist_pool():
                ...
                # Make the request
                operation = await client.delete_specialist_pool(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_specialist_pool]
    ...
    async def update_specialist_pool(self,
            request: Optional[Union[specialist_pool_service.UpdateSpecialistPoolRequest, dict]] = None,
            *,
            specialist_pool: Optional[gca_specialist_pool.SpecialistPool] = None,
        ...
        .. code-block:: python
            ...
            async def sample_update_specialist_pool():
                ...
                # Make the request
                operation = await client.update_specialist_pool(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_specialist_pool]
