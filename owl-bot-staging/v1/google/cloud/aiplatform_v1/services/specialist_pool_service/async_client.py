...
class SpecialistPoolServiceAsyncClient:
    ...
    async def create_specialist_pool(self,
            request: Union[specialist_pool_service.CreateSpecialistPoolRequest, dict] = None,
            *,
            parent: str = None,
    ...
    async def delete_specialist_pool(self,
            request: Union[specialist_pool_service.DeleteSpecialistPoolRequest, dict] = None,
            *,
            name: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
    ...
    async def update_specialist_pool(self,
            request: Union[specialist_pool_service.UpdateSpecialistPoolRequest, dict] = None,
            *,
            specialist_pool: gca_specialist_pool.SpecialistPool = None,
