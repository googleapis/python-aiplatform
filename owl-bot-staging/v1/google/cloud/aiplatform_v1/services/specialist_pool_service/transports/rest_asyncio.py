...
class AsyncSpecialistPoolServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    async def pre_create_specialist_pool(self, request: specialist_pool_service.CreateSpecialistPoolRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[specialist_pool_service.CreateSpecialistPoolRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_create_specialist_pool(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    async def post_create_specialist_pool_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_specialist_pool
    ...
    async def pre_delete_specialist_pool(self, request: specialist_pool_service.DeleteSpecialistPoolRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[specialist_pool_service.DeleteSpecialistPoolRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_delete_specialist_pool(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    async def post_delete_specialist_pool_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_specialist_pool
    ...
    async def pre_get_specialist_pool(self, request: specialist_pool_service.GetSpecialistPoolRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[specialist_pool_service.GetSpecialistPoolRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_get_specialist_pool(self, response: specialist_pool.SpecialistPool) -> specialist_pool.SpecialistPool:
    ...
    async def post_get_specialist_pool_with_metadata(self, response: specialist_pool.SpecialistPool, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[specialist_pool.SpecialistPool, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_specialist_pool
    ...
    async def pre_list_specialist_pools(self, request: specialist_pool_service.ListSpecialistPoolsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[specialist_pool_service.ListSpecialistPoolsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_list_specialist_pools(self, response: specialist_pool_service.ListSpecialistPoolsResponse) -> specialist_pool_service.ListSpecialistPoolsResponse:
    ...
    async def post_list_specialist_pools_with_metadata(self, response: specialist_pool_service.ListSpecialistPoolsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[specialist_pool_service.ListSpecialistPoolsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_specialist_pools
    ...
    async def pre_update_specialist_pool(self, request: specialist_pool_service.UpdateSpecialistPoolRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[specialist_pool_service.UpdateSpecialistPoolRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_update_specialist_pool(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    async def post_update_specialist_pool_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_specialist_pool
...
class AsyncSpecialistPoolServiceRestTransport(_BaseSpecialistPoolServiceRestTransport):
    ...
    def __init__(self,
        ...
        Args:
            ...
            interceptor (Optional[AsyncSpecialistPoolServiceRestInterceptor]): Interceptor used
    ...
    class _CreateSpecialistPool(_BaseSpecialistPoolServiceRestTransport._BaseCreateSpecialistPool, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseCreateSpecialistPool._get_http_options()

            request, metadata = await self._interceptor.pre_create_specialist_pool(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseCreateSpecialistPool._get_transcoded_request(http_options, request)

            body = _BaseSpecialistPoolServiceRestTransport._BaseCreateSpecialistPool._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseCreateSpecialistPool._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._CreateSpecialistPool._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp, _ = await self._interceptor.post_create_specialist_pool_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _DeleteSpecialistPool(_BaseSpecialistPoolServiceRestTransport._BaseDeleteSpecialistPool, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseDeleteSpecialistPool._get_http_options()

            request, metadata = await self._interceptor.pre_delete_specialist_pool(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseDeleteSpecialistPool._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseDeleteSpecialistPool._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._DeleteSpecialistPool._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_delete_specialist_pool_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
    ...
    class _GetSpecialistPool(_BaseSpecialistPoolServiceRestTransport._BaseGetSpecialistPool, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseGetSpecialistPool._get_http_options()

            request, metadata = await self._interceptor.pre_get_specialist_pool(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseGetSpecialistPool._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseGetSpecialistPool._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._GetSpecialistPool._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_get_specialist_pool_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _ListSpecialistPools(_BaseSpecialistPoolServiceRestTransport._BaseListSpecialistPools, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseListSpecialistPools._get_http_options()

            request, metadata = await self._interceptor.pre_list_specialist_pools(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseListSpecialistPools._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseListSpecialistPools._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._ListSpecialistPools._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_list_specialist_pools_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = specialist_pool_service.ListSpecialistPoolsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
    ...
    class _UpdateSpecialistPool(_BaseSpecialistPoolServiceRestTransport._BaseUpdateSpecialistPool, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseUpdateSpecialistPool._get_http_options()

            request, metadata = await self._interceptor.pre_update_specialist_pool(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseUpdateSpecialistPool._get_transcoded_request(http_options, request)

            body = _BaseSpecialistPoolServiceRestTransport._BaseUpdateSpecialistPool._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseUpdateSpecialistPool._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._UpdateSpecialistPool._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_update_specialist_pool_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
    ...
    class _GetLocation(_BaseSpecialistPoolServiceRestTransport._BaseGetLocation, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseGetLocation._get_http_options()

            request, metadata = await self._interceptor.pre_get_location(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseGetLocation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseGetLocation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseSpecialistPoolServiceRestTransport._BaseListLocations, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseListLocations._get_http_options()

            request, metadata = await self._interceptor.pre_list_locations(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseListLocations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseListLocations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetIamPolicy(_BaseSpecialistPoolServiceRestTransport._BaseGetIamPolicy, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseGetIamPolicy._get_http_options()

            request, metadata = await self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseGetIamPolicy._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseGetIamPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetIamPolicy(_BaseSpecialistPoolServiceRestTransport._BaseSetIamPolicy, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseSetIamPolicy._get_http_options()

            request, metadata = await self._interceptor.pre_set_iam_policy(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseSetIamPolicy._get_transcoded_request(http_options, request)

            body = _BaseSpecialistPoolServiceRestTransport._BaseSetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseSetIamPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseSpecialistPoolServiceRestTransport._BaseTestIamPermissions, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = await self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _CancelOperation(_BaseSpecialistPoolServiceRestTransport._BaseCancelOperation, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseCancelOperation._get_http_options()

            request, metadata = await self._interceptor.pre_cancel_operation(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseCancelOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseCancelOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseSpecialistPoolServiceRestTransport._BaseDeleteOperation, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseDeleteOperation._get_http_options()

            request, metadata = await self._interceptor.pre_delete_operation(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseDeleteOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseDeleteOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseSpecialistPoolServiceRestTransport._BaseGetOperation, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseGetOperation._get_http_options()

            request, metadata = await self._interceptor.pre_get_operation(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseGetOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseGetOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseSpecialistPoolServiceRestTransport._BaseListOperations, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseListOperations._get_http_options()

            request, metadata = await self._interceptor.pre_list_operations(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseListOperations._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseListOperations._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _WaitOperation(_BaseSpecialistPoolServiceRestTransport._BaseWaitOperation, AsyncSpecialistPoolServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSpecialistPoolServiceRestTransport._BaseWaitOperation._get_http_options()

            request, metadata = await self._interceptor.pre_wait_operation(request, metadata)
            transcoded_request = _BaseSpecialistPoolServiceRestTransport._BaseWaitOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSpecialistPoolServiceRestTransport._BaseWaitOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSpecialistPoolServiceRestTransport._WaitOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
