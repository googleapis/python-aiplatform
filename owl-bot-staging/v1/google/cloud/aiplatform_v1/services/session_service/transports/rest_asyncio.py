...
class AsyncSessionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    async def pre_append_event(self, request: session_service.AppendEventRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[session_service.AppendEventRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_append_event(self, response: session_service.AppendEventResponse) -> session_service.AppendEventResponse:
    ...
    async def post_append_event_with_metadata(self, response: session_service.AppendEventResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[session_service.AppendEventResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for append_event
    ...
    async def pre_create_session(self, request: session_service.CreateSessionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[session_service.CreateSessionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_create_session(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    async def post_create_session_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_session
    ...
    async def pre_delete_session(self, request: session_service.DeleteSessionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[session_service.DeleteSessionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_delete_session(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
    ...
    async def post_delete_session_with_metadata(self, response: operations_pb2.Operation, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_session
    ...
    async def pre_get_session(self, request: session_service.GetSessionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[session_service.GetSessionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_get_session_with_metadata(self, response: session.Session, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[session.Session, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_session
    ...
    async def pre_list_events(self, request: session_service.ListEventsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[session_service.ListEventsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_list_events(self, response: session_service.ListEventsResponse) -> session_service.ListEventsResponse:
    ...
    async def post_list_events_with_metadata(self, response: session_service.ListEventsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[session_service.ListEventsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_events
    ...
    async def pre_list_sessions(self, request: session_service.ListSessionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[session_service.ListSessionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_list_sessions(self, response: session_service.ListSessionsResponse) -> session_service.ListSessionsResponse:
    ...
    async def post_list_sessions_with_metadata(self, response: session_service.ListSessionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[session_service.ListSessionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_sessions
    ...
    async def pre_update_session(self, request: session_service.UpdateSessionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[session_service.UpdateSessionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_update_session(self, response: gca_session.Session) -> gca_session.Session:
    ...
    async def post_update_session_with_metadata(self, response: gca_session.Session, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gca_session.Session, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_session
...
class AsyncSessionServiceRestTransport(_BaseSessionServiceRestTransport):
    ...
    def __init__(self,
        ...
        Args:
            ...
            interceptor (Optional[AsyncSessionServiceRestInterceptor]): Interceptor used
    ...
    class _AppendEvent(_BaseSessionServiceRestTransport._BaseAppendEvent, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSessionServiceRestTransport._BaseAppendEvent._get_http_options()

            request, metadata = await self._interceptor.pre_append_event(request, metadata)
            transcoded_request = _BaseSessionServiceRestTransport._BaseAppendEvent._get_transcoded_request(http_options, request)

            body = _BaseSessionServiceRestTransport._BaseAppendEvent._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSessionServiceRestTransport._BaseAppendEvent._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._AppendEvent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp, _ = await self._interceptor.post_append_event_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = session_service.AppendEventResponse.to_json(response)
                except:
    ...
    class _CreateSession(_BaseSessionServiceRestTransport._BaseCreateSession, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            request, metadata = await self._interceptor.pre_create_session(request, metadata)
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._CreateSession._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_create_session_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _DeleteSession(_BaseSessionServiceRestTransport._BaseDeleteSession, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            request, metadata = await self._interceptor.pre_delete_session(request, metadata)
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._DeleteSession._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_delete_session_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = json_format.MessageToJson(resp)
                except:
    ...
    class _GetSession(_BaseSessionServiceRestTransport._BaseGetSession, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            request, metadata = await self._interceptor.pre_get_session(request, metadata)
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._GetSession._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_get_session_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _ListEvents(_BaseSessionServiceRestTransport._BaseListEvents, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSessionServiceRestTransport._BaseListEvents._get_http_options()

            request, metadata = await self._interceptor.pre_list_events(request, metadata)
            transcoded_request = _BaseSessionServiceRestTransport._BaseListEvents._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSessionServiceRestTransport._BaseListEvents._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._ListEvents._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_list_events_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = session_service.ListEventsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
    ...
    class _ListSessions(_BaseSessionServiceRestTransport._BaseListSessions, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            request, metadata = await self._interceptor.pre_list_sessions(request, metadata)
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._ListSessions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_list_sessions_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = session_service.ListSessionsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
    ...
    class _UpdateSession(_BaseSessionServiceRestTransport._BaseUpdateSession, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            request, metadata = await self._interceptor.pre_update_session(request, metadata)
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._UpdateSession._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_update_session_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    @property
    def append_event(self) -> Callable[
    ...
    class _GetLocation(_BaseSessionServiceRestTransport._BaseGetLocation, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._GetLocation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListLocations(_BaseSessionServiceRestTransport._BaseListLocations, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetIamPolicy(_BaseSessionServiceRestTransport._BaseGetIamPolicy, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSessionServiceRestTransport._BaseGetIamPolicy._get_http_options()

            request, metadata = await self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BaseSessionServiceRestTransport._BaseGetIamPolicy._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSessionServiceRestTransport._BaseGetIamPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetIamPolicy(_BaseSessionServiceRestTransport._BaseSetIamPolicy, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSessionServiceRestTransport._BaseSetIamPolicy._get_http_options()

            request, metadata = await self._interceptor.pre_set_iam_policy(request, metadata)
            transcoded_request = _BaseSessionServiceRestTransport._BaseSetIamPolicy._get_transcoded_request(http_options, request)

            body = _BaseSessionServiceRestTransport._BaseSetIamPolicy._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseSessionServiceRestTransport._BaseSetIamPolicy._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseSessionServiceRestTransport._BaseTestIamPermissions, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSessionServiceRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = await self._interceptor.pre_test_iam_permissions(request, metadata)
            transcoded_request = _BaseSessionServiceRestTransport._BaseTestIamPermissions._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSessionServiceRestTransport._BaseTestIamPermissions._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _CancelOperation(_BaseSessionServiceRestTransport._BaseCancelOperation, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._CancelOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _DeleteOperation(_BaseSessionServiceRestTransport._BaseDeleteOperation, AsyncSessionServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._DeleteOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetOperation(_BaseSessionServiceRestTransport._BaseGetOperation, AsyncSessionServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseSessionServiceRestTransport._BaseListOperations, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _WaitOperation(_BaseSessionServiceRestTransport._BaseWaitOperation, AsyncSessionServiceRestStub):
        def __hash__(self):
        ...
        async def __call__(self,
            ...
            http_options = _BaseSessionServiceRestTransport._BaseWaitOperation._get_http_options()

            request, metadata = await self._interceptor.pre_wait_operation(request, metadata)
            transcoded_request = _BaseSessionServiceRestTransport._BaseWaitOperation._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseSessionServiceRestTransport._BaseWaitOperation._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = await AsyncSessionServiceRestTransport._WaitOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
