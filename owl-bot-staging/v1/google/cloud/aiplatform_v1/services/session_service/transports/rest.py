...
class SessionServiceRestTransport(_BaseSessionServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseSessionServiceRestTransport._BaseGetIamPolicy, SessionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SessionServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseSessionServiceRestTransport._BaseTestIamPermissions, SessionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = SessionServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
