...
class _BaseSessionServiceRestTransport(SessionServiceTransport):
    ...
    class _BaseAppendEvent:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSessionServiceRestTransport._BaseAppendEvent._get_unset_required_fields(query_params))
    ...
    class _BaseListEvents:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSessionServiceRestTransport._BaseListEvents._get_unset_required_fields(query_params))
