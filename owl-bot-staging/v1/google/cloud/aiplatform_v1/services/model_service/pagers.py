...
class ListModelVersionCheckpointsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[model_service.ListModelVersionCheckpointsResponse]],
            request: model_service.ListModelVersionCheckpointsRequest,
            response: model_service.ListModelVersionCheckpointsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[model_service.ListModelVersionCheckpointsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListModelEvaluationSlicesAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[model_service.ListModelEvaluationSlicesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
