...
class AsyncModelServiceRestTransport(_BaseModelServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseModelServiceRestTransport._BaseGetIamPolicy, AsyncModelServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncModelServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseModelServiceRestTransport._BaseTestIamPermissions, AsyncModelServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncModelServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
