...
class FeaturestoreServiceClient(metaclass=FeaturestoreServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = FeaturestoreServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            FeaturestoreServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, FeaturestoreServiceTransport, Callable[..., FeaturestoreServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = FeaturestoreServiceClient._read_environment_variables()
        self._client_cert_source = FeaturestoreServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = FeaturestoreServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[FeaturestoreServiceTransport], Callable[..., FeaturestoreServiceTransport]] = (
    ...
    def create_featurestore(self,
            request: Optional[Union[featurestore_service.CreateFeaturestoreRequest, dict]] = None,
            *,
    ...
    def get_featurestore(self,
            request: Optional[Union[featurestore_service.GetFeaturestoreRequest, dict]] = None,
            *,
    ...
    def list_featurestores(self,
            request: Optional[Union[featurestore_service.ListFeaturestoresRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def update_featurestore(self,
            request: Optional[Union[featurestore_service.UpdateFeaturestoreRequest, dict]] = None,
            *,
            featurestore: Optional[gca_featurestore.Featurestore] = None,
    ...
    def delete_featurestore(self,
            request: Optional[Union[featurestore_service.DeleteFeaturestoreRequest, dict]] = None,
            *,
            name: Optional[str] = None,
    ...
    def create_entity_type(self,
            request: Optional[Union[featurestore_service.CreateEntityTypeRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def get_entity_type(self,
            request: Optional[Union[featurestore_service.GetEntityTypeRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_entity_types(self,
            request: Optional[Union[featurestore_service.ListEntityTypesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def update_entity_type(self,
            request: Optional[Union[featurestore_service.UpdateEntityTypeRequest, dict]] = None,
            *,
            entity_type: Optional[gca_entity_type.EntityType] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def delete_entity_type(self,
            request: Optional[Union[featurestore_service.DeleteEntityTypeRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            force: Optional[bool] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def import_feature_values(self,
            request: Optional[Union[featurestore_service.ImportFeatureValuesRequest, dict]] = None,
            *,
    ...
    def batch_read_feature_values(self,
            request: Optional[Union[featurestore_service.BatchReadFeatureValuesRequest, dict]] = None,
            *,
    ...
    def export_feature_values(self,
            request: Optional[Union[featurestore_service.ExportFeatureValuesRequest, dict]] = None,
            *,
            entity_type: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def delete_feature_values(self,
            request: Optional[Union[featurestore_service.DeleteFeatureValuesRequest, dict]] = None,
            *,
            entity_type: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def search_features(self,
            request: Optional[Union[featurestore_service.SearchFeaturesRequest, dict]] = None,
            *,
