...
class FeaturestoreServiceRestTransport(_BaseFeaturestoreServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseFeaturestoreServiceRestTransport._BaseGetIamPolicy, FeaturestoreServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeaturestoreServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseFeaturestoreServiceRestTransport._BaseTestIamPermissions, FeaturestoreServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FeaturestoreServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
