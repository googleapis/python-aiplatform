...
class AsyncFeaturestoreServiceRestTransport(_BaseFeaturestoreServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseFeaturestoreServiceRestTransport._BaseGetIamPolicy, AsyncFeaturestoreServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncFeaturestoreServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseFeaturestoreServiceRestTransport._BaseTestIamPermissions, AsyncFeaturestoreServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncFeaturestoreServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
