...
class IndexEndpointServiceClient(metaclass=IndexEndpointServiceClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = IndexEndpointServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            IndexEndpointServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, IndexEndpointServiceTransport, Callable[..., IndexEndpointServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = IndexEndpointServiceClient._read_environment_variables()
        self._client_cert_source = IndexEndpointServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = IndexEndpointServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[IndexEndpointServiceTransport], Callable[..., IndexEndpointServiceTransport]] = (
    ...
    def create_index_endpoint(self,
            request: Optional[Union[index_endpoint_service.CreateIndexEndpointRequest, dict]] = None,
            *,
    ...
    def get_index_endpoint(self,
            request: Optional[Union[index_endpoint_service.GetIndexEndpointRequest, dict]] = None,
            *,
    ...
    def list_index_endpoints(self,
            request: Optional[Union[index_endpoint_service.ListIndexEndpointsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def update_index_endpoint(self,
            request: Optional[Union[index_endpoint_service.UpdateIndexEndpointRequest, dict]] = None,
            *,
            index_endpoint: Optional[gca_index_endpoint.IndexEndpoint] = None,
    ...
    def delete_index_endpoint(self,
            request: Optional[Union[index_endpoint_service.DeleteIndexEndpointRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def deploy_index(self,
            request: Optional[Union[index_endpoint_service.DeployIndexRequest, dict]] = None,
            *,
    ...
    def undeploy_index(self,
            request: Optional[Union[index_endpoint_service.UndeployIndexRequest, dict]] = None,
            *,
            index_endpoint: Optional[str] = None,
    ...
    def mutate_deployed_index(self,
            request: Optional[Union[index_endpoint_service.MutateDeployedIndexRequest, dict]] = None,
            *,
            index_endpoint: Optional[str] = None,
            deployed_index: Optional[gca_index_endpoint.DeployedIndex] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
