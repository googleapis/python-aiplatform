...
class IndexEndpointServiceAsyncClient:
    ...
    parse_reservation_path = staticmethod(IndexEndpointServiceClient.parse_reservation_path)
    ...
    async def create_index_endpoint(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.create_index_endpoint]
    ...
    async def update_index_endpoint(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_index_endpoint]
    ...
    async def delete_index_endpoint(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_index_endpoint]
    ...
    async def deploy_index(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.deploy_index]
    ...
    async def undeploy_index(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.undeploy_index]
    ...
    async def mutate_deployed_index(self,
        ...
        .. code-block:: python
            ...
            async def sample_mutate_deployed_index():
                ...
                # Make the request
                operation = await client.mutate_deployed_index(request=request)
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.mutate_deployed_index]
