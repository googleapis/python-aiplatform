...
class IndexEndpointServiceRestTransport(_BaseIndexEndpointServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseIndexEndpointServiceRestTransport._BaseGetIamPolicy, IndexEndpointServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = IndexEndpointServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseIndexEndpointServiceRestTransport._BaseTestIamPermissions, IndexEndpointServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = IndexEndpointServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
