...
class ReasoningEngineExecutionServiceGrpcAsyncIOTransport(ReasoningEngineExecutionServiceTransport):
    ...
    def cancel_async_query_reasoning_engine(self) -> Callable[
            ...
            Awaitable[reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineResponse]]:
        ...
        Returns:
            Callable[[~.CancelAsyncQueryReasoningEngineRequest],
                    Awaitable[~.CancelAsyncQueryReasoningEngineResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
