...
class AsyncFeatureOnlineStoreAdminServiceRestTransport(_BaseFeatureOnlineStoreAdminServiceRestTransport):
    ...
    class _GetIamPolicy(_BaseFeatureOnlineStoreAdminServiceRestTransport._BaseGetIamPolicy, AsyncFeatureOnlineStoreAdminServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncFeatureOnlineStoreAdminServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _TestIamPermissions(_BaseFeatureOnlineStoreAdminServiceRestTransport._BaseTestIamPermissions, AsyncFeatureOnlineStoreAdminServiceRestStub):
        ...
        async def __call__(self,
            ...
            # Send the request
            response = await AsyncFeatureOnlineStoreAdminServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
