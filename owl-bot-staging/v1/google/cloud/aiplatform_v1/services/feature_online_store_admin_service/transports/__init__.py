...
try:
    ...
    ASYNC_REST_CLASSES = ('AsyncFeatureOnlineStoreAdminServiceRestTransport', 'AsyncFeatureOnlineStoreAdminServiceRestInterceptor')
    HAS_REST_ASYNC = True
...
_transport_registry = OrderedDict()  # type: Dict[str, Type[FeatureOnlineStoreAdminServiceTransport]]
...
if HAS_REST_ASYNC:  # pragma: NO COVER
    _transport_registry['rest_asyncio'] = AsyncFeatureOnlineStoreAdminServiceRestTransport
