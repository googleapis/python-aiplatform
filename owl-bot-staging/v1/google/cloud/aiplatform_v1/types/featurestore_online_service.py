...
class ReadFeatureValuesResponse(proto.Message):
    ...
    class Header(proto.Message):
        ...
        feature_descriptors: MutableSequence['ReadFeatureValuesResponse.FeatureDescriptor'] = proto.RepeatedField(
            proto.MESSAGE,
            number=2,
    ...
    class EntityView(proto.Message):
        ...
        data: MutableSequence['ReadFeatureValuesResponse.EntityView.Data'] = proto.RepeatedField(
            proto.MESSAGE,
            number=2,
