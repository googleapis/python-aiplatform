...
class EvaluatedAnnotation(proto.Message):
    ...
    explanations: MutableSequence['EvaluatedAnnotationExplanation'] = proto.RepeatedField(
        proto.MESSAGE,
        number=8,
        message='EvaluatedAnnotationExplanation',
    )
    error_analysis_annotations: MutableSequence['ErrorAnalysisAnnotation'] = proto.RepeatedField(
        proto.MESSAGE,
        number=9,
