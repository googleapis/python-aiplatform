...
class DeployedIndex(proto.Message):
    ...
    psc_automation_configs: MutableSequence[service_networking.PSCAutomationConfig] = proto.RepeatedField(
        proto.MESSAGE,
        number=19,
...
class IndexPrivateEndpoints(proto.Message):
    ...
    psc_automated_endpoints: MutableSequence[service_networking.PscAutomatedEndpoints] = proto.RepeatedField(
        proto.MESSAGE,
        number=3,
