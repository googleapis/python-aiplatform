...
class CopyModelRequest(proto.Message):
    ...
    Attributes:
        ...
        custom_service_account (str):
            Optional. The user-provided custom service account to use to
            do the copy model. If empty, `Vertex AI Service
            Agent <https://cloud.google.com/vertex-ai/docs/general/access-control#service-agents>`__
            will be used to access resources needed to upload the model.
            This account must belong to the destination project where
            the model is copied to, i.e., the project specified in the
            ``parent`` field of this request and have the Vertex AI
            Service Agent role in the source project.
    ...
    custom_service_account: str = proto.Field(
        proto.STRING,
        number=7,
    )
...
class BatchImportModelEvaluationSlicesRequest(proto.Message):
    ...
    model_evaluation_slices: MutableSequence[model_evaluation_slice.ModelEvaluationSlice] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
...
class BatchImportEvaluatedAnnotationsRequest(proto.Message):
    ...
    evaluated_annotations: MutableSequence[evaluated_annotation.EvaluatedAnnotation] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
...
class ListModelEvaluationsResponse(proto.Message):
    ...
    model_evaluations: MutableSequence[gca_model_evaluation.ModelEvaluation] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_model_evaluation.ModelEvaluation,
    )
