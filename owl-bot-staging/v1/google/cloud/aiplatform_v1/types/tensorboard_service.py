...
class ReadTensorboardUsageResponse(proto.Message):
    ...
    class PerMonthUsageData(proto.Message):
        ...
        user_usage_data: MutableSequence['ReadTensorboardUsageResponse.PerUserUsageData'] = proto.RepeatedField(
            proto.MESSAGE,
            number=1,
...
class CreateTensorboardExperimentRequest(proto.Message):
    ...
    tensorboard_experiment: gca_tensorboard_experiment.TensorboardExperiment = proto.Field(
        proto.MESSAGE,
        number=2,
...
class ListTensorboardExperimentsResponse(proto.Message):
    ...
    tensorboard_experiments: MutableSequence[gca_tensorboard_experiment.TensorboardExperiment] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_tensorboard_experiment.TensorboardExperiment,
    )
...
class BatchCreateTensorboardRunsResponse(proto.Message):
    ...
    tensorboard_runs: MutableSequence[gca_tensorboard_run.TensorboardRun] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class BatchCreateTensorboardTimeSeriesRequest(proto.Message):
    ...
    requests: MutableSequence['CreateTensorboardTimeSeriesRequest'] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
...
class BatchCreateTensorboardTimeSeriesResponse(proto.Message):
    ...
    tensorboard_time_series: MutableSequence[gca_tensorboard_time_series.TensorboardTimeSeries] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class CreateTensorboardTimeSeriesRequest(proto.Message):
    ...
    tensorboard_time_series: gca_tensorboard_time_series.TensorboardTimeSeries = proto.Field(
        proto.MESSAGE,
        number=2,
        message=gca_tensorboard_time_series.TensorboardTimeSeries,
    )
...
class BatchReadTensorboardTimeSeriesDataResponse(proto.Message):
    ...
    time_series_data: MutableSequence[tensorboard_data.TimeSeriesData] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class WriteTensorboardExperimentDataRequest(proto.Message):
    ...
    write_run_data_requests: MutableSequence['WriteTensorboardRunDataRequest'] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
...
class ExportTensorboardTimeSeriesDataResponse(proto.Message):
    ...
    time_series_data_points: MutableSequence[tensorboard_data.TimeSeriesDataPoint] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
