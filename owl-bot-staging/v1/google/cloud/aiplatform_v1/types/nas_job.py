...
class NasJobSpec(proto.Message):
    ...
    class MultiTrialAlgorithmSpec(proto.Message):
        ...
        class MetricSpec(proto.Message):
            ...
            goal: 'NasJobSpec.MultiTrialAlgorithmSpec.MetricSpec.GoalType' = proto.Field(
                proto.ENUM,
                number=2,
        ...
        search_trial_spec: 'NasJobSpec.MultiTrialAlgorithmSpec.SearchTrialSpec' = proto.Field(
            proto.MESSAGE,
            number=3,
            message='NasJobSpec.MultiTrialAlgorithmSpec.SearchTrialSpec',
        )
        train_trial_spec: 'NasJobSpec.MultiTrialAlgorithmSpec.TrainTrialSpec' = proto.Field(
            proto.MESSAGE,
            number=4,
