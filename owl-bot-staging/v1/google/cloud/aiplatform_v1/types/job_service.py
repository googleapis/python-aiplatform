...
class ListDataLabelingJobsResponse(proto.Message):
    ...
    data_labeling_jobs: MutableSequence[gca_data_labeling_job.DataLabelingJob] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_data_labeling_job.DataLabelingJob,
    )
...
class CreateHyperparameterTuningJobRequest(proto.Message):
    ...
    hyperparameter_tuning_job: gca_hyperparameter_tuning_job.HyperparameterTuningJob = proto.Field(
        proto.MESSAGE,
        number=2,
...
class ListHyperparameterTuningJobsResponse(proto.Message):
    ...
    hyperparameter_tuning_jobs: MutableSequence[gca_hyperparameter_tuning_job.HyperparameterTuningJob] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_hyperparameter_tuning_job.HyperparameterTuningJob,
    )
...
class ListNasTrialDetailsResponse(proto.Message):
    ...
    nas_trial_details: MutableSequence[gca_nas_job.NasTrialDetail] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class ListBatchPredictionJobsResponse(proto.Message):
    ...
    batch_prediction_jobs: MutableSequence[gca_batch_prediction_job.BatchPredictionJob] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_batch_prediction_job.BatchPredictionJob,
    )
...
class SearchModelDeploymentMonitoringStatsAnomaliesResponse(proto.Message):
    ...
    monitoring_stats: MutableSequence[gca_model_deployment_monitoring_job.ModelMonitoringStatsAnomalies] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class ListModelDeploymentMonitoringJobsResponse(proto.Message):
    ...
    model_deployment_monitoring_jobs: MutableSequence[gca_model_deployment_monitoring_job.ModelDeploymentMonitoringJob] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gca_model_deployment_monitoring_job.ModelDeploymentMonitoringJob,
    )
