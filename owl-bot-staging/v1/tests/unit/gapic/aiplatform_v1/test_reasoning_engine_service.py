...
def test_create_reasoning_engine_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["reasoning_engine"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'spec': {'package_spec': {'pickle_object_gcs_uri': 'pickle_object_gcs_uri_value', 'dependency_files_gcs_uri': 'dependency_files_gcs_uri_value', 'requirements_gcs_uri': 'requirements_gcs_uri_value', 'python_version': 'python_version_value'}, 'deployment_spec': {'env': [{'name': 'name_value', 'value': 'value_value'}], 'secret_env': [{'name': 'name_value', 'secret_ref': {'secret': 'secret_value', 'version': 'version_value'}}]}, 'class_methods': [{'fields': {}}], 'agent_framework': 'agent_framework_value'}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'etag': 'etag_value'}
