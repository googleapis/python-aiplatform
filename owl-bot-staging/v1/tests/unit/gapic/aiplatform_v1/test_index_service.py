    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.update_index] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.upsert_datapoints] = mock_object
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        class AwaitableMock(mock.AsyncMock):
            def __await__(self):
                ...
                return iter([])
        mock_object = AwaitableMock()
        client._client._transport._wrapped_methods[client._client._transport.remove_datapoints] = mock_object
...
def test_create_index_rest_bad_request(transport: str = 'rest', request_type=index_service.CreateIndexRequest):
    client = IndexServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_index_rest_bad_request(transport: str = 'rest', request_type=index_service.GetIndexRequest):
    client = IndexServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_indexes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = index_service.ListIndexesResponse.to_json(index_service.ListIndexesResponse())
...
def test_list_indexes_rest_bad_request(transport: str = 'rest', request_type=index_service.ListIndexesRequest):
    client = IndexServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_index_rest_bad_request(transport: str = 'rest', request_type=index_service.UpdateIndexRequest):
    client = IndexServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_index_rest_bad_request(transport: str = 'rest', request_type=index_service.DeleteIndexRequest):
    client = IndexServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_upsert_datapoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = index_service.UpsertDatapointsResponse.to_json(index_service.UpsertDatapointsResponse())
...
def test_upsert_datapoints_rest_bad_request(transport: str = 'rest', request_type=index_service.UpsertDatapointsRequest):
    client = IndexServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_remove_datapoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = index_service.RemoveDatapointsResponse.to_json(index_service.RemoveDatapointsResponse())
...
def test_remove_datapoints_rest_bad_request(transport: str = 'rest', request_type=index_service.RemoveDatapointsRequest):
    client = IndexServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
