...
from google.cloud.aiplatform_v1.services.persistent_resource_service import PersistentResourceServiceAsyncClient
from google.cloud.aiplatform_v1.services.persistent_resource_service import PersistentResourceServiceClient
...
def test_persistent_resource_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.persistent_resource_service.transports.PersistentResourceServiceGrpcTransport.__init__') as grpc_transport:
...
async def test_create_persistent_resource_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.create_persistent_resource] = mock_object
...
async def test_get_persistent_resource_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_persistent_resource] = mock_object
...
async def test_list_persistent_resources_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_persistent_resources] = mock_object
...
async def test_delete_persistent_resource_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_persistent_resource] = mock_object
...
async def test_update_persistent_resource_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_persistent_resource] = mock_object
...
async def test_reboot_persistent_resource_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.reboot_persistent_resource] = mock_object
...
@pytest.mark.asyncio
async def test_reboot_persistent_resource_async(transport: str = 'grpc_asyncio', request_type=persistent_resource_service.RebootPersistentResourceRequest):
    client = PersistentResourceServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_persistent_resource_rest_bad_request(transport: str = 'rest', request_type=persistent_resource_service.CreatePersistentResourceRequest):
    client = PersistentResourceServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_persistent_resource_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/persistentResources" % client.transport._host, args[1])
...
def test_get_persistent_resource_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = persistent_resource.PersistentResource.to_json(persistent_resource.PersistentResource())
...
def test_get_persistent_resource_rest_bad_request(transport: str = 'rest', request_type=persistent_resource_service.GetPersistentResourceRequest):
    client = PersistentResourceServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_persistent_resource_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/persistentResources/*}" % client.transport._host, args[1])
...
def test_list_persistent_resources_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = persistent_resource_service.ListPersistentResourcesResponse.to_json(persistent_resource_service.ListPersistentResourcesResponse())
...
def test_list_persistent_resources_rest_bad_request(transport: str = 'rest', request_type=persistent_resource_service.ListPersistentResourcesRequest):
    client = PersistentResourceServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_persistent_resource_rest_bad_request(transport: str = 'rest', request_type=persistent_resource_service.DeletePersistentResourceRequest):
    client = PersistentResourceServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_persistent_resource_rest_bad_request(transport: str = 'rest', request_type=persistent_resource_service.UpdatePersistentResourceRequest):
    client = PersistentResourceServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_persistent_resource_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{persistent_resource.name=projects/*/locations/*/persistentResources/*}" % client.transport._host, args[1])
...
def test_reboot_persistent_resource_rest_bad_request(transport: str = 'rest', request_type=persistent_resource_service.RebootPersistentResourceRequest):
    client = PersistentResourceServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_reboot_persistent_resource_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/persistentResources/*}:reboot" % client.transport._host, args[1])
...
def test_persistent_resource_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.persistent_resource_service.transports.PersistentResourceServiceTransport.__init__') as Transport:
...
def test_persistent_resource_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.persistent_resource_service.transports.PersistentResourceServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_persistent_resource_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.persistent_resource_service.transports.PersistentResourceServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PersistentResourceServiceTransport()
        adc.assert_called_once()
