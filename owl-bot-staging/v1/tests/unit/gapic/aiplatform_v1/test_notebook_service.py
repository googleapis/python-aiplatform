...
from google.cloud.aiplatform_v1.services.notebook_service import NotebookServiceAsyncClient
...
from google.cloud.aiplatform_v1.types import notebook_execution_job as gca_notebook_execution_job
...
def test_notebook_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.notebook_service.transports.NotebookServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_notebook_runtime_template_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/notebookRuntimeTemplates" % client.transport._host, args[1])
...
def test_get_notebook_runtime_template_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/notebookRuntimeTemplates/*}" % client.transport._host, args[1])
...
def test_update_notebook_runtime_template_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{notebook_runtime_template.name=projects/*/locations/*/notebookRuntimeTemplates/*}" % client.transport._host, args[1])
...
def test_assign_notebook_runtime_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/notebookRuntimes:assign" % client.transport._host, args[1])
...
def test_get_notebook_runtime_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/notebookRuntimes/*}" % client.transport._host, args[1])
...
def test_list_notebook_runtimes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/notebookRuntimes" % client.transport._host, args[1])
...
def test_upgrade_notebook_runtime_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/notebookRuntimes/*}:upgrade" % client.transport._host, args[1])
...
def test_start_notebook_runtime_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/notebookRuntimes/*}:start" % client.transport._host, args[1])
...
def test_stop_notebook_runtime_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/notebookRuntimes/*}:stop" % client.transport._host, args[1])
...
def test_create_notebook_execution_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/notebookExecutionJobs" % client.transport._host, args[1])
...
def test_get_notebook_execution_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/notebookExecutionJobs/*}" % client.transport._host, args[1])
...
def test_notebook_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.notebook_service.transports.NotebookServiceTransport.__init__') as Transport:
...
def test_notebook_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.notebook_service.transports.NotebookServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_notebook_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.notebook_service.transports.NotebookServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NotebookServiceTransport()
        adc.assert_called_once()
