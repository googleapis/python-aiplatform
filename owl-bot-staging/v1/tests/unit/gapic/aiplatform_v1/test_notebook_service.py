...
async def test_create_notebook_runtime_template_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_notebook_runtime_template_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_notebook_runtime_templates_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_notebook_runtime_template_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_update_notebook_runtime_template_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_assign_notebook_runtime_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_notebook_runtime_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_notebook_runtimes_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_notebook_runtime_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_upgrade_notebook_runtime_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_start_notebook_runtime_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_stop_notebook_runtime_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_create_notebook_execution_job_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_notebook_execution_job_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_notebook_execution_jobs_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_notebook_execution_job_async(request_type, transport: str = 'grpc_asyncio'):
    client = NotebookServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
