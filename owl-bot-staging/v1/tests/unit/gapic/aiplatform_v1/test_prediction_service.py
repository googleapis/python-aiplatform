...
def test_predict_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{endpoint=projects/*/locations/*/endpoints/*}:predict" % client.transport._host, args[1])
...
def test_raw_predict_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{endpoint=projects/*/locations/*/endpoints/*}:rawPredict" % client.transport._host, args[1])
...
def test_stream_raw_predict_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{endpoint=projects/*/locations/*/endpoints/*}:streamRawPredict" % client.transport._host, args[1])
...
def test_explain_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{endpoint=projects/*/locations/*/endpoints/*}:explain" % client.transport._host, args[1])
...
def test_generate_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{model=projects/*/locations/*/endpoints/*}:generateContent" % client.transport._host, args[1])
...
def test_stream_generate_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{model=projects/*/locations/*/endpoints/*}:streamGenerateContent" % client.transport._host, args[1])
...
def test_embed_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{model=projects/*/locations/*/publishers/*/models/*}:embedContent" % client.transport._host, args[1])
