...
from google.cloud.aiplatform_v1.services.data_foundry_service import DataFoundryServiceAsyncClient
from google.cloud.aiplatform_v1.services.data_foundry_service import DataFoundryServiceClient
...
def test__get_default_mtls_endpoint():
    ...
    assert DataFoundryServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert DataFoundryServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert DataFoundryServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert DataFoundryServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert DataFoundryServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    assert DataFoundryServiceClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint

def test__read_environment_variables():
    assert DataFoundryServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert DataFoundryServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert DataFoundryServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert DataFoundryServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert DataFoundryServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert DataFoundryServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert DataFoundryServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert DataFoundryServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert DataFoundryServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(DataFoundryServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataFoundryServiceClient))
@mock.patch.object(DataFoundryServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataFoundryServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = DataFoundryServiceClient._DEFAULT_UNIVERSE
    default_endpoint = DataFoundryServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = DataFoundryServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert DataFoundryServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert DataFoundryServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == DataFoundryServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DataFoundryServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert DataFoundryServiceClient._get_api_endpoint(None, None, default_universe, "always") == DataFoundryServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DataFoundryServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == DataFoundryServiceClient.DEFAULT_MTLS_ENDPOINT
    assert DataFoundryServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert DataFoundryServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        DataFoundryServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert DataFoundryServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert DataFoundryServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert DataFoundryServiceClient._get_universe_domain(None, None) == DataFoundryServiceClient._DEFAULT_UNIVERSE
...
def test_data_foundry_service_client_from_service_account_info(client_class, transport_name):
...
def test_data_foundry_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_data_foundry_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (DataFoundryServiceAsyncClient, transports.DataFoundryServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (DataFoundryServiceClient, transports.DataFoundryServiceRestTransport, "rest"),
])
@mock.patch.object(DataFoundryServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataFoundryServiceClient))
@mock.patch.object(DataFoundryServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataFoundryServiceAsyncClient))
def test_data_foundry_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (DataFoundryServiceClient, transports.DataFoundryServiceGrpcTransport, "grpc", "true"),
    (DataFoundryServiceAsyncClient, transports.DataFoundryServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (DataFoundryServiceClient, transports.DataFoundryServiceGrpcTransport, "grpc", "false"),
    (DataFoundryServiceAsyncClient, transports.DataFoundryServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (DataFoundryServiceClient, transports.DataFoundryServiceRestTransport, "rest", "true"),
    (DataFoundryServiceClient, transports.DataFoundryServiceRestTransport, "rest", "false"),
])
@mock.patch.object(DataFoundryServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataFoundryServiceClient))
@mock.patch.object(DataFoundryServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(DataFoundryServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_data_foundry_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    DataFoundryServiceClient, DataFoundryServiceAsyncClient
])
@mock.patch.object(DataFoundryServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataFoundryServiceClient))
@mock.patch.object(DataFoundryServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(DataFoundryServiceAsyncClient))
...
def test_data_foundry_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (DataFoundryServiceClient, transports.DataFoundryServiceGrpcTransport, "grpc", grpc_helpers),
    (DataFoundryServiceAsyncClient, transports.DataFoundryServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (DataFoundryServiceClient, transports.DataFoundryServiceRestTransport, "rest", None),
])
def test_data_foundry_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_data_foundry_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.data_foundry_service.transports.DataFoundryServiceGrpcTransport.__init__') as grpc_transport:
...
def test_data_foundry_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_generate_synthetic_data(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.generate_synthetic_data),
            '__call__') as call:
...
def test_generate_synthetic_data_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.generate_synthetic_data in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.generate_synthetic_data] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_generate_synthetic_data_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.generate_synthetic_data in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.generate_synthetic_data] = mock_rpc
...
@pytest.mark.asyncio
async def test_generate_synthetic_data_async(transport: str = 'grpc_asyncio', request_type=data_foundry_service.GenerateSyntheticDataRequest):
    client = DataFoundryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(data_foundry_service.GenerateSyntheticDataResponse(
        ))
...
def test_generate_synthetic_data_rest_required_fields(request_type=data_foundry_service.GenerateSyntheticDataRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_synthetic_data._get_unset_required_fields(jsonified_request)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            return_value = data_foundry_service.GenerateSyntheticDataResponse.pb(return_value)
...
def test_generate_synthetic_data_rest_unset_required_fields():
    transport = transports.DataFoundryServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.generate_synthetic_data._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("location", "count", "outputFieldSpecs", )))
...
def test_generate_synthetic_data_rest_bad_request(request_type=data_foundry_service.GenerateSyntheticDataRequest):
    client = DataFoundryServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_generate_synthetic_data_rest_interceptors(null_interceptor):
    transport = transports.DataFoundryServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.DataFoundryServiceRestInterceptor(),
        )
    client = DataFoundryServiceClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.DataFoundryServiceRestInterceptor, "post_generate_synthetic_data") as post, \
        mock.patch.object(transports.DataFoundryServiceRestInterceptor, "post_generate_synthetic_data_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.DataFoundryServiceRestInterceptor, "pre_generate_synthetic_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = data_foundry_service.GenerateSyntheticDataRequest.pb(data_foundry_service.GenerateSyntheticDataRequest())
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = data_foundry_service.GenerateSyntheticDataResponse.to_json(data_foundry_service.GenerateSyntheticDataResponse())
        ...
        post_with_metadata.return_value = data_foundry_service.GenerateSyntheticDataResponse(), metadata

        client.generate_synthetic_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_generate_synthetic_data_rest_asyncio_bad_request(request_type=data_foundry_service.GenerateSyntheticDataRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = DataFoundryServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_generate_synthetic_data_rest_asyncio_interceptors(null_interceptor):
    ...
    transport = transports.AsyncDataFoundryServiceRestTransport(
        credentials=async_anonymous_credentials(),
        interceptor=None if null_interceptor else transports.AsyncDataFoundryServiceRestInterceptor(),
        )
    client = DataFoundryServiceAsyncClient(transport=transport)

    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncDataFoundryServiceRestInterceptor, "post_generate_synthetic_data") as post, \
        mock.patch.object(transports.AsyncDataFoundryServiceRestInterceptor, "post_generate_synthetic_data_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncDataFoundryServiceRestInterceptor, "pre_generate_synthetic_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = data_foundry_service.GenerateSyntheticDataRequest.pb(data_foundry_service.GenerateSyntheticDataRequest())
        ...
        await client.generate_synthetic_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_data_foundry_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.data_foundry_service.transports.DataFoundryServiceTransport.__init__') as Transport:
...
def test_data_foundry_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.data_foundry_service.transports.DataFoundryServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_data_foundry_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.data_foundry_service.transports.DataFoundryServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataFoundryServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.DataFoundryServiceGrpcTransport, transports.DataFoundryServiceGrpcAsyncIOTransport])
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.DataFoundryServiceGrpcTransport, transports.DataFoundryServiceGrpcAsyncIOTransport])
def test_data_foundry_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.DataFoundryServiceTransport, '_prep_wrapped_messages') as prep:
        client = DataFoundryServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (DataFoundryServiceAsyncClient, transports.DataFoundryServiceGrpcAsyncIOTransport),
])
