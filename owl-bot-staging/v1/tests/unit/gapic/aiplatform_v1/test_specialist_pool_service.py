...
async def test_create_specialist_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.create_specialist_pool] = mock_object
...
async def test_get_specialist_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_specialist_pool] = mock_object
...
async def test_list_specialist_pools_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_specialist_pools] = mock_object
...
async def test_delete_specialist_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_specialist_pool] = mock_object
...
async def test_update_specialist_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_specialist_pool] = mock_object
...
def test_create_specialist_pool_rest(request_type):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_create_specialist_pool_rest_bad_request(transport: str = 'rest', request_type=specialist_pool_service.CreateSpecialistPoolRequest):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_specialist_pool_rest_error():
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_get_specialist_pool_rest(request_type):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_specialist_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = specialist_pool.SpecialistPool.to_json(specialist_pool.SpecialistPool())
...
def test_get_specialist_pool_rest_bad_request(transport: str = 'rest', request_type=specialist_pool_service.GetSpecialistPoolRequest):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_specialist_pool_rest_error():
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_list_specialist_pools_rest(request_type):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_list_specialist_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = specialist_pool_service.ListSpecialistPoolsResponse.to_json(specialist_pool_service.ListSpecialistPoolsResponse())
...
def test_list_specialist_pools_rest_bad_request(transport: str = 'rest', request_type=specialist_pool_service.ListSpecialistPoolsRequest):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_specialist_pool_rest(request_type):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_delete_specialist_pool_rest_bad_request(transport: str = 'rest', request_type=specialist_pool_service.DeleteSpecialistPoolRequest):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_specialist_pool_rest_error():
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_update_specialist_pool_rest(request_type):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_update_specialist_pool_rest_bad_request(transport: str = 'rest', request_type=specialist_pool_service.UpdateSpecialistPoolRequest):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_specialist_pool_rest_error():
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_transport_kind(transport_name):
    transport = SpecialistPoolServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
