...
@pytest.mark.asyncio
async def test_mutate_deployed_model_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = EndpointServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_create_endpoint_rest_bad_request(transport: str = 'rest', request_type=endpoint_service.CreateEndpointRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_endpoint_rest_bad_request(transport: str = 'rest', request_type=endpoint_service.GetEndpointRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = endpoint_service.ListEndpointsResponse.to_json(endpoint_service.ListEndpointsResponse())
...
def test_list_endpoints_rest_bad_request(transport: str = 'rest', request_type=endpoint_service.ListEndpointsRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_endpoint.Endpoint.to_json(gca_endpoint.Endpoint())
...
def test_update_endpoint_rest_bad_request(transport: str = 'rest', request_type=endpoint_service.UpdateEndpointRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_endpoint_rest_bad_request(transport: str = 'rest', request_type=endpoint_service.DeleteEndpointRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_deploy_model_rest_bad_request(transport: str = 'rest', request_type=endpoint_service.DeployModelRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_undeploy_model_rest_bad_request(transport: str = 'rest', request_type=endpoint_service.UndeployModelRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_mutate_deployed_model_rest(request_type):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_mutate_deployed_model_rest_bad_request(transport: str = 'rest', request_type=endpoint_service.MutateDeployedModelRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_mutate_deployed_model_rest_error():
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_transport_kind(transport_name):
    transport = EndpointServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
