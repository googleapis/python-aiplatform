...
def test__get_default_mtls_endpoint():
    ...
    assert EndpointServiceClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint

def test__read_environment_variables():
    assert EndpointServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert EndpointServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert EndpointServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert EndpointServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert EndpointServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert EndpointServiceClient._get_client_cert_source(None, False) is None
    assert EndpointServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert EndpointServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert EndpointServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert EndpointServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(EndpointServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EndpointServiceClient))
@mock.patch.object(EndpointServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EndpointServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = EndpointServiceClient._DEFAULT_UNIVERSE
    default_endpoint = EndpointServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = EndpointServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert EndpointServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert EndpointServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == EndpointServiceClient.DEFAULT_MTLS_ENDPOINT
    assert EndpointServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert EndpointServiceClient._get_api_endpoint(None, None, default_universe, "always") == EndpointServiceClient.DEFAULT_MTLS_ENDPOINT
    assert EndpointServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == EndpointServiceClient.DEFAULT_MTLS_ENDPOINT
    assert EndpointServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert EndpointServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        EndpointServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert EndpointServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert EndpointServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert EndpointServiceClient._get_universe_domain(None, None) == EndpointServiceClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class,transport_name", [
    (EndpointServiceClient, "grpc"),
    (EndpointServiceAsyncClient, "grpc_asyncio"),
    (EndpointServiceClient, "rest"),
])
def test_endpoint_service_client_from_service_account_info(client_class, transport_name):
...
@pytest.mark.parametrize("transport_class,transport_name", [
    ...
    (transports.EndpointServiceRestTransport, "rest"),
])
def test_endpoint_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_endpoint_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (EndpointServiceClient, transports.EndpointServiceRestTransport, "rest"),
])
@mock.patch.object(EndpointServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EndpointServiceClient))
@mock.patch.object(EndpointServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EndpointServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (EndpointServiceClient, transports.EndpointServiceRestTransport, "rest", "true"),
    (EndpointServiceClient, transports.EndpointServiceRestTransport, "rest", "false"),
])
@mock.patch.object(EndpointServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EndpointServiceClient))
@mock.patch.object(EndpointServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EndpointServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    EndpointServiceClient, EndpointServiceAsyncClient
])
...
@mock.patch.object(EndpointServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EndpointServiceClient))
@mock.patch.object(EndpointServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(EndpointServiceAsyncClient))
def test_endpoint_service_client_client_api_endpoint(client_class):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (EndpointServiceClient, transports.EndpointServiceGrpcTransport, "grpc", grpc_helpers),
    (EndpointServiceAsyncClient, transports.EndpointServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (EndpointServiceClient, transports.EndpointServiceRestTransport, "rest", None),
])
def test_endpoint_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_endpoint_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_create_endpoint_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = endpoint_service.CreateEndpointRequest(
            parent='parent_value',
            endpoint_id='endpoint_id_value',
        )
...
@pytest.mark.asyncio
async def test_create_endpoint_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_endpoint in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_endpoint] = mock_rpc
...
def test_get_endpoint_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = endpoint_service.GetEndpointRequest(
            name='name_value',
        )
        assert args[0] == request_msg
...
@pytest.mark.asyncio
async def test_get_endpoint_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EndpointServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_endpoint in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_endpoint] = mock_rpc
...
def test_list_endpoints_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = endpoint_service.ListEndpointsRequest(
            parent='parent_value',
            filter='filter_value',
            page_token='page_token_value',
            order_by='order_by_value',
...
@pytest.mark.asyncio
async def test_list_endpoints_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EndpointServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_endpoints in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_endpoints] = mock_rpc
...
@pytest.mark.asyncio
async def test_update_endpoint_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EndpointServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_endpoint in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_endpoint] = mock_rpc
...
async def test_update_endpoint_async(request_type, transport: str = 'grpc_asyncio'):
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_endpoint_long_running(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_endpoint_long_running),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_endpoint_long_running_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_endpoint_long_running in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_endpoint_long_running] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_endpoint_long_running_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EndpointServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_endpoint_long_running in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_endpoint_long_running] = mock_rpc
...
async def test_update_endpoint_long_running_async(request_type, transport: str = 'grpc_asyncio'):
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_endpoint_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = endpoint_service.DeleteEndpointRequest(
            name='name_value',
        )
        assert args[0] == request_msg
...
@pytest.mark.asyncio
async def test_delete_endpoint_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EndpointServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_endpoint in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_endpoint] = mock_rpc
...
def test_deploy_model_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = endpoint_service.DeployModelRequest(
            endpoint='endpoint_value',
        )
        assert args[0] == request_msg
...
async def test_deploy_model_async(request_type, transport: str = 'grpc_asyncio'):
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_deploy_model_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = gca_endpoint.DeployedModel(dedicated_resources=machine_resources.DedicatedResources(machine_spec=machine_resources.MachineSpec(machine_type='machine_type_value')))
        assert arg == mock_val
...
def test_undeploy_model_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = endpoint_service.UndeployModelRequest(
            endpoint='endpoint_value',
            deployed_model_id='deployed_model_id_value',
        )
        assert args[0] == request_msg
...
async def test_undeploy_model_async(request_type, transport: str = 'grpc_asyncio'):
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_mutate_deployed_model(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.mutate_deployed_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_mutate_deployed_model_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client.mutate_deployed_model(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = endpoint_service.MutateDeployedModelRequest(
            endpoint='endpoint_value',
        )
        assert args[0] == request_msg

def test_mutate_deployed_model_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EndpointServiceClient(
        ...
        # Ensure method has been cached
        assert client._transport.mutate_deployed_model in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.mutate_deployed_model] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_mutate_deployed_model_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = EndpointServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.mutate_deployed_model in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.mutate_deployed_model] = mock_rpc
...
async def test_mutate_deployed_model_async(request_type, transport: str = 'grpc_asyncio'):
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_endpoint_rest_required_fields(request_type=endpoint_service.CreateEndpointRequest):
...
def test_create_endpoint_rest_unset_required_fields():
    transport = transports.EndpointServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_endpoint._get_unset_required_fields({})
    assert set(unset_fields) == (set(("endpointId", )) & set(("parent", "endpoint", )))
...
def test_create_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/endpoints" % client.transport._host, args[1])
...
def test_get_endpoint_rest_required_fields(request_type=endpoint_service.GetEndpointRequest):
    transport_class = transports.EndpointServiceRestTransport
...
def test_get_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/endpoints/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/endpoints/*}" % client.transport._host, args[1])
...
def test_list_endpoints_rest_required_fields(request_type=endpoint_service.ListEndpointsRequest):
    transport_class = transports.EndpointServiceRestTransport
    ...
    # Designate an appropriate value for the returned response.
    return_value = endpoint_service.ListEndpointsResponse()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = endpoint_service.ListEndpointsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_endpoints_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(endpoint_service.ListEndpointsResponse.to_json(x) for x in response)
...
def test_update_endpoint_rest_required_fields(request_type=endpoint_service.UpdateEndpointRequest):
    transport_class = transports.EndpointServiceRestTransport
    ...
    # Designate an appropriate value for the returned response.
    return_value = gca_endpoint.Endpoint()
    # Mock the http request call within the method and fake a response.
    with mock.patch.object(Session, 'request') as req:
        # We need to mock transcode() because providing default values
        # for required fields will fail the real version if the http_options
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = gca_endpoint.Endpoint.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_update_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'endpoint': {'name': 'projects/sample1/locations/sample2/endpoints/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{endpoint.name=projects/*/locations/*/endpoints/*}" % client.transport._host, args[1])
...
def test_update_endpoint_long_running_rest_required_fields(request_type=endpoint_service.UpdateEndpointLongRunningRequest):
    transport_class = transports.EndpointServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_endpoint_long_running._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_endpoint_long_running_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{endpoint.name=projects/*/locations/*/endpoints/*}:update" % client.transport._host, args[1])
...
def test_delete_endpoint_rest_required_fields(request_type=endpoint_service.DeleteEndpointRequest):
    transport_class = transports.EndpointServiceRestTransport
...
def test_deploy_model_rest_required_fields(request_type=endpoint_service.DeployModelRequest):
    transport_class = transports.EndpointServiceRestTransport
...
def test_deploy_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{endpoint=projects/*/locations/*/endpoints/*}:deployModel" % client.transport._host, args[1])
...
def test_undeploy_model_rest_required_fields(request_type=endpoint_service.UndeployModelRequest):
    transport_class = transports.EndpointServiceRestTransport
...
def test_undeploy_model_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("endpoint", "deployedModelId", )))
...
def test_undeploy_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{endpoint=projects/*/locations/*/endpoints/*}:undeployModel" % client.transport._host, args[1])
...
def test_mutate_deployed_model_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = EndpointServiceClient(
...
def test_mutate_deployed_model_rest_required_fields(request_type=endpoint_service.MutateDeployedModelRequest):
    transport_class = transports.EndpointServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).mutate_deployed_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_mutate_deployed_model_rest_unset_required_fields():
    transport = transports.EndpointServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.mutate_deployed_model._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("endpoint", "deployedModel", "updateMask", )))


def test_mutate_deployed_model_rest_flattened():
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{endpoint=projects/*/locations/*/endpoints/*}:mutateDeployedModel" % client.transport._host, args[1])


def test_mutate_deployed_model_rest_flattened_error(transport: str = 'rest'):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_endpoint_empty_call_grpc():
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_endpoint(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_endpoint_empty_call_grpc():
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = gca_endpoint.Endpoint()
        client.update_endpoint(request=None)
...
def test_delete_endpoint_empty_call_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_endpoint(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_mutate_deployed_model_empty_call_grpc():
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.mutate_deployed_model(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_endpoint_empty_call_grpc_asyncio():
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_endpoint(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_endpoint_empty_call_grpc_asyncio():
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_endpoint_empty_call_grpc_asyncio():
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_endpoint(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_mutate_deployed_model_empty_call_grpc_asyncio():
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.mutate_deployed_model(request=None)
...
def test_create_endpoint_rest_bad_request(request_type=endpoint_service.CreateEndpointRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_endpoint_rest_call_success(request_type):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_create_endpoint") as post, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_create_endpoint_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "pre_create_endpoint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.CreateEndpointRequest.pb(endpoint_service.CreateEndpointRequest())
...
def test_get_endpoint_rest_bad_request(request_type=endpoint_service.GetEndpointRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_get_endpoint") as post, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_get_endpoint_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "pre_get_endpoint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.GetEndpointRequest.pb(endpoint_service.GetEndpointRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_endpoints_rest_bad_request(request_type=endpoint_service.ListEndpointsRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_list_endpoints") as post, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_list_endpoints_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "pre_list_endpoints") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.ListEndpointsRequest.pb(endpoint_service.ListEndpointsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = endpoint_service.ListEndpointsResponse.to_json(endpoint_service.ListEndpointsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = endpoint_service.ListEndpointsResponse(), metadata
...
def test_update_endpoint_rest_bad_request(request_type=endpoint_service.UpdateEndpointRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_endpoint_rest_call_success(request_type):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # Determine if the message type is proto-plus or protobuf
    test_field = endpoint_service.UpdateEndpointRequest.meta.fields["endpoint"]
...
def test_update_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_update_endpoint") as post, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_update_endpoint_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "pre_update_endpoint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.UpdateEndpointRequest.pb(endpoint_service.UpdateEndpointRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_endpoint_long_running_rest_bad_request(request_type=endpoint_service.UpdateEndpointLongRunningRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_endpoint_long_running_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_update_endpoint_long_running") as post, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_update_endpoint_long_running_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "pre_update_endpoint_long_running") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.UpdateEndpointLongRunningRequest.pb(endpoint_service.UpdateEndpointLongRunningRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_endpoint_long_running(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_endpoint_rest_bad_request(request_type=endpoint_service.DeleteEndpointRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_endpoint_rest_call_success(request_type):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_delete_endpoint") as post, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_delete_endpoint_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "pre_delete_endpoint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.DeleteEndpointRequest.pb(endpoint_service.DeleteEndpointRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_deploy_model_rest_bad_request(request_type=endpoint_service.DeployModelRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_deploy_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_deploy_model") as post, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_deploy_model_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "pre_deploy_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.DeployModelRequest.pb(endpoint_service.DeployModelRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_undeploy_model_rest_bad_request(request_type=endpoint_service.UndeployModelRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_undeploy_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_undeploy_model") as post, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_undeploy_model_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "pre_undeploy_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.UndeployModelRequest.pb(endpoint_service.UndeployModelRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_mutate_deployed_model_rest_bad_request(request_type=endpoint_service.MutateDeployedModelRequest):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_mutate_deployed_model_rest_call_success(request_type):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_mutate_deployed_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_mutate_deployed_model") as post, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "post_mutate_deployed_model_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.EndpointServiceRestInterceptor, "pre_mutate_deployed_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.MutateDeployedModelRequest.pb(endpoint_service.MutateDeployedModelRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.mutate_deployed_model(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_endpoint_empty_call_rest():
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_endpoint_empty_call_rest():
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_mutate_deployed_model_empty_call_rest():
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_transport_kind_rest_asyncio():
    ...
    transport = EndpointServiceAsyncClient.get_transport_class("rest_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
@pytest.mark.asyncio
async def test_create_endpoint_rest_asyncio_bad_request(request_type=endpoint_service.CreateEndpointRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_endpoint_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_create_endpoint_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEndpointServiceRestTransport(
        credentials=async_anonymous_credentials(),
        interceptor=None if null_interceptor else transports.AsyncEndpointServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_create_endpoint") as post, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_create_endpoint_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "pre_create_endpoint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.CreateEndpointRequest.pb(endpoint_service.CreateEndpointRequest())
        ...
        await client.create_endpoint(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_endpoint_rest_asyncio_bad_request(request_type=endpoint_service.GetEndpointRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_endpoint_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_get_endpoint_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEndpointServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_get_endpoint") as post, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_get_endpoint_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "pre_get_endpoint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.GetEndpointRequest.pb(endpoint_service.GetEndpointRequest())
        ...
        await client.get_endpoint(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_endpoints_rest_asyncio_bad_request(request_type=endpoint_service.ListEndpointsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_endpoints_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_list_endpoints_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEndpointServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_list_endpoints") as post, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_list_endpoints_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "pre_list_endpoints") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.ListEndpointsRequest.pb(endpoint_service.ListEndpointsRequest())
        ...
        await client.list_endpoints(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_update_endpoint_rest_asyncio_bad_request(request_type=endpoint_service.UpdateEndpointRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_update_endpoint_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_update_endpoint_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEndpointServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_update_endpoint") as post, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_update_endpoint_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "pre_update_endpoint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.UpdateEndpointRequest.pb(endpoint_service.UpdateEndpointRequest())
        ...
        await client.update_endpoint(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_update_endpoint_long_running_rest_asyncio_bad_request(request_type=endpoint_service.UpdateEndpointLongRunningRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_update_endpoint_long_running_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_update_endpoint_long_running") as post, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_update_endpoint_long_running_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "pre_update_endpoint_long_running") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.UpdateEndpointLongRunningRequest.pb(endpoint_service.UpdateEndpointLongRunningRequest())
        ...
        await client.update_endpoint_long_running(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_endpoint_rest_asyncio_bad_request(request_type=endpoint_service.DeleteEndpointRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_endpoint_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_delete_endpoint_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEndpointServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_delete_endpoint") as post, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_delete_endpoint_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "pre_delete_endpoint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.DeleteEndpointRequest.pb(endpoint_service.DeleteEndpointRequest())
        ...
        await client.delete_endpoint(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_deploy_model_rest_asyncio_bad_request(request_type=endpoint_service.DeployModelRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_deploy_model_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_deploy_model_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEndpointServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_deploy_model") as post, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_deploy_model_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "pre_deploy_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.DeployModelRequest.pb(endpoint_service.DeployModelRequest())
        ...
        await client.deploy_model(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_undeploy_model_rest_asyncio_bad_request(request_type=endpoint_service.UndeployModelRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_undeploy_model_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_undeploy_model_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEndpointServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_undeploy_model") as post, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_undeploy_model_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "pre_undeploy_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.UndeployModelRequest.pb(endpoint_service.UndeployModelRequest())
        ...
        await client.undeploy_model(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_mutate_deployed_model_rest_asyncio_bad_request(request_type=endpoint_service.MutateDeployedModelRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_mutate_deployed_model_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_mutate_deployed_model_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncEndpointServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_mutate_deployed_model") as post, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "post_mutate_deployed_model_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncEndpointServiceRestInterceptor, "pre_mutate_deployed_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = endpoint_service.MutateDeployedModelRequest.pb(endpoint_service.MutateDeployedModelRequest())
        ...
        await client.mutate_deployed_model(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_endpoint_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_endpoint_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_endpoints_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_endpoint_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_deploy_model_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_undeploy_model_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_mutate_deployed_model_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
def test_endpoint_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.endpoint_service.transports.EndpointServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_endpoint_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.endpoint_service.transports.EndpointServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.EndpointServiceTransport()
        adc.assert_called_once()
...
def test_endpoint_service_http_transport_client_cert_source_for_mtls():
    cred = ga_credentials.AnonymousCredentials()
...
def test_endpoint_service_host_no_port(transport_name):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_endpoint_service_host_with_port(transport_name):
    client = EndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_endpoint_service_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = EndpointServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = EndpointServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_deployment_resource_pool_path():
    ...
    actual = EndpointServiceClient.deployment_resource_pool_path(project, location, deployment_resource_pool)
