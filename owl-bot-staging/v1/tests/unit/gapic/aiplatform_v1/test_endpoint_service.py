...
@pytest.mark.asyncio
async def test_update_endpoint_long_running_async(transport: str = 'grpc_asyncio', request_type=endpoint_service.UpdateEndpointLongRunningRequest):
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_mutate_deployed_model_async(transport: str = 'grpc_asyncio', request_type=endpoint_service.MutateDeployedModelRequest):
    client = EndpointServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
