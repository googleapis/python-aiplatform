...
from google.cloud.aiplatform_v1.services.metadata_service import MetadataServiceAsyncClient
...
def test__get_client_cert_source():
    ...
    assert MetadataServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert MetadataServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (MetadataServiceClient, transports.MetadataServiceGrpcTransport, "grpc"),
    (MetadataServiceAsyncClient, transports.MetadataServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (MetadataServiceClient, transports.MetadataServiceRestTransport, "rest"),
])
@mock.patch.object(MetadataServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MetadataServiceClient))
@mock.patch.object(MetadataServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MetadataServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (MetadataServiceClient, transports.MetadataServiceRestTransport, "rest", "true"),
    (MetadataServiceClient, transports.MetadataServiceRestTransport, "rest", "false"),
])
@mock.patch.object(MetadataServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MetadataServiceClient))
@mock.patch.object(MetadataServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(MetadataServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    MetadataServiceClient, MetadataServiceAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (MetadataServiceClient, transports.MetadataServiceGrpcTransport, "grpc", grpc_helpers),
    (MetadataServiceAsyncClient, transports.MetadataServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_metadata_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.metadata_service.transports.MetadataServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_metadata_store_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
            type(client.transport.create_metadata_store),
            '__call__') as call:
        client.create_metadata_store(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.CreateMetadataStoreRequest(
            parent='parent_value',
...
@pytest.mark.asyncio
async def test_create_metadata_store_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
...
def test_get_metadata_store_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.get_metadata_store),
            '__call__') as call:
        client.get_metadata_store(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.GetMetadataStoreRequest(
            name='name_value',
...
@pytest.mark.asyncio
async def test_get_metadata_store_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_metadata_stores_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.list_metadata_stores),
            '__call__') as call:
        client.list_metadata_stores(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.ListMetadataStoresRequest(
            parent='parent_value',
...
@pytest.mark.asyncio
async def test_list_metadata_stores_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_delete_metadata_store_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.delete_metadata_store),
            '__call__') as call:
        client.delete_metadata_store(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.DeleteMetadataStoreRequest(
            name='name_value',
...
@pytest.mark.asyncio
async def test_delete_metadata_store_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_artifact_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.update_artifact),
            '__call__') as call:
        client.update_artifact(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.UpdateArtifactRequest(
        )
...
@pytest.mark.asyncio
async def test_update_artifact_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_artifact_async(transport: str = 'grpc_asyncio', request_type=metadata_service.DeleteArtifactRequest):
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_purge_artifacts(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.purge_artifacts),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_purge_artifacts_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.purge_artifacts),
            '__call__') as call:
        client.purge_artifacts(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.PurgeArtifactsRequest(
            parent='parent_value',
...
@pytest.mark.asyncio
async def test_purge_artifacts_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_purge_artifacts_async(transport: str = 'grpc_asyncio', request_type=metadata_service.PurgeArtifactsRequest):
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_context_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_create_context_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_get_context_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_list_contexts_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_context_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_update_context_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_delete_context_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_context_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_purge_contexts(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.purge_contexts),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_purge_contexts_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.purge_contexts),
            '__call__') as call:
        client.purge_contexts(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.PurgeContextsRequest(
            parent='parent_value',
...
@pytest.mark.asyncio
async def test_purge_contexts_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_purge_contexts_async(transport: str = 'grpc_asyncio', request_type=metadata_service.PurgeContextsRequest):
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_add_context_artifacts_and_executions_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_add_context_artifacts_and_executions_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_add_context_children_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.add_context_children),
            '__call__') as call:
        client.add_context_children(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.AddContextChildrenRequest(
            context='context_value',
...
@pytest.mark.asyncio
async def test_add_context_children_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_remove_context_children(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.remove_context_children),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_remove_context_children_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.remove_context_children),
            '__call__') as call:
        client.remove_context_children(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.RemoveContextChildrenRequest(
            context='context_value',
...
@pytest.mark.asyncio
async def test_remove_context_children_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_remove_context_children_async(transport: str = 'grpc_asyncio', request_type=metadata_service.RemoveContextChildrenRequest):
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_context_lineage_subgraph_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_query_context_lineage_subgraph_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_execution_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.update_execution),
            '__call__') as call:
        client.update_execution(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.UpdateExecutionRequest(
        )
...
@pytest.mark.asyncio
async def test_update_execution_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_delete_execution_async(transport: str = 'grpc_asyncio', request_type=metadata_service.DeleteExecutionRequest):
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_purge_executions(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.purge_executions),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_purge_executions_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.purge_executions),
            '__call__') as call:
        client.purge_executions(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.PurgeExecutionsRequest(
            parent='parent_value',
...
@pytest.mark.asyncio
async def test_purge_executions_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_purge_executions_async(transport: str = 'grpc_asyncio', request_type=metadata_service.PurgeExecutionsRequest):
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_add_execution_events_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.add_execution_events),
            '__call__') as call:
        client.add_execution_events(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.AddExecutionEventsRequest(
            execution='execution_value',
...
@pytest.mark.asyncio
async def test_add_execution_events_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_query_execution_inputs_and_outputs_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_query_execution_inputs_and_outputs_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_create_metadata_schema_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.create_metadata_schema),
            '__call__') as call:
        client.create_metadata_schema(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.CreateMetadataSchemaRequest(
            parent='parent_value',
...
@pytest.mark.asyncio
async def test_create_metadata_schema_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_get_metadata_schema_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.get_metadata_schema),
            '__call__') as call:
        client.get_metadata_schema(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.GetMetadataSchemaRequest(
            name='name_value',
...
@pytest.mark.asyncio
async def test_get_metadata_schema_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_list_metadata_schemas_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
            type(client.transport.list_metadata_schemas),
            '__call__') as call:
        client.list_metadata_schemas(request=request)
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == metadata_service.ListMetadataSchemasRequest(
            parent='parent_value',
...
@pytest.mark.asyncio
async def test_list_metadata_schemas_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_query_artifact_lineage_subgraph_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_query_artifact_lineage_subgraph_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = MetadataServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_create_metadata_store_rest(request_type):
    ...
    request_init["metadata_store"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}, 'description': 'description_value', 'state': {'disk_utilization_bytes': 2380}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = metadata_service.CreateMetadataStoreRequest.meta.fields["metadata_store"]
...
def test_create_metadata_store_rest_required_fields(request_type=metadata_service.CreateMetadataStoreRequest):
...
def test_create_metadata_store_rest_interceptors(null_interceptor):
    transport = transports.MetadataServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.MetadataServiceRestInterceptor(),
        )
    client = MetadataServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_create_metadata_store") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_create_metadata_store") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.CreateMetadataStoreRequest.pb(metadata_service.CreateMetadataStoreRequest())
        ...
        client.create_metadata_store(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_metadata_store_rest_bad_request(transport: str = 'rest', request_type=metadata_service.CreateMetadataStoreRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_metadata_store_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/metadataStores" % client.transport._host, args[1])
...
def test_get_metadata_store_rest_required_fields(request_type=metadata_service.GetMetadataStoreRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_get_metadata_store_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_get_metadata_store") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_get_metadata_store") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.GetMetadataStoreRequest.pb(metadata_service.GetMetadataStoreRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metadata_store.MetadataStore.to_json(metadata_store.MetadataStore())
        ...
        client.get_metadata_store(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_metadata_store_rest_bad_request(transport: str = 'rest', request_type=metadata_service.GetMetadataStoreRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_metadata_store_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/metadataStores/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/metadataStores/*}" % client.transport._host, args[1])
...
def test_list_metadata_stores_rest_required_fields(request_type=metadata_service.ListMetadataStoresRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_list_metadata_stores_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_list_metadata_stores") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_list_metadata_stores") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.ListMetadataStoresRequest.pb(metadata_service.ListMetadataStoresRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metadata_service.ListMetadataStoresResponse.to_json(metadata_service.ListMetadataStoresResponse())
        ...
        client.list_metadata_stores(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_metadata_stores_rest_bad_request(transport: str = 'rest', request_type=metadata_service.ListMetadataStoresRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_metadata_stores_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(metadata_service.ListMetadataStoresResponse.to_json(x) for x in response)
...
def test_delete_metadata_store_rest_required_fields(request_type=metadata_service.DeleteMetadataStoreRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_delete_metadata_store_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_delete_metadata_store") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_delete_metadata_store") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.DeleteMetadataStoreRequest.pb(metadata_service.DeleteMetadataStoreRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_metadata_store(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_metadata_store_rest_bad_request(transport: str = 'rest', request_type=metadata_service.DeleteMetadataStoreRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_artifact_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/metadataStores/sample3'}
    request_init["artifact"] = {'name': 'name_value', 'display_name': 'display_name_value', 'uri': 'uri_value', 'etag': 'etag_value', 'labels': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'state': 1, 'schema_title': 'schema_title_value', 'schema_version': 'schema_version_value', 'metadata': {'fields': {}}, 'description': 'description_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_artifact_rest_required_fields(request_type=metadata_service.CreateArtifactRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_create_artifact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_create_artifact") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_create_artifact") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.CreateArtifactRequest.pb(metadata_service.CreateArtifactRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_artifact.Artifact.to_json(gca_artifact.Artifact())
...
def test_create_artifact_rest_bad_request(transport: str = 'rest', request_type=metadata_service.CreateArtifactRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_artifact_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/metadataStores/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/metadataStores/*}/artifacts" % client.transport._host, args[1])
...
def test_get_artifact_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/artifacts/sample4'}
    request = request_type(**request_init)
...
def test_get_artifact_rest_required_fields(request_type=metadata_service.GetArtifactRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_get_artifact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_get_artifact") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_get_artifact") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.GetArtifactRequest.pb(metadata_service.GetArtifactRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_artifact_rest_bad_request(transport: str = 'rest', request_type=metadata_service.GetArtifactRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_artifact_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/artifacts/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/metadataStores/*/artifacts/*}" % client.transport._host, args[1])
...
def test_list_artifacts_rest_required_fields(request_type=metadata_service.ListArtifactsRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_list_artifacts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_list_artifacts") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_list_artifacts") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.ListArtifactsRequest.pb(metadata_service.ListArtifactsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metadata_service.ListArtifactsResponse.to_json(metadata_service.ListArtifactsResponse())
...
def test_list_artifacts_rest_bad_request(transport: str = 'rest', request_type=metadata_service.ListArtifactsRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_artifacts_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(metadata_service.ListArtifactsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_update_artifact_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'artifact': {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/artifacts/sample4'}}
    request_init["artifact"] = {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/artifacts/sample4', 'display_name': 'display_name_value', 'uri': 'uri_value', 'etag': 'etag_value', 'labels': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'state': 1, 'schema_title': 'schema_title_value', 'schema_version': 'schema_version_value', 'metadata': {'fields': {}}, 'description': 'description_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_artifact_rest_required_fields(request_type=metadata_service.UpdateArtifactRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_update_artifact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_update_artifact") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_update_artifact") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.UpdateArtifactRequest.pb(metadata_service.UpdateArtifactRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_artifact(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_artifact_rest_bad_request(transport: str = 'rest', request_type=metadata_service.UpdateArtifactRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_artifact_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'artifact': {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/artifacts/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{artifact.name=projects/*/locations/*/metadataStores/*/artifacts/*}" % client.transport._host, args[1])
...
def test_delete_artifact_rest_required_fields(request_type=metadata_service.DeleteArtifactRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_delete_artifact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_delete_artifact") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_delete_artifact") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.DeleteArtifactRequest.pb(metadata_service.DeleteArtifactRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_artifact_rest_bad_request(transport: str = 'rest', request_type=metadata_service.DeleteArtifactRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_purge_artifacts_rest_required_fields(request_type=metadata_service.PurgeArtifactsRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_purge_artifacts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_purge_artifacts") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_purge_artifacts") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.PurgeArtifactsRequest.pb(metadata_service.PurgeArtifactsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.purge_artifacts(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_purge_artifacts_rest_bad_request(transport: str = 'rest', request_type=metadata_service.PurgeArtifactsRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_purge_artifacts_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/metadataStores/*}/artifacts:purge" % client.transport._host, args[1])
...
def test_create_context_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/metadataStores/sample3'}
    request_init["context"] = {'name': 'name_value', 'display_name': 'display_name_value', 'etag': 'etag_value', 'labels': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'parent_contexts': ['parent_contexts_value1', 'parent_contexts_value2'], 'schema_title': 'schema_title_value', 'schema_version': 'schema_version_value', 'metadata': {'fields': {}}, 'description': 'description_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_context_rest_required_fields(request_type=metadata_service.CreateContextRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_create_context_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_create_context") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_create_context") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.CreateContextRequest.pb(metadata_service.CreateContextRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.create_context(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_context_rest_bad_request(transport: str = 'rest', request_type=metadata_service.CreateContextRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_context_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/metadataStores/*}/contexts" % client.transport._host, args[1])
...
def test_get_context_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/contexts/sample4'}
    request = request_type(**request_init)
...
def test_get_context_rest_required_fields(request_type=metadata_service.GetContextRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_get_context_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_get_context") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_get_context") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.GetContextRequest.pb(metadata_service.GetContextRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_context(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_context_rest_bad_request(transport: str = 'rest', request_type=metadata_service.GetContextRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_context_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/contexts/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/metadataStores/*/contexts/*}" % client.transport._host, args[1])
...
def test_list_contexts_rest_required_fields(request_type=metadata_service.ListContextsRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_list_contexts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_list_contexts") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_list_contexts") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.ListContextsRequest.pb(metadata_service.ListContextsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metadata_service.ListContextsResponse.to_json(metadata_service.ListContextsResponse())
        ...
        client.list_contexts(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_contexts_rest_bad_request(transport: str = 'rest', request_type=metadata_service.ListContextsRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_contexts_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(metadata_service.ListContextsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_update_context_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'context': {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/contexts/sample4'}}
    request_init["context"] = {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/contexts/sample4', 'display_name': 'display_name_value', 'etag': 'etag_value', 'labels': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'parent_contexts': ['parent_contexts_value1', 'parent_contexts_value2'], 'schema_title': 'schema_title_value', 'schema_version': 'schema_version_value', 'metadata': {'fields': {}}, 'description': 'description_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_context_rest_required_fields(request_type=metadata_service.UpdateContextRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_update_context_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_update_context") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_update_context") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.UpdateContextRequest.pb(metadata_service.UpdateContextRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_context(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_context_rest_bad_request(transport: str = 'rest', request_type=metadata_service.UpdateContextRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_context_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'context': {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/contexts/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{context.name=projects/*/locations/*/metadataStores/*/contexts/*}" % client.transport._host, args[1])
...
def test_delete_context_rest_required_fields(request_type=metadata_service.DeleteContextRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_delete_context_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_delete_context") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_delete_context") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.DeleteContextRequest.pb(metadata_service.DeleteContextRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_context(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_context_rest_bad_request(transport: str = 'rest', request_type=metadata_service.DeleteContextRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_purge_contexts_rest_required_fields(request_type=metadata_service.PurgeContextsRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_purge_contexts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_purge_contexts") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_purge_contexts") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.PurgeContextsRequest.pb(metadata_service.PurgeContextsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.purge_contexts(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_purge_contexts_rest_bad_request(transport: str = 'rest', request_type=metadata_service.PurgeContextsRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_purge_contexts_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/metadataStores/*}/contexts:purge" % client.transport._host, args[1])
...
def test_add_context_artifacts_and_executions_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'context': 'projects/sample1/locations/sample2/metadataStores/sample3/contexts/sample4'}
    request = request_type(**request_init)
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value.status_code = 200
        # Convert return value to protobuf type
        return_value = metadata_service.AddContextArtifactsAndExecutionsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
...
def test_add_context_artifacts_and_executions_rest_required_fields(request_type=metadata_service.AddContextArtifactsAndExecutionsRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_add_context_artifacts_and_executions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_add_context_artifacts_and_executions") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_add_context_artifacts_and_executions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.AddContextArtifactsAndExecutionsRequest.pb(metadata_service.AddContextArtifactsAndExecutionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metadata_service.AddContextArtifactsAndExecutionsResponse.to_json(metadata_service.AddContextArtifactsAndExecutionsResponse())
        ...
        client.add_context_artifacts_and_executions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_add_context_artifacts_and_executions_rest_bad_request(transport: str = 'rest', request_type=metadata_service.AddContextArtifactsAndExecutionsRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_add_context_artifacts_and_executions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'context': 'projects/sample1/locations/sample2/metadataStores/sample3/contexts/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{context=projects/*/locations/*/metadataStores/*/contexts/*}:addContextArtifactsAndExecutions" % client.transport._host, args[1])


def test_add_context_artifacts_and_executions_rest_flattened_error(transport: str = 'rest'):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_add_context_children_rest_required_fields(request_type=metadata_service.AddContextChildrenRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_add_context_children_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_add_context_children") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_add_context_children") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.AddContextChildrenRequest.pb(metadata_service.AddContextChildrenRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metadata_service.AddContextChildrenResponse.to_json(metadata_service.AddContextChildrenResponse())
        ...
        client.add_context_children(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_add_context_children_rest_bad_request(transport: str = 'rest', request_type=metadata_service.AddContextChildrenRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_add_context_children_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{context=projects/*/locations/*/metadataStores/*/contexts/*}:addContextChildren" % client.transport._host, args[1])
...
def test_remove_context_children_rest_required_fields(request_type=metadata_service.RemoveContextChildrenRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_remove_context_children_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_remove_context_children") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_remove_context_children") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.RemoveContextChildrenRequest.pb(metadata_service.RemoveContextChildrenRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metadata_service.RemoveContextChildrenResponse.to_json(metadata_service.RemoveContextChildrenResponse())
        ...
        client.remove_context_children(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_remove_context_children_rest_bad_request(transport: str = 'rest', request_type=metadata_service.RemoveContextChildrenRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_remove_context_children_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{context=projects/*/locations/*/metadataStores/*/contexts/*}:removeContextChildren" % client.transport._host, args[1])
...
def test_query_context_lineage_subgraph_rest_required_fields(request_type=metadata_service.QueryContextLineageSubgraphRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_query_context_lineage_subgraph_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_query_context_lineage_subgraph") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_query_context_lineage_subgraph") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.QueryContextLineageSubgraphRequest.pb(metadata_service.QueryContextLineageSubgraphRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = lineage_subgraph.LineageSubgraph.to_json(lineage_subgraph.LineageSubgraph())
        ...
        client.query_context_lineage_subgraph(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_query_context_lineage_subgraph_rest_bad_request(transport: str = 'rest', request_type=metadata_service.QueryContextLineageSubgraphRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_context_lineage_subgraph_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{context=projects/*/locations/*/metadataStores/*/contexts/*}:queryContextLineageSubgraph" % client.transport._host, args[1])
...
def test_create_execution_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/metadataStores/sample3'}
    request_init["execution"] = {'name': 'name_value', 'display_name': 'display_name_value', 'state': 1, 'etag': 'etag_value', 'labels': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'schema_title': 'schema_title_value', 'schema_version': 'schema_version_value', 'metadata': {'fields': {}}, 'description': 'description_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_execution_rest_required_fields(request_type=metadata_service.CreateExecutionRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_create_execution_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_create_execution") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_create_execution") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.CreateExecutionRequest.pb(metadata_service.CreateExecutionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_execution.Execution.to_json(gca_execution.Execution())
        ...
        client.create_execution(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_execution_rest_bad_request(transport: str = 'rest', request_type=metadata_service.CreateExecutionRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_execution_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/metadataStores/*}/executions" % client.transport._host, args[1])
...
def test_get_execution_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/executions/sample4'}
    request = request_type(**request_init)
...
def test_get_execution_rest_required_fields(request_type=metadata_service.GetExecutionRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_get_execution_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_get_execution") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_get_execution") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.GetExecutionRequest.pb(metadata_service.GetExecutionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_execution_rest_bad_request(transport: str = 'rest', request_type=metadata_service.GetExecutionRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_execution_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/executions/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/metadataStores/*/executions/*}" % client.transport._host, args[1])
...
def test_list_executions_rest_required_fields(request_type=metadata_service.ListExecutionsRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_list_executions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_list_executions") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_list_executions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.ListExecutionsRequest.pb(metadata_service.ListExecutionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metadata_service.ListExecutionsResponse.to_json(metadata_service.ListExecutionsResponse())
...
def test_list_executions_rest_bad_request(transport: str = 'rest', request_type=metadata_service.ListExecutionsRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_executions_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(metadata_service.ListExecutionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_update_execution_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'execution': {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/executions/sample4'}}
    request_init["execution"] = {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/executions/sample4', 'display_name': 'display_name_value', 'state': 1, 'etag': 'etag_value', 'labels': {}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'schema_title': 'schema_title_value', 'schema_version': 'schema_version_value', 'metadata': {'fields': {}}, 'description': 'description_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_execution_rest_required_fields(request_type=metadata_service.UpdateExecutionRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_update_execution_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_update_execution") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_update_execution") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.UpdateExecutionRequest.pb(metadata_service.UpdateExecutionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_execution(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_execution_rest_bad_request(transport: str = 'rest', request_type=metadata_service.UpdateExecutionRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_execution_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'execution': {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/executions/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{execution.name=projects/*/locations/*/metadataStores/*/executions/*}" % client.transport._host, args[1])
...
def test_delete_execution_rest_required_fields(request_type=metadata_service.DeleteExecutionRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_delete_execution_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_delete_execution") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_delete_execution") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.DeleteExecutionRequest.pb(metadata_service.DeleteExecutionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_execution_rest_bad_request(transport: str = 'rest', request_type=metadata_service.DeleteExecutionRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_purge_executions_rest_required_fields(request_type=metadata_service.PurgeExecutionsRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_purge_executions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_purge_executions") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_purge_executions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.PurgeExecutionsRequest.pb(metadata_service.PurgeExecutionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.purge_executions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_purge_executions_rest_bad_request(transport: str = 'rest', request_type=metadata_service.PurgeExecutionsRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_purge_executions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/metadataStores/*}/executions:purge" % client.transport._host, args[1])
...
def test_add_execution_events_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'execution': 'projects/sample1/locations/sample2/metadataStores/sample3/executions/sample4'}
    request = request_type(**request_init)
...
def test_add_execution_events_rest_required_fields(request_type=metadata_service.AddExecutionEventsRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_add_execution_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_add_execution_events") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_add_execution_events") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.AddExecutionEventsRequest.pb(metadata_service.AddExecutionEventsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metadata_service.AddExecutionEventsResponse.to_json(metadata_service.AddExecutionEventsResponse())
        ...
        client.add_execution_events(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_add_execution_events_rest_bad_request(transport: str = 'rest', request_type=metadata_service.AddExecutionEventsRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_add_execution_events_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'execution': 'projects/sample1/locations/sample2/metadataStores/sample3/executions/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{execution=projects/*/locations/*/metadataStores/*/executions/*}:addExecutionEvents" % client.transport._host, args[1])
...
def test_query_execution_inputs_and_outputs_rest_required_fields(request_type=metadata_service.QueryExecutionInputsAndOutputsRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_query_execution_inputs_and_outputs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_query_execution_inputs_and_outputs") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_query_execution_inputs_and_outputs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.QueryExecutionInputsAndOutputsRequest.pb(metadata_service.QueryExecutionInputsAndOutputsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.query_execution_inputs_and_outputs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_query_execution_inputs_and_outputs_rest_bad_request(transport: str = 'rest', request_type=metadata_service.QueryExecutionInputsAndOutputsRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_execution_inputs_and_outputs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{execution=projects/*/locations/*/metadataStores/*/executions/*}:queryExecutionInputsAndOutputs" % client.transport._host, args[1])


def test_query_execution_inputs_and_outputs_rest_flattened_error(transport: str = 'rest'):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_metadata_schema_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/metadataStores/sample3'}
    request_init["metadata_schema"] = {'name': 'name_value', 'schema_version': 'schema_version_value', 'schema': 'schema_value', 'schema_type': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'description': 'description_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = metadata_service.CreateMetadataSchemaRequest.meta.fields["metadata_schema"]
...
def test_create_metadata_schema_rest_required_fields(request_type=metadata_service.CreateMetadataSchemaRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_create_metadata_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_create_metadata_schema") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_create_metadata_schema") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.CreateMetadataSchemaRequest.pb(metadata_service.CreateMetadataSchemaRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_metadata_schema.MetadataSchema.to_json(gca_metadata_schema.MetadataSchema())
        ...
        client.create_metadata_schema(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_metadata_schema_rest_bad_request(transport: str = 'rest', request_type=metadata_service.CreateMetadataSchemaRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_metadata_schema_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/metadataStores/*}/metadataSchemas" % client.transport._host, args[1])
...
def test_get_metadata_schema_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/metadataSchemas/sample4'}
    request = request_type(**request_init)
...
def test_get_metadata_schema_rest_required_fields(request_type=metadata_service.GetMetadataSchemaRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_get_metadata_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_get_metadata_schema") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_get_metadata_schema") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.GetMetadataSchemaRequest.pb(metadata_service.GetMetadataSchemaRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metadata_schema.MetadataSchema.to_json(metadata_schema.MetadataSchema())
        ...
        client.get_metadata_schema(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_metadata_schema_rest_bad_request(transport: str = 'rest', request_type=metadata_service.GetMetadataSchemaRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_metadata_schema_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/metadataStores/sample3/metadataSchemas/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/metadataStores/*/metadataSchemas/*}" % client.transport._host, args[1])
...
def test_list_metadata_schemas_rest_required_fields(request_type=metadata_service.ListMetadataSchemasRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_list_metadata_schemas_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_list_metadata_schemas") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_list_metadata_schemas") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.ListMetadataSchemasRequest.pb(metadata_service.ListMetadataSchemasRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = metadata_service.ListMetadataSchemasResponse.to_json(metadata_service.ListMetadataSchemasResponse())
        ...
        client.list_metadata_schemas(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_metadata_schemas_rest_bad_request(transport: str = 'rest', request_type=metadata_service.ListMetadataSchemasRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_metadata_schemas_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(metadata_service.ListMetadataSchemasResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_query_artifact_lineage_subgraph_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'artifact': 'projects/sample1/locations/sample2/metadataStores/sample3/artifacts/sample4'}
    request = request_type(**request_init)
...
def test_query_artifact_lineage_subgraph_rest_required_fields(request_type=metadata_service.QueryArtifactLineageSubgraphRequest):
    transport_class = transports.MetadataServiceRestTransport
...
def test_query_artifact_lineage_subgraph_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "post_query_artifact_lineage_subgraph") as post, \
         mock.patch.object(transports.MetadataServiceRestInterceptor, "pre_query_artifact_lineage_subgraph") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = metadata_service.QueryArtifactLineageSubgraphRequest.pb(metadata_service.QueryArtifactLineageSubgraphRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.query_artifact_lineage_subgraph(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_query_artifact_lineage_subgraph_rest_bad_request(transport: str = 'rest', request_type=metadata_service.QueryArtifactLineageSubgraphRequest):
    client = MetadataServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_artifact_lineage_subgraph_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'artifact': 'projects/sample1/locations/sample2/metadataStores/sample3/artifacts/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{artifact=projects/*/locations/*/metadataStores/*/artifacts/*}:queryArtifactLineageSubgraph" % client.transport._host, args[1])
...
def test_metadata_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.metadata_service.transports.MetadataServiceTransport.__init__') as Transport:
...
def test_metadata_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.metadata_service.transports.MetadataServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_metadata_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.metadata_service.transports.MetadataServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.MetadataServiceTransport()
        adc.assert_called_once()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.MetadataServiceGrpcTransport, transports.MetadataServiceGrpcAsyncIOTransport])
def test_metadata_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
