...
from google.cloud.aiplatform_v1.services.metadata_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_metadata_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
