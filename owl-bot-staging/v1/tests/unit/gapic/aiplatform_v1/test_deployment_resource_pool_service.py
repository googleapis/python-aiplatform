...
from google.cloud.aiplatform_v1.services.deployment_resource_pool_service import DeploymentResourcePoolServiceAsyncClient
from google.cloud.aiplatform_v1.services.deployment_resource_pool_service import DeploymentResourcePoolServiceClient
from google.cloud.aiplatform_v1.services.deployment_resource_pool_service import pagers
from google.cloud.aiplatform_v1.services.deployment_resource_pool_service import transports
...
from google.cloud.aiplatform_v1.types import deployment_resource_pool as gca_deployment_resource_pool
...
def test_deployment_resource_pool_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.deployment_resource_pool_service.transports.DeploymentResourcePoolServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_deployment_resource_pool_empty_call():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == deployment_resource_pool_service.CreateDeploymentResourcePoolRequest()
...
async def test_create_deployment_resource_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.create_deployment_resource_pool] = mock_object
...
@pytest.mark.asyncio
async def test_create_deployment_resource_pool_async(transport: str = 'grpc_asyncio', request_type=deployment_resource_pool_service.CreateDeploymentResourcePoolRequest):
    client = DeploymentResourcePoolServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_deployment_resource_pool_empty_call():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == deployment_resource_pool_service.GetDeploymentResourcePoolRequest()
...
async def test_get_deployment_resource_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_deployment_resource_pool] = mock_object
...
@pytest.mark.asyncio
async def test_get_deployment_resource_pool_async(transport: str = 'grpc_asyncio', request_type=deployment_resource_pool_service.GetDeploymentResourcePoolRequest):
    client = DeploymentResourcePoolServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_deployment_resource_pools_empty_call():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == deployment_resource_pool_service.ListDeploymentResourcePoolsRequest()
...
async def test_list_deployment_resource_pools_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_deployment_resource_pools] = mock_object
...
@pytest.mark.asyncio
async def test_list_deployment_resource_pools_async(transport: str = 'grpc_asyncio', request_type=deployment_resource_pool_service.ListDeploymentResourcePoolsRequest):
    client = DeploymentResourcePoolServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_deployment_resource_pool_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == deployment_resource_pool_service.UpdateDeploymentResourcePoolRequest()


def test_update_deployment_resource_pool_non_empty_request_with_auto_populated_field():
    # This test is a coverage failsafe to make sure that UUID4 fields are
    # automatically populated, according to AIP-4235, with non-empty requests.
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_update_deployment_resource_pool_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = DeploymentResourcePoolServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
async def test_update_deployment_resource_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.update_deployment_resource_pool] = mock_object
...
@pytest.mark.asyncio
async def test_update_deployment_resource_pool_async(transport: str = 'grpc_asyncio', request_type=deployment_resource_pool_service.UpdateDeploymentResourcePoolRequest):
    client = DeploymentResourcePoolServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_update_deployment_resource_pool_field_headers_async():
    client = DeploymentResourcePoolServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_update_deployment_resource_pool_flattened_error():
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_delete_deployment_resource_pool_empty_call():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == deployment_resource_pool_service.DeleteDeploymentResourcePoolRequest()
...
async def test_delete_deployment_resource_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_deployment_resource_pool] = mock_object
...
@pytest.mark.asyncio
async def test_delete_deployment_resource_pool_async(transport: str = 'grpc_asyncio', request_type=deployment_resource_pool_service.DeleteDeploymentResourcePoolRequest):
    client = DeploymentResourcePoolServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_query_deployed_models_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.query_deployed_models] = mock_object
...
@pytest.mark.asyncio
async def test_query_deployed_models_async(transport: str = 'grpc_asyncio', request_type=deployment_resource_pool_service.QueryDeployedModelsRequest):
    client = DeploymentResourcePoolServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_deployment_resource_pool_rest(request_type):
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_create_deployment_resource_pool_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DeploymentResourcePoolServiceClient(
...
def test_create_deployment_resource_pool_rest_bad_request(transport: str = 'rest', request_type=deployment_resource_pool_service.CreateDeploymentResourcePoolRequest):
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_deployment_resource_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/deploymentResourcePools" % client.transport._host, args[1])
...
def test_create_deployment_resource_pool_rest_error():
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_get_deployment_resource_pool_rest(request_type):
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_deployment_resource_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = deployment_resource_pool.DeploymentResourcePool.to_json(deployment_resource_pool.DeploymentResourcePool())
...
def test_get_deployment_resource_pool_rest_bad_request(transport: str = 'rest', request_type=deployment_resource_pool_service.GetDeploymentResourcePoolRequest):
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_deployment_resource_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/deploymentResourcePools/*}" % client.transport._host, args[1])
...
def test_get_deployment_resource_pool_rest_error():
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_list_deployment_resource_pools_rest(request_type):
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_list_deployment_resource_pools_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DeploymentResourcePoolServiceClient(
...
def test_list_deployment_resource_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = deployment_resource_pool_service.ListDeploymentResourcePoolsResponse.to_json(deployment_resource_pool_service.ListDeploymentResourcePoolsResponse())
...
def test_list_deployment_resource_pools_rest_bad_request(transport: str = 'rest', request_type=deployment_resource_pool_service.ListDeploymentResourcePoolsRequest):
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_deployment_resource_pool_rest(request_type):
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    request_init["deployment_resource_pool"] = {'name': 'projects/sample1/locations/sample2/deploymentResourcePools/sample3', 'dedicated_resources': {'machine_spec': {'machine_type': 'machine_type_value', 'accelerator_type': 1, 'accelerator_count': 1805, 'tpu_topology': 'tpu_topology_value', 'reservation_affinity': {'reservation_affinity_type': 1, 'key': 'key_value', 'values': ['values_value1', 'values_value2']}}, 'min_replica_count': 1803, 'max_replica_count': 1805, 'autoscaling_metric_specs': [{'metric_name': 'metric_name_value', 'target': 647}], 'spot': True}, 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}, 'service_account': 'service_account_value', 'disable_container_logging': True, 'create_time': {'seconds': 751, 'nanos': 543}}
    ...
    for subfield_to_delete in subfields_not_in_runtime: # pragma: NO COVER
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init["deployment_resource_pool"][field])):
                    del request_init["deployment_resource_pool"][field][i][subfield]
            else:
                del request_init["deployment_resource_pool"][field][subfield]
    request = request_type(**request_init)
...
def test_update_deployment_resource_pool_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DeploymentResourcePoolServiceClient(
...
def test_update_deployment_resource_pool_rest_bad_request(transport: str = 'rest', request_type=deployment_resource_pool_service.UpdateDeploymentResourcePoolRequest):
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_deployment_resource_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{deployment_resource_pool.name=projects/*/locations/*/deploymentResourcePools/*}" % client.transport._host, args[1])
...
def test_update_deployment_resource_pool_rest_error():
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_delete_deployment_resource_pool_rest(request_type):
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_delete_deployment_resource_pool_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DeploymentResourcePoolServiceClient(
...
def test_delete_deployment_resource_pool_rest_bad_request(transport: str = 'rest', request_type=deployment_resource_pool_service.DeleteDeploymentResourcePoolRequest):
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_deployment_resource_pool_rest_error():
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_query_deployed_models_rest(request_type):
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_query_deployed_models_rest_use_cached_wrapped_rpc():
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        client = DeploymentResourcePoolServiceClient(
...
def test_query_deployed_models_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = deployment_resource_pool_service.QueryDeployedModelsResponse.to_json(deployment_resource_pool_service.QueryDeployedModelsResponse())
...
def test_query_deployed_models_rest_bad_request(transport: str = 'rest', request_type=deployment_resource_pool_service.QueryDeployedModelsRequest):
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_query_deployed_models_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{deployment_resource_pool=projects/*/locations/*/deploymentResourcePools/*}:queryDeployedModels" % client.transport._host, args[1])
...
def test_deployment_resource_pool_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.deployment_resource_pool_service.transports.DeploymentResourcePoolServiceTransport.__init__') as Transport:
...
def test_deployment_resource_pool_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.deployment_resource_pool_service.transports.DeploymentResourcePoolServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_deployment_resource_pool_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.deployment_resource_pool_service.transports.DeploymentResourcePoolServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DeploymentResourcePoolServiceTransport()
        adc.assert_called_once()
...
def test_deployment_resource_pool_service_rest_lro_client():
    client = DeploymentResourcePoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest',
    )
...
def test_deployment_resource_pool_service_client_transport_session_collision(transport_name):
    ...
    client2 = DeploymentResourcePoolServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
    session1 = client1.transport.create_deployment_resource_pool._session
    session2 = client2.transport.create_deployment_resource_pool._session
    assert session1 != session2
    session1 = client1.transport.get_deployment_resource_pool._session
    session2 = client2.transport.get_deployment_resource_pool._session
    assert session1 != session2
    session1 = client1.transport.list_deployment_resource_pools._session
    session2 = client2.transport.list_deployment_resource_pools._session
    assert session1 != session2
    session1 = client1.transport.update_deployment_resource_pool._session
    session2 = client2.transport.update_deployment_resource_pool._session
    assert session1 != session2
    session1 = client1.transport.delete_deployment_resource_pool._session
    session2 = client2.transport.delete_deployment_resource_pool._session
    assert session1 != session2
