...
from google.cloud.aiplatform_v1.services.session_service import SessionServiceAsyncClient
from google.cloud.aiplatform_v1.services.session_service import SessionServiceClient
from google.cloud.aiplatform_v1.services.session_service import pagers
from google.cloud.aiplatform_v1.services.session_service import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert SessionServiceClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
def test_session_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.session_service.transports.SessionServiceGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.asyncio
async def test_create_session_async(transport: str = 'grpc_asyncio', request_type=session_service.CreateSessionRequest):
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_session_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_session(
            parent='parent_value',
            session=gca_session.Session(expire_time=timestamp_pb2.Timestamp(seconds=751)),
            session_id='session_id_value',
        )
...
@pytest.mark.asyncio
async def test_get_session_async(transport: str = 'grpc_asyncio', request_type=session_service.GetSessionRequest):
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_sessions_async(transport: str = 'grpc_asyncio', request_type=session_service.ListSessionsRequest):
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(session_service.ListSessionsResponse(
            next_page_token='next_page_token_value',
        ))
...
@pytest.mark.asyncio
async def test_update_session_async(transport: str = 'grpc_asyncio', request_type=session_service.UpdateSessionRequest):
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_delete_session_async(transport: str = 'grpc_asyncio', request_type=session_service.DeleteSessionRequest):
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_events_async(transport: str = 'grpc_asyncio', request_type=session_service.ListEventsRequest):
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(session_service.ListEventsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_events_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, session.SessionEvent)
                   for i in results)
...
def test_append_event(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.append_event),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_append_event_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SessionServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.append_event in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.append_event] = mock_rpc
...
@pytest.mark.asyncio
async def test_append_event_async(transport: str = 'grpc_asyncio', request_type=session_service.AppendEventRequest):
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(session_service.AppendEventResponse(
        ))
...
def test_create_session_rest_required_fields(request_type=session_service.CreateSessionRequest):
...
def test_create_session_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("sessionId", )) & set(("parent", "session", )))
...
def test_create_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/reasoningEngines/*}/sessions" % client.transport._host, args[1])
...
def test_get_session_rest_required_fields(request_type=session_service.GetSessionRequest):
    transport_class = transports.SessionServiceRestTransport
...
def test_get_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/reasoningEngines/sample3/sessions/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/reasoningEngines/*/sessions/*}" % client.transport._host, args[1])
...
def test_list_sessions_rest_required_fields(request_type=session_service.ListSessionsRequest):
    transport_class = transports.SessionServiceRestTransport
...
def test_list_sessions_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(session_service.ListSessionsResponse.to_json(x) for x in response)
...
def test_update_session_rest_required_fields(request_type=session_service.UpdateSessionRequest):
    transport_class = transports.SessionServiceRestTransport
...
def test_update_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'session': {'name': 'projects/sample1/locations/sample2/reasoningEngines/sample3/sessions/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{session.name=projects/*/locations/*/reasoningEngines/*/sessions/*}" % client.transport._host, args[1])
...
def test_delete_session_rest_required_fields(request_type=session_service.DeleteSessionRequest):
    transport_class = transports.SessionServiceRestTransport
...
def test_list_events_rest_required_fields(request_type=session_service.ListEventsRequest):
    transport_class = transports.SessionServiceRestTransport
...
def test_list_events_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/reasoningEngines/sample3/sessions/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/reasoningEngines/*/sessions/*}/events" % client.transport._host, args[1])
...
def test_list_events_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(session_service.ListEventsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_append_event_rest_required_fields(request_type=session_service.AppendEventRequest):
    transport_class = transports.SessionServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).append_event._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_append_event_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "event", )))
...
def test_append_event_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/reasoningEngines/*/sessions/*}:appendEvent" % client.transport._host, args[1])
...
def test_create_session_rest_bad_request(request_type=session_service.CreateSessionRequest):
    client = SessionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_session_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/reasoningEngines/sample3'}
    request_init["session"] = {'expire_time': {'seconds': 751, 'nanos': 543}, 'ttl': {'seconds': 751, 'nanos': 543}, 'name': 'name_value', 'create_time': {}, 'update_time': {}, 'display_name': 'display_name_value', 'labels': {}, 'session_state': {'fields': {}}, 'user_id': 'user_id_value'}
...
def test_create_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        pb_message = session_service.CreateSessionRequest.pb(session_service.CreateSessionRequest())
...
def test_get_session_rest_bad_request(request_type=session_service.GetSessionRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/reasoningEngines/sample3/sessions/sample4'}
    request = request_type(**request_init)
...
def test_get_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.GetSessionRequest.pb(session_service.GetSessionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_sessions_rest_bad_request(request_type=session_service.ListSessionsRequest):
    client = SessionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_sessions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.ListSessionsRequest.pb(session_service.ListSessionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = session_service.ListSessionsResponse.to_json(session_service.ListSessionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = session_service.ListSessionsResponse(), metadata
...
def test_update_session_rest_bad_request(request_type=session_service.UpdateSessionRequest):
    client = SessionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'session': {'name': 'projects/sample1/locations/sample2/reasoningEngines/sample3/sessions/sample4'}}
    request = request_type(**request_init)
...
def test_update_session_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'session': {'name': 'projects/sample1/locations/sample2/reasoningEngines/sample3/sessions/sample4'}}
    request_init["session"] = {'expire_time': {'seconds': 751, 'nanos': 543}, 'ttl': {'seconds': 751, 'nanos': 543}, 'name': 'projects/sample1/locations/sample2/reasoningEngines/sample3/sessions/sample4', 'create_time': {}, 'update_time': {}, 'display_name': 'display_name_value', 'labels': {}, 'session_state': {'fields': {}}, 'user_id': 'user_id_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.UpdateSessionRequest.pb(session_service.UpdateSessionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_session_rest_bad_request(request_type=session_service.DeleteSessionRequest):
    client = SessionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SessionServiceRestInterceptor, "post_delete_session") as post, \
        mock.patch.object(transports.SessionServiceRestInterceptor, "post_delete_session_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SessionServiceRestInterceptor, "pre_delete_session") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.DeleteSessionRequest.pb(session_service.DeleteSessionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_events_rest_bad_request(request_type=session_service.ListEventsRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/reasoningEngines/sample3/sessions/sample4'}
    request = request_type(**request_init)
...
def test_list_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SessionServiceRestInterceptor, "post_list_events") as post, \
        mock.patch.object(transports.SessionServiceRestInterceptor, "post_list_events_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SessionServiceRestInterceptor, "pre_list_events") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.ListEventsRequest.pb(session_service.ListEventsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = session_service.ListEventsResponse.to_json(session_service.ListEventsResponse())
        req.return_value.content = return_value
...
def test_append_event_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/reasoningEngines/sample3/sessions/sample4'}
    request_init["event"] = {'name': 'name_value', 'author': 'author_value', 'content': {'role': 'role_value', 'parts': [{'text': 'text_value', 'inline_data': {'mime_type': 'mime_type_value', 'data': b'data_blob'}, 'file_data': {'mime_type': 'mime_type_value', 'file_uri': 'file_uri_value'}, 'function_call': {'name': 'name_value', 'args': {'fields': {}}, 'partial_args': [{'null_value': 0, 'number_value': 0.1285, 'string_value': 'string_value_value', 'bool_value': True, 'json_path': 'json_path_value', 'will_continue': True}], 'will_continue': True}, 'function_response': {'name': 'name_value', 'response': {}, 'parts': [{'inline_data': {'mime_type': 'mime_type_value', 'data': b'data_blob', 'display_name': 'display_name_value'}, 'file_data': {'mime_type': 'mime_type_value', 'file_uri': 'file_uri_value', 'display_name': 'display_name_value'}}]}, 'executable_code': {'language': 1, 'code': 'code_value'}, 'code_execution_result': {'outcome': 1, 'output': 'output_value'}, 'thought': True, 'thought_signature': b'thought_signature_blob', 'video_metadata': {'start_offset': {'seconds': 751, 'nanos': 543}, 'end_offset': {}, 'fps': 0.329}, 'media_resolution': {'level': 1}}]}, 'invocation_id': 'invocation_id_value', 'actions': {'skip_summarization': True, 'state_delta': {}, 'artifact_delta': {}, 'escalate': True, 'requested_auth_configs': {}, 'transfer_agent': 'transfer_agent_value'}, 'timestamp': {'seconds': 751, 'nanos': 543}, 'error_code': 'error_code_value', 'error_message': 'error_message_value', 'event_metadata': {'grounding_metadata': {'web_search_queries': ['web_search_queries_value1', 'web_search_queries_value2'], 'search_entry_point': {'rendered_content': 'rendered_content_value', 'sdk_blob': b'sdk_blob_blob'}, 'grounding_chunks': [{'web': {'uri': 'uri_value', 'title': 'title_value'}, 'retrieved_context': {'rag_chunk': {'text': 'text_value', 'page_span': {'first_page': 1060, 'last_page': 944}}, 'uri': 'uri_value', 'title': 'title_value', 'text': 'text_value', 'document_name': 'document_name_value'}, 'maps': {'uri': 'uri_value', 'title': 'title_value', 'text': 'text_value', 'place_id': 'place_id_value', 'place_answer_sources': {'review_snippets': [{'review_id': 'review_id_value', 'google_maps_uri': 'google_maps_uri_value', 'title': 'title_value'}]}}}], 'grounding_supports': [{'segment': {'part_index': 1070, 'start_index': 1189, 'end_index': 942, 'text': 'text_value'}, 'grounding_chunk_indices': [2436, 2437], 'confidence_scores': [0.1789, 0.17900000000000002]}], 'retrieval_metadata': {'google_search_dynamic_retrieval_score': 0.3902}, 'google_maps_widget_context_token': 'google_maps_widget_context_token_value', 'source_flagging_uris': [{'source_id': 'source_id_value', 'flag_content_uri': 'flag_content_uri_value'}]}, 'partial': True, 'turn_complete': True, 'interrupted': True, 'long_running_tool_ids': ['long_running_tool_ids_value1', 'long_running_tool_ids_value2'], 'branch': 'branch_value', 'custom_metadata': {}, 'input_transcription': {'text': 'text_value', 'finished': True}, 'output_transcription': {}}, 'raw_event': {}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_append_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SessionServiceRestInterceptor, "post_append_event") as post, \
        mock.patch.object(transports.SessionServiceRestInterceptor, "post_append_event_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SessionServiceRestInterceptor, "pre_append_event") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.AppendEventRequest.pb(session_service.AppendEventRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = session_service.AppendEventResponse.to_json(session_service.AppendEventResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = session_service.AppendEventResponse(), metadata

        client.append_event(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_create_session_rest_asyncio_bad_request(request_type=session_service.CreateSessionRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_session_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "post_create_session") as post, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "post_create_session_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "pre_create_session") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.CreateSessionRequest.pb(session_service.CreateSessionRequest())
        ...
        await client.create_session(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_session_rest_asyncio_bad_request(request_type=session_service.GetSessionRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_session_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "post_get_session") as post, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "post_get_session_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "pre_get_session") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.GetSessionRequest.pb(session_service.GetSessionRequest())
        ...
        await client.get_session(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_sessions_rest_asyncio_bad_request(request_type=session_service.ListSessionsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_sessions_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "post_list_sessions") as post, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "post_list_sessions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "pre_list_sessions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.ListSessionsRequest.pb(session_service.ListSessionsRequest())
        ...
        await client.list_sessions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_update_session_rest_asyncio_bad_request(request_type=session_service.UpdateSessionRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_update_session_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "post_update_session") as post, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "post_update_session_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "pre_update_session") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.UpdateSessionRequest.pb(session_service.UpdateSessionRequest())
        ...
        await client.update_session(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_session_rest_asyncio_bad_request(request_type=session_service.DeleteSessionRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_session_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "post_delete_session") as post, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "post_delete_session_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "pre_delete_session") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.DeleteSessionRequest.pb(session_service.DeleteSessionRequest())
        ...
        await client.delete_session(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_events_rest_asyncio_bad_request(request_type=session_service.ListEventsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_events_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "post_list_events") as post, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "post_list_events_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "pre_list_events") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.ListEventsRequest.pb(session_service.ListEventsRequest())
        ...
        await client.list_events(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_append_event_rest_asyncio_bad_request(request_type=session_service.AppendEventRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_append_event_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "post_append_event") as post, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "post_append_event_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncSessionServiceRestInterceptor, "pre_append_event") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = session_service.AppendEventRequest.pb(session_service.AppendEventRequest())
        ...
        await client.append_event(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_session_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.session_service.transports.SessionServiceTransport.__init__') as Transport:
...
def test_session_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.session_service.transports.SessionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_session_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.session_service.transports.SessionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SessionServiceTransport()
        adc.assert_called_once()
...
def test_reasoning_engine_path():
    ...
    actual = SessionServiceClient.reasoning_engine_path(project, location, reasoning_engine)
...
def test_session_path():
    ...
    actual = SessionServiceClient.session_path(project, location, reasoning_engine, session)
    assert expected == actual
...
def test_session_event_path():
    ...
    session = "nudibranch"
    event = "cuttlefish"
    expected = "projects/{project}/locations/{location}/reasoningEngines/{reasoning_engine}/sessions/{session}/events/{event}".format(project=project, location=location, reasoning_engine=reasoning_engine, session=session, event=event, )
    actual = SessionServiceClient.session_event_path(project, location, reasoning_engine, session, event)
    assert expected == actual
