...
class aiplatformCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'generate_content': ('model', 'contents', 'system_instruction', 'tools', 'tool_config', 'labels', 'safety_settings', 'generation_config', ),
        ...
        'stream_generate_content': ('model', 'contents', 'system_instruction', 'tools', 'tool_config', 'labels', 'safety_settings', 'generation_config', ),
