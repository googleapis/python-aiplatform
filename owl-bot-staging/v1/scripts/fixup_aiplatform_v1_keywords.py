...
class aiplatformCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'delete_reasoning_engine': ('name', 'force', ),
        ...
        'delete_trial': ('name', ),
        'deploy': ('destination', 'publisher_model_name', 'hugging_face_model_id', 'model_config', 'endpoint_config', 'deploy_config', ),
        ...
        'embed_content': ('model', 'content', 'title', 'task_type', 'output_dimensionality', 'auto_truncate', ),
        ...
        'feature_view_direct_write': ('data_key_and_feature_values', 'feature_view', ),
        ...
        'list_model_version_checkpoints': ('name', 'page_size', 'page_token', ),
        ...
        'pause_schedule': ('name', ),
        'predict': ('endpoint', 'instances', 'parameters', 'labels', ),
        ...
        'stream_generate_content': ('model', 'contents', 'system_instruction', 'cached_content', 'tools', 'tool_config', 'labels', 'safety_settings', 'model_armor_config', 'generation_config', ),
        ...
        'update_rag_engine_config': ('rag_engine_config', ),
