...
#
# google-cloud-aiplatform-v1-schema-predict-prediction documentation build configuration file
#
...
htmlhelp_basename = "google-cloud-aiplatform-v1-schema-predict-prediction-doc"
...
texinfo_documents = [
    (
        ...
        author,
        "google-cloud-aiplatform-v1-schema-predict-prediction",
        "GAPIC library for Google Cloud Aiplatform V1 Schema Predict Prediction API",
        "APIs",
    )
]
