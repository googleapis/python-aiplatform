...
# documentation.
html_theme_options = {
    "description": "Google Cloud Aiplatform V1 Schema Trainingjob Client Libraries for google-cloud-aiplatform-v1-schema-trainingjob-definition",
...
man_pages = [
    (
        ...
        "google-cloud-aiplatform-v1-schema-trainingjob-definition Documentation",
        [author],
        1,
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google-cloud-aiplatform-v1-schema-trainingjob-definition",
        "google-cloud-aiplatform-v1-schema-trainingjob-definition Library",
        "APIs",
    )
]
