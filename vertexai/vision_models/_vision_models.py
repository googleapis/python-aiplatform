...
class EntityLabel:
    ...
    _label_: Optional[str] = None
    _score_: Optional[float] = None
    ...
    def segment_image(
        ...
        if scribble and scribble.image:
            ...
            if scribble_image._gcs_uri:
                instance["scribble"] = {
                        "image": {
                            "gcsUri": scribble_image._gcs_uri
                        }
                    }
            else:
                instance["scribble"] = {
                    "image": {
                        "bytesBase64Encoded": scribble_image._as_base64_string()
                    }
                }
