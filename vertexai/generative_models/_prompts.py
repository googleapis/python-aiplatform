...
class Prompt:
    ...
    def _validate_configs(
        ...
        generation_config = (
            generation_config if generation_config else self._generation_config
        )
        safety_settings = safety_settings if safety_settings else self._safety_settings
        tools = tools if tools else self._tools
        tool_config = tool_config if tool_config else self._tool_config
        system_instruction = (
            system_instruction if system_instruction else self._system_instruction
        )
    ...
    def generation_config(self, generation_config: GenerationConfig) -> None:
    ...
    def safety_settings(self, safety_settings: SafetySetting) -> None:
    ...
    def system_instruction(self, system_instruction: PartsType) -> None:
