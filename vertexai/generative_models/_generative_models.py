...
def _validate_generate_content_parameters(
    ...
    *,
    ...
    cached_content: Optional["_caching.CachedContent"] = None,
...
class _GenerativeModel:
    ...
    def __init__(
        ...
        *,
        ...
        self._cached_content: Optional["_caching.CachedContent"] = None
        self._labels = labels
    ...
    def from_cached_content(
        cls,
        cached_content: Union[str, "_caching.CachedContent"],
        *,
        generation_config: Optional[GenerationConfigType] = None,
        safety_settings: Optional[SafetySettingsType] = None,
    ) -> "_GenerativeModel":
