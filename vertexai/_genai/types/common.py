...
class AsyncQueryAgentEngineConfig(_common.BaseModel):
...
class AsyncQueryAgentEngineConfigDict(TypedDict, total=False):
    """Config for async querying agent engines."""
...
AsyncQueryAgentEngineConfigOrDict = Union[
    AsyncQueryAgentEngineConfig, AsyncQueryAgentEngineConfigDict
]


class _AsyncQueryAgentEngineRequestParameters(_common.BaseModel):
    """Parameters for async querying agent engines."""

    name: Optional[str] = Field(
        default=None, description="""Name of the agent engine."""
    )
    config: Optional[AsyncQueryAgentEngineConfig] = Field(
        default=None, description=""""""
    )


class _AsyncQueryAgentEngineRequestParametersDict(TypedDict, total=False):
    """Parameters for async querying agent engines."""

    name: Optional[str]
    """Name of the agent engine."""

    config: Optional[AsyncQueryAgentEngineConfigDict]
    """"""


_AsyncQueryAgentEngineRequestParametersOrDict = Union[
    _AsyncQueryAgentEngineRequestParameters, _AsyncQueryAgentEngineRequestParametersDict
]
