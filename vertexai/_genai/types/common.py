...
class CreateSandboxEnvironmentTemplateOperation(_common.BaseModel):
    """Operation that has a sandbox template as a response."""
    ...
    response: Optional[SandboxEnvironmentTemplate] = Field(
        default=None, description="""The Sandbox Environment Template."""
    )


class CreateSandboxEnvironmentTemplateOperationDict(TypedDict, total=False):
    """Operation that has a sandbox template as a response."""
    ...
    """The Sandbox Environment Template."""


CreateSandboxEnvironmentTemplateOperationOrDict = Union[
    CreateSandboxEnvironmentTemplateOperation,
    CreateSandboxEnvironmentTemplateOperationDict,
]
