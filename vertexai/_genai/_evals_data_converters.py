...
def get_dataset_converter(
    ...
    if dataset_schema == _EvalDatasetSchema.GEMINI:
        return _GeminiEvalDataConverter()
    elif dataset_schema == _EvalDatasetSchema.FLATTEN:
        return _FlattenEvalDataConverter()
    else:
