...
class _GeminiEvalDataConverter(_evals_constant.EvalDataConverter):
...
class _FlattenEvalDataConverter(_evals_constant.EvalDataConverter):
...
class _OpenAIDataConverter(_evals_constant.EvalDataConverter):
...
) -> _evals_constant.EvalDataConverter:
