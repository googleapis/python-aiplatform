...
class CreateAgentEngineOperation(_common.BaseModel):
    """Operation for creating agent engines."""
...
class CreateAgentEngineOperationDict(TypedDict, total=False):
    """Operation for creating agent engines."""
...
CreateAgentEngineOperationOrDict = Union[
    CreateAgentEngineOperation, CreateAgentEngineOperationDict
]
...
class StreamQueryAgentEngineConfig(_common.BaseModel):
    """Config for stream querying agent engines."""
...
class StreamQueryAgentEngineConfigDict(TypedDict, total=False):
    """Config for stream querying agent engines."""
...
StreamQueryAgentEngineConfigOrDict = Union[
    StreamQueryAgentEngineConfig, StreamQueryAgentEngineConfigDict
]


class _StreamQueryAgentEngineRequestParameters(_common.BaseModel):
    """Parameters for stream querying agent engines."""

    name: Optional[str] = Field(
        default=None, description="""Name of the agent engine."""
    )
    config: Optional[StreamQueryAgentEngineConfig] = Field(
        default=None, description=""""""
    )


class _StreamQueryAgentEngineRequestParametersDict(TypedDict, total=False):
    """Parameters for stream querying agent engines."""

    name: Optional[str]
    """Name of the agent engine."""

    config: Optional[StreamQueryAgentEngineConfigDict]
    """"""


_StreamQueryAgentEngineRequestParametersOrDict = Union[
    _StreamQueryAgentEngineRequestParameters,
    _StreamQueryAgentEngineRequestParametersDict,
]


class StreamQueryAgentEngineResponse(_common.BaseModel):
    """The response for streaming a query for an agent engine."""
...
class StreamQueryAgentEngineResponseDict(TypedDict, total=False):
    """The response for streaming a query for an agent engine."""
...
StreamQueryAgentEngineResponseOrDict = Union[
    StreamQueryAgentEngineResponse, StreamQueryAgentEngineResponseDict
]
...
class UpdateAgentEngineOperation(_common.BaseModel):
    """Operation for creating agent engines."""
...
class UpdateAgentEngineOperationDict(TypedDict, total=False):
    """Operation for creating agent engines."""
...
UpdateAgentEngineOperationOrDict = Union[
    UpdateAgentEngineOperation, UpdateAgentEngineOperationDict
]
...
class AgentEngine(_common.BaseModel):
    ...
    def delete(self):
        ...
        if not isinstance(self.api_resource, ReasoningEngine):
            raise ValueError("api_resource is not initialized.")
        self.api_client.delete(name=self.api_resource.name, config={"force": True})
