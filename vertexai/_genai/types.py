...
class UpdateAgentEngineOperation(_common.BaseModel):
    """Operation for updating agent engines."""
    ...
    response: Optional[ReasoningEngine] = Field(
        default=None, description="""The updated Agent Engine."""
    )
...
class UpdateOperationConfig(_common.BaseModel):
...
class UpdateOperationConfigDict(TypedDict, total=False):

    http_options: Optional[HttpOptionsDict]
    """Used to override HTTP request options."""


UpdateOperationConfigOrDict = Union[UpdateOperationConfig, UpdateOperationConfigDict]


class _UpdateOperationParameters(_common.BaseModel):
    """Parameters for the GET method."""
    ...
    config: Optional[UpdateOperationConfig] = Field(
        default=None,
        description="""Used to override the default configuration.""",
    )


class _UpdateOperationParametersDict(TypedDict, total=False):
    """Parameters for the GET method."""

    operation_name: Optional[str]
    """The server-assigned name for the operation."""

    config: Optional[UpdateOperationConfigDict]
    """Used to override the default configuration."""


_UpdateOperationParametersOrDict = Union[
    _UpdateOperationParameters, _UpdateOperationParametersDict
]
