...
def __getattr__(name: str) -> typing.Any:
    ...
    # Dynamically expose types from google.genai.types
    if hasattr(genai_types, name):
...
class SchemaPromptSpecStructuredPrompt(_common.BaseModel):
    ...
    context: Optional[Content] = Field(
...
class SchemaPromptSpecReferenceSentencePairList(_common.BaseModel):
    ...
    reference_sentence_pairs: Optional[
        list[SchemaPromptSpecReferenceSentencePair]
...
class _CreateDatasetParameters(_common.BaseModel):
    ...
    encryption_spec: Optional[EncryptionSpec] = Field(default=None, description="""""")
...
class GenericOperationMetadata(_common.BaseModel):
    ...
    partial_failures: Optional[list[GoogleRpcStatus]] = Field(
        default=None,
...
class GenericOperationMetadataDict(TypedDict, total=False):
    ...
    partial_failures: Optional[list[GoogleRpcStatusDict]]
...
CreateDatasetVersionOperationMetadataOrDict = Union[
    ...
    CreateDatasetVersionOperationMetadataDict,
]
...
class Prompt(_common.BaseModel):
    ...
    prompt_data: Optional[
        Union[genai_types.PartUnion, list[genai_types.PartUnion]]
    ] = Field(default=None, description="""""")
    variables: Optional[list[dict[str, genai_types.PartUnion]]] = Field(
        default=None, description=""""""
    )
    prompt_name: Optional[str] = Field(default=None, description="""""")
    generation_config: Optional[genai_types.GenerateContentConfig] = Field(
        default=None, description=""""""
    )
    ...
    system_instruction: Optional[str] = Field(default=None, description="""""")
    encryption_spec: Optional[EncryptionSpec] = Field(default=None, description="""""")
...
class PromptDict(TypedDict, total=False):
    ...
    prompt_data: Optional[Union[genai_types.PartUnion, list[genai_types.PartUnion]]]
    """"""

    variables: Optional[list[dict[str, genai_types.PartUnion]]]
    """"""
    ...
    safety_settings: Optional[genai_types.SafetySetting]
    """"""
