...
class OptimizePromptConfig(_common.BaseModel):
...
class OptimizePromptConfigDict(TypedDict, total=False):
    """Config for Prompt Optimizer."""
...
OptimizePromptConfigOrDict = Union[OptimizePromptConfig, OptimizePromptConfigDict]
...
class _OptimizePromptRequestParams(_common.BaseModel):
    """Request for the optimize_prompt method."""

    content: Optional[Content] = Field(default=None, description="""""")
    config: Optional[OptimizePromptConfig] = Field(default=None, description="""""")


class _OptimizePromptRequestParamsDict(TypedDict, total=False):
    """Request for the optimize_prompt method."""

    content: Optional[ContentDict]
    """"""

    config: Optional[OptimizePromptConfigDict]
    """"""


_OptimizePromptRequestParamsOrDict = Union[
    _OptimizePromptRequestParams, _OptimizePromptRequestParamsDict
]
