...
class GetProjectOperationConfig(_common.BaseModel):
    """Config for getting a project operation."""
...
class GetProjectOperationConfigDict(TypedDict, total=False):
    """Config for getting a project operation."""
...
GetProjectOperationConfigOrDict = Union[
    GetProjectOperationConfig, GetProjectOperationConfigDict
]


class _GetProjectOperationParameters(_common.BaseModel):
    """Parameters for getting a project operation."""

    config: Optional[GetProjectOperationConfig] = Field(
        default=None, description=""""""
    )
    operation_id: Optional[str] = Field(default=None, description="""""")
...
class _GetProjectOperationParametersDict(TypedDict, total=False):
    ...
    config: Optional[GetProjectOperationConfigDict]
    """"""
