...
class GoogleApiHttpBody(_common.BaseModel):
    """A Google API HTTP body."""
...
class GoogleApiHttpBodyDict(TypedDict, total=False):
    """A Google API HTTP body."""
...
GoogleApiHttpBodyOrDict = Union[GoogleApiHttpBody, GoogleApiHttpBodyDict]
