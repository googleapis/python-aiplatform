...
class PromptManagement(_api_module.BaseModule):
    ...
    def _wait_for_operation(
        ...
        while not done:
            ...
            # and (prompt_dataset_operation.response is not None and prompt_dataset_operation.response.get("metadata") is not None and prompt_dataset_operation.response.get("name") is not None)
        if (
