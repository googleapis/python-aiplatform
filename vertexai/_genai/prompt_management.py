...
def _SchemaTextPromptDatasetMetadata_to_vertex(
    ...
    if getv(from_object, ["candidate_count"]) is not None:
        setv(
            to_object,
            ["candidateCount"],
            getv(from_object, ["candidate_count"]),
        )
    ...
    if getv(from_object, ["grounding_config"]) is not None:
        setv(
            to_object,
            ["groundingConfig"],
            getv(from_object, ["grounding_config"]),
        )
    ...
    if getv(from_object, ["has_prompt_variable"]) is not None:
        setv(
            to_object,
            ["hasPromptVariable"],
            getv(from_object, ["has_prompt_variable"]),
        )
    ...
    if getv(from_object, ["prompt_api_schema"]) is not None:
        setv(
            to_object,
            ["promptApiSchema"],
            getv(from_object, ["prompt_api_schema"]),
        )
...
def _CreateDatasetParameters_to_vertex(
    ...
    if getv(from_object, ["metadata_schema_uri"]) is not None:
        setv(
            to_object,
            ["metadataSchemaUri"],
            getv(from_object, ["metadata_schema_uri"]),
        )
    ...
    if getv(from_object, ["model_reference"]) is not None:
        setv(
            to_object,
            ["modelReference"],
            getv(from_object, ["model_reference"]),
        )
...
def _CreateDatasetOperationMetadata_from_vertex(
    ...
    if getv(from_object, ["genericMetadata"]) is not None:
        setv(
            to_object,
            ["generic_metadata"],
            getv(from_object, ["genericMetadata"]),
        )
...
def _SchemaTextPromptDatasetMetadata_from_vertex(
    ...
    if getv(from_object, ["candidateCount"]) is not None:
        setv(
            to_object,
            ["candidate_count"],
            getv(from_object, ["candidateCount"]),
        )
    ...
    if getv(from_object, ["groundingConfig"]) is not None:
        setv(
            to_object,
            ["grounding_config"],
            getv(from_object, ["groundingConfig"]),
        )
    ...
    if getv(from_object, ["hasPromptVariable"]) is not None:
        setv(
            to_object,
            ["has_prompt_variable"],
            getv(from_object, ["hasPromptVariable"]),
        )
    ...
    if getv(from_object, ["maxOutputTokens"]) is not None:
        setv(
            to_object,
            ["max_output_tokens"],
            getv(from_object, ["maxOutputTokens"]),
        )
    ...
    if getv(from_object, ["promptApiSchema"]) is not None:
        setv(
            to_object,
            ["prompt_api_schema"],
            getv(from_object, ["promptApiSchema"]),
        )
...
def _Dataset_from_vertex(
    ...
    if getv(from_object, ["metadataArtifact"]) is not None:
        setv(
            to_object,
            ["metadata_artifact"],
            getv(from_object, ["metadataArtifact"]),
        )
    ...
    if getv(from_object, ["metadataSchemaUri"]) is not None:
        setv(
            to_object,
            ["metadata_schema_uri"],
            getv(from_object, ["metadataSchemaUri"]),
        )
    ...
    if getv(from_object, ["modelReference"]) is not None:
        setv(
            to_object,
            ["model_reference"],
            getv(from_object, ["modelReference"]),
        )
...
class PromptManagement(_api_module.BaseModule):
    def _create_dataset_resource(
        ...
        *,
        ...
        encryption_spec: Optional[types.EncryptionSpecOrDict] = None,
    ...
    def create_version(
        ...
        *,
        ...
        if dataset_id and prompt._dataset and dataset_id not in prompt._dataset.name:
        ...
        if not dataset_id:
            create_prompt_dataset_operation = self._create_dataset_resource(
                ...
                encryption_spec=prompt.encryption_spec,
            )
            if not create_prompt_dataset_operation.sdk_http_response:
                raise ValueError("Error creating prompt dataset resource.")
            response_operation_name = json.loads(
                create_prompt_dataset_operation.sdk_http_response.body
            )["name"]
        ...
        if not create_dataset_version_operation.sdk_http_response:
            raise ValueError("Error creating prompt version resource.")
        dataset_version_operation_name = json.loads(
            create_dataset_version_operation.sdk_http_response.body
        )["name"]
        dataset_version_operation_id = dataset_version_operation_name.split("/")[-1]
        prompt_dataset_operation = self._wait_for_operation(
            dataset_id=dataset_id,
            operation_id=dataset_version_operation_id,
        )
        ...
        dataset_version_id = json.loads(
            prompt_dataset_operation.sdk_http_response.body
    ...
    def _wait_for_operation(
        ...
        dataset_id: str,
        operation_id: str,
    ) -> Optional[types.DatasetOperationMetadata]:
        done = False
        ...
        operation_response = prompt_dataset_operation.sdk_http_response
        ...
        return prompt_dataset_operation
