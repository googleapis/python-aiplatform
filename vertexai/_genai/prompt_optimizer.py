...
def _CustomJobSpec_to_vertex(
    ...
    if getv(from_object, ["experiment_run"]) is not None:
        setv(
            to_object, ["experimentRun"], getv(from_object, ["experiment_run"])
        )
...
def _CustomJob_to_vertex(
    ...
    if getv(from_object, ["job_spec"]) is not None:
        setv(
            parent_object,
            ["jobSpec"],
            _CustomJobSpec_to_vertex(
                getv(from_object, ["job_spec"]), to_object
            ),
        )
    ...
    if getv(from_object, ["web_access_uris"]) is not None:
        setv(
            to_object, ["webAccessUris"], getv(from_object, ["web_access_uris"])
        )
...
def _CustomJobSpec_from_vertex(
    ...
    if getv(from_object, ["experimentRun"]) is not None:
        setv(
            to_object, ["experiment_run"], getv(from_object, ["experimentRun"])
        )
...
def _CustomJob_from_vertex(
    ...
    if getv(parent_object, ["jobSpec"]) is not None:
        setv(
            to_object,
            ["job_spec"],
            _CustomJobSpec_from_vertex(
                getv(parent_object, ["jobSpec"]), to_object
            ),
        )
    ...
    if getv(from_object, ["webAccessUris"]) is not None:
        setv(
            to_object, ["web_access_uris"], getv(from_object, ["webAccessUris"])
        )
...
class PromptOptimizer(_api_module.BaseModule):
    ...
    def _create_custom_job_resource(
        ...
        *,
        ...
        print(request_dict, 'request dict before sending\n\n')
    ...
    def optimize(
        ...
        job_spec = types.CustomJobSpec(
            ...
            base_output_directory=types.GcsDestination(
