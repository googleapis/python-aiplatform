...
logger = logging.getLogger("vertexai_genai.sandboxtemplates")
        ...
        Creates a new sandbox template in the Agent Engine.
            ...
            Args:
                name (str):
                    ...
                    Format: projects/{project}/locations/{location}/agentEngines/{agent_engine}
                display_name (str):
        ...
        Delete an Agent Engine sandbox template.
            ...
            Args:
                name (str):
                    ...
                    Format: projects/{project}/locations/{location}/sandboxTemplates/{sandbox_template}
    ...
    def list(
        ...
        *,
        ...
        Lists Agent Engine sandbox templates.
            ...
            Args:
                name (str): Name of the agent engine. Format: projects/{project}/locations/{location}/agentEngines/{agent_engine}
