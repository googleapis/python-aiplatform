...
class AgentEngines(_api_module.BaseModule):
    ...
    def list_memories(
        ...
        *,
        ...
        return Pager(
            "memories",
            functools.partial(self._list_memories, name=name),
    ...
    def list_sessions(
        ...
        *,
        ...
        return Pager(
            "sessions",
            functools.partial(self._list_sessions, name=name),
    ...
    def list_session_events(
        ...
        *,
        ...
        Returns:
            Iterable[SessionEvent]: An iterable of session events.
        """

        return Pager(
            "session_events",
            functools.partial(self._list_session_events, name=name),
            self._list_session_events(name=name, config=config),
            config,
        )
    ...
    def append_session_event(
        ...
        *,
        ...
        Args:
            name (str): Required. The name of the agent engine session to append
              events for.
            author (str): Required. The author of the session event.
            invocation_id (str): Required. The invocation ID of the session
              event.
            timestamp (datetime.datetime): Required. The timestamp of the
              session event.
            config (AppendAgentEngineSessionEventConfig): Optional. The
              configuration for the session event to append.
        """
