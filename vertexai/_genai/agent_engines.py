...
def _StreamQueryAgentEngineResponse_from_vertex(
    api_client: BaseApiClient,
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
...
class AgentEngines(_api_module.BaseModule):
    ...
    def _stream_query(
        ...
        *,
    ...
    ) -> Iterator[types.StreamQueryAgentEngineResponse]:
        ...
        for response_dict in self._api_client.request_streamed(
            ...
            if self._api_client.vertexai:
                response_dict = _StreamQueryAgentEngineResponse_from_vertex(
                    self._api_client, response_dict
                )

            return_value = types.StreamQueryAgentEngineResponse._from_response(
                response=response_dict, kwargs=parameter_model.model_dump()
            )
            self._api_client._verify_response(return_value)
            yield return_value
...
class AsyncAgentEngines(_api_module.BaseModule):
    ...
    async def _stream_query(
        ...
        *,
        name: str,
        config: Optional[types.StreamQueryAgentEngineConfigOrDict] = None,
    ) -> Awaitable[AsyncIterator[types.StreamQueryAgentEngineResponse]]:
        """Streams a response to a query for an Agent Engine."""
