...
class AgentEngines(_api_module.BaseModule):
    ...
    def _is_lightweight_creation(
        ...
        if (
            agent is not None
            or config.source_packages is not None
            or config.developer_connect_source is not None
        ):
            return False
        return True
    ...
    def _set_source_code_spec(
        ...
        *,
        ...
        """Sets source code spec for agent engine."""
        source_code_spec = {}
        ...
        elif developer_connect_source is not None:
    ...
    def _create_config(
        ...
        *,
        ...
        elif source_packages is not None and developer_connect_source is not None:
            raise ValueError(
        ...
        elif source_packages is not None or developer_connect_source is not None:
            agent_engine_spec = {}
