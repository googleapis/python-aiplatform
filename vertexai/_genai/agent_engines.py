...
def _StreamQueryAgentEngineConfig_to_vertex(
    api_client: BaseApiClient,
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
...
def _StreamQueryAgentEngineRequestParameters_to_vertex(
    api_client: BaseApiClient,
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    ...
    if getv(from_object, ["config"]) is not None:
        setv(
            to_object,
            ["config"],
            _StreamQueryAgentEngineConfig_to_vertex(
                api_client, getv(from_object, ["config"]), to_object
            ),
        )
...
def _GoogleApiHttpBody_from_vertex(
    api_client: BaseApiClient,
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
    ...
    if getv(from_object, ["extensions"]) is not None:
        setv(to_object, ["extensions"], getv(from_object, ["extensions"]))
...
class AgentEngines(_api_module.BaseModule):
    ...
    def _stream_query(
        ...
        *,
        name: str,
        config: Optional[types.StreamQueryAgentEngineConfigOrDict] = None,
    ) -> Iterator[types.GoogleApiHttpBody]:
        """Streams a response to a query for an Agent Engine."""

        parameter_model = types._StreamQueryAgentEngineRequestParameters(
            name=name,
            config=config,
        )
        ...
        if not self._api_client.vertexai:
            ...
            request_dict = _StreamQueryAgentEngineRequestParameters_to_vertex(
                self._api_client, parameter_model
            )
            request_url_dict = request_dict.get("_url")
            if request_url_dict:
        ...
        for response_dict in self._api_client.request_streamed(
            ...
            if self._api_client.vertexai:
                response_dict = _GoogleApiHttpBody_from_vertex(
                    self._api_client, response_dict
                )

            return_value = types.GoogleApiHttpBody._from_response(
                response=response_dict, kwargs=parameter_model.model_dump()
            )
            self._api_client._verify_response(return_value)
            yield return_value
...
class AsyncAgentEngines(_api_module.BaseModule):
    ...
    async def _stream_query(
        ...
        *,
        name: str,
        config: Optional[types.StreamQueryAgentEngineConfigOrDict] = None,
    ) -> Awaitable[AsyncIterator[types.GoogleApiHttpBody]]:
        """Streams a response to a query for an Agent Engine."""
