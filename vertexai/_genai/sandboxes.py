...
class Sandboxes(_api_module.BaseModule):
    ...
    def delete(
        ...
        *,
        ...
        Args:
            name (str): Required. The name of the Agent Engine sandbox to be
              deleted. Format:
    ...
    def _list(
        ...
        *,
        ...
        Args:
            ...
            config (ListAgentEngineSandboxesConfig): Optional. Additional
              configurations for listing the Agent Engine sandboxes.

        Returns:
            ListReasoningEnginesSandboxesResponse: The requested Agent Engine
            sandboxes.
        """
    ...
    def create(
        ...
        *,
        ...
        Args:
            name (str): Required. The name of the agent engine to create sandbox
              for.
            spec (SandboxEnvironmentSpec): Optional. The specification for the
              sandbox to create.
            config (CreateAgentEngineSandboxConfigOrDict): Optional. The
    ...
    def list(
        ...
        *,
        ...
        Args:
            name (str): Required. The name of the agent engine to list sandboxes
              for.
            config (ListAgentEngineSandboxConfig): Optional. The configuration
              for the sandboxes to list.

        Returns:
            Iterable[SandboxEnvironment]: An iterable of memories.
        """
        return Pager(
            "sandbox_environments",
