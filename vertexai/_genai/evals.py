...
class Evals(_api_module.BaseModule):
    ...
    def get_evaluation_run(
        ...
        *,
        ...
        # Map bigqueryRequestSet to bigquery_source.
        data_source = response_dict.get("dataSource")
        if "bigqueryRequestSet" in data_source:
            data_source["bigquery_source"] = data_source.pop("bigqueryRequestSet")
