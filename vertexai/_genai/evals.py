...
class Evals(_api_module.BaseModule):
    ...
    def get_evaluation_run(
        ...
        *,
        ...
        result.evaluation_result = _evals_common._get_eval_result_from_eval_run(
            self._api_client, result.evaluation_results
        )
        return result
    ...
    @_common.experimental_warning(
        "The Vertex SDK GenAI evals.get_evaluation_set module is experimental, "
        "and may change in future versions."
    )
    ...
    @_common.experimental_warning(
        "The Vertex SDK GenAI evals.get_evaluation_item module is experimental, "
        "and may change in future versions."
    )
