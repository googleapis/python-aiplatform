...
class OpenModel:
  ...
  def deploy(
    ...
    if use_dedicated_endpoint:
      request.endpoint_config.dedicated_endpoint_enabled = (
  ...
  def list_deploy_options(
    ...
    response = self._us_central1_model_garden_client.get_publisher_model(
        request
    )
    deploy_options = (
...
class PartnerModel:
  ...
  def __init__(
    ...
    Usage:
        ...
        ```
        model = OpenModel("publishers/ai21/models/jamba-large-1.6@001")
        ```
