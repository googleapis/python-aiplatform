...
class DevkitAgent:
    ...
    def set_up(self):
        ...
        os.environ["GOOGLE_CLOUD_LOCATION"] = self._tmpl_attrs.get("location")
        ...
        if "GOOGLE_CLOUD_AGENT_ENGINE_ID" in os.environ:
            ...
            self._tmpl_attrs["session_service"].api_client._http_options["base_url"] = (
                f"https://{self._tmpl_attrs.get("api_endpoint")}"
            )
        ...
        app_name = self._tmpl_attrs.get(
            "agent_engine_id",
            self._tmpl_attrs.get("runner_kwargs", {}).get("app_name", ""),
        )
    ...
    def get_session(
        ...
        **kwargs,
        ...
        session = self._tmpl_attrs.get("session_service").get_session(
            app_name=self._tmpl_attrs.get("agent_engine_id", ""),
            user_id=user_id,
