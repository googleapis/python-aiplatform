...
You will first judge responses individually, following the Rating Rubric and Evaluation Steps. Then you will give step-by-step explanations for your judgement, compare the results to declare the winner based on the Rating Rubric and Evaluation Steps.
...
You will assign the response a rating from the Rating Rubric by foolowing the Evaluation Steps. Give step-by-step explanations for your rating, and only choose ratings from the Rating Rubric.
...
# Evaluation
## Metric Definition
You will be assessing question answering quality, which measures the overall quality of the answer to the question in user prompt. The instruction for performing a question-answering task is provided in the user prompt.
