...
def distill_model(
    *,
    ...
    Args:
        student_model:
            Student model name for distillation, e.g., "gemma".
        teacher_model:
            Teacher model name for distillation, e.g., "gemini-1.0-pro-002".
    ...
    if isinstance(student_model, generative_models.GenerativeModel):
        student_model = student_model._prediction_resource_name  # pylint: disable=protected-access
