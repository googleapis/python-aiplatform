...
class ModelServiceAsyncClient:
  ...
  training_pipeline_path = staticmethod(
      ModelServiceClient.training_pipeline_path)
  ...
  parse_common_folder_path = staticmethod(
      ModelServiceClient.parse_common_folder_path)
  common_organization_path = staticmethod(
      ModelServiceClient.common_organization_path)
  ...
  def from_service_account_info(cls, info: dict, *args, **kwargs):
    """Creates an instance of this client using the provided credentials.
        ...
        """
    return ModelServiceClient.from_service_account_info.__func__(
        ModelServiceAsyncClient, info, *args, **kwargs)  # type: ignore
  ...
  def from_service_account_file(cls, filename: str, *args, **kwargs):
    """Creates an instance of this client using the provided credentials.
        ...
        Returns:
            ModelServiceAsyncClient: The constructed client.
        """
    return ModelServiceClient.from_service_account_file.__func__(
        ModelServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
  ...
  def get_mtls_endpoint_and_cert_source(
    ...
    """Return the API endpoint and client cert source for mutual TLS.
        ...
        """
    return ModelServiceClient.get_mtls_endpoint_and_cert_source(
    ...
    """Instantiates the model service client.
        ...
        Args:
            credentials (Optional[google.auth.credentials.Credentials]): The
              ...
              environment.
            transport (Union[str, ~.ModelServiceTransport]): The transport to
  ...
  async def upload_model(
    ...
    r"""Uploads a Model artifact into Vertex AI.
            ...
            into which to upload the Model. Format:
            ``projects/{project}/locations/{location}``  This corresponds to the
            ``parent`` field on the ``request`` instance; if ``request`` is
            provided, this should not be set. model
            (:class:`google.cloud.aiplatform_v1.types.Model`): Required. The
            Model to create. This corresponds to the ``model`` field on the
            ``request`` instance; if ``request`` is provided, this should not be
            set.
  ...
  async def get_model(
    ...
    r"""Gets a Model.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.GetModelRequest, dict]): The
            request object. Request message for
            [ModelService.GetModel][google.cloud.aiplatform.v1.ModelService.GetModel].
            name (:class:`str`): Required. The name of the Model resource.
                  Format:
                  ``projects/{project}/locations/{location}/models/{model}`` In
                  order to retrieve a specific version of the model, also
                  provide the version ID or version alias. Example:
                  ``projects/{project}/locations/{location}/models/{model}@2``
                  or
                  ``projects/{project}/locations/{location}/models/{model}@golden``
                  If no version ID or alias is specified, the "default" version
                  will be returned. The "default" version alias is created for
                  the first version of the model, and can be moved to other
  ...
  async def list_models(
    ...
    r"""Lists Models in a Location.
            ...
            parent (:class:`str`): Required. The resource name of the Location
            to list the Models from. Format:
            ``projects/{project}/locations/{location}``  This corresponds to the
            ``parent`` field on the ``request`` instance; if ``request`` is
  ...
  async def list_model_versions(
    ...
    r"""Lists versions of the specified model.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListModelVersionsRequest,
            ...
            name (:class:`str`): Required. The name of the model to list
            versions for.  This corresponds to the ``name`` field on the
            ``request`` instance; if ``request`` is provided, this should not be
            set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
  ...
  async def update_model(
    ...
    r"""Updates a Model.
            ...
            model (:class:`google.cloud.aiplatform_v1.types.Model`): Required.
            The Model which replaces the resource on the server. When Model
            Versioning is enabled, the model.name will be used to determine
            whether to update the model or model version.  1. model.name with
            the @ value, e.g. models/123@1, refers to a version specific update.
            2. model.name without the @ value, e.g. models/123, refers to a
            model update. 3. model.name with @-, e.g. models/123@-, refers to a
            model update. 4. Supported model fields: display_name, description;
            supported version-specific fields: version_description. Labels are
            supported in both scenarios. Both the model labels and the version
            labels are merged when a model is returned. When updating labels, if
            the request is for model-specific update, model label gets updated.
            Otherwise, version labels get updated. 5. A model name or model
            version name fields update mismatch will cause a precondition error.
            6. One request cannot update both the model and the version fields.
            You must update them separately.  This corresponds to the ``model``
            field on the ``request`` instance; if ``request`` is provided, this
            should not be set. update_mask
            (:class:`google.protobuf.field_mask_pb2.FieldMask`): Required. The
            update mask applies to the resource. For the ``FieldMask``
            definition, see
            [google.protobuf.FieldMask][google.protobuf.FieldMask].  This
            corresponds to the ``update_mask`` field on the ``request``
            instance; if ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
  ...
  async def delete_model(
    ...
    r"""Deletes a Model.
            ...
            name (:class:`str`): Required. The name of the Model resource to be
            deleted.
                    Format:
  ...
  async def delete_model_version(
    ...
    r"""Deletes a Model version.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.DeleteModelVersionRequest,
            dict]): The request object. Request message for
            [ModelService.DeleteModelVersion][google.cloud.aiplatform.v1.ModelService.DeleteModelVersion].
            name (:class:`str`): Required. The name of the model version to be
            deleted, with a version ID explicitly included.
                    Example:
  ...
  async def merge_version_aliases(
    ...
    r"""Merges a set of aliases for a Model version.
            ...
            .. code-block:: python
                ...
                async def sample_merge_version_aliases():
                    ...
                    request = aiplatform_v1.MergeVersionAliasesRequest(
                        name="name_value",
                        version_aliases=['version_aliases_value_1',
                        'version_aliases_value_2'],
                    )
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.MergeVersionAliasesRequest,
            dict]): The request object. Request message for
            [ModelService.MergeVersionAliases][google.cloud.aiplatform.v1.ModelService.MergeVersionAliases].
            name (:class:`str`): Required. The name of the model version to
            merge aliases, with a version ID explicitly included.
                    Example:
                    ``projects/{project}/locations/{location}/models/{model}@1234``
                    This corresponds to the ``name`` field on the ``request``
                    instance; if ``request`` is provided, this should not be
                    set. version_aliases (:class:`Sequence[str]`): Required. The
                    set of version aliases to merge. The alias should be at most
                    128 characters, and match
                    ``[a-z][a-z0-9-]{0,126}[a-z-0-9]``. Add the ``-`` prefix to
                    an alias means removing that alias from the version. ``-``
                    is NOT counted in the 128 characters.
                      Example: ``-golden`` means removing the ``golden`` alias
                      from the version.  There is NO ordering in aliases, which
                      means  1) The aliases returned from GetModel API might not
                      have the exactly same order from this MergeVersionAliases
                      API. 2) Adding and deleting the same alias in the request
                      is not recommended, and the 2 operations will be cancelled
                      out.  This corresponds to the ``version_aliases`` field on
                      the ``request`` instance; if ``request`` is provided, this
                      should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
  ...
  async def export_model(
    ...
    r"""Exports a trained, exportable Model to a location specified by
            ...
            name (:class:`str`): Required. The resource name of the Model to
            export. The resource name may contain version id or version alias to
            specify the version, if no version is specified, the default version
            will be exported.  This corresponds to the ``name`` field on the
            ``request`` instance; if ``request`` is provided, this should not be
            set. output_config
            (:class:`google.cloud.aiplatform_v1.types.ExportModelRequest.OutputConfig`):
            Required. The desired output location and configuration.  This
            corresponds to the ``output_config`` field on the ``request``
            instance; if ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
  ...
  async def import_model_evaluation(
    ...
    r"""Imports an externally generated ModelEvaluation.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ImportModelEvaluationRequest,
            dict]): The request object. Request message for
            [ModelService.ImportModelEvaluation][google.cloud.aiplatform.v1.ModelService.ImportModelEvaluation]
            parent (:class:`str`): Required. The name of the parent model
            resource. Format:
            ``projects/{project}/locations/{location}/models/{model}``  This
            corresponds to the ``parent`` field on the ``request`` instance; if
            ``request`` is provided, this should not be set. model_evaluation
            (:class:`google.cloud.aiplatform_v1.types.ModelEvaluation`):
            Required. Model evaluation resource to be imported.  This
            corresponds to the ``model_evaluation`` field on the ``request``
            instance; if ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
  ...
  async def get_model_evaluation(
    ...
    r"""Gets a ModelEvaluation.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.GetModelEvaluationRequest,
            dict]): The request object. Request message for
            [ModelService.GetModelEvaluation][google.cloud.aiplatform.v1.ModelService.GetModelEvaluation].
            name (:class:`str`): Required. The name of the ModelEvaluation
            resource.
                    Format:
  ...
  async def list_model_evaluations(
    ...
    r"""Lists ModelEvaluations in a Model.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListModelEvaluationsRequest,
            dict]): The request object. Request message for
            [ModelService.ListModelEvaluations][google.cloud.aiplatform.v1.ModelService.ListModelEvaluations].
            parent (:class:`str`): Required. The resource name of the Model to
            list the ModelEvaluations from. Format:
            ``projects/{project}/locations/{location}/models/{model}``  This
            corresponds to the ``parent`` field on the ``request`` instance; if
  ...
  async def get_model_evaluation_slice(
    ...
    r"""Gets a ModelEvaluationSlice.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.GetModelEvaluationSliceRequest,
            dict]): The request object. Request message for
            [ModelService.GetModelEvaluationSlice][google.cloud.aiplatform.v1.ModelService.GetModelEvaluationSlice].
            name (:class:`str`): Required. The name of the ModelEvaluationSlice
            resource.
                    Format:
  ...
  async def list_model_evaluation_slices(
      self,
      request: Union[model_service.ListModelEvaluationSlicesRequest,
                     dict] = None,
      *,
      parent: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Lists ModelEvaluationSlices in a ModelEvaluation.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListModelEvaluationSlicesRequest,
            dict]): The request object. Request message for
            [ModelService.ListModelEvaluationSlices][google.cloud.aiplatform.v1.ModelService.ListModelEvaluationSlices].
            parent (:class:`str`): Required. The resource name of the
            ModelEvaluation to list the ModelEvaluationSlices from. Format:
            ``projects/{project}/locations/{location}/models/{model}/evaluations/{evaluation}``
  ...
  async def delete_operation(
    ...
    r"""Deletes a long-running operation.
            ...
            Args: request (:class:`~.operations_pb2.DeleteOperationRequest`):
            The
  ...
  async def cancel_operation(
    ...
    r"""Starts asynchronous cancellation on a long-running operation.
            ...
            Args: request (:class:`~.operations_pb2.CancelOperationRequest`):
            The
  ...
  async def wait_operation(
    ...
    r"""Waits until the specified long-running operation is done or reaches at most
            ...
            returned.
            If the timeout specified is greater than the default HTTP/RPC
            timeout,
            the HTTP/RPC
  ...
  async def test_iam_permissions(
    ...
    r"""Tests the specified IAM permissions against the IAM access control
            ...
            Args: request (:class:`~.iam_policy_pb2.TestIamPermissionsRequest`):
            The
  ...
  async def get_location(
    ...
    r"""Gets information about a location.
            ...
            Args: request (:class:`~.location_pb2.GetLocationRequest`): The
            request
