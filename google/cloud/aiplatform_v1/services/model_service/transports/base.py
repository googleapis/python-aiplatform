...
class ModelServiceTransport(abc.ABC):
  ...
  def __init__(
    ...
    if (always_use_jwt_access and
        isinstance(credentials, service_account.Credentials) and
        hasattr(service_account.Credentials, 'with_always_use_jwt_access')):
  ...
  def upload_model(
      self,
  ) -> Callable[[model_service.UploadModelRequest], Union[
  ...
  def get_model(
      self,
  ) -> Callable[[model_service.GetModelRequest], Union[model.Model,
  ...
  def list_models(
      self,
  ) -> Callable[[model_service.ListModelsRequest],
                Union[model_service.ListModelsResponse,
  ...
  def list_model_versions(
      self,
  ) -> Callable[[model_service.ListModelVersionsRequest],
                Union[model_service.ListModelVersionsResponse,
  ...
  def update_model(
      self,
  ) -> Callable[[model_service.UpdateModelRequest], Union[
      gca_model.Model, Awaitable[gca_model.Model]],]:
    raise NotImplementedError()

  @property
  def delete_model(
      self,
  ) -> Callable[[model_service.DeleteModelRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def delete_model_version(
      self,
  ) -> Callable[[model_service.DeleteModelVersionRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def merge_version_aliases(
      self,
  ) -> Callable[[model_service.MergeVersionAliasesRequest], Union[
      model.Model, Awaitable[model.Model]],]:
    raise NotImplementedError()

  @property
  def export_model(
      self,
  ) -> Callable[[model_service.ExportModelRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def import_model_evaluation(
      self,
  ) -> Callable[[model_service.ImportModelEvaluationRequest],
                Union[gca_model_evaluation.ModelEvaluation,
  ...
  def get_model_evaluation(
      self,
  ) -> Callable[[model_service.GetModelEvaluationRequest],
                Union[model_evaluation.ModelEvaluation,
  ...
  def list_model_evaluations(
      self,
  ) -> Callable[[model_service.ListModelEvaluationsRequest],
                Union[model_service.ListModelEvaluationsResponse,
  ...
  def get_model_evaluation_slice(
      self,
  ) -> Callable[[model_service.GetModelEvaluationSliceRequest], Union[
  ...
  def list_model_evaluation_slices(
      self,
  ) -> Callable[[model_service.ListModelEvaluationSlicesRequest], Union[
  ...
  def list_operations(
      self,
                ...
                Union[operations_pb2.ListOperationsResponse,
  ...
  def get_operation(
      self,
  ) -> Callable[[operations_pb2.GetOperationRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def wait_operation(
      self,
  ) -> Callable[[operations_pb2.WaitOperationRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def set_iam_policy(
      self,
  ) -> Callable[[iam_policy_pb2.SetIamPolicyRequest], Union[
      policy_pb2.Policy, Awaitable[policy_pb2.Policy]],]:
    raise NotImplementedError()

  @property
  def get_iam_policy(
      self,
  ) -> Callable[[iam_policy_pb2.GetIamPolicyRequest], Union[
      policy_pb2.Policy, Awaitable[policy_pb2.Policy]],]:
    raise NotImplementedError()
  ...
  def test_iam_permissions(
      self,
                ...
                Union[iam_policy_pb2.TestIamPermissionsResponse,
  ...
  def get_location(
      self,
  ) -> Callable[[locations_pb2.GetLocationRequest], Union[
      locations_pb2.Location, Awaitable[locations_pb2.Location]],]:
    raise NotImplementedError()
  ...
  def list_locations(
      self,
                ...
                Union[locations_pb2.ListLocationsResponse,
