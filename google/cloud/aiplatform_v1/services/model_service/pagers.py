  ...
  def __init__(self,
    ...
    """Instantiate the pager.
        ...
        Args:
            ...
            request (google.cloud.aiplatform_v1.types.ListModelsRequest): The
              initial request object.
            response (google.cloud.aiplatform_v1.types.ListModelsResponse): The
...
class ListModelVersionsPager:
  """A pager for iterating through ``list_model_versions`` requests.
    ...
    This class thinly wraps an initial
    :class:`google.cloud.aiplatform_v1.types.ListModelVersionsResponse` object,
    and
    provides an ``__iter__`` method to iterate through its
    ``models`` field.
    ...
    All the usual
    :class:`google.cloud.aiplatform_v1.types.ListModelVersionsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    """Instantiate the pager.
        ...
        Args:
            ...
            request (google.cloud.aiplatform_v1.types.ListModelVersionsRequest):
              ...
              (google.cloud.aiplatform_v1.types.ListModelVersionsResponse): The
              initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be sent
              along with the request as metadata.
    """
...
class ListModelVersionsAsyncPager:
  ...
  @property
  async def pages(
      self) -> AsyncIterator[model_service.ListModelVersionsResponse]:
    yield self._response
    while self._response.next_page_token:
      self._request.page_token = self._response.next_page_token
      self._response = await self._method(
...
class ListModelEvaluationsPager:
  """A pager for iterating through ``list_model_evaluations`` requests.
    ...
    This class thinly wraps an initial
    :class:`google.cloud.aiplatform_v1.types.ListModelEvaluationsResponse`
    object, and
    provides an ``__iter__`` method to iterate through its
...
class ListModelEvaluationsAsyncPager:
  ...
  @property
  async def pages(
      self) -> AsyncIterator[model_service.ListModelEvaluationsResponse]:
    yield self._response
    while self._response.next_page_token:
      self._request.page_token = self._response.next_page_token
      self._response = await self._method(
...
class ListModelEvaluationSlicesPager:
  """A pager for iterating through ``list_model_evaluation_slices`` requests.
    ...
    This class thinly wraps an initial
    :class:`google.cloud.aiplatform_v1.types.ListModelEvaluationSlicesResponse`
    object, and
    provides an ``__iter__`` method to iterate through its
...
class ListModelEvaluationSlicesAsyncPager:
  ...
  @property
  async def pages(
      self,) -> AsyncIterator[model_service.ListModelEvaluationSlicesResponse]:
    yield self._response
    while self._response.next_page_token:
      self._request.page_token = self._response.next_page_token
      self._response = await self._method(
  ...
  def __aiter__(
      self) -> AsyncIterator[model_evaluation_slice.ModelEvaluationSlice]:
