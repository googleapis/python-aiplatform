...
class ModelServiceClientMeta(type):
  """Metaclass for the ModelService client.
    ...
    support objects (e.g. transport) without polluting the client
    instance objects.
    """
...
class ModelServiceClient(metaclass=ModelServiceClientMeta):
    ...
    """Instantiates the model service client.
        ...
        Args:
            credentials (Optional[google.auth.credentials.Credentials]): The
              ...
              environment.
            transport (Union[str, ModelServiceTransport]): The transport to use.
  ...
  def upload_model(
    ...
    r"""Uploads a Model artifact into Vertex AI.
            ...
            [ModelService.UploadModel][google.cloud.aiplatform.v1.ModelService.UploadModel].
                parent (str): Required. The resource name of the Location into
                which to upload the Model. Format:
                ...
                model (google.cloud.aiplatform_v1.types.Model): Required. The
  ...
  def get_model(
    ...
    r"""Gets a Model.
            ...
            [ModelService.GetModel][google.cloud.aiplatform.v1.ModelService.GetModel].
                ...
                order to retrieve a specific version of the model, also provide
                the version ID or version alias. Example:
                ...
                will be returned. The "default" version alias is created for the
                first version of the model, and can be moved to other versions
                later on. There will be exactly one default version.  This
  ...
  def list_models(
    ...
    r"""Lists Models in a Location.
            ...
            [ModelService.ListModels][google.cloud.aiplatform.v1.ModelService.ListModels].
                parent (str): Required. The resource name of the Location to
                list the Models from. Format:
                ``projects/{project}/locations/{location}``  This corresponds to
                the ``parent`` field on the ``request`` instance; if ``request``
                is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  def list_model_versions(
    ...
    r"""Lists versions of the specified model.
            ...
            [ModelService.ListModelVersions][google.cloud.aiplatform.v1.ModelService.ListModelVersions].
                name (str): Required. The name of the model to list versions
                for. This corresponds to the ``name`` field on the ``request``
  ...
  def update_model(
    ...
    r"""Updates a Model.
            ...
            [ModelService.UpdateModel][google.cloud.aiplatform.v1.ModelService.UpdateModel].
                model (google.cloud.aiplatform_v1.types.Model): Required. The
                Model which replaces the resource on the server. When Model
                Versioning is enabled, the model.name will be used to determine
                whether to update the model or model version.  1. model.name
                with the @ value, e.g. models/123@1, refers to a version
                specific update. 2. model.name without the @ value, e.g.
                models/123, refers to a model update. 3. model.name with @-,
                e.g. models/123@-, refers to a model update. 4. Supported model
                fields: display_name, description; supported version-specific
                fields: version_description. Labels are supported in both
                scenarios. Both the model labels and the version labels are
                merged when a model is returned. When updating labels, if the
                request is for model-specific update, model label gets updated.
                Otherwise, version labels get updated. 5. A model name or model
                version name fields update mismatch will cause a precondition
                error. 6. One request cannot update both the model and the
                version fields. You must update them separately.  This
                corresponds to the ``model`` field on the ``request`` instance;
                if ``request`` is provided, this should not be set.
  ...
  def delete_model(
    ...
    r"""Deletes a Model.
            ...
            [ModelService.DeleteModel][google.cloud.aiplatform.v1.ModelService.DeleteModel].
                name (str): Required. The name of the Model resource to be
                deleted.
                    Format:
  ...
  def delete_model_version(
    ...
    r"""Deletes a Model version.
            ...
            [ModelService.DeleteModelVersion][google.cloud.aiplatform.v1.ModelService.DeleteModelVersion].
                name (str): Required. The name of the model version to be
  ...
  def merge_version_aliases(
    ...
    r"""Merges a set of aliases for a Model version.
            ...
            [ModelService.MergeVersionAliases][google.cloud.aiplatform.v1.ModelService.MergeVersionAliases].
                name (str): Required. The name of the model version to merge
                aliases, with a version ID explicitly included.
                    ...
                    instance; if ``request`` is provided, this should not be
                    set.
                version_aliases (Sequence[str]): Required. The set of version
                aliases to merge. The alias should be at most 128 characters,
                and match ``[a-z][a-z0-9-]{0,126}[a-z-0-9]``. Add the ``-``
                prefix to an alias means removing that alias from the version.
                ``-`` is NOT counted in the 128 characters. Example: ``-golden``
                means removing the ``golden`` alias from the version.  There is
                NO ordering in aliases, which means  1) The aliases returned
                from GetModel API might not have the exactly same order from
                this MergeVersionAliases API. 2) Adding and deleting the same
                alias in the request is not recommended, and the 2 operations
                will be cancelled out.  This corresponds to the
                ``version_aliases`` field on the ``request`` instance; if
    ...
    rpc = self._transport._wrapped_methods[
        self._transport.merge_version_aliases]
  ...
  def export_model(
    ...
    r"""Exports a trained, exportable Model to a location specified by
            ...
            [ModelService.ExportModel][google.cloud.aiplatform.v1.ModelService.ExportModel].
                ...
                specify the version, if no version is specified, the default
                version will be exported.  This corresponds to the ``name``
                field on the ``request`` instance; if ``request`` is provided,
                this should not be set. output_config
  ...
  def import_model_evaluation(
    ...
    r"""Imports an externally generated ModelEvaluation.
            ...
            [ModelService.ImportModelEvaluation][google.cloud.aiplatform.v1.ModelService.ImportModelEvaluation]
                parent (str): Required. The name of the parent model resource.
                  Format:
                  ``projects/{project}/locations/{location}/models/{model}``
                  This corresponds to the ``parent`` field on the ``request``
                  instance; if ``request`` is provided, this should not be set.
                model_evaluation
                (google.cloud.aiplatform_v1.types.ModelEvaluation): Required.
                Model evaluation resource to be imported.  This corresponds to
                the ``model_evaluation`` field on the ``request`` instance; if
                ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
    ...
    # and friendly error handling.
    rpc = self._transport._wrapped_methods[
        self._transport.import_model_evaluation]
  ...
  def get_model_evaluation(
    ...
    r"""Gets a ModelEvaluation.
            ...
            [ModelService.GetModelEvaluation][google.cloud.aiplatform.v1.ModelService.GetModelEvaluation].
                name (str): Required. The name of the ModelEvaluation resource.
                    Format:
  ...
  def list_model_evaluations(
    ...
    r"""Lists ModelEvaluations in a Model.
            ...
            [ModelService.ListModelEvaluations][google.cloud.aiplatform.v1.ModelService.ListModelEvaluations].
                parent (str): Required. The resource name of the Model to list
                the ModelEvaluations from. Format:
  ...
  def get_model_evaluation_slice(
    ...
    r"""Gets a ModelEvaluationSlice.
            ...
            [ModelService.GetModelEvaluationSlice][google.cloud.aiplatform.v1.ModelService.GetModelEvaluationSlice].
                name (str): Required. The name of the ModelEvaluationSlice
                resource.
                    Format:
  ...
  def list_model_evaluation_slices(
    ...
    r"""Lists ModelEvaluationSlices in a ModelEvaluation.
            ...
            [ModelService.ListModelEvaluationSlices][google.cloud.aiplatform.v1.ModelService.ListModelEvaluationSlices].
                ...
                to list the ModelEvaluationSlices from. Format:
                ``projects/{project}/locations/{location}/models/{model}/evaluations/{evaluation}``
                This corresponds to the ``parent`` field on the ``request``
                instance; if ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  def __exit__(self, type, value, traceback):
    """Releases underlying transport's resources.
        ...
        .. warning::     ONLY use as a context manager if the transport
        is NOT shared     with other clients! Exiting the with block
        will CLOSE the transport     and may cause errors in other
        clients!
        """
