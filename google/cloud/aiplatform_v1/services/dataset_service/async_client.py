...
class DatasetServiceAsyncClient:
  ...
  parse_annotation_path = staticmethod(
      DatasetServiceClient.parse_annotation_path)
  ...
  def from_service_account_info(cls, info: dict, *args, **kwargs):
    """Creates an instance of this client using the provided credentials.
        ...
        """
    return DatasetServiceClient.from_service_account_info.__func__(
        DatasetServiceAsyncClient, info, *args, **kwargs)  # type: ignore
  ...
  def from_service_account_file(cls, filename: str, *args, **kwargs):
    """Creates an instance of this client using the provided credentials.
        ...
        Returns:
            DatasetServiceAsyncClient: The constructed client.
        """
    return DatasetServiceClient.from_service_account_file.__func__(
        DatasetServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
  ...
  def get_mtls_endpoint_and_cert_source(
    ...
    """Return the API endpoint and client cert source for mutual TLS.
        ...
        """
    return DatasetServiceClient.get_mtls_endpoint_and_cert_source(
    ...
    """Instantiates the dataset service client.
        ...
        Args:
            credentials (Optional[google.auth.credentials.Credentials]): The
              ...
              environment.
            transport (Union[str, ~.DatasetServiceTransport]): The transport to
  ...
  async def create_dataset(
    ...
    r"""Creates a Dataset.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CreateDatasetRequest,
            ...
            to create the Dataset in. Format:
            ``projects/{project}/locations/{location}``  This corresponds to the
            ``parent`` field on the ``request`` instance; if ``request`` is
            provided, this should not be set. dataset
            (:class:`google.cloud.aiplatform_v1.types.Dataset`): Required. The
            Dataset to create. This corresponds to the ``dataset`` field on the
  ...
  async def get_dataset(
    ...
    r"""Gets a Dataset.
            ...
            name (:class:`str`): Required. The name of the Dataset resource.
  ...
  async def update_dataset(
    ...
    r"""Updates a Dataset.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.UpdateDatasetRequest,
            dict]): The request object. Request message for
            ...
            This corresponds to the ``dataset`` field on the ``request``
            instance; if ``request`` is provided, this should not be set.
            update_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
            Required. The update mask applies to the resource. For the
            ``FieldMask`` definition, see
            [google.protobuf.FieldMask][google.protobuf.FieldMask]. Updatable
                  fields:  -  ``display_name`` -  ``description`` -  ``labels``
                  This corresponds to the ``update_mask`` field on the
  ...
  async def list_datasets(
    ...
    r"""Lists Datasets in a Location.
            ...
            parent (:class:`str`): Required. The name of the Dataset's parent
            resource.
  ...
  async def delete_dataset(
    ...
    r"""Deletes a Dataset.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.DeleteDatasetRequest,
            dict]): The request object. Request message for
            [DatasetService.DeleteDataset][google.cloud.aiplatform.v1.DatasetService.DeleteDataset].
            name (:class:`str`): Required. The resource name of the Dataset to
            delete.
                    Format:
    ...
    r"""Imports data into a Dataset.
            ...
            .. code-block:: python
                ...
                async def sample_import_data():
                    ...
                    import_configs.gcs_source.uris = ['uris_value_1',
                    'uris_value_2']
            ...
            name (:class:`str`): Required. The name of the Dataset resource.
                  ...
                  Required. The desired input locations. The contents of all
                  input locations will be imported in one batch.  This
                  corresponds to the ``import_configs`` field on the ``request``
                  instance; if ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
    ...
    r"""Exports data from a Dataset.
            ...
            .. code-block:: python
                ...
                async def sample_export_data():
                    ...
                    export_config.gcs_destination.output_uri_prefix =
            ...
            name (:class:`str`): Required. The name of the Dataset resource.
                  ...
                  instance; if ``request`` is provided, this should not be set.
                  export_config
                  (:class:`google.cloud.aiplatform_v1.types.ExportDataConfig`):
                  Required. The desired output location.  This corresponds to
                  the ``export_config`` field on the ``request`` instance; if
  ...
  async def list_data_items(
    ...
    r"""Lists DataItems in a Dataset.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListDataItemsRequest,
            dict]): The request object. Request message for
            [DatasetService.ListDataItems][google.cloud.aiplatform.v1.DatasetService.ListDataItems].
            parent (:class:`str`): Required. The resource name of the Dataset to
            list DataItems from. Format:
            ``projects/{project}/locations/{location}/datasets/{dataset}`` This
  ...
  async def get_annotation_spec(
    ...
    r"""Gets an AnnotationSpec.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.GetAnnotationSpecRequest,
            dict]): The request object. Request message for
            [DatasetService.GetAnnotationSpec][google.cloud.aiplatform.v1.DatasetService.GetAnnotationSpec].
            name (:class:`str`): Required. The name of the AnnotationSpec
            resource.
                    Format:
  ...
  async def list_annotations(
    ...
    r"""Lists Annotations belongs to a dataitem
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListAnnotationsRequest,
            dict]): The request object. Request message for
            [DatasetService.ListAnnotations][google.cloud.aiplatform.v1.DatasetService.ListAnnotations].
            parent (:class:`str`): Required. The resource name of the DataItem
            to list Annotations from. Format:
