  ...
  def __init__(self,
    ...
    """Instantiate the pager.
        ...
        Args:
            ...
            request (google.cloud.aiplatform_v1.types.ListDatasetsRequest): The
...
class ListDataItemsPager:
  """A pager for iterating through ``list_data_items`` requests.
    ...
    All the usual
    :class:`google.cloud.aiplatform_v1.types.ListDataItemsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
  ...
  def __init__(self,
    ...
    """Instantiate the pager.
        ...
        Args:
            method (Callable): The method that was originally called, and which
              instantiated this pager.
            request (google.cloud.aiplatform_v1.types.ListDataItemsRequest): The
              initial request object.
...
class ListAnnotationsPager:
  """A pager for iterating through ``list_annotations`` requests.
    ...
    This class thinly wraps an initial
    :class:`google.cloud.aiplatform_v1.types.ListAnnotationsResponse` object,
    and
    provides an ``__iter__`` method to iterate through its
    ``annotations`` field.
    ...
    All the usual
    :class:`google.cloud.aiplatform_v1.types.ListAnnotationsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
