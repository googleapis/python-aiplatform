...
class DatasetServiceTransport(abc.ABC):
  ...
  def create_dataset(
      self,
  ) -> Callable[[dataset_service.CreateDatasetRequest], Union[
  ...
  def get_dataset(
      self,
  ) -> Callable[[dataset_service.GetDatasetRequest], Union[
      dataset.Dataset, Awaitable[dataset.Dataset]],]:
    raise NotImplementedError()

  @property
  def update_dataset(
      self,
  ) -> Callable[[dataset_service.UpdateDatasetRequest], Union[
      gca_dataset.Dataset, Awaitable[gca_dataset.Dataset]],]:
    raise NotImplementedError()
  ...
  def list_datasets(
      self,
                ...
                Union[dataset_service.ListDatasetsResponse,
  ...
  def delete_dataset(
      self,
  ) -> Callable[[dataset_service.DeleteDatasetRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def import_data(
      self,
  ) -> Callable[[dataset_service.ImportDataRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def export_data(
      self,
  ) -> Callable[[dataset_service.ExportDataRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def list_data_items(
      self,
                ...
                Union[dataset_service.ListDataItemsResponse,
  ...
  def get_annotation_spec(
      self,
                ...
                Union[annotation_spec.AnnotationSpec,
  ...
  def list_annotations(
      self,
                ...
                Union[dataset_service.ListAnnotationsResponse,
