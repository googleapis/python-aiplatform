    ...
    r"""Reads Feature values of a specific entity of an
            ...
            .. code-block:: python
                ...
                async def sample_read_feature_values():
                    # Create a client
                    client =
                    aiplatform_v1.FeaturestoreOnlineServingServiceAsyncClient()

                    # Initialize request argument(s)
                    feature_selector = aiplatform_v1.FeatureSelector()
                    feature_selector.id_matcher.ids = ['ids_value_1',
                    'ids_value_2']
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ReadFeatureValuesRequest,
            ...
            For example, for a machine learning model predicting user clicks on
            a website, an EntityType ID could be ``user``.  This corresponds to
            the ``entity_type`` field on the ``request`` instance; if
  ...
  def streaming_read_feature_values(
    ...
    r"""Reads Feature values for multiple entities.
        ...
        Depending
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.StreamingReadFeatureValuesRequest,
            dict]): The request object. Request message for
