...
class ListFeaturestoresPager:
  """A pager for iterating through ``list_featurestores`` requests.
    ...
    :class:`google.cloud.aiplatform_v1.types.ListFeaturestoresResponse` object,
    and
    ...
    All the usual
    :class:`google.cloud.aiplatform_v1.types.ListFeaturestoresResponse`
    ...
    """Instantiate the pager.
        ...
        Args:
            ...
            request (google.cloud.aiplatform_v1.types.ListFeaturestoresRequest):
              ...
              (google.cloud.aiplatform_v1.types.ListFeaturestoresResponse): The
...
class ListEntityTypesPager:
  """A pager for iterating through ``list_entity_types`` requests.
    ...
    This class thinly wraps an initial
    :class:`google.cloud.aiplatform_v1.types.ListEntityTypesResponse` object,
    and
    provides an ``__iter__`` method to iterate through its
    ``entity_types`` field.
    ...
    All the usual
    :class:`google.cloud.aiplatform_v1.types.ListEntityTypesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
  ...
  def __init__(self,
    ...
    """Instantiate the pager.
        ...
        Args:
            method (Callable): The method that was originally called, and which
              instantiated this pager.
            request (google.cloud.aiplatform_v1.types.ListFeaturesRequest): The
...
class SearchFeaturesPager:
  """A pager for iterating through ``search_features`` requests.
    ...
    All the usual
    :class:`google.cloud.aiplatform_v1.types.SearchFeaturesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
