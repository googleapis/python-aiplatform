...
class FeaturestoreServiceTransport(abc.ABC):
  ...
  def create_featurestore(
      self,
  ) -> Callable[[featurestore_service.CreateFeaturestoreRequest], Union[
  ...
  def get_featurestore(
      self,
  ) -> Callable[[featurestore_service.GetFeaturestoreRequest], Union[
      featurestore.Featurestore, Awaitable[featurestore.Featurestore]],]:
    raise NotImplementedError()

  @property
  def list_featurestores(
      self,
  ) -> Callable[[featurestore_service.ListFeaturestoresRequest], Union[
  ...
  def update_featurestore(
      self,
  ) -> Callable[[featurestore_service.UpdateFeaturestoreRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def delete_featurestore(
      self,
  ) -> Callable[[featurestore_service.DeleteFeaturestoreRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def create_entity_type(
      self,
  ) -> Callable[[featurestore_service.CreateEntityTypeRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def get_entity_type(
      self,
  ) -> Callable[[featurestore_service.GetEntityTypeRequest], Union[
      entity_type.EntityType, Awaitable[entity_type.EntityType]],]:
    raise NotImplementedError()

  @property
  def list_entity_types(
      self,
  ) -> Callable[[featurestore_service.ListEntityTypesRequest], Union[
  ...
  def update_entity_type(
      self,
  ) -> Callable[[featurestore_service.UpdateEntityTypeRequest], Union[
      gca_entity_type.EntityType, Awaitable[gca_entity_type.EntityType]],]:
    raise NotImplementedError()

  @property
  def delete_entity_type(
      self,
  ) -> Callable[[featurestore_service.DeleteEntityTypeRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def create_feature(
      self,
  ) -> Callable[[featurestore_service.CreateFeatureRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def batch_create_features(
      self,
  ) -> Callable[[featurestore_service.BatchCreateFeaturesRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def get_feature(
      self,
  ) -> Callable[[featurestore_service.GetFeatureRequest], Union[
      feature.Feature, Awaitable[feature.Feature]],]:
    raise NotImplementedError()
  ...
  def list_features(
      self,
                ...
                Union[featurestore_service.ListFeaturesResponse,
  ...
  def update_feature(
      self,
  ) -> Callable[[featurestore_service.UpdateFeatureRequest], Union[
      gca_feature.Feature, Awaitable[gca_feature.Feature]],]:
    raise NotImplementedError()

  @property
  def delete_feature(
      self,
  ) -> Callable[[featurestore_service.DeleteFeatureRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def import_feature_values(
      self,
  ) -> Callable[[featurestore_service.ImportFeatureValuesRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def batch_read_feature_values(
      self,
  ) -> Callable[[featurestore_service.BatchReadFeatureValuesRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def export_feature_values(
      self,
  ) -> Callable[[featurestore_service.ExportFeatureValuesRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def search_features(
      self,
  ) -> Callable[[featurestore_service.SearchFeaturesRequest], Union[
