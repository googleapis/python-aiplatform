...
class PipelineServiceAsyncClient:
  ...
  async def create_training_pipeline(
    ...
    r"""Creates a TrainingPipeline.
        ...
        A created
            ...
            provided, this should not be set. training_pipeline
            (:class:`google.cloud.aiplatform_v1.types.TrainingPipeline`):
  ...
  async def create_pipeline_job(
    ...
    r"""Creates a PipelineJob.
        ...
        A PipelineJob will run
            ...
            ``projects/{project}/locations/{location}``  This corresponds to the
            ``parent`` field on the ``request`` instance; if ``request`` is
            provided, this should not be set. pipeline_job
            (:class:`google.cloud.aiplatform_v1.types.PipelineJob`): Required.
            The PipelineJob to create. This corresponds to the ``pipeline_job``
            field on the ``request`` instance; if ``request`` is provided, this
            should not be set. pipeline_job_id (:class:`str`): The ID to use for
            the PipelineJob, which will become the final component of the
            ...
            characters are /[a-z][0-9]-/.  This corresponds to the
            ``pipeline_job_id`` field on the ``request`` instance; if
            ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
  ...
  async def get_pipeline_job(
    ...
    r"""Gets a PipelineJob.
            ...
            name (:class:`str`): Required. The name of the PipelineJob resource.
            Format:
