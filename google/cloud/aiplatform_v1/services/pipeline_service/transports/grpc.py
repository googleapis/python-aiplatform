...
class PipelineServiceGrpcTransport(PipelineServiceTransport):
  ...
  def operations_client(self) -> operations_v1.OperationsClient:
    """Create the client designed to process long-running operations.
        ...
        This property caches on the instance; repeated calls return the
        same client.
        """
  ...
  def create_training_pipeline(
    ...
    if 'create_training_pipeline' not in self._stubs:
      self._stubs['create_training_pipeline'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=pipeline_service.CreateTrainingPipelineRequest
          .serialize,
          response_deserializer=gca_training_pipeline.TrainingPipeline
          .deserialize,
      )
  ...
  def list_training_pipelines(
      self,
  ) -> Callable[[pipeline_service.ListTrainingPipelinesRequest],
    ...
    if 'list_training_pipelines' not in self._stubs:
      self._stubs['list_training_pipelines'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=pipeline_service.ListTrainingPipelinesRequest
          .serialize,
          response_deserializer=pipeline_service.ListTrainingPipelinesResponse
          .deserialize,
      )
  ...
  def delete_training_pipeline(
      self,
  ) -> Callable[[pipeline_service.DeleteTrainingPipelineRequest],
    ...
    if 'delete_training_pipeline' not in self._stubs:
      self._stubs['delete_training_pipeline'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=pipeline_service.DeleteTrainingPipelineRequest
          .serialize,
  ...
  def cancel_training_pipeline(
      self,
  ) -> Callable[[pipeline_service.CancelTrainingPipelineRequest],
                empty_pb2.Empty]:
    ...
    if 'cancel_training_pipeline' not in self._stubs:
      self._stubs['cancel_training_pipeline'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=pipeline_service.CancelTrainingPipelineRequest
          .serialize,
  ...
  def create_pipeline_job(
      self,
  ) -> Callable[[pipeline_service.CreatePipelineJobRequest],
    ...
    if 'create_pipeline_job' not in self._stubs:
      self._stubs['create_pipeline_job'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=pipeline_service.CreatePipelineJobRequest
          .serialize,
  ...
  def get_pipeline_job(
      self,
  ) -> Callable[[pipeline_service.GetPipelineJobRequest],
  ...
  def list_pipeline_jobs(
    ...
    if 'list_pipeline_jobs' not in self._stubs:
      self._stubs['list_pipeline_jobs'] = self.grpc_channel.unary_unary(
          ...
          response_deserializer=pipeline_service.ListPipelineJobsResponse
          .deserialize,
      )
  ...
  def delete_pipeline_job(
      self,
  ) -> Callable[[pipeline_service.DeletePipelineJobRequest],
                operations_pb2.Operation]:
    ...
    if 'delete_pipeline_job' not in self._stubs:
      self._stubs['delete_pipeline_job'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=pipeline_service.DeletePipelineJobRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def cancel_pipeline_job(
    ...
    if 'cancel_pipeline_job' not in self._stubs:
      self._stubs['cancel_pipeline_job'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=pipeline_service.CancelPipelineJobRequest
          .serialize,
          response_deserializer=empty_pb2.Empty.FromString,
      )
