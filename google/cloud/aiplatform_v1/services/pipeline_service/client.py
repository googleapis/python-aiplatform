...
class PipelineServiceClient(metaclass=PipelineServiceClientMeta):
  """A service for creating and managing Vertex AI's pipelines.
    ...
    This   includes both ``TrainingPipeline`` resources (used for AutoML
    and   custom training) and ``PipelineJob`` resources (used for
    Vertex AI   Pipelines).
    """
        ...
        A created
            ...
            .. code-block:: python
                ...
                def sample_create_training_pipeline():
                    ...
                    training_pipeline.training_task_inputs.null_value =
                    "NULL_VALUE"
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CreateTrainingPipelineRequest,
            ...
            [PipelineService.CreateTrainingPipeline][google.cloud.aiplatform.v1.PipelineService.CreateTrainingPipeline].
                ...
                create the TrainingPipeline in. Format:
                ...
                (google.cloud.aiplatform_v1.types.TrainingPipeline): Required.
                The TrainingPipeline to create.  This corresponds to the
  ...
  def get_training_pipeline(
    ...
    r"""Gets a TrainingPipeline.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.GetTrainingPipelineRequest,
            dict]): The request object. Request message for
  ...
  def list_training_pipelines(
    ...
    r"""Lists TrainingPipelines in a Location.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListTrainingPipelinesRequest,
            dict]): The request object. Request message for
            [PipelineService.ListTrainingPipelines][google.cloud.aiplatform.v1.PipelineService.ListTrainingPipelines].
                parent (str): Required. The resource name of the Location to
                list the TrainingPipelines from. Format:
                ``projects/{project}/locations/{location}``  This corresponds to
                the ``parent`` field on the ``request`` instance; if ``request``
  ...
  def delete_training_pipeline(
    ...
    r"""Deletes a TrainingPipeline.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.DeleteTrainingPipelineRequest,
            dict]): The request object. Request message for
  ...
  def cancel_training_pipeline(
    ...
    r"""Cancels a TrainingPipeline.
        ...
        Starts asynchronous cancellation on
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CancelTrainingPipelineRequest,
            dict]): The request object. Request message for
            [PipelineService.CancelTrainingPipeline][google.cloud.aiplatform.v1.PipelineService.CancelTrainingPipeline].
                name (str): Required. The name of the TrainingPipeline to
                cancel.
                    Format:
                    ``projects/{project}/locations/{location}/trainingPipelines/{training_pipeline}``
                    This corresponds to the ``name`` field on the ``request``
    ...
    r"""Creates a PipelineJob.
        ...
        A PipelineJob will run
            ...
            [PipelineService.CreatePipelineJob][google.cloud.aiplatform.v1.PipelineService.CreatePipelineJob].
                parent (str): Required. The resource name of the Location to
                create the PipelineJob in. Format:
                ``projects/{project}/locations/{location}``  This corresponds to
                the ``parent`` field on the ``request`` instance; if ``request``
                is provided, this should not be set.
                pipeline_job (google.cloud.aiplatform_v1.types.PipelineJob):
                Required. The PipelineJob to create. This corresponds to the
                ``pipeline_job`` field on the ``request`` instance; if
                ``request`` is provided, this should not be set.
                pipeline_job_id (str): The ID to use for the PipelineJob, which
                will become the final component of the PipelineJob name. If not
                provided, an ID will be automatically generated.  This value
                should be less than 128 characters, and valid characters are
                /[a-z][0-9]-/.  This corresponds to the ``pipeline_job_id``
  ...
  def get_pipeline_job(
    ...
    r"""Gets a PipelineJob.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.GetPipelineJobRequest,
            dict]): The request object. Request message for
            [PipelineService.GetPipelineJob][google.cloud.aiplatform.v1.PipelineService.GetPipelineJob].
                name (str): Required. The name of the PipelineJob resource.
                Format:
  ...
  def list_pipeline_jobs(
    ...
    r"""Lists PipelineJobs in a Location.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListPipelineJobsRequest,
            dict]): The request object. Request message for
            [PipelineService.ListPipelineJobs][google.cloud.aiplatform.v1.PipelineService.ListPipelineJobs].
                parent (str): Required. The resource name of the Location to
                list the PipelineJobs from. Format:
                ``projects/{project}/locations/{location}``  This corresponds to
                the ``parent`` field on the ``request`` instance; if ``request``
                is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  def delete_pipeline_job(
    ...
    r"""Deletes a PipelineJob.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.DeletePipelineJobRequest,
            dict]): The request object. Request message for
  ...
  def cancel_pipeline_job(
    ...
    r"""Cancels a PipelineJob.
        ...
        Starts asynchronous cancellation on the
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CancelPipelineJobRequest,
            dict]): The request object. Request message for
            [PipelineService.CancelPipelineJob][google.cloud.aiplatform.v1.PipelineService.CancelPipelineJob].
                name (str): Required. The name of the PipelineJob to cancel.
                Format:
                ``projects/{project}/locations/{location}/pipelineJobs/{pipeline_job}``
                This corresponds to the ``name`` field on the ``request``
                instance; if ``request`` is provided, this should not be set.
