...
class ReasoningEngineExecutionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_async_query_reasoning_engine(
        self,
    ...
    def post_async_query_reasoning_engine(
    ...
    def post_async_query_reasoning_engine_with_metadata(
        self,
...
class ReasoningEngineExecutionServiceRestTransport(
    ...
    class _AsyncQueryReasoningEngine(
        ...
        def __hash__(self):
            return hash(
                "ReasoningEngineExecutionServiceRestTransport.AsyncQueryReasoningEngine"
            )
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_async_query_reasoning_engine(
                request, metadata
            )
            ...
            # Send the request
            response = ReasoningEngineExecutionServiceRestTransport._AsyncQueryReasoningEngine._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            resp, _ = self._interceptor.post_async_query_reasoning_engine_with_metadata(
