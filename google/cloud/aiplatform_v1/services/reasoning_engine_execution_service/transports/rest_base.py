    ...
    class _BaseAsyncQueryReasoningEngine:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{name=projects/*/locations/*/reasoningEngines/*}:asyncQuery",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v1/{name=reasoningEngines/*}:asyncQuery",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseCancelAsyncQueryReasoningEngine:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{name=projects/*/locations/*/reasoningEngines/*}:cancelAsyncQuery",
                    "body": "*",
                },
                {
                    "method": "post",
                    "uri": "/v1/{name=reasoningEngines/*}:cancelAsyncQuery",
                    "body": "*",
                },
            ]
            return http_options
