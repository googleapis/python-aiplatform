...
class AsyncReasoningEngineExecutionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    async def pre_async_query_reasoning_engine(
        self,
    ...
    async def post_async_query_reasoning_engine(
    ...
    async def post_async_query_reasoning_engine_with_metadata(
        self,
    ...
    async def pre_cancel_async_query_reasoning_engine(
        self,
    ...
    async def post_cancel_async_query_reasoning_engine(
        self,
    ...
    async def post_cancel_async_query_reasoning_engine_with_metadata(
        self,
        response: reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineResponse,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
...
class AsyncReasoningEngineExecutionServiceRestTransport(
    ...
    class _AsyncQueryReasoningEngine(
        ...
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineExecutionServiceRestTransport.AsyncQueryReasoningEngine"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseReasoningEngineExecutionServiceRestTransport._BaseAsyncQueryReasoningEngine._get_http_options()
            )

            request, metadata = (
                await self._interceptor.pre_async_query_reasoning_engine(
                    request, metadata
                )
            )
            transcoded_request = _BaseReasoningEngineExecutionServiceRestTransport._BaseAsyncQueryReasoningEngine._get_transcoded_request(
                http_options, request
            )

            body = _BaseReasoningEngineExecutionServiceRestTransport._BaseAsyncQueryReasoningEngine._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseReasoningEngineExecutionServiceRestTransport._BaseAsyncQueryReasoningEngine._get_query_params_json(
                transcoded_request
            )
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._AsyncQueryReasoningEngine._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            resp, _ = (
                await self._interceptor.post_async_query_reasoning_engine_with_metadata(
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ReasoningEngineExecutionServiceAsyncClient.async_query_reasoning_engine",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ReasoningEngineExecutionService",
                        "rpcName": "AsyncQueryReasoningEngine",
    ...
    class _CancelAsyncQueryReasoningEngine(
        ...
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineExecutionServiceRestTransport.CancelAsyncQueryReasoningEngine"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            request, metadata = (
                await self._interceptor.pre_cancel_async_query_reasoning_engine(
                    request, metadata
                )
            )
            ...
            # Send the request
            response = await AsyncReasoningEngineExecutionServiceRestTransport._CancelAsyncQueryReasoningEngine._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_cancel_async_query_reasoning_engine(
                resp
            )
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = (
                await self._interceptor.post_cancel_async_query_reasoning_engine_with_metadata(
                    resp, response_metadata
                )
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ReasoningEngineExecutionServiceAsyncClient.cancel_async_query_reasoning_engine",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ReasoningEngineExecutionService",
                        "rpcName": "CancelAsyncQueryReasoningEngine",
                        "metadata": http_response["headers"],
