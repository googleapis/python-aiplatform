...
class MigrationServiceAsyncClient:
  ...
  annotated_dataset_path = staticmethod(
      MigrationServiceClient.annotated_dataset_path)
  ...
  common_location_path = staticmethod(
      MigrationServiceClient.common_location_path)
  ...
  def from_service_account_info(cls, info: dict, *args, **kwargs):
    """Creates an instance of this client using the provided credentials
        ...
        """
    return MigrationServiceClient.from_service_account_info.__func__(
        MigrationServiceAsyncClient, info, *args, **kwargs)  # type: ignore
  ...
  def from_service_account_file(cls, filename: str, *args, **kwargs):
    """Creates an instance of this client using the provided credentials
        ...
        Returns:
            MigrationServiceAsyncClient: The constructed client.
        """
    return MigrationServiceClient.from_service_account_file.__func__(
        MigrationServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
  ...
  def get_mtls_endpoint_and_cert_source(
    ...
    """Return the API endpoint and client cert source for mutual TLS.
        ...
        """
    return MigrationServiceClient.get_mtls_endpoint_and_cert_source(
  ...
  get_transport_class = functools.partial(
      type(MigrationServiceClient).get_transport_class,
    ...
    """Instantiates the migration service client.
        ...
        Args:
            credentials (Optional[google.auth.credentials.Credentials]): The
              ...
              environment.
            transport (Union[str, ~.MigrationServiceTransport]): The transport
  ...
  async def search_migratable_resources(
      self,
      request: Union[migration_service.SearchMigratableResourcesRequest,
                     dict] = None,
      *,
      parent: str = None,
    ...
    r"""Searches all of the resources in
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.SearchMigratableResourcesRequest,
              ...
              parent (:class:`str`): Required. The location that the migratable
              resources should be searched from. It's the Vertex AI location
              that the resources can be migrated to, not the resources' original
  ...
  async def batch_migrate_resources(
      self,
      request: Union[migration_service.BatchMigrateResourcesRequest,
                     dict] = None,
      *,
      parent: str = None,
      migrate_resource_requests: Sequence[
          migration_service.MigrateResourceRequest] = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
      timeout: float = None,
      metadata: Sequence[Tuple[str, str]] = (),
    ...
    r"""Batch migrates resources from ml.googleapis.com,
        ...
        .. code-block:: python
            ...
            async def sample_batch_migrate_resources():
                ...
                aiplatform_v1.MigrateResourceRequest()
                migrate_resource_requests.migrate_ml_engine_model_version_config.endpoint
                = "endpoint_value"
                migrate_resource_requests.migrate_ml_engine_model_version_config.model_version
                = "model_version_value"
                migrate_resource_requests.migrate_ml_engine_model_version_config.model_display_name
                = "model_display_name_value"
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.BatchMigrateResourcesRequest,
              dict]): The request object. Request message for
              [MigrationService.BatchMigrateResources][google.cloud.aiplatform.v1.MigrationService.BatchMigrateResources].
              parent (:class:`str`): Required. The location of the migrated
              resource will live in. Format:
              ``projects/{project}/locations/{location}``  This corresponds to
              the ``parent`` field on the ``request`` instance; if ``request``
              is provided, this should not be set. migrate_resource_requests
              (:class:`Sequence[google.cloud.aiplatform_v1.types.MigrateResourceRequest]`):
              Required. The request messages specifying the resources to
              migrate. They must be in the same location as the destination. Up
              to 50 resources can be migrated in one batch.  This corresponds to
              the ``migrate_resource_requests`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
            timeout (float): The timeout for this request.
