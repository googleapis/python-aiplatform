...
class TensorboardServiceGrpcTransport(TensorboardServiceTransport):
  ...
  def list_tensorboard_experiments(
      self,
  ) -> Callable[[tensorboard_service.ListTensorboardExperimentsRequest],
  ...
  def batch_create_tensorboard_runs(
      self,
  ) -> Callable[[tensorboard_service.BatchCreateTensorboardRunsRequest],
  ...
  def batch_create_tensorboard_time_series(
      self,
  ) -> Callable[[tensorboard_service.BatchCreateTensorboardTimeSeriesRequest],
  ...
  def list_tensorboard_time_series(
      self,
  ) -> Callable[[tensorboard_service.ListTensorboardTimeSeriesRequest],
  ...
  def read_tensorboard_blob_data(
      self,
  ) -> Callable[[tensorboard_service.ReadTensorboardBlobDataRequest],
  ...
  def write_tensorboard_run_data(
      self,
  ) -> Callable[[tensorboard_service.WriteTensorboardRunDataRequest],
