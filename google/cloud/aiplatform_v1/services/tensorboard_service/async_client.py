...
class TensorboardServiceAsyncClient:
  ...
  tensorboard_run_path = staticmethod(
      TensorboardServiceClient.tensorboard_run_path)
  ...
  common_location_path = staticmethod(
      TensorboardServiceClient.common_location_path)
  ...
  def from_service_account_info(cls, info: dict, *args, **kwargs):
    """Creates an instance of this client using the provided credentials
        ...
        """
    return TensorboardServiceClient.from_service_account_info.__func__(
        TensorboardServiceAsyncClient, info, *args, **kwargs)  # type: ignore
  ...
  def from_service_account_file(cls, filename: str, *args, **kwargs):
    """Creates an instance of this client using the provided credentials
        ...
        Returns:
            TensorboardServiceAsyncClient: The constructed client.
        """
    return TensorboardServiceClient.from_service_account_file.__func__(
        TensorboardServiceAsyncClient, filename, *args,
        **kwargs)  # type: ignore
  ...
  def get_mtls_endpoint_and_cert_source(
    ...
    """Return the API endpoint and client cert source for mutual TLS.
        ...
        """
    return TensorboardServiceClient.get_mtls_endpoint_and_cert_source(
    ...
    """Instantiates the tensorboard service client.
        ...
        Args:
            credentials (Optional[google.auth.credentials.Credentials]): The
              ...
              environment.
            transport (Union[str, ~.TensorboardServiceTransport]): The transport
              to use. If set to None, a transport is chosen automatically.
            client_options (ClientOptions): Custom options for the client. It
              won't take effect if a ``transport`` instance is provided. (1) The
              ``api_endpoint`` property can be used to override the default
              endpoint provided by the client. GOOGLE_API_USE_MTLS_ENDPOINT
              environment variable can also be used to override the endpoint:
              "always" (always use the default mTLS endpoint), "never" (always
              use the default regular endpoint) and "auto" (auto switch to the
              default mTLS endpoint if client certificate is present, this is
              the default value). However, the ``api_endpoint`` property takes
              precedence if provided. (2) If GOOGLE_API_USE_CLIENT_CERTIFICATE
              environment variable is "true", then the ``client_cert_source``
              property can be used to provide client certificate for mutual TLS
              transport. If not provided, the default SSL client certificate
              will be used if present. If GOOGLE_API_USE_CLIENT_CERTIFICATE is
              "false" or not set, no client certificate will be used.
  ...
  async def create_tensorboard(
    ...
    r"""Creates a Tensorboard.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.CreateTensorboardRequest,
              ...
              parent (:class:`str`): Required. The resource name of the Location
              to create the Tensorboard in. Format:
              ...
              (:class:`google.cloud.aiplatform_v1.types.Tensorboard`): Required.
              The Tensorboard to create. This corresponds to the ``tensorboard``
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.aiplatform_v1.types.Tensorboard`
                Tensorboard is a physical database that stores users' training
                metrics.
  ...
  async def get_tensorboard(
    ...
    r"""Gets a Tensorboard.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.GetTensorboardRequest,
              dict]): The request object. Request message for
              [TensorboardService.GetTensorboard][google.cloud.aiplatform.v1.TensorboardService.GetTensorboard].
              name (:class:`str`): Required. The name of the Tensorboard
              resource. Format:
  ...
  async def update_tensorboard(
    ...
    r"""Updates a Tensorboard.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.UpdateTensorboardRequest,
              dict]): The request object. Request message for
              [TensorboardService.UpdateTensorboard][google.cloud.aiplatform.v1.TensorboardService.UpdateTensorboard].
              tensorboard
              (:class:`google.cloud.aiplatform_v1.types.Tensorboard`): Required.
              The Tensorboard's ``name`` field is used to identify the
              Tensorboard to be updated. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}``
              This corresponds to the ``tensorboard`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
              ...
              the user does not provide a mask then all fields will be
              overwritten if new values are specified.  This corresponds to the
  ...
  async def list_tensorboards(
    ...
    r"""Lists Tensorboards in a Location.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.ListTensorboardsRequest,
              dict]): The request object. Request message for
  ...
  async def delete_tensorboard(
    ...
    r"""Deletes a Tensorboard.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.DeleteTensorboardRequest,
              dict]): The request object. Request message for
              [TensorboardService.DeleteTensorboard][google.cloud.aiplatform.v1.TensorboardService.DeleteTensorboard].
              name (:class:`str`): Required. The name of the Tensorboard to be
              deleted.
                Format:
                  ``projects/{project}/locations/{location}/tensorboards/{tensorboard}``
                  This corresponds to the ``name`` field on the ``request``
  ...
  async def create_tensorboard_experiment(
      self,
      request: Union[tensorboard_service.CreateTensorboardExperimentRequest,
                     dict] = None,
      *,
      parent: str = None,
      tensorboard_experiment: gca_tensorboard_experiment
    ...
    r"""Creates a TensorboardExperiment.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.CreateTensorboardExperimentRequest,
              dict]): The request object. Request message for
              [TensorboardService.CreateTensorboardExperiment][google.cloud.aiplatform.v1.TensorboardService.CreateTensorboardExperiment].
              parent (:class:`str`): Required. The resource name of the
              Tensorboard to create the TensorboardExperiment in. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}``
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
              tensorboard_experiment
              (:class:`google.cloud.aiplatform_v1.types.TensorboardExperiment`):
              The TensorboardExperiment to create. This corresponds to the
              ``tensorboard_experiment`` field on the ``request`` instance; if
              ``request`` is provided, this should not be set.
              tensorboard_experiment_id (:class:`str`): Required. The ID to use
              for the Tensorboard experiment, which will become the final
              component of the Tensorboard experiment's resource name.  This
              value should be 1-128 characters, and valid characters are
              /[a-z][0-9]-/.  This corresponds to the
              ``tensorboard_experiment_id`` field on the ``request`` instance;
  ...
  async def get_tensorboard_experiment(
      self,
      request: Union[tensorboard_service.GetTensorboardExperimentRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Gets a TensorboardExperiment.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.GetTensorboardExperimentRequest,
              dict]): The request object. Request message for
              [TensorboardService.GetTensorboardExperiment][google.cloud.aiplatform.v1.TensorboardService.GetTensorboardExperiment].
              name (:class:`str`): Required. The name of the
              TensorboardExperiment resource. Format:
  ...
  async def update_tensorboard_experiment(
      self,
      request: Union[tensorboard_service.UpdateTensorboardExperimentRequest,
                     dict] = None,
      *,
      tensorboard_experiment: gca_tensorboard_experiment
      .TensorboardExperiment = None,
    ...
    r"""Updates a TensorboardExperiment.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.UpdateTensorboardExperimentRequest,
              dict]): The request object. Request message for
              [TensorboardService.UpdateTensorboardExperiment][google.cloud.aiplatform.v1.TensorboardService.UpdateTensorboardExperiment].
              tensorboard_experiment
              (:class:`google.cloud.aiplatform_v1.types.TensorboardExperiment`):
              Required. The TensorboardExperiment's ``name`` field is used to
              identify the TensorboardExperiment to be updated. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}``
              This corresponds to the ``tensorboard_experiment`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set. update_mask
              (:class:`google.protobuf.field_mask_pb2.FieldMask`): Required.
              Field mask is used to specify the fields to be overwritten in the
              TensorboardExperiment resource by the update. The fields specified
              ...
              if new values are specified.  This corresponds to the
              ``update_mask`` field on the ``request`` instance; if ``request``
              is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
  ...
  async def list_tensorboard_experiments(
      self,
      request: Union[tensorboard_service.ListTensorboardExperimentsRequest,
                     dict] = None,
      *,
      parent: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Lists TensorboardExperiments in a Location.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.ListTensorboardExperimentsRequest,
              dict]): The request object. Request message for
              [TensorboardService.ListTensorboardExperiments][google.cloud.aiplatform.v1.TensorboardService.ListTensorboardExperiments].
              parent (:class:`str`): Required. The resource name of the
              Tensorboard to list TensorboardExperiments. Format:
              'projects/{project}/locations/{location}/tensorboards/{tensorboard}'
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
  ...
  async def delete_tensorboard_experiment(
      self,
      request: Union[tensorboard_service.DeleteTensorboardExperimentRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
  ...
  async def create_tensorboard_run(
    ...
    r"""Creates a TensorboardRun.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.CreateTensorboardRunRequest,
              dict]): The request object. Request message for
              [TensorboardService.CreateTensorboardRun][google.cloud.aiplatform.v1.TensorboardService.CreateTensorboardRun].
              parent (:class:`str`): Required. The resource name of the
              TensorboardExperiment to create the TensorboardRun in. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}``
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
              tensorboard_run
              (:class:`google.cloud.aiplatform_v1.types.TensorboardRun`):
              Required. The TensorboardRun to create.  This corresponds to the
              ``tensorboard_run`` field on the ``request`` instance; if
              ``request`` is provided, this should not be set.
              tensorboard_run_id (:class:`str`): Required. The ID to use for the
              Tensorboard run, which will become the final component of the
              Tensorboard run's resource name.  This value should be 1-128
              characters, and valid characters are /[a-z][0-9]-/.  This
              corresponds to the ``tensorboard_run_id`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
            timeout (float): The timeout for this request.
  ...
  async def batch_create_tensorboard_runs(
      self,
      request: Union[tensorboard_service.BatchCreateTensorboardRunsRequest,
                     dict] = None,
      *,
      parent: str = None,
      requests: Sequence[
          tensorboard_service.CreateTensorboardRunRequest] = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
      timeout: float = None,
      metadata: Sequence[Tuple[str, str]] = (),
    ...
    r"""Batch create TensorboardRuns.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.BatchCreateTensorboardRunsRequest,
              dict]): The request object. Request message for
              [TensorboardService.BatchCreateTensorboardRuns][google.cloud.aiplatform.v1.TensorboardService.BatchCreateTensorboardRuns].
              parent (:class:`str`): Required. The resource name of the
              TensorboardExperiment to create the TensorboardRuns in. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}``
              The parent field in the CreateTensorboardRunRequest messages must
              match this field.  This corresponds to the ``parent`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set. requests
              (:class:`Sequence[google.cloud.aiplatform_v1.types.CreateTensorboardRunRequest]`):
              Required. The request message specifying the TensorboardRuns to
              create. A maximum of 1000 TensorboardRuns can be created in a
              batch.  This corresponds to the ``requests`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
  ...
  async def get_tensorboard_run(
    ...
    r"""Gets a TensorboardRun.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.GetTensorboardRunRequest,
              dict]): The request object. Request message for
              [TensorboardService.GetTensorboardRun][google.cloud.aiplatform.v1.TensorboardService.GetTensorboardRun].
              name (:class:`str`): Required. The name of the TensorboardRun
              resource.
                Format:
  ...
  async def update_tensorboard_run(
      self,
      request: Union[tensorboard_service.UpdateTensorboardRunRequest,
                     dict] = None,
      *,
      tensorboard_run: gca_tensorboard_run.TensorboardRun = None,
      update_mask: field_mask_pb2.FieldMask = None,
    ...
    r"""Updates a TensorboardRun.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.UpdateTensorboardRunRequest,
              dict]): The request object. Request message for
              [TensorboardService.UpdateTensorboardRun][google.cloud.aiplatform.v1.TensorboardService.UpdateTensorboardRun].
              tensorboard_run
              (:class:`google.cloud.aiplatform_v1.types.TensorboardRun`):
              Required. The TensorboardRun's ``name`` field is used to identify
              the TensorboardRun to be updated. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}``
              This corresponds to the ``tensorboard_run`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set. update_mask
              (:class:`google.protobuf.field_mask_pb2.FieldMask`): Required.
              Field mask is used to specify the fields to be overwritten in the
              ...
              field will be overwritten if it is in the mask. If the user does
              not provide a mask then all fields will be overwritten if new
              values are specified.  This corresponds to the ``update_mask``
              field on the ``request`` instance; if ``request`` is provided,
              this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
  ...
  async def list_tensorboard_runs(
      self,
      request: Union[tensorboard_service.ListTensorboardRunsRequest,
                     dict] = None,
      *,
      parent: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Lists TensorboardRuns in a Location.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.ListTensorboardRunsRequest,
              dict]): The request object. Request message for
              [TensorboardService.ListTensorboardRuns][google.cloud.aiplatform.v1.TensorboardService.ListTensorboardRuns].
              parent (:class:`str`): Required. The resource name of the
              TensorboardExperiment to list TensorboardRuns. Format:
              'projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}'
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
  ...
  async def delete_tensorboard_run(
      self,
      request: Union[tensorboard_service.DeleteTensorboardRunRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Deletes a TensorboardRun.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.DeleteTensorboardRunRequest,
              dict]): The request object. Request message for
              [TensorboardService.DeleteTensorboardRun][google.cloud.aiplatform.v1.TensorboardService.DeleteTensorboardRun].
              name (:class:`str`): Required. The name of the TensorboardRun to
              be deleted.
                Format:
                  ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}``
                  This corresponds to the ``name`` field on the ``request``
  ...
  async def batch_create_tensorboard_time_series(
      ...
      *,
      parent: str = None,
      requests: Sequence[
          tensorboard_service.CreateTensorboardTimeSeriesRequest] = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
      timeout: float = None,
      metadata: Sequence[Tuple[str, str]] = (),
    ...
    r"""Batch create TensorboardTimeSeries that belong to a
        ...
        .. code-block:: python
            ...
            async def sample_batch_create_tensorboard_time_series():
                ...
                requests.parent = "parent_value"
                requests.tensorboard_time_series.display_name =
                "display_name_value"
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.BatchCreateTensorboardTimeSeriesRequest,
              dict]): The request object. Request message for
              ...
              parent (:class:`str`): Required. The resource name of the
              TensorboardExperiment to create the TensorboardTimeSeries in.
              Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}``
              The TensorboardRuns referenced by the parent fields in the
              CreateTensorboardTimeSeriesRequest messages must be sub resources
              of this TensorboardExperiment.  This corresponds to the ``parent``
              field on the ``request`` instance; if ``request`` is provided,
              this should not be set. requests
              (:class:`Sequence[google.cloud.aiplatform_v1.types.CreateTensorboardTimeSeriesRequest]`):
              Required. The request message specifying the TensorboardTimeSeries
              to create. A maximum of 1000 TensorboardTimeSeries can be created
              in a batch.  This corresponds to the ``requests`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
  ...
  async def create_tensorboard_time_series(
      self,
      request: Union[tensorboard_service.CreateTensorboardTimeSeriesRequest,
                     dict] = None,
      *,
      parent: str = None,
      tensorboard_time_series: gca_tensorboard_time_series
      .TensorboardTimeSeries = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
      timeout: float = None,
      metadata: Sequence[Tuple[str, str]] = (),
    ...
    r"""Creates a TensorboardTimeSeries.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.CreateTensorboardTimeSeriesRequest,
              dict]): The request object. Request message for
              [TensorboardService.CreateTensorboardTimeSeries][google.cloud.aiplatform.v1.TensorboardService.CreateTensorboardTimeSeries].
              parent (:class:`str`): Required. The resource name of the
              TensorboardRun to create the TensorboardTimeSeries in. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}``
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
              tensorboard_time_series
              (:class:`google.cloud.aiplatform_v1.types.TensorboardTimeSeries`):
              Required. The TensorboardTimeSeries to create.  This corresponds
              to the ``tensorboard_time_series`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
            timeout (float): The timeout for this request.
  ...
  async def get_tensorboard_time_series(
      self,
      request: Union[tensorboard_service.GetTensorboardTimeSeriesRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
  ...
  async def update_tensorboard_time_series(
      self,
      request: Union[tensorboard_service.UpdateTensorboardTimeSeriesRequest,
                     dict] = None,
      *,
      tensorboard_time_series: gca_tensorboard_time_series
      .TensorboardTimeSeries = None,
    ...
    r"""Updates a TensorboardTimeSeries.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.UpdateTensorboardTimeSeriesRequest,
              dict]): The request object. Request message for
              [TensorboardService.UpdateTensorboardTimeSeries][google.cloud.aiplatform.v1.TensorboardService.UpdateTensorboardTimeSeries].
              tensorboard_time_series
              (:class:`google.cloud.aiplatform_v1.types.TensorboardTimeSeries`):
              Required. The TensorboardTimeSeries' ``name`` field is used to
              identify the TensorboardTimeSeries to be updated. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}/timeSeries/{time_series}``
              This corresponds to the ``tensorboard_time_series`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set. update_mask
              (:class:`google.protobuf.field_mask_pb2.FieldMask`): Required.
              Field mask is used to specify the fields to be overwritten in the
              TensorboardTimeSeries resource by the update. The fields specified
              in the update_mask are relative to the resource, not the full
              request. A field will be overwritten if it is in the mask. If the
              user does not provide a mask then all fields will be overwritten
              if new values are specified.  This corresponds to the
  ...
  async def list_tensorboard_time_series(
      self,
      request: Union[tensorboard_service.ListTensorboardTimeSeriesRequest,
                     dict] = None,
      *,
      parent: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Lists TensorboardTimeSeries in a Location.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.ListTensorboardTimeSeriesRequest,
              dict]): The request object. Request message for
              [TensorboardService.ListTensorboardTimeSeries][google.cloud.aiplatform.v1.TensorboardService.ListTensorboardTimeSeries].
              parent (:class:`str`): Required. The resource name of the
              TensorboardRun to list TensorboardTimeSeries. Format:
              'projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}'
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
  ...
  async def delete_tensorboard_time_series(
      self,
      request: Union[tensorboard_service.DeleteTensorboardTimeSeriesRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
  ...
  async def batch_read_tensorboard_time_series_data(
    ...
    r"""Reads multiple TensorboardTimeSeries' data.
    ...
    The data
        ...
        .. code-block:: python
            ...
            async def sample_batch_read_tensorboard_time_series_data():
                ...
                # Initialize request argument(s)
                request =
                aiplatform_v1.BatchReadTensorboardTimeSeriesDataRequest(
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.BatchReadTensorboardTimeSeriesDataRequest,
              dict]): The request object. Request message for
              ...
              tensorboard (:class:`str`): Required. The resource name of the
              Tensorboard containing TensorboardTimeSeries to read data from.
                Format:
                  ``projects/{project}/locations/{location}/tensorboards/{tensorboard}``.
                  The TensorboardTimeSeries referenced by
                  [time_series][google.cloud.aiplatform.v1.BatchReadTensorboardTimeSeriesDataRequest.time_series]
                  must be sub resources of this Tensorboard.  This corresponds
                  to the ``tensorboard`` field on the ``request`` instance; if
                  ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
            timeout (float): The timeout for this request.
  ...
  async def read_tensorboard_time_series_data(
      self,
      request: Union[tensorboard_service.ReadTensorboardTimeSeriesDataRequest,
                     dict] = None,
      *,
    ...
    r"""Reads a TensorboardTimeSeries' data.

    By default, if the number
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.ReadTensorboardTimeSeriesDataRequest,
              dict]): The request object. Request message for
              ...
              tensorboard_time_series (:class:`str`): Required. The resource
              name of the TensorboardTimeSeries to read data from. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}/timeSeries/{time_series}``
              This corresponds to the ``tensorboard_time_series`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set.
  ...
  def read_tensorboard_blob_data(
      self,
      request: Union[tensorboard_service.ReadTensorboardBlobDataRequest,
                     dict] = None,
      *,
    ...
    r"""Gets bytes of TensorboardBlobs.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.ReadTensorboardBlobDataRequest,
              dict]): The request object. Request message for
              [TensorboardService.ReadTensorboardBlobData][google.cloud.aiplatform.v1.TensorboardService.ReadTensorboardBlobData].
              time_series (:class:`str`): Required. The resource name of the
              TensorboardTimeSeries to list Blobs. Format:
              'projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}/timeSeries/{time_series}'
              This corresponds to the ``time_series`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
            timeout (float): The timeout for this request.
  ...
  async def write_tensorboard_experiment_data(
      self,
      request: Union[tensorboard_service.WriteTensorboardExperimentDataRequest,
                     dict] = None,
      *,
      tensorboard_experiment: str = None,
      write_run_data_requests: Sequence[
          tensorboard_service.WriteTensorboardRunDataRequest] = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
      timeout: float = None,
      metadata: Sequence[Tuple[str, str]] = (),
    ...
    r"""Write time series data points of multiple
        ...
        .. code-block:: python
            ...
            async def sample_write_tensorboard_experiment_data():
                ...
                aiplatform_v1.WriteTensorboardRunDataRequest()
                write_run_data_requests.tensorboard_run =
                "tensorboard_run_value"
                write_run_data_requests.time_series_data.tensorboard_time_series_id
                = "tensorboard_time_series_id_value"
                write_run_data_requests.time_series_data.value_type =
                "BLOB_SEQUENCE"
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.WriteTensorboardExperimentDataRequest,
              dict]): The request object. Request message for
              ...
              tensorboard_experiment (:class:`str`): Required. The resource name
              of the TensorboardExperiment to write data to. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}``
              This corresponds to the ``tensorboard_experiment`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set. write_run_data_requests
              (:class:`Sequence[google.cloud.aiplatform_v1.types.WriteTensorboardRunDataRequest]`):
              Required. Requests containing per-run TensorboardTimeSeries data
              to write.  This corresponds to the ``write_run_data_requests``
              field on the ``request`` instance; if ``request`` is provided,
              this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
  ...
  async def write_tensorboard_run_data(
      self,
      request: Union[tensorboard_service.WriteTensorboardRunDataRequest,
                     dict] = None,
      *,
    ...
    r"""Write time series data points into multiple
        ...
        .. code-block:: python
            ...
            async def sample_write_tensorboard_run_data():
                ...
                time_series_data.tensorboard_time_series_id =
                "tensorboard_time_series_id_value"
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.WriteTensorboardRunDataRequest,
              dict]): The request object. Request message for
              [TensorboardService.WriteTensorboardRunData][google.cloud.aiplatform.v1.TensorboardService.WriteTensorboardRunData].
              tensorboard_run (:class:`str`): Required. The resource name of the
              TensorboardRun to write data to. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}``
              This corresponds to the ``tensorboard_run`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set. time_series_data
              (:class:`Sequence[google.cloud.aiplatform_v1.types.TimeSeriesData]`):
              Required. The TensorboardTimeSeries data to write. Values with in
              a time series are indexed by their step value. Repeated writes to
              the same step will overwrite the existing value for that step. The
              upper limit of data points per write request is 5000.  This
              corresponds to the ``time_series_data`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
            timeout (float): The timeout for this request.
  ...
  async def export_tensorboard_time_series_data(
      self,
      request: Union[tensorboard_service.ExportTensorboardTimeSeriesDataRequest,
                     dict] = None,
      *,
      tensorboard_time_series: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Exports a TensorboardTimeSeries' data.
    ...
    Data is
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.ExportTensorboardTimeSeriesDataRequest,
              dict]): The request object. Request message for
              ...
              tensorboard_time_series (:class:`str`): Required. The resource
              name of the TensorboardTimeSeries to export data from. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}/timeSeries/{time_series}``
              This corresponds to the ``tensorboard_time_series`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set.
