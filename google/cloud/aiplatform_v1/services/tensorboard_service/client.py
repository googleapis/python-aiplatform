...
class TensorboardServiceClient(metaclass=TensorboardServiceClientMeta):
  ...
  def tensorboard_path(
    ...
    return ("projects/{project}/locations/{location}/tensorboards/{tensorboard}"
            .format(
                project=project,
                location=location,
  ...
  def create_tensorboard(
    ...
    r"""Creates a Tensorboard.
        ...
        Args:
            ...
            parent (str): Required. The resource name of the Location to create
            ...
            tensorboard (google.cloud.aiplatform_v1.types.Tensorboard):
              ...
              ``tensorboard`` field on the ``request`` instance; if ``request``
              is provided, this should not be set.
  ...
  def get_tensorboard(
    ...
    r"""Gets a Tensorboard.
        ...
        Args:
            ...
            name (str): Required. The name of the Tensorboard resource. Format:
    ...
    r"""Updates a Tensorboard.
        ...
        Args:
            ...
            tensorboard (google.cloud.aiplatform_v1.types.Tensorboard):
              ...
              instance; if ``request`` is provided, this should not be set.
            update_mask (google.protobuf.field_mask_pb2.FieldMask): Required.
  ...
  def list_tensorboards(
    ...
    r"""Lists Tensorboards in a Location.
        ...
        Args:
            ...
            parent (str): Required. The resource name of the Location to list
  ...
  def delete_tensorboard(
    ...
    r"""Deletes a Tensorboard.
        ...
        Args:
            ...
            name (str): Required. The name of the Tensorboard to be deleted.
                Format:
                  ``projects/{project}/locations/{location}/tensorboards/{tensorboard}``
                  This corresponds to the ``name`` field on the ``request``
                  instance; if ``request`` is provided, this should not be set.
  ...
  def create_tensorboard_experiment(
    ...
    r"""Creates a TensorboardExperiment.
        ...
        Args:
            ...
            parent (str): Required. The resource name of the Tensorboard to
              create the TensorboardExperiment in. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}``
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            tensorboard_experiment
              (google.cloud.aiplatform_v1.types.TensorboardExperiment): The
              TensorboardExperiment to create. This corresponds to the
              ``tensorboard_experiment`` field on the ``request`` instance; if
              ``request`` is provided, this should not be set.
            tensorboard_experiment_id (str): Required. The ID to use for the
              Tensorboard experiment, which will become the final component of
              the Tensorboard experiment's resource name.  This value should be
              1-128 characters, and valid characters are /[a-z][0-9]-/.  This
              corresponds to the ``tensorboard_experiment_id`` field on the
  ...
  def get_tensorboard_experiment(
    ...
    r"""Gets a TensorboardExperiment.
        ...
        Args:
            ...
            name (str): Required. The name of the TensorboardExperiment
              resource. Format:
  ...
  def list_tensorboard_experiments(
    ...
    r"""Lists TensorboardExperiments in a Location.
        ...
        Args:
            ...
            parent (str): Required. The resource name of the Tensorboard to list
  ...
  def delete_tensorboard_experiment(
    ...
    r"""Deletes a TensorboardExperiment.
        ...
        Args:
            ...
            name (str): Required. The name of the TensorboardExperiment to be
              deleted. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}``
              This corresponds to the ``name`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
  ...
  def create_tensorboard_run(
    ...
    r"""Creates a TensorboardRun.
        ...
        Args:
            ...
            tensorboard_run (google.cloud.aiplatform_v1.types.TensorboardRun):
              ...
              ``request`` is provided, this should not be set.
            tensorboard_run_id (str): Required. The ID to use for the
    ...
    # and friendly error handling.
    rpc = self._transport._wrapped_methods[
        self._transport.create_tensorboard_run]
  ...
  def update_tensorboard_run(
    ...
    # and friendly error handling.
    rpc = self._transport._wrapped_methods[
        self._transport.update_tensorboard_run]
  ...
  def list_tensorboard_runs(
    ...
    # and friendly error handling.
    rpc = self._transport._wrapped_methods[
        self._transport.list_tensorboard_runs]
  ...
  def delete_tensorboard_run(
    ...
    r"""Deletes a TensorboardRun.
        ...
        Args:
            ...
            name (str): Required. The name of the TensorboardRun to be deleted.
                Format:
                  ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}``
                  This corresponds to the ``name`` field on the ``request``
                  instance; if ``request`` is provided, this should not be set.
    ...
    # and friendly error handling.
    rpc = self._transport._wrapped_methods[
        self._transport.delete_tensorboard_run]
  ...
  def create_tensorboard_time_series(
    ...
    r"""Creates a TensorboardTimeSeries.
        ...
        Args:
            ...
            parent (str): Required. The resource name of the TensorboardRun to
  ...
  def get_tensorboard_time_series(
    ...
    r"""Gets a TensorboardTimeSeries.
        ...
        Args:
            ...
            name (str): Required. The name of the TensorboardTimeSeries
              resource. Format:
  ...
  def delete_tensorboard_time_series(
    ...
    r"""Deletes a TensorboardTimeSeries.
        ...
        Args:
            ...
            name (str): Required. The name of the TensorboardTimeSeries to be
              deleted. Format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}/timeSeries/{time_series}``
              This corresponds to the ``name`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
  ...
  def batch_read_tensorboard_time_series_data(
    ...
    The data
        ...
        Args:
            ...
            tensorboard (str): Required. The resource name of the Tensorboard
  ...
  def read_tensorboard_time_series_data(
    ...
    By default, if the number
        ...
        Args:
            ...
            tensorboard_time_series (str): Required. The resource name of the
  ...
  def read_tensorboard_blob_data(
    ...
    r"""Gets bytes of TensorboardBlobs.
        ...
        Args:
            ...
            time_series (str): Required. The resource name of the
  ...
  def write_tensorboard_experiment_data(
    ...
    r"""Write time series data points of multiple
        ...
        Args:
            ...
            tensorboard_experiment (str): Required. The resource name of the
  ...
  def write_tensorboard_run_data(
    ...
    r"""Write time series data points into multiple
        ...
        Args:
            ...
            tensorboard_run (str): Required. The resource name of the
