  ...
  def predict(
    ...
    r"""Perform an online prediction.
            ...
            [PredictionService.Predict][google.cloud.aiplatform.v1.PredictionService.Predict].
                ...
                instance; if ``request`` is provided, this should not be set.
                parameters (google.protobuf.struct_pb2.Value): The parameters
                that govern the prediction. The schema of the parameters may be
  ...
  def raw_predict(
    ...
    r"""Perform an online prediction with an arbitrary HTTP payload.
            ...
            [PredictionService.RawPredict][google.cloud.aiplatform.v1.PredictionService.RawPredict].
                ...
                This corresponds to the ``endpoint`` field on the ``request``
                instance; if ``request`` is provided, this should not be set.
                http_body (google.api.httpbody_pb2.HttpBody): The prediction
                input. Supports HTTP headers and arbitrary data payload.  A
                [DeployedModel][google.cloud.aiplatform.v1.DeployedModel] may
                ...
                model. You can specify the schema for each instance in the
                ...
                [Model][google.cloud.aiplatform.v1.Model]. This schema applies
  ...
  def explain(
    ...
    r"""Perform an online explanation.
            ...
            [PredictionService.Explain][google.cloud.aiplatform.v1.PredictionService.Explain].
                ...
                This corresponds to the ``parameters`` field on the ``request``
                instance; if ``request`` is provided, this should not be set.
                deployed_model_id (str): If specified, this ExplainRequest will
                be served by the chosen DeployedModel, overriding
