...
class PredictionServiceAsyncClient:
  ...
  async def predict(
    ...
    r"""Perform an online prediction.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.PredictRequest, dict]): The
            ...
            parameters that govern the prediction. The schema of the parameters
            may be specified via Endpoint's DeployedModels' [Model's
  ...
  async def raw_predict(
    ...
    r"""Perform an online prediction with an arbitrary HTTP payload.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.RawPredictRequest, dict]):
            ...
            prediction input. Supports HTTP headers and arbitrary data payload.
            A [DeployedModel][google.cloud.aiplatform.v1.DeployedModel] may have
            an upper limit on the number of instances it supports per request.
            When this limit it is exceeded for an AutoML model, the
            ...
            ``RawPredict`` method.  This corresponds to the ``http_body`` field
            ...
            Returns:
                google.api.httpbody_pb2.HttpBody:
                    Message that represents an arbitrary HTTP body. It should
                    only
                    be used for
  ...
  async def explain(
    ...
    r"""Perform an online explanation.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ExplainRequest, dict]): The
            request object. Request message for
            ...
            This corresponds to the ``parameters`` field on the ``request``
            instance; if ``request`` is provided, this should not be set.
            deployed_model_id (:class:`str`): If specified, this ExplainRequest
            will be served by the chosen DeployedModel, overriding
