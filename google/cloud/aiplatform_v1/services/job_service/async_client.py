...
class JobServiceAsyncClient:
  ...
  batch_prediction_job_path = staticmethod(
      JobServiceClient.batch_prediction_job_path)
  ...
  parse_common_folder_path = staticmethod(
      JobServiceClient.parse_common_folder_path)
  ...
  def from_service_account_info(cls, info: dict, *args, **kwargs):
    """Creates an instance of this client using the provided credentials.
        ...
        """
    return JobServiceClient.from_service_account_info.__func__(
        JobServiceAsyncClient, info, *args, **kwargs)  # type: ignore
  ...
  def from_service_account_file(cls, filename: str, *args, **kwargs):
    """Creates an instance of this client using the provided credentials.
        ...
        Returns:
            JobServiceAsyncClient: The constructed client.
        """
    return JobServiceClient.from_service_account_file.__func__(
        JobServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
  ...
  def get_mtls_endpoint_and_cert_source(
    ...
    """Return the API endpoint and client cert source for mutual TLS.
        ...
        """
    return JobServiceClient.get_mtls_endpoint_and_cert_source(
    ...
    """Instantiates the job service client.
        ...
        Args:
            credentials (Optional[google.auth.credentials.Credentials]): The
              ...
              environment.
            transport (Union[str, ~.JobServiceTransport]): The transport to use.
  ...
  async def create_custom_job(
    ...
    r"""Creates a CustomJob.

        A created CustomJob right away
            ...
            .. code-block:: python
                ...
                async def sample_create_custom_job():
                    ...
                    custom_job.job_spec.worker_pool_specs.container_spec.image_uri
                    =
                    "image_uri_value"
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CreateCustomJobRequest,
            ...
            provided, this should not be set. custom_job
            (:class:`google.cloud.aiplatform_v1.types.CustomJob`): Required. The
            CustomJob to create. This corresponds to the ``custom_job`` field on
  ...
  async def get_custom_job(
    ...
    r"""Gets a CustomJob.
            ...
            name (:class:`str`): Required. The name of the CustomJob resource.
                  Format:
  ...
  async def list_custom_jobs(
    ...
    r"""Lists CustomJobs in a Location.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListCustomJobsRequest,
            dict]): The request object. Request message for
            [JobService.ListCustomJobs][google.cloud.aiplatform.v1.JobService.ListCustomJobs].
            parent (:class:`str`): Required. The resource name of the Location
            to list the CustomJobs from. Format:
            ``projects/{project}/locations/{location}``  This corresponds to the
            ``parent`` field on the ``request`` instance; if ``request`` is
  ...
  async def delete_custom_job(
    ...
    r"""Deletes a CustomJob.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.DeleteCustomJobRequest,
            dict]): The request object. Request message for
            [JobService.DeleteCustomJob][google.cloud.aiplatform.v1.JobService.DeleteCustomJob].
            name (:class:`str`): Required. The name of the CustomJob resource to
            be deleted. Format:
            ``projects/{project}/locations/{location}/customJobs/{custom_job}``
  ...
  async def cancel_custom_job(
    ...
    r"""Cancels a CustomJob.
        ...
        Starts asynchronous cancellation on the
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CancelCustomJobRequest,
            dict]): The request object. Request message for
            [JobService.CancelCustomJob][google.cloud.aiplatform.v1.JobService.CancelCustomJob].
            name (:class:`str`): Required. The name of the CustomJob to cancel.
            Format:
            ``projects/{project}/locations/{location}/customJobs/{custom_job}``
            This corresponds to the ``name`` field on the ``request`` instance;
            if ``request`` is provided, this should not be set.
    ...
    r"""Creates a DataLabelingJob.
            ...
            .. code-block:: python
                ...
                async def sample_create_data_labeling_job():
                    ...
                    data_labeling_job.inputs_schema_uri =
                    "inputs_schema_uri_value"
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CreateDataLabelingJobRequest,
            dict]): The request object. Request message for
            [JobService.CreateDataLabelingJob][google.cloud.aiplatform.v1.JobService.CreateDataLabelingJob].
            parent (:class:`str`): Required. The parent of the DataLabelingJob.
            Format: ``projects/{project}/locations/{location}``  This
            corresponds to the ``parent`` field on the ``request`` instance; if
            ``request`` is provided, this should not be set. data_labeling_job
            (:class:`google.cloud.aiplatform_v1.types.DataLabelingJob`):
            Required. The DataLabelingJob to create.  This corresponds to the
            ``data_labeling_job`` field on the ``request`` instance; if
  ...
  async def get_data_labeling_job(
    ...
    r"""Gets a DataLabelingJob.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.GetDataLabelingJobRequest,
            dict]): The request object. Request message for
            [JobService.GetDataLabelingJob][google.cloud.aiplatform.v1.JobService.GetDataLabelingJob].
            name (:class:`str`): Required. The name of the DataLabelingJob.
                  Format:
  ...
  async def list_data_labeling_jobs(
    ...
    r"""Lists DataLabelingJobs in a Location.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListDataLabelingJobsRequest,
            dict]): The request object. Request message for
  ...
  async def delete_data_labeling_job(
    ...
    r"""Deletes a DataLabelingJob.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.DeleteDataLabelingJobRequest,
            dict]): The request object. Request message for
            [JobService.DeleteDataLabelingJob][google.cloud.aiplatform.v1.JobService.DeleteDataLabelingJob].
            name (:class:`str`): Required. The name of the DataLabelingJob to be
            deleted.
                    Format:
                    ``projects/{project}/locations/{location}/dataLabelingJobs/{data_labeling_job}``
                    This corresponds to the ``name`` field on the ``request``
  ...
  async def cancel_data_labeling_job(
    ...
    r"""Cancels a DataLabelingJob.

        Success of cancellation is
            not guaranteed.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CancelDataLabelingJobRequest,
            dict]): The request object. Request message for
  ...
  async def create_hyperparameter_tuning_job(
      self,
      request: Union[job_service.CreateHyperparameterTuningJobRequest,
                     dict] = None,
      *,
      parent: str = None,
    ...
    r"""Creates a HyperparameterTuningJob
            ...
            .. code-block:: python
                ...
                async def sample_create_hyperparameter_tuning_job():
                    ...
                    aiplatform_v1.HyperparameterTuningJob()
                    hyperparameter_tuning_job.display_name =
                    "display_name_value"
                    hyperparameter_tuning_job.study_spec.metrics.metric_id =
                    "metric_id_value"
                    hyperparameter_tuning_job.study_spec.metrics.goal =
                    "MINIMIZE"
                    hyperparameter_tuning_job.study_spec.parameters.double_value_spec.min_value
                    = 0.96
                    hyperparameter_tuning_job.study_spec.parameters.double_value_spec.max_value
                    = 0.962
                    hyperparameter_tuning_job.study_spec.parameters.parameter_id
                    =
                    "parameter_id_value"
                    hyperparameter_tuning_job.max_trial_count = 1609
                    hyperparameter_tuning_job.parallel_trial_count = 2128
                    hyperparameter_tuning_job.trial_job_spec.worker_pool_specs.container_spec.image_uri
                    = "image_uri_value"

                    request =
                    aiplatform_v1.CreateHyperparameterTuningJobRequest(
                        parent="parent_value",
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CreateHyperparameterTuningJobRequest,
            dict]): The request object. Request message for
            [JobService.CreateHyperparameterTuningJob][google.cloud.aiplatform.v1.JobService.CreateHyperparameterTuningJob].
            parent (:class:`str`): Required. The resource name of the Location
            to create the HyperparameterTuningJob in. Format:
            ``projects/{project}/locations/{location}``  This corresponds to the
            ``parent`` field on the ``request`` instance; if ``request`` is
            provided, this should not be set. hyperparameter_tuning_job
            (:class:`google.cloud.aiplatform_v1.types.HyperparameterTuningJob`):
            Required. The HyperparameterTuningJob to create.  This corresponds
            to the ``hyperparameter_tuning_job`` field on the ``request``
            instance; if ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
  ...
  async def get_hyperparameter_tuning_job(
      self,
      request: Union[job_service.GetHyperparameterTuningJobRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Gets a HyperparameterTuningJob
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.GetHyperparameterTuningJobRequest,
            dict]): The request object. Request message for
            [JobService.GetHyperparameterTuningJob][google.cloud.aiplatform.v1.JobService.GetHyperparameterTuningJob].
            name (:class:`str`): Required. The name of the
            HyperparameterTuningJob resource. Format:
  ...
  async def list_hyperparameter_tuning_jobs(
      self,
      request: Union[job_service.ListHyperparameterTuningJobsRequest,
                     dict] = None,
      *,
      parent: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Lists HyperparameterTuningJobs in a Location.
            ...
            parent (:class:`str`): Required. The resource name of the Location
            to list the HyperparameterTuningJobs from. Format:
            ``projects/{project}/locations/{location}``  This corresponds to the
            ``parent`` field on the ``request`` instance; if ``request`` is
            provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  async def delete_hyperparameter_tuning_job(
      self,
      request: Union[job_service.DeleteHyperparameterTuningJobRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Deletes a HyperparameterTuningJob.
            ...
            .. code-block:: python
                ...
                async def sample_delete_hyperparameter_tuning_job():
                    ...
                    # Initialize request argument(s)
                    request =
                    aiplatform_v1.DeleteHyperparameterTuningJobRequest(
                        name="name_value",
                    )
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.DeleteHyperparameterTuningJobRequest,
            dict]): The request object. Request message for
            [JobService.DeleteHyperparameterTuningJob][google.cloud.aiplatform.v1.JobService.DeleteHyperparameterTuningJob].
            name (:class:`str`): Required. The name of the
            HyperparameterTuningJob resource to be deleted. Format:
            ``projects/{project}/locations/{location}/hyperparameterTuningJobs/{hyperparameter_tuning_job}``
            This corresponds to the ``name`` field on the ``request`` instance;
            if ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  async def cancel_hyperparameter_tuning_job(
      self,
      request: Union[job_service.CancelHyperparameterTuningJobRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Cancels a HyperparameterTuningJob.
        ...
        Starts asynchronous
            ...
            .. code-block:: python
                ...
                async def sample_cancel_hyperparameter_tuning_job():
                    ...
                    # Initialize request argument(s)
                    request =
                    aiplatform_v1.CancelHyperparameterTuningJobRequest(
                        name="name_value",
                    )
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CancelHyperparameterTuningJobRequest,
            dict]): The request object. Request message for
            [JobService.CancelHyperparameterTuningJob][google.cloud.aiplatform.v1.JobService.CancelHyperparameterTuningJob].
            name (:class:`str`): Required. The name of the
            HyperparameterTuningJob to cancel. Format:
            ``projects/{project}/locations/{location}/hyperparameterTuningJobs/{hyperparameter_tuning_job}``
            This corresponds to the ``name`` field on the ``request`` instance;
            if ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  async def create_batch_prediction_job(
    ...
    r"""Creates a BatchPredictionJob.

        A BatchPredictionJob
            ...
            .. code-block:: python
                ...
                async def sample_create_batch_prediction_job():
                    ...
                    batch_prediction_job.input_config.instances_format =
                    "instances_format_value"
                    batch_prediction_job.output_config.gcs_destination.output_uri_prefix
                    = "output_uri_prefix_value"
                    batch_prediction_job.output_config.predictions_format =
                    "predictions_format_value"
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CreateBatchPredictionJobRequest,
            dict]): The request object. Request message for
            [JobService.CreateBatchPredictionJob][google.cloud.aiplatform.v1.JobService.CreateBatchPredictionJob].
            parent (:class:`str`): Required. The resource name of the Location
            to create the BatchPredictionJob in. Format:
            ``projects/{project}/locations/{location}``  This corresponds to the
            ``parent`` field on the ``request`` instance; if ``request`` is
            provided, this should not be set. batch_prediction_job
            (:class:`google.cloud.aiplatform_v1.types.BatchPredictionJob`):
            Required. The BatchPredictionJob to create.  This corresponds to the
            ``batch_prediction_job`` field on the ``request`` instance; if
            ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
  ...
  async def get_batch_prediction_job(
    ...
    r"""Gets a BatchPredictionJob
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.GetBatchPredictionJobRequest,
            dict]): The request object. Request message for
            [JobService.GetBatchPredictionJob][google.cloud.aiplatform.v1.JobService.GetBatchPredictionJob].
            name (:class:`str`): Required. The name of the BatchPredictionJob
            resource.
                    Format:
  ...
  async def list_batch_prediction_jobs(
    ...
    r"""Lists BatchPredictionJobs in a Location.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListBatchPredictionJobsRequest,
            dict]): The request object. Request message for
            [JobService.ListBatchPredictionJobs][google.cloud.aiplatform.v1.JobService.ListBatchPredictionJobs].
            parent (:class:`str`): Required. The resource name of the Location
            to list the BatchPredictionJobs from. Format:
            ``projects/{project}/locations/{location}``  This corresponds to the
            ``parent`` field on the ``request`` instance; if ``request`` is
            provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  async def delete_batch_prediction_job(
    ...
    r"""Deletes a BatchPredictionJob.
        ...
        Can only be called on
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.DeleteBatchPredictionJobRequest,
            dict]): The request object. Request message for
  ...
  async def cancel_batch_prediction_job(
    ...
    r"""Cancels a BatchPredictionJob.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CancelBatchPredictionJobRequest,
            dict]): The request object. Request message for
            [JobService.CancelBatchPredictionJob][google.cloud.aiplatform.v1.JobService.CancelBatchPredictionJob].
            name (:class:`str`): Required. The name of the BatchPredictionJob to
            cancel.
                    Format:
                    ``projects/{project}/locations/{location}/batchPredictionJobs/{batch_prediction_job}``
                    This corresponds to the ``name`` field on the ``request``
  ...
  async def create_model_deployment_monitoring_job(
      self,
      request: Union[job_service.CreateModelDeploymentMonitoringJobRequest,
                     dict] = None,
      *,
      parent: str = None,
      model_deployment_monitoring_job: gca_model_deployment_monitoring_job
      .ModelDeploymentMonitoringJob = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
      timeout: float = None,
      metadata: Sequence[Tuple[str, str]] = (),
  ) -> gca_model_deployment_monitoring_job.ModelDeploymentMonitoringJob:
    r"""Creates a ModelDeploymentMonitoringJob.
        ...
        It will run
            ...
            .. code-block:: python
                ...
                async def sample_create_model_deployment_monitoring_job():
                    ...
                    aiplatform_v1.ModelDeploymentMonitoringJob()
                    model_deployment_monitoring_job.display_name =
                    "display_name_value"
                    model_deployment_monitoring_job.endpoint = "endpoint_value"

                    request =
                    aiplatform_v1.CreateModelDeploymentMonitoringJobRequest(
                        parent="parent_value",
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CreateModelDeploymentMonitoringJobRequest,
            dict]): The request object. Request message for
            [JobService.CreateModelDeploymentMonitoringJob][google.cloud.aiplatform.v1.JobService.CreateModelDeploymentMonitoringJob].
            parent (:class:`str`): Required. The parent of the
            ModelDeploymentMonitoringJob. Format:
            ``projects/{project}/locations/{location}``  This corresponds to the
            ``parent`` field on the ``request`` instance; if ``request`` is
            provided, this should not be set. model_deployment_monitoring_job
            (:class:`google.cloud.aiplatform_v1.types.ModelDeploymentMonitoringJob`):
            Required. The ModelDeploymentMonitoringJob to create  This
            corresponds to the ``model_deployment_monitoring_job`` field on the
  ...
  async def search_model_deployment_monitoring_stats_anomalies(
    ...
    r"""Searches Model Monitoring Statistics generated within
            ...
            .. code-block:: python
                ...
                async def
                sample_search_model_deployment_monitoring_stats_anomalies():
                    # Create a client
                    client = aiplatform_v1.JobServiceAsyncClient()

                    # Initialize request argument(s)
                    request =
                    aiplatform_v1.SearchModelDeploymentMonitoringStatsAnomaliesRequest(
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.SearchModelDeploymentMonitoringStatsAnomaliesRequest,
            dict]): The request object. Request message for
            ...
            model_deployment_monitoring_job (:class:`str`): Required.
            ModelDeploymentMonitoring Job resource name.
                    Format:
                    ``projects/{project}/locations/{location}/modelDeploymentMonitoringJobs/{model_deployment_monitoring_job}``
                    This corresponds to the ``model_deployment_monitoring_job``
                    field on the ``request`` instance; if ``request`` is
                    provided, this should not be set. deployed_model_id
                    (:class:`str`): Required. The DeployedModel ID of the
                    [ModelDeploymentMonitoringObjectiveConfig.deployed_model_id].
                    This corresponds to the ``deployed_model_id`` field on the
                    ``request`` instance; if ``request`` is provided, this
                    should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
  ...
  async def get_model_deployment_monitoring_job(
      self,
      request: Union[job_service.GetModelDeploymentMonitoringJobRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Gets a ModelDeploymentMonitoringJob.
            ...
            .. code-block:: python
                ...
                async def sample_get_model_deployment_monitoring_job():
                    ...
                    # Initialize request argument(s)
                    request =
                    aiplatform_v1.GetModelDeploymentMonitoringJobRequest(
                        name="name_value",
                    )
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.GetModelDeploymentMonitoringJobRequest,
            dict]): The request object. Request message for
  ...
  async def list_model_deployment_monitoring_jobs(
      self,
      request: Union[job_service.ListModelDeploymentMonitoringJobsRequest,
                     dict] = None,
      *,
      parent: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Lists ModelDeploymentMonitoringJobs in a Location.
            ...
            .. code-block:: python
                ...
                async def sample_list_model_deployment_monitoring_jobs():
                    ...
                    # Initialize request argument(s)
                    request =
                    aiplatform_v1.ListModelDeploymentMonitoringJobsRequest(
                        parent="parent_value",
                    )
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListModelDeploymentMonitoringJobsRequest,
            dict]): The request object. Request message for
  ...
  async def update_model_deployment_monitoring_job(
      self,
      request: Union[job_service.UpdateModelDeploymentMonitoringJobRequest,
                     dict] = None,
      *,
      model_deployment_monitoring_job: gca_model_deployment_monitoring_job
      .ModelDeploymentMonitoringJob = None,
    ...
    r"""Updates a ModelDeploymentMonitoringJob.
            ...
            .. code-block:: python
                ...
                async def sample_update_model_deployment_monitoring_job():
                    ...
                    request =
                    aiplatform_v1.UpdateModelDeploymentMonitoringJobRequest(
                        model_deployment_monitoring_job=model_deployment_monitoring_job,
                    )
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.UpdateModelDeploymentMonitoringJobRequest,
            dict]): The request object. Request message for
            [JobService.UpdateModelDeploymentMonitoringJob][google.cloud.aiplatform.v1.JobService.UpdateModelDeploymentMonitoringJob].
            model_deployment_monitoring_job
            (:class:`google.cloud.aiplatform_v1.types.ModelDeploymentMonitoringJob`):
            Required. The model monitoring configuration which replaces the
            resource on the server.  This corresponds to the
            ``model_deployment_monitoring_job`` field on the ``request``
            instance; if ``request`` is provided, this should not be set.
            update_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
            Required. The update mask is used to specify the fields to be
            overwritten in the ModelDeploymentMonitoringJob resource by the
            update. The fields specified in the update_mask are relative to the
            resource, not the full request. A field will be overwritten if it is
            in the mask. If the user does not provide a mask then only the
            non-empty fields present in the request will be overwritten. Set the
            update_mask to ``*`` to override all fields. For the objective
            config, the user can either provide the update mask for
            ...
            and - ``model_deployment_monitoring_objective_configs`` . or -
            ``model_deployment_monitoring_objective_configs.objective_config.training_dataset``
            -
            ``model_deployment_monitoring_objective_configs.objective_config.training_prediction_skew_detection_config``
            -
            ``model_deployment_monitoring_objective_configs.objective_config.prediction_drift_detection_config``
            This corresponds to the ``update_mask`` field on the ``request``
            instance; if ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
            ...
            Returns:
                google.api_core.operation_async.AsyncOperation:
                    ...
                    The result type for the operation will be
                    :class:`google.cloud.aiplatform_v1.types.ModelDeploymentMonitoringJob`
                    Represents a job that runs periodically to monitor the
                    deployed
                    models in an
  ...
  async def delete_model_deployment_monitoring_job(
      self,
      request: Union[job_service.DeleteModelDeploymentMonitoringJobRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Deletes a ModelDeploymentMonitoringJob.
            ...
            .. code-block:: python
                ...
                async def sample_delete_model_deployment_monitoring_job():
                    ...
                    # Initialize request argument(s)
                    request =
                    aiplatform_v1.DeleteModelDeploymentMonitoringJobRequest(
                        name="name_value",
                    )
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.DeleteModelDeploymentMonitoringJobRequest,
            dict]): The request object. Request message for
            ...
            monitoring job to delete. Format:
            ``projects/{project}/locations/{location}/modelDeploymentMonitoringJobs/{model_deployment_monitoring_job}``
            This corresponds to the ``name`` field on the ``request`` instance;
            if ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  async def pause_model_deployment_monitoring_job(
      self,
      request: Union[job_service.PauseModelDeploymentMonitoringJobRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Pauses a ModelDeploymentMonitoringJob.
        ...
        If the job is running,
            ...
            .. code-block:: python
                ...
                async def sample_pause_model_deployment_monitoring_job():
                    ...
                    # Initialize request argument(s)
                    request =
                    aiplatform_v1.PauseModelDeploymentMonitoringJobRequest(
                        name="name_value",
                    )
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.PauseModelDeploymentMonitoringJobRequest,
            dict]): The request object. Request message for
  ...
  async def resume_model_deployment_monitoring_job(
      self,
      request: Union[job_service.ResumeModelDeploymentMonitoringJobRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Resumes a paused ModelDeploymentMonitoringJob.
        ...
        It
            ...
            .. code-block:: python
                ...
                async def sample_resume_model_deployment_monitoring_job():
                    ...
                    # Initialize request argument(s)
                    request =
                    aiplatform_v1.ResumeModelDeploymentMonitoringJobRequest(
                        name="name_value",
                    )
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ResumeModelDeploymentMonitoringJobRequest,
            dict]): The request object. Request message for
