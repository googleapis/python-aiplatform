...
class JobServiceClient(metaclass=JobServiceClientMeta):
  ...
  def parse_hyperparameter_tuning_job_path(path: str) -> Dict[str, str]:
    """Parses a hyperparameter_tuning_job path into its component
  ...
  def parse_model_deployment_monitoring_job_path(path: str) -> Dict[str, str]:
    """Parses a model_deployment_monitoring_job path into its component
  ...
  def get_custom_job(
    ...
    r"""Gets a CustomJob.
            ...
            [JobService.GetCustomJob][google.cloud.aiplatform.v1.JobService.GetCustomJob].
                name (str): Required. The name of the CustomJob resource.
                Format:
  ...
  def list_custom_jobs(
    ...
    r"""Lists CustomJobs in a Location.
            ...
            [JobService.ListCustomJobs][google.cloud.aiplatform.v1.JobService.ListCustomJobs].
                parent (str): Required. The resource name of the Location to
                list the CustomJobs from. Format:
                ``projects/{project}/locations/{location}``  This corresponds to
                the ``parent`` field on the ``request`` instance; if ``request``
                is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
    ...
    r"""Cancels a CustomJob.
        ...
        Starts asynchronous cancellation on the
            ...
            [JobService.CancelCustomJob][google.cloud.aiplatform.v1.JobService.CancelCustomJob].
                name (str): Required. The name of the CustomJob to cancel.
                Format:
                ``projects/{project}/locations/{location}/customJobs/{custom_job}``
                This corresponds to the ``name`` field on the ``request``
                instance; if ``request`` is provided, this should not be set.
  ...
  def create_data_labeling_job(
    ...
    r"""Creates a DataLabelingJob.
            ...
            [JobService.CreateDataLabelingJob][google.cloud.aiplatform.v1.JobService.CreateDataLabelingJob].
                parent (str): Required. The parent of the DataLabelingJob.
                ...
                data_labeling_job
                (google.cloud.aiplatform_v1.types.DataLabelingJob): Required.
  ...
  def delete_data_labeling_job(
    ...
    r"""Deletes a DataLabelingJob.
            ...
            [JobService.DeleteDataLabelingJob][google.cloud.aiplatform.v1.JobService.DeleteDataLabelingJob].
                name (str): Required. The name of the DataLabelingJob to be
                deleted.
                    Format:
                    ``projects/{project}/locations/{location}/dataLabelingJobs/{data_labeling_job}``
                    This corresponds to the ``name`` field on the ``request``
  ...
  def create_hyperparameter_tuning_job(
    ...
    r"""Creates a HyperparameterTuningJob
            ...
            [JobService.CreateHyperparameterTuningJob][google.cloud.aiplatform.v1.JobService.CreateHyperparameterTuningJob].
                parent (str): Required. The resource name of the Location to
                create the HyperparameterTuningJob in. Format:
                ``projects/{project}/locations/{location}``  This corresponds to
                the ``parent`` field on the ``request`` instance; if ``request``
                is provided, this should not be set. hyperparameter_tuning_job
                (google.cloud.aiplatform_v1.types.HyperparameterTuningJob):
                Required. The HyperparameterTuningJob to create.  This
                corresponds to the ``hyperparameter_tuning_job`` field on the
  ...
  def list_hyperparameter_tuning_jobs(
    ...
    r"""Lists HyperparameterTuningJobs in a Location.
            ...
            [JobService.ListHyperparameterTuningJobs][google.cloud.aiplatform.v1.JobService.ListHyperparameterTuningJobs].
                parent (str): Required. The resource name of the Location to
                list the HyperparameterTuningJobs from. Format:
                ``projects/{project}/locations/{location}``  This corresponds to
                the ``parent`` field on the ``request`` instance; if ``request``
                is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
    ...
    r"""Creates a BatchPredictionJob.
        ...
        A BatchPredictionJob
            ...
            [JobService.CreateBatchPredictionJob][google.cloud.aiplatform.v1.JobService.CreateBatchPredictionJob].
                ...
                (google.cloud.aiplatform_v1.types.BatchPredictionJob): Required.
                The BatchPredictionJob to create.  This corresponds to the
  ...
  def get_batch_prediction_job(
    ...
    r"""Gets a BatchPredictionJob
            ...
            [JobService.GetBatchPredictionJob][google.cloud.aiplatform.v1.JobService.GetBatchPredictionJob].
                name (str): Required. The name of the BatchPredictionJob
                resource.
                    Format:
  ...
  def list_batch_prediction_jobs(
    ...
    r"""Lists BatchPredictionJobs in a Location.
            ...
            [JobService.ListBatchPredictionJobs][google.cloud.aiplatform.v1.JobService.ListBatchPredictionJobs].
                parent (str): Required. The resource name of the Location to
                list the BatchPredictionJobs from. Format:
                ``projects/{project}/locations/{location}``  This corresponds to
                the ``parent`` field on the ``request`` instance; if ``request``
                is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  def cancel_batch_prediction_job(
    ...
    r"""Cancels a BatchPredictionJob.
            ...
            [JobService.CancelBatchPredictionJob][google.cloud.aiplatform.v1.JobService.CancelBatchPredictionJob].
                name (str): Required. The name of the BatchPredictionJob to
                cancel.
                    Format:
                    ``projects/{project}/locations/{location}/batchPredictionJobs/{batch_prediction_job}``
                    This corresponds to the ``name`` field on the ``request``
  ...
  def update_model_deployment_monitoring_job(
    ...
    r"""Updates a ModelDeploymentMonitoringJob.
            ...
            instance; if ``request`` is provided, this should not be set.
                ...
                the resource, not the full request. A field will be overwritten
                if it is in the mask. If the user does not provide a mask then
                only the non-empty fields present in the request will be
                overwritten. Set the update_mask to ``*`` to override all
                fields. For the objective config, the user can either provide
                the update mask for
  ...
  def delete_model_deployment_monitoring_job(
    ...
    r"""Deletes a ModelDeploymentMonitoringJob.
            ...
            [JobService.DeleteModelDeploymentMonitoringJob][google.cloud.aiplatform.v1.JobService.DeleteModelDeploymentMonitoringJob].
                name (str): Required. The resource name of the model monitoring
                job to delete. Format:
                ``projects/{project}/locations/{location}/modelDeploymentMonitoringJobs/{model_deployment_monitoring_job}``
                This corresponds to the ``name`` field on the ``request``
                instance; if ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
