...
class JobServiceGrpcAsyncIOTransport(JobServiceTransport):
  ...
  def create_custom_job(
      self,
  ) -> Callable[[job_service.CreateCustomJobRequest],
  ...
  def get_custom_job(
      self,
  ) -> Callable[[job_service.GetCustomJobRequest],
  ...
  def delete_custom_job(
      self,
  ) -> Callable[[job_service.DeleteCustomJobRequest],
  ...
  def cancel_custom_job(
      self,
  ) -> Callable[[job_service.CancelCustomJobRequest],
  ...
  def cancel_data_labeling_job(
      self,
  ) -> Callable[[job_service.CancelDataLabelingJobRequest],
                Awaitable[empty_pb2.Empty]]:
  ...
  def get_hyperparameter_tuning_job(
    ...
    if "get_hyperparameter_tuning_job" not in self._stubs:
      self._stubs[
          "get_hyperparameter_tuning_job"] = self.grpc_channel.unary_unary(
  ...
  def create_batch_prediction_job(
    ...
    if "create_batch_prediction_job" not in self._stubs:
      self._stubs[
          "create_batch_prediction_job"] = self.grpc_channel.unary_unary(
  ...
  def delete_batch_prediction_job(
    ...
    if "delete_batch_prediction_job" not in self._stubs:
      self._stubs[
          "delete_batch_prediction_job"] = self.grpc_channel.unary_unary(
  ...
  def cancel_batch_prediction_job(
      self,
  ) -> Callable[[job_service.CancelBatchPredictionJobRequest],
                Awaitable[empty_pb2.Empty]]:
    ...
    if "cancel_batch_prediction_job" not in self._stubs:
      self._stubs[
          "cancel_batch_prediction_job"] = self.grpc_channel.unary_unary(
  ...
  def create_model_deployment_monitoring_job(
      self,
  ) -> Callable[[job_service.CreateModelDeploymentMonitoringJobRequest],
                Awaitable[gca_model_deployment_monitoring_job
