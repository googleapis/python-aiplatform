...
class JobServiceTransport(abc.ABC):
    ...
    def create_custom_job(
        self,
    ) -> Callable[[job_service.CreateCustomJobRequest], Union[
            gca_custom_job.CustomJob, Awaitable[gca_custom_job.CustomJob]],]:
        raise NotImplementedError()

    @property
    def get_custom_job(
        self,
    ) -> Callable[[job_service.GetCustomJobRequest], Union[
            custom_job.CustomJob, Awaitable[custom_job.CustomJob]],]:
        raise NotImplementedError()
    ...
    def delete_custom_job(
        self,
    ) -> Callable[[job_service.DeleteCustomJobRequest], Union[
    ...
    def cancel_custom_job(
        self,
    ) -> Callable[[job_service.CancelCustomJobRequest], Union[
    ...
    def create_data_labeling_job(
        self,
                  ...
                  Union[gca_data_labeling_job.DataLabelingJob,
    ...
    def get_data_labeling_job(
        self,
                  ...
                  Union[data_labeling_job.DataLabelingJob,
    ...
    def delete_data_labeling_job(
        self,
    ) -> Callable[[job_service.DeleteDataLabelingJobRequest], Union[
            operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
        raise NotImplementedError()
    ...
    def cancel_data_labeling_job(
        self,
    ) -> Callable[[job_service.CancelDataLabelingJobRequest], Union[
            empty_pb2.Empty, Awaitable[empty_pb2.Empty]],]:
        raise NotImplementedError()
    ...
    def create_hyperparameter_tuning_job(
        self,
    ) -> Callable[[job_service.CreateHyperparameterTuningJobRequest], Union[
    ...
    def get_hyperparameter_tuning_job(
        self,
    ) -> Callable[[job_service.GetHyperparameterTuningJobRequest], Union[
    ...
    def list_hyperparameter_tuning_jobs(
        self,
    ) -> Callable[[job_service.ListHyperparameterTuningJobsRequest], Union[
    ...
    def delete_hyperparameter_tuning_job(
        self,
    ) -> Callable[[job_service.DeleteHyperparameterTuningJobRequest], Union[
            operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
        raise NotImplementedError()
    ...
    def cancel_hyperparameter_tuning_job(
        self,
    ) -> Callable[[job_service.CancelHyperparameterTuningJobRequest], Union[
            empty_pb2.Empty, Awaitable[empty_pb2.Empty]],]:
        raise NotImplementedError()
    ...
    def create_batch_prediction_job(
        self,
    ) -> Callable[[job_service.CreateBatchPredictionJobRequest], Union[
    ...
    def get_batch_prediction_job(
        self,
                  ...
                  Union[batch_prediction_job.BatchPredictionJob,
    ...
    def list_batch_prediction_jobs(
        self,
    ) -> Callable[[job_service.ListBatchPredictionJobsRequest], Union[
    ...
    def delete_batch_prediction_job(
        self,
    ) -> Callable[[job_service.DeleteBatchPredictionJobRequest], Union[
            operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
        raise NotImplementedError()
    ...
    def cancel_batch_prediction_job(
        self,
    ) -> Callable[[job_service.CancelBatchPredictionJobRequest], Union[
            empty_pb2.Empty, Awaitable[empty_pb2.Empty]],]:
        raise NotImplementedError()
    ...
    def create_model_deployment_monitoring_job(
        self,
    ) -> Callable[[job_service.CreateModelDeploymentMonitoringJobRequest], Union[
    ...
    def search_model_deployment_monitoring_stats_anomalies(
        ...
        [job_service.SearchModelDeploymentMonitoringStatsAnomaliesRequest], Union[
    ...
    def get_model_deployment_monitoring_job(
        self,
    ) -> Callable[[job_service.GetModelDeploymentMonitoringJobRequest], Union[
        model_deployment_monitoring_job.ModelDeploymentMonitoringJob,
        Awaitable[model_deployment_monitoring_job
                  .ModelDeploymentMonitoringJob],],]:
        raise NotImplementedError()
    ...
    def list_model_deployment_monitoring_jobs(
        self,
    ) -> Callable[[job_service.ListModelDeploymentMonitoringJobsRequest], Union[
    ...
    def update_model_deployment_monitoring_job(
        self,
    ) -> Callable[[job_service.UpdateModelDeploymentMonitoringJobRequest], Union[
            operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
        raise NotImplementedError()
    ...
    def delete_model_deployment_monitoring_job(
        self,
    ) -> Callable[[job_service.DeleteModelDeploymentMonitoringJobRequest], Union[
            operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
        raise NotImplementedError()
    ...
    def pause_model_deployment_monitoring_job(
        self,
    ) -> Callable[[job_service.PauseModelDeploymentMonitoringJobRequest], Union[
            empty_pb2.Empty, Awaitable[empty_pb2.Empty]],]:
        raise NotImplementedError()
    ...
    def resume_model_deployment_monitoring_job(
        self,
    ) -> Callable[[job_service.ResumeModelDeploymentMonitoringJobRequest], Union[
            empty_pb2.Empty, Awaitable[empty_pb2.Empty]],]:
        raise NotImplementedError()
