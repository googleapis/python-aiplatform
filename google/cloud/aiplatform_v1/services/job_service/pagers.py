...
class ListCustomJobsPager:
  """A pager for iterating through ``list_custom_jobs`` requests.
    ...
    All the usual
    :class:`google.cloud.aiplatform_v1.types.ListCustomJobsResponse`
...
class ListDataLabelingJobsPager:
  """A pager for iterating through ``list_data_labeling_jobs`` requests.
    ...
    This class thinly wraps an initial
    :class:`google.cloud.aiplatform_v1.types.ListDataLabelingJobsResponse`
    object, and
    provides an ``__iter__`` method to iterate through its
  ...
  def __init__(self,
    ...
    """Instantiate the pager.
        ...
        Args:
            method (Callable): The method that was originally called, and which
              instantiated this pager. request
              (google.cloud.aiplatform_v1.types.ListDataLabelingJobsRequest):
              The initial request object. response
...
class ListDataLabelingJobsAsyncPager:
  ...
  @property
  async def pages(
      self) -> AsyncIterator[job_service.ListDataLabelingJobsResponse]:
    yield self._response
    while self._response.next_page_token:
      self._request.page_token = self._response.next_page_token
      self._response = await self._method(
...
class ListHyperparameterTuningJobsPager:
  """A pager for iterating through ``list_hyperparameter_tuning_jobs``
    ...
    This class thinly wraps an initial
    :class:`google.cloud.aiplatform_v1.types.ListHyperparameterTuningJobsResponse`
    object, and
    provides an ``__iter__`` method to iterate through its
  ...
  def __iter__(
      self) -> Iterator[hyperparameter_tuning_job.HyperparameterTuningJob]:
    for page in self.pages:
...
class ListHyperparameterTuningJobsAsyncPager:
  ...
  @property
  async def pages(
      self,) -> AsyncIterator[job_service.ListHyperparameterTuningJobsResponse]:
    yield self._response
    while self._response.next_page_token:
      self._request.page_token = self._response.next_page_token
      self._response = await self._method(
...
class ListBatchPredictionJobsPager:
  """A pager for iterating through ``list_batch_prediction_jobs`` requests.
    ...
    This class thinly wraps an initial
    :class:`google.cloud.aiplatform_v1.types.ListBatchPredictionJobsResponse`
    object, and
    provides an ``__iter__`` method to iterate through its
...
class ListBatchPredictionJobsAsyncPager:
  ...
  @property
  async def pages(
      self) -> AsyncIterator[job_service.ListBatchPredictionJobsResponse]:
    yield self._response
    while self._response.next_page_token:
      self._request.page_token = self._response.next_page_token
      self._response = await self._method(
...
class SearchModelDeploymentMonitoringStatsAnomaliesPager:
  """A pager for iterating through
    ...
    ``search_model_deployment_monitoring_stats_anomalies`` requests.

    This class thinly wraps an initial
    :class:`google.cloud.aiplatform_v1.types.SearchModelDeploymentMonitoringStatsAnomaliesResponse`
    object, and
    provides an ``__iter__`` method to iterate through its
    ``monitoring_stats`` field.

    If there are more pages, the ``__iter__`` method will make additional
    ``SearchModelDeploymentMonitoringStatsAnomalies`` requests and continue to
    iterate
...
class ListModelDeploymentMonitoringJobsPager:
  """A pager for iterating through ``list_model_deployment_monitoring_jobs``
    ...
    This class thinly wraps an initial
    :class:`google.cloud.aiplatform_v1.types.ListModelDeploymentMonitoringJobsResponse`
    object, and
    provides an ``__iter__`` method to iterate through its
  ...
  def __init__(
    ...
    """
    self._method = method
    self._request = job_service.ListModelDeploymentMonitoringJobsRequest(
        request)
    self._response = response
    self._metadata = metadata
  ...
  @property
  def pages(
      self) -> Iterator[job_service.ListModelDeploymentMonitoringJobsResponse]:
    yield self._response
    while self._response.next_page_token:
      self._request.page_token = self._response.next_page_token
      self._response = self._method(self._request, metadata=self._metadata)
