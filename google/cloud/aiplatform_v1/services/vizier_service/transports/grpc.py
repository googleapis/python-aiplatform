...
class VizierServiceGrpcTransport(VizierServiceTransport):
  ...
  @property
  def create_study(
      self,) -> Callable[[vizier_service.CreateStudyRequest], gca_study.Study]:
  ...
  @property
  def get_study(
      self) -> Callable[[vizier_service.GetStudyRequest], study.Study]:
  ...
  @property
  def delete_study(
      self,) -> Callable[[vizier_service.DeleteStudyRequest], empty_pb2.Empty]:
  ...
  @property
  def lookup_study(
      self,) -> Callable[[vizier_service.LookupStudyRequest], study.Study]:
  ...
  def suggest_trials(
      self,
  ) -> Callable[[vizier_service.SuggestTrialsRequest],
  ...
  @property
  def create_trial(
      self,) -> Callable[[vizier_service.CreateTrialRequest], study.Trial]:
  ...
  @property
  def get_trial(
      self) -> Callable[[vizier_service.GetTrialRequest], study.Trial]:
  ...
  def add_trial_measurement(
    ...
    if 'add_trial_measurement' not in self._stubs:
      self._stubs['add_trial_measurement'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=vizier_service.AddTrialMeasurementRequest
          .serialize,
          response_deserializer=study.Trial.deserialize,
      )
  ...
  @property
  def complete_trial(
      self,) -> Callable[[vizier_service.CompleteTrialRequest], study.Trial]:
  ...
  @property
  def delete_trial(
      self,) -> Callable[[vizier_service.DeleteTrialRequest], empty_pb2.Empty]:
  ...
  def check_trial_early_stopping_state(
      self,
  ) -> Callable[[vizier_service.CheckTrialEarlyStoppingStateRequest],
                operations_pb2.Operation]:
    ...
    if 'check_trial_early_stopping_state' not in self._stubs:
      self._stubs[
          'check_trial_early_stopping_state'] = self.grpc_channel.unary_unary(
              '/google.cloud.aiplatform.v1.VizierService/CheckTrialEarlyStoppingState',
              request_serializer=vizier_service
              .CheckTrialEarlyStoppingStateRequest.serialize,
              response_deserializer=operations_pb2.Operation.FromString,
          )
  ...
  @property
  def stop_trial(
      self) -> Callable[[vizier_service.StopTrialRequest], study.Trial]:
  ...
  def list_optimal_trials(
    ...
    if 'list_optimal_trials' not in self._stubs:
      self._stubs['list_optimal_trials'] = self.grpc_channel.unary_unary(
          ...
          response_deserializer=vizier_service.ListOptimalTrialsResponse
          .deserialize,
      )
