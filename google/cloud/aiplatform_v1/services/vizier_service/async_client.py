...
class VizierServiceAsyncClient:
  ...
  parse_custom_job_path = staticmethod(
      VizierServiceClient.parse_custom_job_path)
  ...
  def from_service_account_info(cls, info: dict, *args, **kwargs):
    """Creates an instance of this client using the provided credentials.
        ...
        """
    return VizierServiceClient.from_service_account_info.__func__(
        VizierServiceAsyncClient, info, *args, **kwargs)  # type: ignore
  ...
  def from_service_account_file(cls, filename: str, *args, **kwargs):
    """Creates an instance of this client using the provided credentials.
        ...
        Returns:
            VizierServiceAsyncClient: The constructed client.
        """
    return VizierServiceClient.from_service_account_file.__func__(
        VizierServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
  ...
  def get_mtls_endpoint_and_cert_source(
    ...
    """Return the API endpoint and client cert source for mutual TLS.
        ...
        """
    return VizierServiceClient.get_mtls_endpoint_and_cert_source(
    ...
    """Instantiates the vizier service client.
        ...
        Args:
            credentials (Optional[google.auth.credentials.Credentials]): The
              ...
              environment.
            transport (Union[str, ~.VizierServiceTransport]): The transport to
  ...
  async def create_study(
    ...
    r"""Creates a Study.
        ...
        A resource name will be generated
            ...
            .. code-block:: python
                ...
                async def sample_create_study():
                    ...
                    study.study_spec.parameters.double_value_spec.min_value =
                    0.96
                    study.study_spec.parameters.double_value_spec.max_value =
                    0.962
                    study.study_spec.parameters.parameter_id =
                    "parameter_id_value"
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CreateStudyRequest, dict]):
            ...
            to create the CustomJob in. Format:
            ``projects/{project}/locations/{location}``  This corresponds to the
            ``parent`` field on the ``request`` instance; if ``request`` is
            provided, this should not be set. study
            (:class:`google.cloud.aiplatform_v1.types.Study`): Required. The
            Study configuration used to create the Study.  This corresponds to
            the ``study`` field on the ``request`` instance; if ``request`` is
  ...
  async def get_study(
    ...
    r"""Gets a Study by name.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.GetStudyRequest, dict]): The
            request object. Request message for
            [VizierService.GetStudy][google.cloud.aiplatform.v1.VizierService.GetStudy].
            name (:class:`str`): Required. The name of the Study resource.
                  Format:
  ...
  async def list_studies(
    ...
    r"""Lists all the studies in a region for an associated
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListStudiesRequest, dict]):
            The request object. Request message for
            [VizierService.ListStudies][google.cloud.aiplatform.v1.VizierService.ListStudies].
            parent (:class:`str`): Required. The resource name of the Location
            to list the Study from. Format:
            ``projects/{project}/locations/{location}``  This corresponds to the
            ``parent`` field on the ``request`` instance; if ``request`` is
            provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  async def delete_study(
    ...
    r"""Deletes a Study.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.DeleteStudyRequest, dict]):
            The request object. Request message for
            [VizierService.DeleteStudy][google.cloud.aiplatform.v1.VizierService.DeleteStudy].
            name (:class:`str`): Required. The name of the Study resource to be
            deleted.
                    Format:
                    ``projects/{project}/locations/{location}/studies/{study}``
                    This corresponds to the ``name`` field on the ``request``
  ...
  async def lookup_study(
    ...
    r"""Looks a study up using the user-defined display_name field
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.LookupStudyRequest, dict]):
            The request object. Request message for
            [VizierService.LookupStudy][google.cloud.aiplatform.v1.VizierService.LookupStudy].
            parent (:class:`str`): Required. The resource name of the Location
            to get the Study from. Format:
            ``projects/{project}/locations/{location}``  This corresponds to the
            ``parent`` field on the ``request`` instance; if ``request`` is
            provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  async def suggest_trials(
    ...
    r"""Adds one or more Trials to a Study, with parameter values
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.SuggestTrialsRequest,
  ...
  async def create_trial(
    ...
    r"""Adds a user provided Trial to a Study.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CreateTrialRequest, dict]):
            The request object. Request message for
            [VizierService.CreateTrial][google.cloud.aiplatform.v1.VizierService.CreateTrial].
            parent (:class:`str`): Required. The resource name of the Study to
            create the Trial in. Format:
            ``projects/{project}/locations/{location}/studies/{study}``  This
            corresponds to the ``parent`` field on the ``request`` instance; if
            ``request`` is provided, this should not be set. trial
            (:class:`google.cloud.aiplatform_v1.types.Trial`): Required. The
            Trial to create. This corresponds to the ``trial`` field on the
  ...
  async def get_trial(
    ...
    r"""Gets a Trial.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.GetTrialRequest, dict]): The
            request object. Request message for
            [VizierService.GetTrial][google.cloud.aiplatform.v1.VizierService.GetTrial].
            name (:class:`str`): Required. The name of the Trial resource.
                  Format:
  ...
  async def list_trials(
    ...
    r"""Lists the Trials associated with a Study.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListTrialsRequest, dict]):
            The request object. Request message for
            [VizierService.ListTrials][google.cloud.aiplatform.v1.VizierService.ListTrials].
            parent (:class:`str`): Required. The resource name of the Study to
            list the Trial from. Format:
            ``projects/{project}/locations/{location}/studies/{study}``  This
            corresponds to the ``parent`` field on the ``request`` instance; if
  ...
  async def add_trial_measurement(
    ...
    r"""Adds a measurement of the objective metrics to a
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.AddTrialMeasurementRequest,
            dict]): The request object. Request message for
  ...
  async def complete_trial(
    ...
    r"""Marks a Trial as complete.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CompleteTrialRequest,
            dict]): The request object. Request message for
  ...
  async def delete_trial(
    ...
    r"""Deletes a Trial.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.DeleteTrialRequest, dict]):
            The request object. Request message for
            [VizierService.DeleteTrial][google.cloud.aiplatform.v1.VizierService.DeleteTrial].
            name (:class:`str`): Required. The Trial's name. Format:
            ``projects/{project}/locations/{location}/studies/{study}/trials/{trial}``
  ...
  async def check_trial_early_stopping_state(
      self,
      request: Union[vizier_service.CheckTrialEarlyStoppingStateRequest,
                     dict] = None,
      *,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
      timeout: float = None,
    ...
    r"""Checks whether a Trial should stop or not.
        ...
        Returns a
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CheckTrialEarlyStoppingStateRequest,
            dict]): The request object. Request message for
  ...
  async def stop_trial(
    ...
    r"""Stops a Trial.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.StopTrialRequest, dict]):
            The request object. Request message for
  ...
  async def list_optimal_trials(
    ...
    r"""Lists the pareto-optimal Trials for multi-objective Study or the
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListOptimalTrialsRequest,
            dict]): The request object. Request message for
            [VizierService.ListOptimalTrials][google.cloud.aiplatform.v1.VizierService.ListOptimalTrials].
            parent (:class:`str`): Required. The name of the Study that the
            optimal Trial belongs to.  This corresponds to the ``parent`` field
            on the ``request`` instance; if ``request`` is provided, this should
            not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
