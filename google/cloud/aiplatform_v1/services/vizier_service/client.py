...
class VizierServiceClient(metaclass=VizierServiceClientMeta):
    ...
    r"""Creates a Study.
        ...
        A resource name will be generated
            ...
            [VizierService.CreateStudy][google.cloud.aiplatform.v1.VizierService.CreateStudy].
                ...
                create the CustomJob in. Format:
                ...
                study (google.cloud.aiplatform_v1.types.Study): Required. The
                Study configuration used to create the Study.  This corresponds
                to the ``study`` field on the ``request`` instance; if
  ...
  def get_study(
    ...
    r"""Gets a Study by name.
            ...
            [VizierService.GetStudy][google.cloud.aiplatform.v1.VizierService.GetStudy].
                name (str): Required. The name of the Study resource. Format:
  ...
  def delete_study(
    ...
    r"""Deletes a Study.
            ...
            [VizierService.DeleteStudy][google.cloud.aiplatform.v1.VizierService.DeleteStudy].
                name (str): Required. The name of the Study resource to be
                deleted.
                    Format:
                    ``projects/{project}/locations/{location}/studies/{study}``
                    This corresponds to the ``name`` field on the ``request``
  ...
  def lookup_study(
    ...
    r"""Looks a study up using the user-defined display_name field
            ...
            [VizierService.LookupStudy][google.cloud.aiplatform.v1.VizierService.LookupStudy].
                parent (str): Required. The resource name of the Location to get
                the Study from. Format:
                ``projects/{project}/locations/{location}`` This corresponds to
                the ``parent`` field on the ``request`` instance; if ``request``
                is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  def create_trial(
    ...
    r"""Adds a user provided Trial to a Study.
            ...
            [VizierService.CreateTrial][google.cloud.aiplatform.v1.VizierService.CreateTrial].
                parent (str): Required. The resource name of the Study to create
                the Trial in. Format:
                ``projects/{project}/locations/{location}/studies/{study}``
                This corresponds to the ``parent`` field on the ``request``
                instance; if ``request`` is provided, this should not be set.
                trial (google.cloud.aiplatform_v1.types.Trial): Required. The
  ...
  def get_trial(
    ...
    r"""Gets a Trial.
            ...
            [VizierService.GetTrial][google.cloud.aiplatform.v1.VizierService.GetTrial].
                name (str): Required. The name of the Trial resource. Format:
  ...
  def list_trials(
    ...
    r"""Lists the Trials associated with a Study.
            ...
            [VizierService.ListTrials][google.cloud.aiplatform.v1.VizierService.ListTrials].
                parent (str): Required. The resource name of the Study to list
                the Trial from. Format:
                ``projects/{project}/locations/{location}/studies/{study}``
                This corresponds to the ``parent`` field on the ``request``
                instance; if ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  def add_trial_measurement(
    ...
    rpc = self._transport._wrapped_methods[
        self._transport.add_trial_measurement]
  ...
  def delete_trial(
    ...
    r"""Deletes a Trial.
            ...
            [VizierService.DeleteTrial][google.cloud.aiplatform.v1.VizierService.DeleteTrial].
                name (str): Required. The Trial's name. Format:
                ``projects/{project}/locations/{location}/studies/{study}/trials/{trial}``
                This corresponds to the ``name`` field on the ``request``
                instance; if ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  def list_optimal_trials(
    ...
    r"""Lists the pareto-optimal Trials for multi-objective Study or the
            ...
            [VizierService.ListOptimalTrials][google.cloud.aiplatform.v1.VizierService.ListOptimalTrials].
                parent (str): Required. The name of the Study that the optimal
                Trial belongs to.  This corresponds to the ``parent`` field on
