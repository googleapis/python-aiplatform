...
class SpecialistPoolServiceAsyncClient:
  ...
  def from_service_account_info(cls, info: dict, *args, **kwargs):
    ...
    return SpecialistPoolServiceClient.from_service_account_info.__func__(
        SpecialistPoolServiceAsyncClient, info, *args, **kwargs)  # type: ignore
  ...
  async def create_specialist_pool(
    ...
    r"""Creates a SpecialistPool.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.CreateSpecialistPoolRequest,
              ...
              parent (:class:`str`): Required. The parent Project name for the
              new SpecialistPool. The form is
              ``projects/{project}/locations/{location}``.  This corresponds to
              the ``parent`` field on the ``request`` instance; if ``request``
              is provided, this should not be set. specialist_pool
              (:class:`google.cloud.aiplatform_v1.types.SpecialistPool`):
              Required. The SpecialistPool to create.  This corresponds to the
              ``specialist_pool`` field on the ``request`` instance; if
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.aiplatform_v1.types.SpecialistPool`
                SpecialistPool represents customers' own workforce to work on
                their data
  ...
  async def get_specialist_pool(
    ...
    r"""Gets a SpecialistPool.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.GetSpecialistPoolRequest,
              dict]): The request object. Request message for
              [SpecialistPoolService.GetSpecialistPool][google.cloud.aiplatform.v1.SpecialistPoolService.GetSpecialistPool].
              name (:class:`str`): Required. The name of the SpecialistPool
              resource. The form is
  ...
  async def list_specialist_pools(
    ...
    r"""Lists SpecialistPools in a Location.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.ListSpecialistPoolsRequest,
              dict]): The request object. Request message for
              [SpecialistPoolService.ListSpecialistPools][google.cloud.aiplatform.v1.SpecialistPoolService.ListSpecialistPools].
              parent (:class:`str`): Required. The name of the SpecialistPool's
  ...
  async def delete_specialist_pool(
    ...
    r"""Deletes a SpecialistPool as well as all Specialists
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.DeleteSpecialistPoolRequest,
              dict]): The request object. Request message for
              [SpecialistPoolService.DeleteSpecialistPool][google.cloud.aiplatform.v1.SpecialistPoolService.DeleteSpecialistPool].
              name (:class:`str`): Required. The resource name of the
              SpecialistPool to delete. Format:
              ``projects/{project}/locations/{location}/specialistPools/{specialist_pool}``
              This corresponds to the ``name`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
  ...
  async def update_specialist_pool(
    ...
    r"""Updates a SpecialistPool.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1.types.UpdateSpecialistPoolRequest,
              dict]): The request object. Request message for
              [SpecialistPoolService.UpdateSpecialistPool][google.cloud.aiplatform.v1.SpecialistPoolService.UpdateSpecialistPool].
              specialist_pool
              (:class:`google.cloud.aiplatform_v1.types.SpecialistPool`):
              Required. The SpecialistPool which replaces the resource on the
              server.  This corresponds to the ``specialist_pool`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set. update_mask
              (:class:`google.protobuf.field_mask_pb2.FieldMask`): Required. The
              update mask applies to the resource.  This corresponds to the
