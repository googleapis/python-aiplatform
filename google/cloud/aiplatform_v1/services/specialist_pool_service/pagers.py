...
class ListSpecialistPoolsPager:
  """A pager for iterating through ``list_specialist_pools`` requests.
    ...
    :class:`google.cloud.aiplatform_v1.types.ListSpecialistPoolsResponse`
    object, and
  ...
  def __init__(
    ...
    """Instantiate the pager.
        ...
        Args:
            ...
            request
              (google.cloud.aiplatform_v1.types.ListSpecialistPoolsRequest): The
  ...
  @property
  def pages(
      self) -> Iterator[specialist_pool_service.ListSpecialistPoolsResponse]:
