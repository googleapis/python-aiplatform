...
class IndexEndpointServiceGrpcTransport(IndexEndpointServiceTransport):
  ...
  def create_index_endpoint(
      self,
  ) -> Callable[[index_endpoint_service.CreateIndexEndpointRequest],
    ...
    if 'create_index_endpoint' not in self._stubs:
      self._stubs['create_index_endpoint'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=index_endpoint_service.CreateIndexEndpointRequest
          .serialize,
  ...
  def get_index_endpoint(
      self,
  ) -> Callable[[index_endpoint_service.GetIndexEndpointRequest],
    ...
    if 'get_index_endpoint' not in self._stubs:
      self._stubs['get_index_endpoint'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=index_endpoint_service.GetIndexEndpointRequest
          .serialize,
  ...
  def list_index_endpoints(
      self,
  ) -> Callable[[index_endpoint_service.ListIndexEndpointsRequest],
    ...
    if 'list_index_endpoints' not in self._stubs:
      self._stubs['list_index_endpoints'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=index_endpoint_service.ListIndexEndpointsRequest
          .serialize,
          response_deserializer=index_endpoint_service
          .ListIndexEndpointsResponse.deserialize,
      )
  ...
  def update_index_endpoint(
    ...
    if 'update_index_endpoint' not in self._stubs:
      self._stubs['update_index_endpoint'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=index_endpoint_service.UpdateIndexEndpointRequest
          .serialize,
  ...
  def delete_index_endpoint(
      self,
  ) -> Callable[[index_endpoint_service.DeleteIndexEndpointRequest],
                operations_pb2.Operation]:
    ...
    if 'delete_index_endpoint' not in self._stubs:
      self._stubs['delete_index_endpoint'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=index_endpoint_service.DeleteIndexEndpointRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def deploy_index(
      self,
  ) -> Callable[[index_endpoint_service.DeployIndexRequest],
                operations_pb2.Operation]:
    ...
    if 'deploy_index' not in self._stubs:
      self._stubs['deploy_index'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=index_endpoint_service.DeployIndexRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def undeploy_index(
      self,
  ) -> Callable[[index_endpoint_service.UndeployIndexRequest],
                operations_pb2.Operation]:
    ...
    if 'undeploy_index' not in self._stubs:
      self._stubs['undeploy_index'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=index_endpoint_service.UndeployIndexRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def mutate_deployed_index(
      self,
  ) -> Callable[[index_endpoint_service.MutateDeployedIndexRequest],
                operations_pb2.Operation]:
    ...
    if 'mutate_deployed_index' not in self._stubs:
      self._stubs['mutate_deployed_index'] = self.grpc_channel.unary_unary(
          ...
          request_serializer=index_endpoint_service.MutateDeployedIndexRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
