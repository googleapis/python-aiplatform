...
class IndexEndpointServiceAsyncClient:
  ...
  async def create_index_endpoint(
    ...
    r"""Creates an IndexEndpoint.
            ...
            provided, this should not be set. index_endpoint
            (:class:`google.cloud.aiplatform_v1.types.IndexEndpoint`): Required.
            The IndexEndpoint to create.  This corresponds to the
            ``index_endpoint`` field on the ``request`` instance; if ``request``
  ...
  async def update_index_endpoint(
    ...
    r"""Updates an IndexEndpoint.
            ...
            index_endpoint
            (:class:`google.cloud.aiplatform_v1.types.IndexEndpoint`): Required.
            The IndexEndpoint which replaces the resource on the server.  This
            corresponds to the ``index_endpoint`` field on the ``request``
  ...
  async def deploy_index(
    ...
    r"""Deploys an Index into this IndexEndpoint, creating a
            ...
            ``projects/{project}/locations/{location}/indexEndpoints/{index_endpoint}``
            This corresponds to the ``index_endpoint`` field on the ``request``
            instance; if ``request`` is provided, this should not be set.
            deployed_index
            (:class:`google.cloud.aiplatform_v1.types.DeployedIndex`): Required.
            The DeployedIndex to be created within the IndexEndpoint.  This
            corresponds to the ``deployed_index`` field on the ``request``
            instance; if ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
  ...
  async def undeploy_index(
    ...
    r"""Undeploys an Index from an IndexEndpoint, removing a
            ...
            This corresponds to the ``index_endpoint`` field on the ``request``
            instance; if ``request`` is provided, this should not be set.
            deployed_index_id (:class:`str`): Required. The ID of the
  ...
  async def mutate_deployed_index(
    ...
    r"""Update an existing DeployedIndex under an
            ...
            the updatable fields are [DeployedIndex][automatic_resources] and
            [DeployedIndex][dedicated_resources]  This corresponds to the
            ``deployed_index`` field on the ``request`` instance; if ``request``
            is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
