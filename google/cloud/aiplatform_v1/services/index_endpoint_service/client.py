...
class IndexEndpointServiceClient(metaclass=IndexEndpointServiceClientMeta):
    ...
    """Instantiates the index endpoint service client.
        ...
        Args:
            credentials (Optional[google.auth.credentials.Credentials]): The
              ...
              environment.
            transport (Union[str, IndexEndpointServiceTransport]): The transport
  ...
  def create_index_endpoint(
      self,
      request: Union[index_endpoint_service.CreateIndexEndpointRequest,
                     dict] = None,
      *,
      parent: str = None,
    ...
    r"""Creates an IndexEndpoint.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.CreateIndexEndpointRequest,
            ...
            [IndexEndpointService.CreateIndexEndpoint][google.cloud.aiplatform.v1.IndexEndpointService.CreateIndexEndpoint].
                ...
                create the IndexEndpoint in. Format:
                ...
                ``index_endpoint`` field on the ``request`` instance; if
            ...
            Returns:
                google.api_core.operation.Operation:
                    ...
                    :class:`google.cloud.aiplatform_v1.types.IndexEndpoint`
                    Indexes
                    are deployed into it. An IndexEndpoint can have multiple
                       DeployedIndexes.
    ...
    rpc = self._transport._wrapped_methods[
        self._transport.create_index_endpoint]
    ...
    response = gac_operation.from_gapic(
        ...
        metadata_type=index_endpoint_service
  ...
  def get_index_endpoint(
      self,
      request: Union[index_endpoint_service.GetIndexEndpointRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Gets an IndexEndpoint.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.GetIndexEndpointRequest,
            dict]): The request object. Request message for
            [IndexEndpointService.GetIndexEndpoint][google.cloud.aiplatform.v1.IndexEndpointService.GetIndexEndpoint]
                name (str): Required. The name of the IndexEndpoint resource.
                    Format:
  ...
  def list_index_endpoints(
      self,
      request: Union[index_endpoint_service.ListIndexEndpointsRequest,
                     dict] = None,
      *,
      parent: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Lists IndexEndpoints in a Location.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.ListIndexEndpointsRequest,
            dict]): The request object. Request message for
            [IndexEndpointService.ListIndexEndpoints][google.cloud.aiplatform.v1.IndexEndpointService.ListIndexEndpoints].
                parent (str): Required. The resource name of the Location from
                which to list the IndexEndpoints. Format:
                ``projects/{project}/locations/{location}``  This corresponds to
                the ``parent`` field on the ``request`` instance; if ``request``
                is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
  ...
  def update_index_endpoint(
      self,
      request: Union[index_endpoint_service.UpdateIndexEndpointRequest,
                     dict] = None,
      *,
      index_endpoint: gca_index_endpoint.IndexEndpoint = None,
    ...
    r"""Updates an IndexEndpoint.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.UpdateIndexEndpointRequest,
            dict]): The request object. Request message for
            [IndexEndpointService.UpdateIndexEndpoint][google.cloud.aiplatform.v1.IndexEndpointService.UpdateIndexEndpoint].
                index_endpoint (google.cloud.aiplatform_v1.types.IndexEndpoint):
                Required. The IndexEndpoint which replaces the resource on the
                server.  This corresponds to the ``index_endpoint`` field on the
    ...
    # and friendly error handling.
    rpc = self._transport._wrapped_methods[
        self._transport.update_index_endpoint]
  ...
  def delete_index_endpoint(
      self,
      request: Union[index_endpoint_service.DeleteIndexEndpointRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Deletes an IndexEndpoint.
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.DeleteIndexEndpointRequest,
            dict]): The request object. Request message for
            [IndexEndpointService.DeleteIndexEndpoint][google.cloud.aiplatform.v1.IndexEndpointService.DeleteIndexEndpoint].
                name (str): Required. The name of the IndexEndpoint resource to
                be deleted. Format:
                ``projects/{project}/locations/{location}/indexEndpoints/{index_endpoint}``
                This corresponds to the ``name`` field on the ``request``
                instance; if ``request`` is provided, this should not be set.
    ...
    # and friendly error handling.
    rpc = self._transport._wrapped_methods[
        self._transport.delete_index_endpoint]
  ...
  def deploy_index(
    ...
    r"""Deploys an Index into this IndexEndpoint, creating a
            ...
            [IndexEndpointService.DeployIndex][google.cloud.aiplatform.v1.IndexEndpointService.DeployIndex].
                index_endpoint (str): Required. The name of the IndexEndpoint
                resource into which to deploy an Index. Format:
                ``projects/{project}/locations/{location}/indexEndpoints/{index_endpoint}``
                This corresponds to the ``index_endpoint`` field on the
                ``request`` instance; if ``request`` is provided, this should
                not be set.
                deployed_index (google.cloud.aiplatform_v1.types.DeployedIndex):
                Required. The DeployedIndex to be created within the
                IndexEndpoint.  This corresponds to the ``deployed_index`` field
  ...
  def undeploy_index(
    ...
    r"""Undeploys an Index from an IndexEndpoint, removing a
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.UndeployIndexRequest,
            dict]): The request object. Request message for
            [IndexEndpointService.UndeployIndex][google.cloud.aiplatform.v1.IndexEndpointService.UndeployIndex].
                index_endpoint (str): Required. The name of the IndexEndpoint
                resource from which to undeploy an Index. Format:
                ``projects/{project}/locations/{location}/indexEndpoints/{index_endpoint}``
                This corresponds to the ``index_endpoint`` field on the
                ``request`` instance; if ``request`` is provided, this should
                not be set.
                deployed_index_id (str): Required. The ID of the DeployedIndex
                to be undeployed from the IndexEndpoint.  This corresponds to
                the ``deployed_index_id`` field on the ``request`` instance; if
                ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
  ...
  def mutate_deployed_index(
      self,
      request: Union[index_endpoint_service.MutateDeployedIndexRequest,
                     dict] = None,
      *,
      index_endpoint: str = None,
      deployed_index: gca_index_endpoint.DeployedIndex = None,
    ...
    r"""Update an existing DeployedIndex under an
            ...
            Args: request
            (Union[google.cloud.aiplatform_v1.types.MutateDeployedIndexRequest,
            dict]): The request object. Request message for
            [IndexEndpointService.MutateDeployedIndex][google.cloud.aiplatform.v1.IndexEndpointService.MutateDeployedIndex].
                ...
                [DeployedIndex][dedicated_resources]  This corresponds to the
                ``deployed_index`` field on the ``request`` instance; if
                ``request`` is provided, this should not be set.
                retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
                timeout (float): The timeout for this request.
    ...
    # and friendly error handling.
    rpc = self._transport._wrapped_methods[
        self._transport.mutate_deployed_index]
