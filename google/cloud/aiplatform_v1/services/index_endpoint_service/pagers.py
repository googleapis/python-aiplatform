...
class ListIndexEndpointsPager:
  """A pager for iterating through ``list_index_endpoints`` requests.
    ...
    :class:`google.cloud.aiplatform_v1.types.ListIndexEndpointsResponse` object,
    and
    ...
    All the usual
    :class:`google.cloud.aiplatform_v1.types.ListIndexEndpointsResponse`
    ...
    """Instantiate the pager.
        ...
        Args:
            method (Callable): The method that was originally called, and which
              ...
              (google.cloud.aiplatform_v1.types.ListIndexEndpointsRequest): The
              initial request object. response
              (google.cloud.aiplatform_v1.types.ListIndexEndpointsResponse): The
