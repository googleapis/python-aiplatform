...
class EndpointServiceTransport(abc.ABC):
  ...
  def create_endpoint(
      self,
  ) -> Callable[[endpoint_service.CreateEndpointRequest], Union[
  ...
  def get_endpoint(
      self,
  ) -> Callable[[endpoint_service.GetEndpointRequest], Union[
      endpoint.Endpoint, Awaitable[endpoint.Endpoint]],]:
    raise NotImplementedError()

  @property
  def list_endpoints(
      self,
  ) -> Callable[[endpoint_service.ListEndpointsRequest],
                Union[endpoint_service.ListEndpointsResponse,
  ...
  def update_endpoint(
      self,
  ) -> Callable[[endpoint_service.UpdateEndpointRequest], Union[
      gca_endpoint.Endpoint, Awaitable[gca_endpoint.Endpoint]],]:
    raise NotImplementedError()

  @property
  def delete_endpoint(
      self,
  ) -> Callable[[endpoint_service.DeleteEndpointRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def deploy_model(
      self,
  ) -> Callable[[endpoint_service.DeployModelRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def undeploy_model(
      self,
  ) -> Callable[[endpoint_service.UndeployModelRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
