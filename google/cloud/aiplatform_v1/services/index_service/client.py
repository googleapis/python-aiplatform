  ...
  def create_index(
    ...
    r"""Creates an Index.
        ...
        Args:
            ...
            index (google.cloud.aiplatform_v1.types.Index): Required. The Index
              to create. This corresponds to the ``index`` field on the
  ...
  def update_index(
    ...
    r"""Updates an Index.
        ...
        Args:
            ...
            index (google.cloud.aiplatform_v1.types.Index): Required. The Index
              which updates the resource on the server.  This corresponds to the
              ``index`` field on the ``request`` instance; if ``request`` is
