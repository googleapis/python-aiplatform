...
class IndexServiceAsyncClient:
  ...
  parse_common_folder_path = staticmethod(
      IndexServiceClient.parse_common_folder_path)
  common_organization_path = staticmethod(
      IndexServiceClient.common_organization_path)
  ...
  def from_service_account_info(cls, info: dict, *args, **kwargs):
    """Creates an instance of this client using the provided credentials
        ...
        """
    return IndexServiceClient.from_service_account_info.__func__(
        IndexServiceAsyncClient, info, *args, **kwargs)  # type: ignore
  ...
  def from_service_account_file(cls, filename: str, *args, **kwargs):
    """Creates an instance of this client using the provided credentials
        ...
        Returns:
            IndexServiceAsyncClient: The constructed client.
        """
    return IndexServiceClient.from_service_account_file.__func__(
        IndexServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
  ...
  def get_mtls_endpoint_and_cert_source(
    ...
    """Return the API endpoint and client cert source for mutual TLS.
        ...
        """
    return IndexServiceClient.get_mtls_endpoint_and_cert_source(
    ...
    """Instantiates the index service client.
        ...
        Args:
            credentials (Optional[google.auth.credentials.Credentials]): The
              ...
              environment.
            transport (Union[str, ~.IndexServiceTransport]): The transport to
    ...
    r"""Creates an Index.
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.CreateIndexRequest,
              ...
              to create the Index in. Format:
              ``projects/{project}/locations/{location}``  This corresponds to
              the ``parent`` field on the ``request`` instance; if ``request``
              is provided, this should not be set. index
              (:class:`google.cloud.aiplatform_v1.types.Index`): Required. The
              Index to create. This corresponds to the ``index`` field on the
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.aiplatform_v1.types.Index` A representation
                of a collection of database items organized in a way that
  ...
  async def get_index(
    ...
    r"""Gets an Index.
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.GetIndexRequest,
              dict]): The request object. Request message for
              [IndexService.GetIndex][google.cloud.aiplatform.v1.IndexService.GetIndex]
              name (:class:`str`): Required. The name of the Index resource.
              Format:
              ``projects/{project}/locations/{location}/indexes/{index}``  This
  ...
  async def list_indexes(
    ...
    r"""Lists Indexes in a Location.
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.ListIndexesRequest,
              dict]): The request object. Request message for
              [IndexService.ListIndexes][google.cloud.aiplatform.v1.IndexService.ListIndexes].
              parent (:class:`str`): Required. The resource name of the Location
              from which to list the Indexes. Format:
              ``projects/{project}/locations/{location}``  This corresponds to
              the ``parent`` field on the ``request`` instance; if ``request``
    ...
    r"""Updates an Index.
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.UpdateIndexRequest,
              ...
              index (:class:`google.cloud.aiplatform_v1.types.Index`): Required.
              The Index which updates the resource on the server.  This
              corresponds to the ``index`` field on the ``request`` instance; if
              ``request`` is provided, this should not be set. update_mask
              (:class:`google.protobuf.field_mask_pb2.FieldMask`): The update
              mask applies to the resource. For the ``FieldMask`` definition,
              see [google.protobuf.FieldMask][google.protobuf.FieldMask].  This
  ...
  async def delete_index(
    ...
    An Index can only be deleted when all its
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.DeleteIndexRequest,
              dict]): The request object. Request message for
              [IndexService.DeleteIndex][google.cloud.aiplatform.v1.IndexService.DeleteIndex].
              name (:class:`str`): Required. The name of the Index resource to
              be deleted.
                Format:
