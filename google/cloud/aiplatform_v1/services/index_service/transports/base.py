...
class IndexServiceTransport(abc.ABC):
  ...
  def create_index(
      self,
  ) -> Callable[[index_service.CreateIndexRequest], Union[
  ...
  def get_index(
      self,
  ) -> Callable[[index_service.GetIndexRequest], Union[index.Index,
  ...
  def update_index(
      self,
  ) -> Callable[[index_service.UpdateIndexRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def delete_index(
      self,
  ) -> Callable[[index_service.DeleteIndexRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
