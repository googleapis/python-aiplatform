...
class MetadataServiceGrpcAsyncIOTransport(MetadataServiceTransport):
  ...
  def create_metadata_store(
      self,
  ) -> Callable[[metadata_service.CreateMetadataStoreRequest],
    ...
    if "create_metadata_store" not in self._stubs:
      self._stubs["create_metadata_store"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=metadata_service.CreateMetadataStoreRequest
          .serialize,
  ...
  def get_metadata_store(
      self,
  ) -> Callable[[metadata_service.GetMetadataStoreRequest],
  ...
  def list_metadata_stores(
      self,
  ) -> Callable[[metadata_service.ListMetadataStoresRequest],
    ...
    if "list_metadata_stores" not in self._stubs:
      self._stubs["list_metadata_stores"] = self.grpc_channel.unary_unary(
          ...
          .serialize,
          response_deserializer=metadata_service.ListMetadataStoresResponse
          .deserialize,
      )
  ...
  def delete_metadata_store(
      self,
  ) -> Callable[[metadata_service.DeleteMetadataStoreRequest],
                Awaitable[operations_pb2.Operation],]:
    ...
    if "delete_metadata_store" not in self._stubs:
      self._stubs["delete_metadata_store"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=metadata_service.DeleteMetadataStoreRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def create_artifact(
      self,
  ) -> Callable[[metadata_service.CreateArtifactRequest],
  ...
  def get_artifact(
      self,
  ) -> Callable[[metadata_service.GetArtifactRequest],
  ...
  def list_artifacts(
      self,
  ) -> Callable[[metadata_service.ListArtifactsRequest],
    ...
    if "list_artifacts" not in self._stubs:
      self._stubs["list_artifacts"] = self.grpc_channel.unary_unary(
          ...
          response_deserializer=metadata_service.ListArtifactsResponse
          .deserialize,
      )
  ...
  def update_artifact(
      self,
  ) -> Callable[[metadata_service.UpdateArtifactRequest],
                Awaitable[gca_artifact.Artifact]]:
  ...
  def delete_artifact(
      self,
  ) -> Callable[[metadata_service.DeleteArtifactRequest],
                Awaitable[operations_pb2.Operation]]:
  ...
  def purge_artifacts(
      self,
  ) -> Callable[[metadata_service.PurgeArtifactsRequest],
                Awaitable[operations_pb2.Operation]]:
  ...
  def create_context(
      self,
  ) -> Callable[[metadata_service.CreateContextRequest],
  ...
  def get_context(
      self,
  ) -> Callable[[metadata_service.GetContextRequest],
  ...
  def list_contexts(
      self,
  ) -> Callable[[metadata_service.ListContextsRequest],
    ...
    if "list_contexts" not in self._stubs:
      self._stubs["list_contexts"] = self.grpc_channel.unary_unary(
          ...
          response_deserializer=metadata_service.ListContextsResponse
          .deserialize,
      )
  ...
  def update_context(
      self,
  ) -> Callable[[metadata_service.UpdateContextRequest],
                Awaitable[gca_context.Context]]:
  ...
  def delete_context(
      self,
  ) -> Callable[[metadata_service.DeleteContextRequest],
                Awaitable[operations_pb2.Operation]]:
  ...
  def purge_contexts(
      self,
  ) -> Callable[[metadata_service.PurgeContextsRequest],
                Awaitable[operations_pb2.Operation]]:
  ...
  def add_context_artifacts_and_executions(
    ...
    if "add_context_artifacts_and_executions" not in self._stubs:
      self._stubs[
          "add_context_artifacts_and_executions"] = self.grpc_channel.unary_unary(
              "/google.cloud.aiplatform.v1.MetadataService/AddContextArtifactsAndExecutions",
              request_serializer=metadata_service
              .AddContextArtifactsAndExecutionsRequest.serialize,
              response_deserializer=metadata_service
              .AddContextArtifactsAndExecutionsResponse.deserialize,
          )
  ...
  def add_context_children(
      self,
  ) -> Callable[[metadata_service.AddContextChildrenRequest],
    ...
    if "add_context_children" not in self._stubs:
      self._stubs["add_context_children"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=metadata_service.AddContextChildrenRequest
          .serialize,
          response_deserializer=metadata_service.AddContextChildrenResponse
          .deserialize,
      )
  ...
  def query_context_lineage_subgraph(
      self,
  ) -> Callable[[metadata_service.QueryContextLineageSubgraphRequest],
  ...
  def create_execution(
      self,
  ) -> Callable[[metadata_service.CreateExecutionRequest],
  ...
  def get_execution(
      self,
  ) -> Callable[[metadata_service.GetExecutionRequest],
  ...
  def list_executions(
      self,
  ) -> Callable[[metadata_service.ListExecutionsRequest],
    ...
    if "list_executions" not in self._stubs:
      self._stubs["list_executions"] = self.grpc_channel.unary_unary(
          ...
          response_deserializer=metadata_service.ListExecutionsResponse
          .deserialize,
      )
  ...
  def update_execution(
      self,
  ) -> Callable[[metadata_service.UpdateExecutionRequest],
                Awaitable[gca_execution.Execution]]:
  ...
  def delete_execution(
      self,
  ) -> Callable[[metadata_service.DeleteExecutionRequest],
                Awaitable[operations_pb2.Operation]]:
  ...
  def purge_executions(
      self,
  ) -> Callable[[metadata_service.PurgeExecutionsRequest],
                Awaitable[operations_pb2.Operation]]:
  ...
  def add_execution_events(
      self,
  ) -> Callable[[metadata_service.AddExecutionEventsRequest],
    ...
    if "add_execution_events" not in self._stubs:
      self._stubs["add_execution_events"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=metadata_service.AddExecutionEventsRequest
          .serialize,
          response_deserializer=metadata_service.AddExecutionEventsResponse
          .deserialize,
      )
  ...
  def query_execution_inputs_and_outputs(
      self,
  ) -> Callable[[metadata_service.QueryExecutionInputsAndOutputsRequest],
                Awaitable[lineage_subgraph.LineageSubgraph],]:
    ...
    if "query_execution_inputs_and_outputs" not in self._stubs:
      self._stubs[
          "query_execution_inputs_and_outputs"] = self.grpc_channel.unary_unary(
              "/google.cloud.aiplatform.v1.MetadataService/QueryExecutionInputsAndOutputs",
              request_serializer=metadata_service
              .QueryExecutionInputsAndOutputsRequest.serialize,
              response_deserializer=lineage_subgraph.LineageSubgraph
              .deserialize,
          )
  ...
  def create_metadata_schema(
      self,
  ) -> Callable[[metadata_service.CreateMetadataSchemaRequest],
    ...
    if "create_metadata_schema" not in self._stubs:
      self._stubs["create_metadata_schema"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=metadata_service.CreateMetadataSchemaRequest
          .serialize,
  ...
  def get_metadata_schema(
      self,
  ) -> Callable[[metadata_service.GetMetadataSchemaRequest],
    ...
    if "get_metadata_schema" not in self._stubs:
      self._stubs["get_metadata_schema"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=metadata_service.GetMetadataSchemaRequest
          .serialize,
  ...
  def list_metadata_schemas(
      self,
  ) -> Callable[[metadata_service.ListMetadataSchemasRequest],
    ...
    if "list_metadata_schemas" not in self._stubs:
      self._stubs["list_metadata_schemas"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=metadata_service.ListMetadataSchemasRequest
          .serialize,
          response_deserializer=metadata_service.ListMetadataSchemasResponse
          .deserialize,
      )
  ...
  def query_artifact_lineage_subgraph(
      self,
  ) -> Callable[[metadata_service.QueryArtifactLineageSubgraphRequest],
                Awaitable[lineage_subgraph.LineageSubgraph],]:
    ...
    if "query_artifact_lineage_subgraph" not in self._stubs:
      self._stubs["query_artifact_lineage_subgraph"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=metadata_service
          .QueryArtifactLineageSubgraphRequest.serialize,
          response_deserializer=lineage_subgraph.LineageSubgraph.deserialize,
      )
