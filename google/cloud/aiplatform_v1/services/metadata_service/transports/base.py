...
class MetadataServiceTransport(abc.ABC):
  ...
  def create_metadata_store(
      self,
  ) -> Callable[[metadata_service.CreateMetadataStoreRequest], Union[
  ...
  def get_metadata_store(
      self,
  ) -> Callable[[metadata_service.GetMetadataStoreRequest], Union[
      metadata_store.MetadataStore, Awaitable[metadata_store.MetadataStore]],]:
    raise NotImplementedError()

  @property
  def list_metadata_stores(
      self,
  ) -> Callable[[metadata_service.ListMetadataStoresRequest], Union[
  ...
  def delete_metadata_store(
      self,
  ) -> Callable[[metadata_service.DeleteMetadataStoreRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def create_artifact(
      self,
  ) -> Callable[[metadata_service.CreateArtifactRequest], Union[
      gca_artifact.Artifact, Awaitable[gca_artifact.Artifact]],]:
    raise NotImplementedError()

  @property
  def get_artifact(
      self,
  ) -> Callable[[metadata_service.GetArtifactRequest], Union[
      artifact.Artifact, Awaitable[artifact.Artifact]],]:
    raise NotImplementedError()
  ...
  def list_artifacts(
      self,
                ...
                Union[metadata_service.ListArtifactsResponse,
  ...
  def update_artifact(
      self,
  ) -> Callable[[metadata_service.UpdateArtifactRequest], Union[
      gca_artifact.Artifact, Awaitable[gca_artifact.Artifact]],]:
    raise NotImplementedError()
  ...
  def delete_artifact(
      self,
  ) -> Callable[[metadata_service.DeleteArtifactRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def purge_artifacts(
      self,
  ) -> Callable[[metadata_service.PurgeArtifactsRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def create_context(
      self,
  ) -> Callable[[metadata_service.CreateContextRequest], Union[
      gca_context.Context, Awaitable[gca_context.Context]],]:
    raise NotImplementedError()

  @property
  def get_context(
      self,
  ) -> Callable[[metadata_service.GetContextRequest], Union[
      context.Context, Awaitable[context.Context]],]:
    raise NotImplementedError()
  ...
  def list_contexts(
      self,
                ...
                Union[metadata_service.ListContextsResponse,
  ...
  def update_context(
      self,
  ) -> Callable[[metadata_service.UpdateContextRequest], Union[
      gca_context.Context, Awaitable[gca_context.Context]],]:
    raise NotImplementedError()
  ...
  def delete_context(
      self,
  ) -> Callable[[metadata_service.DeleteContextRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def purge_contexts(
      self,
  ) -> Callable[[metadata_service.PurgeContextsRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def add_context_artifacts_and_executions(
      self,
  ) -> Callable[[metadata_service.AddContextArtifactsAndExecutionsRequest],
                Union[metadata_service.AddContextArtifactsAndExecutionsResponse,
                      Awaitable[metadata_service
  ...
  def add_context_children(
      self,
  ) -> Callable[[metadata_service.AddContextChildrenRequest], Union[
  ...
  def query_context_lineage_subgraph(
      self,
                ...
                Union[lineage_subgraph.LineageSubgraph,
  ...
  def create_execution(
      self,
  ) -> Callable[[metadata_service.CreateExecutionRequest], Union[
      gca_execution.Execution, Awaitable[gca_execution.Execution]],]:
    raise NotImplementedError()

  @property
  def get_execution(
      self,
  ) -> Callable[[metadata_service.GetExecutionRequest], Union[
      execution.Execution, Awaitable[execution.Execution]],]:
    raise NotImplementedError()
  ...
  def list_executions(
      self,
                ...
                Union[metadata_service.ListExecutionsResponse,
  ...
  def update_execution(
      self,
  ) -> Callable[[metadata_service.UpdateExecutionRequest], Union[
      gca_execution.Execution, Awaitable[gca_execution.Execution]],]:
    raise NotImplementedError()
  ...
  def delete_execution(
      self,
  ) -> Callable[[metadata_service.DeleteExecutionRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def purge_executions(
      self,
  ) -> Callable[[metadata_service.PurgeExecutionsRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def add_execution_events(
      self,
  ) -> Callable[[metadata_service.AddExecutionEventsRequest], Union[
  ...
  def create_metadata_schema(
      self,
                ...
                Union[gca_metadata_schema.MetadataSchema,
  ...
  def get_metadata_schema(
      self,
                ...
                Union[metadata_schema.MetadataSchema,
  ...
  def list_metadata_schemas(
      self,
  ) -> Callable[[metadata_service.ListMetadataSchemasRequest], Union[
