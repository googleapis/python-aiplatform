...
class ListMetadataStoresPager:
  """A pager for iterating through ``list_metadata_stores`` requests.
    ...
    :class:`google.cloud.aiplatform_v1.types.ListMetadataStoresResponse` object,
    and
    ...
    All the usual
    :class:`google.cloud.aiplatform_v1.types.ListMetadataStoresResponse`
  ...
  def __init__(self,
    ...
    """Instantiate the pager.
        ...
        Args:
            ...
            request
              (google.cloud.aiplatform_v1.types.ListMetadataStoresRequest): The
              initial request object.
            response
              (google.cloud.aiplatform_v1.types.ListMetadataStoresResponse): The
...
class ListMetadataStoresAsyncPager:
  ...
  @property
  async def pages(
      self) -> AsyncIterator[metadata_service.ListMetadataStoresResponse]:
    yield self._response
    while self._response.next_page_token:
      self._request.page_token = self._response.next_page_token
...
class ListArtifactsPager:
  """A pager for iterating through ``list_artifacts`` requests.
    ...
    All the usual
    :class:`google.cloud.aiplatform_v1.types.ListArtifactsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
  ...
  def __init__(self,
    ...
    """Instantiate the pager.
        ...
        Args:
            method (Callable): The method that was originally called, and which
              instantiated this pager.
            request (google.cloud.aiplatform_v1.types.ListArtifactsRequest): The
              initial request object.
...
class ListArtifactsAsyncPager:
  ...
  @property
  async def pages(
      self) -> AsyncIterator[metadata_service.ListArtifactsResponse]:
    yield self._response
    while self._response.next_page_token:
      self._request.page_token = self._response.next_page_token
      self._response = await self._method(
  ...
  def __init__(self,
    ...
    """Instantiate the pager.
        ...
        Args:
            method (Callable): The method that was originally called, and which
              instantiated this pager.
            request (google.cloud.aiplatform_v1.types.ListContextsRequest): The
              initial request object.
...
class ListExecutionsPager:
  """A pager for iterating through ``list_executions`` requests.
    ...
    All the usual
    :class:`google.cloud.aiplatform_v1.types.ListExecutionsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
...
class ListExecutionsAsyncPager:
  ...
  @property
  async def pages(
      self) -> AsyncIterator[metadata_service.ListExecutionsResponse]:
    yield self._response
    while self._response.next_page_token:
      self._request.page_token = self._response.next_page_token
      self._response = await self._method(
...
class ListMetadataSchemasPager:
  """A pager for iterating through ``list_metadata_schemas`` requests.
    ...
    This class thinly wraps an initial
    :class:`google.cloud.aiplatform_v1.types.ListMetadataSchemasResponse`
    object, and
    provides an ``__iter__`` method to iterate through its
    ...
    """Instantiate the pager.
        ...
        Args:
            method (Callable): The method that was originally called, and which
              instantiated this pager.
            request
              (google.cloud.aiplatform_v1.types.ListMetadataSchemasRequest): The
              initial request object.
            response
...
class ListMetadataSchemasAsyncPager:
  ...
  @property
  async def pages(
      self,) -> AsyncIterator[metadata_service.ListMetadataSchemasResponse]:
    yield self._response
    while self._response.next_page_token:
      self._request.page_token = self._response.next_page_token
      self._response = await self._method(
