...
class MetadataServiceAsyncClient:
  ...
  parse_execution_path = staticmethod(
      MetadataServiceClient.parse_execution_path)
  metadata_schema_path = staticmethod(
  ...
  def from_service_account_info(cls, info: dict, *args, **kwargs):
    """Creates an instance of this client using the provided credentials
        ...
        """
    return MetadataServiceClient.from_service_account_info.__func__(
        MetadataServiceAsyncClient, info, *args, **kwargs)  # type: ignore
  ...
  def from_service_account_file(cls, filename: str, *args, **kwargs):
    """Creates an instance of this client using the provided credentials
        ...
        Returns:
            MetadataServiceAsyncClient: The constructed client.
        """
    return MetadataServiceClient.from_service_account_file.__func__(
        MetadataServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
  ...
  def get_mtls_endpoint_and_cert_source(
    ...
    """Return the API endpoint and client cert source for mutual TLS.
        ...
        """
    return MetadataServiceClient.get_mtls_endpoint_and_cert_source(
  ...
  get_transport_class = functools.partial(
      type(MetadataServiceClient).get_transport_class,
    ...
    r"""Initializes a MetadataStore, including allocation of
        ...
        Args:
            request
              ...
              where the MetadataStore should be created. Format:
              ...
              (:class:`google.cloud.aiplatform_v1.types.MetadataStore`):
              Required. The MetadataStore to create.  This corresponds to the
              ``metadata_store`` field on the ``request`` instance; if
              ``request`` is provided, this should not be set. metadata_store_id
              (:class:`str`): The {metadatastore} portion of the resource name
              with the format:
    ...
    r"""Lists MetadataStores for a Location.
        ...
        Args:
            request
              ...
              parent (:class:`str`): Required. The Location whose MetadataStores
    ...
    r"""Creates an Artifact associated with a MetadataStore.
        ...
        Args:
            request
              ...
              MetadataStore where the Artifact should be created. Format:
              ``projects/{project}/locations/{location}/metadataStores/{metadatastore}``
              ...
              ``artifact`` field on the ``request`` instance; if ``request`` is
              provided, this should not be set. artifact_id (:class:`str`): The
              {artifact} portion of the resource name with the
                format:
    ...
    r"""Retrieves a specific Artifact.
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.GetArtifactRequest,
              ...
              name (:class:`str`): Required. The resource name of the Artifact
              to retrieve.
                Format:
                  ``projects/{project}/locations/{location}/metadataStores/{metadatastore}/artifacts/{artifact}``
                  This corresponds to the ``name`` field on the ``request``
    ...
    r"""Lists Artifacts in the MetadataStore.
        ...
        Args:
            request
              ...
              parent (:class:`str`): Required. The MetadataStore whose Artifacts
              should be listed. Format:
              ``projects/{project}/locations/{location}/metadataStores/{metadatastore}``
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            ...
            request
              ...
              used to identify the Artifact to be updated.
                Format:
                  ...
                  instance; if ``request`` is provided, this should not be set.
                  update_mask
                  (:class:`google.protobuf.field_mask_pb2.FieldMask`): Optional.
                  A FieldMask indicating which fields should be updated.
                  Functionality of this field is not yet supported.  This
    ...
    r"""Purges Artifacts.
        ...
        Args:
            request
              ...
              parent (:class:`str`): Required. The metadata store to purge
              Artifacts from.
                Format:
                  ``projects/{project}/locations/{location}/metadataStores/{metadatastore}``
                  This corresponds to the ``parent`` field on the ``request``
    ...
    r"""Creates a Context associated with a MetadataStore.
        ...
        Args:
            request
              ...
              parent (:class:`str`): Required. The resource name of the
              MetadataStore where the Context should be created. Format:
              ``projects/{project}/locations/{location}/metadataStores/{metadatastore}``
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
              context (:class:`google.cloud.aiplatform_v1.types.Context`):
              Required. The Context to create. This corresponds to the
              ``context`` field on the ``request`` instance; if ``request`` is
              provided, this should not be set. context_id (:class:`str`): The
              {context} portion of the resource name with the
                format:
    ...
    r"""Retrieves a specific Context.
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.GetContextRequest,
              ...
              name (:class:`str`): Required. The resource name of the Context to
              retrieve.
                Format:
                  ``projects/{project}/locations/{location}/metadataStores/{metadatastore}/contexts/{context}``
                  This corresponds to the ``name`` field on the ``request``
    ...
    r"""Lists Contexts on the MetadataStore.
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.ListContextsRequest,
              ...
              parent (:class:`str`): Required. The MetadataStore whose Contexts
              should be listed. Format:
              ``projects/{project}/locations/{location}/metadataStores/{metadatastore}``
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
    ...
    r"""Adds a set of Artifacts and Executions to a Context.
        ...
        Args:
            request
              ...
              context (:class:`str`): Required. The resource name of the Context
              that the Artifacts and Executions belong to. Format:
              ``projects/{project}/locations/{location}/metadataStores/{metadatastore}/contexts/{context}``
              This corresponds to the ``context`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
              artifacts (:class:`Sequence[str]`): The resource names of the
              Artifacts to attribute to the Context.
                Format:
                  ``projects/{project}/locations/{location}/metadataStores/{metadatastore}/artifacts/{artifact}``
                  This corresponds to the ``artifacts`` field on the ``request``
                  instance; if ``request`` is provided, this should not be set.
                  executions (:class:`Sequence[str]`): The resource names of the
                  Executions to associate with the Context.
                Format:
    ...
    If any
        ...
        Args:
            request
              ...
              context (:class:`str`): Required. The resource name of the parent
              Context.
                Format:
                  ``projects/{project}/locations/{location}/metadataStores/{metadatastore}/contexts/{context}``
                  This corresponds to the ``context`` field on the ``request``
                  instance; if ``request`` is provided, this should not be set.
                  child_contexts (:class:`Sequence[str]`): The resource names of
                  the child Contexts.  This corresponds to the
                  ``child_contexts`` field on the ``request`` instance; if
                  ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
            timeout (float): The timeout for this request.
    ...
    r"""Retrieves Artifacts and Executions within the
        ...
        Args:
            request
              ...
              context (:class:`str`): Required. The resource name of the Context
              whose Artifacts and Executions should be retrieved as a
    ...
    r"""Creates an Execution associated with a MetadataStore.
        ...
        Args:
            request
              ...
              parent (:class:`str`): Required. The resource name of the
              MetadataStore where the Execution should be created. Format:
              ``projects/{project}/locations/{location}/metadataStores/{metadatastore}``
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
              ...
              provided, this should not be set. execution_id (:class:`str`): The
              {execution} portion of the resource name with the
                format:
                  ``projects/{project}/locations/{location}/metadataStores/{metadatastore}/executions/{execution}``
    ...
    r"""Retrieves a specific Execution.
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.GetExecutionRequest,
              ...
              name (:class:`str`): Required. The resource name of the Execution
              to retrieve. Format:
              ``projects/{project}/locations/{location}/metadataStores/{metadatastore}/executions/{execution}``
              This corresponds to the ``name`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
    ...
    r"""Lists Executions in the MetadataStore.
        ...
        Args:
            request
              ...
              parent (:class:`str`): Required. The MetadataStore whose
    ...
    An Event
        ...
        Args:
            request
              ...
              execution (:class:`str`): Required. The resource name of the
              Execution that the Events connect Artifacts with. Format:
              ``projects/{project}/locations/{location}/metadataStores/{metadatastore}/executions/{execution}``
              This corresponds to the ``execution`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
              events
              (:class:`Sequence[google.cloud.aiplatform_v1.types.Event]`): The
    ...
    r"""Obtains the set of input and output Artifacts for
        ...
        Args:
            request
              ...
              execution (:class:`str`): Required. The resource name of the
              Execution whose input and output Artifacts should be retrieved as
    ...
    r"""Creates a MetadataSchema.
        ...
        Args:
            request
              ...
              parent (:class:`str`): Required. The resource name of the
              MetadataStore where the MetadataSchema should be created. Format:
              ``projects/{project}/locations/{location}/metadataStores/{metadatastore}``
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
              metadata_schema
              (:class:`google.cloud.aiplatform_v1.types.MetadataSchema`):
              Required. The MetadataSchema to create.  This corresponds to the
              ``metadata_schema`` field on the ``request`` instance; if
              ``request`` is provided, this should not be set.
              metadata_schema_id (:class:`str`): The {metadata_schema} portion
    ...
    r"""Retrieves lineage of an Artifact represented through
        ...
        Args:
            request
              ...
              artifact (:class:`str`): Required. The resource name of the
              Artifact whose Lineage needs to be retrieved as a LineageSubgraph.
                Format:
                  ``projects/{project}/locations/{location}/metadataStores/{metadatastore}/artifacts/{artifact}``
