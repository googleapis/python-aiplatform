...
class Execution(proto.Message):
  r"""Instance of a general execution.
    ...
    Attributes:
        name (str): Output only. The resource name of the Execution.
        display_name (str): User provided display name of the Execution. May be
          up to 128 Unicode characters.
        state (google.cloud.aiplatform_v1.types.Execution.State): The state of
          this Execution. This is a property of the Execution, and does not
        ...
        labels (Mapping[str, str]): The labels with user-defined metadata to
          organize your Executions. Label keys and values can be no longer than
          64 characters (Unicode codepoints), can only contain lowercase
          letters, numeric characters, underscores and dashes. International
          characters are allowed. No more than 64 user labels can be associated
          with one Execution (System labels are excluded).
        ...
        schema_version (str): The version of the schema in ``schema_title`` to
          use.  Schema title and version is expected to be registered in earlier
          Create Schema calls. And both are used together as unique identifiers
          to identify schemas within the local metadata store.
        metadata (google.protobuf.struct_pb2.Struct): Properties of the
          Execution. The size of this field should not exceed 200KB.
