...
class MigratableResource(proto.Message):
  r"""Represents one resource that exists in automl.googleapis.com,
    ...
    Attributes:
        ml_engine_model_version
          ...
          Output only. Represents one Version in ml.googleapis.com.  This field
          is a member of `oneof`_ ``resource``.
        automl_model
          (google.cloud.aiplatform_v1.types.MigratableResource.AutomlModel):
          Output only. Represents one Model in automl.googleapis.com.  This
          field is a member of `oneof`_ ``resource``.
        automl_dataset
          (google.cloud.aiplatform_v1.types.MigratableResource.AutomlDataset):
          Output only. Represents one Dataset in automl.googleapis.com.  This
          field is a member of `oneof`_ ``resource``.
        data_labeling_dataset
          (google.cloud.aiplatform_v1.types.MigratableResource.DataLabelingDataset):
          Output only. Represents one Dataset in datalabeling.googleapis.com.
          This field is a member of `oneof`_ ``resource``.
        last_migrate_time (google.protobuf.timestamp_pb2.Timestamp): Output
          only. Timestamp when the last migration attempt on this
          MigratableResource started. Will not be set if there's no migration
          attempt on this MigratableResource.
        last_update_time (google.protobuf.timestamp_pb2.Timestamp): Output only.
  ...
  class MlEngineModelVersion(proto.Message):
    r"""Represents one model Version in ml.googleapis.com.
        ...
        Attributes:
            endpoint (str): The ml.googleapis.com endpoint that this model
              Version currently lives in. Example values:  -  ml.googleapis.com
              -  us-centrall-ml.googleapis.com -  europe-west4-ml.googleapis.com
              -  asia-east1-ml.googleapis.com
            version (str): Full resource name of ml engine model Version.
  ...
  class AutomlModel(proto.Message):
    r"""Represents one Model in automl.googleapis.com.
        ...
        Attributes:
            model (str): Full resource name of automl Model. Format:
              ``projects/{project}/locations/{location}/models/{model}``.
            model_display_name (str): The Model's display name in
  ...
  class AutomlDataset(proto.Message):
    r"""Represents one Dataset in automl.googleapis.com.
        ...
        Attributes:
            dataset (str): Full resource name of automl Dataset. Format:
              ``projects/{project}/locations/{location}/datasets/{dataset}``.
            dataset_display_name (str): The Dataset's display name in
              automl.googleapis.com.
    """
  ...
  class DataLabelingDataset(proto.Message):
    r"""Represents one Dataset in datalabeling.googleapis.com.
        ...
        Attributes:
            dataset (str): Full resource name of data labeling Dataset. Format:
              ``projects/{project}/datasets/{dataset}``.
            dataset_display_name (str): The Dataset's display name in
              datalabeling.googleapis.com.
            data_labeling_annotated_datasets
              (Sequence[google.cloud.aiplatform_v1.types.MigratableResource.DataLabelingDataset.DataLabelingAnnotatedDataset]):
    ...
    class DataLabelingAnnotatedDataset(proto.Message):
      r"""Represents one AnnotatedDataset in
            ...
            Attributes:
                annotated_dataset (str): Full resource name of data labeling
                  AnnotatedDataset.
                    Format:
                      ``projects/{project}/datasets/{dataset}/annotatedDatasets/{annotated_dataset}``.
                annotated_dataset_display_name (str): The AnnotatedDataset's
                  display name in datalabeling.googleapis.com.
      """
