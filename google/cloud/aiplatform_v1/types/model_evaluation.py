...
class ModelEvaluation(proto.Message):
  r"""A collection of metrics calculated by comparing Model's
    ...
    Attributes:
        name (str): Output only. The resource name of the ModelEvaluation.
        display_name (str): The display name of the ModelEvaluation.
        metrics_schema_uri (str): Points to a YAML file stored on Google Cloud
        ...
        metrics (google.protobuf.struct_pb2.Value): Evaluation metrics of the
          Model. The schema of the metrics is stored in
        ...
        slice_dimensions (Sequence[str]): All possible
          [dimensions][ModelEvaluationSlice.slice.dimension] of
          ModelEvaluationSlices. The dimensions can be used as the filter of the
          [ModelService.ListModelEvaluationSlices][google.cloud.aiplatform.v1.ModelService.ListModelEvaluationSlices]
          request, in the form of ``slice.dimension = <dimension>``.
        data_item_schema_uri (str): Points to a YAML file stored on Google Cloud
          ...
          ModelEvaluation.
        annotation_schema_uri (str): Points to a YAML file stored on Google
          Cloud Storage describing [EvaluatedDataItemView.predictions][],
        ...
        model_explanation (google.cloud.aiplatform_v1.types.ModelExplanation):
          Aggregated explanation metrics for the Model's prediction output over
          the data this ModelEvaluation uses. This field is populated only if
          the Model is evaluated with explanations, and only for AutoML tabular
          Models.
        explanation_specs
          (Sequence[google.cloud.aiplatform_v1.types.ModelEvaluation.ModelEvaluationExplanationSpec]):
          Describes the values of
          [ExplanationSpec][google.cloud.aiplatform.v1.ExplanationSpec] that are
          used for explaining the predicted values on the evaluated data.
        metadata (google.protobuf.struct_pb2.Value): The metadata of the
          ModelEvaluation. For the ModelEvaluation uploaded from Managed
          Pipeline, metadata contains a structured value with keys of
          "pipeline_job_id", "evaluation_dataset_type",
  ...
  class ModelEvaluationExplanationSpec(proto.Message):
    r"""
        ...
        Attributes:
            explanation_type (str): Explanation type.  For AutoML Image
              Classification models, possible values are:  -
