...
class TensorboardTimeSeries(proto.Message):
  r"""TensorboardTimeSeries maps to times series produced in
    ...
    Attributes:
        name (str): Output only. Name of the TensorboardTimeSeries.
        display_name (str): Required. User provided name of this
        ...
        description (str): Description of this TensorboardTimeSeries.
        value_type
        ...
        plugin_name (str): Immutable. Name of the plugin this time series
          pertain to. Such as Scalar, Tensor, Blob
        plugin_data (bytes): Data of the current plugin, with the size limited
          to 65KB.
        metadata
  ...
  class Metadata(proto.Message):
    r"""Describes metadata for a TensorboardTimeSeries.
        ...
        Attributes:
            max_step (int): Output only. Max step index of all data points
              within a TensorboardTimeSeries.
            max_wall_time (google.protobuf.timestamp_pb2.Timestamp): Output
              only. Max wall clock timestamp of all data points within a
              TensorboardTimeSeries.
            max_blob_sequence_length (int): Output only. The largest blob
              sequence length (number of blobs) of all data points in this time
