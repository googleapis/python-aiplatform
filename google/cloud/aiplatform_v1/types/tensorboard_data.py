...
class TimeSeriesDataPoint(proto.Message):
  r"""A TensorboardTimeSeries data point.
    ...
    Attributes:
        scalar (google.cloud.aiplatform_v1.types.Scalar): A scalar value.  This
          field is a member of `oneof`_ ``value``.
        tensor (google.cloud.aiplatform_v1.types.TensorboardTensor): A tensor
          value.  This field is a member of `oneof`_ ``value``.
        blobs (google.cloud.aiplatform_v1.types.TensorboardBlobSequence): A blob
          sequence value.  This field is a member of `oneof`_ ``value``.
  ...
  r"""One point viewable on a tensor metric plot.
    ...
    Attributes:
        ...
        version_number (int): Optional. Version number of TensorProto used to
          serialize [value][google.cloud.aiplatform.v1.TensorboardTensor.value].
  """
