...
class ReadTensorboardUsageResponse(proto.Message):
    ...
    Attributes:
        monthly_usage_data (Mapping[str, google.cloud.aiplatform_v1.types.ReadTensorboardUsageResponse.PerMonthUsageData]):
    ...
    class PerMonthUsageData(proto.Message):
        ...
        Attributes:
            user_usage_data (Sequence[google.cloud.aiplatform_v1.types.ReadTensorboardUsageResponse.PerUserUsageData]):
...
class ListTensorboardExperimentsResponse(proto.Message):
    ...
    Attributes:
        tensorboard_experiments (Sequence[google.cloud.aiplatform_v1.types.TensorboardExperiment]):
...
class ReadTensorboardBlobDataResponse(proto.Message):
    ...
    Attributes:
        blobs (Sequence[google.cloud.aiplatform_v1.types.TensorboardBlob]):
