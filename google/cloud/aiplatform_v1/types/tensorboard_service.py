...
class CreateTensorboardRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the Location to create the
          Tensorboard in. Format: ``projects/{project}/locations/{location}``
        tensorboard (google.cloud.aiplatform_v1.types.Tensorboard): Required.
          The Tensorboard to create.
  """
...
class ListTensorboardsRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        filter (str): Lists the Tensorboards that match the filter expression.
        page_size (int): The maximum number of Tensorboards to return. The
          service may return fewer than this value. If unspecified, at most 100
          Tensorboards will be returned. The maximum value is 100; values above
        ...
        order_by (str): Field to use to sort the list.
...
class UpdateTensorboardRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        update_mask (google.protobuf.field_mask_pb2.FieldMask): Required. Field
          ...
          provide a mask then all fields will be overwritten if new values are
          specified.
        tensorboard (google.cloud.aiplatform_v1.types.Tensorboard): Required.
          The Tensorboard's ``name`` field is used to identify the Tensorboard
...
class DeleteTensorboardRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the Tensorboard to be deleted. Format:
          ``projects/{project}/locations/{location}/tensorboards/{tensorboard}``
  """
...
class CreateTensorboardExperimentRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the Tensorboard to create
          the TensorboardExperiment in. Format:
          ``projects/{project}/locations/{location}/tensorboards/{tensorboard}``
        tensorboard_experiment
          (google.cloud.aiplatform_v1.types.TensorboardExperiment): The
          TensorboardExperiment to create.
        tensorboard_experiment_id (str): Required. The ID to use for the
          Tensorboard experiment, which will become the final component of the
    ...
    Attributes:
        parent (str): Required. The resource name of the Tensorboard to list
          TensorboardExperiments.
            Format:
              'projects/{project}/locations/{location}/tensorboards/{tensorboard}'
        filter (str): Lists the TensorboardExperiments that match the filter
          expression.
        page_size (int): The maximum number of TensorboardExperiments to return.
          The service may return fewer than this value. If unspecified, at most
          50 TensorboardExperiments will be returned. The maximum value is 1000;
  ...
  r"""Response message for
    ...
    Attributes:
        tensorboard_experiments
          (Sequence[google.cloud.aiplatform_v1.types.TensorboardExperiment]):
  ...
  r"""Request message for
    ...
    Attributes:
        update_mask (google.protobuf.field_mask_pb2.FieldMask): Required. Field
          ...
          specified.
        tensorboard_experiment
          (google.cloud.aiplatform_v1.types.TensorboardExperiment): Required.
          The TensorboardExperiment's ``name`` field is used to identify the
...
class BatchCreateTensorboardRunsRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the TensorboardExperiment
...
class BatchCreateTensorboardRunsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        tensorboard_runs
          (Sequence[google.cloud.aiplatform_v1.types.TensorboardRun]): The
          created TensorboardRuns.
  """
...
class CreateTensorboardRunRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        tensorboard_run_id (str): Required. The ID to use for the Tensorboard
          run, which will become the final component of the Tensorboard run's
          resource name.  This value should be 1-128 characters, and valid
...
class GetTensorboardRunRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the TensorboardRun resource. Format:
...
class ReadTensorboardBlobDataRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        blob_ids (Sequence[str]): IDs of the blobs to read.
  """
...
class ReadTensorboardBlobDataResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        blobs (Sequence[google.cloud.aiplatform_v1.types.TensorboardBlob]): Blob
          messages containing blob bytes.
  """
...
class ListTensorboardRunsRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the TensorboardExperiment
          to list TensorboardRuns.
            Format:
              'projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}'
        filter (str): Lists the TensorboardRuns that match the filter
          expression.
        page_size (int): The maximum number of TensorboardRuns to return. The
          service may return fewer than this value. If unspecified, at most 50
          TensorboardRuns will be returned. The maximum value is 1000; values
...
class ListTensorboardRunsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        tensorboard_runs
          (Sequence[google.cloud.aiplatform_v1.types.TensorboardRun]): The
          TensorboardRuns mathching the request.
        next_page_token (str): A token, which can be sent as
  ...
  r"""Request message for
    ...
    Attributes:
        ...
        requests
          ...
          create. A maximum of 1000 TensorboardTimeSeries can be created in a
          batch.
  """
  ...
  r"""Response message for
    ...
    Attributes:
        tensorboard_time_series
          (Sequence[google.cloud.aiplatform_v1.types.TensorboardTimeSeries]):
  ...
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the TensorboardRun to
          ...
          ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}``
        tensorboard_time_series_id (str): Optional. The user specified unique ID
          to use for the TensorboardTimeSeries, which will become the final
          component of the TensorboardTimeSeries's resource name. This value
          should match "[a-z0-9][a-z0-9-]{0, 127}".
        tensorboard_time_series
          (google.cloud.aiplatform_v1.types.TensorboardTimeSeries): Required.
...
class ListTensorboardTimeSeriesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the TensorboardRun to list
          TensorboardTimeSeries.
            Format:
              'projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}'
        filter (str): Lists the TensorboardTimeSeries that match the filter
          expression.
        page_size (int): The maximum number of TensorboardTimeSeries to return.
          The service may return fewer than this value. If unspecified, at most
          50 TensorboardTimeSeries will be returned. The maximum value is 1000;
          values above 1000 will be coerced to 1000.
        page_token (str): A page token, received from a previous
          [TensorboardService.ListTensorboardTimeSeries][google.cloud.aiplatform.v1.TensorboardService.ListTensorboardTimeSeries]
          call. Provide this to retrieve the subsequent page.  When paginating,
...
class UpdateTensorboardTimeSeriesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        tensorboard_time_series
          (google.cloud.aiplatform_v1.types.TensorboardTimeSeries): Required.
          The TensorboardTimeSeries' ``name`` field is used to identify the
          TensorboardTimeSeries to be updated. Format:
          ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}/timeSeries/{time_series}``
  """
...
class BatchReadTensorboardTimeSeriesDataRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        time_series (Sequence[str]): Required. The resource names of the
  ...
  r"""Request message for
    ...
    Attributes:
        tensorboard_time_series (str): Required. The resource name of the
          TensorboardTimeSeries to read data from. Format:
          ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}/timeSeries/{time_series}``
        max_data_points (int): The maximum number of TensorboardTimeSeries' data
          to return. This value should be a positive integer. This value can be
          set to -1 to return all data.
        filter (str): Reads the TensorboardTimeSeries' data that match the
          filter expression.
  """
...
class ReadTensorboardTimeSeriesDataResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        time_series_data (google.cloud.aiplatform_v1.types.TimeSeriesData): The
          returned time series data.
  """
...
class WriteTensorboardRunDataRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        tensorboard_run (str): Required. The resource name of the TensorboardRun
          to write data to. Format:
          ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}``
        time_series_data
          (Sequence[google.cloud.aiplatform_v1.types.TimeSeriesData]): Required.
          The TensorboardTimeSeries data to write. Values with in a time series
          are indexed by their step value. Repeated writes to the same step will
          overwrite the existing value for that step. The upper limit of data
  ...
  r"""Request message for
    ...
    Attributes:
        tensorboard_time_series (str): Required. The resource name of the
          ...
          ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}/timeSeries/{time_series}``
        filter (str): Exports the TensorboardTimeSeries' data that match the
          filter expression.
        page_size (int): The maximum number of data points to return per page.
          The default page_size will be 1000. Values must be between 1 and
          10000. Values above 10000 will be coerced to 10000.
        page_token (str): A page token, received from a previous
          [TensorboardService.ExportTensorboardTimeSeries][] call. Provide this
          to retrieve the subsequent page.  When paginating, all other
          parameters provided to
          [TensorboardService.ExportTensorboardTimeSeries][] must match the call
          that provided the page token.
        order_by (str): Field to use to sort the TensorboardTimeSeries' data. By
          default, TensorboardTimeSeries' data will be returned in a pseudo
          random order.
  """
  ...
  r"""Response message for
    ...
    Attributes:
        time_series_data_points
          (Sequence[google.cloud.aiplatform_v1.types.TimeSeriesDataPoint]): The
          returned time series data points.
        next_page_token (str): A token, which can be sent as
