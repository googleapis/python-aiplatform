...
class Model(proto.Message):
  r"""A trained machine learning Model.
    ...
    Attributes:
        ...
        predict_schemata (google.cloud.aiplatform_v1.types.PredictSchemata): The
          schemata that describe formats of the Model's predictions and
        ...
        supported_export_formats
          (Sequence[google.cloud.aiplatform_v1.types.Model.ExportFormat]):
        ...
        supported_deployment_resources_types
          (Sequence[google.cloud.aiplatform_v1.types.Model.DeploymentResourcesType]):
        ...
        deployed_models
          (Sequence[google.cloud.aiplatform_v1.types.DeployedModelRef]): Output
          only. The pointers to DeployedModels created from this Model. Note
          that Model could have been deployed to Endpoints in different
          Locations.
        explanation_spec (google.cloud.aiplatform_v1.types.ExplanationSpec): The
          default explanation specification for this Model.  The Model can be
          used for [requesting explanation][PredictionService.Explain] after
          being
          [deployed][google.cloud.aiplatform.v1.EndpointService.DeployModel] if
    ...
    r"""Represents export format supported by the Model.
        ...
        Attributes:
            id (str): Output only. The ID of the export format. The possible
              ...
              code.
            exportable_contents
              (Sequence[google.cloud.aiplatform_v1.types.Model.ExportFormat.ExportableContent]):
  ...
  Some fields in
    ...
    Attributes:
        ...
        command (Sequence[str]): Immutable. Specifies the command that runs when
          ...
          [args][google.cloud.aiplatform.v1.ModelContainerSpec.args] field or
          the container's ```CMD``
          ...
          [env][google.cloud.aiplatform.v1.ModelContainerSpec.env] field. You
        ...
        args (Sequence[str]): Immutable. Specifies arguments for the command
          ...
          <https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#container-v1-core>`__.
        env (Sequence[google.cloud.aiplatform_v1.types.EnvVar]): Immutable. List
          ...
          <https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#container-v1-core>`__.
        ports (Sequence[google.cloud.aiplatform_v1.types.Port]): Immutable. List
        ...
        predict_route (str): Immutable. HTTP path on the container to send
          ...
          when you [deploy this Model to an
          ...
          ``DeployedModel``. (Vertex AI makes this value available to your
          container code as the ```AIP_DEPLOYED_MODEL_ID`` environment variable
          <https://cloud.google.com/vertex-ai/docs/predictions/custom-container-requirements#aip-variables>`__.)
