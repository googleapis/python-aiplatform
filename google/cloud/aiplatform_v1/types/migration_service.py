...
class SearchMigratableResourcesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The location that the migratable resources
          should be searched from. It's the Vertex AI location that the
          resources can be migrated to, not the resources' original location.
          Format: ``projects/{project}/locations/{location}``
        page_size (int): The standard page size. The default and maximum value
          is 100.
        page_token (str): The standard page token.
        filter (str): A filter for your search. You can use the following types
          of
            filters:  -  Resource type filters. The following strings filter for
              a specific type of
              [MigratableResource][google.cloud.aiplatform.v1.MigratableResource]:
              -  ``ml_engine_model_version:*`` -  ``automl_model:*`` -
              ``automl_dataset:*`` -  ``data_labeling_dataset:*``  -  "Migrated
              or not" filters. The following strings filter for resources that
              either have or have not already been
               migrated:  -  ``last_migrate_time:*`` filters for migrated
                 resources. -  ``NOT last_migrate_time:*`` filters for not yet
                 migrated resources.
  """
  ...
  r"""Response message for
    ...
    Attributes:
        migratable_resources
          (Sequence[google.cloud.aiplatform_v1.types.MigratableResource]): All
          migratable resources that can be migrated to the location specified in
          the request.
        next_page_token (str): The standard next-page token. The
          migratable_resources may not fill page_size in
...
class BatchMigrateResourcesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The location of the migrated resource will live
          in. Format: ``projects/{project}/locations/{location}``
        migrate_resource_requests
          (Sequence[google.cloud.aiplatform_v1.types.MigrateResourceRequest]):
...
class MigrateResourceRequest(proto.Message):
  r"""Config of migrating one resource from automl.googleapis.com,
    ...
    Attributes:
        migrate_ml_engine_model_version_config
          ...
          Model.  This field is a member of `oneof`_ ``request``.
        ...
        migrate_automl_dataset_config
          ...
          Dataset.  This field is a member of `oneof`_ ``request``.
        migrate_data_labeling_dataset_config
          ...
          AI's Dataset.  This field is a member of `oneof`_ ``request``.
  """
  ...
  class MigrateMlEngineModelVersionConfig(proto.Message):
    r"""Config for migrating version in ml.googleapis.com to Vertex
        ...
        Attributes:
            endpoint (str): Required. The ml.googleapis.com endpoint that this
              model version should be migrated from. Example values:  -
              ml.googleapis.com  -  us-centrall-ml.googleapis.com  -
              europe-west4-ml.googleapis.com  -  asia-east1-ml.googleapis.com
            model_version (str): Required. Full resource name of ml engine model
              version.
                Format:
                  ``projects/{project}/models/{model}/versions/{version}``.
            model_display_name (str): Required. Display name of the model in
              Vertex AI. System will pick a display name if unspecified.
    """
  ...
  class MigrateAutomlModelConfig(proto.Message):
    r"""Config for migrating Model in automl.googleapis.com to Vertex
        ...
        Attributes:
            model (str): Required. Full resource name of automl Model. Format:
              ``projects/{project}/locations/{location}/models/{model}``.
            model_display_name (str): Optional. Display name of the model in
              Vertex AI. System will pick a display name if unspecified.
    """
  ...
  class MigrateAutomlDatasetConfig(proto.Message):
    r"""Config for migrating Dataset in automl.googleapis.com to
        ...
        Attributes:
            dataset (str): Required. Full resource name of automl Dataset.
              Format:
              ``projects/{project}/locations/{location}/datasets/{dataset}``.
            dataset_display_name (str): Required. Display name of the Dataset in
              Vertex AI. System will pick a display name if unspecified.
    """
  ...
  class MigrateDataLabelingDatasetConfig(proto.Message):
    r"""Config for migrating Dataset in datalabeling.googleapis.com
        ...
        Attributes:
            dataset (str): Required. Full resource name of data labeling
              Dataset.
                Format: ``projects/{project}/datasets/{dataset}``.
            dataset_display_name (str): Optional. Display name of the Dataset in
              Vertex AI. System will pick a display name if unspecified.
            migrate_data_labeling_annotated_dataset_configs
              (Sequence[google.cloud.aiplatform_v1.types.MigrateResourceRequest.MigrateDataLabelingDatasetConfig.MigrateDataLabelingAnnotatedDatasetConfig]):
              Optional. Configs for migrating AnnotatedDataset in
              datalabeling.googleapis.com to Vertex AI's SavedQuery. The
              specified AnnotatedDatasets have to belong to the datalabeling
              Dataset.
    """
    ...
    class MigrateDataLabelingAnnotatedDatasetConfig(proto.Message):
      r"""Config for migrating AnnotatedDataset in
            ...
            Attributes:
                annotated_dataset (str): Required. Full resource name of data
                  labeling AnnotatedDataset. Format:
  ...
  r"""Response message for
    ...
    Attributes:
        migrate_resource_responses
          (Sequence[google.cloud.aiplatform_v1.types.MigrateResourceResponse]):
...
class MigrateResourceResponse(proto.Message):
  r"""Describes a successfully migrated resource.
    ...
    Attributes:
        dataset (str): Migrated Dataset's resource name.  This field is a member
          of `oneof`_ ``migrated_resource``.
        model (str): Migrated Model's resource name.  This field is a member of
          `oneof`_ ``migrated_resource``.
        migratable_resource
          (google.cloud.aiplatform_v1.types.MigratableResource): Before
          migration, the identifier in ml.googleapis.com, automl.googleapis.com
...
class BatchMigrateResourcesOperationMetadata(proto.Message):
  r"""Runtime operation information for
    ...
    Attributes:
        generic_metadata
          (google.cloud.aiplatform_v1.types.GenericOperationMetadata): The
          common part of the operation metadata.
        partial_results
          (Sequence[google.cloud.aiplatform_v1.types.BatchMigrateResourcesOperationMetadata.PartialResult]):
  ...
  class PartialResult(proto.Message):
    r"""Represents a partial result in batch migration operation for one
        ...
        Attributes:
            error (google.rpc.status_pb2.Status): The error result of the
              migration request in case of failure.  This field is a member of
              `oneof`_ ``result``.
            model (str): Migrated model resource name.  This field is a member
              of `oneof`_ ``result``.
            dataset (str): Migrated dataset resource name.  This field is a
              member of `oneof`_ ``result``.
