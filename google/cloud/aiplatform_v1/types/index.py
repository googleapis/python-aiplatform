...
class Index(proto.Message):
  r"""A representation of a collection of database items organized
    ...
    Attributes:
        name (str): Output only. The resource name of the Index.
        display_name (str): Required. The display name of the Index. The name
        ...
        metadata_schema_uri (str): Immutable. Points to a YAML file stored on
          ...
          Index, that is specific to it. Unset if the Index does not have any
          ...
          <https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.0.2.md#schemaObject>`__.
            Note: The URI given on output will be immutable and probably
              ...
              read access.
        metadata (google.protobuf.struct_pb2.Value): An additional information
          about the Index; the schema of the metadata can be found in
          [metadata_schema][google.cloud.aiplatform.v1.Index.metadata_schema_uri].
        deployed_indexes
          (Sequence[google.cloud.aiplatform_v1.types.DeployedIndexRef]): Output
          only. The pointers to DeployedIndexes created from this Index. An
        ...
        labels (Mapping[str, str]): The labels with user-defined metadata to
          organize your Indexes. Label keys and values can be no longer than 64
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp): Output only.
          Timestamp when this Index was most recently updated. This also
          includes any update to the contents of the Index. Note that Operations
          working on this Index may have their
          [Operations.metadata.generic_metadata.update_time]
          [google.cloud.aiplatform.v1.GenericOperationMetadata.update_time] a
          little after the value of this timestamp, yet that does not mean their
          results are not already reflected in the Index. Result of any
