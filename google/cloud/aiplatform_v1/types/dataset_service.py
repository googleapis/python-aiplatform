...
class CreateDatasetRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        dataset (google.cloud.aiplatform_v1.types.Dataset): Required. The
          Dataset to create.
  """
...
class ListDatasetsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        datasets (Sequence[google.cloud.aiplatform_v1.types.Dataset]): A list of
          Datasets that matches the specified filter in the request.
  ...
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the Dataset resource. Format:
          ``projects/{project}/locations/{location}/datasets/{dataset}``
        import_configs
          (Sequence[google.cloud.aiplatform_v1.types.ImportDataConfig]):
...
class ListDataItemsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        data_items (Sequence[google.cloud.aiplatform_v1.types.DataItem]): A list
          of DataItems that matches the specified filter in the request.
        next_page_token (str): The standard List next-page token.
  """
...
class ListAnnotationsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        annotations (Sequence[google.cloud.aiplatform_v1.types.Annotation]): A
