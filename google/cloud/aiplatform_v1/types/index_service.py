...
class CreateIndexRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        index (google.cloud.aiplatform_v1.types.Index): Required. The Index to
          create.
  """
...
class ListIndexesResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        indexes (Sequence[google.cloud.aiplatform_v1.types.Index]): List of
  ...
  r"""Runtime operation metadata with regard to Matching Engine
    ...
    Attributes:
        content_validation_stats
          (Sequence[google.cloud.aiplatform_v1.types.NearestNeighborSearchOperationMetadata.ContentValidationStats]):
          ...
          [Index.metadata][google.cloud.aiplatform.v1.Index.metadata]. Please
          note that, currently for those files that are broken or has
  ...
  class ContentValidationStats(proto.Message):
    r"""
        ...
        Attributes:
            ...
            partial_errors
              (Sequence[google.cloud.aiplatform_v1.types.NearestNeighborSearchOperationMetadata.RecordError]):
