...
class Dataset(proto.Message):
  r"""A collection of DataItems and Annotations on them.
    ...
    Attributes:
        name (str): Output only. The resource name of the Dataset.
        display_name (str): Required. The user-defined name of the Dataset. The
        ...
        metadata (google.protobuf.struct_pb2.Value): Required. Additional
        ...
        labels (Mapping[str, str]): The labels with user-defined metadata to
          organize your Datasets.  Label keys and values can be no longer than
          64 characters (Unicode codepoints), can only contain lowercase
          letters, numeric characters, underscores and dashes. International
          characters are allowed. No more than 64 user labels can be associated
          with one Dataset (System labels are excluded).  See
        ...
        encryption_spec (google.cloud.aiplatform_v1.types.EncryptionSpec):
          ...
          Dataset and all sub-resources of this Dataset will be secured by this
          key.
  """
...
class ImportDataConfig(proto.Message):
  r"""Describes the location from where we import data into a
    ...
    Attributes:
        gcs_source (google.cloud.aiplatform_v1.types.GcsSource): The Google
          Cloud Storage location for the input content.  This field is a member
          of `oneof`_ ``source``.
        data_item_labels (Mapping[str, str]): Labels that will be applied to
          ...
          operation, the labels will be combined and if key collision happens in
          this case, one of the values will be picked randomly. Two DataItems
          are considered identical if their content bytes are identical (e.g.
        ...
        import_schema_uri (str): Required. Points to a YAML file stored on
          Google Cloud Storage describing the import format. Validation will be
          done against the schema. The schema is defined as an `OpenAPI 3.0.2
          Schema Object
          <https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.0.2.md#schemaObject>`__.
  """
...
class ExportDataConfig(proto.Message):
  r"""Describes what part of the Dataset is to be exported, the
    ...
    Attributes:
        gcs_destination (google.cloud.aiplatform_v1.types.GcsDestination): The
          Google Cloud Storage location where the output is to be written to. In
          ...
          export output will be written into that directory. Inside that
          ...
          describe the output format.  This field is a member of `oneof`_
          ``destination``.
        annotations_filter (str): A filter on Annotations of the Dataset. Only
          Annotations on to-be-exported DataItems(specified by
          [data_items_filter][]) that match this filter will be exported. The
          filter syntax is the same as in
