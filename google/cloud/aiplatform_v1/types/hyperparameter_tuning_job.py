...
class HyperparameterTuningJob(proto.Message):
  r"""Represents a HyperparameterTuningJob.
  ...
  A
    ...
    Attributes:
        name (str): Output only. Resource name of the HyperparameterTuningJob.
        display_name (str): Required. The display name of the
          HyperparameterTuningJob. The name can be up to 128 characters long and
          can be consist of any UTF-8 characters.
        study_spec (google.cloud.aiplatform_v1.types.StudySpec): Required. Study
        ...
        parallel_trial_count (int): Required. The desired number of Trials to
          run in parallel.
        max_failed_trial_count (int): The number of failed Trials that need to
          be seen before failing the HyperparameterTuningJob. If set to 0,
          Vertex AI decides how many Trials must fail before the whole job
          fails.
        ...
        trials (Sequence[google.cloud.aiplatform_v1.types.Trial]): Output only.
        ...
        create_time (google.protobuf.timestamp_pb2.Timestamp): Output only. Time
          when the HyperparameterTuningJob was created.
        start_time (google.protobuf.timestamp_pb2.Timestamp): Output only. Time
          when the HyperparameterTuningJob for the first time entered the
          ``JOB_STATE_RUNNING`` state.
        end_time (google.protobuf.timestamp_pb2.Timestamp): Output only. Time
          when the HyperparameterTuningJob entered any of the following states:
          ``JOB_STATE_SUCCEEDED``, ``JOB_STATE_FAILED``,
          ``JOB_STATE_CANCELLED``.
        update_time (google.protobuf.timestamp_pb2.Timestamp): Output only. Time
          when the HyperparameterTuningJob was most recently updated.
        ...
        labels (Mapping[str, str]): The labels with user-defined metadata to
          organize HyperparameterTuningJobs. Label keys and values can be no
        ...
        encryption_spec (google.cloud.aiplatform_v1.types.EncryptionSpec):
          ...
          If this is set, then all resources created by the
          HyperparameterTuningJob will be encrypted with the provided encryption
          key.
  """
