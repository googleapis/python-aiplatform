...
class CreateStudyRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        study (google.cloud.aiplatform_v1.types.Study): Required. The Study
...
class ListStudiesResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        studies (Sequence[google.cloud.aiplatform_v1.types.Study]): The studies
...
class SuggestTrialsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        trials (Sequence[google.cloud.aiplatform_v1.types.Trial]): A list of
          Trials.
        study_state (google.cloud.aiplatform_v1.types.Study.State): The state of
          the Study.
  ...
  r"""Details of operations that perform Trials suggestion.
    ...
    Attributes:
        generic_metadata
          ...
          metadata for suggesting Trials.
  ...
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the Study to create the
          Trial in. Format:
          ``projects/{project}/locations/{location}/studies/{study}``
        trial (google.cloud.aiplatform_v1.types.Trial): Required. The Trial to
          create.
  """
...
class ListTrialsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        trials (Sequence[google.cloud.aiplatform_v1.types.Trial]): The Trials
  ...
  r"""Request message for
    ...
    Attributes:
        trial_name (str): Required. The name of the trial to add measurement.
          Format:
          ``projects/{project}/locations/{location}/studies/{study}/trials/{trial}``
        measurement (google.cloud.aiplatform_v1.types.Measurement): Required.
...
class ListOptimalTrialsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        optimal_trials (Sequence[google.cloud.aiplatform_v1.types.Trial]): The
          pareto-optimal Trials for multiple objective Study or the optimal
