...
class ListTrainingPipelinesResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        training_pipelines
          (Sequence[google.cloud.aiplatform_v1.types.TrainingPipeline]): List of
          TrainingPipelines in the requested page.
...
class CreatePipelineJobRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        pipeline_job (google.cloud.aiplatform_v1.types.PipelineJob): Required.
