  ...
  r"""A message representing a Study.
    ...
    Attributes:
        ...
        display_name (str): Required. Describes the Study, default value is
          empty string.
        study_spec (google.cloud.aiplatform_v1.types.StudySpec): Required.
          Configuration of the Study.
        state (google.cloud.aiplatform_v1.types.Study.State): Output only. The
          detailed state of a Study.
  ...
  A Trial contains a unique set
    ...
    Attributes:
        ...
        id (str): Output only. The identifier of the Trial assigned by the
          service.
        state (google.cloud.aiplatform_v1.types.Trial.State): Output only. The
          detailed state of the Trial.
        parameters (Sequence[google.cloud.aiplatform_v1.types.Trial.Parameter]):
          Output only. The parameters of the Trial.
        final_measurement (google.cloud.aiplatform_v1.types.Measurement): Output
          only. The final measurement containing the objective value.
...
class StudySpec(proto.Message):
  r"""Represents specification of a Study.
    ...
    Attributes:
        ...
        algorithm (google.cloud.aiplatform_v1.types.StudySpec.Algorithm): The
          search algorithm specified for the Study.
        observation_noise
          (google.cloud.aiplatform_v1.types.StudySpec.ObservationNoise): The
          observation noise level of the study. Currently only supported by the
          Vertex AI Vizier service. Not supported by HyperparamterTuningJob or
          TrainingPipeline.
    ...
    r"""Represents a single parameter to optimize.
        ...
        Attributes:
            ...
            conditional_parameter_specs
              (Sequence[google.cloud.aiplatform_v1.types.StudySpec.ParameterSpec.ConditionalParameterSpec]):
