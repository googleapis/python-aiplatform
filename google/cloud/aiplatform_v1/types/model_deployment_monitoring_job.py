...
class ModelDeploymentMonitoringJob(proto.Message):
  r"""Represents a job that runs periodically to monitor the
    ...
    Attributes:
        name (str): Output only. Resource name of a
          ModelDeploymentMonitoringJob.
        display_name (str): Required. The user-defined name of the
          ModelDeploymentMonitoringJob. The name can be up to 128 characters
          long and can be consist of any UTF-8 characters. Display name of a
          ModelDeploymentMonitoringJob.
        endpoint (str): Required. Endpoint resource name. Format:
          ``projects/{project}/locations/{location}/endpoints/{endpoint}``
        state (google.cloud.aiplatform_v1.types.JobState): Output only. The
          detailed state of the monitoring job. When the job is still creating,
          the state will be 'PENDING'. Once the job is successfully created, the
          state will be 'RUNNING'. Pause the job, the state will be 'PAUSED'.
        ...
        model_deployment_monitoring_objective_configs
          (Sequence[google.cloud.aiplatform_v1.types.ModelDeploymentMonitoringObjectiveConfig]):
        ...
        logging_sampling_strategy
          (google.cloud.aiplatform_v1.types.SamplingStrategy): Required. Sample
          Strategy for logging.
        model_monitoring_alert_config
          (google.cloud.aiplatform_v1.types.ModelMonitoringAlertConfig): Alert
          config for model monitoring.
        predict_instance_schema_uri (str): YAML schema file uri describing the
          format of a single instance, which are given to format this Endpoint's
          prediction (and explanation). If not set, we will generate predict
          schema from collected predict requests.
        sample_predict_instance (google.protobuf.struct_pb2.Value): Sample
          Predict instance, same format as
          ...
          requests.
        analysis_instance_schema_uri (str): YAML schema file uri describing the
          format of a single instance that you want Tensorflow Data Validation
          (TFDV) to analyze.  If this field is empty, all the feature data types
          are inferred from
          ...
          prediction request/response. If there are any data type differences
          ...
          must be set as all the fields in predict instance formatted as string.
        bigquery_tables
          (Sequence[google.cloud.aiplatform_v1.types.ModelDeploymentMonitoringBigQueryTable]):
          Output only. The created bigquery tables for the job under customer
          project. Customer could do their own query & analysis. There could be
          4 log tables in maximum: 1. Training data logging predict
          request/response 2. Serving data logging predict request/response
        log_ttl (google.protobuf.duration_pb2.Duration): The TTL of BigQuery
          tables in user projects which stores logs. A day is the basic unit of
          the TTL and we take the ceil of TTL/86400(a day). e.g. { second: 3600}
          indicates ttl = 1 day.
        labels (Mapping[str, str]): The labels with user-defined metadata to
          organize your ModelDeploymentMonitoringJob.  Label keys and values can
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp): Output only.
          ...
          recently.
        next_schedule_time (google.protobuf.timestamp_pb2.Timestamp): Output
          only. Timestamp when this monitoring pipeline will be scheduled to run
          for the next round.
        stats_anomalies_base_directory
          (google.cloud.aiplatform_v1.types.GcsDestination): Stats anomalies
          base folder path.
        ...
        enable_monitoring_pipeline_logs (bool): If true, the scheduled
          monitoring pipeline logs are sent to Google Cloud Logging, including
          pipeline status and anomalies detected. Please note the logs incur
          cost, which are subject to `Cloud Logging pricing
          <https://cloud.google.com/logging#pricing>`__.
        error (google.rpc.status_pb2.Status): Output only. Only populated when
          the job's state is ``JOB_STATE_FAILED`` or ``JOB_STATE_CANCELLED``.
  """
  ...
  class LatestMonitoringPipelineMetadata(proto.Message):
    r"""All metadata of most recent monitoring pipelines.
        ...
        Attributes:
            run_time (google.protobuf.timestamp_pb2.Timestamp): The time that
              most recent monitoring pipelines that is related to this run.
            status (google.rpc.status_pb2.Status): The status of the most recent
              monitoring pipeline.
    """
  ...
  r"""ModelDeploymentMonitoringBigQueryTable specifies the BigQuery
    ...
    Attributes:
        ...
        log_type
          ...
          The type of log.
        bigquery_table_path (str): The created BigQuery table to store logs.
...
class ModelDeploymentMonitoringObjectiveConfig(proto.Message):
  r"""ModelDeploymentMonitoringObjectiveConfig contains the pair of
    ...
    Attributes:
        deployed_model_id (str): The DeployedModel ID of the objective config.
        objective_config
          (google.cloud.aiplatform_v1.types.ModelMonitoringObjectiveConfig): The
          objective config of for the modelmonitoring job of this deployed
          model.
  """
...
class ModelDeploymentMonitoringScheduleConfig(proto.Message):
  r"""The config for scheduling monitoring job.
    ...
    Attributes:
        monitor_interval (google.protobuf.duration_pb2.Duration): Required. The
          model monitoring job scheduling interval. It will be rounded up to
          next full hour. This defines how often the monitoring jobs are
          triggered.
        monitor_window (google.protobuf.duration_pb2.Duration): The time window
          of the prediction data being included in each prediction dataset. This
          window specifies how long the data should be collected from historical
          model results for each run. If not set,
          ...
          will be used. e.g. If currently the cutoff time is 2022-01-08 14:30:00
          and the monitor_window is set to be 3600, then data from 2022-01-08
          13:30:00 to 2022-01-08
...
class ModelMonitoringStatsAnomalies(proto.Message):
  r"""Statistics and anomalies generated by Model Monitoring.
    ...
    Attributes:
        ...
        deployed_model_id (str): Deployed Model ID.
        anomaly_count (int): Number of anomalies within all stats.
        feature_stats
          (Sequence[google.cloud.aiplatform_v1.types.ModelMonitoringStatsAnomalies.FeatureHistoricStatsAnomalies]):
  ...
  class FeatureHistoricStatsAnomalies(proto.Message):
    r"""Historical Stats (and Anomalies) for a specific Feature.
        ...
        Attributes:
            feature_display_name (str): Display Name of the Feature.
            threshold (google.cloud.aiplatform_v1.types.ThresholdConfig):
              Threshold for anomaly detection.
            training_stats
              (google.cloud.aiplatform_v1.types.FeatureStatsAnomaly): Stats
              calculated for the Training Dataset.
            prediction_stats
              (Sequence[google.cloud.aiplatform_v1.types.FeatureStatsAnomaly]):
