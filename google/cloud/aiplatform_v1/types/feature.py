  ...
  r"""Feature Metadata information that describes an attribute of
    ...
    Attributes:
        ...
        monitoring_stats_anomalies
          (Sequence[google.cloud.aiplatform_v1.types.Feature.MonitoringStatsAnomaly]):
    ...
    r"""A list of historical [Snapshot
        ...
        Attributes:
            ...
            feature_stats_anomaly
              (google.cloud.aiplatform_v1.types.FeatureStatsAnomaly): Output
              only. The stats and anomalies generated at specific timestamp.
    """
