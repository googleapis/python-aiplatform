  ...
  r"""Used to assign specific AnnotationSpec to a particular area
    ...
    Attributes:
        ...
        payload_schema_uri (str): Required. Google Cloud Storage URI points to a
          ...
          [payload][google.cloud.aiplatform.v1.Annotation.payload]. The schema
          is defined as an `OpenAPI 3.0.2 Schema Object
        ...
        annotation_source
          (google.cloud.aiplatform_v1.types.UserActionReference): Output only.
