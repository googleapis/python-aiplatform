    ...
    r"""Training Dataset information.
        ...
        Attributes:
            ...
            gcs_source (google.cloud.aiplatform_v1.types.GcsSource): The Google
              Cloud Storage uri of the unmanaged Dataset used to train this
              Model.  This field is a member of `oneof`_ ``data_source``.
            ...
            logging_sampling_strategy
              (google.cloud.aiplatform_v1.types.SamplingStrategy): Strategy to
              sample data from Training Dataset. If not set, we process the
              whole dataset.
    """
    ...
    It
        ...
        Attributes:
            skew_thresholds (Mapping[str,
              google.cloud.aiplatform_v1.types.ThresholdConfig]): Key is the
              feature name and value is the threshold. If a feature needs to be
              monitored for skew, a value threshold must be configured for that
              feature. The threshold here is against feature distribution
              distance between the training and prediction feature.
            attribution_score_skew_thresholds (Mapping[str,
              google.cloud.aiplatform_v1.types.ThresholdConfig]): Key is the
              feature name and value is the threshold. The threshold here is
              against attribution score distance between the training and
              prediction feature.
            default_skew_threshold
              (google.cloud.aiplatform_v1.types.ThresholdConfig): Skew anomaly
              detection threshold used by all features. When the per-feature
              thresholds are not set, this field can be used to specify a
    ...
    r"""The config for Prediction data drift detection.
        ...
        Attributes:
            drift_thresholds (Mapping[str,
              google.cloud.aiplatform_v1.types.ThresholdConfig]): Key is the
              feature name and value is the threshold. If a feature needs to be
              monitored for drift, a value threshold must be configured for that
              feature. The threshold here is against feature distribution
            ...
            default_drift_threshold
              (google.cloud.aiplatform_v1.types.ThresholdConfig): Drift anomaly
              detection threshold used by all features. When the per-feature
              thresholds are not set, this field can be used to specify a
              threshold for all features.
    """
  ...
  class ExplanationConfig(proto.Message):
    ...
    class ExplanationBaseline(proto.Message):
      r"""Output from
            ...
            Attributes:
                gcs (google.cloud.aiplatform_v1.types.GcsDestination): Cloud
                  Storage location for BatchExplain output.  This field is a
