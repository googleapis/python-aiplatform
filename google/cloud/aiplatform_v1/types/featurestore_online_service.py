...
class ReadFeatureValuesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        entity_type (str): Required. The resource name of the EntityType for the
          entity being read. Value format:
          ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entityType}``.
          For example, for a machine learning model predicting user clicks on a
          website, an EntityType ID could be ``user``.
        entity_id (str): Required. ID for a specific entity. For example, for a
...
class ReadFeatureValuesResponse(proto.Message):
  ...
  class Header(proto.Message):
    r"""Response header with metadata for the requested
        ...
        Attributes:
            entity_type (str): The resource name of the EntityType from the
              [ReadFeatureValuesRequest][google.cloud.aiplatform.v1.ReadFeatureValuesRequest].
              Value format:
              ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entityType}``.
            feature_descriptors
              (Sequence[google.cloud.aiplatform_v1.types.ReadFeatureValuesResponse.FeatureDescriptor]):
  ...
  class EntityView(proto.Message):
    r"""Entity view with Feature values.
        ...
        Attributes:
            entity_id (str): ID of the requested entity.
            data
              (Sequence[google.cloud.aiplatform_v1.types.ReadFeatureValuesResponse.EntityView.Data]):
    ...
    class Data(proto.Message):
      r"""Container to hold value(s), successive in time, for one
            ...
            For each oneof, at most one member field can be set at the same
            time.
            ...
            Attributes:
                value (google.cloud.aiplatform_v1.types.FeatureValue): Feature
                  value if a single value is requested.  This field is a member
                  of `oneof`_ ``data``.
                values (google.cloud.aiplatform_v1.types.FeatureValueList):
                  Feature values list if values, successive in time, are
                  requested. If the requested number of values is greater than
                  the number of existing Feature values, nonexistent values are
                  omitted instead of being returned as empty.  This field is a
                  member of `oneof`_ ``data``.
      """
...
class StreamingReadFeatureValuesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        entity_type (str): Required. The resource name of the entities' type.
          Value
            format:
              ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entityType}``.
              For example, for a machine learning model predicting user clicks
              on a website, an EntityType ID could be ``user``.
        entity_ids (Sequence[str]): Required. IDs of entities to read Feature
          values of. The maximum number of IDs is 100. For example, for a
          machine learning model predicting user clicks on a website, an entity
          ID could be ``user_123``.
        feature_selector (google.cloud.aiplatform_v1.types.FeatureSelector):
          Required. Selector choosing Features of the target EntityType. Feature
          IDs will be deduplicated.
  """
...
class FeatureValue(proto.Message):
  r"""Value for a feature.
    ...
    Attributes:
        bool_value (bool): Bool type feature value.  This field is a member of
          `oneof`_ ``value``.
        double_value (float): Double type feature value.  This field is a member
          of `oneof`_ ``value``.
        int64_value (int): Int64 feature value.  This field is a member of
          `oneof`_ ``value``.
        string_value (str): String feature value.  This field is a member of
          `oneof`_ ``value``.
        bool_array_value (google.cloud.aiplatform_v1.types.BoolArray): A list of
          bool type feature value.  This field is a member of `oneof`_
          ``value``.
        double_array_value (google.cloud.aiplatform_v1.types.DoubleArray): A
          list of double type feature value.  This field is a member of `oneof`_
          ``value``.
        int64_array_value (google.cloud.aiplatform_v1.types.Int64Array): A list
          of int64 type feature value.  This field is a member of `oneof`_
          ``value``.
        string_array_value (google.cloud.aiplatform_v1.types.StringArray): A
          list of string type feature value.  This field is a member of `oneof`_
          ``value``.
        bytes_value (bytes): Bytes feature value.  This field is a member of
          `oneof`_ ``value``.
  ...
  class Metadata(proto.Message):
    r"""Metadata of feature value.
        ...
        Attributes:
            generate_time (google.protobuf.timestamp_pb2.Timestamp): Feature
              generation timestamp. Typically, it is provided by user at feature
              ingestion time. If not, feature store will use the system
              timestamp when the data is ingested into feature store. For
              streaming ingestion, the time, aligned by days, must be no older
              than five years (1825 days) and no later than one year (366 days)
              in the future.
    """
...
class FeatureValueList(proto.Message):
  r"""Container for list of values.
    ...
    Attributes:
        values (Sequence[google.cloud.aiplatform_v1.types.FeatureValue]): A list
          of feature values. All of them should be the same data type.
  """
