...
class GetIndexEndpointRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the IndexEndpoint resource. Format:
  ...
  r"""Request message for
    ...
    Attributes:
        ...
        filter (str): Optional. An expression for filtering the results of the
          ...
          -  ``index_endpoint`` supports = and !=. ``index_endpoint`` represents
          ...
          ``display_name`` supports =, != and regex() (uses `re2
          <https://github.com/google/re2/wiki/Syntax>`__ syntax) -  ``labels``
...
class ListIndexEndpointsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        index_endpoints
          (Sequence[google.cloud.aiplatform_v1.types.IndexEndpoint]): List of
          IndexEndpoints in the requested page.
...
class DeleteIndexEndpointRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the IndexEndpoint resource to be
          deleted. Format:
          ``projects/{project}/locations/{location}/indexEndpoints/{index_endpoint}``
  """
...
class DeployIndexRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        index_endpoint (str): Required. The name of the IndexEndpoint resource
...
class DeployIndexResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        deployed_index (google.cloud.aiplatform_v1.types.DeployedIndex): The
          DeployedIndex that had been deployed in the IndexEndpoint.
  """
  ...
  r"""Runtime operation information for
    ...
    Attributes:
        generic_metadata
          (google.cloud.aiplatform_v1.types.GenericOperationMetadata): The
          operation generic information.
        deployed_index_id (str): The unique index id specified by user
  """
  ...
  r"""Request message for
    ...
    Attributes:
        index_endpoint (str): Required. The name of the IndexEndpoint resource
          ...
          ``projects/{project}/locations/{location}/indexEndpoints/{index_endpoint}``
        deployed_index_id (str): Required. The ID of the DeployedIndex to be
...
class MutateDeployedIndexResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        deployed_index (google.cloud.aiplatform_v1.types.DeployedIndex): The
          DeployedIndex that had been updated in the IndexEndpoint.
  """
