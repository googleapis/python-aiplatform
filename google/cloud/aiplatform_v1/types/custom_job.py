  ...
  r"""Represents a job that runs custom workloads such as a Docker
    ...
    Attributes:
        ...
        display_name (str): Required. The display name of the CustomJob. The
          ...
          characters.
        job_spec (google.cloud.aiplatform_v1.types.CustomJobSpec): Required. Job
          spec.
...
class CustomJobSpec(proto.Message):
  r"""Represents the spec of a CustomJob.
    ...
    Attributes:
        worker_pool_specs
          (Sequence[google.cloud.aiplatform_v1.types.WorkerPoolSpec]): Required.
          The spec of the worker pools including machine type and Docker image.
          All worker pools except the first one are optional and can be skipped
          by providing an empty value.
        scheduling (google.cloud.aiplatform_v1.types.Scheduling): Scheduling
          options for a CustomJob.
        ...
        base_output_directory (google.cloud.aiplatform_v1.types.GcsDestination):
          ...
          a subdirectory of name [id][google.cloud.aiplatform.v1.Trial.id] under
        ...
        tensorboard (str): Optional. The name of a Vertex AI
          [Tensorboard][google.cloud.aiplatform.v1.Tensorboard] resource to
...
class WorkerPoolSpec(proto.Message):
  r"""Represents the spec of a worker pool in a job.
    ...
    Attributes:
        container_spec (google.cloud.aiplatform_v1.types.ContainerSpec): The
          custom container task.  This field is a member of `oneof`_ ``task``.
        python_package_spec
          (google.cloud.aiplatform_v1.types.PythonPackageSpec): The Python
          packaged task.  This field is a member of `oneof`_ ``task``.
        machine_spec (google.cloud.aiplatform_v1.types.MachineSpec): Optional.
        ...
        disk_spec (google.cloud.aiplatform_v1.types.DiskSpec): Disk spec.
  """
  ...
  r"""The spec of a Container.
    ...
    Attributes:
        ...
        args (Sequence[str]): The arguments to be passed when starting the
          container.
        env (Sequence[google.cloud.aiplatform_v1.types.EnvVar]): Environment
          variables to be passed to the container. Maximum limit is 100.
  """
  ...
  r"""The spec of a Python packaged code.
    ...
    Attributes:
        ...
        args (Sequence[str]): Command line arguments to be passed to the Python
          task.
        env (Sequence[google.cloud.aiplatform_v1.types.EnvVar]): Environment
          variables to be passed to the python module. Maximum limit is 100.
  """
