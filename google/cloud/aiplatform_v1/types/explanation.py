...
class Explanation(proto.Message):
  r"""Explanation of a prediction (provided in
    ...
    Attributes:
        attributions (Sequence[google.cloud.aiplatform_v1.types.Attribution]):
        ...
        neighbors (Sequence[google.cloud.aiplatform_v1.types.Neighbor]): Output
          only. List of the nearest neighbors for example-based explanations.
          For models deployed with the examples explanations feature enabled,
          the attributions field is empty and instead the neighbors field is
          populated.
  """
...
class ModelExplanation(proto.Message):
  r"""Aggregated explanation metrics for a Model over a set of
    ...
    Attributes:
        mean_attributions
          (Sequence[google.cloud.aiplatform_v1.types.Attribution]): Output only.
          Aggregated attributions explaining the Model's prediction outputs over
          the set of instances. The attributions are grouped by outputs.  For
          Models that predict only one output, such as regression Models that
          predict only one score, there is only one attibution that explains the
          predicted output. For Models that predict multiple outputs, such as
          multiclass Models that predict multiple classes, each element explains
  ...
  r"""Attribution that explains a particular prediction output.
    ...
    Attributes:
        ...
        feature_attributions (google.protobuf.struct_pb2.Value): Output only.
          ...
          inputs][google.cloud.aiplatform.v1.ExplanationMetadata.inputs].  The
          value is a struct, whose keys are the name of the feature. The values
  ...
  r"""Parameters to configure explaining for Model's predictions.
    ...
    Attributes:
        sampled_shapley_attribution
          (google.cloud.aiplatform_v1.types.SampledShapleyAttribution): An
        ...
        integrated_gradients_attribution
          (google.cloud.aiplatform_v1.types.IntegratedGradientsAttribution): An
          attribution method that computes Aumann-Shapley values taking
          advantage of the model's fully differentiable structure. Refer to this
          paper for more details:
            https://arxiv.org/abs/1703.01365  This field is a member of `oneof`_
              ``method``.
        xrai_attribution (google.cloud.aiplatform_v1.types.XraiAttribution): An
  ...
  r"""An attribution method that computes the Aumann-Shapley value
    ...
    Attributes:
        ...
        blur_baseline_config
          (google.cloud.aiplatform_v1.types.BlurBaselineConfig): Config for IG
          with blur baseline. When enabled, a linear path from the maximally
    ...
    Attributes:
        ...
        smooth_grad_config (google.cloud.aiplatform_v1.types.SmoothGradConfig):
          ...
          the computed gradients. Refer to this paper for more details:
            https://arxiv.org/pdf/1706.03825.pdf
        blur_baseline_config
          (google.cloud.aiplatform_v1.types.BlurBaselineConfig): Config for XRAI
          with blur baseline. When enabled, a linear path from the maximally
          blurred image to the input image is created. Using a blurred baseline
          instead of zero (black image) is motivated by the BlurIG approach
          explained here: https://arxiv.org/abs/2004.03383
        ...
        noise_sigma (float): This is a single float value and will be used to
          ...
          SmoothGrad paper:
            https://arxiv.org/pdf/1706.03825.pdf. Defaults to 0.1.  If the
              ...
              ``GradientNoiseSigma``.
        feature_noise_sigma
          (google.cloud.aiplatform_v1.types.FeatureNoiseSigma): This is similar
          to
...
class FeatureNoiseSigma(proto.Message):
  ...
  Noise sigma represents the standard
    ...
    Attributes:
        noise_sigma
          (Sequence[google.cloud.aiplatform_v1.types.FeatureNoiseSigma.NoiseSigmaForFeature]):
...
class ExplanationSpecOverride(proto.Message):
  r"""The [ExplanationSpec][google.cloud.aiplatform.v1.ExplanationSpec]
    ...
    Attributes:
        parameters (google.cloud.aiplatform_v1.types.ExplanationParameters): The
  ...
  r"""The
    ...
    Attributes:
        inputs (Mapping[str,
          ...
          metadata][google.cloud.aiplatform.v1.ExplanationMetadata.inputs] of
          the features. The key is the name of the feature to be overridden. The
          keys specified here must exist in the input metadata to be overridden.
          If a feature is not specified here, the corresponding feature's input
  ...
  r"""Overrides for example-based explanations.
    ...
    Attributes:
        ...
        crowding_count (int): The number of neighbors to return that have the
          same crowding tag.
        restrictions
          (Sequence[google.cloud.aiplatform_v1.types.ExamplesRestrictionsNamespace]):
          Restrict the resulting nearest neighbors to respect these constraints.
        return_embeddings (bool): If true, return the embeddings instead of
          neighbors.
        data_format
          (google.cloud.aiplatform_v1.types.ExamplesOverride.DataFormat): The
          format of the data being provided with each call.
  """
