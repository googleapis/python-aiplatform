...
class TrainingPipeline(proto.Message):
  r"""The TrainingPipeline orchestrates tasks associated with training a
    ...
    Attributes:
        ...
        model_to_upload (google.cloud.aiplatform_v1.types.Model): Describes the
          Model that may be uploaded (via
          ...
          [name][google.cloud.aiplatform.v1.Model.name] is populated. The Model
          is always uploaded into the Project and Location in which this
          pipeline is.
        ...
        state (google.cloud.aiplatform_v1.types.PipelineState): Output only. The
          detailed state of the pipeline.
...
class InputDataConfig(proto.Message):
  r"""Specifies Vertex AI owned input data to be used for training,
    ...
    Attributes:
        fraction_split (google.cloud.aiplatform_v1.types.FractionSplit): Split
          based on fractions defining the size of each set.  This field is a
          member of `oneof`_ ``split``.
        filter_split (google.cloud.aiplatform_v1.types.FilterSplit): Split based
          on the provided filters for each set.  This field is a member of
          `oneof`_ ``split``.
        ...
        stratified_split (google.cloud.aiplatform_v1.types.StratifiedSplit):
          ...
          of the specified column.  This field is a member of `oneof`_
          ``split``.
        gcs_destination (google.cloud.aiplatform_v1.types.GcsDestination): The
          Cloud Storage location where the training data is to be written to. In
          the given directory a new directory is created with name:
        ...
        bigquery_destination
          (google.cloud.aiplatform_v1.types.BigQueryDestination): Only
