...
class CreateCustomJobRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        custom_job (google.cloud.aiplatform_v1.types.CustomJob): Required. The
          CustomJob to create.
  """
...
class ListCustomJobsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        custom_jobs (Sequence[google.cloud.aiplatform_v1.types.CustomJob]): List
          of CustomJobs in the requested page.
...
class DeleteCustomJobRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the CustomJob resource to be deleted.
            Format:
              ``projects/{project}/locations/{location}/customJobs/{custom_job}``
  """
  ...
  r"""Request message for
    ...
    Attributes:
        ...
        filter (str): The standard list filter.  Supported fields:  -
          ...
          display_name="my_job"``  -  ``state="JOB_STATE_FAILED"``
        page_size (int): The standard list page size.
        page_token (str): The standard list page token.
        read_mask (google.protobuf.field_mask_pb2.FieldMask): Mask specifying
          ...
          is a field in DataLabelingJob. If this field is not set, all fields of
          the DataLabelingJob are returned.
...
class ListDataLabelingJobsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        data_labeling_jobs
          (Sequence[google.cloud.aiplatform_v1.types.DataLabelingJob]): A list
          of DataLabelingJobs that matches the specified filter in the request.
  ...
  r"""Request message for
    ...
    Attributes:
        ...
        hyperparameter_tuning_job
          ...
          The HyperparameterTuningJob to create.
  """
...
class GetHyperparameterTuningJobRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the HyperparameterTuningJob resource.
            Format:
  ...
  r"""Response message for
    ...
    Attributes:
        hyperparameter_tuning_jobs
          (Sequence[google.cloud.aiplatform_v1.types.HyperparameterTuningJob]):
...
class CancelHyperparameterTuningJobRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the HyperparameterTuningJob to cancel.
            Format:
              ``projects/{project}/locations/{location}/hyperparameterTuningJobs/{hyperparameter_tuning_job}``
  """
  ...
  r"""Request message for
    ...
    Attributes:
        ...
        batch_prediction_job
          (google.cloud.aiplatform_v1.types.BatchPredictionJob): Required. The
          BatchPredictionJob to create.
  """
...
class ListBatchPredictionJobsRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        filter (str): The standard list filter.  Supported fields:  -
          ``display_name`` supports = and !=.  -  ``state`` supports = and !=.
          -  ``model_display_name`` supports = and !=  Some examples of using
  ...
  r"""Response message for
    ...
    Attributes:
        batch_prediction_jobs
          (Sequence[google.cloud.aiplatform_v1.types.BatchPredictionJob]): List
          of BatchPredictionJobs in the requested page.
        next_page_token (str): A token to retrieve the next page of results.
          Pass to
...
class DeleteBatchPredictionJobRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the BatchPredictionJob resource to be
          deleted. Format:
          ``projects/{project}/locations/{location}/batchPredictionJobs/{batch_prediction_job}``
  """
...
class SearchModelDeploymentMonitoringStatsAnomaliesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        feature_display_name (str): The feature display name. If specified, only
        ...
        objectives
          (Sequence[google.cloud.aiplatform_v1.types.SearchModelDeploymentMonitoringStatsAnomaliesRequest.StatsAnomaliesObjective]):
          Required. Objectives of the stats to retrieve.
        page_size (int): The standard list page size.
        page_token (str): A page token received from a previous
          [JobService.SearchModelDeploymentMonitoringStatsAnomalies][google.cloud.aiplatform.v1.JobService.SearchModelDeploymentMonitoringStatsAnomalies]
          call.
        start_time (google.protobuf.timestamp_pb2.Timestamp): The earliest
          timestamp of stats being generated. If not set, indicates fetching
          stats till the earliest possible one.
        end_time (google.protobuf.timestamp_pb2.Timestamp): The latest timestamp
          of stats being generated. If not set, indicates feching stats till the
          latest possible one.
  """
  ...
  class StatsAnomaliesObjective(proto.Message):
    r"""Stats requested for specific objective.
        ...
        Attributes:
            ...
            top_feature_count (int): If set, all attribution scores between
              ...
              are fetched, and page token doesn't take affect in this case. Only
              used to retrieve attribution score for the top Features which has
    ...
    type_ = proto.Field(
        proto.ENUM,
        number=1,
        enum=gca_model_deployment_monitoring_job
...
class SearchModelDeploymentMonitoringStatsAnomaliesResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        monitoring_stats
          (Sequence[google.cloud.aiplatform_v1.types.ModelMonitoringStatsAnomalies]):
          ...
          in the response.
        next_page_token (str): The page token that can be used by the next
          [JobService.SearchModelDeploymentMonitoringStatsAnomalies][google.cloud.aiplatform.v1.JobService.SearchModelDeploymentMonitoringStatsAnomalies]
          call.
  """
  ...
  r"""Response message for
    ...
    Attributes:
        model_deployment_monitoring_jobs
          (Sequence[google.cloud.aiplatform_v1.types.ModelDeploymentMonitoringJob]):
  ...
  r"""Request message for
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask): Required. The
          ...
          user does not provide a mask then only the non-empty fields present in
          the request will be overwritten. Set the update_mask to ``*`` to
          override all fields. For the objective config, the user can either
...
class DeleteModelDeploymentMonitoringJobRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The resource name of the model monitoring job to
          delete. Format:
          ``projects/{project}/locations/{location}/modelDeploymentMonitoringJobs/{model_deployment_monitoring_job}``
  """
