...
class PipelineJob(proto.Message):
  r"""An instance of a machine learning PipelineJob.
    ...
    Attributes:
        name (str): Output only. The resource name of the PipelineJob.
        display_name (str): The display name of the Pipeline. The name can be up
        ...
        start_time (google.protobuf.timestamp_pb2.Timestamp): Output only.
          Pipeline start time.
        end_time (google.protobuf.timestamp_pb2.Timestamp): Output only.
          Pipeline end time.
        update_time (google.protobuf.timestamp_pb2.Timestamp): Output only.
          Timestamp when this PipelineJob was most recently updated.
        pipeline_spec (google.protobuf.struct_pb2.Struct): The spec of the
          pipeline.
        state (google.cloud.aiplatform_v1.types.PipelineState): Output only. The
          detailed state of the job.
        job_detail (google.cloud.aiplatform_v1.types.PipelineJobDetail): Output
          only. The details of pipeline run. Not available in the list view.
        error (google.rpc.status_pb2.Status): Output only. The error that
          occurred during pipeline execution. Only populated when the pipeline's
          state is FAILED or CANCELLED.
        labels (Mapping[str, str]): The labels with user-defined metadata to
          organize PipelineJob. Label keys and values can be no longer than 64
          characters (Unicode codepoints), can only contain lowercase letters,
          numeric characters, underscores and dashes. International characters
          are allowed. See https://goo.gl/xmQnxf for more information and
          examples of labels.
        runtime_config
          (google.cloud.aiplatform_v1.types.PipelineJob.RuntimeConfig): Runtime
        ...
        service_account (str): The service account that the pipeline workload
          runs as. If not specified, the Compute Engine default service account
        ...
        network (str): The full name of the Compute Engine `network
          </compute/docs/networks-and-firewalls#networks>`__ to which the
          ...
          being launched, if applied, such as Vertex AI Training or Dataflow
          job. If left unspecified, the workload is not peered with any network.
        template_uri (str): A template uri from where the
          [PipelineJob.pipeline_spec][google.cloud.aiplatform.v1.PipelineJob.pipeline_spec],
          if empty, will be downloaded.
        template_metadata
          (google.cloud.aiplatform_v1.types.PipelineTemplateMetadata): Output
          only. Pipeline template metadata. Will fill up fields if
    ...
    r"""The runtime config of a PipelineJob.
        ...
        Attributes:
            parameters (Mapping[str, google.cloud.aiplatform_v1.types.Value]):
              ...
              instead. The runtime parameters of the PipelineJob. The parameters
              will be passed into
              [PipelineJob.pipeline_spec][google.cloud.aiplatform.v1.PipelineJob.pipeline_spec]
              to replace the placeholders at runtime. This field is used by
              pipelines built using ``PipelineJob.pipeline_spec.schema_version``
              2.0.0 or lower, such as pipelines built using Kubeflow Pipelines
              SDK 1.8 or lower.
            gcs_output_directory (str): Required. A path in a Cloud Storage
              ...
              pattern ``{job_id}/{task_id}/{output_key}`` under the specified
              output directory. The service account specified in this pipeline
              must have the ``storage.objects.get`` and
            ...
            parameter_values (Mapping[str, google.protobuf.struct_pb2.Value]):
              ...
              to replace the placeholders at runtime. This field is used by
              pipelines built using ``PipelineJob.pipeline_spec.schema_version``
              2.1.0, such as pipelines built using Kubeflow Pipelines SDK 1.9 or
              higher and the v2 DSL.
            failure_policy
              (google.cloud.aiplatform_v1.types.PipelineFailurePolicy):
              Represents the failure policy of a pipeline. Currently, the
              default of a pipeline is that the pipeline will continue to run
              until no more tasks can be executed, also known as
              PIPELINE_FAILURE_POLICY_FAIL_SLOW. However, if a pipeline is set
              to PIPELINE_FAILURE_POLICY_FAIL_FAST, it will stop scheduling any
              new tasks when a task has failed. Any scheduled tasks will
...
class PipelineTemplateMetadata(proto.Message):
  r"""Pipeline template metadata if
    ...
    Attributes:
        version (str): The version_name in artifact registry.  Will always be
          presented in output if the
          [PipelineJob.template_uri][google.cloud.aiplatform.v1.PipelineJob.template_uri]
          is from supported template registry.  Format is
          "sha256:abcdef123456...".
  """
...
class PipelineJobDetail(proto.Message):
  r"""The runtime detail of PipelineJob.
    ...
    Attributes:
        pipeline_context (google.cloud.aiplatform_v1.types.Context): Output
          only. The context of the pipeline.
        pipeline_run_context (google.cloud.aiplatform_v1.types.Context): Output
          only. The context of the current pipeline run.
        task_details
          (Sequence[google.cloud.aiplatform_v1.types.PipelineTaskDetail]):
...
class PipelineTaskDetail(proto.Message):
  r"""The runtime detail of a task execution.
    ...
    Attributes:
        task_id (int): Output only. The system generated ID of the task.
        parent_task_id (int): Output only. The id of the parent task if the task
          is within a component scope. Empty if the task is at the root level.
        task_name (str): Output only. The user specified name of the task that
          is defined in [PipelineJob.spec][].
        create_time (google.protobuf.timestamp_pb2.Timestamp): Output only. Task
          create time.
        start_time (google.protobuf.timestamp_pb2.Timestamp): Output only. Task
          start time.
        end_time (google.protobuf.timestamp_pb2.Timestamp): Output only. Task
          end time.
        executor_detail
          (google.cloud.aiplatform_v1.types.PipelineTaskExecutorDetail): Output
          only. The detailed execution info.
        state (google.cloud.aiplatform_v1.types.PipelineTaskDetail.State):
          Output only. State of the task.
        execution (google.cloud.aiplatform_v1.types.Execution): Output only. The
          execution metadata of the task.
        error (google.rpc.status_pb2.Status): Output only. The error that
          occurred during task execution. Only populated when the task's state
          is FAILED or CANCELLED.
        pipeline_task_status
          (Sequence[google.cloud.aiplatform_v1.types.PipelineTaskDetail.PipelineTaskStatus]):
  ...
  class PipelineTaskStatus(proto.Message):
    r"""A single record of the task status.
        ...
        Attributes:
            ...
            error (google.rpc.status_pb2.Status): Output only. The error that
              occurred during the state. May be set when the state is any of the
              non-final state (PENDING/RUNNING/CANCELLING) or FAILED state. If
              the state is FAILED, the error here is final and not going to be
...
class PipelineTaskExecutorDetail(proto.Message):
  r"""The runtime detail of a pipeline executor.
    ...
    Attributes:
        container_detail
          ...
          Output only. The detailed info for a container executor.  This field
          is a member of `oneof`_ ``details``.
        custom_job_detail
          (google.cloud.aiplatform_v1.types.PipelineTaskExecutorDetail.CustomJobDetail):
          Output only. The detailed info for a custom job executor.  This field
          is a member of `oneof`_ ``details``.
  """

  class ContainerDetail(proto.Message):
    r"""The detail of a container execution.

    It contains the job
        names of the lifecycle of a container execution.

        Attributes:
            main_job (str): Output only. The name of the
              [CustomJob][google.cloud.aiplatform.v1.CustomJob] for the main
              container execution.
            pre_caching_check_job (str): Output only. The name of the
              [CustomJob][google.cloud.aiplatform.v1.CustomJob] for the
              pre-caching-check container execution. This job will be available
              if the
              [PipelineJob.pipeline_spec][google.cloud.aiplatform.v1.PipelineJob.pipeline_spec]
  ...
  class CustomJobDetail(proto.Message):
    r"""The detailed info for a custom job executor.
        ...
        Attributes:
            job (str): Output only. The name of the
