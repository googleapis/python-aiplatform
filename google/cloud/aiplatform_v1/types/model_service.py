...
class UploadModelRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        model (google.cloud.aiplatform_v1.types.Model): Required. The Model to
          create.
  """
  ...
  r"""Request message for
    ...
    Attributes:
        ...
        filter (str): An expression for filtering the results of the request.
          ...
          name][google.cloud.aiplatform.v1.Model.name]. -  ``display_name``
...
class ListModelsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        models (Sequence[google.cloud.aiplatform_v1.types.Model]): List of
...
class ListModelVersionsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        models (Sequence[google.cloud.aiplatform_v1.types.Model]): List of Model
...
class UpdateModelRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        model (google.cloud.aiplatform_v1.types.Model): Required. The Model
    ...
    r"""Output configuration for the Model export.
        ...
        Attributes:
            ...
            artifact_destination
              (google.cloud.aiplatform_v1.types.GcsDestination): The Cloud
...
class ListModelEvaluationsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        model_evaluations
          (Sequence[google.cloud.aiplatform_v1.types.ModelEvaluation]): List of
          ModelEvaluations in the requested page.
        next_page_token (str): A token to retrieve next page of results. Pass to
  ...
  r"""Response message for
    ...
    Attributes:
        model_evaluation_slices
          (Sequence[google.cloud.aiplatform_v1.types.ModelEvaluationSlice]):
