...
class IndexEndpoint(proto.Message):
  ...
  An IndexEndpoint can have
    ...
    Attributes:
        ...
        deployed_indexes
          (Sequence[google.cloud.aiplatform_v1beta1.types.DeployedIndex]):
...
class DeployedIndex(proto.Message):
  ...
  IndexEndpoints contain one or more
    ...
    Attributes:
        ...
        private_endpoints
          (google.cloud.aiplatform_v1beta1.types.IndexPrivateEndpoints): Output
          only. Provides paths for users to send requests directly to the
          deployed index services running on Cloud via private services access.
        ...
        index_sync_time (google.protobuf.timestamp_pb2.Timestamp): Output only.
          ...
          of the original Index, it means that this DeployedIndex and the
          original Index are in sync. If this timestamp is older, then to see
          which updates this DeployedIndex already contains (and which not), one
          must [list][Operations.ListOperations] [Operations][Operation]
        ...
        automatic_resources
          (google.cloud.aiplatform_v1beta1.types.AutomaticResources): Optional.
        ...
        dedicated_resources
          ...
          and that need a higher degree of manual configuration. If
