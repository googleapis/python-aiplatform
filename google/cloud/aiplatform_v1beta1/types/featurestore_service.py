...
class ListFeaturestoresResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        featurestores
          (Sequence[google.cloud.aiplatform_v1beta1.types.Featurestore]): The
...
class ImportFeatureValuesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        avro_source (google.cloud.aiplatform_v1beta1.types.AvroSource):  This
          field is a member of `oneof`_ ``source``.
        bigquery_source (google.cloud.aiplatform_v1beta1.types.BigQuerySource):
          This field is a member of `oneof`_ ``source``.
        csv_source (google.cloud.aiplatform_v1beta1.types.CsvSource):  This
          field is a member of `oneof`_ ``source``.
        ...
        entity_id_field (str): Source column that holds entity IDs. If not
          ...
          ``entity_id``.
        feature_specs
          (Sequence[google.cloud.aiplatform_v1beta1.types.ImportFeatureValuesRequest.FeatureSpec]):
  ...
  r"""Request message for
    ...
    Attributes:
        csv_read_instances (google.cloud.aiplatform_v1beta1.types.CsvSource):
          ...
          more entity IDs identifying entities of the corresponding EntityTypes
          whose Features are requested.  Each output instance contains Feature
          values of requested entities concatenated together as of the read
        ...
        bigquery_read_instances
          (google.cloud.aiplatform_v1beta1.types.BigQuerySource): Similar to
        ...
        pass_through_fields
          (Sequence[google.cloud.aiplatform_v1beta1.types.BatchReadFeatureValuesRequest.PassThroughField]):
        ...
        entity_type_specs
          (Sequence[google.cloud.aiplatform_v1beta1.types.BatchReadFeatureValuesRequest.EntityTypeSpec]):
    ...
    r"""Selects Features of an EntityType to read values of and
        ...
        Attributes:
            ...
            feature_selector
              ...
              Selectors choosing which Feature values to read from the
              EntityType.
            settings
              (Sequence[google.cloud.aiplatform_v1beta1.types.DestinationFeatureSetting]):
  ...
  r"""A destination location for Feature values and format.
    ...
    Attributes:
        bigquery_destination
          (google.cloud.aiplatform_v1beta1.types.BigQueryDestination): Output in
          BigQuery format.
        ...
        tfrecord_destination
          (google.cloud.aiplatform_v1beta1.types.TFRecordDestination): Output in
  ...
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the Featurestore to create
          EntityTypes. Format:
          ``projects/{project}/locations/{location}/featurestores/{featurestore}``
        entity_type (google.cloud.aiplatform_v1beta1.types.EntityType): The
...
class ListEntityTypesResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        entity_types
          (Sequence[google.cloud.aiplatform_v1beta1.types.EntityType]): The
  ...
  r"""Request message for
    ...
    Attributes:
        entity_type (google.cloud.aiplatform_v1beta1.types.EntityType):
          Required. The EntityType's ``name`` field is used to identify the
          EntityType to be updated. Format:
          ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}``
        update_mask (google.protobuf.field_mask_pb2.FieldMask): Field mask is
  ...
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the EntityType to create a
          Feature. Format:
          ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}``
        feature (google.cloud.aiplatform_v1beta1.types.Feature): Required. The
          Feature to create.
...
class BatchCreateFeaturesResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        features (Sequence[google.cloud.aiplatform_v1beta1.types.Feature]): The
          Features created.
  """
