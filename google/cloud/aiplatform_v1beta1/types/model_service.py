...
class UploadModelRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the Location into which to
          upload the Model. Format: ``projects/{project}/locations/{location}``
        parent_model (str): Optional. The resource name of the model into which
          to upload the version. Only specify this field when uploading a new
          version.
        ...
        model (google.cloud.aiplatform_v1beta1.types.Model): Required. The Model
          to create.
  """
...
class UploadModelResponse(proto.Message):
  r"""Response message of
    ...
    Attributes:
        model (str): The name of the uploaded Model resource. Format:
          ``projects/{project}/locations/{location}/models/{model}``
        model_version_id (str): Output only. The version ID of the model that is
          uploaded.
  """
...
class GetModelRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the Model resource. Format:
          ``projects/{project}/locations/{location}/models/{model}``  In order
          to retrieve a specific version of the model, also provide the version
          ...
          of the model, and can be moved to other versions later on. There will
          be exactly one default version.
  """
...
class ListModelsRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the Location to list the
        ...
        filter (str): An expression for filtering the results of the request.
          ...
          ``model`` supports = and !=. ``model`` represents the Model ID, i.e.
          the last segment of the Model's [resource
          name][google.cloud.aiplatform.v1beta1.Model.name]. -  ``display_name``
          supports = and != -  ``labels`` supports general map functions that
          is:  -  ``labels.key=value`` - key:value equality -  \`labels.key:\*
          or labels:key - key existence -  A key including a space must be
          quoted. ``labels."a key"``.  Some examples:  -  ``model=1234`` -
          ``displayName="myDisplayName"`` -  ``labels.myKey="myValue"``
        page_size (int): The standard list page size.
        page_token (str): The standard list page token. Typically obtained via
          [ListModelsResponse.next_page_token][google.cloud.aiplatform.v1beta1.ListModelsResponse.next_page_token]
          of the previous
          [ModelService.ListModels][google.cloud.aiplatform.v1beta1.ModelService.ListModels]
          call.
        read_mask (google.protobuf.field_mask_pb2.FieldMask): Mask specifying
...
class ListModelsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        models (Sequence[google.cloud.aiplatform_v1beta1.types.Model]): List of
          Models in the requested page.
        next_page_token (str): A token to retrieve next page of results. Pass to
...
class ListModelVersionsRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the model to list versions for.
        page_size (int): The standard list page size.
        page_token (str): The standard list page token. Typically obtained via
        ...
        filter (str): An expression for filtering the results of the request.
          ...
          ``labels.key=value`` - key:value equality -  \`labels.key:\* or
...
class ListModelVersionsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        models (Sequence[google.cloud.aiplatform_v1beta1.types.Model]): List of
          Model versions in the requested page. In the returned Model name
          field, version ID instead of regvision tag will be included.
        next_page_token (str): A token to retrieve the next page of results.
          Pass to
...
class UpdateModelRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        model (google.cloud.aiplatform_v1beta1.types.Model): Required. The Model
          which replaces the resource on the server. When Model Versioning is
          enabled, the model.name will be used to determine whether to update
          the model or model version.  1. model.name with the @ value, e.g.
          models/123@1, refers to a version specific update. 2. model.name
          without the @ value, e.g. models/123, refers to a model update. 3.
          model.name with @-, e.g. models/123@-, refers to a model update. 4.
          Supported model fields: display_name, description; supported
          version-specific fields: version_description. Labels are supported in
          both scenarios. Both the model labels and the version labels are
          merged when a model is returned. When updating labels, if the request
          is for model-specific update, model label gets updated. Otherwise,
          version labels get updated. 5. A model name or model version name
          fields update mismatch will cause a precondition error. 6. One request
          cannot update both the model and the version fields. You must update
          them separately.
        update_mask (google.protobuf.field_mask_pb2.FieldMask): Required. The
          update mask applies to the resource. For the ``FieldMask`` definition,
          see [google.protobuf.FieldMask][google.protobuf.FieldMask].
  """
...
class UpdateExplanationDatasetRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        model (str): Required. The resource name of the Model to update. Format:
          ``projects/{project}/locations/{location}/models/{model}``
        examples (google.cloud.aiplatform_v1beta1.types.Examples): The example
          config containing the location of the dataset.
  """
...
class DeleteModelRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the Model resource to be deleted.
...
class DeleteModelVersionRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the model version to be deleted, with
...
class MergeVersionAliasesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the model version to merge aliases,
          with a version ID explicitly included.
            Example:
              ``projects/{project}/locations/{location}/models/{model}@1234``
        version_aliases (Sequence[str]): Required. The set of version aliases to
          merge. The alias should be at most 128 characters, and match
          ``[a-z][a-z0-9-]{0,126}[a-z-0-9]``. Add the ``-`` prefix to an alias
          means removing that alias from the version. ``-`` is NOT counted in
          the 128 characters. Example: ``-golden`` means removing the ``golden``
          alias from the version.  There is NO ordering in aliases, which means
          1) The aliases returned from GetModel API might not have the exactly
          same order from this MergeVersionAliases API. 2) Adding and deleting
          the same alias in the request is not recommended, and the 2 operations
...
class ExportModelRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The resource name of the Model to export. The
          resource name may contain version id or version alias to specify the
          version, if no version is specified, the default version will be
          exported.
        output_config
  ...
  class OutputConfig(proto.Message):
    r"""Output configuration for the Model export.
        ...
        Attributes:
            export_format_id (str): The ID of the format in which the Model must
              be exported. Each Model lists the [export formats it
              supports][google.cloud.aiplatform.v1beta1.Model.supported_export_formats].
              If no value is provided here, then the first from the list of the
              Model's supported formats is used by default.
            artifact_destination
              (google.cloud.aiplatform_v1beta1.types.GcsDestination): The Cloud
              Storage location where the Model artifact is to be written to.
              Under the directory given as the destination a new one with name
              "``model-export-<model-display-name>-<timestamp-of-export-call>``",
              where timestamp is in YYYY-MM-DDThh:mm:ss.sssZ ISO-8601 format,
              will be created. Inside, the Model and any of its supporting files
              will be written. This field should only be set when the
              ``exportableContent`` field of the
...
class ExportModelOperationMetadata(proto.Message):
  ...
  class OutputInfo(proto.Message):
    r"""Further describes the output of the ExportModel.

    Supplements
        [ExportModelRequest.OutputConfig][google.cloud.aiplatform.v1beta1.ExportModelRequest.OutputConfig].

        Attributes:
            artifact_output_uri (str): Output only. If the Model artifact is
              being exported to Google Cloud Storage this is the full path of
              the directory created, into which the Model files are being
              written to.
            image_output_uri (str): Output only. If the Model image is being
              exported to Google Container Registry or Artifact Registry this is
              the full path of the image created.
    """
...
class ImportModelEvaluationRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The name of the parent model resource. Format:
          ``projects/{project}/locations/{location}/models/{model}``
        model_evaluation
          (google.cloud.aiplatform_v1beta1.types.ModelEvaluation): Required.
...
class BatchImportModelEvaluationSlicesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The name of the parent ModelEvaluation resource.
            Format:
              ``projects/{project}/locations/{location}/models/{model}/evaluations/{evaluation}``
        model_evaluation_slices
          (Sequence[google.cloud.aiplatform_v1beta1.types.ModelEvaluationSlice]):
...
class BatchImportModelEvaluationSlicesResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        imported_model_evaluation_slices (Sequence[str]): Output only. List of
          imported
...
class GetModelEvaluationRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the ModelEvaluation resource. Format:
          ``projects/{project}/locations/{location}/models/{model}/evaluations/{evaluation}``
  """
...
class ListModelEvaluationsRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the Model to list the
...
class ListModelEvaluationsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        model_evaluations
          (Sequence[google.cloud.aiplatform_v1beta1.types.ModelEvaluation]):
...
class GetModelEvaluationSliceRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the ModelEvaluationSlice resource.
            Format:
...
class ListModelEvaluationSlicesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the ModelEvaluation to list
          the ModelEvaluationSlices from. Format:
          ``projects/{project}/locations/{location}/models/{model}/evaluations/{evaluation}``
        filter (str): The standard list filter.  -  ``slice.dimension`` - for =.
        page_size (int): The standard list page size.
        page_token (str): The standard list page token. Typically obtained via
