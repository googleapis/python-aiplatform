...
class CreateIndexRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        index (google.cloud.aiplatform_v1beta1.types.Index): Required. The Index
          to create.
  """
...
class GetIndexRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the Index resource. Format:
  ...
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the Location from which to
          list the Indexes. Format: ``projects/{project}/locations/{location}``
...
class ListIndexesResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        indexes (Sequence[google.cloud.aiplatform_v1beta1.types.Index]): List of
          indexes in the requested page.
...
class UpdateIndexRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        index (google.cloud.aiplatform_v1beta1.types.Index): Required. The Index
          which updates the resource on the server.
        update_mask (google.protobuf.field_mask_pb2.FieldMask): The update mask
...
class DeleteIndexRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the Index resource to be deleted.
  ...
  r"""Runtime operation metadata with regard to Matching Engine
    ...
    Attributes:
        content_validation_stats
          (Sequence[google.cloud.aiplatform_v1beta1.types.NearestNeighborSearchOperationMetadata.ContentValidationStats]):
          ...
          Please note that, currently for those files that are broken or has
          unsupported file format, we will not have the stats for those files.
        data_bytes_count (int): The ingested data size in bytes.
  """
  ...
  class RecordError(proto.Message):
    r"""
        ...
        Attributes:
            ...
            error_message (str): A human-readable message that is shown to the
              user to help them fix the error. Note that this message may change
              from time to time, your code should check against error_type as
              the source of truth.
            source_gcs_uri (str): Cloud Storage URI pointing to the original
              file in user's bucket.
            embedding_id (str): Empty if the embedding id is failed to parse.
            raw_record (str): The original content of this record.
    """
  ...
  class ContentValidationStats(proto.Message):
    r"""
        ...
        Attributes:
            source_gcs_uri (str): Cloud Storage URI pointing to the original
              file in user's bucket.
            valid_record_count (int): Number of records in this file that were
              successfully processed.
            invalid_record_count (int): Number of records in this file we
              skipped due to validate errors.
            partial_errors
              (Sequence[google.cloud.aiplatform_v1beta1.types.NearestNeighborSearchOperationMetadata.RecordError]):
              The detail information of the partial failures encountered for
              those invalid records that couldn't be parsed. Up to 50 partial
