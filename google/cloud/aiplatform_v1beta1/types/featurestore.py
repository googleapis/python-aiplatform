...
class Featurestore(proto.Message):
  r"""Vertex AI Feature Store provides a centralized repository for
    ...
    Attributes:
        name (str): Output only. Name of the Featurestore. Format:
        ...
        labels (Mapping[str, str]): Optional. The labels with user-defined
          metadata to organize your Featurestore. Label keys and values can be
          ...
          labels can be associated with one Featurestore(System labels are
        ...
        online_serving_config
          ...
          Optional. Config for online storage resources. If unset, the
          featurestore will not have an online store and cannot be used for
          online serving.
        state (google.cloud.aiplatform_v1beta1.types.Featurestore.State): Output
          only. State of the featurestore.
  ...
  class OnlineServingConfig(proto.Message):
    r"""OnlineServingConfig specifies the details for provisioning
        ...
        Attributes:
            fixed_node_count (int): The number of nodes for the online store.
              The number of nodes doesn't scale automatically, but you can
              manually update the number of nodes. If set to 0, the featurestore
    ...
    class Scaling(proto.Message):
      r"""Online serving scaling configuration.

      If min_node_count and
            max_node_count are set to the same value, the cluster will be
            configured with the fixed number of node (no auto-scaling).

            Attributes:
                min_node_count (int): Required. The minimum number of nodes to
                  scale down to. Must be greater than or equal to 1.
                max_node_count (int): The maximum number of nodes to scale up
                  to. Must be greater than min_node_count, and less than or
