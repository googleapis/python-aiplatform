...
class Explanation(proto.Message):
  r"""Explanation of a prediction (provided in
    ...
    Attributes:
        attributions
          (Sequence[google.cloud.aiplatform_v1beta1.types.Attribution]): Output
          only. Feature attributions grouped by predicted outputs.  For Models
          that predict only one output, such as regression Models that predict
          only one score, there is only one attibution that explains the
          predicted output. For Models that predict multiple outputs, such as
          multiclass Models that predict multiple classes, each element explains
          one specific item.
          ...
          [instance_output_value][Attributions.instance_output_value] in
          descending order. If
...
class ModelExplanation(proto.Message):
  r"""Aggregated explanation metrics for a Model over a set of
    ...
    Attributes:
        mean_attributions
          (Sequence[google.cloud.aiplatform_v1beta1.types.Attribution]): Output
          only. Aggregated attributions explaining the Model's prediction
          outputs over the set of instances. The attributions are grouped by
          ...
          element explains one specific item.
          [Attribution.output_index][google.cloud.aiplatform.v1beta1.Attribution.output_index]
          can be used to identify which output this attribution is explaining.
          The
          ...
          fields are averaged over the test data.
            NOTE: Currently AutoML tabular classification Models produce only
              one attribution, which averages attributions over all the classes
              it predicts.
...
class Attribution(proto.Message):
  r"""Attribution that explains a particular prediction output.
    ...
    Attributes:
        baseline_output_value (float): Output only. Model predicted output if
          the input instance is constructed from the baselines of all the
          features defined in
          ...
          If the Model's predicted output has multiple dimensions (rank > 1),
          this is the value in the output located by
          [output_index][google.cloud.aiplatform.v1beta1.Attribution.output_index].
          If there are multiple baselines, their output values are averaged.
        instance_output_value (float): Output only. Model predicted output on
          the corresponding [explanation instance][ExplainRequest.instances].
          The field name of the output is determined by the key in
          [ExplanationMetadata.outputs][google.cloud.aiplatform.v1beta1.ExplanationMetadata.outputs].
          If the Model predicted output has multiple dimensions, this is the
          value in the output located by
          [output_index][google.cloud.aiplatform.v1beta1.Attribution.output_index].
        feature_attributions (google.protobuf.struct_pb2.Value): Output only.
          Attributions of each explained feature. Features are extracted from
          the [prediction
          ...
          The value is a struct, whose keys are the name of the feature. The
          values are how much the feature in the
          [instance][google.cloud.aiplatform.v1beta1.ExplainRequest.instances]
          contributed to the predicted result.  The format of the value is
          determined by the feature's input
            format:  -  If the feature is a scalar value, the attribution value
              is a [floating number][google.protobuf.Value.number_value].  -  If
              the feature is an array of scalar values, the attribution value is
              an [array][google.protobuf.Value.list_value].  -  If the feature
              is a struct, the attribution value is a
        ...
        output_index (Sequence[int]): Output only. The index that locates the
          explained prediction output.  If the prediction output is a scalar
          value, output_index is not populated. If the prediction output has
          multiple dimensions, the length of the output_index list is the same
          as the number of dimensions of the output. The i-th element in
          output_index is the element index of the i-th dimension of the output
          vector. Indices start from 0.
        output_display_name (str): Output only. The display name of the output
          identified by
          [output_index][google.cloud.aiplatform.v1beta1.Attribution.output_index].
          For example, the predicted class name by a multi-classification Model.
          This field is only populated iff the Model predicts display names as a
          separate field along with the explained output. The predicted display
          name must has the same shape of the explained output, and can be
          located using output_index.
        approximation_error (float): Output only. Error of
          [feature_attributions][google.cloud.aiplatform.v1beta1.Attribution.feature_attributions]
          caused by approximation used in the explanation method. Lower value
          means more precise attributions.  -  For Sampled Shapley
          ...
          might reduce the error. -  For [XRAI
          ...
          </vertex-ai/docs/explainable-ai/overview>`__ for more information.
        output_name (str): Output only. Name of the explain output. Specified as
          the key in
          [ExplanationMetadata.outputs][google.cloud.aiplatform.v1beta1.ExplanationMetadata.outputs].
  """
...
class Neighbor(proto.Message):
  r"""Neighbors for example-based explanations.
    ...
    Attributes:
        neighbor_id (str): Output only. The neighbor id.
        neighbor_distance (float): Output only. The neighbor distance.
  """
  ...
  r"""Specification of Model explanation.
    ...
    Attributes:
        ...
        metadata (google.cloud.aiplatform_v1beta1.types.ExplanationMetadata):
          Required. Metadata describing the Model's input and output for
          explanation.
  """
  ...
  r"""Parameters to configure explaining for Model's predictions.
    ...
    Attributes:
        sampled_shapley_attribution
          (google.cloud.aiplatform_v1beta1.types.SampledShapleyAttribution): An
          attribution method that approximates Shapley values for features that
          contribute to the label being predicted. A sampling strategy is used
          to approximate the value rather than considering all subsets of
          features. Refer to this paper for model details:
            https://arxiv.org/abs/1306.4265.  This field is a member of `oneof`_
              ``method``.
        integrated_gradients_attribution
          ...
          paper for more details:
            https://arxiv.org/abs/1703.01365  This field is a member of `oneof`_
              ``method``.
        xrai_attribution
          (google.cloud.aiplatform_v1beta1.types.XraiAttribution): An
          attribution method that redistributes Integrated Gradients attribution
          to segmented regions, taking advantage of the model's fully
          differentiable structure. Refer to this paper for more details:
            https://arxiv.org/abs/1906.02825 XRAI currently performs better on
              natural images, like a picture of a house or an animal. If the
              images are taken in artificial environments, like a lab or
        ...
        examples (google.cloud.aiplatform_v1beta1.types.Examples): Example-based
          explanations that returns the nearest neighbors from the provided
          dataset.  This field is a member of `oneof`_ ``method``.
        top_k (int): If populated, returns attributions for top K indices of
          outputs (defaults to 1). Only applies to Models that predicts more
          than one outputs (e,g, multi-class Models). When set to -1, returns
          explanations for all outputs.
        output_indices (google.protobuf.struct_pb2.ListValue): If populated,
          only returns attributions that have
          [output_index][google.cloud.aiplatform.v1beta1.Attribution.output_index]
          ...
          returns attributions for
          [top_k][google.cloud.aiplatform.v1beta1.ExplanationParameters.top_k]
          indices of outputs. If neither top_k nor output_indeices is populated,
          returns the argmax index of the outputs.  Only applicable to Models
          that predict multiple outputs (e,g, multi-class Models that predict
          multiple classes).
  """
...
class SampledShapleyAttribution(proto.Message):
  r"""An attribution method that approximates Shapley values for
    ...
    Attributes:
        path_count (int): Required. The number of feature permutations to
          consider when approximating the Shapley values.  Valid range of its
          value is [1, 50], inclusively.
  """
...
class IntegratedGradientsAttribution(proto.Message):
  r"""An attribution method that computes the Aumann-Shapley value
    ...
    Attributes:
        step_count (int): Required. The number of steps for approximating the
          path integral. A good value to start is 50 and gradually increase
          until the sum to diff property is within the desired error range.
          Valid range of its value is [1, 100], inclusively.
        smooth_grad_config
          (google.cloud.aiplatform_v1beta1.types.SmoothGradConfig): Config for
          SmoothGrad approximation of gradients. When enabled, the gradients are
        ...
        blur_baseline_config
          (google.cloud.aiplatform_v1beta1.types.BlurBaselineConfig): Config for
          IG with blur baseline. When enabled, a linear path from the maximally
...
class XraiAttribution(proto.Message):
  r"""An explanation method that redistributes Integrated Gradients
    ...
    Attributes:
        ...
        blur_baseline_config
          (google.cloud.aiplatform_v1beta1.types.BlurBaselineConfig): Config for
          XRAI with blur baseline. When enabled, a linear path from the
          maximally blurred image to the input image is created. Using a blurred
          baseline instead of zero (black image) is motivated by the BlurIG
...
class SmoothGradConfig(proto.Message):
  r"""Config for SmoothGrad approximation of gradients.
    ...
    Attributes:
        noise_sigma (float): This is a single float value and will be used to
          add noise to all the features. Use this field when all features are
          ...
          <https://developers.google.com/machine-learning/data-prep/transform/normalization>`__.
          ...
          SmoothGrad paper:
            https://arxiv.org/pdf/1706.03825.pdf. Defaults to 0.1.  If the
              distribution is different per feature, set
              [feature_noise_sigma][google.cloud.aiplatform.v1beta1.SmoothGradConfig.feature_noise_sigma]
              instead for each feature.  This field is a member of `oneof`_
              ``GradientNoiseSigma``.
        feature_noise_sigma
          (google.cloud.aiplatform_v1beta1.types.FeatureNoiseSigma): This is
          similar to
          ...
          different. No noise is added to features that are not set. If this
          field is unset,
          [noise_sigma][google.cloud.aiplatform.v1beta1.SmoothGradConfig.noise_sigma]
          will be used for all features.  This field is a member of `oneof`_
          ``GradientNoiseSigma``.
        noisy_sample_count (int): The number of gradient samples to use for
          approximation. The higher this number, the more accurate the gradient
          is, but the runtime complexity increases by this factor as well. Valid
...
class FeatureNoiseSigma(proto.Message):
  r"""Noise sigma by features.

  Noise sigma represents the standard
    deviation of the gaussian kernel that will be used to add noise
    to interpolated inputs prior to computing gradients.

    Attributes:
        noise_sigma
          (Sequence[google.cloud.aiplatform_v1beta1.types.FeatureNoiseSigma.NoiseSigmaForFeature]):
  ...
  class NoiseSigmaForFeature(proto.Message):
    r"""Noise sigma for a single feature.
        ...
        Attributes:
            name (str): The name of the input feature for which noise sigma is
              provided. The features are defined in [explanation metadata
              inputs][google.cloud.aiplatform.v1beta1.ExplanationMetadata.inputs].
            sigma (float): This represents the standard deviation of the
              Gaussian kernel that will be used to add noise to the feature
              prior to computing gradients. Similar to
              [noise_sigma][google.cloud.aiplatform.v1beta1.SmoothGradConfig.noise_sigma]
              but represents the noise added to the current feature. Defaults to
              0.1.
    """
...
class BlurBaselineConfig(proto.Message):
  r"""Config for blur baseline.
    ...
    Attributes:
        max_blur_sigma (float): The standard deviation of the blur kernel for
          the blurred baseline. The same blurring parameter is used for both the
          height and the width dimension. If not set, the method defaults to the
...
class Examples(proto.Message):
  r"""Example-based explainability that returns the nearest
    ...
    Attributes:
        nearest_neighbor_search_config (google.protobuf.struct_pb2.Value): The
          configuration for the generated index, the semantics are the same as
          [metadata][google.cloud.aiplatform.v1beta1.Index.metadata] and should
          match NearestNeighborSearchConfig.  This field is a member of `oneof`_
          ``config``.
        presets (google.cloud.aiplatform_v1beta1.types.Presets): Preset config
          based on the desired query speed-precision trade-off and modality
          This field is a member of `oneof`_ ``config``.
        gcs_source (google.cloud.aiplatform_v1beta1.types.GcsSource): The Cloud
          Storage location for the input instances.
        neighbor_count (int): The number of neighbors to return.
  """
...
class Presets(proto.Message):
  r"""Preset configuration for example-based explanations
    ...
    Attributes:
        query (google.cloud.aiplatform_v1beta1.types.Presets.Query): Preset
          option controlling parameters for query speed-precision trade-off
...
class ExplanationSpecOverride(proto.Message):
  r"""The
    ...
    Attributes:
        parameters
          (google.cloud.aiplatform_v1beta1.types.ExplanationParameters): The
          parameters to be overridden. Note that the
        ...
        metadata
          ...
          overridden.
        examples_override
          (google.cloud.aiplatform_v1beta1.types.ExamplesOverride): The
          example-based explanations parameter overrides.
  """
  ...
  r"""The
    ...
    Attributes:
        inputs (Mapping[str,
          ...
          of the features. The key is the name of the feature to be overridden.
          The keys specified here must exist in the input metadata to be
          overridden. If a feature is not specified here, the corresponding
          feature's input metadata is not overridden.
  """
...
class ExamplesOverride(proto.Message):
  r"""Overrides for example-based explanations.
    ...
    Attributes:
        neighbor_count (int): The number of neighbors to return.
        crowding_count (int): The number of neighbors to return that have the
          same crowding tag.
        restrictions
          (Sequence[google.cloud.aiplatform_v1beta1.types.ExamplesRestrictionsNamespace]):
          Restrict the resulting nearest neighbors to respect these constraints.
        return_embeddings (bool): If true, return the embeddings instead of
          neighbors.
        data_format
...
class ExamplesRestrictionsNamespace(proto.Message):
  r"""Restrictions namespace for example-based explanations
    ...
    Attributes:
        ...
        allow (Sequence[str]): The list of allowed tags.
        deny (Sequence[str]): The list of deny tags.
  """
