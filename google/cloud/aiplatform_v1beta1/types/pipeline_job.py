  ...
  r"""An instance of a machine learning PipelineJob.
    ...
    Attributes:
        ...
        state (google.cloud.aiplatform_v1beta1.types.PipelineState): Output
          only. The detailed state of the job.
    ...
    r"""The runtime config of a PipelineJob.
        ...
        Attributes:
            parameters (Mapping[str,
              google.cloud.aiplatform_v1beta1.types.Value]): Deprecated. Use
...
class PipelineJobDetail(proto.Message):
  r"""The runtime detail of PipelineJob.
    ...
    Attributes:
        pipeline_context (google.cloud.aiplatform_v1beta1.types.Context): Output
          only. The context of the pipeline.
        pipeline_run_context (google.cloud.aiplatform_v1beta1.types.Context):
          Output only. The context of the current pipeline run.
        task_details
          (Sequence[google.cloud.aiplatform_v1beta1.types.PipelineTaskDetail]):
...
class PipelineTaskDetail(proto.Message):
  r"""The runtime detail of a task execution.
    ...
    Attributes:
        ...
        execution (google.cloud.aiplatform_v1beta1.types.Execution): Output
          only. The execution metadata of the task.
        error (google.rpc.status_pb2.Status): Output only. The error that
          occurred during task execution. Only populated when the task's state
          is FAILED or CANCELLED.
        pipeline_task_status
          (Sequence[google.cloud.aiplatform_v1beta1.types.PipelineTaskDetail.PipelineTaskStatus]):
  ...
  class ArtifactList(proto.Message):
    r"""A list of artifact metadata.
        ...
        Attributes:
            artifacts
              (Sequence[google.cloud.aiplatform_v1beta1.types.Artifact]): Output
