...
class CreateCustomJobRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        custom_job (google.cloud.aiplatform_v1beta1.types.CustomJob): Required.
          The CustomJob to create.
  """
...
class CreateDataLabelingJobRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        data_labeling_job
          (google.cloud.aiplatform_v1beta1.types.DataLabelingJob): Required. The
          DataLabelingJob to create.
  """
...
class ListDataLabelingJobsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        data_labeling_jobs
          (Sequence[google.cloud.aiplatform_v1beta1.types.DataLabelingJob]): A
          list of DataLabelingJobs that matches the specified filter in the
          request.
  ...
  r"""Response message for
    ...
    Attributes:
        hyperparameter_tuning_jobs
          (Sequence[google.cloud.aiplatform_v1beta1.types.HyperparameterTuningJob]):
  ...
  r"""Request message for
    ...
    Attributes:
        ...
        batch_prediction_job
          (google.cloud.aiplatform_v1beta1.types.BatchPredictionJob): Required.
          The BatchPredictionJob to create.
  """
  ...
  r"""Response message for
    ...
    Attributes:
        batch_prediction_jobs
          (Sequence[google.cloud.aiplatform_v1beta1.types.BatchPredictionJob]):
...
class SearchModelDeploymentMonitoringStatsAnomaliesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        objectives
          (Sequence[google.cloud.aiplatform_v1beta1.types.SearchModelDeploymentMonitoringStatsAnomaliesRequest.StatsAnomaliesObjective]):
...
class SearchModelDeploymentMonitoringStatsAnomaliesResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        monitoring_stats
          (Sequence[google.cloud.aiplatform_v1beta1.types.ModelMonitoringStatsAnomalies]):
  ...
  r"""Response message for
    ...
    Attributes:
        model_deployment_monitoring_jobs
          (Sequence[google.cloud.aiplatform_v1beta1.types.ModelDeploymentMonitoringJob]):
