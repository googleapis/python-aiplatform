...
class ModelEvaluationSlice(proto.Message):
  r"""A collection of metrics calculated by comparing Model's
    ...
    Attributes:
        name (str): Output only. The resource name of the ModelEvaluationSlice.
        slice_
          ...
          Model.
        metrics_schema_uri (str): Output only. Points to a YAML file stored on
          Google Cloud Storage describing the
          [metrics][google.cloud.aiplatform.v1beta1.ModelEvaluationSlice.metrics]
          of this ModelEvaluationSlice. The schema is defined as an OpenAPI
          3.0.2 `Schema Object
          <https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.0.2.md#schemaObject>`__.
        metrics (google.protobuf.struct_pb2.Value): Output only. Sliced
  ...
  class Slice(proto.Message):
    r"""Definition of a slice.
        ...
        Attributes:
            dimension (str): Output only. The dimension of the slice. Well-known
              dimensions are:  -  ``annotationSpec``: This slice is on the test
            ...
            value (str): Output only. The value of the dimension in this slice.
    """
