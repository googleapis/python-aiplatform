...
class ListTensorboardsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        tensorboards
          (Sequence[google.cloud.aiplatform_v1beta1.types.Tensorboard]): The
          Tensorboards mathching the request.
  ...
  r"""Response message for
    ...
    Attributes:
        tensorboard_experiments
          (Sequence[google.cloud.aiplatform_v1beta1.types.TensorboardExperiment]):
...
class BatchCreateTensorboardRunsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        tensorboard_runs
          (Sequence[google.cloud.aiplatform_v1beta1.types.TensorboardRun]): The
  ...
  r"""Response message for
    ...
    Attributes:
        tensorboard_time_series
          (Sequence[google.cloud.aiplatform_v1beta1.types.TensorboardTimeSeries]):
