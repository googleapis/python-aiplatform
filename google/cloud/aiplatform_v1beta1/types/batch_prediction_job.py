...
class BatchPredictionJob(proto.Message):
  r"""A job that uses a
    ...
    Attributes:
        ...
        dedicated_resources
          (google.cloud.aiplatform_v1beta1.types.BatchDedicatedResources): The
          config of resources used by the Model during the batch prediction. If
          the Model
        ...
        service_account (str): The service account that the DeployedModel's
          ...
          used, which has minimal permissions and the custom container, if used,
          may not have enough permission to access other GCP resources.  Users
        ...
        resources_consumed
          (google.cloud.aiplatform_v1beta1.types.ResourcesConsumed): Output
          only. Information about resources that had been consumed by this job.
        ...
        completion_stats
          (google.cloud.aiplatform_v1beta1.types.CompletionStats): Output only.
        ...
        model_monitoring_config
          (google.cloud.aiplatform_v1beta1.types.ModelMonitoringConfig): Model
          monitoring config will be used for analysis model behaviors, based on
          the input and output to the batch prediction job, as well as the
    ...
    r"""Configures the input to
        ...
        Attributes:
            gcs_source (google.cloud.aiplatform_v1beta1.types.GcsSource): The
              Cloud Storage location for the input instances.  This field is a
              member of `oneof`_ ``source``.
            bigquery_source
              (google.cloud.aiplatform_v1beta1.types.BigQuerySource): The
              BigQuery location of the input table. The schema of the table
    ...
    r"""Configures the output of
        ...
        Attributes:
            ...
            bigquery_destination
              (google.cloud.aiplatform_v1beta1.types.BigQueryDestination): The
