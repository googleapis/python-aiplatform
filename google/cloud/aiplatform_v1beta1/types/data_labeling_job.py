...
class DataLabelingJob(proto.Message):
    ...
    Attributes:
        ...
        annotation_labels (Sequence[~.data_labeling_job.DataLabelingJob.AnnotationLabelsEntry]):
        ...
        active_learning_config (~.data_labeling_job.ActiveLearningConfig):
...
class ActiveLearningConfig(proto.Message):
    ...
    Attributes:
        ...
        max_data_item_percentage (int):
            ...
            labeling.
        sample_config (~.data_labeling_job.SampleConfig):
            ...
            sampling strategy.
        training_config (~.data_labeling_job.TrainingConfig):
...
class SampleConfig(proto.Message):
    ...
    Attributes:
        ...
        following_batch_sample_percentage (int):
            ...
            batch).
        sample_strategy (~.data_labeling_job.SampleConfig.SampleStrategy):
