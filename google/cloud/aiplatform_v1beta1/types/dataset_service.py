...
class CreateDatasetRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        dataset (google.cloud.aiplatform_v1beta1.types.Dataset): Required. The
          Dataset to create.
  """
...
class GetDatasetRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the Dataset resource.
...
class UpdateDatasetRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        dataset (google.cloud.aiplatform_v1beta1.types.Dataset): Required. The
          Dataset which replaces the resource on the server.
        update_mask (google.protobuf.field_mask_pb2.FieldMask): Required. The
          ...
          see [google.protobuf.FieldMask][google.protobuf.FieldMask]. Updatable
  ...
  r"""Request message for
    ...
    Attributes:
        ...
        filter (str): An expression for filtering the results of the request.
          ...
          ``display_name``: supports = and != -  ``metadata_schema_uri``:
          ...
          quoted. ``labels."a key"``.  Some examples:  -
...
class ListDatasetsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        datasets (Sequence[google.cloud.aiplatform_v1beta1.types.Dataset]): A
          list of Datasets that matches the specified filter in the request.
...
class ExportDataResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        exported_files (Sequence[str]): All of the files that are exported in
  ...
  r"""Runtime operation information for
    ...
    Attributes:
        generic_metadata
          (google.cloud.aiplatform_v1beta1.types.GenericOperationMetadata): The
          common part of the operation metadata.
        gcs_output_directory (str): A Google Cloud Storage directory which path
          ends with '/'. The exported data is stored in the directory.
  """
...
class ListDataItemsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        data_items (Sequence[google.cloud.aiplatform_v1beta1.types.DataItem]): A
...
class GetAnnotationSpecRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the AnnotationSpec resource. Format:
...
class ListAnnotationsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        annotations
          (Sequence[google.cloud.aiplatform_v1beta1.types.Annotation]): A list
          of Annotations that matches the specified filter in the request.
        next_page_token (str): The standard List next-page token.
  """
