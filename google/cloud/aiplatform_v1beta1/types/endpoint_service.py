...
class CreateEndpointRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        endpoint (google.cloud.aiplatform_v1beta1.types.Endpoint): Required. The
          Endpoint to create.
        endpoint_id (str): Immutable. The ID to use for endpoint, which will
...
class GetEndpointRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the Endpoint resource. Format:
...
class ListEndpointsRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the Location from which to
        ...
        filter (str): Optional. An expression for filtering the results of the
          ...
          -  ``endpoint`` supports = and !=. ``endpoint`` represents the
          Endpoint ID, i.e. the last segment of the Endpoint's [resource
          ...
          \`labels.key:\* or labels:key - key existence -  A key including a
          space must be quoted. ``labels."a key"``.  Some examples:  -
          ``endpoint=1`` -  ``displayName="myDisplayName"`` -
          ``labels.myKey="myValue"``
        page_size (int): Optional. The standard list page size.
        page_token (str): Optional. The standard list page token. Typically
          obtained via
          [ListEndpointsResponse.next_page_token][google.cloud.aiplatform.v1beta1.ListEndpointsResponse.next_page_token]
          of the previous
          [EndpointService.ListEndpoints][google.cloud.aiplatform.v1beta1.EndpointService.ListEndpoints]
          call.
        read_mask (google.protobuf.field_mask_pb2.FieldMask): Optional. Mask
...
class UpdateEndpointRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        endpoint (google.cloud.aiplatform_v1beta1.types.Endpoint): Required. The
          Endpoint which replaces the resource on the server.
        update_mask (google.protobuf.field_mask_pb2.FieldMask): Required. The
          update mask applies to the resource. See
...
class DeleteEndpointRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the Endpoint resource to be deleted.
            Format:
              ``projects/{project}/locations/{location}/endpoints/{endpoint}``
  """
...
class DeployModelRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        endpoint (str): Required. The name of the Endpoint resource into which
        ...
        traffic_split (Mapping[str, int]): A map from a DeployedModel's ID to
          ...
          that DeployedModel.  If this field is non-empty, then the Endpoint's
          ...
          DeployedModel will be filled in its place by this method. The traffic
          percentage values must add up to 100.  If this field is empty, then
          the Endpoint's
          [traffic_split][google.cloud.aiplatform.v1beta1.Endpoint.traffic_split]
          is not updated.
  """
...
class UndeployModelRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        endpoint (str): Required. The name of the Endpoint resource from which
          to undeploy a Model. Format:
          ``projects/{project}/locations/{location}/endpoints/{endpoint}``
        deployed_model_id (str): Required. The ID of the DeployedModel to be
          undeployed from the Endpoint.
        traffic_split (Mapping[str, int]): If this field is provided, then the
          Endpoint's
          [traffic_split][google.cloud.aiplatform.v1beta1.Endpoint.traffic_split]
          will be overwritten with it. If last DeployedModel is being undeployed
          from the Endpoint, the [Endpoint.traffic_split] will always end up
          empty when this call returns. A DeployedModel will be successfully
