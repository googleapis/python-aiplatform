...
class Annotation(proto.Message):
  r"""Used to assign specific AnnotationSpec to a particular area
    ...
    Attributes:
        name (str): Output only. Resource name of the Annotation.
        payload_schema_uri (str): Required. Google Cloud Storage URI points to a
          YAML file describing
          [payload][google.cloud.aiplatform.v1beta1.Annotation.payload]. The
        ...
        payload (google.protobuf.struct_pb2.Value): Required. The schema of the
          payload can be found in
        ...
        annotation_source
          (google.cloud.aiplatform_v1beta1.types.UserActionReference): Output
          only. The source of the Annotation.
        labels (Mapping[str, str]): Optional. The labels with user-defined
          metadata to organize your Annotations.  Label keys and values can be
          no longer than 64 characters (Unicode codepoints), can only contain
          lowercase letters, numeric characters, underscores and dashes.
          International characters are allowed. No more than 64 user labels can
          be associated with one Annotation(System labels are excluded).  See
          https://goo.gl/xmQnxf for more information and examples of labels.
          System reserved label keys are prefixed with
          "aiplatform.googleapis.com/" and are immutable. Following system
          labels exist for each Annotation:  -
