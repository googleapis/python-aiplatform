...
class ListMetadataStoresResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        metadata_stores
          (Sequence[google.cloud.aiplatform_v1beta1.types.MetadataStore]): The
  ...
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the MetadataStore where the
          ...
          ``projects/{project}/locations/{location}/metadataStores/{metadatastore}``
        artifact (google.cloud.aiplatform_v1beta1.types.Artifact): Required. The
          Artifact to create.
  ...
  r"""Request message for
    ...
    Attributes:
        artifact (google.cloud.aiplatform_v1beta1.types.Artifact): Required. The
          ...
          [Artifact.name][google.cloud.aiplatform.v1beta1.Artifact.name] field
          is used to identify the Artifact to be updated.
            Format:
              ``projects/{project}/locations/{location}/metadataStores/{metadatastore}/artifacts/{artifact}``
        ...
        allow_missing (bool): If set to true, and the
          [Artifact][google.cloud.aiplatform.v1beta1.Artifact] is not found, a
          new [Artifact][google.cloud.aiplatform.v1beta1.Artifact] is created.
  """
  ...
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the MetadataStore where the
          ...
          ``projects/{project}/locations/{location}/metadataStores/{metadatastore}``
        context (google.cloud.aiplatform_v1beta1.types.Context): Required. The
          Context to create.
...
class ListContextsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        contexts (Sequence[google.cloud.aiplatform_v1beta1.types.Context]): The
  ...
  r"""Request message for
    ...
    Attributes:
        context (google.cloud.aiplatform_v1beta1.types.Context): Required. The
          ...
          [Context.name][google.cloud.aiplatform.v1beta1.Context.name] field is
          used to identify the Context to be updated. Format:
          ``projects/{project}/locations/{location}/metadataStores/{metadatastore}/contexts/{context}``
        update_mask (google.protobuf.field_mask_pb2.FieldMask): Optional. A
          FieldMask indicating which fields should be updated. Functionality of
          this field is not yet supported.
        allow_missing (bool): If set to true, and the
          [Context][google.cloud.aiplatform.v1beta1.Context] is not found, a new
          [Context][google.cloud.aiplatform.v1beta1.Context] is created.
  """
  ...
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the MetadataStore where the
          ...
          ``projects/{project}/locations/{location}/metadataStores/{metadatastore}``
        execution (google.cloud.aiplatform_v1beta1.types.Execution): Required.
  ...
  r"""Request message for
    ...
    Attributes:
        execution (google.cloud.aiplatform_v1beta1.types.Execution): Required.
          ...
          [Execution.name][google.cloud.aiplatform.v1beta1.Execution.name] field
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask): Optional. A
          ...
          this field is not yet supported.
        allow_missing (bool): If set to true, and the
          [Execution][google.cloud.aiplatform.v1beta1.Execution] is not found, a
          new [Execution][google.cloud.aiplatform.v1beta1.Execution] is created.
  """
...
class ListMetadataSchemasResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        metadata_schemas
          (Sequence[google.cloud.aiplatform_v1beta1.types.MetadataSchema]): The
