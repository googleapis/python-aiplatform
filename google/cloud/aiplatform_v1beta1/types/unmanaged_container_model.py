...
class UnmanagedContainerModel(proto.Message):
  r"""Contains model information necessary to perform batch
    ...
    Attributes:
        ...
        predict_schemata
          (google.cloud.aiplatform_v1beta1.types.PredictSchemata): Contains the
          schemata used in Model's predictions and explanations
        container_spec
          (google.cloud.aiplatform_v1beta1.types.ModelContainerSpec): Input
          only. The specification of the container that is to be used when
