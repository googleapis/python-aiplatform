...
class Feature(proto.Message):
  r"""Feature Metadata information that describes an attribute of
    ...
    Attributes:
        name (str): Immutable. Name of the Feature. Format:
          ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}/features/{feature}``
          The last part feature is assigned by the client. The feature can be up
          to 64 characters long and can consist only of ASCII Latin letters A-Z
          and a-z, underscore(_), and ASCII digits 0-9 starting with a letter.
        ...
        labels (Mapping[str, str]): Optional. The labels with user-defined
          metadata to organize your Features. Label keys and values can be no
          ...
          labels can be associated with one Feature (System labels are
        ...
        monitoring_config
          ...
          Optional. Deprecated: The custom monitoring configuration for this
          ...
          BOOL, STRING, DOUBLE or INT64 can enable monitoring.  If this is
          populated with [FeaturestoreMonitoringConfig.disabled][] = true,
        ...
        disable_monitoring (bool): Optional. If not set, use the
          ...
          EntityType.
        monitoring_stats
          (Sequence[google.cloud.aiplatform_v1beta1.types.FeatureStatsAnomaly]):
          Output only. A list of historical [Snapshot
          Analysis][FeaturestoreMonitoringConfig.SnapshotAnalysis] stats
        ...
        monitoring_stats_anomalies
          (Sequence[google.cloud.aiplatform_v1beta1.types.Feature.MonitoringStatsAnomaly]):
