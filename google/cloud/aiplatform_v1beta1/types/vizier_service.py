...
class CreateStudyRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        study (google.cloud.aiplatform_v1beta1.types.Study): Required. The Study
...
class ListStudiesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        page_token (str): Optional. A page token to request the next page of
          results. If unspecified, there are no subsequent pages.
        page_size (int): Optional. The maximum number of studies to return per
          "page" of results. If unspecified, service will pick an appropriate
          default.
  """
...
class ListStudiesResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        studies (Sequence[google.cloud.aiplatform_v1beta1.types.Study]): The
          studies associated with the project.
        next_page_token (str): Passes this token as the ``page_token`` field of
          the request for a subsequent call. If this field is omitted, there are
          no subsequent pages.
  """
...
class DeleteStudyRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        name (str): Required. The name of the Study resource to be deleted.
...
class LookupStudyRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the Location to get the
          Study from. Format: ``projects/{project}/locations/{location}``
        display_name (str): Required. The user-defined display name of the Study
  """
...
class SuggestTrialsRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The project and location that the Study belongs
          to. Format:
          ``projects/{project}/locations/{location}/studies/{study}``
        suggestion_count (int): Required. The number of suggestions requested.
        client_id (str): Required. The identifier of the client that is
          requesting the suggestion.  If multiple SuggestTrialsRequests have the
          same ``client_id``, the service will return the identical suggested
          Trial if the Trial is pending, and provide a new Trial if the last
...
class SuggestTrialsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        trials (Sequence[google.cloud.aiplatform_v1beta1.types.Trial]): A list
          of Trials.
        study_state (google.cloud.aiplatform_v1beta1.types.Study.State): The
          state of the Study.
        start_time (google.protobuf.timestamp_pb2.Timestamp): The time at which
          the operation was started.
        end_time (google.protobuf.timestamp_pb2.Timestamp): The time at which
...
class SuggestTrialsMetadata(proto.Message):
  r"""Details of operations that perform Trials suggestion.
    ...
    Attributes:
        ...
        client_id (str): The identifier of the client that is requesting the
          ...
          if the Trial is pending, and provide a new Trial if the last suggested
          Trial was completed.
  """
...
class CreateTrialRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the Study to create the
          Trial in. Format:
          ``projects/{project}/locations/{location}/studies/{study}``
        trial (google.cloud.aiplatform_v1beta1.types.Trial): Required. The Trial
          to create.
  """
...
class ListTrialsRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The resource name of the Study to list the Trial
          from. Format:
          ``projects/{project}/locations/{location}/studies/{study}``
        page_token (str): Optional. A page token to request the next page of
          results. If unspecified, there are no subsequent pages.
        page_size (int): Optional. The number of Trials to retrieve per "page"
          of results. If unspecified, the service will pick an appropriate
          default.
  """
...
class ListTrialsResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        trials (Sequence[google.cloud.aiplatform_v1beta1.types.Trial]): The
          Trials associated with the Study.
        next_page_token (str): Pass this token as the ``page_token`` field of
          the request for a subsequent call. If this field is omitted, there are
          no subsequent pages.
  """
...
class AddTrialMeasurementRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        trial_name (str): Required. The name of the trial to add measurement.
          Format:
          ``projects/{project}/locations/{location}/studies/{study}/trials/{trial}``
...
class CompleteTrialRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        trial_infeasible (bool): Optional. True if the Trial cannot be run with
          the given Parameter, and final_measurement will be ignored.
        infeasible_reason (str): Optional. A human readable reason why the trial
          was infeasible. This should only be provided if ``trial_infeasible``
          is true.
  """
...
class CheckTrialEarlyStoppingStateRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        trial_name (str): Required. The Trial's name. Format:
          ``projects/{project}/locations/{location}/studies/{study}/trials/{trial}``
  """
...
class CheckTrialEarlyStoppingStateResponse(proto.Message):
  r"""Response message for
    ...
    Attributes:
        should_stop (bool): True if the Trial should stop.
  """
  ...
  r"""This message will be placed in the metadata field of a
    ...
    Attributes:
        generic_metadata
          (google.cloud.aiplatform_v1beta1.types.GenericOperationMetadata):
          Operation metadata for suggesting Trials.
        study (str): The name of the Study that the Trial belongs to.
        trial (str): The Trial name.
  """
...
class ListOptimalTrialsRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        parent (str): Required. The name of the Study that the optimal Trial
          belongs to.
  """
