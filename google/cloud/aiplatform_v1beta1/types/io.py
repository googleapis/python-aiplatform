...
class AvroSource(proto.Message):
  r"""The storage details for Avro input content.
    ...
    Attributes:
        gcs_source (google.cloud.aiplatform_v1beta1.types.GcsSource): Required.
...
class GcsSource(proto.Message):
  r"""The Google Cloud Storage location for the input content.
    ...
    Attributes:
        uris (Sequence[str]): Required. Google Cloud Storage URI(-s) to the
          input file(s). May contain wildcards. For more information on
          wildcards, see
...
class GcsDestination(proto.Message):
  r"""The Google Cloud Storage location where the output is to be
    ...
    Attributes:
        output_uri_prefix (str): Required. Google Cloud Storage URI to output
...
class BigQuerySource(proto.Message):
  r"""The BigQuery location for the input content.
    ...
    Attributes:
        input_uri (str): Required. BigQuery URI to a table, up to 2000
          characters long. Accepted forms:  -  BigQuery path. For example:
...
class BigQueryDestination(proto.Message):
  r"""The BigQuery location for the output content.
    ...
    Attributes:
        output_uri (str): Required. BigQuery URI to a project or table, up to
          2000 characters long.  When only the project is specified, the Dataset
          and Table is created. When the full table reference is specified, the
...
class ContainerRegistryDestination(proto.Message):
  r"""The Container Registry location for the container image.
    ...
    Attributes:
        output_uri (str): Required. Container Registry URI of a container image.
