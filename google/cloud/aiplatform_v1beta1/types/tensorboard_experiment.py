...
class TensorboardExperiment(proto.Message):
  r"""A TensorboardExperiment is a group of TensorboardRuns, that
    ...
    Attributes:
        name (str): Output only. Name of the TensorboardExperiment. Format:
          ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}``
        display_name (str): User provided name of this TensorboardExperiment.
        description (str): Description of this TensorboardExperiment.
        ...
        labels (Mapping[str, str]): The labels with user-defined metadata to
          ...
          its value is the [metadata_schema's][metadata_schema_uri] title.
        etag (str): Used to perform consistent read-modify-write updates. If not
          set, a blind "overwrite" update happens.
        source (str): Immutable. Source of the TensorboardExperiment. Example: a
          custom training job.
  """
