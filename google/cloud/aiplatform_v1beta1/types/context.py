...
class Context(proto.Message):
  r"""Instance of a general context.
    ...
    Attributes:
        name (str): Output only. The resource name of the Context.
        display_name (str): User provided display name of the Context. May be up
        ...
        labels (Mapping[str, str]): The labels with user-defined metadata to
          organize your Contexts. Label keys and values can be no longer than 64
        ...
        parent_contexts (Sequence[str]): Output only. A list of resource names
          of Contexts that are parents of this Context. A Context may have at
          most 10 parent_contexts.
        ...
        schema_version (str): The version of the schema in schema_name to use.
          ...
          Create Schema calls. And both are used together as unique identifiers
          to identify schemas within the local metadata store.
        metadata (google.protobuf.struct_pb2.Struct): Properties of the Context.
