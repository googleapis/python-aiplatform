...
class ReadFeatureValuesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        feature_selector
          (google.cloud.aiplatform_v1beta1.types.FeatureSelector): Required.
    ...
    r"""Response header with metadata for the requested
        ...
        Attributes:
            entity_type (str): The resource name of the EntityType from the
              ...
              ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entityType}``.
            feature_descriptors
              (Sequence[google.cloud.aiplatform_v1beta1.types.ReadFeatureValuesResponse.FeatureDescriptor]):
  ...
  class EntityView(proto.Message):
    r"""Entity view with Feature values.
        ...
        Attributes:
            ...
            data
              (Sequence[google.cloud.aiplatform_v1beta1.types.ReadFeatureValuesResponse.EntityView.Data]):
      ...
      r"""Container to hold value(s), successive in time, for one
            ...
            Attributes:
                value (google.cloud.aiplatform_v1beta1.types.FeatureValue):
                  Feature value if a single value is requested.  This field is a
...
class StreamingReadFeatureValuesRequest(proto.Message):
  r"""Request message for
    ...
    Attributes:
        ...
        feature_selector
          (google.cloud.aiplatform_v1beta1.types.FeatureSelector): Required.
          Selector choosing Features of the target EntityType. Feature IDs will
          be deduplicated.
  """
  ...
  r"""Value for a feature.
    ...
    Attributes:
        ...
        string_value (str): String feature value.  This field is a member of
          `oneof`_ ``value``.
        bool_array_value (google.cloud.aiplatform_v1beta1.types.BoolArray): A
          list of bool type feature value.  This field is a member of `oneof`_
          ``value``.
        double_array_value (google.cloud.aiplatform_v1beta1.types.DoubleArray):
          A list of double type feature value.  This field is a member of
          `oneof`_ ``value``.
        int64_array_value (google.cloud.aiplatform_v1beta1.types.Int64Array): A
          list of int64 type feature value.  This field is a member of `oneof`_
          ``value``.
        string_array_value (google.cloud.aiplatform_v1beta1.types.StringArray):
          A list of string type feature value.  This field is a member of
          `oneof`_ ``value``.
...
class FeatureValueList(proto.Message):
  r"""Container for list of values.
    ...
    Attributes:
        values (Sequence[google.cloud.aiplatform_v1beta1.types.FeatureValue]): A
          list of feature values. All of them should be the same data type.
  """
