...
class MetadataSchema(proto.Message):
  r"""Instance of a general MetadataSchema.
    ...
    Attributes:
        name (str): Output only. The resource name of the MetadataSchema.
        schema_version (str): The version of the MetadataSchema. The version's
          format must match the following regular expression:
          ``^[0-9]+[.][0-9]+[.][0-9]+$``, which would allow to order/compare
          different versions. Example: 1.0.0, 1.0.1, etc.
        schema (str): Required. The raw YAML string representation of the
          ...
          <https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.2.md#schemaObject>`__
        schema_type
        ...
        description (str): Description of the Metadata Schema
  """
