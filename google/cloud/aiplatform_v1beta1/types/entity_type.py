...
class EntityType(proto.Message):
  r"""An entity type is a type of object in a system that needs to
    ...
    Attributes:
        name (str): Immutable. Name of the EntityType. Format:
        ...
        labels (Mapping[str, str]): Optional. The labels with user-defined
          metadata to organize your EntityTypes. Label keys and values can be no
          ...
          labels can be associated with one EntityType (System labels are
          excluded)." System reserved label keys are prefixed with
          "aiplatform.googleapis.com/" and are immutable.
        etag (str): Optional. Used to perform a consistent read-modify-write
        ...
        monitoring_config
          ...
          BOOL, STRING, DOUBLE or INT64 under this EntityType.  If this is
          populated with [FeaturestoreMonitoringConfig.monitoring_interval]
