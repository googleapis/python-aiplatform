...
class Index(proto.Message):
  r"""A representation of a collection of database items organized
    ...
    Attributes:
        ...
        deployed_indexes
          (Sequence[google.cloud.aiplatform_v1beta1.types.DeployedIndexRef]):
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp): Output only.
          ...
          a little after the value of this timestamp, yet that does not mean
          their results are not already reflected in the Index. Result of any
