...
class FeaturestoreMonitoringConfig(proto.Message):
  r"""Configuration of how features in Featurestore are monitored.
    ...
    Attributes:
        ...
        numerical_threshold_config
          ...
          Threshold for numerical features of anomaly detection. This is shared
          by all objectives of Featurestore Monitoring for numerical features
          (i.e. Features with type
  ...
  class SnapshotAnalysis(proto.Message):
    r"""Configuration of the Featurestore's Snapshot Analysis Based
        ...
        Attributes:
            disabled (bool): The monitoring schedule for snapshot analysis. For
              EntityType-level config: unset / disabled = true indicates
              disabled by default for Features under it; otherwise by default
              enable snapshot analysis monitoring with monitoring_interval for
              Features under it. Feature-level
                config: disabled = true indicates disabled regardless of the
                  ...
                  EntityType-level config. Explicitly Disable the snapshot
            ...
            monitoring_interval_days (int): Configuration of the snapshot
              analysis based monitoring pipeline running interval. The value
              indicates number of days. If both
              ...
              [FeaturestoreMonitoringConfig.SnapshotAnalysis.monitoring_interval_days][google.cloud.aiplatform.v1beta1.FeaturestoreMonitoringConfig.SnapshotAnalysis.monitoring_interval_days]
              will be used.
            staleness_days (int): Customized export features time window for
              snapshot analysis. Unit is one day. Default value is 3 weeks.
  ...
  class ThresholdConfig(proto.Message):
    r"""The config for Featurestore Monitoring threshold.
        ...
        Attributes:
            value (float): Specify a threshold value that can trigger the alert.
              1. For categorical feature, the distribution distance is
              ...
              Each feature must have a non-zero threshold if they need to be
