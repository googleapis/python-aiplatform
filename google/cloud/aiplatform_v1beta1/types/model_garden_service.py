...
class GetPublisherModelRequest(proto.Message):
  ...
  Attributes:
      name (str): Required. The name of the PublisherModel resource. Format:
        ``publishers/{publisher}/models/{publisher_model}``
      language_code (str): Optional. The IETF BCP-47 language code representing
        the language in which the publisher model's text information should be
        written in.
      view (google.cloud.aiplatform_v1beta1.types.PublisherModelView): Optional.
        PublisherModel view specifying which fields to read.
      is_hugging_face_model (bool): Optional. Boolean indicates whether the
        requested model is a Hugging Face model.
      hugging_face_token (str): Optional. Token used to access Hugging Face
        gated models.
  """
...
class ListPublisherModelsRequest(proto.Message):
  ...
  Attributes:
      parent (str): Required. The name of the Publisher from which to list the
        PublisherModels. Format: ``publishers/{publisher}``
      filter (str): Optional. The standard list filter.
      ...
      language_code (str): Optional. The IETF BCP-47 language code representing
        the language in which the publisher models' text information should be
        written in. If not set, by default English (en).
      list_all_versions (bool): Optional. List all publisher model versions if
...
class ListPublisherModelsResponse(proto.Message):
  ...
  Attributes: publisher_models
  (MutableSequence[google.cloud.aiplatform_v1beta1.types.PublisherModel]): List
  of PublisherModels in the requested page.
...
class DeployPublisherModelRequest(proto.Message):
  ...
  Attributes:
      model (str): Required. The name of the PublisherModel resource. Format:
        ``publishers/{publisher}/models/{publisher_model}@{version_id}``, or
        ``publishers/hf-{hugging-face-author}/models/{hugging-face-model-name}@001``
      destination (str): Required. The resource name of the Location to deploy
        the model in. Format: ``projects/{project}/locations/{location}``
      endpoint_display_name (str): Optional. The user-specified display name of
        the endpoint. If not set, a default name will be used.
        dedicated_resources
        (google.cloud.aiplatform_v1beta1.types.DedicatedResources): Optional.
        The dedicated resources to use for the endpoint. If not set, the default
        resources will be used.
      model_display_name (str): Optional. The user-specified display name of the
        uploaded model. If not set, a default name will be used.
      hugging_face_access_token (str): Optional. The Hugging Face read access
        token used to access the model artifacts of gated models.
      accept_eula (bool): Optional. Whether the user accepts the End User
        License Agreement (EULA) for the model.
  """
...
class DeployPublisherModelResponse(proto.Message):
  ...
  Attributes:
      publisher_model (str): Output only. The name of the PublisherModel
        resource.
          Format:
            ``publishers/{publisher}/models/{publisher_model}@{version_id}``, or
            ``publishers/hf-{hugging-face-author}/models/{hugging-face-model-name}@001``
      endpoint (str): Output only. The name of the Endpoint created. Format:
        ``projects/{project}/locations/{location}/endpoints/{endpoint}``
      model (str): Output only. The name of the Model created. Format:
...
class DeployPublisherModelOperationMetadata(proto.Message):
  ...
  operation generic information.
      ...
      resource.
          ...
          ``publishers/{publisher}/models/{publisher_model}@{version_id}``, or
          ``publishers/hf-{hugging-face-author}/models/{hugging-face-model-name}@001``
      destination (str): Output only. The resource name of the Location to
      deploy the model in. Format: ``projects/{project}/locations/{location}``
      project_number (int): Output only. The project number where the deploy
