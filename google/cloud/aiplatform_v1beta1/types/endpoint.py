...
class Endpoint(proto.Message):
  r"""Models are deployed into it, and afterwards Endpoint is
    ...
    Attributes:
        ...
        deployed_models
          (Sequence[google.cloud.aiplatform_v1beta1.types.DeployedModel]):
...
class DeployedModel(proto.Message):
  ...
  Endpoints contain one or more
    ...
    Attributes:
        dedicated_resources
          (google.cloud.aiplatform_v1beta1.types.DedicatedResources): A
          description of resources that are dedicated to the DeployedModel, and
          that need a higher degree of manual configuration.  This field is a
          member of `oneof`_ ``prediction_resources``.
        automatic_resources
          (google.cloud.aiplatform_v1beta1.types.AutomaticResources): A
          description of resources that to large degree are decided by Vertex
          AI, and require only a modest additional configuration.  This field is
          a member of `oneof`_ ``prediction_resources``.
        ...
        explanation_spec
          (google.cloud.aiplatform_v1beta1.types.ExplanationSpec): Explanation
          configuration for this DeployedModel.  When deploying a Model using
          [EndpointService.DeployModel][google.cloud.aiplatform.v1beta1.EndpointService.DeployModel],
        ...
        enable_container_logging (bool): If true, the container of the
          DeployedModel instances will send ``stderr`` and ``stdout`` streams to
          Stackdriver Logging.  Only supported for custom-trained Models and
        ...
        enable_access_logging (bool): These logs are like standard server access
          ...
          this option.
        private_endpoints
          (google.cloud.aiplatform_v1beta1.types.PrivateEndpoints): Output only.
          Provide paths for users to send predict/explain/health requests
          directly to the deployed model services running on Cloud via private
          services access. This field is populated if
          [network][google.cloud.aiplatform.v1beta1.Endpoint.network] is
          configured.
  """
  ...
  r"""Configuration for logging request-response to a BigQuery
    ...
    Attributes:
        ...
        bigquery_destination
          (google.cloud.aiplatform_v1beta1.types.BigQueryDestination): BigQuery
          table for logging. If only given a project, a new dataset will be
          created with name ``logging_<endpoint-display-name>_<endpoint-id>``
