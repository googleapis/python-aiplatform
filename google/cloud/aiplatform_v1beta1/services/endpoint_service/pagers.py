...
class ListEndpointsPager:
  """A pager for iterating through ``list_endpoints`` requests.
    ...
    :class:`google.cloud.aiplatform_v1beta1.types.ListEndpointsResponse` object,
    and
    ...
    All the usual
    :class:`google.cloud.aiplatform_v1beta1.types.ListEndpointsResponse`
  ...
  def __init__(self,
    ...
    """Instantiate the pager.
        ...
        Args:
            ...
            request
              (google.cloud.aiplatform_v1beta1.types.ListEndpointsRequest): The
              initial request object.
            response
              (google.cloud.aiplatform_v1beta1.types.ListEndpointsResponse): The
...
class ListEndpointsAsyncPager:
  ...
  @property
  async def pages(
      self) -> AsyncIterator[endpoint_service.ListEndpointsResponse]:
    yield self._response
    while self._response.next_page_token:
      self._request.page_token = self._response.next_page_token
