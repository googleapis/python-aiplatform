...
class MetadataServiceClient(metaclass=MetadataServiceClientMeta):
  ...
  def create_metadata_store(
    ...
    r"""Initializes a MetadataStore, including allocation of
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CreateMetadataStoreRequest,
            ...
            metadata_store
              (google.cloud.aiplatform_v1beta1.types.MetadataStore): Required.
              The MetadataStore to create.  This corresponds to the
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.aiplatform_v1beta1.types.MetadataStore`
                Instance of a metadata store. Contains a set of metadata that
                can be
                   queried.
  ...
  def get_metadata_store(
    ...
    r"""Retrieves a specific MetadataStore.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetMetadataStoreRequest,
              dict]): The request object. Request message for
  ...
  def list_metadata_stores(
    ...
    r"""Lists MetadataStores for a Location.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListMetadataStoresRequest,
              dict]): The request object. Request message for
  ...
  def delete_metadata_store(
    ...
    r"""Deletes a single MetadataStore and all its child
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeleteMetadataStoreRequest,
              dict]): The request object. Request message for
  ...
  def create_artifact(
    ...
    r"""Creates an Artifact associated with a MetadataStore.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CreateArtifactRequest,
              dict]): The request object. Request message for
            ...
            parent (str): Required. The resource name of the MetadataStore where
              ...
              instance; if ``request`` is provided, this should not be set.
            artifact (google.cloud.aiplatform_v1beta1.types.Artifact): Required.
              The Artifact to create. This corresponds to the ``artifact`` field
  ...
  def get_artifact(
    ...
    r"""Retrieves a specific Artifact.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetArtifactRequest,
              dict]): The request object. Request message for
  ...
  def list_artifacts(
    ...
    r"""Lists Artifacts in the MetadataStore.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListArtifactsRequest,
              dict]): The request object. Request message for
  ...
  def update_artifact(
    ...
    r"""Updates a stored Artifact.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.UpdateArtifactRequest,
              dict]): The request object. Request message for
              [MetadataService.UpdateArtifact][google.cloud.aiplatform.v1beta1.MetadataService.UpdateArtifact].
            artifact (google.cloud.aiplatform_v1beta1.types.Artifact): Required.
              The Artifact containing updates. The Artifact's
  ...
  def delete_artifact(
    ...
    r"""Deletes an Artifact.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeleteArtifactRequest,
              dict]): The request object. Request message for
  ...
  def purge_artifacts(
    ...
    r"""Purges Artifacts.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.PurgeArtifactsRequest,
              dict]): The request object. Request message for
  ...
  def create_context(
    ...
    r"""Creates a Context associated with a MetadataStore.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CreateContextRequest,
              dict]): The request object. Request message for
            ...
            parent (str): Required. The resource name of the MetadataStore where
              ...
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            context (google.cloud.aiplatform_v1beta1.types.Context): Required.
              The Context to create. This corresponds to the ``context`` field
              on the ``request`` instance; if ``request`` is provided, this
              should not be set.
  ...
  def get_context(
    ...
    r"""Retrieves a specific Context.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetContextRequest,
              dict]): The request object. Request message for
  ...
  def list_contexts(
    ...
    r"""Lists Contexts on the MetadataStore.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListContextsRequest,
              dict]): The request object. Request message for
  ...
  def delete_context(
    ...
    r"""Deletes a stored Context.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeleteContextRequest,
              dict]): The request object. Request message for
  ...
  def purge_contexts(
    ...
    r"""Purges Contexts.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.PurgeContextsRequest,
              dict]): The request object. Request message for
    ...
    r"""Adds a set of Artifacts and Executions to a Context.
        ...
        .. code-block:: python
            ...
            def sample_add_context_artifacts_and_executions():
                ...
                # Initialize request argument(s)
                request =
                aiplatform_v1beta1.AddContextArtifactsAndExecutionsRequest(
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.AddContextArtifactsAndExecutionsRequest,
              dict]): The request object. Request message for
  ...
  def query_context_lineage_subgraph(
    ...
    r"""Retrieves Artifacts and Executions within the
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.QueryContextLineageSubgraphRequest,
              dict]): The request object. Request message for
  ...
  def create_execution(
    ...
    r"""Creates an Execution associated with a MetadataStore.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CreateExecutionRequest,
              dict]): The request object. Request message for
            ...
            execution (google.cloud.aiplatform_v1beta1.types.Execution):
              ...
              ``execution`` field on the ``request`` instance; if ``request`` is
  ...
  def get_execution(
    ...
    r"""Retrieves a specific Execution.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetExecutionRequest,
              dict]): The request object. Request message for
  ...
  def list_executions(
    ...
    r"""Lists Executions in the MetadataStore.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListExecutionsRequest,
              dict]): The request object. Request message for
  ...
  def update_execution(
    ...
    r"""Updates a stored Execution.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.UpdateExecutionRequest,
              dict]): The request object. Request message for
  ...
  def delete_execution(
    ...
    r"""Deletes an Execution.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeleteExecutionRequest,
              dict]): The request object. Request message for
  ...
  def purge_executions(
    ...
    r"""Purges Executions.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.PurgeExecutionsRequest,
              dict]): The request object. Request message for
  ...
  def add_execution_events(
    ...
    An Event
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.AddExecutionEventsRequest,
              dict]): The request object. Request message for
            ...
            execution (str): Required. The resource name of the Execution that
              ...
              This corresponds to the ``execution`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            events (Sequence[google.cloud.aiplatform_v1beta1.types.Event]): The
    ...
    r"""Obtains the set of input and output Artifacts for
        ...
        .. code-block:: python
            ...
            def sample_query_execution_inputs_and_outputs():
                ...
                # Initialize request argument(s)
                request =
                aiplatform_v1beta1.QueryExecutionInputsAndOutputsRequest(
                    execution="execution_value",
                )
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.QueryExecutionInputsAndOutputsRequest,
              dict]): The request object. Request message for
  ...
  def create_metadata_schema(
    ...
    r"""Creates a MetadataSchema.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CreateMetadataSchemaRequest,
              dict]): The request object. Request message for
            ...
            parent (str): Required. The resource name of the MetadataStore where
              ...
              instance; if ``request`` is provided, this should not be set.
            metadata_schema
              (google.cloud.aiplatform_v1beta1.types.MetadataSchema): Required.
              The MetadataSchema to create.  This corresponds to the
  ...
  def get_metadata_schema(
    ...
    r"""Retrieves a specific MetadataSchema.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetMetadataSchemaRequest,
              dict]): The request object. Request message for
  ...
  def list_metadata_schemas(
    ...
    r"""Lists MetadataSchemas.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListMetadataSchemasRequest,
              dict]): The request object. Request message for
    ...
    r"""Retrieves lineage of an Artifact represented through
        ...
        .. code-block:: python
            ...
            def sample_query_artifact_lineage_subgraph():
                ...
                # Initialize request argument(s)
                request =
                aiplatform_v1beta1.QueryArtifactLineageSubgraphRequest(
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.QueryArtifactLineageSubgraphRequest,
              dict]): The request object. Request message for
