        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_feature_monitor():
                ...
                # Make the request
                operation = await client.create_feature_monitor(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_feature_monitor():
                ...
                # Make the request
                operation = await client.update_feature_monitor(request=request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_feature_monitor():
                ...
                # Make the request
                operation = await client.delete_feature_monitor(request=request)
