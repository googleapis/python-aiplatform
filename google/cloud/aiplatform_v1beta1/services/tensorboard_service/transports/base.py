...
class TensorboardServiceTransport(abc.ABC):
  ...
  def create_tensorboard(
      self,
  ) -> Callable[[tensorboard_service.CreateTensorboardRequest], Union[
  ...
  def get_tensorboard(
      self,
  ) -> Callable[[tensorboard_service.GetTensorboardRequest], Union[
      tensorboard.Tensorboard, Awaitable[tensorboard.Tensorboard]],]:
    raise NotImplementedError()

  @property
  def update_tensorboard(
      self,
  ) -> Callable[[tensorboard_service.UpdateTensorboardRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def list_tensorboards(
      self,
  ) -> Callable[[tensorboard_service.ListTensorboardsRequest], Union[
  ...
  def delete_tensorboard(
      self,
  ) -> Callable[[tensorboard_service.DeleteTensorboardRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def create_tensorboard_experiment(
      self,
  ) -> Callable[[tensorboard_service.CreateTensorboardExperimentRequest], Union[
  ...
  def get_tensorboard_experiment(
      self,
  ) -> Callable[[tensorboard_service.GetTensorboardExperimentRequest], Union[
  ...
  def update_tensorboard_experiment(
      self,
  ) -> Callable[[tensorboard_service.UpdateTensorboardExperimentRequest], Union[
      gca_tensorboard_experiment.TensorboardExperiment,
      Awaitable[gca_tensorboard_experiment.TensorboardExperiment],],]:
    raise NotImplementedError()
  ...
  def list_tensorboard_experiments(
      self,
  ) -> Callable[[tensorboard_service.ListTensorboardExperimentsRequest], Union[
  ...
  def delete_tensorboard_experiment(
      self,
  ) -> Callable[[tensorboard_service.DeleteTensorboardExperimentRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def create_tensorboard_run(
      self,
                ...
                Union[gca_tensorboard_run.TensorboardRun,
  ...
  def batch_create_tensorboard_runs(
      self,
  ) -> Callable[[tensorboard_service.BatchCreateTensorboardRunsRequest], Union[
  ...
  def get_tensorboard_run(
      self,
                ...
                Union[tensorboard_run.TensorboardRun,
  ...
  def list_tensorboard_runs(
      self,
  ) -> Callable[[tensorboard_service.ListTensorboardRunsRequest], Union[
  ...
  def delete_tensorboard_run(
      self,
  ) -> Callable[[tensorboard_service.DeleteTensorboardRunRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def batch_create_tensorboard_time_series(
      ...
      [tensorboard_service.BatchCreateTensorboardTimeSeriesRequest], Union[
  ...
  def create_tensorboard_time_series(
      self,
  ) -> Callable[[tensorboard_service.CreateTensorboardTimeSeriesRequest], Union[
  ...
  def get_tensorboard_time_series(
      self,
  ) -> Callable[[tensorboard_service.GetTensorboardTimeSeriesRequest], Union[
  ...
  def update_tensorboard_time_series(
      self,
  ) -> Callable[[tensorboard_service.UpdateTensorboardTimeSeriesRequest], Union[
      gca_tensorboard_time_series.TensorboardTimeSeries,
      Awaitable[gca_tensorboard_time_series.TensorboardTimeSeries],],]:
    raise NotImplementedError()
  ...
  def list_tensorboard_time_series(
      self,
  ) -> Callable[[tensorboard_service.ListTensorboardTimeSeriesRequest], Union[
  ...
  def delete_tensorboard_time_series(
      self,
  ) -> Callable[[tensorboard_service.DeleteTensorboardTimeSeriesRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def batch_read_tensorboard_time_series_data(
      ...
      [tensorboard_service.BatchReadTensorboardTimeSeriesDataRequest], Union[
  ...
  def read_tensorboard_time_series_data(
      self,
  ) -> Callable[[tensorboard_service.ReadTensorboardTimeSeriesDataRequest],
                Union[tensorboard_service.ReadTensorboardTimeSeriesDataResponse,
                      Awaitable[tensorboard_service
  ...
  def read_tensorboard_blob_data(
      self,
  ) -> Callable[[tensorboard_service.ReadTensorboardBlobDataRequest], Union[
  ...
  def write_tensorboard_experiment_data(
      self,
  ) -> Callable[[tensorboard_service.WriteTensorboardExperimentDataRequest],
                Union[
  ...
  def write_tensorboard_run_data(
      self,
  ) -> Callable[[tensorboard_service.WriteTensorboardRunDataRequest], Union[
  ...
  def export_tensorboard_time_series_data(
      self,
  ) -> Callable[[tensorboard_service.ExportTensorboardTimeSeriesDataRequest],
                Union[
