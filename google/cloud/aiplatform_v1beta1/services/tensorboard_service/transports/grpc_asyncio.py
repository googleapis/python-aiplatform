...
class TensorboardServiceGrpcAsyncIOTransport(TensorboardServiceTransport):
  ...
  def __init__(
    ...
    self._operations_client: Optional[
        operations_v1.OperationsAsyncClient] = None
  ...
  def create_tensorboard(
      self,
  ) -> Callable[[tensorboard_service.CreateTensorboardRequest],
    ...
    if "create_tensorboard" not in self._stubs:
      self._stubs["create_tensorboard"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service.CreateTensorboardRequest
          .serialize,
  ...
  def get_tensorboard(
      self,
  ) -> Callable[[tensorboard_service.GetTensorboardRequest],
    ...
    if "get_tensorboard" not in self._stubs:
      self._stubs["get_tensorboard"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service.GetTensorboardRequest
          .serialize,
  ...
  def update_tensorboard(
      self,
  ) -> Callable[[tensorboard_service.UpdateTensorboardRequest],
                Awaitable[operations_pb2.Operation],]:
    ...
    if "update_tensorboard" not in self._stubs:
      self._stubs["update_tensorboard"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service.UpdateTensorboardRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def list_tensorboards(
      self,
  ) -> Callable[[tensorboard_service.ListTensorboardsRequest],
    ...
    if "list_tensorboards" not in self._stubs:
      self._stubs["list_tensorboards"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service.ListTensorboardsRequest
          .serialize,
          response_deserializer=tensorboard_service.ListTensorboardsResponse
          .deserialize,
      )
  ...
  def delete_tensorboard(
      self,
  ) -> Callable[[tensorboard_service.DeleteTensorboardRequest],
                Awaitable[operations_pb2.Operation],]:
    ...
    if "delete_tensorboard" not in self._stubs:
      self._stubs["delete_tensorboard"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service.DeleteTensorboardRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def create_tensorboard_experiment(
      self,
  ) -> Callable[[tensorboard_service.CreateTensorboardExperimentRequest],
    ...
    if "create_tensorboard_experiment" not in self._stubs:
      self._stubs["create_tensorboard_experiment"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service
          .CreateTensorboardExperimentRequest.serialize,
          response_deserializer=gca_tensorboard_experiment.TensorboardExperiment
          .deserialize,
      )
  ...
  def get_tensorboard_experiment(
      self,
  ) -> Callable[[tensorboard_service.GetTensorboardExperimentRequest],
    ...
    if "get_tensorboard_experiment" not in self._stubs:
      self._stubs["get_tensorboard_experiment"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service.GetTensorboardExperimentRequest
          .serialize,
          response_deserializer=tensorboard_experiment.TensorboardExperiment
          .deserialize,
      )
  ...
  def update_tensorboard_experiment(
      self,
  ) -> Callable[[tensorboard_service.UpdateTensorboardExperimentRequest],
                Awaitable[gca_tensorboard_experiment.TensorboardExperiment],]:
    ...
    if "update_tensorboard_experiment" not in self._stubs:
      self._stubs["update_tensorboard_experiment"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service
          .UpdateTensorboardExperimentRequest.serialize,
          response_deserializer=gca_tensorboard_experiment.TensorboardExperiment
          .deserialize,
      )
  ...
  def list_tensorboard_experiments(
    ...
    if "list_tensorboard_experiments" not in self._stubs:
      self._stubs["list_tensorboard_experiments"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service
          .ListTensorboardExperimentsRequest.serialize,
          response_deserializer=tensorboard_service
          .ListTensorboardExperimentsResponse.deserialize,
      )
  ...
  def delete_tensorboard_experiment(
      self,
  ) -> Callable[[tensorboard_service.DeleteTensorboardExperimentRequest],
                Awaitable[operations_pb2.Operation],]:
    ...
    if "delete_tensorboard_experiment" not in self._stubs:
      self._stubs["delete_tensorboard_experiment"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service
          .DeleteTensorboardExperimentRequest.serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def create_tensorboard_run(
      self,
  ) -> Callable[[tensorboard_service.CreateTensorboardRunRequest],
    ...
    if "create_tensorboard_run" not in self._stubs:
      self._stubs["create_tensorboard_run"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service.CreateTensorboardRunRequest
          .serialize,
  ...
  def batch_create_tensorboard_runs(
    ...
    if "batch_create_tensorboard_runs" not in self._stubs:
      self._stubs["batch_create_tensorboard_runs"] = self.grpc_channel.unary_unary(
          "/google.cloud.aiplatform.v1beta1.TensorboardService/BatchCreateTensorboardRuns",
          request_serializer=tensorboard_service
          .BatchCreateTensorboardRunsRequest.serialize,
          response_deserializer=tensorboard_service
          .BatchCreateTensorboardRunsResponse.deserialize,
      )
  ...
  def get_tensorboard_run(
      self,
  ) -> Callable[[tensorboard_service.GetTensorboardRunRequest],
    ...
    if "get_tensorboard_run" not in self._stubs:
      self._stubs["get_tensorboard_run"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service.GetTensorboardRunRequest
          .serialize,
  ...
  def update_tensorboard_run(
      self,
  ) -> Callable[[tensorboard_service.UpdateTensorboardRunRequest],
                Awaitable[gca_tensorboard_run.TensorboardRun],]:
    ...
    if "update_tensorboard_run" not in self._stubs:
      self._stubs["update_tensorboard_run"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service.UpdateTensorboardRunRequest
          .serialize,
          response_deserializer=gca_tensorboard_run.TensorboardRun.deserialize,
      )
  ...
  def list_tensorboard_runs(
      self,
  ) -> Callable[[tensorboard_service.ListTensorboardRunsRequest],
    ...
    if "list_tensorboard_runs" not in self._stubs:
      self._stubs["list_tensorboard_runs"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service.ListTensorboardRunsRequest
          .serialize,
          response_deserializer=tensorboard_service.ListTensorboardRunsResponse
          .deserialize,
      )
  ...
  def delete_tensorboard_run(
      self,
  ) -> Callable[[tensorboard_service.DeleteTensorboardRunRequest],
                Awaitable[operations_pb2.Operation],]:
    ...
    if "delete_tensorboard_run" not in self._stubs:
      self._stubs["delete_tensorboard_run"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service.DeleteTensorboardRunRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def batch_create_tensorboard_time_series(
    ...
    if "batch_create_tensorboard_time_series" not in self._stubs:
      self._stubs[
          "batch_create_tensorboard_time_series"] = self.grpc_channel.unary_unary(
              "/google.cloud.aiplatform.v1beta1.TensorboardService/BatchCreateTensorboardTimeSeries",
              request_serializer=tensorboard_service
              .BatchCreateTensorboardTimeSeriesRequest.serialize,
              response_deserializer=tensorboard_service
              .BatchCreateTensorboardTimeSeriesResponse.deserialize,
          )
  ...
  def create_tensorboard_time_series(
      self,
  ) -> Callable[[tensorboard_service.CreateTensorboardTimeSeriesRequest],
    ...
    if "create_tensorboard_time_series" not in self._stubs:
      self._stubs["create_tensorboard_time_series"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service
          .CreateTensorboardTimeSeriesRequest.serialize,
          response_deserializer=gca_tensorboard_time_series
          .TensorboardTimeSeries.deserialize,
      )
  ...
  def get_tensorboard_time_series(
      self,
  ) -> Callable[[tensorboard_service.GetTensorboardTimeSeriesRequest],
    ...
    if "get_tensorboard_time_series" not in self._stubs:
      self._stubs["get_tensorboard_time_series"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service.GetTensorboardTimeSeriesRequest
          .serialize,
          response_deserializer=tensorboard_time_series.TensorboardTimeSeries
          .deserialize,
      )
  ...
  def update_tensorboard_time_series(
      self,
  ) -> Callable[[tensorboard_service.UpdateTensorboardTimeSeriesRequest],
                Awaitable[gca_tensorboard_time_series.TensorboardTimeSeries],]:
    ...
    if "update_tensorboard_time_series" not in self._stubs:
      self._stubs["update_tensorboard_time_series"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service
          .UpdateTensorboardTimeSeriesRequest.serialize,
          response_deserializer=gca_tensorboard_time_series
          .TensorboardTimeSeries.deserialize,
      )
  ...
  def list_tensorboard_time_series(
    ...
    if "list_tensorboard_time_series" not in self._stubs:
      self._stubs["list_tensorboard_time_series"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service
          .ListTensorboardTimeSeriesRequest.serialize,
          response_deserializer=tensorboard_service
          .ListTensorboardTimeSeriesResponse.deserialize,
      )
  ...
  def delete_tensorboard_time_series(
      self,
  ) -> Callable[[tensorboard_service.DeleteTensorboardTimeSeriesRequest],
                Awaitable[operations_pb2.Operation],]:
    ...
    if "delete_tensorboard_time_series" not in self._stubs:
      self._stubs["delete_tensorboard_time_series"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service
          .DeleteTensorboardTimeSeriesRequest.serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def batch_read_tensorboard_time_series_data(
      self,
  ) -> Callable[[tensorboard_service.BatchReadTensorboardTimeSeriesDataRequest],
    ...
    if "batch_read_tensorboard_time_series_data" not in self._stubs:
      self._stubs[
          "batch_read_tensorboard_time_series_data"] = self.grpc_channel.unary_unary(
              "/google.cloud.aiplatform.v1beta1.TensorboardService/BatchReadTensorboardTimeSeriesData",
              request_serializer=tensorboard_service
              .BatchReadTensorboardTimeSeriesDataRequest.serialize,
              response_deserializer=tensorboard_service
              .BatchReadTensorboardTimeSeriesDataResponse.deserialize,
          )
  ...
  def read_tensorboard_time_series_data(
    ...
    if "read_tensorboard_time_series_data" not in self._stubs:
      self._stubs[
          "read_tensorboard_time_series_data"] = self.grpc_channel.unary_unary(
              "/google.cloud.aiplatform.v1beta1.TensorboardService/ReadTensorboardTimeSeriesData",
              request_serializer=tensorboard_service
              .ReadTensorboardTimeSeriesDataRequest.serialize,
              response_deserializer=tensorboard_service
              .ReadTensorboardTimeSeriesDataResponse.deserialize,
          )
  ...
  def read_tensorboard_blob_data(
    ...
    if "read_tensorboard_blob_data" not in self._stubs:
      self._stubs["read_tensorboard_blob_data"] = self.grpc_channel.unary_stream(
          ...
          request_serializer=tensorboard_service.ReadTensorboardBlobDataRequest
          .serialize,
          response_deserializer=tensorboard_service
          .ReadTensorboardBlobDataResponse.deserialize,
      )
  ...
  def write_tensorboard_experiment_data(
    ...
    if "write_tensorboard_experiment_data" not in self._stubs:
      self._stubs[
          "write_tensorboard_experiment_data"] = self.grpc_channel.unary_unary(
              "/google.cloud.aiplatform.v1beta1.TensorboardService/WriteTensorboardExperimentData",
              request_serializer=tensorboard_service
              .WriteTensorboardExperimentDataRequest.serialize,
              response_deserializer=tensorboard_service
              .WriteTensorboardExperimentDataResponse.deserialize,
          )
  ...
  def write_tensorboard_run_data(
    ...
    if "write_tensorboard_run_data" not in self._stubs:
      self._stubs["write_tensorboard_run_data"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=tensorboard_service.WriteTensorboardRunDataRequest
          .serialize,
          response_deserializer=tensorboard_service
          .WriteTensorboardRunDataResponse.deserialize,
      )
  ...
  def export_tensorboard_time_series_data(
    ...
    if "export_tensorboard_time_series_data" not in self._stubs:
      self._stubs[
          "export_tensorboard_time_series_data"] = self.grpc_channel.unary_unary(
              "/google.cloud.aiplatform.v1beta1.TensorboardService/ExportTensorboardTimeSeriesData",
              request_serializer=tensorboard_service
              .ExportTensorboardTimeSeriesDataRequest.serialize,
              response_deserializer=tensorboard_service
              .ExportTensorboardTimeSeriesDataResponse.deserialize,
          )
