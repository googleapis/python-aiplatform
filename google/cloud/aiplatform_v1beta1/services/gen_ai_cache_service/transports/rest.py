...
class GenAiCacheServiceRestTransport(GenAiCacheServiceTransport):
    ...
    class _CreateCachedContent(GenAiCacheServiceRestStub):
        def __hash__(self):
    ...
    class _DeleteCachedContent(GenAiCacheServiceRestStub):
        def __hash__(self):
    ...
    class _GetCachedContent(GenAiCacheServiceRestStub):
        def __hash__(self):
    ...
    class _ListCachedContents(GenAiCacheServiceRestStub):
        def __hash__(self):
    ...
    class _UpdateCachedContent(GenAiCacheServiceRestStub):
        def __hash__(self):
    ...
    class _GetLocation(GenAiCacheServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.GetLocationRequest,
            *,
    ...
    class _ListLocations(GenAiCacheServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.ListLocationsRequest,
            *,
    ...
    class _GetIamPolicy(GenAiCacheServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.GetIamPolicyRequest,
            *,
    ...
    class _SetIamPolicy(GenAiCacheServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.SetIamPolicyRequest,
            *,
    ...
    class _TestIamPermissions(GenAiCacheServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.TestIamPermissionsRequest,
            *,
    ...
    class _CancelOperation(GenAiCacheServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.CancelOperationRequest,
            *,
    ...
    class _DeleteOperation(GenAiCacheServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.DeleteOperationRequest,
            *,
    ...
    class _GetOperation(GenAiCacheServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,
    ...
    class _ListOperations(GenAiCacheServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.ListOperationsRequest,
            *,
    ...
    class _WaitOperation(GenAiCacheServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.WaitOperationRequest,
            *,
