...
class SpecialistPoolServiceClientMeta(type):
  ...
  _transport_registry = (
      OrderedDict())  # type: Dict[str, Type[SpecialistPoolServiceTransport]]
  _transport_registry["grpc"] = SpecialistPoolServiceGrpcTransport
  _transport_registry[
      "grpc_asyncio"] = SpecialistPoolServiceGrpcAsyncIOTransport
...
class SpecialistPoolServiceClient(metaclass=SpecialistPoolServiceClientMeta):
  ...
  def create_specialist_pool(
    ...
    r"""Creates a SpecialistPool.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CreateSpecialistPoolRequest,
            ...
            parent (str): Required. The parent Project name for the new
            ...
            specialist_pool
              (google.cloud.aiplatform_v1beta1.types.SpecialistPool): Required.
              The SpecialistPool to create.  This corresponds to the
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.aiplatform_v1beta1.types.SpecialistPool`
  ...
  def get_specialist_pool(
    ...
    r"""Gets a SpecialistPool.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetSpecialistPoolRequest,
              dict]): The request object. Request message for
              [SpecialistPoolService.GetSpecialistPool][google.cloud.aiplatform.v1beta1.SpecialistPoolService.GetSpecialistPool].
            name (str): Required. The name of the SpecialistPool resource. The
              form is
  ...
  def list_specialist_pools(
    ...
    r"""Lists SpecialistPools in a Location.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListSpecialistPoolsRequest,
              dict]): The request object. Request message for
              [SpecialistPoolService.ListSpecialistPools][google.cloud.aiplatform.v1beta1.SpecialistPoolService.ListSpecialistPools].
            parent (str): Required. The name of the SpecialistPool's parent
  ...
  def delete_specialist_pool(
    ...
    r"""Deletes a SpecialistPool as well as all Specialists
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeleteSpecialistPoolRequest,
              dict]): The request object. Request message for
              [SpecialistPoolService.DeleteSpecialistPool][google.cloud.aiplatform.v1beta1.SpecialistPoolService.DeleteSpecialistPool].
            name (str): Required. The resource name of the SpecialistPool to
              delete. Format:
              ``projects/{project}/locations/{location}/specialistPools/{specialist_pool}``
              This corresponds to the ``name`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
  ...
  def update_specialist_pool(
    ...
    r"""Updates a SpecialistPool.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.UpdateSpecialistPoolRequest,
              dict]): The request object. Request message for
              [SpecialistPoolService.UpdateSpecialistPool][google.cloud.aiplatform.v1beta1.SpecialistPoolService.UpdateSpecialistPool].
            specialist_pool
              (google.cloud.aiplatform_v1beta1.types.SpecialistPool): Required.
              The SpecialistPool which replaces the resource on the server.
              This corresponds to the ``specialist_pool`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set.
            update_mask (google.protobuf.field_mask_pb2.FieldMask): Required.
              The update mask applies to the resource.  This corresponds to the
