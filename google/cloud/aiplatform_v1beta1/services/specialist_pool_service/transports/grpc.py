...
class SpecialistPoolServiceGrpcTransport(SpecialistPoolServiceTransport):
  ...
  def create_specialist_pool(
      self,
  ) -> Callable[[specialist_pool_service.CreateSpecialistPoolRequest],
    ...
    if "create_specialist_pool" not in self._stubs:
      self._stubs["create_specialist_pool"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=specialist_pool_service.CreateSpecialistPoolRequest
          .serialize,
  ...
  def get_specialist_pool(
    ...
    if "get_specialist_pool" not in self._stubs:
      self._stubs["get_specialist_pool"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=specialist_pool_service.GetSpecialistPoolRequest
          .serialize,
  ...
  def list_specialist_pools(
      self,
  ) -> Callable[[specialist_pool_service.ListSpecialistPoolsRequest],
    ...
    if "list_specialist_pools" not in self._stubs:
      self._stubs["list_specialist_pools"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=specialist_pool_service.ListSpecialistPoolsRequest
          .serialize,
          response_deserializer=specialist_pool_service
          .ListSpecialistPoolsResponse.deserialize,
      )
  ...
  def delete_specialist_pool(
      self,
  ) -> Callable[[specialist_pool_service.DeleteSpecialistPoolRequest],
                operations_pb2.Operation]:
    ...
    if "delete_specialist_pool" not in self._stubs:
      self._stubs["delete_specialist_pool"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=specialist_pool_service.DeleteSpecialistPoolRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def update_specialist_pool(
      self,
  ) -> Callable[[specialist_pool_service.UpdateSpecialistPoolRequest],
                operations_pb2.Operation]:
    ...
    if "update_specialist_pool" not in self._stubs:
      self._stubs["update_specialist_pool"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=specialist_pool_service.UpdateSpecialistPoolRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
