...
class SpecialistPoolServiceTransport(abc.ABC):
  ...
  def create_specialist_pool(
      self,
  ) -> Callable[[specialist_pool_service.CreateSpecialistPoolRequest], Union[
  ...
  def get_specialist_pool(
      self,
  ) -> Callable[[specialist_pool_service.GetSpecialistPoolRequest],
                Union[specialist_pool.SpecialistPool,
  ...
  def list_specialist_pools(
      self,
  ) -> Callable[[specialist_pool_service.ListSpecialistPoolsRequest], Union[
  ...
  def delete_specialist_pool(
      self,
  ) -> Callable[[specialist_pool_service.DeleteSpecialistPoolRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def update_specialist_pool(
      self,
  ) -> Callable[[specialist_pool_service.UpdateSpecialistPoolRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
