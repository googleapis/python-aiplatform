...
class DatasetServiceClient(metaclass=DatasetServiceClientMeta):
  ...
  def create_dataset(
    ...
    r"""Creates a Dataset.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CreateDatasetRequest,
            ...
            dataset (google.cloud.aiplatform_v1beta1.types.Dataset): Required.
              The Dataset to create. This corresponds to the ``dataset`` field
  ...
  def get_dataset(
    ...
    r"""Gets a Dataset.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetDatasetRequest,
              dict]): The request object. Request message for
              [DatasetService.GetDataset][google.cloud.aiplatform.v1beta1.DatasetService.GetDataset].
            name (str): Required. The name of the Dataset resource.  This
  ...
  def update_dataset(
    ...
    r"""Updates a Dataset.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.UpdateDatasetRequest,
              dict]): The request object. Request message for
              [DatasetService.UpdateDataset][google.cloud.aiplatform.v1beta1.DatasetService.UpdateDataset].
            dataset (google.cloud.aiplatform_v1beta1.types.Dataset): Required.
              The Dataset which replaces the resource on the server.  This
              corresponds to the ``dataset`` field on the ``request`` instance;
  ...
  def list_datasets(
    ...
    r"""Lists Datasets in a Location.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListDatasetsRequest,
              dict]): The request object. Request message for
              [DatasetService.ListDatasets][google.cloud.aiplatform.v1beta1.DatasetService.ListDatasets].
            parent (str): Required. The name of the Dataset's parent resource.
  ...
  def delete_dataset(
    ...
    r"""Deletes a Dataset.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeleteDatasetRequest,
              dict]): The request object. Request message for
  ...
  def import_data(
    ...
    r"""Imports data into a Dataset.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ImportDataRequest,
              dict]): The request object. Request message for
              [DatasetService.ImportData][google.cloud.aiplatform.v1beta1.DatasetService.ImportData].
            name (str): Required. The name of the Dataset resource. Format:
              ``projects/{project}/locations/{location}/datasets/{dataset}``
              This corresponds to the ``name`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            import_configs
              (Sequence[google.cloud.aiplatform_v1beta1.types.ImportDataConfig]):
              Required. The desired input locations. The contents of all input
              locations will be imported in one batch.  This corresponds to the
              ``import_configs`` field on the ``request`` instance; if
              ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
            timeout (float): The timeout for this request.
  ...
  def export_data(
    ...
    r"""Exports data from a Dataset.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ExportDataRequest,
              dict]): The request object. Request message for
            ...
            export_config
              ...
              ``export_config`` field on the ``request`` instance; if
              ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
            timeout (float): The timeout for this request.
  ...
  def list_data_items(
    ...
    r"""Lists DataItems in a Dataset.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListDataItemsRequest,
              dict]): The request object. Request message for
              [DatasetService.ListDataItems][google.cloud.aiplatform.v1beta1.DatasetService.ListDataItems].
            parent (str): Required. The resource name of the Dataset to list
  ...
  def get_annotation_spec(
    ...
    r"""Gets an AnnotationSpec.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetAnnotationSpecRequest,
              dict]): The request object. Request message for
              [DatasetService.GetAnnotationSpec][google.cloud.aiplatform.v1beta1.DatasetService.GetAnnotationSpec].
            name (str): Required. The name of the AnnotationSpec resource.
                Format:
  ...
  def list_annotations(
    ...
    r"""Lists Annotations belongs to a dataitem
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListAnnotationsRequest,
              dict]): The request object. Request message for
              [DatasetService.ListAnnotations][google.cloud.aiplatform.v1beta1.DatasetService.ListAnnotations].
            parent (str): Required. The resource name of the DataItem to list
