...
class DatasetServiceGrpcAsyncIOTransport(DatasetServiceTransport):
  ...
  def get_dataset(
      self,
  ) -> Callable[[dataset_service.GetDatasetRequest],
  ...
  def update_dataset(
      self,
  ) -> Callable[[dataset_service.UpdateDatasetRequest],
  ...
  def import_data(
      self,
  ) -> Callable[[dataset_service.ImportDataRequest],
                Awaitable[operations_pb2.Operation]]:
  ...
  def export_data(
      self,
  ) -> Callable[[dataset_service.ExportDataRequest],
                Awaitable[operations_pb2.Operation]]:
