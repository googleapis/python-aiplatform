...
class DatasetServiceGrpcTransport(DatasetServiceTransport):
  ...
  def create_dataset(
      self,
  ) -> Callable[[dataset_service.CreateDatasetRequest],
  ...
  @property
  def get_dataset(
      self,) -> Callable[[dataset_service.GetDatasetRequest], dataset.Dataset]:
  ...
  def list_datasets(
      self,
  ) -> Callable[[dataset_service.ListDatasetsRequest],
    ...
    if "list_datasets" not in self._stubs:
      self._stubs["list_datasets"] = self.grpc_channel.unary_unary(
          ...
          response_deserializer=dataset_service.ListDatasetsResponse
          .deserialize,
      )
  ...
  def delete_dataset(
      self,
  ) -> Callable[[dataset_service.DeleteDatasetRequest],
                operations_pb2.Operation]:
  ...
  def list_data_items(
      self,
  ) -> Callable[[dataset_service.ListDataItemsRequest],
    ...
    if "list_data_items" not in self._stubs:
      self._stubs["list_data_items"] = self.grpc_channel.unary_unary(
          ...
          response_deserializer=dataset_service.ListDataItemsResponse
          .deserialize,
      )
  ...
  def get_annotation_spec(
      self,
  ) -> Callable[[dataset_service.GetAnnotationSpecRequest],
  ...
  def list_annotations(
      self,
  ) -> Callable[[dataset_service.ListAnnotationsRequest],
    ...
    if "list_annotations" not in self._stubs:
      self._stubs["list_annotations"] = self.grpc_channel.unary_unary(
          ...
          response_deserializer=dataset_service.ListAnnotationsResponse
          .deserialize,
      )
