...
class ReasoningEngineServiceGrpcAsyncIOTransport(ReasoningEngineServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_reasoning_engine: gapic_v1.method_async.wrap_method(
                self.create_reasoning_engine,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_reasoning_engine: gapic_v1.method_async.wrap_method(
            ...
            self.delete_reasoning_engine: gapic_v1.method_async.wrap_method(
