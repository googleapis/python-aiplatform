...
class _BaseReasoningEngineExecutionServiceRestTransport(
    ...
    class _BaseAsyncQueryReasoningEngine:
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = (
                reasoning_engine_execution_service.AsyncQueryReasoningEngineRequest.pb(
                    request
                )
            )
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseReasoningEngineExecutionServiceRestTransport._BaseAsyncQueryReasoningEngine._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseCancelAsyncQueryReasoningEngine:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = reasoning_engine_execution_service.CancelAsyncQueryReasoningEngineRequest.pb(
                request
            )
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseReasoningEngineExecutionServiceRestTransport._BaseCancelAsyncQueryReasoningEngine._get_unset_required_fields(
                    query_params
                )
            )
