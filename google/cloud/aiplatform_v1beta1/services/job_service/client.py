  ...
  def delete_custom_job(
    ...
    r"""Deletes a CustomJob.
        ...
        Args:
            ...
            name (str): Required. The name of the CustomJob resource to be
              deleted. Format:
              ``projects/{project}/locations/{location}/customJobs/{custom_job}``
              This corresponds to the ``name`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
    ...
    r"""Creates a DataLabelingJob.
        ...
        Args:
            ...
            parent (str): Required. The parent of the DataLabelingJob. Format:
              ...
              is provided, this should not be set.
            data_labeling_job
              (google.cloud.aiplatform_v1beta1.types.DataLabelingJob): Required.
              The DataLabelingJob to create.  This corresponds to the
  ...
  def delete_data_labeling_job(
    ...
    r"""Deletes a DataLabelingJob.
        ...
        Args:
            ...
            name (str): Required. The name of the DataLabelingJob to be deleted.
                Format:
                  ``projects/{project}/locations/{location}/dataLabelingJobs/{data_labeling_job}``
                  This corresponds to the ``name`` field on the ``request``
                  instance; if ``request`` is provided, this should not be set.
  ...
  def list_hyperparameter_tuning_jobs(
    ...
    r"""Lists HyperparameterTuningJobs in a Location.
        ...
        Args:
            ...
            parent (str): Required. The resource name of the Location to list
              the HyperparameterTuningJobs from. Format:
              ``projects/{project}/locations/{location}``  This corresponds to
              the ``parent`` field on the ``request`` instance; if ``request``
              is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
  ...
  def cancel_hyperparameter_tuning_job(
    ...
    Starts asynchronous
        ...
        Args:
            ...
            name (str): Required. The name of the HyperparameterTuningJob to
              cancel. Format:
              ``projects/{project}/locations/{location}/hyperparameterTuningJobs/{hyperparameter_tuning_job}``
              This corresponds to the ``name`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
  ...
  def get_batch_prediction_job(
    ...
    r"""Gets a BatchPredictionJob
        ...
        Args:
            ...
            name (str): Required. The name of the BatchPredictionJob resource.
                Format:
  ...
  def delete_batch_prediction_job(
    ...
    Can only be called on
        ...
        Args:
            ...
            name (str): Required. The name of the BatchPredictionJob resource to
              be deleted. Format:
              ``projects/{project}/locations/{location}/batchPredictionJobs/{batch_prediction_job}``
              This corresponds to the ``name`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
  ...
  def cancel_batch_prediction_job(
    ...
    r"""Cancels a BatchPredictionJob.
        ...
        Args:
            ...
            name (str): Required. The name of the BatchPredictionJob to cancel.
                Format:
                  ``projects/{project}/locations/{location}/batchPredictionJobs/{batch_prediction_job}``
                  This corresponds to the ``name`` field on the ``request``
                  instance; if ``request`` is provided, this should not be set.
  ...
  def create_model_deployment_monitoring_job(
    ...
    It will run
        ...
        Args:
            ...
            parent (str): Required. The parent of the
  ...
  def search_model_deployment_monitoring_stats_anomalies(
    ...
    r"""Searches Model Monitoring Statistics generated within
        ...
        Args:
            ...
            model_deployment_monitoring_job (str): Required.
            ...
            deployed_model_id (str): Required. The DeployedModel ID of the
    ...
    r"""Updates a ModelDeploymentMonitoringJob.
        ...
        Args:
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask): Required.
              The update mask is used to specify the fields to be overwritten in
              the ModelDeploymentMonitoringJob resource by the update. The
              fields specified in the update_mask are relative to the resource,
              not the full request. A field will be overwritten if it is in the
              mask. If the user does not provide a mask then only the non-empty
              fields present in the request will be overwritten. Set the
  ...
  def delete_model_deployment_monitoring_job(
    ...
    r"""Deletes a ModelDeploymentMonitoringJob.
        ...
        Args:
            ...
            name (str): Required. The resource name of the model monitoring job
              to delete. Format:
              ``projects/{project}/locations/{location}/modelDeploymentMonitoringJobs/{model_deployment_monitoring_job}``
              This corresponds to the ``name`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
