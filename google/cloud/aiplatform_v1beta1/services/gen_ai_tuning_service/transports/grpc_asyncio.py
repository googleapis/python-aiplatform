...
class GenAiTuningServiceGrpcAsyncIOTransport(GenAiTuningServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_tuning_job: gapic_v1.method_async.wrap_method(
                self.create_tuning_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_tuning_job: gapic_v1.method_async.wrap_method(
                self.get_tuning_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_tuning_jobs: gapic_v1.method_async.wrap_method(
