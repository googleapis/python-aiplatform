...
class AsyncOnlineEvaluatorServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    async def pre_activate_online_evaluator(
        self,
    ...
    async def post_activate_online_evaluator(
    ...
    async def post_activate_online_evaluator_with_metadata(
        self,
    ...
    async def pre_create_online_evaluator(
        self,
    ...
    async def post_create_online_evaluator(
        self, response: operations_pb2.Operation
    ) -> operations_pb2.Operation:
    ...
    async def post_create_online_evaluator_with_metadata(
        self,
        response: operations_pb2.Operation,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def pre_delete_online_evaluator(
        self,
    ...
    async def post_delete_online_evaluator(
        self, response: operations_pb2.Operation
    ) -> operations_pb2.Operation:
    ...
    async def post_delete_online_evaluator_with_metadata(
        self,
        response: operations_pb2.Operation,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def pre_get_online_evaluator(
        self,
    ...
    async def post_get_online_evaluator(
        self, response: online_evaluator.OnlineEvaluator
    ...
    async def post_get_online_evaluator_with_metadata(
        self,
        response: online_evaluator.OnlineEvaluator,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        online_evaluator.OnlineEvaluator, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Post-rpc interceptor for get_online_evaluator
    ...
    async def pre_list_online_evaluators(
        self,
    ...
    async def post_list_online_evaluators(
    ...
    async def post_list_online_evaluators_with_metadata(
        self,
        response: online_evaluator_service.ListOnlineEvaluatorsResponse,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        online_evaluator_service.ListOnlineEvaluatorsResponse,
        Sequence[Tuple[str, Union[str, bytes]]],
    ...
    async def pre_suspend_online_evaluator(
        self,
    ...
    async def post_suspend_online_evaluator(
        self, response: operations_pb2.Operation
    ) -> operations_pb2.Operation:
    ...
    async def post_suspend_online_evaluator_with_metadata(
        self,
        response: operations_pb2.Operation,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def pre_update_online_evaluator(
        self,
    ...
    async def post_update_online_evaluator(
        self, response: operations_pb2.Operation
    ) -> operations_pb2.Operation:
    ...
    async def post_update_online_evaluator_with_metadata(
        self,
        response: operations_pb2.Operation,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class AsyncOnlineEvaluatorServiceRestTransport(
    ...
    class _ActivateOnlineEvaluator(
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncOnlineEvaluatorServiceRestTransport._ActivateOnlineEvaluator._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            resp, _ = (
                await self._interceptor.post_activate_online_evaluator_with_metadata(
    ...
    class _CreateOnlineEvaluator(
        _BaseOnlineEvaluatorServiceRestTransport._BaseCreateOnlineEvaluator,
        AsyncOnlineEvaluatorServiceRestStub,
    ):
        def __hash__(self):
            return hash(
                "AsyncOnlineEvaluatorServiceRestTransport.CreateOnlineEvaluator"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncOnlineEvaluatorServiceRestTransport._CreateOnlineEvaluator._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = (
                await self._interceptor.post_create_online_evaluator_with_metadata(
                    resp, response_metadata
                )
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
    ...
    class _DeleteOnlineEvaluator(
        _BaseOnlineEvaluatorServiceRestTransport._BaseDeleteOnlineEvaluator,
        AsyncOnlineEvaluatorServiceRestStub,
    ):
        def __hash__(self):
            return hash(
                "AsyncOnlineEvaluatorServiceRestTransport.DeleteOnlineEvaluator"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = (
                await self._interceptor.post_delete_online_evaluator_with_metadata(
                    resp, response_metadata
                )
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
    ...
    class _GetOnlineEvaluator(
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncOnlineEvaluatorServiceRestTransport._GetOnlineEvaluator._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_get_online_evaluator_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                try:
                    response_payload = online_evaluator.OnlineEvaluator.to_json(
                        response
                    )
                except:
                    response_payload = None
    ...
    class _ListOnlineEvaluators(
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncOnlineEvaluatorServiceRestTransport._ListOnlineEvaluators._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_list_online_evaluators_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                try:
                    response_payload = (
                        online_evaluator_service.ListOnlineEvaluatorsResponse.to_json(
                            response
                        )
                    )
                except:
    ...
    class _SuspendOnlineEvaluator(
        _BaseOnlineEvaluatorServiceRestTransport._BaseSuspendOnlineEvaluator,
        AsyncOnlineEvaluatorServiceRestStub,
    ):
        def __hash__(self):
            return hash(
                "AsyncOnlineEvaluatorServiceRestTransport.SuspendOnlineEvaluator"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = (
                await self._interceptor.post_suspend_online_evaluator_with_metadata(
                    resp, response_metadata
                )
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
    ...
    class _UpdateOnlineEvaluator(
        _BaseOnlineEvaluatorServiceRestTransport._BaseUpdateOnlineEvaluator,
        AsyncOnlineEvaluatorServiceRestStub,
    ):
        def __hash__(self):
            return hash(
                "AsyncOnlineEvaluatorServiceRestTransport.UpdateOnlineEvaluator"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncOnlineEvaluatorServiceRestTransport._UpdateOnlineEvaluator._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = (
                await self._interceptor.post_update_online_evaluator_with_metadata(
                    resp, response_metadata
                )
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
    ...
    class _GetLocation(
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncOnlineEvaluatorServiceRestTransport._GetLocation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _ListLocations(
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncOnlineEvaluatorServiceRestTransport._ListLocations._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _GetIamPolicy(
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncOnlineEvaluatorServiceRestTransport._GetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _SetIamPolicy(
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncOnlineEvaluatorServiceRestTransport._SetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _TestIamPermissions(
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncOnlineEvaluatorServiceRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _CancelOperation(
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncOnlineEvaluatorServiceRestTransport._CancelOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _DeleteOperation(
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncOnlineEvaluatorServiceRestTransport._DeleteOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _GetOperation(
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncOnlineEvaluatorServiceRestTransport._GetOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _ListOperations(
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncOnlineEvaluatorServiceRestTransport._ListOperations._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
