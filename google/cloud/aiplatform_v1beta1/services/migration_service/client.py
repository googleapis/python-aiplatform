...
class MigrationServiceClient(metaclass=MigrationServiceClientMeta):
    ...
    """Instantiates the migration service client.
        ...
        Args:
            credentials (Optional[google.auth.credentials.Credentials]): The
              ...
              environment.
            transport (Union[str, MigrationServiceTransport]): The transport to
  ...
  def search_migratable_resources(
    ...
    r"""Searches all of the resources in
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.SearchMigratableResourcesRequest,
  ...
  def batch_migrate_resources(
    ...
    r"""Batch migrates resources from ml.googleapis.com,
        ...
        .. code-block:: python
            ...
            def sample_batch_migrate_resources():
                ...
                aiplatform_v1beta1.MigrateResourceRequest()
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.BatchMigrateResourcesRequest,
              dict]): The request object. Request message for
              [MigrationService.BatchMigrateResources][google.cloud.aiplatform.v1beta1.MigrationService.BatchMigrateResources].
            parent (str): Required. The location of the migrated resource will
              live in. Format: ``projects/{project}/locations/{location}``  This
              corresponds to the ``parent`` field on the ``request`` instance;
              if ``request`` is provided, this should not be set.
            migrate_resource_requests
              (Sequence[google.cloud.aiplatform_v1beta1.types.MigrateResourceRequest]):
    ...
    # and friendly error handling.
    rpc = self._transport._wrapped_methods[
        self._transport.batch_migrate_resources]
