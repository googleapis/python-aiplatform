...
class MigrationServiceGrpcTransport(MigrationServiceTransport):
  ...
  def search_migratable_resources(
      self,
  ) -> Callable[[migration_service.SearchMigratableResourcesRequest],
    ...
    if "search_migratable_resources" not in self._stubs:
      self._stubs["search_migratable_resources"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=migration_service.SearchMigratableResourcesRequest
          .serialize,
          response_deserializer=migration_service
          .SearchMigratableResourcesResponse.deserialize,
      )
  ...
  def batch_migrate_resources(
      self,
  ) -> Callable[[migration_service.BatchMigrateResourcesRequest],
    ...
    if "batch_migrate_resources" not in self._stubs:
      self._stubs["batch_migrate_resources"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=migration_service.BatchMigrateResourcesRequest
          .serialize,
