...
class PipelineServiceAsyncClient:
  ...
  parse_custom_job_path = staticmethod(
      PipelineServiceClient.parse_custom_job_path)
  ...
  parse_execution_path = staticmethod(
      PipelineServiceClient.parse_execution_path)
  ...
  training_pipeline_path = staticmethod(
      PipelineServiceClient.training_pipeline_path)
  ...
  common_location_path = staticmethod(
      PipelineServiceClient.common_location_path)
  ...
  def from_service_account_info(cls, info: dict, *args, **kwargs):
    """Creates an instance of this client using the provided credentials
        ...
        """
    return PipelineServiceClient.from_service_account_info.__func__(
        PipelineServiceAsyncClient, info, *args, **kwargs)  # type: ignore
  ...
  def from_service_account_file(cls, filename: str, *args, **kwargs):
    """Creates an instance of this client using the provided credentials
        ...
        Returns:
            PipelineServiceAsyncClient: The constructed client.
        """
    return PipelineServiceClient.from_service_account_file.__func__(
        PipelineServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
  ...
  def get_mtls_endpoint_and_cert_source(
    ...
    """Return the API endpoint and client cert source for mutual TLS.
        ...
        """
    return PipelineServiceClient.get_mtls_endpoint_and_cert_source(
    ...
    """Instantiates the pipeline service client.
        ...
        Args:
            credentials (Optional[google.auth.credentials.Credentials]): The
              ...
              environment.
            transport (Union[str, ~.PipelineServiceTransport]): The transport to
  ...
  async def create_training_pipeline(
      self,
      request: Union[pipeline_service.CreateTrainingPipelineRequest,
                     dict] = None,
      *,
      parent: str = None,
    ...
    A created
        ...
        .. code-block:: python
            ...
            async def sample_create_training_pipeline():
                ...
                training_pipeline.training_task_definition =
                "training_task_definition_value"
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CreateTrainingPipelineRequest,
              ...
              to create the TrainingPipeline in. Format:
              ...
              (:class:`google.cloud.aiplatform_v1beta1.types.TrainingPipeline`):
              Required. The TrainingPipeline to create.  This corresponds to the
              ``training_pipeline`` field on the ``request`` instance; if
  ...
  async def get_training_pipeline(
    ...
    r"""Gets a TrainingPipeline.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetTrainingPipelineRequest,
              dict]): The request object. Request message for
              [PipelineService.GetTrainingPipeline][google.cloud.aiplatform.v1beta1.PipelineService.GetTrainingPipeline].
              name (:class:`str`): Required. The name of the TrainingPipeline
              resource.
                Format:
  ...
  async def list_training_pipelines(
      self,
      request: Union[pipeline_service.ListTrainingPipelinesRequest,
                     dict] = None,
      *,
      parent: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Lists TrainingPipelines in a Location.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListTrainingPipelinesRequest,
              dict]): The request object. Request message for
              [PipelineService.ListTrainingPipelines][google.cloud.aiplatform.v1beta1.PipelineService.ListTrainingPipelines].
              parent (:class:`str`): Required. The resource name of the Location
              to list the TrainingPipelines from. Format:
              ``projects/{project}/locations/{location}``  This corresponds to
              the ``parent`` field on the ``request`` instance; if ``request``
  ...
  async def delete_training_pipeline(
      self,
      request: Union[pipeline_service.DeleteTrainingPipelineRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Deletes a TrainingPipeline.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeleteTrainingPipelineRequest,
              dict]): The request object. Request message for
  ...
  async def cancel_training_pipeline(
      self,
      request: Union[pipeline_service.CancelTrainingPipelineRequest,
                     dict] = None,
      *,
      name: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Cancels a TrainingPipeline.

    Starts asynchronous cancellation on
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CancelTrainingPipelineRequest,
              dict]): The request object. Request message for
              [PipelineService.CancelTrainingPipeline][google.cloud.aiplatform.v1beta1.PipelineService.CancelTrainingPipeline].
              name (:class:`str`): Required. The name of the TrainingPipeline to
              cancel.
                Format:
                  ``projects/{project}/locations/{location}/trainingPipelines/{training_pipeline}``
                  This corresponds to the ``name`` field on the ``request``
  ...
  async def create_pipeline_job(
    ...
    r"""Creates a PipelineJob.

    A PipelineJob will run
        ...
        Args:
            request
              ...
              parent (:class:`str`): Required. The resource name of the Location
              to create the PipelineJob in. Format:
              ``projects/{project}/locations/{location}``  This corresponds to
              the ``parent`` field on the ``request`` instance; if ``request``
              is provided, this should not be set. pipeline_job
              (:class:`google.cloud.aiplatform_v1beta1.types.PipelineJob`):
              Required. The PipelineJob to create. This corresponds to the
              ``pipeline_job`` field on the ``request`` instance; if ``request``
              is provided, this should not be set. pipeline_job_id
              (:class:`str`): The ID to use for the PipelineJob, which will
              become the final component of the PipelineJob name. If not
              provided, an ID will be automatically generated.  This value
              should be less than 128 characters, and valid characters are
              /[a-z][0-9]-/.  This corresponds to the ``pipeline_job_id`` field
  ...
  async def get_pipeline_job(
    ...
    r"""Gets a PipelineJob.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetPipelineJobRequest,
              dict]): The request object. Request message for
              [PipelineService.GetPipelineJob][google.cloud.aiplatform.v1beta1.PipelineService.GetPipelineJob].
              name (:class:`str`): Required. The name of the PipelineJob
              resource. Format:
  ...
  async def list_pipeline_jobs(
    ...
    r"""Lists PipelineJobs in a Location.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListPipelineJobsRequest,
              dict]): The request object. Request message for
              [PipelineService.ListPipelineJobs][google.cloud.aiplatform.v1beta1.PipelineService.ListPipelineJobs].
              parent (:class:`str`): Required. The resource name of the Location
              to list the PipelineJobs from. Format:
              ``projects/{project}/locations/{location}``  This corresponds to
              the ``parent`` field on the ``request`` instance; if ``request``
              is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
  ...
  async def delete_pipeline_job(
    ...
    r"""Deletes a PipelineJob.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeletePipelineJobRequest,
              dict]): The request object. Request message for
  ...
  async def cancel_pipeline_job(
    ...
    r"""Cancels a PipelineJob.

    Starts asynchronous cancellation on the
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CancelPipelineJobRequest,
              dict]): The request object. Request message for
              [PipelineService.CancelPipelineJob][google.cloud.aiplatform.v1beta1.PipelineService.CancelPipelineJob].
              name (:class:`str`): Required. The name of the PipelineJob to
              cancel. Format:
              ``projects/{project}/locations/{location}/pipelineJobs/{pipeline_job}``
              This corresponds to the ``name`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
