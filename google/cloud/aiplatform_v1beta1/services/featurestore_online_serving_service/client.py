...
class FeaturestoreOnlineServingServiceClientMeta(type):
  ...
  _transport_registry[
      "grpc_asyncio"] = FeaturestoreOnlineServingServiceGrpcAsyncIOTransport
    ...
    r"""Reads Feature values of a specific entity of an
        ...
        .. code-block:: python
            ...
            def sample_read_feature_values():
                # Create a client
                client =
                aiplatform_v1beta1.FeaturestoreOnlineServingServiceClient()
        ...
        Args:
            ...
            entity_type (str): Required. The resource name of the EntityType for
              the entity being read. Value format:
  ...
  def streaming_read_feature_values(
    ...
    Depending
        ...
        Args:
            ...
            entity_type (str): Required. The resource name of the entities'
              type. Value
                format:
                  ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entityType}``.
