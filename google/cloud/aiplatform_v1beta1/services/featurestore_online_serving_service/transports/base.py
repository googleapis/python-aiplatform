...
class FeaturestoreOnlineServingServiceTransport(abc.ABC):
    ...
    @property
    def read_feature_values(self) -> typing.Callable[
            [featurestore_online_service.ReadFeatureValuesRequest],
            typing.Union[
                featurestore_online_service.ReadFeatureValuesResponse,
                typing.Awaitable[featurestore_online_service.ReadFeatureValuesResponse]
            ]]:
        raise NotImplementedError()

    @property
    def streaming_read_feature_values(self) -> typing.Callable[
