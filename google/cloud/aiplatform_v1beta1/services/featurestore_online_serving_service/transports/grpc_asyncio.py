...
class FeaturestoreOnlineServingServiceGrpcAsyncIOTransport(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.read_feature_values: gapic_v1.method_async.wrap_method(
                self.read_feature_values,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.streaming_read_feature_values: gapic_v1.method_async.wrap_method(
                self.streaming_read_feature_values,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.write_feature_values: gapic_v1.method_async.wrap_method(
