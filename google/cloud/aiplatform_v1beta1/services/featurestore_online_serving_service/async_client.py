...
class FeaturestoreOnlineServingServiceAsyncClient:
  ...
  def from_service_account_info(cls, info: dict, *args, **kwargs):
    """Creates an instance of this client using the provided credentials
        ...
        """
    return FeaturestoreOnlineServingServiceClient.from_service_account_info.__func__(
        FeaturestoreOnlineServingServiceAsyncClient, info, *args,
        **kwargs)  # type: ignore
  ...
  def from_service_account_file(cls, filename: str, *args, **kwargs):
    """Creates an instance of this client using the provided credentials
        ...
        Returns:
            FeaturestoreOnlineServingServiceAsyncClient: The constructed client.
        """
    return FeaturestoreOnlineServingServiceClient.from_service_account_file.__func__(
        FeaturestoreOnlineServingServiceAsyncClient, filename, *args,
        **kwargs)  # type: ignore
  ...
  def get_mtls_endpoint_and_cert_source(
    ...
    """Return the API endpoint and client cert source for mutual TLS.
        ...
        """
    return FeaturestoreOnlineServingServiceClient.get_mtls_endpoint_and_cert_source(
  ...
  def transport(self) -> FeaturestoreOnlineServingServiceTransport:
    """Returns the transport used by the client instance.
        ...
        Returns:
            FeaturestoreOnlineServingServiceTransport: The transport used by the
            client instance.
        """
  ...
  def __init__(
      ...
      *,
      ...
      transport: Union[
          str, FeaturestoreOnlineServingServiceTransport] = "grpc_asyncio",
    ...
    """Instantiates the featurestore online serving service client.
        ...
        Args:
            credentials (Optional[google.auth.credentials.Credentials]): The
              ...
              environment.
            transport (Union[str, ~.FeaturestoreOnlineServingServiceTransport]):
              The transport to use. If set to None, a transport is chosen
              automatically.
  ...
  async def read_feature_values(
      self,
      request: Union[featurestore_online_service.ReadFeatureValuesRequest,
                     dict] = None,
      *,
    ...
    r"""Reads Feature values of a specific entity of an
        ...
        .. code-block:: python
            ...
            async def sample_read_feature_values():
                # Create a client
                client =
                aiplatform_v1beta1.FeaturestoreOnlineServingServiceAsyncClient()
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ReadFeatureValuesRequest,
              ...
              entity_type (:class:`str`): Required. The resource name of the
              EntityType for the entity being read. Value format:
              ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entityType}``.
              For example, for a machine learning model predicting user clicks
              on a website, an EntityType ID could be ``user``.  This
  ...
  def streaming_read_feature_values(
      ...
      *,
      ...
      featurestore_online_service.ReadFeatureValuesResponse]]:
    r"""Reads Feature values for multiple entities.
    ...
    Depending
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.StreamingReadFeatureValuesRequest,
              dict]): The request object. Request message for
              ...
              entities' type. Value
                format:
                  ...
                  clicks on a website, an EntityType ID could be ``user``.  This
                  corresponds to the ``entity_type`` field on the ``request``
                  instance; if ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
