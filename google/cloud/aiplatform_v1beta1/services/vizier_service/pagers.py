...
class ListStudiesPager:
  """A pager for iterating through ``list_studies`` requests.
    ...
    :class:`google.cloud.aiplatform_v1beta1.types.ListStudiesResponse` object,
    and
    ...
    All the usual
    :class:`google.cloud.aiplatform_v1beta1.types.ListStudiesResponse`
  ...
  def __init__(self,
    ...
    """Instantiate the pager.
        ...
        Args:
            ...
            response
              (google.cloud.aiplatform_v1beta1.types.ListStudiesResponse): The
...
class ListTrialsPager:
  """A pager for iterating through ``list_trials`` requests.
    ...
    This class thinly wraps an initial
    :class:`google.cloud.aiplatform_v1beta1.types.ListTrialsResponse` object,
    and
    provides an ``__iter__`` method to iterate through its
    ``trials`` field.
    ...
    All the usual
    :class:`google.cloud.aiplatform_v1beta1.types.ListTrialsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
