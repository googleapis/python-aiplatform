    ...
    A resource name will be generated
        ...
        Args:
            request
              ...
              is provided, this should not be set. study
              (:class:`google.cloud.aiplatform_v1beta1.types.Study`): Required.
              The Study configuration used to create the Study.  This
              corresponds to the ``study`` field on the ``request`` instance; if
    ...
    r"""Deletes a Study.
        ...
        Args:
            request
              ...
              name (:class:`str`): Required. The name of the Study resource to
              be deleted.
                Format:
    ...
    r"""Adds a user provided Trial to a Study.
        ...
        Args:
            request
              ...
              if ``request`` is provided, this should not be set. trial
              (:class:`google.cloud.aiplatform_v1beta1.types.Trial`): Required.
              The Trial to create. This corresponds to the ``trial`` field on
    ...
    r"""Lists the pareto-optimal Trials for multi-objective Study or the
        ...
        Args:
            request
              ...
              optimal Trial belongs to.  This corresponds to the ``parent``
