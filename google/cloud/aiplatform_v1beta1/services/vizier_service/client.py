...
class VizierServiceClient(metaclass=VizierServiceClientMeta):
  ...
  def create_study(
    ...
    A resource name will be generated
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CreateStudyRequest,
            ...
            study (google.cloud.aiplatform_v1beta1.types.Study): Required. The
  ...
  def get_study(
    ...
    r"""Gets a Study by name.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetStudyRequest,
              dict]): The request object. Request message for
            ...
            name (str): Required. The name of the Study resource. Format:
              ...
              corresponds to the ``name`` field on the ``request`` instance; if
  ...
  def list_studies(
    ...
    r"""Lists all the studies in a region for an associated
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListStudiesRequest,
              dict]): The request object. Request message for
  ...
  def delete_study(
    ...
    r"""Deletes a Study.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeleteStudyRequest,
              dict]): The request object. Request message for
  ...
  def lookup_study(
    ...
    r"""Looks a study up using the user-defined display_name field
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.LookupStudyRequest,
              dict]): The request object. Request message for
  ...
  def suggest_trials(
    ...
    r"""Adds one or more Trials to a Study, with parameter values
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.SuggestTrialsRequest,
              dict]): The request object. Request message for
  ...
  def create_trial(
    ...
    r"""Adds a user provided Trial to a Study.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CreateTrialRequest,
              dict]): The request object. Request message for
            ...
            trial (google.cloud.aiplatform_v1beta1.types.Trial): Required. The
  ...
  def get_trial(
    ...
    r"""Gets a Trial.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetTrialRequest,
              dict]): The request object. Request message for
  ...
  def list_trials(
    ...
    r"""Lists the Trials associated with a Study.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListTrialsRequest,
              dict]): The request object. Request message for
              [VizierService.ListTrials][google.cloud.aiplatform.v1beta1.VizierService.ListTrials].
            parent (str): Required. The resource name of the Study to list the
              Trial from. Format:
              ``projects/{project}/locations/{location}/studies/{study}``  This
              corresponds to the ``parent`` field on the ``request`` instance;
              if ``request`` is provided, this should not be set.
  ...
  def add_trial_measurement(
    ...
    r"""Adds a measurement of the objective metrics to a
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.AddTrialMeasurementRequest,
              dict]): The request object. Request message for
  ...
  def complete_trial(
    ...
    r"""Marks a Trial as complete.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CompleteTrialRequest,
              dict]): The request object. Request message for
  ...
  def delete_trial(
    ...
    r"""Deletes a Trial.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeleteTrialRequest,
              dict]): The request object. Request message for
    ...
    Returns a
        ...
        .. code-block:: python
            ...
            def sample_check_trial_early_stopping_state():
                ...
                # Initialize request argument(s)
                request =
                aiplatform_v1beta1.CheckTrialEarlyStoppingStateRequest(
                    trial_name="trial_name_value",
                )
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CheckTrialEarlyStoppingStateRequest,
              dict]): The request object. Request message for
  ...
  def stop_trial(
    ...
    r"""Stops a Trial.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.StopTrialRequest,
              dict]): The request object. Request message for
  ...
  def list_optimal_trials(
    ...
    r"""Lists the pareto-optimal Trials for multi-objective Study or the
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListOptimalTrialsRequest,
              dict]): The request object. Request message for
            ...
            parent (str): Required. The name of the Study that the optimal Trial
              belongs to.  This corresponds to the ``parent`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
