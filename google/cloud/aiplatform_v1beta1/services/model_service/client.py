...
class ModelServiceClient(metaclass=ModelServiceClientMeta):
  ...
  def upload_model(
    ...
    r"""Uploads a Model artifact into Vertex AI.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.UploadModelRequest,
              dict]): The request object. Request message for
              [ModelService.UploadModel][google.cloud.aiplatform.v1beta1.ModelService.UploadModel].
            parent (str): Required. The resource name of the Location into which
            ...
            model (google.cloud.aiplatform_v1beta1.types.Model): Required. The
  ...
  def get_model(
    ...
    r"""Gets a Model.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetModelRequest,
              dict]): The request object. Request message for
            ...
            name (str): Required. The name of the Model resource. Format:
              ...
              If no version ID or alias is specified, the "default" version will
              be returned. The "default" version alias is created for the first
              version of the model, and can be moved to other versions later on.
              There will be exactly one default version.  This corresponds to
              the ``name`` field on the ``request`` instance; if ``request`` is
  ...
  def list_models(
    ...
    r"""Lists Models in a Location.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListModelsRequest,
              dict]): The request object. Request message for
  ...
  def list_model_versions(
    ...
    r"""Lists versions of the specified model.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListModelVersionsRequest,
              dict]): The request object. Request message for
  ...
  def update_model(
    ...
    r"""Updates a Model.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.UpdateModelRequest,
              dict]): The request object. Request message for
            ...
            model (google.cloud.aiplatform_v1beta1.types.Model): Required. The
              ...
              update. 2. model.name without the @ value, e.g. models/123, refers
              to a model update. 3. model.name with @-, e.g. models/123@-,
              refers to a model update. 4. Supported model fields: display_name,
              description; supported version-specific fields:
              version_description. Labels are supported in both scenarios. Both
              the model labels and the version labels are merged when a model is
              returned. When updating labels, if the request is for
              model-specific update, model label gets updated. Otherwise,
              version labels get updated. 5. A model name or model version name
              fields update mismatch will cause a precondition error. 6. One
              request cannot update both the model and the version fields. You
              must update them separately.  This corresponds to the ``model``
  ...
  def update_explanation_dataset(
      self,
      request: Union[model_service.UpdateExplanationDatasetRequest,
                     dict] = None,
      *,
      model: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Incrementally update the dataset used for an examples
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.UpdateExplanationDatasetRequest,
              dict]): The request object. Request message for
              [ModelService.UpdateExplanationDataset][google.cloud.aiplatform.v1beta1.ModelService.UpdateExplanationDataset].
            model (str): Required. The resource name of the Model to update.
                Format:
  ...
  def delete_model(
    ...
    r"""Deletes a Model.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeleteModelRequest,
              dict]): The request object. Request message for
  ...
  def delete_model_version(
    ...
    r"""Deletes a Model version.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeleteModelVersionRequest,
              dict]): The request object. Request message for
              [ModelService.DeleteModelVersion][google.cloud.aiplatform.v1beta1.ModelService.DeleteModelVersion].
            name (str): Required. The name of the model version to be deleted,
  ...
  def merge_version_aliases(
    ...
    r"""Merges a set of aliases for a Model version.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.MergeVersionAliasesRequest,
              dict]): The request object. Request message for
            ...
            version_aliases (Sequence[str]): Required. The set of version
              aliases to merge. The alias should be at most 128 characters, and
              match ``[a-z][a-z0-9-]{0,126}[a-z-0-9]``. Add the ``-`` prefix to
              an alias means removing that alias from the version. ``-`` is NOT
              counted in the 128 characters. Example: ``-golden`` means removing
              the ``golden`` alias from the version.  There is NO ordering in
              aliases, which means  1) The aliases returned from GetModel API
              might not have the exactly same order from this
              MergeVersionAliases API. 2) Adding and deleting the same alias in
              the request is not recommended, and the 2 operations will be
              cancelled out.  This corresponds to the ``version_aliases`` field
  ...
  def export_model(
    ...
    r"""Exports a trained, exportable Model to a location specified by
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ExportModelRequest,
              dict]): The request object. Request message for
            ...
            name (str): Required. The resource name of the Model to export. The
              resource name may contain version id or version alias to specify
              the version, if no version is specified, the default version will
              be exported.  This corresponds to the ``name`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set.
            output_config
  ...
  def import_model_evaluation(
    ...
    r"""Imports an externally generated ModelEvaluation.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ImportModelEvaluationRequest,
              dict]): The request object. Request message for
            ...
            model_evaluation
              ...
              Model evaluation resource to be imported.  This corresponds to the
              ``model_evaluation`` field on the ``request`` instance; if
  ...
  def batch_import_model_evaluation_slices(
      self,
      request: Union[model_service.BatchImportModelEvaluationSlicesRequest,
                     dict] = None,
      *,
      parent: str = None,
      model_evaluation_slices: Sequence[
          model_evaluation_slice.ModelEvaluationSlice] = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
      timeout: float = None,
      metadata: Sequence[Tuple[str, str]] = (),
    ...
    r"""Imports a list of externally generated
        ...
        .. code-block:: python
            ...
            def sample_batch_import_model_evaluation_slices():
                ...
                # Initialize request argument(s)
                request =
                aiplatform_v1beta1.BatchImportModelEvaluationSlicesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.BatchImportModelEvaluationSlicesRequest,
              dict]): The request object. Request message for
            ...
            parent (str): Required. The name of the parent ModelEvaluation
              resource. Format:
            ...
            model_evaluation_slices
              ...
              Required. Model evaluation slice resource to be imported.  This
              corresponds to the ``model_evaluation_slices`` field on the
              ``request`` instance; if ``request`` is provided, this should not
              be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
  ...
  def get_model_evaluation(
    ...
    r"""Gets a ModelEvaluation.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetModelEvaluationRequest,
              dict]): The request object. Request message for
  ...
  def list_model_evaluations(
    ...
    r"""Lists ModelEvaluations in a Model.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListModelEvaluationsRequest,
              dict]): The request object. Request message for
  ...
  def get_model_evaluation_slice(
    ...
    r"""Gets a ModelEvaluationSlice.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetModelEvaluationSliceRequest,
              dict]): The request object. Request message for
  ...
  def list_model_evaluation_slices(
    ...
    r"""Lists ModelEvaluationSlices in a ModelEvaluation.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListModelEvaluationSlicesRequest,
              dict]): The request object. Request message for
              [ModelService.ListModelEvaluationSlices][google.cloud.aiplatform.v1beta1.ModelService.ListModelEvaluationSlices].
            parent (str): Required. The resource name of the ModelEvaluation to
