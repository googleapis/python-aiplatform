    ...
    r"""Uploads a Model artifact into Vertex AI.
        ...
        Args:
            request
              ...
              (:class:`google.cloud.aiplatform_v1beta1.types.Model`): Required.
              The Model to create. This corresponds to the ``model`` field on
    ...
    r"""Updates a Model.
        ...
        Args:
            request
              ...
              When Model Versioning is enabled, the model.name will be used to
              determine whether to update the model or model version.  1.
              model.name with the @ value, e.g. models/123@1, refers to a
              version specific update. 2. model.name without the @ value, e.g.
              models/123, refers to a model update. 3. model.name with @-, e.g.
              models/123@-, refers to a model update. 4. Supported model fields:
              display_name, description; supported version-specific fields:
              ...
              this should not be set. update_mask
    ...
    r"""Incrementally update the dataset used for an examples
        ...
        Args:
            request
              ...
              model (:class:`str`): Required. The resource name of the Model to
              update.
                Format:
    ...
    r"""Deletes a Model.
        ...
        Args:
            request
              ...
              name (:class:`str`): Required. The name of the Model resource to
              be deleted.
                Format:
                  ``projects/{project}/locations/{location}/models/{model}``
            ...
            request
              ...
              merge aliases, with a version ID explicitly included.
                Example:
                  ...
                  This corresponds to the ``name`` field on the ``request``
                  instance; if ``request`` is provided, this should not be set.
                  version_aliases (:class:`Sequence[str]`): Required. The set of
                  version aliases to merge. The alias should be at most 128
                  characters, and match ``[a-z][a-z0-9-]{0,126}[a-z-0-9]``. Add
                  the ``-`` prefix to an alias means removing that alias from
                  the version. ``-`` is NOT counted in the 128 characters.
                  Example: ``-golden`` means removing the ``golden`` alias from
                  the version.  There is NO ordering in aliases, which means  1)
                  The aliases returned from GetModel API might not have the
                  exactly same order from this MergeVersionAliases API. 2)
                  Adding and deleting the same alias in the request is not
                  recommended, and the 2 operations will be cancelled out.  This
                  corresponds to the ``version_aliases`` field on the
    ...
    r"""Exports a trained, exportable Model to a location specified by
        ...
        Args:
            request
              ...
              export. The resource name may contain version id or version alias
              to specify the version, if no version is specified, the default
              version will be exported.  This corresponds to the ``name`` field
              on the ``request`` instance; if ``request`` is provided, this
              should not be set. output_config
              (:class:`google.cloud.aiplatform_v1beta1.types.ExportModelRequest.OutputConfig`):
    ...
    r"""Imports an externally generated ModelEvaluation.
        ...
        Args:
            request
              ...
              model_evaluation
              (:class:`google.cloud.aiplatform_v1beta1.types.ModelEvaluation`):
    ...
    r"""Imports a list of externally generated
        ...
        Args:
            request
              ...
              parent (:class:`str`): Required. The name of the parent
              ModelEvaluation resource. Format:
              ``projects/{project}/locations/{location}/models/{model}/evaluations/{evaluation}``
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
              model_evaluation_slices
              (:class:`Sequence[google.cloud.aiplatform_v1beta1.types.ModelEvaluationSlice]`):
