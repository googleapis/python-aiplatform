...
class ModelServiceGrpcAsyncIOTransport(ModelServiceTransport):
  ...
  def upload_model(
      self,
  ) -> Callable[[model_service.UploadModelRequest],
  ...
  def list_model_versions(
    ...
    if "list_model_versions" not in self._stubs:
      self._stubs["list_model_versions"] = self.grpc_channel.unary_unary(
          ...
          response_deserializer=model_service.ListModelVersionsResponse
          .deserialize,
      )
  ...
  def update_explanation_dataset(
      self,
  ) -> Callable[[model_service.UpdateExplanationDatasetRequest],
                Awaitable[operations_pb2.Operation],]:
    ...
    if "update_explanation_dataset" not in self._stubs:
      self._stubs["update_explanation_dataset"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=model_service.UpdateExplanationDatasetRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def delete_model(
      self,
  ) -> Callable[[model_service.DeleteModelRequest],
                Awaitable[operations_pb2.Operation]]:
  ...
  def delete_model_version(
      self,
  ) -> Callable[[model_service.DeleteModelVersionRequest],
                Awaitable[operations_pb2.Operation]]:
  ...
  def merge_version_aliases(
      self,
  ) -> Callable[[model_service.MergeVersionAliasesRequest],
  ...
  def export_model(
      self,
  ) -> Callable[[model_service.ExportModelRequest],
                Awaitable[operations_pb2.Operation]]:
  ...
  def import_model_evaluation(
    ...
    if "import_model_evaluation" not in self._stubs:
      self._stubs["import_model_evaluation"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=model_service.ImportModelEvaluationRequest
          .serialize,
          response_deserializer=gca_model_evaluation.ModelEvaluation
          .deserialize,
      )
  ...
  def batch_import_model_evaluation_slices(
    ...
    if "batch_import_model_evaluation_slices" not in self._stubs:
      self._stubs[
          "batch_import_model_evaluation_slices"] = self.grpc_channel.unary_unary(
              "/google.cloud.aiplatform.v1beta1.ModelService/BatchImportModelEvaluationSlices",
              request_serializer=model_service
              .BatchImportModelEvaluationSlicesRequest.serialize,
              response_deserializer=model_service
              .BatchImportModelEvaluationSlicesResponse.deserialize,
          )
  ...
  def list_model_evaluations(
    ...
    if "list_model_evaluations" not in self._stubs:
      self._stubs["list_model_evaluations"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=model_service.ListModelEvaluationsRequest
          .serialize,
          response_deserializer=model_service.ListModelEvaluationsResponse
          .deserialize,
      )
  ...
  def get_model_evaluation_slice(
      self,
  ) -> Callable[[model_service.GetModelEvaluationSliceRequest],
    ...
    if "get_model_evaluation_slice" not in self._stubs:
      self._stubs["get_model_evaluation_slice"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=model_service.GetModelEvaluationSliceRequest
          .serialize,
          response_deserializer=model_evaluation_slice.ModelEvaluationSlice
          .deserialize,
      )
  ...
  def list_model_evaluation_slices(
      self,
  ) -> Callable[[model_service.ListModelEvaluationSlicesRequest],
    ...
    if "list_model_evaluation_slices" not in self._stubs:
      self._stubs["list_model_evaluation_slices"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=model_service.ListModelEvaluationSlicesRequest
          .serialize,
          response_deserializer=model_service.ListModelEvaluationSlicesResponse
          .deserialize,
      )
