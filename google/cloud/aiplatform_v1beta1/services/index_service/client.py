...
class IndexServiceClientMeta(type):
  ...
  )  # type: Dict[str, Type[IndexServiceTransport]]
    ...
    """Instantiates the index service client.
        ...
        Args:
            credentials (Optional[google.auth.credentials.Credentials]): The
              ...
              environment.
            transport (Union[str, IndexServiceTransport]): The transport to use.
  ...
  def create_index(
    ...
    r"""Creates an Index.
        ...
        Args:
            ...
            index (google.cloud.aiplatform_v1beta1.types.Index): Required. The
  ...
  def list_indexes(
    ...
    r"""Lists Indexes in a Location.
        ...
        Args:
            ...
            parent (str): Required. The resource name of the Location from which
  ...
  def update_index(
    ...
    r"""Updates an Index.
        ...
        Args:
            ...
            index (google.cloud.aiplatform_v1beta1.types.Index): Required. The
              Index which updates the resource on the server.  This corresponds
              to the ``index`` field on the ``request`` instance; if ``request``
              is provided, this should not be set.
            update_mask (google.protobuf.field_mask_pb2.FieldMask): The update
