...
class _BaseReasoningEngineRuntimeRevisionServiceRestTransport(
    ReasoningEngineRuntimeRevisionServiceTransport
):
    """Base REST backend transport for ReasoningEngineRuntimeRevisionService.
    ...
    class _BaseDeleteReasoningEngineRuntimeRevision:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1beta1/{name=projects/*/locations/*/reasoningEngines/*/runtimeRevisions/*}",
                },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = reasoning_engine_runtime_revision_service.DeleteReasoningEngineRuntimeRevisionRequest.pb(
                request
            )
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseReasoningEngineRuntimeRevisionServiceRestTransport._BaseDeleteReasoningEngineRuntimeRevision._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseGetReasoningEngineRuntimeRevision:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = reasoning_engine_runtime_revision_service.GetReasoningEngineRuntimeRevisionRequest.pb(
                request
            )
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseReasoningEngineRuntimeRevisionServiceRestTransport._BaseGetReasoningEngineRuntimeRevision._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseListReasoningEngineRuntimeRevisions:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1beta1/{parent=projects/*/locations/*/reasoningEngines/*}/runtimeRevisions",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = reasoning_engine_runtime_revision_service.ListReasoningEngineRuntimeRevisionsRequest.pb(
                request
            )
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseReasoningEngineRuntimeRevisionServiceRestTransport._BaseListReasoningEngineRuntimeRevisions._get_unset_required_fields(
                    query_params
                )
            )
...
__all__ = ("_BaseReasoningEngineRuntimeRevisionServiceRestTransport",)
