...
from .rest_base import _BaseReasoningEngineRuntimeRevisionServiceRestTransport
...
class AsyncReasoningEngineRuntimeRevisionServiceRestInterceptor:
    """Asynchronous Interceptor for ReasoningEngineRuntimeRevisionService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the AsyncReasoningEngineRuntimeRevisionServiceRestTransport.

    .. code-block:: python
        class MyCustomReasoningEngineRuntimeRevisionServiceInterceptor(ReasoningEngineRuntimeRevisionServiceRestInterceptor):
            async def pre_delete_reasoning_engine_runtime_revision(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_delete_reasoning_engine_runtime_revision(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_get_reasoning_engine_runtime_revision(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_get_reasoning_engine_runtime_revision(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_list_reasoning_engine_runtime_revisions(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_list_reasoning_engine_runtime_revisions(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = AsyncReasoningEngineRuntimeRevisionServiceRestTransport(interceptor=MyCustomReasoningEngineRuntimeRevisionServiceInterceptor())
        client = async ReasoningEngineRuntimeRevisionServiceClient(transport=transport)


    """

    async def pre_delete_reasoning_engine_runtime_revision(
        self,
        ...
        """Pre-rpc interceptor for delete_reasoning_engine_runtime_revision

        Override in a subclass to manipulate the request or metadata
        before they are sent to the ReasoningEngineRuntimeRevisionService server.
        """
        return request, metadata

    async def post_delete_reasoning_engine_runtime_revision(
        self, response: operations_pb2.Operation
    ) -> operations_pb2.Operation:
        """Post-rpc interceptor for delete_reasoning_engine_runtime_revision

        DEPRECATED. Please use the `post_delete_reasoning_engine_runtime_revision_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the ReasoningEngineRuntimeRevisionService server but before
        it is returned to user code. This `post_delete_reasoning_engine_runtime_revision` interceptor runs
        before the `post_delete_reasoning_engine_runtime_revision_with_metadata` interceptor.
        """
        return response

    async def post_delete_reasoning_engine_runtime_revision_with_metadata(
        self,
        ...
        is returned by the ReasoningEngineRuntimeRevisionService server but before it is returned to user code.

        We recommend only using this `post_delete_reasoning_engine_runtime_revision_with_metadata`
        interceptor in new development instead of the `post_delete_reasoning_engine_runtime_revision` interceptor.
        When both interceptors are used, this `post_delete_reasoning_engine_runtime_revision_with_metadata` interceptor runs after the
        `post_delete_reasoning_engine_runtime_revision` interceptor. The (possibly modified) response returned by
        `post_delete_reasoning_engine_runtime_revision` will be passed to
        `post_delete_reasoning_engine_runtime_revision_with_metadata`.
        """
        return response, metadata

    async def pre_get_reasoning_engine_runtime_revision(
        self,
        ...
        """Pre-rpc interceptor for get_reasoning_engine_runtime_revision
    ...
    async def post_get_reasoning_engine_runtime_revision(
        self, response: reasoning_engine_runtime_revision.ReasoningEngineRuntimeRevision
    ) -> reasoning_engine_runtime_revision.ReasoningEngineRuntimeRevision:
        """Post-rpc interceptor for get_reasoning_engine_runtime_revision

        DEPRECATED. Please use the `post_get_reasoning_engine_runtime_revision_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the ReasoningEngineRuntimeRevisionService server but before
        it is returned to user code. This `post_get_reasoning_engine_runtime_revision` interceptor runs
        before the `post_get_reasoning_engine_runtime_revision_with_metadata` interceptor.
        """
        return response

    async def post_get_reasoning_engine_runtime_revision_with_metadata(
        self,
        response: reasoning_engine_runtime_revision.ReasoningEngineRuntimeRevision,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        reasoning_engine_runtime_revision.ReasoningEngineRuntimeRevision,
        Sequence[Tuple[str, Union[str, bytes]]],
        ...
        We recommend only using this `post_get_reasoning_engine_runtime_revision_with_metadata`
        interceptor in new development instead of the `post_get_reasoning_engine_runtime_revision` interceptor.
        When both interceptors are used, this `post_get_reasoning_engine_runtime_revision_with_metadata` interceptor runs after the
        `post_get_reasoning_engine_runtime_revision` interceptor. The (possibly modified) response returned by
        `post_get_reasoning_engine_runtime_revision` will be passed to
        `post_get_reasoning_engine_runtime_revision_with_metadata`.
        """
        return response, metadata

    async def pre_list_reasoning_engine_runtime_revisions(
        self,
        ...
        """Pre-rpc interceptor for list_reasoning_engine_runtime_revisions
    ...
    async def post_list_reasoning_engine_runtime_revisions(
        self,
        response: reasoning_engine_runtime_revision_service.ListReasoningEngineRuntimeRevisionsResponse,
    ) -> (
        reasoning_engine_runtime_revision_service.ListReasoningEngineRuntimeRevisionsResponse
    ):
        """Post-rpc interceptor for list_reasoning_engine_runtime_revisions

        DEPRECATED. Please use the `post_list_reasoning_engine_runtime_revisions_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the ReasoningEngineRuntimeRevisionService server but before
        it is returned to user code. This `post_list_reasoning_engine_runtime_revisions` interceptor runs
        before the `post_list_reasoning_engine_runtime_revisions_with_metadata` interceptor.
        """
        return response

    async def post_list_reasoning_engine_runtime_revisions_with_metadata(
        self,
        response: reasoning_engine_runtime_revision_service.ListReasoningEngineRuntimeRevisionsResponse,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        ...
        We recommend only using this `post_list_reasoning_engine_runtime_revisions_with_metadata`
        interceptor in new development instead of the `post_list_reasoning_engine_runtime_revisions` interceptor.
        When both interceptors are used, this `post_list_reasoning_engine_runtime_revisions_with_metadata` interceptor runs after the
        `post_list_reasoning_engine_runtime_revisions` interceptor. The (possibly modified) response returned by
        `post_list_reasoning_engine_runtime_revisions` will be passed to
        `post_list_reasoning_engine_runtime_revisions_with_metadata`.
        """
        return response, metadata
...
class AsyncReasoningEngineRuntimeRevisionServiceRestStub:
    _session: AsyncAuthorizedSession
    _host: str
    _interceptor: AsyncReasoningEngineRuntimeRevisionServiceRestInterceptor


class AsyncReasoningEngineRuntimeRevisionServiceRestTransport(
    _BaseReasoningEngineRuntimeRevisionServiceRestTransport
):
    """Asynchronous REST backend transport for ReasoningEngineRuntimeRevisionService.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            interceptor (Optional[AsyncReasoningEngineRuntimeRevisionServiceRestInterceptor]): Interceptor used
        ...
        self._interceptor = (
            interceptor or AsyncReasoningEngineRuntimeRevisionServiceRestInterceptor()
        )
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_reasoning_engine_runtime_revision: self._wrap_method(
                self.get_reasoning_engine_runtime_revision,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_reasoning_engine_runtime_revisions: self._wrap_method(
                self.list_reasoning_engine_runtime_revisions,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_reasoning_engine_runtime_revision: self._wrap_method(
                self.delete_reasoning_engine_runtime_revision,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    class _DeleteReasoningEngineRuntimeRevision(
        _BaseReasoningEngineRuntimeRevisionServiceRestTransport._BaseDeleteReasoningEngineRuntimeRevision,
        AsyncReasoningEngineRuntimeRevisionServiceRestStub,
    ):
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineRuntimeRevisionServiceRestTransport.DeleteReasoningEngineRuntimeRevision"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            r"""Call the delete reasoning engine
            runtime revision method over HTTP.
            ...
            request, metadata = (
                await self._interceptor.pre_delete_reasoning_engine_runtime_revision(
                    request, metadata
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceClient.DeleteReasoningEngineRuntimeRevision",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "DeleteReasoningEngineRuntimeRevision",
            ...
            # Send the request
            response = await AsyncReasoningEngineRuntimeRevisionServiceRestTransport._DeleteReasoningEngineRuntimeRevision._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            resp = (
                await self._interceptor.post_delete_reasoning_engine_runtime_revision(
                    resp
                )
            )
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = (
                await self._interceptor.post_delete_reasoning_engine_runtime_revision_with_metadata(
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceAsyncClient.delete_reasoning_engine_runtime_revision",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "DeleteReasoningEngineRuntimeRevision",
    ...
    class _GetReasoningEngineRuntimeRevision(
        _BaseReasoningEngineRuntimeRevisionServiceRestTransport._BaseGetReasoningEngineRuntimeRevision,
        AsyncReasoningEngineRuntimeRevisionServiceRestStub,
    ):
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineRuntimeRevisionServiceRestTransport.GetReasoningEngineRuntimeRevision"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            r"""Call the get reasoning engine
            runtime revision method over HTTP.
                ...
                Returns:
                    ~.reasoning_engine_runtime_revision.ReasoningEngineRuntimeRevision:
                        ReasoningEngineRuntimeRevision is a
                    specific version of the runtime related
                    part of ReasoningEngine. Contains only
                    the fields that are revision specific.
            ...
            request, metadata = (
                await self._interceptor.pre_get_reasoning_engine_runtime_revision(
                    request, metadata
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceClient.GetReasoningEngineRuntimeRevision",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "GetReasoningEngineRuntimeRevision",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = await AsyncReasoningEngineRuntimeRevisionServiceRestTransport._GetReasoningEngineRuntimeRevision._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            # Return the response
            resp = reasoning_engine_runtime_revision.ReasoningEngineRuntimeRevision()
            pb_resp = (
                reasoning_engine_runtime_revision.ReasoningEngineRuntimeRevision.pb(
                    resp
                )
            )
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_get_reasoning_engine_runtime_revision(
                resp
            )
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = (
                await self._interceptor.post_get_reasoning_engine_runtime_revision_with_metadata(
                    resp, response_metadata
                )
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = reasoning_engine_runtime_revision.ReasoningEngineRuntimeRevision.to_json(
                        response
                    )
                except:
                    response_payload = None
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceAsyncClient.get_reasoning_engine_runtime_revision",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "GetReasoningEngineRuntimeRevision",
                        "metadata": http_response["headers"],
    ...
    class _ListReasoningEngineRuntimeRevisions(
        _BaseReasoningEngineRuntimeRevisionServiceRestTransport._BaseListReasoningEngineRuntimeRevisions,
        AsyncReasoningEngineRuntimeRevisionServiceRestStub,
    ):
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineRuntimeRevisionServiceRestTransport.ListReasoningEngineRuntimeRevisions"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            r"""Call the list reasoning engine
            runtime revisions method over HTTP.
            ...
            request, metadata = (
                await self._interceptor.pre_list_reasoning_engine_runtime_revisions(
                    request, metadata
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceClient.ListReasoningEngineRuntimeRevisions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "ListReasoningEngineRuntimeRevisions",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = await AsyncReasoningEngineRuntimeRevisionServiceRestTransport._ListReasoningEngineRuntimeRevisions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            pb_resp = reasoning_engine_runtime_revision_service.ListReasoningEngineRuntimeRevisionsResponse.pb(
                resp
            )
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_list_reasoning_engine_runtime_revisions(
                resp
            )
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = (
                await self._interceptor.post_list_reasoning_engine_runtime_revisions_with_metadata(
                    resp, response_metadata
                )
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = reasoning_engine_runtime_revision_service.ListReasoningEngineRuntimeRevisionsResponse.to_json(
                        response
                    )
                except:
                    response_payload = None
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceAsyncClient.list_reasoning_engine_runtime_revisions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "ListReasoningEngineRuntimeRevisions",
                        "metadata": http_response["headers"],
    ...
    @property
    def delete_reasoning_engine_runtime_revision(
        self,
    ) -> Callable[
        [
            reasoning_engine_runtime_revision_service.DeleteReasoningEngineRuntimeRevisionRequest
        ...
        return self._DeleteReasoningEngineRuntimeRevision(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def get_reasoning_engine_runtime_revision(
        self,
    ) -> Callable[
        [
            reasoning_engine_runtime_revision_service.GetReasoningEngineRuntimeRevisionRequest
        ...
        return self._GetReasoningEngineRuntimeRevision(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def list_reasoning_engine_runtime_revisions(
        self,
    ) -> Callable[
        [
            reasoning_engine_runtime_revision_service.ListReasoningEngineRuntimeRevisionsRequest
        ...
        return self._ListReasoningEngineRuntimeRevisions(self._session, self._host, self._interceptor)  # type: ignore
    ...
    class _GetLocation(
        ...
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineRuntimeRevisionServiceRestTransport.GetLocation"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = await AsyncReasoningEngineRuntimeRevisionServiceRestTransport._GetLocation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(
        ...
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineRuntimeRevisionServiceRestTransport.ListLocations"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
            ...
            # Send the request
            response = await AsyncReasoningEngineRuntimeRevisionServiceRestTransport._ListLocations._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _GetIamPolicy(
        ...
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineRuntimeRevisionServiceRestTransport.GetIamPolicy"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
            ...
            # Send the request
            response = await AsyncReasoningEngineRuntimeRevisionServiceRestTransport._GetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceAsyncClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _SetIamPolicy(
        ...
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineRuntimeRevisionServiceRestTransport.SetIamPolicy"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
            ...
            # Send the request
            response = await AsyncReasoningEngineRuntimeRevisionServiceRestTransport._SetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceAsyncClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _TestIamPermissions(
        ...
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineRuntimeRevisionServiceRestTransport.TestIamPermissions"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
            ...
            # Send the request
            response = await AsyncReasoningEngineRuntimeRevisionServiceRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceAsyncClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(
        ...
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineRuntimeRevisionServiceRestTransport.CancelOperation"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
            ...
            # Send the request
            response = await AsyncReasoningEngineRuntimeRevisionServiceRestTransport._CancelOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _DeleteOperation(
        ...
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineRuntimeRevisionServiceRestTransport.DeleteOperation"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
            ...
            # Send the request
            response = await AsyncReasoningEngineRuntimeRevisionServiceRestTransport._DeleteOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _GetOperation(
        ...
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineRuntimeRevisionServiceRestTransport.GetOperation"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
            ...
            # Send the request
            response = await AsyncReasoningEngineRuntimeRevisionServiceRestTransport._GetOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(
        ...
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineRuntimeRevisionServiceRestTransport.ListOperations"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
            ...
            # Send the request
            response = await AsyncReasoningEngineRuntimeRevisionServiceRestTransport._ListOperations._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
    ...
    class _WaitOperation(
        ...
        def __hash__(self):
            return hash(
                "AsyncReasoningEngineRuntimeRevisionServiceRestTransport.WaitOperation"
            )
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
            ...
            # Send the request
            response = await AsyncReasoningEngineRuntimeRevisionServiceRestTransport._WaitOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ReasoningEngineRuntimeRevisionServiceAsyncClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService",
                        "rpcName": "WaitOperation",
                        "httpResponse": http_response,
