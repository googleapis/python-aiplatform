...
class ReasoningEngineRuntimeRevisionServiceClient(
    metaclass=ReasoningEngineRuntimeRevisionServiceClientMeta
):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                ReasoningEngineRuntimeRevisionServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = ReasoningEngineRuntimeRevisionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = (
            ReasoningEngineRuntimeRevisionServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            ReasoningEngineRuntimeRevisionServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, ReasoningEngineRuntimeRevisionServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                ReasoningEngineRuntimeRevisionServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ReasoningEngineRuntimeRevisionServiceClient._get_api_endpoint(
    ...
    def get_reasoning_engine_runtime_revision(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_reasoning_engine_runtime_revision
        ]
    ...
    def list_reasoning_engine_runtime_revisions(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_reasoning_engine_runtime_revisions
        ]
    ...
    def delete_reasoning_engine_runtime_revision(
        ...
        *,
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_reasoning_engine_runtime_revision
        ]
...
__all__ = ("ReasoningEngineRuntimeRevisionServiceClient",)
