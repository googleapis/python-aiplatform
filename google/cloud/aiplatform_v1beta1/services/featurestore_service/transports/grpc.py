...
class FeaturestoreServiceGrpcTransport(FeaturestoreServiceTransport):
  ...
  def create_featurestore(
      self,
  ) -> Callable[[featurestore_service.CreateFeaturestoreRequest],
    ...
    if "create_featurestore" not in self._stubs:
      self._stubs["create_featurestore"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.CreateFeaturestoreRequest
          .serialize,
  ...
  def get_featurestore(
      self,
  ) -> Callable[[featurestore_service.GetFeaturestoreRequest],
    ...
    if "get_featurestore" not in self._stubs:
      self._stubs["get_featurestore"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.GetFeaturestoreRequest
          .serialize,
  ...
  def list_featurestores(
      self,
  ) -> Callable[[featurestore_service.ListFeaturestoresRequest],
    ...
    if "list_featurestores" not in self._stubs:
      self._stubs["list_featurestores"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.ListFeaturestoresRequest
          .serialize,
          response_deserializer=featurestore_service.ListFeaturestoresResponse
          .deserialize,
      )
  ...
  def update_featurestore(
      self,
  ) -> Callable[[featurestore_service.UpdateFeaturestoreRequest],
                operations_pb2.Operation]:
    ...
    if "update_featurestore" not in self._stubs:
      self._stubs["update_featurestore"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.UpdateFeaturestoreRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def delete_featurestore(
      self,
  ) -> Callable[[featurestore_service.DeleteFeaturestoreRequest],
                operations_pb2.Operation]:
    ...
    if "delete_featurestore" not in self._stubs:
      self._stubs["delete_featurestore"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.DeleteFeaturestoreRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def create_entity_type(
      self,
  ) -> Callable[[featurestore_service.CreateEntityTypeRequest],
                operations_pb2.Operation]:
    ...
    if "create_entity_type" not in self._stubs:
      self._stubs["create_entity_type"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.CreateEntityTypeRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def get_entity_type(
      self,
  ) -> Callable[[featurestore_service.GetEntityTypeRequest],
    ...
    if "get_entity_type" not in self._stubs:
      self._stubs["get_entity_type"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.GetEntityTypeRequest
          .serialize,
  ...
  def list_entity_types(
      self,
  ) -> Callable[[featurestore_service.ListEntityTypesRequest],
    ...
    if "list_entity_types" not in self._stubs:
      self._stubs["list_entity_types"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.ListEntityTypesRequest
          .serialize,
          response_deserializer=featurestore_service.ListEntityTypesResponse
          .deserialize,
      )
  ...
  def update_entity_type(
      self,
  ) -> Callable[[featurestore_service.UpdateEntityTypeRequest],
    ...
    if "update_entity_type" not in self._stubs:
      self._stubs["update_entity_type"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.UpdateEntityTypeRequest
          .serialize,
  ...
  def delete_entity_type(
      self,
  ) -> Callable[[featurestore_service.DeleteEntityTypeRequest],
                operations_pb2.Operation]:
    ...
    if "delete_entity_type" not in self._stubs:
      self._stubs["delete_entity_type"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.DeleteEntityTypeRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def create_feature(
      self,
  ) -> Callable[[featurestore_service.CreateFeatureRequest],
                operations_pb2.Operation]:
    ...
    if "create_feature" not in self._stubs:
      self._stubs["create_feature"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.CreateFeatureRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def batch_create_features(
      self,
  ) -> Callable[[featurestore_service.BatchCreateFeaturesRequest],
                operations_pb2.Operation]:
    ...
    if "batch_create_features" not in self._stubs:
      self._stubs["batch_create_features"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.BatchCreateFeaturesRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def list_features(
      self,
  ) -> Callable[[featurestore_service.ListFeaturesRequest],
    ...
    if "list_features" not in self._stubs:
      self._stubs["list_features"] = self.grpc_channel.unary_unary(
          ...
          response_deserializer=featurestore_service.ListFeaturesResponse
          .deserialize,
      )
  ...
  def update_feature(
      self,
  ) -> Callable[[featurestore_service.UpdateFeatureRequest],
                gca_feature.Feature]:
    ...
    if "update_feature" not in self._stubs:
      self._stubs["update_feature"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.UpdateFeatureRequest
          .serialize,
  ...
  def delete_feature(
      self,
  ) -> Callable[[featurestore_service.DeleteFeatureRequest],
                operations_pb2.Operation]:
    ...
    if "delete_feature" not in self._stubs:
      self._stubs["delete_feature"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.DeleteFeatureRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def import_feature_values(
      self,
  ) -> Callable[[featurestore_service.ImportFeatureValuesRequest],
                operations_pb2.Operation]:
    ...
    if "import_feature_values" not in self._stubs:
      self._stubs["import_feature_values"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.ImportFeatureValuesRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def batch_read_feature_values(
    ...
    if "batch_read_feature_values" not in self._stubs:
      self._stubs["batch_read_feature_values"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.BatchReadFeatureValuesRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def export_feature_values(
      self,
  ) -> Callable[[featurestore_service.ExportFeatureValuesRequest],
                operations_pb2.Operation]:
    ...
    if "export_feature_values" not in self._stubs:
      self._stubs["export_feature_values"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.ExportFeatureValuesRequest
          .serialize,
          response_deserializer=operations_pb2.Operation.FromString,
      )
  ...
  def search_features(
      self,
  ) -> Callable[[featurestore_service.SearchFeaturesRequest],
    ...
    if "search_features" not in self._stubs:
      self._stubs["search_features"] = self.grpc_channel.unary_unary(
          ...
          request_serializer=featurestore_service.SearchFeaturesRequest
          .serialize,
          response_deserializer=featurestore_service.SearchFeaturesResponse
          .deserialize,
      )
