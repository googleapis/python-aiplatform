...
class FeaturestoreServiceTransport(abc.ABC):
    ...
    def get_featurestore(
        ...
        typing.Union[
            featurestore.Featurestore, typing.Awaitable[featurestore.Featurestore]
        ],
    ]:
        raise NotImplementedError()
    ...
    def update_entity_type(
        ...
        typing.Union[
            gca_entity_type.EntityType, typing.Awaitable[gca_entity_type.EntityType]
        ],
    ]:
        raise NotImplementedError()
    ...
    def get_feature(
        ...
        typing.Union[feature.Feature, typing.Awaitable[feature.Feature]],
    ]:
        raise NotImplementedError()
    ...
    def update_feature(
        ...
        typing.Union[gca_feature.Feature, typing.Awaitable[gca_feature.Feature]],
    ]:
        raise NotImplementedError()
