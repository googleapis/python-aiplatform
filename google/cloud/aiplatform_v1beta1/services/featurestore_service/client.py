...
class FeaturestoreServiceClient(metaclass=FeaturestoreServiceClientMeta):
    ...
    """Instantiates the featurestore service client.
        ...
        Args:
            credentials (Optional[google.auth.credentials.Credentials]): The
              ...
              environment.
            transport (Union[str, FeaturestoreServiceTransport]): The transport
  ...
  def create_featurestore(
      self,
      request: Union[featurestore_service.CreateFeaturestoreRequest,
                     dict] = None,
      *,
      parent: str = None,
    ...
    r"""Creates a new Featurestore in a given project and
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CreateFeaturestoreRequest,
            ...
            featurestore (google.cloud.aiplatform_v1beta1.types.Featurestore):
              ...
              ``featurestore`` field on the ``request`` instance; if ``request``
              is provided, this should not be set.
            featurestore_id (str): Required. The ID to use for this
              ...
              project and location.  This corresponds to the ``featurestore_id``
  ...
  def get_featurestore(
    ...
    r"""Gets details of a single Featurestore.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetFeaturestoreRequest,
              dict]): The request object. Request message for
              [FeaturestoreService.GetFeaturestore][google.cloud.aiplatform.v1beta1.FeaturestoreService.GetFeaturestore].
            name (str): Required. The name of the Featurestore resource.  This
  ...
  def list_featurestores(
      self,
      request: Union[featurestore_service.ListFeaturestoresRequest,
                     dict] = None,
      *,
      parent: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Lists Featurestores in a given project and location.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListFeaturestoresRequest,
              dict]): The request object. Request message for
  ...
  def update_featurestore(
      self,
      request: Union[featurestore_service.UpdateFeaturestoreRequest,
                     dict] = None,
      *,
      featurestore: gca_featurestore.Featurestore = None,
    ...
    r"""Updates the parameters of a single Featurestore.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.UpdateFeaturestoreRequest,
              dict]): The request object. Request message for
              [FeaturestoreService.UpdateFeaturestore][google.cloud.aiplatform.v1beta1.FeaturestoreService.UpdateFeaturestore].
            featurestore (google.cloud.aiplatform_v1beta1.types.Featurestore):
              Required. The Featurestore's ``name`` field is used to identify
              the Featurestore to be updated. Format:
              ``projects/{project}/locations/{location}/featurestores/{featurestore}``
              This corresponds to the ``featurestore`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            update_mask (google.protobuf.field_mask_pb2.FieldMask): Field mask
              is used to specify the fields to be overwritten in the
              Featurestore resource by the update. The fields specified in the
              ...
              not provide a mask then only the non-empty fields present in the
              request will be overwritten. Set the update_mask to ``*`` to
              override all fields.  Updatable fields:  -  ``labels`` -
              ``online_serving_config.fixed_node_count`` -
              ``online_serving_config.scaling``  This corresponds to the
  ...
  def delete_featurestore(
      self,
      request: Union[featurestore_service.DeleteFeaturestoreRequest,
                     dict] = None,
      *,
      name: str = None,
      force: bool = None,
    ...
    r"""Deletes a single Featurestore.

    The Featurestore must not contain
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeleteFeaturestoreRequest,
              dict]): The request object. Request message for
            ...
            force (bool): If set to true, any EntityTypes and Features for this
              ...
              only work if the Featurestore has no EntityTypes.)  This
              corresponds to the ``force`` field on the ``request`` instance; if
              ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
            timeout (float): The timeout for this request.
    ...
    r"""Creates a new EntityType in a given Featurestore.
        ...
        Args:
            ...
            entity_type_id (str): Required. The ID to use for the EntityType,
              ...
              value must be unique within a featurestore.  This corresponds to
              the ``entity_type_id`` field on the ``request`` instance; if
              ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
            timeout (float): The timeout for this request.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.aiplatform_v1beta1.types.EntityType` An
                entity type is a type of object in a system that needs to be
                modeled and
  ...
  def get_entity_type(
    ...
    r"""Gets details of a single EntityType.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetEntityTypeRequest,
              dict]): The request object. Request message for
  ...
  def update_entity_type(
    ...
    r"""Updates the parameters of a single EntityType.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.UpdateEntityTypeRequest,
              dict]): The request object. Request message for
            ...
            entity_type (google.cloud.aiplatform_v1beta1.types.EntityType):
              ...
              instance; if ``request`` is provided, this should not be set.
            update_mask (google.protobuf.field_mask_pb2.FieldMask): Field mask
              is used to specify the fields to be overwritten in the EntityType
              ...
              be overwritten if it is in the mask. If the user does not provide
              a mask then only the non-empty fields present in the request will
              be overwritten. Set the update_mask to ``*`` to override all
              fields.  Updatable fields:  -  ``description`` -  ``labels`` -
              ...
              ``monitoring_config.categorical_threshold_config.value``  This
  ...
  def delete_entity_type(
    ...
    r"""Deletes a single EntityType.

    The EntityType must not have any
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeleteEntityTypeRequest,
              dict]): The request object. Request message for
              [FeaturestoreService.DeleteEntityTypes][].
            name (str): Required. The name of the EntityType to be deleted.
                Format:
                  ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}``
                  This corresponds to the ``name`` field on the ``request``
                  instance; if ``request`` is provided, this should not be set.
            force (bool): If set to true, any Features for this EntityType will
              ...
              EntityType has no Features.)  This corresponds to the ``force``
              field on the ``request`` instance; if ``request`` is provided,
              this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
  ...
  def create_feature(
    ...
    r"""Creates a new Feature in a given EntityType.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.CreateFeatureRequest,
              dict]): The request object. Request message for
              [FeaturestoreService.CreateFeature][google.cloud.aiplatform.v1beta1.FeaturestoreService.CreateFeature].
            parent (str): Required. The resource name of the EntityType to
              create a Feature. Format:
              ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}``
              This corresponds to the ``parent`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            feature (google.cloud.aiplatform_v1beta1.types.Feature): Required.
              The Feature to create. This corresponds to the ``feature`` field
            ...
            feature_id (str): Required. The ID to use for the Feature, which
              ...
              ``[a-z0-9_]``. The first character cannot be a number.  The value
              must be unique within an EntityType.  This corresponds to the
              ``feature_id`` field on the ``request`` instance; if ``request``
              is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
            timeout (float): The timeout for this request.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.aiplatform_v1beta1.types.Feature` Feature
                Metadata information that describes an attribute of an entity
                type.
  ...
  def batch_create_features(
      self,
      request: Union[featurestore_service.BatchCreateFeaturesRequest,
                     dict] = None,
      *,
      parent: str = None,
    ...
    r"""Creates a batch of Features in a given EntityType.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.BatchCreateFeaturesRequest,
              dict]): The request object. Request message for
            ...
            requests
              ...
              Required. The request message specifying the Features to create.
              ...
              ``parent`` is set in a child request, then the value must match
              the ``parent`` value in this request message.  This corresponds to
              the ``requests`` field on the ``request`` instance; if ``request``
              is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
            timeout (float): The timeout for this request.
    ...
    rpc = self._transport._wrapped_methods[
        self._transport.batch_create_features]
  ...
  def get_feature(
    ...
    r"""Gets details of a single Feature.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.GetFeatureRequest,
              dict]): The request object. Request message for
  ...
  def list_features(
    ...
    r"""Lists Features in a given EntityType.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ListFeaturesRequest,
              dict]): The request object. Request message for
  ...
  def update_feature(
    ...
    r"""Updates the parameters of a single Feature.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.UpdateFeatureRequest,
              dict]): The request object. Request message for
              [FeaturestoreService.UpdateFeature][google.cloud.aiplatform.v1beta1.FeaturestoreService.UpdateFeature].
            feature (google.cloud.aiplatform_v1beta1.types.Feature): Required.
              The Feature's ``name`` field is used to identify the Feature to be
              updated. Format:
              ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}/features/{feature}``
              This corresponds to the ``feature`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            update_mask (google.protobuf.field_mask_pb2.FieldMask): Field mask
              is used to specify the fields to be overwritten in the Features
              resource by the update. The fields specified in the update_mask
              are relative to the resource, not the full request. A field will
              be overwritten if it is in the mask. If the user does not provide
              a mask then only the non-empty fields present in the request will
              be overwritten. Set the update_mask to ``*`` to override all
              fields.  Updatable fields:  -  ``description`` -  ``labels`` -
              ``disable_monitoring``  This corresponds to the ``update_mask``
              field on the ``request`` instance; if ``request`` is provided,
              this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
  ...
  def delete_feature(
    ...
    r"""Deletes a single Feature.
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.DeleteFeatureRequest,
              dict]): The request object. Request message for
              [FeaturestoreService.DeleteFeature][google.cloud.aiplatform.v1beta1.FeaturestoreService.DeleteFeature].
            name (str): Required. The name of the Features to be deleted.
                Format:
                  ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}/features/{feature}``
                  This corresponds to the ``name`` field on the ``request``
                  instance; if ``request`` is provided, this should not be set.
  ...
  def import_feature_values(
      self,
      request: Union[featurestore_service.ImportFeatureValuesRequest,
                     dict] = None,
      *,
    ...
    r"""Imports Feature values into the Featurestore from a
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ImportFeatureValuesRequest,
              dict]): The request object. Request message for
            ...
            entity_type (str): Required. The resource name of the EntityType
              grouping the Features for which values are being imported.
                Format:
                  ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entityType}``
                  This corresponds to the ``entity_type`` field on the
    ...
    # and friendly error handling.
    rpc = self._transport._wrapped_methods[
        self._transport.import_feature_values]
    ...
    r"""Batch reads Feature values from a Featurestore.
        ...
        .. code-block:: python
            ...
            def sample_batch_read_feature_values():
                ...
                csv_read_instances.gcs_source.uris = ['uris_value_1',
                'uris_value_2']
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.BatchReadFeatureValuesRequest,
              dict]): The request object. Request message for
              [FeaturestoreService.BatchReadFeatureValues][google.cloud.aiplatform.v1beta1.FeaturestoreService.BatchReadFeatureValues].
            featurestore (str): Required. The resource name of the Featurestore
  ...
  def export_feature_values(
      self,
      request: Union[featurestore_service.ExportFeatureValuesRequest,
                     dict] = None,
      *,
      entity_type: str = None,
      retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    r"""Exports Feature values from all the entities of a
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.ExportFeatureValuesRequest,
              dict]): The request object. Request message for
              [FeaturestoreService.ExportFeatureValues][google.cloud.aiplatform.v1beta1.FeaturestoreService.ExportFeatureValues].
            entity_type (str): Required. The resource name of the EntityType
              from which to export Feature values. Format:
              ``projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}``
              This corresponds to the ``entity_type`` field on the ``request``
              instance; if ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
    ...
    # and friendly error handling.
    rpc = self._transport._wrapped_methods[
        self._transport.export_feature_values]
  ...
  def search_features(
    ...
    r"""Searches Features matching a query in a given
        ...
        Args:
            request
              (Union[google.cloud.aiplatform_v1beta1.types.SearchFeaturesRequest,
              dict]): The request object. Request message for
              [FeaturestoreService.SearchFeatures][google.cloud.aiplatform.v1beta1.FeaturestoreService.SearchFeatures].
            location (str): Required. The resource name of the Location to
              search Features. Format:
              ``projects/{project}/locations/{location}``  This corresponds to
              the ``location`` field on the ``request`` instance; if ``request``
              is provided, this should not be set.
            query (str): Query string that is a conjunction of field-restricted
              queries and/or field-restricted filters. Field-restricted queries
              and filters can be combined using ``AND`` to form a conjunction.
              A field query is in the form FIELD:QUERY. This implicitly checks
              if QUERY exists as a substring within Feature's FIELD. The QUERY
              and the FIELD are converted to a sequence of words (i.e. tokens)
              for comparison. This is done by:  -  Removing leading/trailing
              whitespace and tokenizing the search value. Characters that are
              not one of alphanumeric ``[a-zA-Z0-9]``, underscore ``_``, or
              asterisk ``*`` are treated as delimiters for tokens. ``*`` is
              treated as a wildcard that matches characters within a token. -
              Ignoring case. -  Prepending an asterisk to the first and
              appending an asterisk to the last token in QUERY.  A QUERY must be
              either a singular token or a phrase. A phrase is one or multiple
              words enclosed in double quotation marks ("). With phrases, the
              order of the words is important. Words in the phrase must be
              matching in order and consecutively.  Supported FIELDs for
              ...
              ``entity_type_id``
                Examples:  -  ``feature_id: foo`` --> Matches a Feature with ID
                  ...
                  ``barfoo``). -  ``feature_id: foo*feature`` --> Matches a
                  Feature with ID containing the substring ``foo*feature`` (eg.
                  ``foobarfeature``). -  ``feature_id: foo AND description:
                  bar`` --> Matches a Feature with ID containing the substring
                  ``foo`` and description containing the substring ``bar``.
                  ...
                  case-sensitive.  -  ``feature_id``: Supports = comparisons. -
                  ``description``: Supports = comparisons. Multi-token filters
                  should be enclosed in quotes. -  ``entity_type_id``: Supports
                  = comparisons. -  ``value_type``: Supports = and !=
                  comparisons. -  ``labels``: Supports key-value equality as
                  well as key presence. -  ``featurestore_id``: Supports =
                  comparisons.
                Examples:  -  ``description = "foo bar"`` --> Any Feature with
                  ...
                  = yes AND labels.env = prod`` --> Features having both
                  (active: yes) and (env: prod) labels. -  ``labels.env: *`` -->
                  Any Feature which has a label with ``env`` as the key.  This
