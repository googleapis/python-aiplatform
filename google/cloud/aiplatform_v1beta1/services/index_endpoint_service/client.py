  ...
  def create_index_endpoint(
    ...
    r"""Creates an IndexEndpoint.
        ...
        Args:
            ...
            index_endpoint
              (google.cloud.aiplatform_v1beta1.types.IndexEndpoint): Required.
    ...
    r"""Deploys an Index into this IndexEndpoint, creating a
        ...
        Args:
            ...
            index_endpoint (str): Required. The name of the IndexEndpoint
              ...
              be set.
            deployed_index
              (google.cloud.aiplatform_v1beta1.types.DeployedIndex): Required.
    ...
    r"""Undeploys an Index from an IndexEndpoint, removing a
        ...
        Args:
            ...
            deployed_index_id (str): Required. The ID of the DeployedIndex to be
              undeployed from the IndexEndpoint.  This corresponds to the
              ``deployed_index_id`` field on the ``request`` instance; if
              ``request`` is provided, this should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if
              any, should be retried.
            timeout (float): The timeout for this request.
  ...
  def mutate_deployed_index(
    ...
    r"""Update an existing DeployedIndex under an
        ...
        Args:
            ...
            deployed_index
              (google.cloud.aiplatform_v1beta1.types.DeployedIndex): Required.
              The DeployedIndex to be updated within the IndexEndpoint.
