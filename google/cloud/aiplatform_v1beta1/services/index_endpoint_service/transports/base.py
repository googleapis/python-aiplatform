...
class IndexEndpointServiceTransport(abc.ABC):
  ...
  def create_index_endpoint(
      self,
  ) -> Callable[[index_endpoint_service.CreateIndexEndpointRequest], Union[
  ...
  def get_index_endpoint(
      self,
  ) -> Callable[[index_endpoint_service.GetIndexEndpointRequest], Union[
      index_endpoint.IndexEndpoint, Awaitable[index_endpoint.IndexEndpoint]],]:
    raise NotImplementedError()

  @property
  def list_index_endpoints(
      self,
  ) -> Callable[[index_endpoint_service.ListIndexEndpointsRequest], Union[
  ...
  def update_index_endpoint(
      self,
  ) -> Callable[[index_endpoint_service.UpdateIndexEndpointRequest],
                Union[gca_index_endpoint.IndexEndpoint,
  ...
  def delete_index_endpoint(
      self,
  ) -> Callable[[index_endpoint_service.DeleteIndexEndpointRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def deploy_index(
      self,
  ) -> Callable[[index_endpoint_service.DeployIndexRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def undeploy_index(
      self,
  ) -> Callable[[index_endpoint_service.UndeployIndexRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
  ...
  def mutate_deployed_index(
      self,
  ) -> Callable[[index_endpoint_service.MutateDeployedIndexRequest], Union[
      operations_pb2.Operation, Awaitable[operations_pb2.Operation]],]:
    raise NotImplementedError()
