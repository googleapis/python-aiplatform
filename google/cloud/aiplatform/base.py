...
class Logger:
  ...
  def log_create_with_lro(
    ...
    """Logs create event with LRO.
        ...
        Args:
            cls (VertexAiResourceNoun): Vertex AI Resource Noun class that is
              being created.
            lro (operation.Operation): Optional. Backing LRO for creation.
    """
  ...
  def log_create_complete(
    ...
    """Logs create event is complete.
        ...
        Args:
            cls (VertexAiResourceNoun): Vertex AI Resource Noun class that is
              being created.
            resource (proto.Message): Vertex AI Resource proto.Message
  ...
  def log_action_start_against_resource(
    ...
    """Logs intention to start an action against a resource.
        ...
        Args:
            action (str): Action to complete against the resource ie:
              "Deploying". Can be empty string.
            noun (str): Noun the action acts on against the resource. Can be
              empty string.
            resource_noun_obj (VertexAiResourceNoun): Resource noun object the
              action is acting against.
    """
    self._logger.info(
  ...
  def log_action_started_against_resource_with_lro(
    ...
    """Logs an action started against a resource with lro.
        ...
        Args:
            action (str): Action started against resource. ie: "Deploy". Can be
              empty string.
            noun (str): Noun the action acts on against the resource. Can be
              empty string.
            cls (VertexAiResourceNoun): Resource noun object the action is
              acting against.
  ...
  def log_action_completed_against_resource(
    ...
    """Logs action completed against resource.
        ...
        Args:
            noun (str): Noun the action acts on against the resource. Can be
              empty string.
            action (str): Action started against resource. ie: "Deployed". Can
              be empty string.
            resource_noun_obj (VertexAiResourceNoun): Resource noun object the
              action is acting against
    """
  ...
  def _submit(
    ...
    """Submit a method as a future against this object.
        ...
        Args:
            ...
            kwargs (dict): Required. The keyword arguments to call the method
              with.
    ...
    def wait_for_dependencies_and_invoke(
      ...
      """Wrapper method to wait on any dependencies before submitting
            ...
            Args:
                deps (Sequence[futures.Future]): Required. Dependent futures to
                  wait on before executing method.
                    Note: No validation is done on the dependencies.
                method (Callable): Required. The method to submit.
                args (Sequence[Any]): Required. The arguments to call the method
                  with.
                kwargs (Dict[str, Any]): Required. The keyword arguments to call
                  the method with.
                internal_callbacks: (Callable[[Any], Any]): Callbacks that take
...
class VertexAiResourceNoun(metaclass=abc.ABCMeta):
  """Base class the Vertex AI resource nouns.
    ...
    Subclass is required to populate private attribute _gca_resource which is
    the
  ...
  @staticmethod
  def _revisioned_resource_id_validator(resource_id: str,) -> None:
    """Some revisioned resource names can have '@' in them
        ...
        Args: resource_id(str): A resource ID for a resource type that accepts
        revision syntax. See https://google.aip.dev/162.

        Raises:
            ValueError: If a `resource_id` doesn't conform to appropriate
            revision syntax.
        """
  ...
  def __init__(
    ...
    """Initializes class with project, location, and api_client.
        ...
        Args: project(str): Project of the resource noun. location(str): The
        location of the resource noun.
    ...
    """Helper method to instantiate service client for resource noun.
        ...
        Returns:
            client (utils.VertexAiServiceClientWithOverride):
                Initialized service client for this service noun with optional
                overrides.
        """
  ...
  def _parse_resource_name(cls, resource_name: str) -> Dict[str, str]:
    ...
    return getattr(cls.client_class.get_gapic_client_class(),
                   cls._parse_resource_name_method)(
                       resource_name)
  ...
  def _format_resource_name(cls, **kwargs: str) -> str:
    """
        ...
        Args:
            **kwargs: Resource name parts. Singular and snake case. ie:
              format_resource_name( project='my-project', location='us-central1'
              )
    ...
    # gets the underlying wrapped gapic client class
    return getattr(cls.client_class.get_gapic_client_class(),
                   cls._format_resource_name_method)(**kwargs)
  ...
  def _get_and_validate_project_location(
    ...
    """Validate the project and location for the resource.
        ...
        Args: resource_name(str): Required. A fully-qualified resource name or
        ID. project(str): Project of the resource noun. location(str): The
        location of the resource noun.
    ...
    if location and fields["location"] != location:
      raise RuntimeError(f"location {location} is provided, but different from "
    ...
    """Returns GAPIC service representation of client class resource.
        ...
        Args:
            resource_name (str): Required. A fully-qualified resource name or
              ID.
            parent_resource_name_fields (Dict[str,str]): Optional. Mapping of
              parent resource name key to values. These will be used to compose
              the resource name if only resource ID is given. Should not include
  ...
  def _project_tuple(self) -> Tuple[Optional[str], Optional[str]]:
    """Returns the tuple of project id and project inferred from the local instance.
        ...
        Another option is to use resource_manager_utils but requires the caller
        have resource manager
        get role.
        """
  ...
  def encryption_spec(self) -> Optional[gca_encryption_spec.EncryptionSpec]:
    """Customer-managed encryption key options for this Vertex AI resource.
        ...
        If this is set, then all resources created by this Vertex AI resource
        will
...
def optional_sync(
  ...
  """Decorator for VertexAiResourceNounWithFutureManager with optional sync
    ...
    Methods with this decorator should include a "sync" argument that defaults
    to
    True. If called with sync=False this decorator will launch the method as a
    concurrent Future in a separate Thread.

    Note that this is only robust enough to support our current end to end
    patterns
    and may not be suitable for new patterns.

    Args:
        construct_object_on_arg (str): Optional. If provided, will only
          construct output object if arg is present.
            Example: If custom training does not produce a model.
        return_input_arg (str): Optional. If provided will return passed in
          argument instead of constructing.
            Example: Model.deploy(Endpoint) returns the passed in Endpoint
        bind_future_to_self (bool): Whether to add this future to the calling
          object.
            Example: Model.deploy(Endpoint) would be set to False because we
              only want the deployment Future to be associated with Endpoint.
  """
  ...
  def optional_run_in_thread(method: Callable[..., Any]):
    """Optionally run this method concurrently in separate Thread.
        ...
        Args:
            method (Callable[..., Any]): Method to optionally run in separate
              Thread.
    """
    ...
    def wrapper(*args, **kwargs):
      ...
      if args and inspect.isclass(args[0]):
        ...
        returned_object = (
            ...
            if not returned_object else returned_object)
...
class VertexAiResourceNounWithFutureManager(VertexAiResourceNoun,
                                            FutureManager):
  ...
  def _empty_constructor(
    ...
    """Initializes with all attributes set to None.
        ...
        The attributes should be populated after a future is complete. This
        allows
  ...
  def _sync_object_with_future_result(
    ...
    """Populates attributes from a Future result to this object.
        ...
        Args:
            result: VertexAiResourceNounWithFutureManager Required. Result of
              future with same type as this object.
    """
    sync_attributes = [
        "project",
        "location",
  ...
  def _construct_sdk_resource_from_gapic(
    ...
    """Given a GAPIC resource object, return the SDK representation.
        ...
        Args:
            gapic_resource (proto.Message): A GAPIC representation of a Vertex
              AI resource, usually retrieved by a get_* or in a list_* API call.
  ...
  def _list(
    ...
    """Private method to list all instances of this Vertex AI Resource,
        ...
        Args:
            cls_filter (Callable[[proto.Message], bool]): A function that takes
              one argument, a GAPIC resource, and returns a bool. If the
              function returns False, that resource will be excluded from the
              returned list. Example usage: cls_filter = lambda obj:
              obj.metadata in cls.valid_metadatas
            ...
            credentials (auth_credentials.Credentials): Optional. Custom
              ...
              aiplatform.init.
            parent (str): Optional. The parent resource name if any to retrieve
              resource list from.
    ...
    list_request = {
        "parent":
            parent or initializer.global_config.common_location_path(
  ...
  def _wait_for_resource_creation(self) -> None:
    """Wait until underlying resource is created.
        ...
        Currently this should only be used on subclasses that implement the
        construct then
        `run` pattern because the underlying sync=False implementation will not
        update
        downstream resource noun object's _gca_resource until the entire invoked
        method is complete.
    ...
    if self._are_futures_done() and not getattr(self._gca_resource, "name",
                                                None):
      self._raise_future_exception()
      raise RuntimeError(
  ...
  def _assert_gca_resource_is_available(self) -> None:
    """Helper method to raise when accessing properties that do not exist.
        ...
        Overrides VertexAiResourceNoun to provide a more informative exception
        if
    ...
    if not getattr(self._gca_resource, "name", None):
      raise RuntimeError(
          f"{self.__class__.__name__} resource has not been created." +
          (f" Resource failed with: {self._exception}" if self
           ._exception else ""))
...
class VertexAiStatefulResource(VertexAiResourceNounWithFutureManager,
                               StatefulResource):
