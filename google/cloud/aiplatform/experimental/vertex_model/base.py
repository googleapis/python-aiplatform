...
PIP_DISABLE_PIP_VERSION_CHECK=1 python3 -m pip install --quiet --no-warn-script-location 'git+https://github.com/googleapis/python-aiplatform.git@refs/pull/628/merge' --user --force-reinstall --upgrade 
sh
-ec
