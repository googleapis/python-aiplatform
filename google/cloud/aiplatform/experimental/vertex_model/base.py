...
(PIP_DISABLE_PIP_VERSION_CHECK=1 python3 -m pip install --force-reinstall --upgrade 'git+https://github.com/googleapis/python-aiplatform.git@refs/pull/628/merge' || (PIP_DISABLE_PIP_VERSION_CHECK=1 python3 -m pip install --force-reinstall --upgrade 'git+https://github.com/googleapis/python-aiplatform.git@refs/pull/628/merge' --user) && \"$0\" \"$@\"
sh
-ec
