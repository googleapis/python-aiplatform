...
class _TrainingScriptPythonPackager:
  """Converts a Python script into Python package suitable for aiplatform
    ...
    Usage:  packager = TrainingScriptPythonPackager('my_script.py', ['pandas',
      'pytorch']) gcs_path = packager.package_and_copy_to_gcs(
      gcs_staging_dir='my-bucket', project='my-project') module_name =
      packager.module_name  The package after installed can be executed as:
...
setup(
  ...
  def __init__(
    ...
    """Initializes packager.
        ...
        Args:
            ...
            requirements (Sequence[str]): List of python packages dependencies
              of script.
    """
  ...
  def make_package(self, package_directory: str) -> str:
    ...
    setup_cmd = [_get_python_executable()
  ...
  def package_and_copy(self, copy_method: Callable[[str], str]) -> str:
    """Packages the script and executes copy with given copy_method.
        ...
        Args: copy_method Callable[[str], str] Takes a string path, copies to a
        desired location, and returns the output path location.
  ...
  def package_and_copy_to_gcs(
    ...
    """Packages script in Python package and copies package to GCS bucket.
        ...
        Args
            ...
            project (str): Required. Project where GCS Staging bucket is
            located.
