...
def upload_to_gcs(
  ...
  """Uploads local files to GCS.
    ...
    Args:
        ...
        project: Optional. Google Cloud Project that contains the staging
          bucket.
        credentials: The custom credentials to use when making API calls. If not
          provided, default credentials will be used.
  ...
  if source_path_obj.is_dir():
    ...
    for source_file_path in source_file_paths:
      ...
      _logger.debug(
          f'Uploading "{source_file_path}" to "{destination_file_uri}"')
...
def stage_local_data_in_gcs(
  ...
  """Stages a local data in GCS.
    ...
    Args:
        ...
        staging_gcs_dir: Optional. Google Cloud Storage bucket to be used for
          data staging.
        project: Optional. Google Cloud Project that contains the staging
          bucket.
