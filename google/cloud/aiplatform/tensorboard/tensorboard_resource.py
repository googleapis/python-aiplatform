...
class Tensorboard(_TensorboardServiceResource):
  ...
  def create(
    ...
    """Creates a new tensorboard.
        ...
        Args:
            display_name (str): Optional. The user-defined name of the
              Tensorboard. The name can be up to 128 characters long and can be
            ...
            labels (Dict[str, str]): Optional. Labels with user-defined metadata
              to organize your Tensorboards. Label keys and values can be no
            ...
            project (str): Optional. Project to upload this model to. Overrides
              project set in aiplatform.init.
            location (str): Optional. Location to upload this model to.
            ...
            encryption_spec_key_name (str): Optional. Cloud KMS resource
              identifier of the customer managed encryption key used to protect
              the tensorboard. Has the
                form:
                  ``projects/my-project/locations/my-region/keyRings/my-kr/cryptoKeys/my-key``.
                  The key needs to be in the same region as where the compute
                  resource is created.  If set, this Tensorboard and all
                  sub-resources of this Tensorboard will be secured by this key.
  ...
  def update(
    ...
    """Updates an existing tensorboard.
        ...
        Args:
            display_name (str): Optional. User-defined name of the Tensorboard.
...
class TensorboardExperiment(_TensorboardServiceResource):
    ...
    """Retrieves an existing tensorboard experiment given a tensorboard experiment name or ID.
        ...
        Example Usage:
            ...
            tb_exp = aiplatform.TensorboardExperiment(
                ...
                "projects/123/locations/us-central1/tensorboards/456/experiments/678"
            )
        ...
        Args:
            tensorboard_experiment_name (str): Required. A fully-qualified
              tensorboard experiment resource name or resource ID.
                Example:
                  "projects/123/locations/us-central1/tensorboards/456/experiments/678"
                  or "678" when tensorboard_id is passed and project and
                  location are initialized or passed.
    ...
    """Creates a new TensorboardExperiment.
        ...
        Args:
            tensorboard_experiment_id (str): Required. The ID to use for the
              ...
              be set.
            tensorboard_name (str): Required. The resource name or ID of the
              Tensorboard to create the TensorboardExperiment in. Format of
              resource name:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}``
            display_name (str): Optional. The user-defined name of the
              Tensorboard Experiment. The name can be up to 128 characters long
  ...
  def list(
    ...
    """List TensorboardExperiemnts in a Tensorboard resource.
        ...
        Args: tensorboard_name(str): Required. The resource name or resource ID
        of the Tensorboard to list TensorboardExperiments. Format, if resource
        name:
        'projects/{project}/locations/{location}/tensorboards/{tensorboard}'
...
class TensorboardRun(_TensorboardServiceResource):
    ...
    """Retrieves an existing tensorboard run given a tensorboard run name or ID.
        ...
        Example Usage:
            ...
            tb_run = aiplatform.TensorboardRun(
                ...
                "projects/123/locations/us-central1/tensorboards/456/experiments/678/run/8910"
            )
        ...
        Args:
            tensorboard_run_name (str): Required. A fully-qualified tensorboard
              run resource name or resource ID.
                Example:
                  "projects/123/locations/us-central1/tensorboards/456/experiments/678/runs/8910"
                  or "8910" when tensorboard_id and tensorboard_experiment_id
                  are passed and project and location are initialized or passed.
            tensorboard_id (str): Optional. A tensorboard resource ID.
            tensorboard_experiment_id (str): Optional. A tensorboard experiment
              resource ID.
            project (str): Optional. Project to retrieve tensorboard from. If
              not set, project set in aiplatform.init will be used.
            location (str): Optional. Location to retrieve tensorboard from. If
        ...
        Raises:
            ValueError: if only one of tensorboard_id or
            tensorboard_experiment_id is provided.
        """
  ...
  def create(
    ...
    """Creates a new tensorboard run.
        ...
        Args:
            ...
            tensorboard_experiment_name (str): Required. The resource name or ID
              of the TensorboardExperiment to create the TensorboardRun in.
              Resource name format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}``
              If resource ID is provided then tensorboard_id must be provided.
            tensorboard_id (str): Optional. The resource ID of the Tensorboard
              to create the TensorboardRun in.
            display_name (str): Optional. The user-defined name of the
              Tensorboard Run. This value must be unique among all
              TensorboardRuns belonging to the same parent
              TensorboardExperiment.  If not provided tensorboard_run_id will be
              used.
  ...
  def list(
    ...
    """List all instances of TensorboardRun in TensorboardExperiment.
        ...
        Args:
            tensorboard_experiment_name (str): Required. The resource name or
              resource ID of the TensorboardExperiment to list TensorboardRun.
              Format, if resource name:
              'projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}'
              If resource ID is provided then tensorboard_id must be provided.
            tensorboard_id (str): Optional. The resource ID of the Tensorboard
              that contains the TensorboardExperiment to list TensorboardRun.
            filter (str): Optional. An expression for filtering the results of
              the request. For field names both snake_case and camelCase are
              supported.
            order_by (str): Optional. A comma-separated list of fields to order
  ...
  def write_tensorboard_scalar_data(
    ...
    """Writes tensorboard scalar data to this run.
        ...
        Args:
            time_series_data (Dict[str, float]): Required. Dictionary of where
              keys are TensorboardTimeSeries display name and values are the
              scalar value..
            step (int): Required. Step index of this data point within the run.
            wall_time (timestamp_pb2.Timestamp): Optional. Wall clock timestamp
              when this data point is generated by the end user.  If not
              provided, this will be generated based on the value from
              time.time()
    """
    ...
    if any(key not in self._time_series_display_name_to_id_mapping
  ...
  def _get_time_series_display_name_to_id_mapping(self) -> Dict[str, str]:
    """Returns a mapping of the TimeSeries display names to resource IDs for this Run.
        ...
        Returns:
            Dict[str, str] - Dictionary mapping TensorboardTimeSeries display
            names to
  ...
  def create_tensorboard_time_series(
      ...
      display_name: str,
      value_type: Union[
          gca_tensorboard_time_series.TensorboardTimeSeries.ValueType,
          str] = "SCALAR",
    ...
    """Creates a new tensorboard time series.
        ...
        Args:
            display_name (str): Optional. User provided name of this
              TensorboardTimeSeries. This value should be unique among all
              TensorboardTimeSeries resources belonging to the same
              TensorboardRun resource (parent resource).
            value_type
              (Union[gca_tensorboard_time_series.TensorboardTimeSeries.ValueType,
              str]): Optional. Type of TensorboardTimeSeries value. One of
              'SCALAR', 'TENSOR', 'BLOB_SEQUENCE'.
            plugin_name (str): Optional. Name of the plugin this time series
              pertain to. Such as Scalar, Tensor, Blob.
            plugin_data (bytes): Optional. Data of the current plugin, with the
              size limited to 65KB.
            description (str): Optional. Description of this
              TensorboardTimeseries.
    ...
    self._time_series_display_name_to_id_mapping[
        tb_time_series.display_name] = tb_time_series.name

    return tb_time_series

  def read_time_series_data(
      self) -> Dict[str, gca_tensorboard_data.TimeSeriesData]:
    ...
    inverted_mapping = {
        resource_id: display_name for display_name, resource_id in
        self._time_series_display_name_to_id_mapping.items()
    }
    ...
    read_response = self.api_client.batch_read_tensorboard_time_series_data(
        request=gca_tensorboard_service
...
class TensorboardTimeSeries(_TensorboardServiceResource):
  ...
  def __init__(
    ...
    """Retrieves an existing tensorboard time series given a tensorboard time series name or ID.
        ...
        Args:
            tensorboard_time_series_name (str): Required. A fully-qualified
              tensorboard time series resource name or resource ID.
                Example:
                  "projects/123/locations/us-central1/tensorboards/456/experiments/789/run/1011/timeSeries/mse"
                  or "mse" when tensorboard_id, tensorboard_experiment_id,
                  tensorboard_run_id are passed and project and location are
        ...
        Raises:
            ...
            tensorboard_experiment_id is provided.
        """
    if not (bool(tensorboard_id) == bool(tensorboard_experiment_id) ==
    ...
    """Creates a new tensorboard time series.
        ...
        Args:
            display_name (str): Optional. User provided name of this
              ...
              TensorboardTimeSeries resources belonging to the same
              TensorboardRun resource (parent resource).
            tensorboard_run_name (str): Required. The resource name or ID of the
              TensorboardRun to create the TensorboardTimeseries in. Resource
              name format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}``
              If resource ID is provided then tensorboard_id and
              tensorboard_experiment_id must be provided.
            tensorboard_id (str): Optional. The resource ID of the Tensorboard
              to create the TensorboardTimeSeries in.
            tensorboard_experiment_id (str): Optional. The ID of the
  ...
  def list(
    ...
    """List all instances of TensorboardTimeSeries in TensorboardRun.
        ...
        Args:
            tensorboard_run_name (str): Required. The resource name or ID of the
              TensorboardRun to list the TensorboardTimeseries from. Resource
              name format:
              ``projects/{project}/locations/{location}/tensorboards/{tensorboard}/experiments/{experiment}/runs/{run}``
              If resource ID is provided then tensorboard_id and
              tensorboard_experiment_id must be provided.
            tensorboard_id (str): Optional. The resource ID of the Tensorboard
              to list the TensorboardTimeSeries from.
            tensorboard_experiment_id (str): Optional. The ID of the
              TensorboardExperiment to list the TensorboardTimeSeries from.
            filter (str): Optional. An expression for filtering the results of
              the request. For field names both snake_case and camelCase are
              supported.
            order_by (str): Optional. A comma-separated list of fields to order
