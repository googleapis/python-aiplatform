...
class TensorboardExperiment(_TensorboardServiceResource):
    ...
    def __init__(
        ...
        """Retrieves an existing managed tensorboard experiment given a tensorboard experiment name or ID.

        Args:
            tensorboard_experiment_name (str):
                Required: A fully-qualified tensorboard resource experiment name or tensorboard experiment ID.
                Example: "projects/123/locations/us-central1/tensorboards/456/experiments/123" or
                "123" when tensorboard_name is passed and project and location are initialized or passed.
            tensorboard_name (str):
                Optional. Tensorboard resource id.
            project (str):
                Optional. Project to retrieve tensorboard from. If not set, project
                set in aiplatform.init will be used.
            location (str):
