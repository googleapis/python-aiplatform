...
from google.cloud.aiplatform.aiplatform import utils
...
VERTEX_AI_DEPENDENCY_PATH = (
    "google-cloud-aiplatform @ file://localhost/gcs/jaycee-bucket/"
    + "vertex_ai/google_cloud_aiplatform-1.22.1-py2.py3-none-any.whl"
    + "#egg=google-cloud-aiplatform"
)
