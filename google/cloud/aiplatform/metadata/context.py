...
class _Context(resource._Resource):
  ...
  def add_artifacts_and_executions(
    ...
    """Associate Executions and attribute Artifacts to a given Context.
        ...
        Args:
            artifact_resource_names (Sequence[str]): Optional. The full resource
              name of Artifacts to attribute to the Context.
            execution_resource_names (Sequence[str]): Optional. The full
              resource name of Executions to associate with the Context.
    """
  ...
  def _list_resources(
    ...
    """List Contexts in the parent path that matches the filter.
        ...
        Args:
            client (utils.MetadataClientWithOverride): Required. client to send
              require to Metadata Service.
            parent (str): Required. The path where Contexts are stored.
  ...
  def query_lineage_subgraph(self) -> gca_lineage_subgraph.LineageSubgraph:
    """Queries lineage subgraph of this context.
        ...
        Returns:
            lineage subgraph(gca_lineage_subgraph.LineageSubgraph): Lineage
            subgraph of this Context.
        """
  ...
  def get_executions(self) -> List[execution.Execution]:
    """Returns Executions associated to this context.
        ...
        Returns:
            executions (List[Executions]): Executions associated to this
            context.
        """
