...
class BaseExecutionSchema(metaclass=abc.ABCMeta):
  ...
  def __init__(
    ...
    """Initializes the Execution with the given name, URI and metadata.
        ...
        Args:
            ...
            execution_id (str): Optional. The <resource_id> portion of the
              Execution name with the following format, this is globally unique
              in a metadataStore.
  ...
  def start_execution(
    ...
    """Create and starts a new Metadata Execution or resumes a previously created Execution.
        ...
        This method is similar to create_execution with additional support for
        Experiments.
        If an Experiment is set prior to running this command, the Experiment
        will be
        associtaed with the created execution, otherwise this method behaves the
        same
        as create_execution.
        ...
        ```
        with execution_schema.ContainerExecution(resource_id='my-exc',
        resume=True) as exc:
            ...
        ```
        Args:
            metadata_store_id (str): Optional. The <metadata_store_id> portion
              ...
              If not provided, the MetadataStore's ID will be set to "default".
              Currently only the 'default' MetadataStore ID is supported.
            resume (bool): Resume an existing execution.
            project (str): Optional. Project used to create this Execution.
              Overrides project set in aiplatform.init.
            location (str): Optional. Location used to create this Execution.
              Overrides location set in aiplatform.init.
