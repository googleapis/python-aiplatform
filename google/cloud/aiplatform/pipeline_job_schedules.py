...
class PipelineJobSchedule(
    ...
    def list(
        ...
        # TODO(): check enable_simple_view. dont think this works with PipelineJobSchedule bc of `read_mask`
        # https://source.corp.google.com/piper///depot/google3/third_party/py/google/cloud/aiplatform/aiplatform/constants/pipeline.py;l=45?q=constants%2Fpipeline&sq=package:piper%20file:%2F%2Fdepot%2Fgoogle3%20-file:google3%2Fexperimental 
        ...
        Args:
            ...
            enable_simple_view (bool):
                ...
                each PipelineJobSchedule resource in your response: `state`, `display_name`,
    ...
    def list_jobs(
        ...
        # TODO(): verify schedule_id.
        """List all PipelineJob 's created by a PipelineJobSchedule.
