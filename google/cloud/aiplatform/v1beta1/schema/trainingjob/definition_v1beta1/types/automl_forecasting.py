...
class AutoMlForecastingInputs(proto.Message):
  r"""
    ...
    Attributes:
        target_column (str): The name of the column that the model is to
          predict.
        time_series_identifier_column (str): The name of the column that
          identifies the time series.
        time_column (str): The name of the column that identifies time order in
          the time series.
        transformations
          (Sequence[google.cloud.aiplatform.v1beta1.schema.trainingjob.definition_v1beta1.types.AutoMlForecastingInputs.Transformation]):
        ...
        optimization_objective (str): Objective function the model is optimizing
          towards. The training process creates a model that optimizes the value
          of the objective function over the validation set.  The supported
          optimization objectives: "minimize-rmse" (default) - Minimize root-
          mean-squared error (RMSE).   "minimize-mae" - Minimize mean-absolute
          error (MAE).   "minimize- rmsle" - Minimize root-mean-squared log
          error (RMSLE).   "minimize-rmspe" - Minimize root- mean-squared
        ...
        weight_column (str): Column name that should be used as the weight
          ...
          equal weight of 1.
        static_columns (Sequence[str]): Column names that should be used as
          static columns. The value of these columns are static per time series.
        time_variant_past_only_columns (Sequence[str]): Column names that should
          be used as time variant past only columns. This column contains
          information for the given entity (identified by the
          time_series_identifier_column) that is known for the past but not the
          future (e.g. population of a city in a given year, or weather on a
          given day).
        time_variant_past_and_future_columns (Sequence[str]): Column names that
          should be used as time variant past and future columns. This column
          contains information for the given entity (identified by the key
          column) that is known for the past and the future
        period
          (google.cloud.aiplatform.v1beta1.schema.trainingjob.definition_v1beta1.types.AutoMlForecastingInputs.Period):
          Expected difference in time granularity between rows in the data. If
          it is not set, the period is inferred from data.
        forecast_window_start (int): The number of periods offset into the
          future as the start of the forecast window (the window of future
          values to predict, relative to the present.), where each period is one
          unit of granularity as defined by the ``period`` field above. Default
          to 0. Inclusive.
        forecast_window_end (int): The number of periods offset into the future
          as the end of the forecast window (the window of future values to
          predict, relative to the present.), where each period is one unit of
          granularity as defined by the ``period`` field above. Inclusive.
        past_horizon (int): The number of periods offset into the past to
          restrict past sequence, where each period is one unit of granularity
          as defined by the ``period``. Default value 0 means that it lets
  ...
  class Transformation(proto.Message):
    r"""
        ...
        Attributes:
            ...
            repeated_numeric
              (google.cloud.aiplatform.v1beta1.schema.trainingjob.definition_v1beta1.types.AutoMlForecastingInputs.Transformation.NumericArrayTransformation):
            repeated_categorical
              (google.cloud.aiplatform.v1beta1.schema.trainingjob.definition_v1beta1.types.AutoMlForecastingInputs.Transformation.CategoricalArrayTransformation):
            repeated_text
              (google.cloud.aiplatform.v1beta1.schema.trainingjob.definition_v1beta1.types.AutoMlForecastingInputs.Transformation.TextArrayTransformation):
    """
  ...
  class Period(proto.Message):
    r"""A duration of time expressed in time granularity units.
        ...
        Attributes:
            unit (str): The time granularity unit of this time period. The
              supported unit are: "hour" "day" "week" "month" "year".
            quantity (int): The number of units per period, e.g. 3 weeks or 2
              months.
    """
  ...
  time_variant_past_and_future_columns = proto.RepeatedField(
