...
class VideoObjectTrackingPredictionResult(proto.Message):
  r"""Prediction output format for Video Object Tracking.
    ...
    Attributes:
        ...
        time_segment_end (google.protobuf.duration_pb2.Duration): The end,
          inclusive, of the video's time segment in which the object instance
          has been detected. Expressed as a number of seconds as measured from
          the start of the video, with fractions up to a microsecond precision,
        ...
        confidence (google.protobuf.wrappers_pb2.FloatValue): The Model's
          ...
          confidence.
        frames
          (Sequence[google.cloud.aiplatform.v1beta1.schema.predict.prediction_v1beta1.types.VideoObjectTrackingPredictionResult.Frame]):
  ...
  class Frame(proto.Message):
    r"""The fields ``xMin``, ``xMax``, ``yMin``, and ``yMax`` refer to a
        ...
        Attributes:
            time_offset (google.protobuf.duration_pb2.Duration): A time (frame)
              of a video in which the object has been detected. Expressed as a
              number of seconds as measured from the start of the video, with
              fractions up to a microsecond precision, and with "s" appended at
              the end.
            x_min (google.protobuf.wrappers_pb2.FloatValue): The leftmost
              coordinate of the bounding box.
            x_max (google.protobuf.wrappers_pb2.FloatValue): The rightmost
              coordinate of the bounding box.
            y_min (google.protobuf.wrappers_pb2.FloatValue): The topmost
              coordinate of the bounding box.
            y_max (google.protobuf.wrappers_pb2.FloatValue): The bottommost
              coordinate of the bounding box.
    """
