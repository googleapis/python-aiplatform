...
class TextExtractionPredictionResult(proto.Message):
  r"""Prediction output format for Text Extraction.
    ...
    Attributes:
        ...
        text_segment_start_offsets (Sequence[int]): The start offsets,
          inclusive, of the text segment in which the AnnotationSpec has been
          identified. Expressed as a zero-based number of characters as measured
          from the start of the text snippet.
        text_segment_end_offsets (Sequence[int]): The end offsets, inclusive, of
          the text segment in which the AnnotationSpec has been identified.
          Expressed as a zero-based number of characters as measured from the
          start of the text snippet.
