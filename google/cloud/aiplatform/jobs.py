...
class CustomJob(_RunnableJob, base.PreviewMixin):
    ...
    def run(
        ...
        persistent_resource_id: Optional[str] = None,
        strategy: Optional[gca_custom_job_compat.Scheduling.Strategy] = None,
    ) -> None:
        ...
        Args:
            ...
            persistent_resource_id (str):
                ...
                configs on the job should be consistent with those on the
                PersistentResource, otherwise, the job will be rejected.
            strategy (gca_custom_job_compat.Scheduling.Strategy):
    ...
    def submit(
        ...
        *,
        ...
        if timeout or restart_job_on_worker_restart or disable_retries or strategy:
