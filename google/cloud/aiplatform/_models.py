...
class _Endpoint(base.VertexAiResourceNounWithFutureManager):
    ...
    def undeploy_all(self, sync: bool = True) -> "_Endpoint":
...
class PrivateEndpoint(_Endpoint):
    """
...
class _Model(base.VertexAiResourceNounWithFutureManager):
    ...
    def deploy(
        self,
        endpoint: Optional[Union["_Endpoint", "PrivateEndpoint"]] = None,
        deployed_model_display_name: Optional[str] = None,
        traffic_percentage: Optional[int] = 0,
        traffic_split: Optional[Dict[str, int]] = None,
        machine_type: Optional[str] = None,
        ...
        autoscaling_target_cpu_utilization: Optional[int] = None,
        autoscaling_target_accelerator_duty_cycle: Optional[int] = None,
    ) -> Union[_Endpoint, PrivateEndpoint]:
        ...
        Returns:
            endpoint (Union[_Endpoint, PrivateEndpoint]):
        ...
        _Endpoint._validate_deploy_args(
            min_replica_count=min_replica_count,
            max_replica_count=max_replica_count,
            accelerator_type=accelerator_type,
            deployed_model_display_name=deployed_model_display_name,
    ...
    def __init__(
        ...
        if isinstance(model, _Model):
            ...
            self.model_resource_name = utils.full_resource_name(
                ...
                parse_resource_name_method=_Model._parse_resource_name,
                format_resource_name_method=_Model._format_resource_name,
                project=project,
                location=location,
        ...
        self.client = _Model._instantiate_client(location, self.credentials)
