...
class MatchService(object):
    ...
    def Match(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.aiplatform.container.v1.MatchService/Match',
    ...
    def BatchMatch(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.aiplatform.container.v1.MatchService/BatchMatch',
    ...
    @staticmethod
    def BatchGetEmbeddings(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.cloud.aiplatform.container.v1.MatchService/BatchGetEmbeddings',
