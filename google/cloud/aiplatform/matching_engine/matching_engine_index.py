...
class MatchingEngineIndex(base.VertexAiResourceNounWithFutureManager):
  ...
  def __init__(
    ...
    """Retrieves an existing index given an index name or ID.
        ...
        Args:
            index_name (str): Required. A fully-qualified index resource name or
              a index ID.
                Example:
                  "projects/123/locations/us-central1/indexes/my_index_id" or
                  "my_index_id" when project and location are initialized or
                  passed.
            project (str): Optional. Project to retrieve index from. If not set,
              project set in aiplatform.init will be used.
            location (str): Optional. Location to retrieve index from. If not
              set, location set in aiplatform.init will be used.
            credentials (auth_credentials.Credentials): Optional. Custom
              credentials to use to retrieve this Index. Overrides credentials
  ...
  def _create(
    ...
    """Creates a MatchingEngineIndex resource.
        ...
        Args:
            display_name (str): Required. The display name of the Index. The
              name can be up to 128 characters long and can be consist of any
              UTF-8 characters.
            contents_delta_uri (str): Required. Allows inserting, updating  or
              deleting the contents of the Matching Engine Index. The string
              must be a valid Google Cloud Storage directory path. If this field
              is set when calling IndexService.UpdateIndex, then no other Index
              field can be  also updated as part of the same call. The expected
              structure and format of the files this URI points to is described
              at
                https://docs.google.com/document/d/12DLVB6Nq6rdv8grxfBsPhUA283KWrQ9ZenPBp0zUC30
            config (matching_engine_index_config.MatchingEngineIndexConfig):
              Required. The configuration with regard to the algorithms used for
              efficient search.
            description (str): Optional. The description of the Index.
            labels (Dict[str, str]): Optional. The labels with user-defined
              metadata to organize your Index. Label keys and values can be no
              ...
              user labels can be associated with one Index(System labels are
  ...
  def update_metadata(
    ...
    """Updates the metadata for this index.
        ...
        Args:
            display_name (str): Optional. The display name of the Index. The
              name can be up to 128 characters long and can be consist of any
              UTF-8 characters.
            description (str): Optional. The description of the Index.
            labels (Dict[str, str]): Optional. The labels with user-defined
    ...
    """Updates the embeddings for this index.
        ...
        Args:
            contents_delta_uri (str): Required. Allows inserting, updating  or
              ...
              at
                https://docs.google.com/document/d/12DLVB6Nq6rdv8grxfBsPhUA283KWrQ9ZenPBp0zUC30
            is_complete_overwrite (bool): Optional. If this field is set
              together with contentsDeltaUri when calling
              IndexService.UpdateIndex, then existing content of the Index will
              be replaced by the data from the contentsDeltaUri.
            request_metadata (Sequence[Tuple[str, str]]): Optional. Strings
              which should be sent along with the request as metadata.
  ...
  def deployed_indexes(
      self,) -> List[gca_matching_engine_deployed_index_ref.DeployedIndexRef]:
  ...
  def create_tree_ah_index(
      ...
      distance_measure_type: Optional[
          matching_engine_index_config.DistanceMeasureType] = None,
      description: Optional[str] = None,
      labels: Optional[Dict[str, str]] = None,
      project: Optional[str] = None,
      location: Optional[str] = None,
    ...
    """Creates a MatchingEngineIndex resource that uses the tree-AH algorithm.
        ...
        Args:
            ...
            contents_delta_uri (str): Required. Allows inserting, updating  or
              ...
              at
                https://docs.google.com/document/d/12DLVB6Nq6rdv8grxfBsPhUA283KWrQ9ZenPBp0zUC30
            dimensions (int): Required. The number of dimensions of the input
              vectors.
            approximate_neighbors_count (int): Required. The default number of
              neighbors to find via approximate search before exact reordering
              is performed. Exact reordering is a procedure where results
              returned by an approximate search algorithm are reordered via a
              more expensive distance computation.
            leaf_node_embedding_count (int): Optional. Number of embeddings on
              each leaf node. The default value is 1000 if not set.
            leaf_nodes_to_search_percent (float): Optional. The default
              percentage of leaf nodes that any query may be searched. Must be
              in range 1-100, inclusive. The default value is 10 (means 10%) if
              not set.
            distance_measure_type
              (matching_engine_index_config.DistanceMeasureType): Optional. The
              distance measure used in nearest neighbor search.
            description (str): Optional. The description of the Index.
            labels (Dict[str, str]): Optional. The labels with user-defined
              metadata to organize your Index. Label keys and values can be no
              longer than 64 characters (Unicode codepoints), can only contain
