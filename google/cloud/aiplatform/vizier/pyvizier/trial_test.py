...
class TrialTest(absltest.TestCase):
    def testCompleteInplace(self):
        ...
        measurement = Measurement(
            metrics={"pr-auc": Metric(value=0.8), "latency": Metric(value=32)}
        )
        ...
        self.assertLessEqual(test.completion_time, datetime.datetime.now().astimezone())
    ...
    def testCompleteNotInplace(self):
        ...
        self.assertLessEqual(
            completed.completion_time, datetime.datetime.now().astimezone()
        )
...
class ParameterDictTest(parameterized.TestCase):
    @parameterized.parameters((True,), (3,), (1.0,), ("aa",))
