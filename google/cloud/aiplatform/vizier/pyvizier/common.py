...
class Metadata(abc.MutableMapping):
    ...
    def __init__(
        self,
        *args: Union[Dict[str, MetadataValue], Iterable[Tuple[str, MetadataValue]]],
        **kwargs: MetadataValue,
        ...
        self._stores: DefaultDict[
            Namespace, _MetadataSingleNameSpace
    ...
    def get(
        self, key: str, default: Optional[T] = None, *, cls: Type[T] = str
    ) -> Optional[T]:
        """Gets the metadata as type `cls`, or None if not possible.
