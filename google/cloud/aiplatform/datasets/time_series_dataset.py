...
class TimeSeriesDataset(datasets._ColumnNamesDataset):
    ...
    You can create a managed time series dataset from CSV files in a Cloud Storage
    bucket or from a BigQuery table.

    The following code shows you how to create with a CSV file that has the time
    series dataset:
    ...
    The following code shows you how to create with a BigQuery table file
    that has the time series dataset:
    ...
    def create(
        ...
        Args:
            ...
            encryption_spec_key_name (Optional[str]):
                ...
                If `encryption_spec_key_name` is set, this `TimeSeriesDataset`
