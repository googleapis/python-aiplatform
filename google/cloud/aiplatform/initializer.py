...
class _Config:
  ...
  def init(
      ...
      *,
      ...
      experiment_tensorboard: Optional[Union[
    ...
    """Updates common initialization parameters with provided options.
        ...
        Args:
            ...
            location (str): The default location to use when making API calls.
              If not set defaults to us-central-1.
            experiment (str): Optional. The experiment name.
            experiment_description (str): Optional. The description of the
              experiment.
            experiment_tensorboard (Union[str,
              tensorboard_resource.Tensorboard]): Optional. The Vertex AI
              TensorBoard instance, Tensorboard resource name, or Tensorboard
              resource ID to use as a backing Tensorboard for the provided
              experiment.  Example tensorboard resource name format:
              "projects/123/locations/us-central1/tensorboards/456"
            staging_bucket (str): The default staging bucket to use to stage
              artifacts when making API calls. In the form gs://...
            credentials (google.auth.credentials.Credentials): The default
              custom credentials to use when making API calls. If not provided
            ...
            encryption_spec_key_name (Optional[str]): Optional. The Cloud KMS
              ...
              protect a resource. Has the
                form:
                  ``projects/my-project/locations/my-region/keyRings/my-kr/cryptoKeys/my-key``.
                  The key needs to be in the same region as where the compute
                  resource is created.  If set, this resource and all
    ...
    if (project and project != self._project) or (location and
  ...
  def get_encryption_spec(
    ...
    """Creates a gca_encryption_spec.EncryptionSpec instance from the given
        ...
        Args:
            encryption_spec_key_name (Optional[str]): The default encryption key
              name to use when creating resources.
  ...
  def get_client_options(
    ...
    """Creates GAPIC client_options using location and type.
        ...
        Args:
            location_override (str): Optional. Set this parameter to get client
              options for a location different from location set by initializer.
              Must be a GCP region supported by Vertex AI.
            prediction_client (str): Optional. flag to use a prediction
              endpoint.
            api_base_path_override (str): Optional. Override default API base
              path.
    ...
    service_base_path = api_base_path_override or (
        ...
        if prediction_client else constants.API_BASE_PATH)
  ...
  def common_location_path(self,
    ...
    """Get parent resource with optional project and location override.
        ...
        Args:
            project (str): GCP project. If not provided will use the current
              project.
            location (str): Location. If not provided will use the current
              location.
  ...
  def create_client(
    ...
    """Instantiates a given VertexAiServiceClient with optional
        ...
        Args:
            client_class (utils.VertexAiServiceClientWithOverride): Required. A
              Vertex AI Service Client with optional overrides.
            credentials (auth_credentials.Credentials): Optional. Custom auth
              credentials. If not provided will use the current config.
        ...
        Returns:
            client: Instantiated Vertex AI Service client with optional
            overrides
        """
