...
class VersionInfo(NamedTuple):
  ...
  Attributes:
      ...
      create_time: Timestamp when this Model version was uploaded into Vertex
        AI.
      update_time: Timestamp when this Model version was most recently updated.
      model_display_name: The user-defined name of the model this version
        belongs to.
      model_resource_name: The fully-qualified model resource name. e.g.
      ...
      version_aliases: User provided version aliases so that a model version can
        be referenced via alias (i.e.
        projects/{project}/locations/{location}/models/{model_display_name}@{version_alias}).
        Default is None.
      version_description: The description of this version. Default is None.
  """
...
class Prediction(NamedTuple):
  ...
  Attributes:
      ...
      deployed_model_id: ID of the Endpoint's DeployedModel that served this
        prediction.
      metadata: The metadata that is the output of the predictions call.
      model_version_id: ID of the DeployedModel's version that served this
        prediction.
      model_resource_name: The fully-qualified resource name of the model that
        served this prediction.
      explanations: The explanations of the Model's predictions. It has the same
...
class Endpoint(base.VertexAiResourceNounWithFutureManager, base.PreviewMixin):
  ...
  def __init__(
    ...
    Args:
        endpoint_name (str): Required. A fully-qualified endpoint resource name
          or endpoint ID.
            Example: "projects/123/locations/us-central1/endpoints/456" or "456"
  ...
  def network(self) -> Optional[str]:
    ...
    left unspecified, the Endpoint is not peered with any network.
    """
  ...
  def create(
    ...
    Args:
        display_name (str): Optional. The user-defined name of the Endpoint. The
        ...
        create_request_timeout (float): Optional. The timeout for the create
          request in seconds.
        endpoint_id (str): Optional. The ID to use for endpoint, which will
          become the final component of the endpoint resource name. If not
          provided, Vertex AI will generate a value for this ID.  This value
          should be 1-10 characters, and valid characters are /[0-9]/. When
          using HTTP/JSON, this field is populated based on a query string
          argument, such as ``?endpoint_id=12345``. This is the fallback for
          fields that are not included in either the URI or the body.
  ...
  def _create(
    ...
    Args:
        api_client (EndpointServiceClient): Required. An instance of
          EndpointServiceClient with the correct api_endpoint already set based
          on user's preferences.
        display_name (str): Required. The user-defined name of the Endpoint. The
          name can be up to 128 characters long and can be consist of any UTF-8
          characters.
        project (str): Required. Project to retrieve endpoint from.
        location (str): Required. Location to retrieve endpoint from.
        description (str): Optional. The description of the Endpoint.
        labels (Dict[str, str]): Optional. The labels with user-defined metadata
          to organize your Endpoints. Label keys and values can be no longer
          than 64 characters (Unicode codepoints), can only contain lowercase
        ...
        credentials (auth_credentials.Credentials): Optional. Custom credentials
          to use to upload this model. Overrides credentials set in
          aiplatform.init.
        encryption_spec (gca_encryption_spec.EncryptionSpec): Optional. The
          Cloud KMS customer managed encryption key used to protect the dataset.
          The key needs to be in the same region as where the compute resource
          is created.  If set, this Dataset and all sub-resources of this
        ...
        network (str): Optional. The full name of the Compute Engine network to
          ...
          already be configured for the network. Cannot be specified when
          enable_private_service_connect is True. Read more about
          PrivateEndpoints [in the
          documentation](https://cloud.google.com/vertex-ai/docs/predictions/using-private-endpoints)
        enable_private_service_connect (bool): If true, the endpoint can be
          accessible via [Private Service
          Connect](https://cloud.google.com/vpc/docs/private-service-connect).
          Cannot be True when network is specified.
        project_allowlist (Sequence[str]): Optional. List of projects from which
          traffic can be accepted by the endpoint via
          [ServiceAttachment](https://cloud.google.com/vpc/docs/private-service-connect#service-attachments)
        sync (bool): Whether to create this endpoint synchronously.
        create_request_timeout (float): Optional. The timeout for the create
          request in seconds.
        endpoint_id (str): Optional. The ID to use for endpoint, which will
          become the final component of the endpoint resource name. If not
          ...
          fields that are not included in either the URI or the body.
          predict_request_response_logging_config
          (aiplatform.endpoint.PredictRequestResponseLoggingConfig): Optional.
          The request response logging configuration for online prediction.
  ...
  def _construct_sdk_resource_from_gapic(
    ...
    Args:
        gapic_resource (proto.Message): A GAPIC representation of a Endpoint
          resource, usually retrieved by a get_* or in a list_* API call.
        project (str): Optional. Project to construct Endpoint object from. If
          not set, project set in aiplatform.init will be used.
        location (str): Optional. Location to construct Endpoint object from. If
          not set, location set in aiplatform.init will be used.
        credentials (auth_credentials.Credentials): Optional. Custom credentials
          to use to construct Endpoint. Overrides credentials set in
          aiplatform.init.
  ...
  def _allocate_traffic(
    ...
    Args:
        traffic_split (Dict[str, int]): Required. Current traffic split of
          deployed models in endpoint.
        traffic_percentage (int): Required. Desired traffic to new deployed
          model.
  ...
  def _unallocate_traffic(
    ...
    Args:
        traffic_split (Dict[str, int]): Required. Current traffic split of
          deployed models in endpoint.
        deployed_model_id (str): Required. Desired traffic to new deployed
          model.
  ...
  def deploy(
    ...
    Args:
        ...
        accelerator_count (int): Optional. The number of accelerators to attach
          to a worker replica.
        tpu_topology (str): Optional. The TPU topology to use for the
          DeployedModel. Required for CloudTPU multihost deployments.
        ...
        enable_access_logging (bool): Whether to enable endpoint access logging.
          Defaults to False.
        disable_container_logging (bool): If True, container logs from the
          deployed model will not be written to Cloud Logging. Defaults to
          False.
    """
    self._sync_gca_resource_if_skipped()
  ...
  def _deploy_call(
    ...
    Args:
        ...
        service_account (str): The service account that the DeployedModel's
          ...
          service account that doesn't have access to the resource project.
          Users deploying the Model must have the `iam.serviceAccounts.actAs`
          permission on this service account. If not specified, uses the service
          account set in aiplatform.init.
        explanation_spec (aiplatform.explain.ExplanationSpec): Optional.
          Specification of Model explanation.
        metadata (Sequence[Tuple[str, str]]): Optional. Strings which should be
          sent along with the request as metadata.
    ...
    service_account = (
        service_account or initializer.global_config.service_account
    )
    ...
    if bool(accelerator_type) != bool(accelerator_count):
      raise ValueError(
          "Both `accelerator_type` and `accelerator_count` should be specified"
          " or None."
      )
  ...
  def undeploy(
    ...
    Args:
        deployed_model_id (str): Required. The ID of the DeployedModel to be
          undeployed from the Endpoint.
        traffic_split (Dict[str, int]): Optional. A map of DeployedModel IDs to
          the percentage of this Endpoint's traffic that should be forwarded to
          that DeployedModel. Required if undeploying a model with non-zero
          traffic from an Endpoint with multiple deployed models. The traffic
          percentage values must add up to 100, or map must be empty if the
          Endpoint is to not accept any traffic at the moment. If a
    ...
    if traffic_split is not None:
      if (
          deployed_model_id in traffic_split
          and traffic_split[deployed_model_id]
      ):
    ...
    # Two or more models deployed to Endpoint and remaining traffic will be zero
      ...
      raise ValueError(
          f"Undeploying deployed model '{deployed_model_id}' would leave the"
          " remaining traffic split at 0%. Traffic split must add up to 100%"
          " when models are deployed. Please undeploy the other models first"
          " or provide an updated traffic_split."
      )
  ...
  def _undeploy(
    ...
    """
    self._sync_gca_resource_if_skipped()
    current_traffic_split = traffic_split or dict(
  ...
  def update(
    ...
    Args:
        display_name (str): Optional. The display name of the Endpoint. The name
        ...
        request_metadata (Sequence[Tuple[str, str]]): Optional. Strings which
          should be sent along with the request as metadata.
        update_request_timeout (float): Optional. The timeout for the update
          request in seconds.
    ...
    copied_endpoint_proto = current_endpoint_proto.__class__(
        current_endpoint_proto
    )
  ...
  def predict(
    ...
    Args:
        instances (List): Required. The instances that are the input to the
          prediction call. A DeployedModel may have an upper limit on the number
          of instances it supports per request, and when it is exceeded the
          prediction call errors in case of AutoML Models, or, in case of
          customer created Models, the behaviour is as documented by that Model.
          The schema of any single instance may be specified via Endpoint's
          DeployedModels'
          [Model's][google.cloud.aiplatform.v1beta1.DeployedModel.model]
          [PredictSchemata's][google.cloud.aiplatform.v1beta1.Model.predict_schemata]
          ``instance_schema_uri``.
        parameters (Dict): The parameters that govern the prediction. The schema
          of the parameters may be specified via Endpoint's DeployedModels'
          [Model's ][google.cloud.aiplatform.v1beta1.DeployedModel.model]
          [PredictSchemata's][google.cloud.aiplatform.v1beta1.Model.predict_schemata]
          ``parameters_schema_uri``.
        timeout (float): Optional. The timeout for this request in seconds.
        use_raw_predict (bool): Optional. Default value is False. If set to
          True, the underlying prediction call will be made against
  ...
  async def predict_async(
    ...
    Args:
        instances (List): Required. The instances that are the input to the
          ...
          [PredictSchemata's][google.cloud.aiplatform.v1beta1.Model.predict_schemata]
          ``instance_schema_uri``.
        parameters (Dict): Optional. The parameters that govern the prediction.
  ...
  def raw_predict(
    ...
    Args:
        body (bytes): The body of the prediction request in bytes. This must not
          exceed 1.5 mb per request.
        headers (Dict[str, str]): The header of the request as a dictionary.
          There are no restrictions on the header.
  ...
  def explain(
    ...
    Args:
        ...
        parameters (Dict): The parameters that govern the prediction. The schema
          ...
          [PredictSchemata's][google.cloud.aiplatform.v1beta1.Model.predict_schemata]
          ``parameters_schema_uri``.
        deployed_model_id (str): Optional. If specified, this ExplainRequest
          will be served by the chosen DeployedModel, overriding this Endpoint's
          traffic split.
        timeout (float): Optional. The timeout for this request in seconds.
  ...
  def list(
    ...
    Example Usage:
        aiplatform.Endpoint.list(
            filter='labels.my_label="my_label_value" OR
            display_name=!"old_endpoint"',
        )

    Args:
        filter (str): Optional. An expression for filtering the results of the
          request. For field names both snake_case and camelCase are supported.
        order_by (str): Optional. A comma-separated list of fields to order by,
          sorted in ascending order. Use "desc" after a field name for
          descending. Supported fields: `display_name`, `create_time`,
          `update_time`
        project (str): Optional. Project to retrieve list from. If not set,
          project set in aiplatform.init will be used.
        location (str): Optional. Location to retrieve list from. If not set,
          location set in aiplatform.init will be used.
        credentials (auth_credentials.Credentials): Optional. Custom credentials
          to use to retrieve list. Overrides credentials set in aiplatform.init.
  ...
  def delete(self, force: bool = False, sync: bool = True) -> None:
    ...
    If force is set to True, all models on this Endpoint will be undeployed
    prior to deletion.

    Args:
        force (bool): Required. If force is set to True, all deployed models on
          this Endpoint will be undeployed first. Default is False.
        sync (bool): Whether to execute this method synchronously. If False,
          this method will be executed in concurrent Future and any downstream
          object will be immediately returned and synced when the Future has
          completed.
    ...
    Raises:
        FailedPrecondition: If models are deployed on this Endpoint and force =
        False.
    """
    if force:
...
class PrivateEndpoint(Endpoint):
  ...
  Read more [about private endpoints in the
  documentation.](https://cloud.google.com/vertex-ai/docs/predictions/using-private-endpoints)
  """
  ...
  def __init__(
    ...
    Args:
        endpoint_name (str): Required. A fully-qualified endpoint resource name
          or endpoint ID.
            Example:
              "projects/123/locations/us-central1/endpoints/my_endpoint_id" or
              "my_endpoint_id" when project and location are initialized or
              passed.
        project (str): Optional. Project to retrieve endpoint from. If not set,
          project set in aiplatform.init will be used.
        location (str): Optional. Location to retrieve endpoint from. If not
    ...
    try:
      ...
      raise ImportError(
          "Cannot import the urllib3 HTTP client. Please install"
          " google-cloud-aiplatform[private_endpoints]."
      )
  ...
  def predict_http_uri(self) -> Optional[str]:
    ...
    return self._gca_resource.deployed_models[
        0
    ].private_endpoints.predict_http_uri
  ...
  def create(
    ...
    Args:
        ...
        network (str): Optional. The full name of the Compute Engine network to
          ...
          be set when enable_private_service_connect is True.
        enable_private_service_connect (bool): If true, the endpoint can be
          accessible via [Private Service
          Connect](https://cloud.google.com/vpc/docs/private-service-connect).
          Cannot be True when network is specified.
    ...
    if not network and not private_service_connect_config:
      raise ValueError(
          ...
          "`enable_private_service_connect`. You can also set network"
          "using aiplatform.init(network=...)"
      )
    if network and private_service_connect_config:
      raise ValueError(
          "Argument `network` and `private_service_connect`=True are"
  ...
  def _construct_sdk_resource_from_gapic(
    ...
    Args:
        gapic_resource (proto.Message): A GAPIC representation of a
          PrivateEndpoint resource, usually retrieved by a get_* or in a list_*
          API call.
        project (str): Optional. Project to construct Endpoint object from. If
          not set, project set in aiplatform.init will be used.
        location (str): Optional. Location to construct Endpoint object from. If
  ...
  def _http_request(
    ...
    Args:
        method (str): Required. The HTTP request method to use. Example: "POST"
          or "GET"
        url (str): Required. The url used to send requests and get responses
          from.
        body (Dict[str, Any]): Optional. Data sent to the url in the HTTP
          request. For a PrivateEndpoint, an instance is sent and a prediction
          response is expected.
        headers (Dict[str, str]): Optional. Header in the HTTP request.
    ...
    Raises:
        ...
        RuntimeError: A connection could not be established with the
        PrivateEndpoint and
    ...
    try:
      ...
      raise RuntimeError(
          f"Failed to make a {method} request to this URI, make sure:  this"
          " call is being made inside the network this PrivateEndpoint is"
          f" peered to ({self._gca_resource.network}), calling health_check()"
          f" returns True, and that {url} is a valid URL."
      ) from exc
  ...
  def predict(
    ...
    network the PrivateEndpoint is peered to. Otherwise, the predict() call will
    fail with error code 404. To check, use `PrivateEndpoint.network`.
    ...
    Args:
        instances (List): Required. The instances that are the input to the
          prediction call. Instance types mut be JSON serializable. A
        ...
        parameters (Dict): The parameters that govern the prediction. The schema
          ...
          [PredictSchemata's][google.cloud.aiplatform.v1beta1.Model.predict_schemata]
          ``parameters_schema_uri``.
        endpoint_override (Optional[str]): The Private Service Connect
          endpoint's IP address or URL that points to the endpoint's service
          attachment.
    ...
    if self.private_service_connect_config:
      ...
      if not self.credentials:
        raise RuntimeError(
            "Cannot make a predict request because credentials are not"
            "provided. Please ensure credentials are provided."
        )
      ...
      return Prediction(
          predictions=prediction_response.get("predictions"),
          metadata=prediction_response.get("metadata"),
          deployed_model_id=prediction_response.get("deployed_model_id"),
      )
  ...
  def raw_predict(
    ...
    This method must be called within the network the PrivateEndpoint is peered
    to. Otherwise, the predict() call will fail with error code 404." "To check,
    use `PrivateEndpoint.network`.
  ...
  def health_check(self) -> bool:
    ...
    Must be" "within network that this PrivateEndpoint is in.
    ...
    if self.private_service_connect_config:
      raise RuntimeError(
          "Health check request is not supported on PSC based PrivateEndpoint."
      )

    if not self._gca_resource.deployed_models:
      raise RuntimeError(
          "Cannot make a health check request because a model has not been"
          "deployed on this Private Endpoint. Please ensure a model has"
          "been deployed."
      )

    if not self._gca_resource.deployed_models:
      raise RuntimeError(
          "Cannot make a health check request because a model has not"
          "been deployed on this Private Endpoint. Please ensure a model"
          "has been deployed."
      )
  ...
  def list(
    ...
    return cls._list_with_local_order(
        ...
        # Only PrivateEndpoints have a network set or private_service_connect_config
        filter=filter,
        order_by=order_by,
        project=project,
        location=location,
  ...
  def undeploy(
    ...
    Args:
        deployed_model_id (str): Required. The ID of the DeployedModel to be
          undeployed from the PrivateEndpoint. Use PrivateEndpoint.list_models()
          to get the deployed model ID.
        sync (bool): Whether to execute this method synchronously. If False,
          this method will be executed in concurrent Future and any downstream
          object will be immediately returned and synced when the Future has
          completed.
  ...
  def delete(self, force: bool = False, sync: bool = True) -> None:
    ...
    If force is set to True, all models on this PrivateEndpoint will be
    undeployed prior to deletion.
...
class Model(base.VertexAiResourceNounWithFutureManager, base.PreviewMixin):
  ...
  def supported_input_storage_formats(self) -> List[str]:
    ...
    [Read the docs for more on batch prediction
    formats](https://cloud.google.com/vertex-ai/docs/predictions/batch-predictions#batch_request_input)
  ...
  def supported_output_storage_formats(self) -> List[str]:
    ...
    [Read the docs for more on batch prediction
    formats](https://cloud.google.com/vertex-ai/docs/predictions/batch-predictions)
  ...
  def __init__(
    ...
    Args:
        model_name (str): Required. A fully-qualified model resource name or
          model ID.
            Example: "projects/123/locations/us-central1/models/456" or "456"
              when project and location are initialized or passed. May
              optionally contain a version ID or version alias in
              {model_name}@{version} form. See version arg.
        project (str): Optional project to retrieve model from. If not set,
          project set in aiplatform.init will be used.
        location (str): Optional location to retrieve model from. If not set,
          location set in aiplatform.init will be used.
        credentials: Optional[auth_credentials.Credentials]=None, Custom
          credentials to use to upload this model. If not set, credentials set
          in aiplatform.init will be used.
        version (str): Optional. Version ID or version alias. When set, the
          specified model version will be targeted unless overridden in method
          calls. When not set, the model with the "default" alias will be
          targeted unless overridden in method calls. No behavior change if only
          one version of a model exists.

    Raises:
        ValueError: If `version` is passed alongside a model_name referencing a
        different version.
    """
    ...
    if parsed_version:
      if version and version != parsed_version:
        raise ValueError(
            f"A version of {version} was passed that conflicts with the version"
            f" of {parsed_version} in the model_name."
        )
    ...
    versioned_model_name = ModelRegistry._get_versioned_name(
        model_name, version
    )
    self._gca_resource = self._get_gca_resource(
        resource_name=versioned_model_name
    )
  ...
  def update(
    ...
    Args:
        display_name (str): The display name of the Model. The name can be up to
          128 characters long and can be consist of any UTF-8 characters.
        description (str): The description of the model.
        labels (Dict[str, str]): Optional. The labels with user-defined metadata
          to organize your Models. Label keys and values can be no longer than
  ...
  def upload(
    ...
    Args:
        ...
        artifact_uri (str): Optional. The path to the directory containing the
          Model artifact and any of its supporting files. Leave blank for custom
          container prediction. Not present for AutoML Models.
        model_id (str): Optional. The ID to use for the uploaded Model, which
        ...
        parent_model (str): Optional. The resource name or model ID of an
          existing model that the newly-uploaded model will be a version of.
        ...
        is_default_version (bool): Optional. When set to True, the newly
          ...
          included. Subsequent uses of this model without a version specified
          will use this "default" version.  When set to False, the "default"
          alias will not be moved. Actions targeting the newly-uploaded model
          version will need to specifically reference this version by ID or
          alias.  New model uploads, i.e. version 1, will always be "default"
          aliased.
        version_aliases (Sequence[str]): Optional. User provided version aliases
          so that a model version can be referenced via alias instead of
          auto-generated version ID. A default version alias will be created for
          the first version of the model.  The format is
        ...
        local_model (Optional[LocalModel]): Optional. A LocalModel instance that
          includes a `serving_container_spec`. If provided, the
          `serving_container_spec` of the LocalModel instance will overwrite the
          values of all other serving container parameters.
        instance_schema_uri (str): Optional. Points to a YAML file stored on
          Google Cloud Storage describing the format of a single instance, which
          are used in ``PredictRequest.instances``, ``ExplainRequest.instances``
          and ``BatchPredictionJob.input_config``. The schema is defined as an
          OpenAPI 3.0.2 `Schema Object
          <https://tinyurl.com/y538mdwt#schema-object>`__. AutoML Models always
          have this field populated by AI Platform. Note: The URI given on
        ...
        parameters_schema_uri (str): Optional. Points to a YAML file stored on
          Google Cloud Storage describing the parameters of prediction and
          explanation via ``PredictRequest.parameters``,
          ``ExplainRequest.parameters`` and
          ``BatchPredictionJob.model_parameters``. The schema is defined as an
          OpenAPI 3.0.2 `Schema Object
          <https://tinyurl.com/y538mdwt#schema-object>`__. AutoML Models always
          have this field populated by AI Platform, if no parameters are
          supported it is set to an empty string. Note: The URI given on output
          will be immutable and probably different, including the URI scheme,
          than the one given on input. The output URI will point to a location
          where the user only has a read access.
        prediction_schema_uri (str): Optional. Points to a YAML file stored on
          ...
          ``BatchPredictionJob.output_config``. The schema is defined as an
          OpenAPI 3.0.2 `Schema Object
          <https://tinyurl.com/y538mdwt#schema-object>`__. AutoML Models always
          have this field populated by AI Platform. Note: The URI given on
          output will be immutable and probably different, including the URI
        ...
        explanation_parameters (aiplatform.explain.ExplanationParameters):
          Optional. Parameters to configure explaining for Model's predictions.
          For more details, see `Ref docs <http://tinyurl.com/1an4zake>`
        display_name (str): Optional. The display name of the Model. The name
          can be up to 128 characters long and can be consist of any UTF-8
          characters.
        project: Optional[str]=None, Project to upload this model to. Overrides
          project set in aiplatform.init.
        location: Optional[str]=None, Location to upload this model to.
          Overrides location set in aiplatform.init.
        credentials: Optional[auth_credentials.Credentials]=None, Custom
          credentials to use to upload this model. Overrides credentials set in
          aiplatform.init.
        labels (Dict[str, str]): Optional. The labels with user-defined metadata
          to organize your Models. Label keys and values can be no longer than
          64 characters (Unicode codepoints), can only contain lowercase
        ...
        encryption_spec_key_name (Optional[str]): Optional. The Cloud KMS
          ...
          protect the model. Has the
            form:
              ...
              this Model will be secured by this key.  Overrides
              encryption_spec_key_name set in aiplatform.init.
        staging_bucket (str): Optional. Bucket to stage local model artifacts.
          Overrides staging_bucket set in aiplatform.init.
        upload_request_timeout (float): Optional. The timeout for the upload
          request in seconds.
    ...
    Raises:
        ValueError: If explanation_metadata is specified while
    ...
    if artifact_uri and not artifact_uri.startswith("gs://"):
      ...
      PREBUILT_IMAGE_RE = (
          "(us|europe|asia)-docker.pkg.dev/vertex-ai/prediction/"
      )
      if re.match(PREBUILT_IMAGE_RE, serving_container_image_uri):
        if not model_dir.is_dir():
          raise ValueError(
              f"artifact_uri path must be a directory: '{artifact_uri}' when"
              f" using prebuilt image '{serving_container_image_uri}'"
          )
        if not any(
          ...
          raise ValueError(
              "artifact_uri directory does not contain any supported model"
              " files. When using a prebuilt serving image, the upload method"
              " only supports the following model files:"
              f" '{_SUPPORTED_MODEL_FILE_NAMES}'"
          )
    ...
    this_model = cls(
        model_upload_response.model,
        version=model_upload_response.model_version_id,
    )
  ...
  def deploy(
    ...
    Args:
        ...
        accelerator_count (int): Optional. The number of accelerators to attach
          to a worker replica.
        tpu_topology (str): Optional. The TPU topology to use for the
          DeployedModel. Requireid for CloudTPU multihost deployments.
        service_account (str): The service account that the DeployedModel's
          container runs as. Specify the email address of the service account.
          If this service account is not specified, the container runs as a
          service account that doesn't have access to the resource project.
        ...
        network (str): Optional. The full name of the Compute Engine network to
          ...
          documentation](https://cloud.google.com/vertex-ai/docs/predictions/using-private-endpoints).
          Cannot be set when enable_private_service_connect=True
        enable_private_service_connect (bool): If true, the endpoint can be
          accessible via [Private Service
          Connect](https://cloud.google.com/vpc/docs/private-service-connect).
          Cannot be True when network is specified.
  ...
  def _deploy(
    ...
    if endpoint is None:
      ...
      if not network and not enable_private_service_connect:
  ...
  def batch_predict(
    ...
    Args:
        job_display_name (str): Optional. The user-defined name of the
          BatchPredictionJob. The name can be up to 128 characters long and can
          be consist of any UTF-8 characters.
        gcs_source: Optional[Sequence[str]] = None Google Cloud Storage URI(-s)
          to your instances to run batch prediction on. They must match
          `instances_format`.
        bigquery_source: Optional[str] = None BigQuery URI to a table, up to
          2000 characters long. For example:
          `bq://projectId.bqDatasetId.bqTableId`
        instances_format: str = "jsonl" The format in which instances are
          provided. Must be one of the formats listed in
          `Model.supported_input_storage_formats`. Default is "jsonl" when using
          `gcs_source`. If a `bigquery_source` is provided, this is overridden
          to "bigquery".
        gcs_destination_prefix: Optional[str] = None The Google Cloud Storage
          location of the directory where the output is to be written to. In the
          given directory a new directory is created. Its name is
          ...
          value has ```google.rpc.Status`` <Status>`__ containing only ``code``
          and ``message`` fields.
        bigquery_destination_prefix: Optional[str] = None The BigQuery URI to a
          project or table, up to 2000 characters long. When only the project is
          specified, the Dataset and Table is created. When the full table
          reference is specified, the Dataset must exist and table must not
          exist. Accepted forms: ``bq://projectId`` or
          ``bq://projectId.bqDatasetId``. If no Dataset is specified, a new one
          is created with the name
          ``prediction_<model-display-name>_<job-create-time>`` where the table
          name is made BigQuery-dataset-name compatible (for example, most
          ...
          Model has both ``instance`` and ``prediction`` schemata defined then
          the tables have columns as
            follows: The ``predictions`` table contains instances for which the
              ...
              ``message``.
        predictions_format: str = "jsonl" Required. The format in which Vertex
          AI outputs the predictions, must be one of the formats specified in
          `Model.supported_output_storage_formats`. Default is "jsonl" when
          using `gcs_destination_prefix`. If a `bigquery_destination_prefix` is
          provided, this is overridden to "bigquery".
        model_parameters: Optional[Dict] = None Optional. The parameters that
          govern the predictions. The schema of the parameters may be specified
          via the Model's `parameters_schema_uri`.
        machine_type: Optional[str] = None Optional. The type of machine for
          running batch prediction on dedicated resources. Not specifying
          machine type will result in batch prediction job being run with
          automatic resources.
        accelerator_type: Optional[str] = None Optional. The type of
          accelerator(s) that may be attached to the machine as per
          `accelerator_count`. Only used if `machine_type` is set.
        accelerator_count: Optional[int] = None Optional. The number of
          accelerators to attach to the `machine_type`. Only used if
          `machine_type` is set.
        starting_replica_count: Optional[int] = None The number of machine
          replicas used at the start of the batch operation. If not set, Vertex
          AI decides starting number, not greater than `max_replica_count`. Only
          used if `machine_type` is set.
        max_replica_count: Optional[int] = None The maximum number of machine
        ...
        explanation_metadata (aiplatform.explain.ExplanationMetadata): Optional.
          Explanation metadata configuration for this BatchPredictionJob. Can be
          specified only if `generate_explanation` is set to `True`.  This value
          overrides the value of `Model.explanation_metadata`. All fields of
        ...
        explanation_parameters (aiplatform.explain.ExplanationParameters):
          ...
          value overrides the value of `Model.explanation_parameters`. All
          fields of `explanation_parameters` are optional in the request. If a
          field of the `explanation_parameters` object is not populated, the
        ...
        labels: Optional[Dict[str, str]] = None Optional. The labels with
          user-defined metadata to organize your BatchPredictionJobs. Label keys
          ...
          and dashes. International characters are allowed. See
          https://goo.gl/xmQnxf for more information and examples of labels.
        credentials: Optional[auth_credentials.Credentials] = None Optional.
          Custom credentials to use to create this batch prediction job.
  ...
  def list(
    ...
    Example Usage:
        aiplatform.Model.list(
            filter='labels.my_label="my_label_value" AND
  ...
  def _construct_sdk_resource_from_gapic(
    ...
    Args:
        gapic_resource (gca_model_compat.Model): A GAPIC representation of a
          Model resource.
        project (str): Optional. Project to construct SDK object from. If not
          set, project set in aiplatform.init will be used.
        location (str): Optional. Location to construct SDK object from. If not
          set, location set in aiplatform.init will be used.
        credentials (auth_credentials.Credentials): Optional. Custom credentials
          to use to construct SDK object. Overrides credentials set in
          aiplatform.init.

    Returns:
        Model:
            An initialized SDK Model object that represents the Model GAPIC
            type.
    """
    ...
    sdk_resource._resource_id_validator = (
        super()._revisioned_resource_id_validator
    )
  ...
  @base.optional_sync()
  def _wait_on_export(
      self, operation_future: operation.Operation, sync=True
  ) -> None:
    operation_future.result()
  ...
  def export_model(
    ...
    A Model is considered to be exportable if it has at least one
    `supported_export_formats`. Either `artifact_destination` or
    `image_destination` must be provided.
    ...
    Args:
        export_format_id (str): Required. The ID of the format in which the
          Model must be exported. The list of export formats that this Model
          supports can be found by calling `Model.supported_export_formats`.
        artifact_destination (str): The Cloud Storage location where the Model
        ...
        image_destination (str): The Google Container Registry or Artifact
          Registry URI where the Model container image will be copied to.
        ...
        sync (bool): Whether to execute this export synchronously. If False,
          this method will be executed in concurrent Future and any downstream
          object will be immediately returned and synced when the Future has
          completed.
    ...
    if export_format_id not in self.supported_export_formats:
      raise ValueError(
          f"'{export_format_id}' is not a supported export format for this"
          " model. Choose one of the following:"
          f" {self.supported_export_formats}"
      )
    ...
    if (
      ...
      raise ValueError(
          "This model can not be exported as an artifact in"
          " '{export_format_id}' format. Try exporting as a container image by"
          " passing the `image_destination` argument."
      )

    if image_destination and content_types.IMAGE not in supported_content_types:
      raise ValueError(
          "This model can not be exported as a container image in"
          " '{export_format_id}' format. Try exporting the model artifacts by"
          " passing a `artifact_destination` argument."
      )
    ...
    if image_destination:
      output_config.image_destination = (
          gca_io_compat.ContainerRegistryDestination(
  ...
  def upload_xgboost_model_file(
    ...
    Args:
        ...
        xgboost_version (str): Optional. The version of the XGBoost serving
          container. Supported versions: ["0.82", "0.90", "1.1", "1.2", "1.3",
          "1.4"]. If the version is not specified, the latest version is used.
        display_name (str): Optional. The display name of the Model. The name
          can be up to 128 characters long and can be consist of any UTF-8
          characters.
        description (str): The description of the model.
    ...
    if model_file_extension not in XGBOOST_SUPPORTED_MODEL_FILE_EXTENSIONS:
      _LOGGER.warning(
          "Only the following XGBoost model file extensions are currently"
          f" supported: '{XGBOOST_SUPPORTED_MODEL_FILE_EXTENSIONS}'"
      )
      _LOGGER.warning(
  ...
  def upload_scikit_learn_model_file(
    ...
    Args:
        model_file_path (str): Required. Local file path of the model.
        sklearn_version (str): Optional. The version of the Scikit-learn serving
          container. Supported versions: ["0.20", "0.22", "0.23", "0.24",
          "1.0"]. If the version is not specified, the latest version is used.
        display_name (str): Optional. The display name of the Model. The name
          can be up to 128 characters long and can be consist of any UTF-8
          characters.
        description (str): The description of the model.
    ...
    Raises:
        ValueError: If explanation_metadata is specified while
        explanation_parameters
            is not. Also if model directory does not contain a supported model
            file.
    """
    if not display_name:
    ...
    if model_file_extension not in SKLEARN_SUPPORTED_MODEL_FILE_EXTENSIONS:
      _LOGGER.warning(
          "Only the following Scikit-learn model file extensions are currently"
          f" supported: '{SKLEARN_SUPPORTED_MODEL_FILE_EXTENSIONS}'"
      )
      _LOGGER.warning(
  ...
  def upload_tensorflow_saved_model(
    ...
    Args:
        saved_model_dir (str): Required. Local directory of the Tensorflow
          SavedModel.
        tensorflow_version (str): Optional. The version of the Tensorflow
          serving container. Supported versions: ["0.15", "2.1", "2.2", "2.3",
          "2.4", "2.5", "2.6", "2.7"]. If the version is not specified, the
  ...
  def copy(
    ...
    Args:
        destination_location (str): The destination location to copy the model
          to.
        destination_model_id (str): Optional. The ID to use for the copied
          Model, which will become the final component of the model resource
          name. This value may be up to 63 characters, and valid characters are
          `[a-z0-9_-]`. The first character cannot be a number or hyphen.  Only
          set this field when copying as a new model. If this field is not set,
          a numeric model id will be generated.
        destination_parent_model (str): Optional. The resource name or model ID
          of an existing model that the newly-copied model will be a version of.
          Only set this field when copying as a new version of an existing
          model.
        encryption_spec_key_name (Optional[str]): Optional. The Cloud KMS
          resource identifier of the customer managed encryption key used to
          protect the model. Has the
            form:
              ...
              this Model will be secured by this key.  Overrides
              encryption_spec_key_name set in aiplatform.init.
        copy_request_timeout (float): Optional. The timeout for the copy request
          in seconds.
    ...
    Raises:
        ValueError: If both `destination_model_id` and
        `destination_parent_model` are set.
    """
    if (
        destination_model_id is not None
        and destination_parent_model is not None
    ):
      raise ValueError(
          "`destination_model_id` and `destination_parent_model` can not be set"
          " together."
      )
  ...
  def list_model_evaluations(
    ...
    If this Model resource was instantiated with a version, the Model Evaluation
    resources for that version will be returned. If no version was provided when
    the Model resource was instantiated, Model Evaluation resources will be
    returned for the default version.
  ...
  def get_model_evaluation(
    ...
    If no evaluation_id is passed, it will return the first evaluation
    associated with this model. If the aiplatform.Model resource was
    instantiated with a version, this will return a Model Evaluation from that
    version. If no version was specified when instantiating the Model resource,
    this will return an Evaluation from the default version.
    ...
    Example usage:
        ...
        # If no arguments are passed, this method returns the first evaluation
        for the model
        my_evaluation = my_model.get_model_evaluation()

    Args:
        evaluation_id (str): Optional. The ID of the model evaluation to
          retrieve.
    ...
    if not evaluation_id:
      if len(evaluations) > 1:
        _LOGGER.warning(
            "Your model has more than one model evaluation, this is returning"
            f" only one evaluation resource: {evaluations[0].resource_name}"
        )
  ...
  def evaluate(
    ...
    Args:
        prediction_type (str): Required. The problem type being addressed by
          this evaluation run. 'classification' and 'regression' are the
          currently supported problem types.
        target_field_name (str): Required. The column name of the field
          containing the label for this prediction task.
        ...
        staging_bucket (str): Optional. The GCS directory to use for staging
          files from this evaluation job. Defaults to the value set in
          aiplatform.init(staging_bucket=...) if not provided. Required if
          staging_bucket is not set in aiplatform.init().
        ...
        generate_feature_attributions (boolean): Optional. Whether the model
          ...
          if not specified.
        evaluation_pipeline_display_name (str): Optional. The display name of
          your model evaluation job. This is the display name that will be
          applied to the Vertex Pipeline run for your evaluation job. If not
          set, a display name will be generated automatically.
        evaluation_metrics_display_name (str): Optional. The display name of the
          model evaluation resource uploaded to Vertex from your Model
          Evaluation pipeline.
        ...
        encryption_spec_key_name (str): Optional. The Cloud KMS resource
          ...
          job. Has the
            form:
              ``projects/my-project/locations/my-region/keyRings/my-kr/cryptoKeys/my-key``.
              The key needs to be in the same region as where the compute
              resource is created. If this is set, then all resources created by
              the PipelineJob for this Model Evaluation will be encrypted with
              the provided encryption key. If not specified, encryption_spec of
              original PipelineJob will be used.
        experiment (Union[str, experiments_resource.Experiment]): Optional. The
          ...
          executing this model evaluation job. Metrics produced by the
          PipelineJob as system.Metric Artifacts will be associated as metrics
          to the provided experiment, and parameters from this PipelineJob will
          be associated as parameters to the provided experiment.
    ...
    Raises:
        ValueError:
            If staging_bucket was not set in aiplatform.init() and
            staging_bucket was not provided.
    ...
    if (gcs_source_uris is None) == (bigquery_source_uri is None):
      raise ValueError(
          "Exactly one of `gcs_source_uris` or `bigquery_source_uri` must be"
          " provided."
      )
    ...
    if bigquery_source_uri and not bigquery_destination_output_uri:
      raise ValueError(
          "`bigquery_destination_output_uri` must be provided if"
          " `bigquery_source_uri` is used as the data source."
      )
    ...
    if bigquery_source_uri is not None and not bigquery_source_uri.startswith(
      ...
      raise ValueError(
          "`bigquery_source_uri` and `bigquery_destination_output_uri` must"
          " start with 'bq://'"
      )
    ...
    if not staging_bucket and initializer.global_config.staging_bucket:
      ...
      raise ValueError(
          "Please provide `evaluation_staging_bucket` when calling evaluate or"
          " set one using aiplatform.init(staging_bucket=...)"
      )

    if prediction_type not in _SUPPORTED_EVAL_PREDICTION_TYPES:
      raise ValueError(
          "Please provide a supported model prediction type, one of:"
          f" {_SUPPORTED_EVAL_PREDICTION_TYPES}."
      )

    if generate_feature_attributions:
      if not self._gca_resource.explanation_spec:
        raise ValueError(
            "To generate feature attributions with your evaluation, call"
            " evaluate on a model with an explanation spec. To run evaluation"
            " on the current model, call evaluate with"
    ...
    if gcs_source_uris:
      ...
      if data_file_extension not in SUPPORTED_INSTANCES_FORMAT_FILE_EXTENSIONS:
        _LOGGER.warning(
            "Only the following data file extensions are currently supported:"
            f" '{SUPPORTED_INSTANCES_FORMAT_FILE_EXTENSIONS}'"
        )
      else:
    ...
    if (
      ...
      raise ValueError(
          "Please provide `class_labels` when running evaluation on a custom"
...
class ModelRegistry:
  ...
  def __init__(
    ...
    Args:
        model (Union[Model, str]): Required. One of the following: 1. A Model
          instance 2. A fully-qualified model resource name 3. A model ID. A
          location and project must be provided.
        location (str): Optional. The model location. Used when passing a model
          name as model. If not set, project set in aiplatform.init will be
          used.
        project (str): Optional. The model project. Used when passing a model
          name as model. If not set, project set in aiplatform.init will be
          used.
        credentials (auth_credentials.Credentials): Optional. Custom credentials
          to use with model access. If not set, credentials set in
  ...
  def get_model(
    ...
    Args:
        version (str): Optional. A model version ID or alias to target. Defaults
          to the model with the "default" alias.
  ...
  def list_versions(
    ...
    Args:
        filter (str): Optional. An expression for filtering the results of the
          ...
          key"`. Some examples: -  `labels.myKey="myValue"`
  ...
  def update_version(
    ...
    Args:
        ...
        version_description (str): The description of the model version.
        labels (Dict[str, str]): Optional. The labels with user-defined metadata
          to organize your Model versions. Label keys and values can be no
  ...
  def add_version_aliases(
    ...
    Args:
        new_aliases (List[str]): Required. The alias(es) to add to a model
          version.
        version (str): Required. The version ID to receive the new alias(es).
    """
  ...
  def remove_version_aliases(
    ...
    Args:
        target_aliases (List[str]): Required. The alias(es) to remove from a
          model version.
        version (str): Required. The version ID to be stripped of the target
          alias(es).
    """
  ...
  def _get_versioned_name(
    ...
    Args:
        resource_name (str): Required. A fully-qualified resource name or
          resource ID.
  ...
  def _parse_versioned_name(
    ...
    Returns:
        parsed_version_name (Tuple[str, Optional[str]]):
            ...
            and the model version as the second element, if present in
            `model_name`.

    Raises:
        ValueError: If the `model_name` is invalid and contains too many '@'
        symbols.
    """
  ...
  def _get_true_version_parent(
    ...
    Args:
        parent_model (str): Optional. A fully-qualified resource name or
          resource ID of the model that would be the parent of another model.
        project (str): Optional. The project of `parent_model`, if not included
          in `parent_model`.
        location (str): Optional. The location of `parent_model`, if not
          included in `parent_model`.

    Returns:
        true_parent_model (str):
            Optional. The true resource name of the parent model, if one should
            exist.
    """
    if parent_model:
  ...
  def _get_true_alias_list(
    ...
    Args:
        version_aliases (Sequence[str]): Optional. The user-provided list of
          model aliases.
        is_default_version (bool): Optional. When set, includes the "default"
          alias in `version_aliases`. Defaults to True.
