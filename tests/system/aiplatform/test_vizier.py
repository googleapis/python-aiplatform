...
class TestVizier(e2e_base.TestEndToEnd):
    ...
    def test_vizier_lifecycle(self, shared_state):
        ...
        sc.automated_stopping_config = pyvizier.AutomatedStoppingConfig.decay_curve_stopping_config(use_steps=True)

        study = aiplatform.Study.create_or_load(display_name=self._temp_prefix, problem=sc)
