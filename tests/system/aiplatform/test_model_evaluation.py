...
_TEST_SLICED_METRICS_CONFIG = [
    {"petal_length": 5.0, "petal_width": 2.5},
    {"sepal_length": 5.6},
]
...
class TestModelEvaluationJob(e2e_base.TestEndToEnd):
    ...
    # TODO: mock the ModelEvaluationSlice to unblock this test
    ...
    #     sliced_metrics = test_model.get_model_evaluation_slices(model_evaluation=eval_metrics)
