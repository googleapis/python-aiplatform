...
class TestFeaturestore(e2e_base.TestEndToEnd):
  ...
  def test_create_get_list_featurestore(self, shared_state):
    ...
    featurestore_id = self._make_display_name(
        key=_TEST_FEATURESTORE_ID).replace("-", "_")[:60]
  ...
  def test_create_get_list_features(self, shared_state):
    ...
    shared_state[
        "user_age_feature_resource_name"] = user_age_feature.resource_name
    ...
    shared_state[
        "user_gender_feature_resource_name"] = user_gender_feature.resource_name

    get_user_gender_feature = aiplatform.Feature(
        feature_name=user_gender_feature.resource_name)
    assert (user_gender_feature.resource_name ==
            get_user_gender_feature.resource_name)
    ...
    shared_state[
        "user_liked_genres_feature_resource_name"] = user_liked_genres_feature.resource_name

    get_user_liked_genres_feature = aiplatform.Feature(
        feature_name=user_liked_genres_feature.resource_name)
    assert (user_liked_genres_feature.resource_name ==
    ...
    assert (get_user_liked_genres_feature.resource_name
  ...
  def test_batch_create_features(self, shared_state):
    ...
    movie_entity_type.batch_create_features(
    ...
    assert (get_movie_avg_rating_feature.resource_name
            in movie_feature_resource_names)
  ...
  def test_batch_serve_to_df(self, shared_state, caplog):
    ...
    user_age_feature_resource_name = shared_state[
        "user_age_feature_resource_name"]
  ...
  def test_online_reads(self, shared_state):
    ...
    movie_entity_views = movie_entity_type.read(
        ...
        feature_ids=[
            _TEST_MOVIE_TITLE_FEATURE_ID, _TEST_MOVIE_GENRES_FEATURE_ID
        ],
    )
