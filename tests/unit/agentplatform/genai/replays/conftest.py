...
from agentplatform._genai import (
    client as agentplatform_genai_client_module,
)
from agentplatform._genai import _agent_engines_utils
from agentplatform._genai.client import (
...
@pytest.fixture
def mock_runtime_create_path_exists():
...
@pytest.fixture
def mock_runtime_create_base64_encoded_tarball():
...
@pytest.fixture
def mock_runtime_create_docker_base64_encoded_tarball():
    """Mocks the _create_base64_encoded_tarball function."""
    with mock.patch.object(
        _agent_engines_utils, "_create_base64_encoded_tarball"
        ...
        yield mock_runtime_create_docker_base64_encoded_tarball
...
def client(use_vertex, replays_prefix, http_options, request):
    ...
    with mock.patch.object(
        ...
        google_genai_client = agentplatform_genai_client_module.Client()
                ...
                with mock.patch.object(bigquery, "Client") as mock_bigquery_client:
                    ...
                    with mock.patch.object(
                        ...
                        with mock.patch.object(
                            ...
                            google_genai_client = (
                                agentplatform_genai_client_module.Client()
                            )
