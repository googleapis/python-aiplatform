...
def test_ingest_events(client):
    ...
    try:
        ...
        result = client.memory_banks.ingest_events(
            name=memory_bank.name,
            scope=scope,
            direct_contents_source={
                "events": [
            ...
            # applied to the memories generated from the ingested events.
            # Because `force_flush` makes generation synchronous, the
            # user-provided metadata is observable on the retrieved memory below.
            config={
...
pytestmark = pytest_helper.setup(
    ...
    test_method="memory_banks.ingest_events",
)
