...
# in third_party/py/google/cloud/aiplatform/tests/unit/agentplatform/genai/replays/
#
# Example:
#   ./third_party/py/google/cloud/aiplatform/tests/unit/agentplatform/genai/run_replay_tests.sh test_evals.py
...
DEFAULT_TEST_PATH="tests/unit/agentplatform/genai/replays/"
