...
class TestMultimodalDataset:
    ...
    def test_to_batch_job_source(self):
        dataset = types.MultimodalDataset(
            name="projects/vertex-sdk-dev/locations/us-central1/datasets/12345",
        )
        source = dataset.to_batch_job_source()
        assert source == genai_types.BatchJobSource(
            vertex_dataset_name="projects/vertex-sdk-dev/locations/us-central1/datasets/12345",
        )
