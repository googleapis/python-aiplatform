...
def test_update_reasoning_engine_empty_call():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = ReasoningEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.asyncio
async def test_update_reasoning_engine_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
    client = ReasoningEngineServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
...
def test_update_reasoning_engine_rest(request_type):
    client = ReasoningEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_update_reasoning_engine_rest_error():
    client = ReasoningEngineServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
