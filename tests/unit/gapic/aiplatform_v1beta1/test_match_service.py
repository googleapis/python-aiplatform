...
def test_find_neighbors_rest_required_fields(request_type=match_service.FindNeighborsRequest):
    ...
    default_values = getattr(
        transport_class._BaseFindNeighbors,
        "_BaseFindNeighbors__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
...
def test_read_index_datapoints_rest_required_fields(request_type=match_service.ReadIndexDatapointsRequest):
    ...
    default_values = getattr(
        transport_class._BaseReadIndexDatapoints,
        "_BaseReadIndexDatapoints__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {k: v for k, v in default_values.items() if k not in jsonified_request}
    jsonified_request.update(unset_fields)
