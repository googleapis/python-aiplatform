...
async def test_find_neighbors_async(request_type, transport: str = 'grpc_asyncio'):
    client = MatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_read_index_datapoints_async(request_type, transport: str = 'grpc_asyncio'):
    client = MatchServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
