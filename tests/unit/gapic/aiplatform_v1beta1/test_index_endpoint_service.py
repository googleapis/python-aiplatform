...
def test_create_index_endpoint_rest(request_type):
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_create_index_endpoint_rest_error():
    client = IndexEndpointServiceClient(
...
def test_get_index_endpoint_rest(request_type):
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_get_index_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = index_endpoint.IndexEndpoint.to_json(
            index_endpoint.IndexEndpoint()
        )
...
def test_get_index_endpoint_rest_bad_request(
    transport: str = "rest", request_type=index_endpoint_service.GetIndexEndpointRequest
):
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_index_endpoint_rest_error():
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_list_index_endpoints_rest(request_type):
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_update_index_endpoint_rest(request_type):
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_update_index_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = gca_index_endpoint.IndexEndpoint.to_json(
            gca_index_endpoint.IndexEndpoint()
        )
...
def test_update_index_endpoint_rest_error():
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_delete_index_endpoint_rest(request_type):
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_deploy_index_rest(request_type):
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_deploy_index_rest_bad_request(
    transport: str = "rest", request_type=index_endpoint_service.DeployIndexRequest
):
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_deploy_index_rest_error():
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_undeploy_index_rest(request_type):
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_undeploy_index_rest_bad_request(
    transport: str = "rest", request_type=index_endpoint_service.UndeployIndexRequest
):
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_undeploy_index_rest_error():
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
...
def test_mutate_deployed_index_rest(request_type):
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_mutate_deployed_index_rest_error():
    client = IndexEndpointServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
