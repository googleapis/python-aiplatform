...
def test_index_endpoint_service_client_service_account_always_use_jwt(client_class):
    with mock.patch.object(
...
def test_index_endpoint_service_client_service_account_always_use_jwt_true(
    transport_class, transport_name
):
    with mock.patch.object(
        service_account.Credentials, "with_always_use_jwt_access", create=True
