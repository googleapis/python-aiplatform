...
from google.cloud.aiplatform_v1beta1.services.featurestore_service import FeaturestoreServiceAsyncClient
from google.cloud.aiplatform_v1beta1.services.featurestore_service import FeaturestoreServiceClient
...
def test__get_client_cert_source():
    ...
    assert FeaturestoreServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert FeaturestoreServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source
...
def test_featurestore_service_client_from_service_account_info(client_class, transport_name):
...
def test_featurestore_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_featurestore_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (FeaturestoreServiceClient, transports.FeaturestoreServiceGrpcTransport, "grpc"),
    (FeaturestoreServiceAsyncClient, transports.FeaturestoreServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (FeaturestoreServiceClient, transports.FeaturestoreServiceRestTransport, "rest"),
])
@mock.patch.object(FeaturestoreServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FeaturestoreServiceClient))
@mock.patch.object(FeaturestoreServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FeaturestoreServiceAsyncClient))
def test_featurestore_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (FeaturestoreServiceClient, transports.FeaturestoreServiceGrpcTransport, "grpc", "true"),
    (FeaturestoreServiceAsyncClient, transports.FeaturestoreServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (FeaturestoreServiceClient, transports.FeaturestoreServiceGrpcTransport, "grpc", "false"),
    (FeaturestoreServiceAsyncClient, transports.FeaturestoreServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (FeaturestoreServiceClient, transports.FeaturestoreServiceRestTransport, "rest", "true"),
    (FeaturestoreServiceClient, transports.FeaturestoreServiceRestTransport, "rest", "false"),
])
@mock.patch.object(FeaturestoreServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FeaturestoreServiceClient))
@mock.patch.object(FeaturestoreServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(FeaturestoreServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_featurestore_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    FeaturestoreServiceClient, FeaturestoreServiceAsyncClient
])
@mock.patch.object(FeaturestoreServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(FeaturestoreServiceClient))
@mock.patch.object(FeaturestoreServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(FeaturestoreServiceAsyncClient))
...
def test_featurestore_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (FeaturestoreServiceClient, transports.FeaturestoreServiceGrpcTransport, "grpc", grpc_helpers),
    (FeaturestoreServiceAsyncClient, transports.FeaturestoreServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (FeaturestoreServiceClient, transports.FeaturestoreServiceRestTransport, "rest", None),
])
def test_featurestore_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_featurestore_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1beta1.services.featurestore_service.transports.FeaturestoreServiceGrpcTransport.__init__') as grpc_transport:
...
def test_featurestore_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_create_featurestore(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_featurestore),
            '__call__') as call:
...
def test_create_featurestore_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.CreateFeaturestoreRequest(
            parent='parent_value',
            featurestore_id='featurestore_id_value',
        )
...
def test_create_featurestore_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_featurestore in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_featurestore] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_featurestore_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_featurestore in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_featurestore] = mock_rpc
...
async def test_create_featurestore_async(request_type, transport: str = 'grpc_asyncio'):
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_featurestore(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_featurestore),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_featurestore_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.GetFeaturestoreRequest(
            name='name_value',
        )
        assert args[0] == request_msg
...
def test_get_featurestore_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_featurestore] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_featurestore_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeaturestoreServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_featurestore in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_featurestore] = mock_rpc
...
async def test_get_featurestore_async(request_type, transport: str = 'grpc_asyncio'):
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_featurestores_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.ListFeaturestoresRequest(
            parent='parent_value',
            filter='filter_value',
            page_token='page_token_value',
            order_by='order_by_value',
...
def test_list_featurestores_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_featurestores in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_featurestores] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_featurestores_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeaturestoreServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_featurestores in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_featurestores] = mock_rpc
...
async def test_list_featurestores_async(request_type, transport: str = 'grpc_asyncio'):
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(featurestore_service.ListFeaturestoresResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_featurestores_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, featurestore.Featurestore)
                   for i in results)
...
def test_update_featurestore(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_featurestore),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_featurestore_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.UpdateFeaturestoreRequest(
        )
        assert args[0] == request_msg
...
def test_update_featurestore_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_featurestore in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_featurestore] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_featurestore_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeaturestoreServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_featurestore in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_featurestore] = mock_rpc
...
async def test_update_featurestore_async(request_type, transport: str = 'grpc_asyncio'):
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_featurestore(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_featurestore),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_featurestore_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.DeleteFeaturestoreRequest(
            name='name_value',
        )
        assert args[0] == request_msg
...
def test_delete_featurestore_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_featurestore in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_featurestore] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_featurestore_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeaturestoreServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_featurestore in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_featurestore] = mock_rpc
...
async def test_delete_featurestore_async(request_type, transport: str = 'grpc_asyncio'):
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_entity_type_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.CreateEntityTypeRequest(
            parent='parent_value',
            entity_type_id='entity_type_id_value',
        )
        assert args[0] == request_msg
...
def test_get_entity_type_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.GetEntityTypeRequest(
            name='name_value',
        )
        assert args[0] == request_msg
...
def test_list_entity_types_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.ListEntityTypesRequest(
            parent='parent_value',
            filter='filter_value',
            page_token='page_token_value',
            order_by='order_by_value',
...
async def test_list_entity_types_async(request_type, transport: str = 'grpc_asyncio'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(featurestore_service.ListEntityTypesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_update_entity_type_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.UpdateEntityTypeRequest(
        )
        assert args[0] == request_msg
...
async def test_update_entity_type_async(request_type, transport: str = 'grpc_asyncio'):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gca_entity_type.EntityType(
            name='name_value',
            description='description_value',
            etag='etag_value',
            offline_storage_ttl_days=2554,
...
def test_delete_entity_type_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.DeleteEntityTypeRequest(
            name='name_value',
        )
        assert args[0] == request_msg
...
def test_import_feature_values(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.import_feature_values),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_import_feature_values_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.ImportFeatureValuesRequest(
            feature_time_field='feature_time_field_value',
            entity_type='entity_type_value',
            entity_id_field='entity_id_field_value',
        )
...
def test_import_feature_values_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.import_feature_values in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.import_feature_values] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_import_feature_values_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeaturestoreServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.import_feature_values in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.import_feature_values] = mock_rpc
...
async def test_import_feature_values_async(request_type, transport: str = 'grpc_asyncio'):
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_batch_read_feature_values(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_read_feature_values),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_batch_read_feature_values_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.BatchReadFeatureValuesRequest(
            featurestore='featurestore_value',
        )
        assert args[0] == request_msg
...
def test_batch_read_feature_values_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_read_feature_values in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_read_feature_values] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_read_feature_values_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeaturestoreServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_read_feature_values in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.batch_read_feature_values] = mock_rpc
...
async def test_batch_read_feature_values_async(request_type, transport: str = 'grpc_asyncio'):
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_export_feature_values(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.export_feature_values),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_export_feature_values_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.ExportFeatureValuesRequest(
            entity_type='entity_type_value',
        )
        assert args[0] == request_msg
...
def test_export_feature_values_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.export_feature_values in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.export_feature_values] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_export_feature_values_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeaturestoreServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.export_feature_values in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.export_feature_values] = mock_rpc
...
async def test_export_feature_values_async(request_type, transport: str = 'grpc_asyncio'):
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_feature_values(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_feature_values),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_feature_values_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.DeleteFeatureValuesRequest(
            entity_type='entity_type_value',
        )
        assert args[0] == request_msg
...
def test_delete_feature_values_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_feature_values in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_feature_values] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_feature_values_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeaturestoreServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_feature_values in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_feature_values] = mock_rpc
...
async def test_delete_feature_values_async(request_type, transport: str = 'grpc_asyncio'):
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_search_features_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        request_msg = featurestore_service.SearchFeaturesRequest(
            location='location_value',
            query='query_value',
            page_token='page_token_value',
        )
...
@pytest.mark.asyncio
async def test_search_features_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = FeaturestoreServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.search_features in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.search_features] = mock_rpc
...
async def test_search_features_async(request_type, transport: str = 'grpc_asyncio'):
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(featurestore_service.SearchFeaturesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_create_featurestore_rest_required_fields(request_type=featurestore_service.CreateFeaturestoreRequest):
...
def test_create_featurestore_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/featurestores" % client.transport._host, args[1])
...
def test_get_featurestore_rest_required_fields(request_type=featurestore_service.GetFeaturestoreRequest):
    transport_class = transports.FeaturestoreServiceRestTransport
...
def test_get_featurestore_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/featurestores/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/featurestores/*}" % client.transport._host, args[1])
...
def test_list_featurestores_rest_required_fields(request_type=featurestore_service.ListFeaturestoresRequest):
    transport_class = transports.FeaturestoreServiceRestTransport
...
def test_list_featurestores_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(featurestore_service.ListFeaturestoresResponse.to_json(x) for x in response)
...
def test_update_featurestore_rest_required_fields(request_type=featurestore_service.UpdateFeaturestoreRequest):
    transport_class = transports.FeaturestoreServiceRestTransport
...
def test_update_featurestore_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'featurestore': {'name': 'projects/sample1/locations/sample2/featurestores/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{featurestore.name=projects/*/locations/*/featurestores/*}" % client.transport._host, args[1])
...
def test_delete_featurestore_rest_required_fields(request_type=featurestore_service.DeleteFeaturestoreRequest):
    transport_class = transports.FeaturestoreServiceRestTransport
...
def test_create_entity_type_rest_required_fields(request_type=featurestore_service.CreateEntityTypeRequest):
    transport_class = transports.FeaturestoreServiceRestTransport
...
def test_create_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/featurestores/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/featurestores/*}/entityTypes" % client.transport._host, args[1])
...
def test_get_entity_type_rest_required_fields(request_type=featurestore_service.GetEntityTypeRequest):
    transport_class = transports.FeaturestoreServiceRestTransport
...
def test_get_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/featurestores/*/entityTypes/*}" % client.transport._host, args[1])
...
def test_list_entity_types_rest_required_fields(request_type=featurestore_service.ListEntityTypesRequest):
    transport_class = transports.FeaturestoreServiceRestTransport
...
def test_list_entity_types_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(featurestore_service.ListEntityTypesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_update_entity_type_rest_required_fields(request_type=featurestore_service.UpdateEntityTypeRequest):
    transport_class = transports.FeaturestoreServiceRestTransport
...
def test_update_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'entity_type': {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{entity_type.name=projects/*/locations/*/featurestores/*/entityTypes/*}" % client.transport._host, args[1])
...
def test_delete_entity_type_rest_required_fields(request_type=featurestore_service.DeleteEntityTypeRequest):
    transport_class = transports.FeaturestoreServiceRestTransport
...
def test_create_feature_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'parent': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/featurestores/*/entityTypes/*}/features" % client.transport._host, args[1])
...
def test_batch_create_features_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/featurestores/*/entityTypes/*}/features:batchCreate" % client.transport._host, args[1])
...
def test_get_feature_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4/features/sample5'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/featurestores/*/entityTypes/*/features/*}" % client.transport._host, args[1])
...
def test_update_feature_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'feature': {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4/features/sample5'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{feature.name=projects/*/locations/*/featurestores/*/entityTypes/*/features/*}" % client.transport._host, args[1])
...
def test_import_feature_values_rest_required_fields(request_type=featurestore_service.ImportFeatureValuesRequest):
    transport_class = transports.FeaturestoreServiceRestTransport
...
def test_import_feature_values_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'entity_type': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{entity_type=projects/*/locations/*/featurestores/*/entityTypes/*}:importFeatureValues" % client.transport._host, args[1])
...
def test_batch_read_feature_values_rest_required_fields(request_type=featurestore_service.BatchReadFeatureValuesRequest):
    transport_class = transports.FeaturestoreServiceRestTransport
...
def test_batch_read_feature_values_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'featurestore': 'projects/sample1/locations/sample2/featurestores/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{featurestore=projects/*/locations/*/featurestores/*}:batchReadFeatureValues" % client.transport._host, args[1])
...
def test_export_feature_values_rest_required_fields(request_type=featurestore_service.ExportFeatureValuesRequest):
    transport_class = transports.FeaturestoreServiceRestTransport
...
def test_export_feature_values_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{entity_type=projects/*/locations/*/featurestores/*/entityTypes/*}:exportFeatureValues" % client.transport._host, args[1])
...
def test_delete_feature_values_rest_required_fields(request_type=featurestore_service.DeleteFeatureValuesRequest):
    transport_class = transports.FeaturestoreServiceRestTransport
...
def test_delete_feature_values_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{entity_type=projects/*/locations/*/featurestores/*/entityTypes/*}:deleteFeatureValues" % client.transport._host, args[1])
...
def test_search_features_rest_required_fields(request_type=featurestore_service.SearchFeaturesRequest):
    transport_class = transports.FeaturestoreServiceRestTransport
...
def test_search_features_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{location=projects/*/locations/*}/featurestores:searchFeatures" % client.transport._host, args[1])
...
def test_search_features_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(featurestore_service.SearchFeaturesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_create_featurestore_empty_call_grpc():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_featurestore(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_featurestore_empty_call_grpc():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = featurestore.Featurestore()
        client.get_featurestore(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_featurestores_empty_call_grpc():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = featurestore_service.ListFeaturestoresResponse()
        client.list_featurestores(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_featurestore_empty_call_grpc():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_featurestore(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_featurestore_empty_call_grpc():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_featurestore(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_feature_values_empty_call_grpc():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.import_feature_values(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_read_feature_values_empty_call_grpc():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.batch_read_feature_values(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_feature_values_empty_call_grpc():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.export_feature_values(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_feature_values_empty_call_grpc():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_feature_values(request=None)
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_features_empty_call_grpc():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="grpc",
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = featurestore_service.SearchFeaturesResponse()
        client.search_features(request=None)
...
def test_transport_kind_grpc_asyncio():
    transport = FeaturestoreServiceAsyncClient.get_transport_class("grpc_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_featurestore_empty_call_grpc_asyncio():
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.create_featurestore(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_featurestore_empty_call_grpc_asyncio():
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.get_featurestore(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_featurestores_empty_call_grpc_asyncio():
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.list_featurestores(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_featurestore_empty_call_grpc_asyncio():
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.update_featurestore(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_featurestore_empty_call_grpc_asyncio():
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_featurestore(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_import_feature_values_empty_call_grpc_asyncio():
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.import_feature_values(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_read_feature_values_empty_call_grpc_asyncio():
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.batch_read_feature_values(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_export_feature_values_empty_call_grpc_asyncio():
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.export_feature_values(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_feature_values_empty_call_grpc_asyncio():
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.delete_feature_values(request=None)
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_search_features_empty_call_grpc_asyncio():
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport="grpc_asyncio",
    )
    ...
    with mock.patch.object(
        ...
        await client.search_features(request=None)
...
def test_transport_kind_rest():
    transport = FeaturestoreServiceClient.get_transport_class("rest")(
        credentials=ga_credentials.AnonymousCredentials()
    )
    assert transport.kind == "rest"


def test_create_featurestore_rest_bad_request(request_type=featurestore_service.CreateFeaturestoreRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_featurestore_rest_call_success(request_type):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["featurestore"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'etag': 'etag_value', 'labels': {}, 'online_serving_config': {'fixed_node_count': 1693, 'scaling': {'min_node_count': 1489, 'max_node_count': 1491, 'cpu_utilization_target': 2377}}, 'state': 1, 'online_storage_ttl_days': 2460, 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}, 'satisfies_pzs': True, 'satisfies_pzi': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = featurestore_service.CreateFeaturestoreRequest.meta.fields["featurestore"]
...
def test_create_featurestore_rest_interceptors(null_interceptor):
    transport = transports.FeaturestoreServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.FeaturestoreServiceRestInterceptor(),
        )
    client = FeaturestoreServiceClient(transport=transport)
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_create_featurestore") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_create_featurestore_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_create_featurestore") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.CreateFeaturestoreRequest.pb(featurestore_service.CreateFeaturestoreRequest())
        ...
        client.create_featurestore(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_featurestore_rest_bad_request(request_type=featurestore_service.GetFeaturestoreRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_featurestore_rest_call_success(request_type):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_featurestore_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_get_featurestore") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_get_featurestore_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_get_featurestore") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.GetFeaturestoreRequest.pb(featurestore_service.GetFeaturestoreRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.get_featurestore(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_featurestores_rest_bad_request(request_type=featurestore_service.ListFeaturestoresRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_featurestores_rest_call_success(request_type):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_featurestores_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_list_featurestores") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_list_featurestores_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_list_featurestores") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.ListFeaturestoresRequest.pb(featurestore_service.ListFeaturestoresRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = featurestore_service.ListFeaturestoresResponse.to_json(featurestore_service.ListFeaturestoresResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = featurestore_service.ListFeaturestoresResponse(), metadata

        client.list_featurestores(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_featurestore_rest_bad_request(request_type=featurestore_service.UpdateFeaturestoreRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'featurestore': {'name': 'projects/sample1/locations/sample2/featurestores/sample3'}}
    request = request_type(**request_init)
...
def test_update_featurestore_rest_call_success(request_type):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    ...
    # send a request that will satisfy transcoding
    request_init = {'featurestore': {'name': 'projects/sample1/locations/sample2/featurestores/sample3'}}
    request_init["featurestore"] = {'name': 'projects/sample1/locations/sample2/featurestores/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'etag': 'etag_value', 'labels': {}, 'online_serving_config': {'fixed_node_count': 1693, 'scaling': {'min_node_count': 1489, 'max_node_count': 1491, 'cpu_utilization_target': 2377}}, 'state': 1, 'online_storage_ttl_days': 2460, 'encryption_spec': {'kms_key_name': 'kms_key_name_value'}, 'satisfies_pzs': True, 'satisfies_pzi': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = featurestore_service.UpdateFeaturestoreRequest.meta.fields["featurestore"]
...
def test_update_featurestore_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_update_featurestore") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_update_featurestore_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_update_featurestore") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.UpdateFeaturestoreRequest.pb(featurestore_service.UpdateFeaturestoreRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_featurestore(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_featurestore_rest_bad_request(request_type=featurestore_service.DeleteFeaturestoreRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_featurestore_rest_call_success(request_type):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_featurestore_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_delete_featurestore") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_delete_featurestore_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_delete_featurestore") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.DeleteFeaturestoreRequest.pb(featurestore_service.DeleteFeaturestoreRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_featurestore(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_create_entity_type_rest_bad_request(request_type=featurestore_service.CreateEntityTypeRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/featurestores/sample3'}
    request = request_type(**request_init)
...
def test_create_entity_type_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/featurestores/sample3'}
    request_init["entity_type"] = {'name': 'name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'etag': 'etag_value', 'monitoring_config': {'snapshot_analysis': {'disabled': True, 'monitoring_interval': {'seconds': 751, 'nanos': 543}, 'monitoring_interval_days': 2586, 'staleness_days': 1506}, 'import_features_analysis': {'state': 1, 'anomaly_detection_baseline': 1}, 'numerical_threshold_config': {'value': 0.541}, 'categorical_threshold_config': {}}, 'offline_storage_ttl_days': 2554, 'satisfies_pzs': True, 'satisfies_pzi': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_create_entity_type") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_create_entity_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_create_entity_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.CreateEntityTypeRequest.pb(featurestore_service.CreateEntityTypeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_get_entity_type_rest_bad_request(request_type=featurestore_service.GetEntityTypeRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4'}
    request = request_type(**request_init)
...
def test_get_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_get_entity_type") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_get_entity_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_get_entity_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.GetEntityTypeRequest.pb(featurestore_service.GetEntityTypeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_list_entity_types_rest_bad_request(request_type=featurestore_service.ListEntityTypesRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_entity_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_list_entity_types") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_list_entity_types_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_list_entity_types") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.ListEntityTypesRequest.pb(featurestore_service.ListEntityTypesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = featurestore_service.ListEntityTypesResponse.to_json(featurestore_service.ListEntityTypesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = featurestore_service.ListEntityTypesResponse(), metadata
...
def test_update_entity_type_rest_bad_request(request_type=featurestore_service.UpdateEntityTypeRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'entity_type': {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4'}}
    request = request_type(**request_init)
...
def test_update_entity_type_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'entity_type': {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4'}}
    request_init["entity_type"] = {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'etag': 'etag_value', 'monitoring_config': {'snapshot_analysis': {'disabled': True, 'monitoring_interval': {'seconds': 751, 'nanos': 543}, 'monitoring_interval_days': 2586, 'staleness_days': 1506}, 'import_features_analysis': {'state': 1, 'anomaly_detection_baseline': 1}, 'numerical_threshold_config': {'value': 0.541}, 'categorical_threshold_config': {}}, 'offline_storage_ttl_days': 2554, 'satisfies_pzs': True, 'satisfies_pzi': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_update_entity_type") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_update_entity_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_update_entity_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.UpdateEntityTypeRequest.pb(featurestore_service.UpdateEntityTypeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_entity_type_rest_bad_request(request_type=featurestore_service.DeleteEntityTypeRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_entity_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_delete_entity_type") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_delete_entity_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_delete_entity_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.DeleteEntityTypeRequest.pb(featurestore_service.DeleteEntityTypeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_create_feature_rest_bad_request(request_type=featurestore_service.CreateFeatureRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4'}
    request = request_type(**request_init)
...
def test_create_feature_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4'}
    request_init["feature"] = {'name': 'name_value', 'description': 'description_value', 'value_type': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'etag': 'etag_value', 'monitoring_config': {'snapshot_analysis': {'disabled': True, 'monitoring_interval': {'seconds': 751, 'nanos': 543}, 'monitoring_interval_days': 2586, 'staleness_days': 1506}, 'import_features_analysis': {'state': 1, 'anomaly_detection_baseline': 1}, 'numerical_threshold_config': {'value': 0.541}, 'categorical_threshold_config': {}}, 'disable_monitoring': True, 'monitoring_stats': [{'score': 0.54, 'stats_uri': 'stats_uri_value', 'anomaly_uri': 'anomaly_uri_value', 'distribution_deviation': 0.23700000000000002, 'anomaly_detection_threshold': 0.28750000000000003, 'start_time': {}, 'end_time': {}}], 'monitoring_stats_anomalies': [{'objective': 1, 'feature_stats_anomaly': {}}], 'feature_stats_and_anomaly': [{'feature_id': 'feature_id_value', 'feature_stats': {'null_value': 0, 'number_value': 0.1285, 'string_value': 'string_value_value', 'bool_value': True, 'struct_value': {'fields': {}}, 'list_value': {'values': {}}}, 'distribution_deviation': 0.23700000000000002, 'drift_detection_threshold': 0.2659, 'drift_detected': True, 'stats_time': {}, 'feature_monitor_job_id': 2329, 'feature_monitor_id': 'feature_monitor_id_value'}], 'version_column_name': 'version_column_name_value', 'point_of_contact': 'point_of_contact_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_create_feature_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_create_feature") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_create_feature_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_create_feature") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_batch_create_features_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_batch_create_features") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_batch_create_features_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_batch_create_features") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_feature_rest_bad_request(request_type=featurestore_service.GetFeatureRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4/features/sample5'}
    request = request_type(**request_init)
...
def test_get_feature_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_get_feature") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_get_feature_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_get_feature") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_features_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_list_features") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_list_features_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_list_features") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_update_feature_rest_bad_request(request_type=featurestore_service.UpdateFeatureRequest):
    ...
    # send a request that will satisfy transcoding
    request_init = {'feature': {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4/features/sample5'}}
    request = request_type(**request_init)
...
def test_update_feature_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'feature': {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4/features/sample5'}}
    request_init["feature"] = {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4/features/sample5', 'description': 'description_value', 'value_type': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'etag': 'etag_value', 'monitoring_config': {'snapshot_analysis': {'disabled': True, 'monitoring_interval': {'seconds': 751, 'nanos': 543}, 'monitoring_interval_days': 2586, 'staleness_days': 1506}, 'import_features_analysis': {'state': 1, 'anomaly_detection_baseline': 1}, 'numerical_threshold_config': {'value': 0.541}, 'categorical_threshold_config': {}}, 'disable_monitoring': True, 'monitoring_stats': [{'score': 0.54, 'stats_uri': 'stats_uri_value', 'anomaly_uri': 'anomaly_uri_value', 'distribution_deviation': 0.23700000000000002, 'anomaly_detection_threshold': 0.28750000000000003, 'start_time': {}, 'end_time': {}}], 'monitoring_stats_anomalies': [{'objective': 1, 'feature_stats_anomaly': {}}], 'feature_stats_and_anomaly': [{'feature_id': 'feature_id_value', 'feature_stats': {'null_value': 0, 'number_value': 0.1285, 'string_value': 'string_value_value', 'bool_value': True, 'struct_value': {'fields': {}}, 'list_value': {'values': {}}}, 'distribution_deviation': 0.23700000000000002, 'drift_detection_threshold': 0.2659, 'drift_detected': True, 'stats_time': {}, 'feature_monitor_job_id': 2329, 'feature_monitor_id': 'feature_monitor_id_value'}], 'version_column_name': 'version_column_name_value', 'point_of_contact': 'point_of_contact_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_feature_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_update_feature") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_update_feature_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_update_feature") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_delete_feature_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_delete_feature") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_delete_feature_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_delete_feature") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_import_feature_values_rest_bad_request(request_type=featurestore_service.ImportFeatureValuesRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'entity_type': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4'}
    request = request_type(**request_init)
...
def test_import_feature_values_rest_call_success(request_type):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_import_feature_values_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_import_feature_values") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_import_feature_values_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_import_feature_values") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.ImportFeatureValuesRequest.pb(featurestore_service.ImportFeatureValuesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.import_feature_values(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_batch_read_feature_values_rest_bad_request(request_type=featurestore_service.BatchReadFeatureValuesRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'featurestore': 'projects/sample1/locations/sample2/featurestores/sample3'}
    request = request_type(**request_init)
...
def test_batch_read_feature_values_rest_call_success(request_type):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_read_feature_values_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_batch_read_feature_values") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_batch_read_feature_values_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_batch_read_feature_values") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.BatchReadFeatureValuesRequest.pb(featurestore_service.BatchReadFeatureValuesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.batch_read_feature_values(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_export_feature_values_rest_bad_request(request_type=featurestore_service.ExportFeatureValuesRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_feature_values_rest_call_success(request_type):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_export_feature_values_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_export_feature_values") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_export_feature_values_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_export_feature_values") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.ExportFeatureValuesRequest.pb(featurestore_service.ExportFeatureValuesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.export_feature_values(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_feature_values_rest_bad_request(request_type=featurestore_service.DeleteFeatureValuesRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_feature_values_rest_call_success(request_type):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_feature_values_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_delete_feature_values") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_delete_feature_values_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_delete_feature_values") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.DeleteFeatureValuesRequest.pb(featurestore_service.DeleteFeatureValuesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_feature_values(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_search_features_rest_bad_request(request_type=featurestore_service.SearchFeaturesRequest):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_search_features_rest_call_success(request_type):
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_search_features_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_search_features") as post, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "post_search_features_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.FeaturestoreServiceRestInterceptor, "pre_search_features") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.SearchFeaturesRequest.pb(featurestore_service.SearchFeaturesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = featurestore_service.SearchFeaturesResponse.to_json(featurestore_service.SearchFeaturesResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = featurestore_service.SearchFeaturesResponse(), metadata

        client.search_features(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_create_featurestore_empty_call_rest():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_get_featurestore_empty_call_rest():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_list_featurestores_empty_call_rest():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_update_featurestore_empty_call_rest():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_featurestore_empty_call_rest():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_import_feature_values_empty_call_rest():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_batch_read_feature_values_empty_call_rest():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_export_feature_values_empty_call_rest():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_delete_feature_values_empty_call_rest():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
# This test is a coverage failsafe to make sure that totally empty calls,
# i.e. request == None and no flattened fields passed, work.
def test_search_features_empty_call_rest():
    client = FeaturestoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_transport_kind_rest_asyncio():
    ...
    transport = FeaturestoreServiceAsyncClient.get_transport_class("rest_asyncio")(
        credentials=async_anonymous_credentials()
    )
...
@pytest.mark.asyncio
async def test_create_featurestore_rest_asyncio_bad_request(request_type=featurestore_service.CreateFeaturestoreRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_featurestore_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_create_featurestore_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
        interceptor=None if null_interceptor else transports.AsyncFeaturestoreServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_create_featurestore") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_create_featurestore_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_create_featurestore") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.CreateFeaturestoreRequest.pb(featurestore_service.CreateFeaturestoreRequest())
        ...
        await client.create_featurestore(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_featurestore_rest_asyncio_bad_request(request_type=featurestore_service.GetFeaturestoreRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_featurestore_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_get_featurestore_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_get_featurestore") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_get_featurestore_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_get_featurestore") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.GetFeaturestoreRequest.pb(featurestore_service.GetFeaturestoreRequest())
        ...
        await client.get_featurestore(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_featurestores_rest_asyncio_bad_request(request_type=featurestore_service.ListFeaturestoresRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_featurestores_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_list_featurestores_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_list_featurestores") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_list_featurestores_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_list_featurestores") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.ListFeaturestoresRequest.pb(featurestore_service.ListFeaturestoresRequest())
        ...
        await client.list_featurestores(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_update_featurestore_rest_asyncio_bad_request(request_type=featurestore_service.UpdateFeaturestoreRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_update_featurestore_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_update_featurestore_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_update_featurestore") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_update_featurestore_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_update_featurestore") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.UpdateFeaturestoreRequest.pb(featurestore_service.UpdateFeaturestoreRequest())
        ...
        await client.update_featurestore(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_featurestore_rest_asyncio_bad_request(request_type=featurestore_service.DeleteFeaturestoreRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_featurestore_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_delete_featurestore_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_delete_featurestore") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_delete_featurestore_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_delete_featurestore") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.DeleteFeaturestoreRequest.pb(featurestore_service.DeleteFeaturestoreRequest())
        ...
        await client.delete_featurestore(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_create_entity_type_rest_asyncio_bad_request(request_type=featurestore_service.CreateEntityTypeRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_entity_type_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_create_entity_type_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_create_entity_type") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_create_entity_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_create_entity_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.CreateEntityTypeRequest.pb(featurestore_service.CreateEntityTypeRequest())
        ...
        await client.create_entity_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_entity_type_rest_asyncio_bad_request(request_type=featurestore_service.GetEntityTypeRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_entity_type_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_get_entity_type_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_get_entity_type") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_get_entity_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_get_entity_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.GetEntityTypeRequest.pb(featurestore_service.GetEntityTypeRequest())
        ...
        await client.get_entity_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_entity_types_rest_asyncio_bad_request(request_type=featurestore_service.ListEntityTypesRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_entity_types_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_list_entity_types_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_list_entity_types") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_list_entity_types_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_list_entity_types") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.ListEntityTypesRequest.pb(featurestore_service.ListEntityTypesRequest())
        ...
        await client.list_entity_types(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_update_entity_type_rest_asyncio_bad_request(request_type=featurestore_service.UpdateEntityTypeRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_update_entity_type_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_update_entity_type_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_update_entity_type") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_update_entity_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_update_entity_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.UpdateEntityTypeRequest.pb(featurestore_service.UpdateEntityTypeRequest())
        ...
        await client.update_entity_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_entity_type_rest_asyncio_bad_request(request_type=featurestore_service.DeleteEntityTypeRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_entity_type_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_delete_entity_type_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_delete_entity_type") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_delete_entity_type_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_delete_entity_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.DeleteEntityTypeRequest.pb(featurestore_service.DeleteEntityTypeRequest())
        ...
        await client.delete_entity_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
async def test_create_feature_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_create_feature") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_create_feature_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_create_feature") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.CreateFeatureRequest.pb(featurestore_service.CreateFeatureRequest())
...
async def test_batch_create_features_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_batch_create_features") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_batch_create_features_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_batch_create_features") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.BatchCreateFeaturesRequest.pb(featurestore_service.BatchCreateFeaturesRequest())
...
async def test_get_feature_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_get_feature") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_get_feature_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_get_feature") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.GetFeatureRequest.pb(featurestore_service.GetFeatureRequest())
...
async def test_list_features_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_list_features") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_list_features_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_list_features") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.ListFeaturesRequest.pb(featurestore_service.ListFeaturesRequest())
...
async def test_update_feature_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_update_feature") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_update_feature_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_update_feature") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.UpdateFeatureRequest.pb(featurestore_service.UpdateFeatureRequest())
...
async def test_delete_feature_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_delete_feature") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_delete_feature_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_delete_feature") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.DeleteFeatureRequest.pb(featurestore_service.DeleteFeatureRequest())
...
@pytest.mark.asyncio
async def test_import_feature_values_rest_asyncio_bad_request(request_type=featurestore_service.ImportFeatureValuesRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_import_feature_values_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_import_feature_values_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_import_feature_values") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_import_feature_values_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_import_feature_values") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.ImportFeatureValuesRequest.pb(featurestore_service.ImportFeatureValuesRequest())
        ...
        await client.import_feature_values(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_batch_read_feature_values_rest_asyncio_bad_request(request_type=featurestore_service.BatchReadFeatureValuesRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_batch_read_feature_values_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_batch_read_feature_values_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_batch_read_feature_values") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_batch_read_feature_values_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_batch_read_feature_values") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.BatchReadFeatureValuesRequest.pb(featurestore_service.BatchReadFeatureValuesRequest())
        ...
        await client.batch_read_feature_values(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_export_feature_values_rest_asyncio_bad_request(request_type=featurestore_service.ExportFeatureValuesRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_export_feature_values_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_export_feature_values_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_export_feature_values") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_export_feature_values_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_export_feature_values") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.ExportFeatureValuesRequest.pb(featurestore_service.ExportFeatureValuesRequest())
        ...
        await client.export_feature_values(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_feature_values_rest_asyncio_bad_request(request_type=featurestore_service.DeleteFeatureValuesRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_feature_values_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_delete_feature_values_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_delete_feature_values") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_delete_feature_values_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_delete_feature_values") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.DeleteFeatureValuesRequest.pb(featurestore_service.DeleteFeatureValuesRequest())
        ...
        await client.delete_feature_values(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_search_features_rest_asyncio_bad_request(request_type=featurestore_service.SearchFeaturesRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_search_features_rest_asyncio_call_success(request_type):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_search_features_rest_asyncio_interceptors(null_interceptor):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    transport = transports.AsyncFeaturestoreServiceRestTransport(
        credentials=async_anonymous_credentials(),
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_search_features") as post, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "post_search_features_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncFeaturestoreServiceRestInterceptor, "pre_search_features") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = featurestore_service.SearchFeaturesRequest.pb(featurestore_service.SearchFeaturesRequest())
        ...
        await client.search_features(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_featurestore_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_featurestore_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_featurestores_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_featurestore_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_featurestore_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_create_entity_type_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_get_entity_type_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_list_entity_types_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_update_entity_type_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_entity_type_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_import_feature_values_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_batch_read_feature_values_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_export_feature_values_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_delete_feature_values_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
# i.e. request == None and no flattened fields passed, work.
@pytest.mark.asyncio
async def test_search_features_empty_call_rest_asyncio():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
def test_featurestore_service_rest_asyncio_lro_client():
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = FeaturestoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
def test_featurestore_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1beta1.services.featurestore_service.transports.FeaturestoreServiceTransport.__init__') as Transport:
...
def test_featurestore_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1beta1.services.featurestore_service.transports.FeaturestoreServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_featurestore_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1beta1.services.featurestore_service.transports.FeaturestoreServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.FeaturestoreServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.FeaturestoreServiceGrpcTransport, transports.FeaturestoreServiceGrpcAsyncIOTransport])
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.FeaturestoreServiceGrpcTransport, transports.FeaturestoreServiceGrpcAsyncIOTransport])
def test_featurestore_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_entity_type_path():
    ...
    actual = FeaturestoreServiceClient.entity_type_path(project, location, featurestore, entity_type)
...
def test_feature_path():
    ...
    actual = FeaturestoreServiceClient.feature_path(project, location, featurestore, entity_type, feature)
    assert expected == actual
...
def test_featurestore_path():
    ...
    location = "mussel"
    featurestore = "winkle"
    expected = "projects/{project}/locations/{location}/featurestores/{featurestore}".format(project=project, location=location, featurestore=featurestore, )
    actual = FeaturestoreServiceClient.featurestore_path(project, location, featurestore)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.FeaturestoreServiceTransport, '_prep_wrapped_messages') as prep:
        client = FeaturestoreServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (FeaturestoreServiceAsyncClient, transports.FeaturestoreServiceGrpcAsyncIOTransport),
])
