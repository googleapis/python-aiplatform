...
def test_create_notebook_runtime_template_rest_required_fields(request_type=notebook_service.CreateNotebookRuntimeTemplateRequest):
    ...
    default_values = getattr(
        transport_class._BaseCreateNotebookRuntimeTemplate,
    ...
    assert not set(unset_fields) - set(("notebookRuntimeTemplateId", ))
...
def test_get_notebook_runtime_template_rest_required_fields(request_type=notebook_service.GetNotebookRuntimeTemplateRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetNotebookRuntimeTemplate,
...
def test_list_notebook_runtime_templates_rest_required_fields(request_type=notebook_service.ListNotebookRuntimeTemplatesRequest):
    ...
    default_values = getattr(
        transport_class._BaseListNotebookRuntimeTemplates,
...
def test_delete_notebook_runtime_template_rest_required_fields(request_type=notebook_service.DeleteNotebookRuntimeTemplateRequest):
    ...
    default_values = getattr(
        transport_class._BaseDeleteNotebookRuntimeTemplate,
...
def test_update_notebook_runtime_template_rest_required_fields(request_type=notebook_service.UpdateNotebookRuntimeTemplateRequest):
    ...
    default_values = getattr(
        transport_class._BaseUpdateNotebookRuntimeTemplate,
...
def test_assign_notebook_runtime_rest_required_fields(request_type=notebook_service.AssignNotebookRuntimeRequest):
    ...
    default_values = getattr(
        transport_class._BaseAssignNotebookRuntime,
...
def test_get_notebook_runtime_rest_required_fields(request_type=notebook_service.GetNotebookRuntimeRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetNotebookRuntime,
...
def test_list_notebook_runtimes_rest_required_fields(request_type=notebook_service.ListNotebookRuntimesRequest):
    ...
    default_values = getattr(
        transport_class._BaseListNotebookRuntimes,
...
def test_delete_notebook_runtime_rest_required_fields(request_type=notebook_service.DeleteNotebookRuntimeRequest):
    ...
    default_values = getattr(
        transport_class._BaseDeleteNotebookRuntime,
...
def test_upgrade_notebook_runtime_rest_required_fields(request_type=notebook_service.UpgradeNotebookRuntimeRequest):
    ...
    default_values = getattr(
        transport_class._BaseUpgradeNotebookRuntime,
...
def test_start_notebook_runtime_rest_required_fields(request_type=notebook_service.StartNotebookRuntimeRequest):
    ...
    default_values = getattr(
        transport_class._BaseStartNotebookRuntime,
...
def test_stop_notebook_runtime_rest_required_fields(request_type=notebook_service.StopNotebookRuntimeRequest):
    ...
    default_values = getattr(
        transport_class._BaseStopNotebookRuntime,
...
def test_create_notebook_execution_job_rest_required_fields(request_type=notebook_service.CreateNotebookExecutionJobRequest):
    ...
    default_values = getattr(
        transport_class._BaseCreateNotebookExecutionJob,
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("notebookExecutionJobId", ))
...
def test_get_notebook_execution_job_rest_required_fields(request_type=notebook_service.GetNotebookExecutionJobRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetNotebookExecutionJob,
...
def test_list_notebook_execution_jobs_rest_required_fields(request_type=notebook_service.ListNotebookExecutionJobsRequest):
    ...
    default_values = getattr(
        transport_class._BaseListNotebookExecutionJobs,
    ...
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("filter", "orderBy", "pageSize", "pageToken", "view", ))
...
def test_delete_notebook_execution_job_rest_required_fields(request_type=notebook_service.DeleteNotebookExecutionJobRequest):
    ...
    default_values = getattr(
        transport_class._BaseDeleteNotebookExecutionJob,
