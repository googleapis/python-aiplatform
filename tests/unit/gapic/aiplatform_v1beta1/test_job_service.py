...
def modify_default_endpoint(client):
  return ("foo.googleapis.com" if
          ("localhost" in client.DEFAULT_ENDPOINT) else client.DEFAULT_ENDPOINT)
...
def test__get_default_mtls_endpoint():
  ...
  assert (JobServiceClient._get_default_mtls_endpoint(api_endpoint) ==
          api_mtls_endpoint)
  assert (JobServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) ==
          api_mtls_endpoint)
  assert (JobServiceClient._get_default_mtls_endpoint(sandbox_endpoint) ==
          sandbox_mtls_endpoint)
  assert (JobServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) ==
          sandbox_mtls_endpoint)
  assert JobServiceClient._get_default_mtls_endpoint(
...
def test_job_service_client_from_service_account_info(client_class,
  ...
  with mock.patch.object(service_account.Credentials,
                         "from_service_account_info") as factory:
    factory.return_value = creds
    info = {"valid": True}
    client = client_class.from_service_account_info(
...
@mock.patch.object(JobServiceClient, "DEFAULT_ENDPOINT",
                   modify_default_endpoint(JobServiceClient))
@mock.patch.object(
    JobServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(JobServiceAsyncClient),
)
def test_job_service_client_client_options(client_class, transport_class,
                                           transport_name):
...
def test_job_service_client_mtls_env_auto(client_class, transport_class,
                                          transport_name, use_client_cert_env):
...
def test_job_service_client_client_options_scopes(client_class, transport_class,
                                                  transport_name):
...
def test_job_service_client_create_channel_credentials_file(
  ...
  with mock.patch.object(
      ...
      autospec=True) as load_creds, mock.patch.object(
          google.auth, "default", autospec=True) as adc, mock.patch.object(
              grpc_helpers, "create_channel") as create_channel:
    creds = ga_credentials.AnonymousCredentials()
...
def test_create_custom_job(request_type, transport: str = "grpc"):
  ...
  with mock.patch.object(type(client.transport.create_custom_job),
                         "__call__") as call:
...
def test_get_custom_job(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.get_custom_job),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
async def test_list_custom_jobs_async_pager():
  ...
  with mock.patch.object(
      ...
      "__call__",
      new_callable=mock.AsyncMock) as call:
    # Set the response to a series of pages.
    call.side_effect = (
        job_service.ListCustomJobsResponse(
            custom_jobs=[
...
def test_delete_custom_job(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.delete_custom_job),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_cancel_custom_job(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.cancel_custom_job),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_list_data_labeling_jobs_pager(transport_name: str = "grpc"):
  ...
  with mock.patch.object(
    ...
    assert len(results) == 6
    assert all(
        isinstance(i, data_labeling_job.DataLabelingJob) for i in results)
...
async def test_list_data_labeling_jobs_async_pager():
  ...
  with mock.patch.object(
    ...
    assert len(responses) == 6
    assert all(
        isinstance(i, data_labeling_job.DataLabelingJob) for i in responses)
...
async def test_list_data_labeling_jobs_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_data_labeling_jobs(
        request={})).pages:  # pragma: no branch
      pages.append(page_)
    for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
      assert page_.raw_page.next_page_token == token
...
def test_create_hyperparameter_tuning_job(request_type,
                                          transport: str = "grpc"):
  client = JobServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
...
def test_create_hyperparameter_tuning_job_flattened():
  ...
  with mock.patch.object(
    ...
    client.create_hyperparameter_tuning_job(
        parent="parent_value",
        hyperparameter_tuning_job=gca_hyperparameter_tuning_job
...
async def test_list_hyperparameter_tuning_jobs_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_hyperparameter_tuning_jobs(
        request={})).pages:  # pragma: no branch
      pages.append(page_)
    for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
      assert page_.raw_page.next_page_token == token
...
def test_delete_hyperparameter_tuning_job(request_type,
                                          transport: str = "grpc"):
  client = JobServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
...
def test_cancel_hyperparameter_tuning_job(request_type,
                                          transport: str = "grpc"):
  client = JobServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
...
def test_get_batch_prediction_job(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.get_batch_prediction_job), "__call__") as call:
    # Designate an appropriate return value for the call.
...
async def test_list_batch_prediction_jobs_async_pager():
  ...
  with mock.patch.object(
    ...
    assert len(responses) == 6
    assert all(
        isinstance(i, batch_prediction_job.BatchPredictionJob)
        for i in responses)
...
async def test_list_batch_prediction_jobs_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_batch_prediction_jobs(
        request={})).pages:  # pragma: no branch
      pages.append(page_)
    for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
      assert page_.raw_page.next_page_token == token
...
def test_create_model_deployment_monitoring_job(request_type,
                                                transport: str = "grpc"):
  client = JobServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
  ...
  with mock.patch.object(
    ...
    call.return_value = gca_model_deployment_monitoring_job.ModelDeploymentMonitoringJob(
        ...
        state=job_state.JobState.JOB_STATE_QUEUED,
        schedule_state=gca_model_deployment_monitoring_job
        .ModelDeploymentMonitoringJob.MonitoringScheduleState.PENDING,
  ...
  assert response.state == job_state.JobState.JOB_STATE_QUEUED
  assert (response.schedule_state == gca_model_deployment_monitoring_job
          .ModelDeploymentMonitoringJob.MonitoringScheduleState.PENDING)
...
def test_create_model_deployment_monitoring_job_flattened():
  ...
  with mock.patch.object(
    ...
    client.create_model_deployment_monitoring_job(
        parent="parent_value",
        model_deployment_monitoring_job=gca_model_deployment_monitoring_job
        .ModelDeploymentMonitoringJob(name="name_value"),
    )
...
def test_get_model_deployment_monitoring_job(request_type,
                                             transport: str = "grpc"):
  client = JobServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
  ...
  with mock.patch.object(
    ...
    call.return_value = model_deployment_monitoring_job.ModelDeploymentMonitoringJob(
        ...
        endpoint="endpoint_value",
        state=job_state.JobState.JOB_STATE_QUEUED,
        schedule_state=model_deployment_monitoring_job
        .ModelDeploymentMonitoringJob.MonitoringScheduleState.PENDING,
        predict_instance_schema_uri="predict_instance_schema_uri_value",
        analysis_instance_schema_uri="analysis_instance_schema_uri_value",
        enable_monitoring_pipeline_logs=True,
  ...
  assert response.endpoint == "endpoint_value"
  assert response.state == job_state.JobState.JOB_STATE_QUEUED
  assert (response.schedule_state == model_deployment_monitoring_job
          .ModelDeploymentMonitoringJob.MonitoringScheduleState.PENDING)
  assert response.predict_instance_schema_uri == "predict_instance_schema_uri_value"
  assert response.analysis_instance_schema_uri == "analysis_instance_schema_uri_value"
  assert response.enable_monitoring_pipeline_logs is True
...
def test_list_model_deployment_monitoring_jobs(request_type,
                                               transport: str = "grpc"):
  client = JobServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
...
async def test_list_model_deployment_monitoring_jobs_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_model_deployment_monitoring_jobs(
        request={})).pages:  # pragma: no branch
      pages.append(page_)
    for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
      assert page_.raw_page.next_page_token == token
...
def test_update_model_deployment_monitoring_job(request_type,
                                                transport: str = "grpc"):
  client = JobServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
...
def test_delete_model_deployment_monitoring_job(request_type,
                                                transport: str = "grpc"):
  client = JobServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
...
def test_pause_model_deployment_monitoring_job(request_type,
                                               transport: str = "grpc"):
  client = JobServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
...
def test_resume_model_deployment_monitoring_job(request_type,
                                                transport: str = "grpc"):
  client = JobServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
...
def test_job_service_transport_create_channel(transport_class, grpc_helpers):
  ...
  with mock.patch.object(
      google.auth, "default", autospec=True) as adc, mock.patch.object(
          grpc_helpers, "create_channel", autospec=True) as create_channel:
    creds = ga_credentials.AnonymousCredentials()
    adc.return_value = (creds, None)
    transport_class(quota_project_id="octopus", scopes=["1", "2"])
...
def test_job_service_grpc_transport_client_cert_source_for_mtls(
  ...
  with mock.patch.object(transport_class,
                         "create_channel") as mock_create_channel:
  ...
  # is used.
  with mock.patch.object(
      transport_class, "create_channel", return_value=mock.Mock()):
...
def test_job_service_transport_channel_mtls_with_client_cert_source(
    transport_class):
  with mock.patch(
      "grpc.ssl_channel_credentials", autospec=True) as grpc_ssl_channel_cred:
    with mock.patch.object(transport_class,
                           "create_channel") as grpc_create_channel:
...
def test_batch_prediction_job_path():
  ...
  actual = JobServiceClient.batch_prediction_job_path(project, location,
...
def test_data_labeling_job_path():
  ...
  actual = JobServiceClient.data_labeling_job_path(project, location,
                                                   data_labeling_job)
  assert expected == actual
...
def test_client_with_default_client_info():
  ...
  with mock.patch.object(transports.JobServiceTransport,
...
async def test_transport_close_async():
  ...
  with mock.patch.object(
      type(getattr(client.transport, "grpc_channel")), "close") as close:
    async with client:
...
def test_delete_operation(transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.delete_operation),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = None
...
def test_cancel_operation(transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.cancel_operation),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = None
...
def test_wait_operation(transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.wait_operation),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_get_operation(transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.get_operation),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = operations_pb2.Operation()
...
def test_list_operations(transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.list_operations),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_get_location(transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.get_location),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_set_iam_policy(transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.set_iam_policy),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_get_iam_policy(transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.get_iam_policy),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = policy_pb2.Policy(
        version=774,
    ...
    response = client.get_iam_policy(
        request={
            "resource":
                "resource_value",
            "options":
                options_pb2.GetPolicyOptions(requested_policy_version=2598),
        })
    call.assert_called()
...
def test_transport_close():
  ...
  for transport, close_name in transports.items():
    ...
    with mock.patch.object(
        type(getattr(client.transport, close_name)), "close") as close:
      with client:
        close.assert_not_called()
      close.assert_called_once()
...
def test_api_key_credentials(client_class, transport_class):
  with mock.patch.object(
      ...
      create=True) as get_api_key_credentials:
    mock_cred = mock.Mock()
