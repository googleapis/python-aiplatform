...
from google.cloud.aiplatform_v1beta1.services.gen_ai_tuning_service import GenAiTuningServiceAsyncClient
...
def test_gen_ai_tuning_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1beta1.services.gen_ai_tuning_service.transports.GenAiTuningServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_tuning_job_rest_required_fields(request_type=genai_tuning_service.CreateTuningJobRequest):
    ...
    default_values = getattr(
        transport_class._BaseCreateTuningJob,
        "_BaseCreateTuningJob__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
...
def test_create_tuning_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/tuningJobs" % client.transport._host, args[1])
...
def test_get_tuning_job_rest_required_fields(request_type=genai_tuning_service.GetTuningJobRequest):
    ...
    default_values = getattr(
        transport_class._BaseGetTuningJob,
        "_BaseGetTuningJob__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {k: v for k, v in default_values.items() if k not in jsonified_request}
    jsonified_request.update(unset_fields)
...
def test_get_tuning_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/tuningJobs/*}" % client.transport._host, args[1])
...
def test_list_tuning_jobs_rest_required_fields(request_type=genai_tuning_service.ListTuningJobsRequest):
    ...
    default_values = getattr(
        transport_class._BaseListTuningJobs,
        "_BaseListTuningJobs__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {k: v for k, v in default_values.items() if k not in jsonified_request}
    jsonified_request.update(unset_fields)
...
def test_cancel_tuning_job_rest_required_fields(request_type=genai_tuning_service.CancelTuningJobRequest):
    ...
    default_values = getattr(
        transport_class._BaseCancelTuningJob,
        "_BaseCancelTuningJob__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {k: v for k, v in default_values.items() if k not in jsonified_request}
    jsonified_request.update(unset_fields)
...
def test_cancel_tuning_job_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/tuningJobs/*}:cancel" % client.transport._host, args[1])
...
def test_rebase_tuned_model_rest_required_fields(request_type=genai_tuning_service.RebaseTunedModelRequest):
    ...
    default_values = getattr(
        transport_class._BaseRebaseTunedModel,
        "_BaseRebaseTunedModel__REQUIRED_FIELDS_DEFAULT_VALUES",
        {},
    )
    unset_fields = {k: v for k, v in default_values.items() if k not in jsonified_request}
    jsonified_request.update(unset_fields)
...
def test_rebase_tuned_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*}/tuningJobs:rebaseTunedModel" % client.transport._host, args[1])
...
def test_gen_ai_tuning_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1beta1.services.gen_ai_tuning_service.transports.GenAiTuningServiceTransport.__init__') as Transport:
...
def test_gen_ai_tuning_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1beta1.services.gen_ai_tuning_service.transports.GenAiTuningServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_gen_ai_tuning_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1beta1.services.gen_ai_tuning_service.transports.GenAiTuningServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GenAiTuningServiceTransport()
        adc.assert_called_once()
