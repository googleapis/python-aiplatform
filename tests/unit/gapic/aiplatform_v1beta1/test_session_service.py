...
from google.cloud.aiplatform_v1beta1.services.session_service import SessionServiceAsyncClient
from google.cloud.aiplatform_v1beta1.services.session_service import SessionServiceClient
...
def test_session_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1beta1.services.session_service.transports.SessionServiceGrpcTransport.__init__') as grpc_transport:
...
async def test_append_event_async(request_type, transport: str = 'grpc_asyncio'):
    client = SessionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/reasoningEngines/*}/sessions" % client.transport._host, args[1])
...
def test_get_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/reasoningEngines/*/sessions/*}" % client.transport._host, args[1])
...
def test_update_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{session.name=projects/*/locations/*/reasoningEngines/*/sessions/*}" % client.transport._host, args[1])
...
def test_list_events_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/reasoningEngines/*/sessions/*}/events" % client.transport._host, args[1])
...
def test_append_event_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/reasoningEngines/*/sessions/*}:appendEvent" % client.transport._host, args[1])
...
def test_session_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1beta1.services.session_service.transports.SessionServiceTransport.__init__') as Transport:
...
def test_session_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1beta1.services.session_service.transports.SessionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_session_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1beta1.services.session_service.transports.SessionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SessionServiceTransport()
        adc.assert_called_once()
