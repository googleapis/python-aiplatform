...
def test_create_specialist_pool(
    ...
    with mock.patch.object(
        type(client._transport.create_specialist_pool), "__call__"
    ) as call:
...
async def test_create_specialist_pool_async(transport: str = "grpc_asyncio"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._client._transport.create_specialist_pool), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
def test_get_specialist_pool(
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._transport.get_specialist_pool), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
async def test_get_specialist_pool_async(transport: str = "grpc_asyncio"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._client._transport.get_specialist_pool), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(
...
def test_list_specialist_pools(
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._transport.list_specialist_pools), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
async def test_list_specialist_pools_async(transport: str = "grpc_asyncio"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._client._transport.list_specialist_pools), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(
...
async def test_list_specialist_pools_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._client._transport.list_specialist_pools),
        "__call__",
...
def test_delete_specialist_pool(
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._transport.delete_specialist_pool), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
async def test_delete_specialist_pool_async(transport: str = "grpc_asyncio"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._client._transport.delete_specialist_pool), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(
            operations_pb2.Operation(name="operations/spam")
...
def test_update_specialist_pool(
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._transport.update_specialist_pool), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
async def test_update_specialist_pool_async(transport: str = "grpc_asyncio"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client._client._transport.update_specialist_pool), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(
            operations_pb2.Operation(name="operations/spam")
