...
def test_evaluation_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.aiplatform_v1beta1.services.evaluation_service.transports.EvaluationServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_generate_instance_rubrics(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.generate_instance_rubrics), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
def test_generate_instance_rubrics_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.generate_instance_rubrics
...
@pytest.mark.asyncio
async def test_generate_instance_rubrics_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.generate_instance_rubrics
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_generate_instance_rubrics_async(
    transport: str = "grpc_asyncio",
    request_type=evaluation_service.GenerateInstanceRubricsRequest,
):
    client = EvaluationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_generate_instance_rubrics_rest_required_fields(
    request_type=evaluation_service.GenerateInstanceRubricsRequest,
):
    transport_class = transports.EvaluationServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).generate_instance_rubrics._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            # Convert return value to protobuf type
            return_value = evaluation_service.GenerateInstanceRubricsResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(return_value)
...
def test_generate_instance_rubrics_rest_bad_request(
    request_type=evaluation_service.GenerateInstanceRubricsRequest,
):
    client = EvaluationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_generate_instance_rubrics_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.EvaluationServiceRestInterceptor, "post_generate_instance_rubrics"
    ) as post, mock.patch.object(
        transports.EvaluationServiceRestInterceptor,
        "post_generate_instance_rubrics_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.EvaluationServiceRestInterceptor, "pre_generate_instance_rubrics"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = evaluation_service.GenerateInstanceRubricsRequest.pb(
            evaluation_service.GenerateInstanceRubricsRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = evaluation_service.GenerateInstanceRubricsResponse.to_json(
            evaluation_service.GenerateInstanceRubricsResponse()
        )
        req.return_value.content = return_value
        ...
        client.generate_instance_rubrics(
            request,
            metadata=[
                ("key", "val"),
                ("cephalopod", "squid"),
...
@pytest.mark.asyncio
async def test_generate_instance_rubrics_rest_asyncio_bad_request(
    request_type=evaluation_service.GenerateInstanceRubricsRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
async def test_generate_instance_rubrics_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AsyncEvaluationServiceRestInterceptor,
        "post_generate_instance_rubrics",
    ) as post, mock.patch.object(
        transports.AsyncEvaluationServiceRestInterceptor,
        "post_generate_instance_rubrics_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.AsyncEvaluationServiceRestInterceptor,
        "pre_generate_instance_rubrics",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        await client.generate_instance_rubrics(
            request,
            metadata=[
                ("key", "val"),
                ("cephalopod", "squid"),
...
def test_evaluation_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.aiplatform_v1beta1.services.evaluation_service.transports.EvaluationServiceTransport.__init__"
    ) as Transport:
...
def test_evaluation_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.aiplatform_v1beta1.services.evaluation_service.transports.EvaluationServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
