...
async def test_list_model_versions_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_model_versions(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_recommend_spec(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.recommend_spec), "__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_recommend_spec_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(type(client.transport.recommend_spec), "__call__") as call:
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == model_service.RecommendSpecRequest(
            parent="parent_value",
            gcs_uri="gcs_uri_value",
        )
...
@pytest.mark.asyncio
async def test_recommend_spec_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.recommend_spec
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_recommend_spec_async(
    transport: str = "grpc_asyncio", request_type=model_service.RecommendSpecRequest
):
    client = ModelServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
@pytest.mark.asyncio
async def test_recommend_spec_async_from_dict():
    await test_recommend_spec_async(request_type=dict)
...
def test_list_model_version_checkpoints_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1beta1/{name=projects/*/locations/*/models/*}:listCheckpoints"
            % client.transport._host,
            args[1],
        )
...
def test_recommend_spec_rest_required_fields(
    request_type=model_service.RecommendSpecRequest,
):
    transport_class = transports.ModelServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).recommend_spec._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_recommend_spec_rest_bad_request(
    request_type=model_service.RecommendSpecRequest,
):
    client = ModelServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_recommend_spec_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ModelServiceRestInterceptor, "post_recommend_spec"
    ) as post, mock.patch.object(
        transports.ModelServiceRestInterceptor, "post_recommend_spec_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.ModelServiceRestInterceptor, "pre_recommend_spec"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = model_service.RecommendSpecRequest.pb(
            model_service.RecommendSpecRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = model_service.RecommendSpecResponse.to_json(
            model_service.RecommendSpecResponse()
        )
        req.return_value.content = return_value
...
@pytest.mark.asyncio
async def test_upload_model_rest_asyncio_bad_request(
    request_type=model_service.UploadModelRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_get_model_rest_asyncio_bad_request(
    request_type=model_service.GetModelRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
            "the library must be installed with the `async_rest` extra to test this feature."
...
@pytest.mark.asyncio
async def test_list_models_rest_asyncio_bad_request(
    request_type=model_service.ListModelsRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
            "the library must be installed with the `async_rest` extra to test this feature."
...
@pytest.mark.asyncio
async def test_list_model_versions_rest_asyncio_bad_request(
    request_type=model_service.ListModelVersionsRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_update_model_rest_asyncio_bad_request(
    request_type=model_service.UpdateModelRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_update_explanation_dataset_rest_asyncio_bad_request(
    request_type=model_service.UpdateExplanationDatasetRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_delete_model_rest_asyncio_bad_request(
    request_type=model_service.DeleteModelRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_delete_model_version_rest_asyncio_bad_request(
    request_type=model_service.DeleteModelVersionRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_merge_version_aliases_rest_asyncio_bad_request(
    request_type=model_service.MergeVersionAliasesRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_export_model_rest_asyncio_bad_request(
    request_type=model_service.ExportModelRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_copy_model_rest_asyncio_bad_request(
    request_type=model_service.CopyModelRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
            "the library must be installed with the `async_rest` extra to test this feature."
...
@pytest.mark.asyncio
async def test_import_model_evaluation_rest_asyncio_bad_request(
    request_type=model_service.ImportModelEvaluationRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_batch_import_model_evaluation_slices_rest_asyncio_bad_request(
    request_type=model_service.BatchImportModelEvaluationSlicesRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
async def test_batch_import_model_evaluation_slices_rest_asyncio_call_success(
    request_type,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_batch_import_model_evaluation_slices_rest_asyncio_interceptors(
    null_interceptor,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_batch_import_evaluated_annotations_rest_asyncio_bad_request(
    request_type=model_service.BatchImportEvaluatedAnnotationsRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
async def test_batch_import_evaluated_annotations_rest_asyncio_call_success(
    request_type,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
@pytest.mark.parametrize("null_interceptor", [True, False])
async def test_batch_import_evaluated_annotations_rest_asyncio_interceptors(
    null_interceptor,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_get_model_evaluation_rest_asyncio_bad_request(
    request_type=model_service.GetModelEvaluationRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_list_model_evaluations_rest_asyncio_bad_request(
    request_type=model_service.ListModelEvaluationsRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_get_model_evaluation_slice_rest_asyncio_bad_request(
    request_type=model_service.GetModelEvaluationSliceRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_list_model_evaluation_slices_rest_asyncio_bad_request(
    request_type=model_service.ListModelEvaluationSlicesRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_recommend_spec_rest_asyncio_bad_request(
    request_type=model_service.RecommendSpecRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
async def test_recommend_spec_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AsyncModelServiceRestInterceptor, "post_recommend_spec"
    ) as post, mock.patch.object(
        transports.AsyncModelServiceRestInterceptor, "post_recommend_spec_with_metadata"
    ) as post_with_metadata, mock.patch.object(
        transports.AsyncModelServiceRestInterceptor, "pre_recommend_spec"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_reservation_path():
    ...
    actual = ModelServiceClient.reservation_path(
...
async def test_get_location_field_headers_async():
    client = ModelServiceAsyncClient(credentials=async_anonymous_credentials())
