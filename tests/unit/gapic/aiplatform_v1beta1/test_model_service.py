...
def test__get_default_mtls_endpoint():
  ...
  assert (ModelServiceClient._get_default_mtls_endpoint(api_endpoint) ==
          api_mtls_endpoint)
  assert (ModelServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) ==
          api_mtls_endpoint)
  assert (ModelServiceClient._get_default_mtls_endpoint(sandbox_endpoint) ==
          sandbox_mtls_endpoint)
  assert (ModelServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
          == sandbox_mtls_endpoint)
  assert ModelServiceClient._get_default_mtls_endpoint(
...
@mock.patch.object(ModelServiceClient, "DEFAULT_ENDPOINT",
                   modify_default_endpoint(ModelServiceClient))
@mock.patch.object(
    ModelServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(ModelServiceAsyncClient),
)
def test_model_service_client_client_options(client_class, transport_class,
                                             transport_name):
...
def test_model_service_client_mtls_env_auto(client_class, transport_class,
                                            transport_name,
                                            use_client_cert_env):
...
def test_model_service_client_client_options_scopes(client_class,
                                                    transport_class,
                                                    transport_name):
...
def test_list_models(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.list_models),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
async def test_list_models_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_models(request={}
...
def test_list_model_versions(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.list_model_versions), "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_list_model_versions_flattened():
  ...
  with mock.patch.object(
    ...
    # Call the method with a truthy value for each flattened field,
    # using the keyword arguments to the method.
    client.list_model_versions(name="name_value",)
...
async def test_list_model_versions_flattened_async():
  ...
  with mock.patch.object(
    ...
    # Call the method with a truthy value for each flattened field,
    # using the keyword arguments to the method.
    response = await client.list_model_versions(name="name_value",)
...
def test_update_model(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.update_model),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_update_explanation_dataset(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.update_explanation_dataset), "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_update_explanation_dataset_flattened():
  ...
  with mock.patch.object(
    ...
    # Call the method with a truthy value for each flattened field,
    # using the keyword arguments to the method.
    client.update_explanation_dataset(model="model_value",)
...
async def test_update_explanation_dataset_flattened_async():
  ...
  with mock.patch.object(
    ...
    # Call the method with a truthy value for each flattened field,
    # using the keyword arguments to the method.
    response = await client.update_explanation_dataset(model="model_value",)
...
def test_delete_model(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.delete_model),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_delete_model_version(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.delete_model_version), "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_delete_model_version_flattened():
  ...
  with mock.patch.object(
    ...
    # Call the method with a truthy value for each flattened field,
    # using the keyword arguments to the method.
    client.delete_model_version(name="name_value",)
...
async def test_delete_model_version_flattened_async():
  ...
  with mock.patch.object(
    ...
    # Call the method with a truthy value for each flattened field,
    # using the keyword arguments to the method.
    response = await client.delete_model_version(name="name_value",)
...
def test_merge_version_aliases(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.merge_version_aliases), "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = model.Model(
        name="name_value",
        version_id="version_id_value",
...
def test_export_model(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.export_model),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_import_model_evaluation(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.import_model_evaluation), "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_import_model_evaluation_flattened():
  ...
  with mock.patch.object(
    ...
    client.import_model_evaluation(
        parent="parent_value",
        model_evaluation=gca_model_evaluation.ModelEvaluation(
            name="name_value"),
    )
...
def test_batch_import_model_evaluation_slices(request_type,
                                              transport: str = "grpc"):
  client = ModelServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
...
def test_get_model_evaluation(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.get_model_evaluation), "__call__") as call:
    # Designate an appropriate return value for the call.
...
async def test_list_model_evaluations_async_pager():
  ...
  with mock.patch.object(
    ...
    assert len(responses) == 6
    assert all(
        isinstance(i, model_evaluation.ModelEvaluation) for i in responses)
...
async def test_list_model_evaluations_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_model_evaluations(
...
def test_list_model_evaluation_slices(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.list_model_evaluation_slices), "__call__") as call:
    # Designate an appropriate return value for the call.
...
async def test_list_model_evaluation_slices_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_model_evaluation_slices(
        request={})).pages:  # pragma: no branch
      pages.append(page_)
    for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
      assert page_.raw_page.next_page_token == token
...
def test_model_evaluation_path():
  ...
  actual = ModelServiceClient.model_evaluation_path(project, location, model,
                                                    evaluation)
  assert expected == actual
...
def test_training_pipeline_path():
  ...
  actual = ModelServiceClient.training_pipeline_path(project, location,
                                                     training_pipeline)
  assert expected == actual
...
def test_client_with_default_client_info():
  ...
  with mock.patch.object(transports.ModelServiceTransport,
