...
def test__get_default_mtls_endpoint():
    ...
    assert (
        ExtensionRegistryServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": ""}):
            with mock.patch.dict(os.environ, {"GOOGLE_API_CERTIFICATE_CONFIG": ""}):
                assert (
                    ExtensionRegistryServiceClient._use_client_cert_effective() is False
                )
...
@pytest.mark.asyncio
async def test_import_extension_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.import_extension
...
@pytest.mark.asyncio
async def test_get_extension_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.get_extension
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_list_extensions_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.list_extensions
            in client._client._transport._wrapped_methods
        )
...
async def test_list_extensions_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_extensions(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
@pytest.mark.asyncio
async def test_update_extension_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.update_extension
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_delete_extension_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.delete_extension
            in client._client._transport._wrapped_methods
        )
...
def test_import_extension_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ExtensionRegistryServiceRestInterceptor,
...
@pytest.mark.asyncio
async def test_import_extension_rest_asyncio_bad_request(
    request_type=extension_registry_service.ImportExtensionRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
async def test_import_extension_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AsyncExtensionRegistryServiceRestInterceptor, "post_import_extension"
    ) as post, mock.patch.object(
        transports.AsyncExtensionRegistryServiceRestInterceptor,
        "post_import_extension_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.AsyncExtensionRegistryServiceRestInterceptor, "pre_import_extension"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
@pytest.mark.asyncio
async def test_get_extension_rest_asyncio_bad_request(
    request_type=extension_registry_service.GetExtensionRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
async def test_get_extension_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AsyncExtensionRegistryServiceRestInterceptor, "post_get_extension"
    ) as post, mock.patch.object(
        transports.AsyncExtensionRegistryServiceRestInterceptor,
        "post_get_extension_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.AsyncExtensionRegistryServiceRestInterceptor, "pre_get_extension"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
@pytest.mark.asyncio
async def test_list_extensions_rest_asyncio_bad_request(
    request_type=extension_registry_service.ListExtensionsRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
async def test_list_extensions_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AsyncExtensionRegistryServiceRestInterceptor, "post_list_extensions"
    ) as post, mock.patch.object(
        transports.AsyncExtensionRegistryServiceRestInterceptor,
        "post_list_extensions_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.AsyncExtensionRegistryServiceRestInterceptor, "pre_list_extensions"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
@pytest.mark.asyncio
async def test_update_extension_rest_asyncio_bad_request(
    request_type=extension_registry_service.UpdateExtensionRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
async def test_update_extension_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AsyncExtensionRegistryServiceRestInterceptor, "post_update_extension"
    ) as post, mock.patch.object(
        transports.AsyncExtensionRegistryServiceRestInterceptor,
        "post_update_extension_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.AsyncExtensionRegistryServiceRestInterceptor, "pre_update_extension"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
@pytest.mark.asyncio
async def test_delete_extension_rest_asyncio_bad_request(
    request_type=extension_registry_service.DeleteExtensionRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
async def test_delete_extension_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.AsyncExtensionRegistryServiceRestInterceptor, "post_delete_extension"
    ) as post, mock.patch.object(
        transports.AsyncExtensionRegistryServiceRestInterceptor,
        "post_delete_extension_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.AsyncExtensionRegistryServiceRestInterceptor, "pre_delete_extension"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
