...
def test__get_default_mtls_endpoint():
  ...
  assert (PipelineServiceClient._get_default_mtls_endpoint(api_endpoint) ==
          api_mtls_endpoint)
  assert (PipelineServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) ==
          api_mtls_endpoint)
  assert (PipelineServiceClient._get_default_mtls_endpoint(sandbox_endpoint) ==
          sandbox_mtls_endpoint)
  assert (PipelineServiceClient._get_default_mtls_endpoint(
      sandbox_mtls_endpoint) == sandbox_mtls_endpoint)
  assert (PipelineServiceClient._get_default_mtls_endpoint(non_googleapi) ==
          non_googleapi)
...
def test_pipeline_service_client_client_options(client_class, transport_class,
                                                transport_name):
...
def test_pipeline_service_client_mtls_env_auto(client_class, transport_class,
                                               transport_name,
                                               use_client_cert_env):
...
def test_pipeline_service_client_get_mtls_endpoint_and_cert_source(
    client_class):
...
def test_pipeline_service_client_client_options_scopes(client_class,
                                                       transport_class,
                                                       transport_name):
...
def test_list_training_pipelines_pager(transport_name: str = "grpc"):
  ...
  with mock.patch.object(
    ...
    assert all(
        isinstance(i, training_pipeline.TrainingPipeline) for i in results)
...
async def test_list_training_pipelines_async_pager():
  ...
  with mock.patch.object(
    ...
    assert all(
        isinstance(i, training_pipeline.TrainingPipeline) for i in responses)
...
async def test_list_training_pipelines_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_training_pipelines(
...
def test_delete_training_pipeline(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.delete_training_pipeline), "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_get_pipeline_job(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.get_pipeline_job),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_list_pipeline_jobs(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.list_pipeline_jobs),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_delete_pipeline_job(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.delete_pipeline_job), "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_pipeline_service_transport_create_channel(transport_class,
                                                   grpc_helpers):
  # If credentials and host are not provided, the transport class should use
  # ADC credentials.
  with mock.patch.object(
...
def test_artifact_path():
  ...
  actual = PipelineServiceClient.artifact_path(project, location,
...
def test_context_path():
  ...
  actual = PipelineServiceClient.context_path(project, location, metadata_store,
                                              context)
  assert expected == actual
...
def test_execution_path():
  ...
  actual = PipelineServiceClient.execution_path(project, location,
...
def test_pipeline_job_path():
  ...
  actual = PipelineServiceClient.pipeline_job_path(project, location,
                                                   pipeline_job)
  assert expected == actual
...
def test_training_pipeline_path():
  ...
  actual = PipelineServiceClient.training_pipeline_path(project, location,
                                                        training_pipeline)
  assert expected == actual
...
def test_client_with_default_client_info():
  ...
  with mock.patch.object(transports.PipelineServiceTransport,
