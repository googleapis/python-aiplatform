...
def test_feature_online_store_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.aiplatform_v1beta1.services.feature_online_store_service.transports.FeatureOnlineStoreServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_streaming_fetch_feature_values_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.streaming_fetch_feature_values
...
@pytest.mark.asyncio
async def test_streaming_fetch_feature_values_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.streaming_fetch_feature_values
            in client._client._transport._wrapped_methods
        )
...
def test_fetch_feature_values_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1beta1/{feature_view=projects/*/locations/*/featureOnlineStores/*/featureViews/*}:fetchFeatureValues"
...
def test_feature_online_store_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.aiplatform_v1beta1.services.feature_online_store_service.transports.FeatureOnlineStoreServiceTransport.__init__"
    ) as Transport:
...
def test_feature_online_store_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.aiplatform_v1beta1.services.feature_online_store_service.transports.FeatureOnlineStoreServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
