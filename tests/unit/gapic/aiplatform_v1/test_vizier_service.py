...
def test__get_default_mtls_endpoint():
  ...
  assert (VizierServiceClient._get_default_mtls_endpoint(api_endpoint) ==
          api_mtls_endpoint)
  assert (VizierServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) ==
          api_mtls_endpoint)
  assert (VizierServiceClient._get_default_mtls_endpoint(sandbox_endpoint) ==
          sandbox_mtls_endpoint)
  assert (VizierServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
          == sandbox_mtls_endpoint)
  assert (VizierServiceClient._get_default_mtls_endpoint(non_googleapi) ==
          non_googleapi)
...
def test_vizier_service_client_from_service_account_info(
    client_class, transport_name):
...
def test_vizier_service_client_from_service_account_file(
    client_class, transport_name):
  creds = ga_credentials.AnonymousCredentials()
  with mock.patch.object(service_account.Credentials,
...
def test_vizier_service_client_client_options(client_class, transport_class,
                                              transport_name):
...
def test_vizier_service_client_mtls_env_auto(client_class, transport_class,
                                             transport_name,
                                             use_client_cert_env):
...
def test_vizier_service_client_client_options_scopes(client_class,
                                                     transport_class,
                                                     transport_name):
...
def test_create_study(request_type, transport: str = "grpc"):
  ...
  with mock.patch.object(type(client.transport.create_study),
                         "__call__") as call:
...
@pytest.mark.asyncio
async def test_get_study_async(transport: str = "grpc_asyncio",
...
def test_list_studies(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.list_studies),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
async def test_list_studies_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_studies(request={}
...
def test_delete_study(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.delete_study),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_lookup_study(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.lookup_study),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = study.Study(
        name="name_value",
...
def test_suggest_trials(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.suggest_trials),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_create_trial(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.create_trial),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_trial_async(transport: str = "grpc_asyncio",
...
def test_list_trials(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.list_trials),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_trials_async(transport: str = "grpc_asyncio",
...
async def test_list_trials_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_trials(request={}
                                                )).pages:  # pragma: no branch
      pages.append(page_)
    for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
      assert page_.raw_page.next_page_token == token
...
def test_complete_trial(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.complete_trial),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = study.Trial(
        name="name_value",
...
def test_delete_trial(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.delete_trial),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = None
...
def test_check_trial_early_stopping_state(request_type,
                                          transport: str = "grpc"):
  client = VizierServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
...
@pytest.mark.asyncio
async def test_stop_trial_async(transport: str = "grpc_asyncio",
...
def test_client_with_default_client_info():
  ...
  with mock.patch.object(transports.VizierServiceTransport,
