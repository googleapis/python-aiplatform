...
from google.cloud.aiplatform_v1.services.session_service import (
...
def test_session_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.aiplatform_v1.services.session_service.transports.SessionServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_create_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/reasoningEngines/*}/sessions"
...
def test_get_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/reasoningEngines/*/sessions/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{session.name=projects/*/locations/*/reasoningEngines/*/sessions/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_events_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/reasoningEngines/*/sessions/*}/events"
            % client.transport._host,
            args[1],
        )
...
def test_append_event_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/reasoningEngines/*/sessions/*}:appendEvent"
            % client.transport._host,
            args[1],
        )
...
def test_session_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.aiplatform_v1.services.session_service.transports.SessionServiceTransport.__init__"
    ) as Transport:
...
def test_session_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.aiplatform_v1.services.session_service.transports.SessionServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
