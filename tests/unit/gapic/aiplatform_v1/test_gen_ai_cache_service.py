...
from google.cloud.aiplatform_v1.services.gen_ai_cache_service import GenAiCacheServiceAsyncClient
from google.cloud.aiplatform_v1.services.gen_ai_cache_service import GenAiCacheServiceClient
...
def test_gen_ai_cache_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.gen_ai_cache_service.transports.GenAiCacheServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_cached_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/cachedContents" % client.transport._host, args[1])
...
def test_get_cached_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/cachedContents/*}" % client.transport._host, args[1])
...
def test_update_cached_content_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{cached_content.name=projects/*/locations/*/cachedContents/*}" % client.transport._host, args[1])
...
def test_gen_ai_cache_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.gen_ai_cache_service.transports.GenAiCacheServiceTransport.__init__') as Transport:
...
def test_gen_ai_cache_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.gen_ai_cache_service.transports.GenAiCacheServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_gen_ai_cache_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.gen_ai_cache_service.transports.GenAiCacheServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.GenAiCacheServiceTransport()
        adc.assert_called_once()
