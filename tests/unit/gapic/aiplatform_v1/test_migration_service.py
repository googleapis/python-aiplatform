...
def test__get_default_mtls_endpoint():
  ...
  assert (MigrationServiceClient._get_default_mtls_endpoint(api_endpoint) ==
          api_mtls_endpoint)
  assert (MigrationServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
          == api_mtls_endpoint)
  assert (MigrationServiceClient._get_default_mtls_endpoint(sandbox_endpoint) ==
          sandbox_mtls_endpoint)
  assert (MigrationServiceClient._get_default_mtls_endpoint(
      sandbox_mtls_endpoint) == sandbox_mtls_endpoint)
  assert (MigrationServiceClient._get_default_mtls_endpoint(non_googleapi) ==
          non_googleapi)
...
def test_migration_service_client_client_options(client_class, transport_class,
                                                 transport_name):
...
def test_migration_service_client_mtls_env_auto(client_class, transport_class,
                                                transport_name,
                                                use_client_cert_env):
...
def test_migration_service_client_get_mtls_endpoint_and_cert_source(
    client_class):
...
def test_migration_service_client_client_options_scopes(client_class,
                                                        transport_class,
                                                        transport_name):
...
async def test_search_migratable_resources_async_pager():
  ...
  with mock.patch.object(
    ...
    assert all(
        isinstance(i, migratable_resource.MigratableResource)
        for i in responses)
...
async def test_search_migratable_resources_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.search_migratable_resources(
    ...
    client.batch_migrate_resources(
        ...
        migrate_resource_requests=[
            migration_service.MigrateResourceRequest(
                migrate_ml_engine_model_version_config=migration_service
...
def test_migration_service_transport_create_channel(transport_class,
                                                    grpc_helpers):
  # If credentials and host are not provided, the transport class should use
  # ADC credentials.
  with mock.patch.object(
...
def test_client_with_default_client_info():
  ...
  with mock.patch.object(transports.MigrationServiceTransport,
