...
def test__get_default_mtls_endpoint():
  ...
  assert (
      FeaturestoreOnlineServingServiceClient._get_default_mtls_endpoint(None) is
      None)
  assert (FeaturestoreOnlineServingServiceClient._get_default_mtls_endpoint(
...
def test_featurestore_online_serving_service_client_client_options(
  ...
  with mock.patch.object(FeaturestoreOnlineServingServiceClient,
...
def test_featurestore_online_serving_service_transport_auth_adc(
    transport_class):
...
def test_parse_common_organization_path():
  ...
  path = FeaturestoreOnlineServingServiceClient.common_organization_path(
      **expected)

  # Check that the path construction is reversible.
  actual = FeaturestoreOnlineServingServiceClient.parse_common_organization_path(
      path)
  assert expected == actual
...
def test_parse_common_project_path():
  ...
  # Check that the path construction is reversible.
  actual = FeaturestoreOnlineServingServiceClient.parse_common_project_path(
      path)
  assert expected == actual
...
def test_parse_common_location_path():
  ...
  # Check that the path construction is reversible.
  actual = FeaturestoreOnlineServingServiceClient.parse_common_location_path(
      path)
  assert expected == actual
...
def test_client_with_default_client_info():
  ...
  with mock.patch.object(transports.FeaturestoreOnlineServingServiceTransport,
