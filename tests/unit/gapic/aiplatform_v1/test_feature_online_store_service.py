...
def test__get_default_mtls_endpoint():
    ...
    assert (
        FeatureOnlineStoreServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        FeatureOnlineStoreServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        FeatureOnlineStoreServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        FeatureOnlineStoreServiceClient._get_default_mtls_endpoint(
            sandbox_mtls_endpoint
        )
        == sandbox_mtls_endpoint
    )
    assert (
        FeatureOnlineStoreServiceClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
    assert (
        FeatureOnlineStoreServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test__get_client_cert_source():
    ...
    with mock.patch(
        ...
        with mock.patch(
            ...
            assert (
                FeatureOnlineStoreServiceClient._get_client_cert_source(None, True)
...
@mock.patch.object(
    ...
    modify_default_endpoint_template(FeatureOnlineStoreServiceClient),
)
@mock.patch.object(
    FeatureOnlineStoreServiceAsyncClient,
    "_DEFAULT_ENDPOINT_TEMPLATE",
    modify_default_endpoint_template(FeatureOnlineStoreServiceAsyncClient),
)
def test__get_api_endpoint():
    ...
    mock_endpoint = FeatureOnlineStoreServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        UNIVERSE_DOMAIN=mock_universe
    )

    assert (
        FeatureOnlineStoreServiceClient._get_api_endpoint(
    ...
    assert (
        ...
        == FeatureOnlineStoreServiceClient.DEFAULT_MTLS_ENDPOINT
    )
    assert (
        FeatureOnlineStoreServiceClient._get_api_endpoint(
...
def test__get_universe_domain():
    ...
    assert (
        FeatureOnlineStoreServiceClient._get_universe_domain(
            client_universe_domain, universe_domain_env
        )
        == client_universe_domain
    )
    assert (
        FeatureOnlineStoreServiceClient._get_universe_domain(None, universe_domain_env)
        == universe_domain_env
    )
    assert (
        FeatureOnlineStoreServiceClient._get_universe_domain(None, None)
        == FeatureOnlineStoreServiceClient._DEFAULT_UNIVERSE
    )
...
def test_feature_online_store_service_client_client_options(
    client_class, transport_class, transport_name
):
    # Check that if channel is provided we won't create a new one.
    with mock.patch.object(
        FeatureOnlineStoreServiceClient, "get_transport_class"
    ) as gtc:
...
def test_feature_online_store_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
@mock.patch.object(
    FeatureOnlineStoreServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(FeatureOnlineStoreServiceClient),
)
@mock.patch.object(
    FeatureOnlineStoreServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(FeatureOnlineStoreServiceAsyncClient),
)
def test_feature_online_store_service_client_get_mtls_endpoint_and_cert_source(
    client_class,
):
    mock_client_cert_source = mock.Mock()
...
def test_feature_online_store_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_feature_online_store_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.aiplatform_v1.services.feature_online_store_service.transports.FeatureOnlineStoreServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_feature_online_store_service_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_fetch_feature_values(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        type(client.transport.fetch_feature_values), "__call__"
    ) as call:
...
def test_fetch_feature_values_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.fetch_feature_values in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_fetch_feature_values_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.fetch_feature_values
...
@pytest.mark.asyncio
async def test_fetch_feature_values_async(
    transport: str = "grpc_asyncio",
...
def test_search_nearest_entities_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.search_nearest_entities
...
@pytest.mark.asyncio
async def test_search_nearest_entities_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.search_nearest_entities
            in client._client._transport._wrapped_methods
        )
...
def test_generate_fetch_access_token(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.generate_fetch_access_token), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = (
...
def test_generate_fetch_access_token_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.generate_fetch_access_token
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_generate_fetch_access_token_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.generate_fetch_access_token
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_generate_fetch_access_token_async(
    transport: str = "grpc_asyncio",
    request_type=feature_online_store_service.GenerateFetchAccessTokenRequest,
):
    client = FeatureOnlineStoreServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_transport_kind_grpc_asyncio():
    transport = FeatureOnlineStoreServiceAsyncClient.get_transport_class(
        "grpc_asyncio"
    )(credentials=async_anonymous_credentials())
...
def test_generate_fetch_access_token_rest_bad_request(
    request_type=feature_online_store_service.GenerateFetchAccessTokenRequest,
):
    client = FeatureOnlineStoreServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_generate_fetch_access_token_rest_call_success(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # Convert return value to protobuf type
        return_value = feature_online_store_service.GenerateFetchAccessTokenResponse.pb(
            return_value
        )
        json_return_value = json_format.MessageToJson(return_value)
        response_value.content = json_return_value.encode("UTF-8")
...
def test_generate_fetch_access_token_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.FeatureOnlineStoreServiceRestInterceptor,
        "post_generate_fetch_access_token",
    ) as post, mock.patch.object(
        transports.FeatureOnlineStoreServiceRestInterceptor,
        "post_generate_fetch_access_token_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.FeatureOnlineStoreServiceRestInterceptor,
        "pre_generate_fetch_access_token",
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = feature_online_store_service.GenerateFetchAccessTokenRequest.pb(
            feature_online_store_service.GenerateFetchAccessTokenRequest()
        )
        transcode.return_value = {
            "method": "post",
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = (
            feature_online_store_service.GenerateFetchAccessTokenResponse.to_json(
                feature_online_store_service.GenerateFetchAccessTokenResponse()
            )
        )
        req.return_value.content = return_value
        ...
        client.generate_fetch_access_token(
            request,
            metadata=[
                ("key", "val"),
                ("cephalopod", "squid"),
...
@pytest.mark.asyncio
async def test_fetch_feature_values_rest_asyncio_bad_request(
    request_type=feature_online_store_service.FetchFeatureValuesRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_search_nearest_entities_rest_asyncio_bad_request(
    request_type=feature_online_store_service.SearchNearestEntitiesRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
@pytest.mark.asyncio
async def test_generate_fetch_access_token_rest_asyncio_bad_request(
    request_type=feature_online_store_service.GenerateFetchAccessTokenRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
async def test_generate_fetch_access_token_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        await client.generate_fetch_access_token(
            request,
            metadata=[
                ("key", "val"),
                ("cephalopod", "squid"),
...
def test_feature_online_store_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.aiplatform_v1.services.feature_online_store_service.transports.FeatureOnlineStoreServiceTransport.__init__"
    ) as Transport:
...
def test_feature_online_store_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.aiplatform_v1.services.feature_online_store_service.transports.FeatureOnlineStoreServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_feature_online_store_service_transport_create_channel(
    transport_class, grpc_helpers
):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
...
def test_feature_online_store_service_transport_channel_mtls_with_adc(transport_class):
    mock_ssl_cred = mock.Mock()
...
def test_feature_view_path():
    ...
    actual = FeatureOnlineStoreServiceClient.feature_view_path(
...
def test_common_billing_account_path():
    ...
    actual = FeatureOnlineStoreServiceClient.common_billing_account_path(
        billing_account
    )
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.FeatureOnlineStoreServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = FeatureOnlineStoreServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
