...
def test_evaluate_instances_empty_call():
...
@pytest.mark.asyncio
async def test_evaluate_instances_empty_call_async():
    # This test is a coverage failsafe to make sure that totally empty calls,
    # i.e. request == None and no flattened fields passed, work.
...
def test_evaluate_instances_rest(request_type):
    client = EvaluationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_evaluate_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value._content = (
            evaluation_service.EvaluateInstancesResponse.to_json(
                evaluation_service.EvaluateInstancesResponse()
            )
        )
...
def test_evaluate_instances_rest_bad_request(
    transport: str = "rest", request_type=evaluation_service.EvaluateInstancesRequest
):
    client = EvaluationServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_evaluate_instances_rest_error():
    client = EvaluationServiceClient(
