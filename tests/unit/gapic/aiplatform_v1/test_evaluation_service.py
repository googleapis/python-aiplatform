...
from google.cloud.aiplatform_v1.services.evaluation_service import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        EvaluationServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert EvaluationServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch(
            ...
            assert EvaluationServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(
            ...
            with pytest.raises(ValueError):
                EvaluationServiceClient._use_client_cert_effective()
...
def test_evaluation_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.aiplatform_v1.services.evaluation_service.transports.EvaluationServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_evaluate_instances(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        type(client.transport.evaluate_instances), "__call__"
    ) as call:
...
def test_evaluate_instances_non_empty_request_with_auto_populated_field():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, _ = call.mock_calls[0]
        assert args[0] == evaluation_service.EvaluateInstancesRequest(
            location="location_value",
        )
...
def test_evaluate_instances_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert (
            client._transport.evaluate_instances in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_evaluate_instances_async_use_cached_wrapped_rpc(
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.evaluate_instances
...
@pytest.mark.asyncio
async def test_evaluate_instances_async(
    transport: str = "grpc_asyncio",
    request_type=evaluation_service.EvaluateInstancesRequest,
):
    client = EvaluationServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
@pytest.mark.asyncio
async def test_evaluate_instances_async_from_dict():
    await test_evaluate_instances_async(request_type=dict)
...
def test_evaluate_instances_rest_required_fields(
    request_type=evaluation_service.EvaluateInstancesRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).evaluate_instances._get_unset_required_fields(jsonified_request)
...
def test_evaluate_instances_rest_unset_required_fields():
...
def test_evaluate_instances_rest_bad_request(
    request_type=evaluation_service.EvaluateInstancesRequest,
):
    client = EvaluationServiceClient(
...
@pytest.mark.asyncio
async def test_evaluate_instances_rest_asyncio_bad_request(
    request_type=evaluation_service.EvaluateInstancesRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
def test_evaluation_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.aiplatform_v1.services.evaluation_service.transports.EvaluationServiceTransport.__init__"
    ) as Transport:
...
def test_evaluation_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.aiplatform_v1.services.evaluation_service.transports.EvaluationServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_get_location_field_headers():
    client = EvaluationServiceClient(credentials=ga_credentials.AnonymousCredentials())
...
async def test_get_location_field_headers_async():
    client = EvaluationServiceAsyncClient(credentials=async_anonymous_credentials())
