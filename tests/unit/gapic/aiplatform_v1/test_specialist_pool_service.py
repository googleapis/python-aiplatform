...
from google.cloud.aiplatform_v1.services.specialist_pool_service import SpecialistPoolServiceAsyncClient
from google.cloud.aiplatform_v1.services.specialist_pool_service import SpecialistPoolServiceClient
...
def test__get_default_mtls_endpoint():
    ...
    assert SpecialistPoolServiceClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert SpecialistPoolServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert SpecialistPoolServiceClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert SpecialistPoolServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert SpecialistPoolServiceClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi
    assert SpecialistPoolServiceClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint

def test__read_environment_variables():
    assert SpecialistPoolServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert SpecialistPoolServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert SpecialistPoolServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert SpecialistPoolServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SpecialistPoolServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test_use_client_cert_effective():
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=True):
            assert SpecialistPoolServiceClient._use_client_cert_effective() is True
    ...
    if hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch("google.auth.transport.mtls.should_use_client_cert", return_value=False):
            assert SpecialistPoolServiceClient._use_client_cert_effective() is False
    ...
    if not hasattr(google.auth.transport.mtls, "should_use_client_cert"):
        with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "unsupported"}):
            with pytest.raises(ValueError):
                SpecialistPoolServiceClient._use_client_cert_effective()
...
def test__get_client_cert_source():
    ...
    assert SpecialistPoolServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SpecialistPoolServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert SpecialistPoolServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SpecialistPoolServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(SpecialistPoolServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SpecialistPoolServiceClient))
@mock.patch.object(SpecialistPoolServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SpecialistPoolServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SpecialistPoolServiceClient._DEFAULT_UNIVERSE
    default_endpoint = SpecialistPoolServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SpecialistPoolServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SpecialistPoolServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert SpecialistPoolServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SpecialistPoolServiceClient.DEFAULT_MTLS_ENDPOINT
    assert SpecialistPoolServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SpecialistPoolServiceClient._get_api_endpoint(None, None, default_universe, "always") == SpecialistPoolServiceClient.DEFAULT_MTLS_ENDPOINT
    assert SpecialistPoolServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SpecialistPoolServiceClient.DEFAULT_MTLS_ENDPOINT
    assert SpecialistPoolServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SpecialistPoolServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SpecialistPoolServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SpecialistPoolServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SpecialistPoolServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SpecialistPoolServiceClient._get_universe_domain(None, None) == SpecialistPoolServiceClient._DEFAULT_UNIVERSE
...
def test_specialist_pool_service_client_from_service_account_info(client_class, transport_name):
...
def test_specialist_pool_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_specialist_pool_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (SpecialistPoolServiceClient, transports.SpecialistPoolServiceGrpcTransport, "grpc"),
    (SpecialistPoolServiceAsyncClient, transports.SpecialistPoolServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (SpecialistPoolServiceClient, transports.SpecialistPoolServiceRestTransport, "rest"),
])
@mock.patch.object(SpecialistPoolServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SpecialistPoolServiceClient))
@mock.patch.object(SpecialistPoolServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SpecialistPoolServiceAsyncClient))
def test_specialist_pool_service_client_client_options(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (SpecialistPoolServiceClient, transports.SpecialistPoolServiceRestTransport, "rest", "true"),
    (SpecialistPoolServiceClient, transports.SpecialistPoolServiceRestTransport, "rest", "false"),
])
@mock.patch.object(SpecialistPoolServiceClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SpecialistPoolServiceClient))
@mock.patch.object(SpecialistPoolServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SpecialistPoolServiceAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_specialist_pool_service_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    SpecialistPoolServiceClient, SpecialistPoolServiceAsyncClient
])
...
def test_specialist_pool_service_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (SpecialistPoolServiceClient, transports.SpecialistPoolServiceGrpcTransport, "grpc", grpc_helpers),
    (SpecialistPoolServiceAsyncClient, transports.SpecialistPoolServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (SpecialistPoolServiceClient, transports.SpecialistPoolServiceRestTransport, "rest", None),
])
def test_specialist_pool_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_specialist_pool_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.specialist_pool_service.transports.SpecialistPoolServiceGrpcTransport.__init__') as grpc_transport:
...
def test_specialist_pool_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_create_specialist_pool_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        assert client._transport.create_specialist_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.create_specialist_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_create_specialist_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.create_specialist_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.create_specialist_pool] = mock_rpc
...
async def test_create_specialist_pool_async(request_type, transport: str = 'grpc_asyncio'):
    client = SpecialistPoolServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_get_specialist_pool_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.get_specialist_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.get_specialist_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_get_specialist_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpecialistPoolServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.get_specialist_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_specialist_pool] = mock_rpc
...
async def test_get_specialist_pool_async(request_type, transport: str = 'grpc_asyncio'):
    client = SpecialistPoolServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_list_specialist_pools_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_specialist_pools in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_specialist_pools] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_specialist_pools_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpecialistPoolServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_specialist_pools in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_specialist_pools] = mock_rpc
...
async def test_list_specialist_pools_async(request_type, transport: str = 'grpc_asyncio'):
    client = SpecialistPoolServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_delete_specialist_pool_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_specialist_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_specialist_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_specialist_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpecialistPoolServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_specialist_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_specialist_pool] = mock_rpc
...
async def test_delete_specialist_pool_async(request_type, transport: str = 'grpc_asyncio'):
    client = SpecialistPoolServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_update_specialist_pool_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.update_specialist_pool in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.update_specialist_pool] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_update_specialist_pool_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpecialistPoolServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_specialist_pool in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_specialist_pool] = mock_rpc
...
async def test_update_specialist_pool_async(request_type, transport: str = 'grpc_asyncio'):
    client = SpecialistPoolServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_specialist_pool_rest_required_fields(request_type=specialist_pool_service.CreateSpecialistPoolRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_specialist_pool._get_unset_required_fields(jsonified_request)
...
def test_create_specialist_pool_rest_unset_required_fields():
    transport = transports.SpecialistPoolServiceRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_specialist_pool._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("parent", "specialistPool", )))
...
def test_create_specialist_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/specialistPools" % client.transport._host, args[1])
...
def test_get_specialist_pool_rest_required_fields(request_type=specialist_pool_service.GetSpecialistPoolRequest):
    transport_class = transports.SpecialistPoolServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_specialist_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_specialist_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/specialistPools/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/specialistPools/*}" % client.transport._host, args[1])
...
def test_list_specialist_pools_rest_required_fields(request_type=specialist_pool_service.ListSpecialistPoolsRequest):
    transport_class = transports.SpecialistPoolServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_specialist_pools._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    assert not set(unset_fields) - set(("page_size", "page_token", "read_mask", ))
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            # Convert return value to protobuf type
            return_value = specialist_pool_service.ListSpecialistPoolsResponse.pb(return_value)
            json_return_value = json_format.MessageToJson(return_value)
...
def test_list_specialist_pools_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("pageSize", "pageToken", "readMask", )) & set(("parent", )))
...
def test_list_specialist_pools_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(specialist_pool_service.ListSpecialistPoolsResponse.to_json(x) for x in response)
...
def test_delete_specialist_pool_rest_required_fields(request_type=specialist_pool_service.DeleteSpecialistPoolRequest):
    transport_class = transports.SpecialistPoolServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_specialist_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_specialist_pool_rest_required_fields(request_type=specialist_pool_service.UpdateSpecialistPoolRequest):
    transport_class = transports.SpecialistPoolServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_specialist_pool._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_specialist_pool_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("specialistPool", "updateMask", )))
...
def test_update_specialist_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'specialist_pool': {'name': 'projects/sample1/locations/sample2/specialistPools/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{specialist_pool.name=projects/*/locations/*/specialistPools/*}" % client.transport._host, args[1])
...
def test_create_specialist_pool_rest_bad_request(request_type=specialist_pool_service.CreateSpecialistPoolRequest):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_create_specialist_pool_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["specialist_pool"] = {'name': 'name_value', 'display_name': 'display_name_value', 'specialist_managers_count': 2662, 'specialist_manager_emails': ['specialist_manager_emails_value1', 'specialist_manager_emails_value2'], 'pending_data_labeling_jobs': ['pending_data_labeling_jobs_value1', 'pending_data_labeling_jobs_value2'], 'specialist_worker_emails': ['specialist_worker_emails_value1', 'specialist_worker_emails_value2']}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = specialist_pool_service.CreateSpecialistPoolRequest.meta.fields["specialist_pool"]
...
def test_create_specialist_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "post_create_specialist_pool") as post, \
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "post_create_specialist_pool_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "pre_create_specialist_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = specialist_pool_service.CreateSpecialistPoolRequest.pb(specialist_pool_service.CreateSpecialistPoolRequest())
        ...
        client.create_specialist_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_get_specialist_pool_rest_bad_request(request_type=specialist_pool_service.GetSpecialistPoolRequest):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/specialistPools/sample3'}
    request = request_type(**request_init)
...
def test_get_specialist_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "post_get_specialist_pool") as post, \
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "post_get_specialist_pool_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "pre_get_specialist_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = specialist_pool_service.GetSpecialistPoolRequest.pb(specialist_pool_service.GetSpecialistPoolRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = specialist_pool.SpecialistPool.to_json(specialist_pool.SpecialistPool())
        req.return_value.content = return_value
        ...
        client.get_specialist_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_specialist_pools_rest_bad_request(request_type=specialist_pool_service.ListSpecialistPoolsRequest):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_specialist_pools_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "post_list_specialist_pools") as post, \
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "post_list_specialist_pools_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "pre_list_specialist_pools") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = specialist_pool_service.ListSpecialistPoolsRequest.pb(specialist_pool_service.ListSpecialistPoolsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = specialist_pool_service.ListSpecialistPoolsResponse.to_json(specialist_pool_service.ListSpecialistPoolsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = specialist_pool_service.ListSpecialistPoolsResponse(), metadata

        client.list_specialist_pools(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_specialist_pool_rest_bad_request(request_type=specialist_pool_service.DeleteSpecialistPoolRequest):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_specialist_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "post_delete_specialist_pool") as post, \
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "post_delete_specialist_pool_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "pre_delete_specialist_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = specialist_pool_service.DeleteSpecialistPoolRequest.pb(specialist_pool_service.DeleteSpecialistPoolRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_specialist_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_update_specialist_pool_rest_bad_request(request_type=specialist_pool_service.UpdateSpecialistPoolRequest):
    client = SpecialistPoolServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
    # send a request that will satisfy transcoding
    request_init = {'specialist_pool': {'name': 'projects/sample1/locations/sample2/specialistPools/sample3'}}
    request = request_type(**request_init)
...
def test_update_specialist_pool_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'specialist_pool': {'name': 'projects/sample1/locations/sample2/specialistPools/sample3'}}
    request_init["specialist_pool"] = {'name': 'projects/sample1/locations/sample2/specialistPools/sample3', 'display_name': 'display_name_value', 'specialist_managers_count': 2662, 'specialist_manager_emails': ['specialist_manager_emails_value1', 'specialist_manager_emails_value2'], 'pending_data_labeling_jobs': ['pending_data_labeling_jobs_value1', 'pending_data_labeling_jobs_value2'], 'specialist_worker_emails': ['specialist_worker_emails_value1', 'specialist_worker_emails_value2']}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748

    # Determine if the message type is proto-plus or protobuf
    test_field = specialist_pool_service.UpdateSpecialistPoolRequest.meta.fields["specialist_pool"]
...
def test_update_specialist_pool_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "post_update_specialist_pool") as post, \
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "post_update_specialist_pool_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SpecialistPoolServiceRestInterceptor, "pre_update_specialist_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = specialist_pool_service.UpdateSpecialistPoolRequest.pb(specialist_pool_service.UpdateSpecialistPoolRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.update_specialist_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_create_specialist_pool_rest_asyncio_bad_request(request_type=specialist_pool_service.CreateSpecialistPoolRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = SpecialistPoolServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_create_specialist_pool_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "post_create_specialist_pool") as post, \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "post_create_specialist_pool_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "pre_create_specialist_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = specialist_pool_service.CreateSpecialistPoolRequest.pb(specialist_pool_service.CreateSpecialistPoolRequest())
        ...
        await client.create_specialist_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_get_specialist_pool_rest_asyncio_bad_request(request_type=specialist_pool_service.GetSpecialistPoolRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = SpecialistPoolServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_get_specialist_pool_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "post_get_specialist_pool") as post, \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "post_get_specialist_pool_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "pre_get_specialist_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = specialist_pool_service.GetSpecialistPoolRequest.pb(specialist_pool_service.GetSpecialistPoolRequest())
        ...
        await client.get_specialist_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_list_specialist_pools_rest_asyncio_bad_request(request_type=specialist_pool_service.ListSpecialistPoolsRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = SpecialistPoolServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_list_specialist_pools_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "post_list_specialist_pools") as post, \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "post_list_specialist_pools_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "pre_list_specialist_pools") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = specialist_pool_service.ListSpecialistPoolsRequest.pb(specialist_pool_service.ListSpecialistPoolsRequest())
        ...
        await client.list_specialist_pools(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_delete_specialist_pool_rest_asyncio_bad_request(request_type=specialist_pool_service.DeleteSpecialistPoolRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = SpecialistPoolServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_delete_specialist_pool_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "post_delete_specialist_pool") as post, \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "post_delete_specialist_pool_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "pre_delete_specialist_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = specialist_pool_service.DeleteSpecialistPoolRequest.pb(specialist_pool_service.DeleteSpecialistPoolRequest())
        ...
        await client.delete_specialist_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
@pytest.mark.asyncio
async def test_update_specialist_pool_rest_asyncio_bad_request(request_type=specialist_pool_service.UpdateSpecialistPoolRequest):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip("the library must be installed with the `async_rest` extra to test this feature.")
    client = SpecialistPoolServiceAsyncClient(
        credentials=async_anonymous_credentials(),
...
async def test_update_specialist_pool_rest_asyncio_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(operation.Operation, "_set_result_from_operation"), \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "post_update_specialist_pool") as post, \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "post_update_specialist_pool_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.AsyncSpecialistPoolServiceRestInterceptor, "pre_update_specialist_pool") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = specialist_pool_service.UpdateSpecialistPoolRequest.pb(specialist_pool_service.UpdateSpecialistPoolRequest())
        ...
        await client.update_specialist_pool(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_specialist_pool_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.specialist_pool_service.transports.SpecialistPoolServiceTransport.__init__') as Transport:
...
def test_specialist_pool_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.specialist_pool_service.transports.SpecialistPoolServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_specialist_pool_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.specialist_pool_service.transports.SpecialistPoolServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.SpecialistPoolServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.SpecialistPoolServiceGrpcTransport, transports.SpecialistPoolServiceGrpcAsyncIOTransport])
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.SpecialistPoolServiceTransport, '_prep_wrapped_messages') as prep:
        client = SpecialistPoolServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
