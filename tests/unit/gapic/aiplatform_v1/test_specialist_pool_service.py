...
def test__get_default_mtls_endpoint():
  ...
  assert (SpecialistPoolServiceClient._get_default_mtls_endpoint(api_endpoint)
          == api_mtls_endpoint)
  assert (SpecialistPoolServiceClient._get_default_mtls_endpoint(
      api_mtls_endpoint) == api_mtls_endpoint)
  assert (SpecialistPoolServiceClient._get_default_mtls_endpoint(
      sandbox_endpoint) == sandbox_mtls_endpoint)
  assert (SpecialistPoolServiceClient._get_default_mtls_endpoint(
      sandbox_mtls_endpoint) == sandbox_mtls_endpoint)
  assert (SpecialistPoolServiceClient._get_default_mtls_endpoint(non_googleapi)
          == non_googleapi)
...
def test_specialist_pool_service_client_client_options(client_class,
                                                       transport_class,
                                                       transport_name):
  # Check that if channel is provided we won't create a new one.
  with mock.patch.object(SpecialistPoolServiceClient,
...
def test_specialist_pool_service_client_mtls_env_auto(client_class,
                                                      transport_class,
                                                      transport_name,
                                                      use_client_cert_env):
...
def test_specialist_pool_service_client_get_mtls_endpoint_and_cert_source(
    client_class):
...
def test_specialist_pool_service_client_client_options_from_dict():
  with mock.patch(
      "google.cloud.aiplatform_v1.services.specialist_pool_service.transports.SpecialistPoolServiceGrpcTransport.__init__"
  ) as grpc_transport:
...
def test_create_specialist_pool(request_type, transport: str = "grpc"):
  ...
  with mock.patch.object(
      type(client.transport.create_specialist_pool), "__call__") as call:
...
def test_get_specialist_pool(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.get_specialist_pool), "__call__") as call:
    # Designate an appropriate return value for the call.
  ...
  assert response.specialist_manager_emails == [
      "specialist_manager_emails_value"
  ]
  assert response.pending_data_labeling_jobs == [
      "pending_data_labeling_jobs_value"
  ]
...
def test_list_specialist_pools(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.list_specialist_pools), "__call__") as call:
    # Designate an appropriate return value for the call.
...
async def test_list_specialist_pools_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_specialist_pools(
...
def test_specialist_pool_service_base_transport():
  ...
  with mock.patch(
      "google.cloud.aiplatform_v1.services.specialist_pool_service.transports.SpecialistPoolServiceTransport.__init__"
  ) as Transport:
...
def test_common_billing_account_path():
  ...
  actual = SpecialistPoolServiceClient.common_billing_account_path(
      billing_account)
  assert expected == actual
...
def test_client_with_default_client_info():
  ...
  with mock.patch.object(transports.SpecialistPoolServiceTransport,
