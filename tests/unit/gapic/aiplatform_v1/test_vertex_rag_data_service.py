...
def test__get_default_mtls_endpoint():
    ...
    assert (
        VertexRagDataServiceClient._get_default_mtls_endpoint(custom_endpoint)
        == custom_endpoint
    )
...
def test_vertex_rag_data_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.aiplatform_v1.services.vertex_rag_data_service.transports.VertexRagDataServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
async def test_list_rag_corpora_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_rag_corpora(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
    ...
    with mock.patch.object(type(client.transport.upload_rag_file), "__call__") as call:
        ...
        client.upload_rag_file(
            ...
            upload_rag_file_config=vertex_rag_data.UploadRagFileConfig(
                rag_file_transformation_config=vertex_rag_data.RagFileTransformationConfig(
...
async def test_list_rag_files_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_rag_files(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_create_rag_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/ragCorpora" % client.transport._host,
            args[1],
        )
...
def test_update_rag_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{rag_corpus.name=projects/*/locations/*/ragCorpora/*}"
...
def test_get_rag_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/ragCorpora/*}" % client.transport._host,
            args[1],
        )
...
def test_upload_rag_file_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles:upload"
            % client.transport._host,
            args[1],
        )
...
def test_import_rag_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles:import"
            % client.transport._host,
            args[1],
        )
...
def test_get_rag_file_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/ragCorpora/*/ragFiles/*}"
            % client.transport._host,
            args[1],
        )
...
def test_list_rag_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles"
            % client.transport._host,
            args[1],
        )
...
def test_update_rag_engine_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{rag_engine_config.name=projects/*/locations/*/ragEngineConfig}"
            % client.transport._host,
            args[1],
        )
...
def test_get_rag_engine_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/ragEngineConfig}"
            % client.transport._host,
            args[1],
        )
...
def test_update_rag_engine_config_rest_call_success(request_type):
    ...
    request_init["rag_engine_config"] = {
        "name": "projects/sample1/locations/sample2/ragEngineConfig",
        "rag_managed_db_config": {"scaled": {}, "basic": {}, "unprovisioned": {}},
    }
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_vertex_rag_data_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.aiplatform_v1.services.vertex_rag_data_service.transports.VertexRagDataServiceTransport.__init__"
    ) as Transport:
...
def test_vertex_rag_data_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.aiplatform_v1.services.vertex_rag_data_service.transports.VertexRagDataServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
