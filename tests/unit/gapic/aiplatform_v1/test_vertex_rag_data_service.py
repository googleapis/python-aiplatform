...
from google.cloud.aiplatform_v1.services.vertex_rag_data_service import VertexRagDataServiceAsyncClient
from google.cloud.aiplatform_v1.services.vertex_rag_data_service import VertexRagDataServiceClient
from google.cloud.aiplatform_v1.services.vertex_rag_data_service import pagers
from google.cloud.aiplatform_v1.services.vertex_rag_data_service import transports
...
def test__get_default_mtls_endpoint():
    ...
    assert VertexRagDataServiceClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
def test_vertex_rag_data_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.vertex_rag_data_service.transports.VertexRagDataServiceGrpcTransport.__init__') as grpc_transport:
...
async def test_create_rag_corpus_async(request_type, transport: str = 'grpc_asyncio'):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_update_rag_corpus_async(request_type, transport: str = 'grpc_asyncio'):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_rag_corpus_async(request_type, transport: str = 'grpc_asyncio'):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_rag_corpora_async(request_type, transport: str = 'grpc_asyncio'):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_rag_corpus_async(request_type, transport: str = 'grpc_asyncio'):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_upload_rag_file_async(request_type, transport: str = 'grpc_asyncio'):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_upload_rag_file_flattened():
    ...
    with mock.patch.object(
        ...
        client.upload_rag_file(
            ...
            upload_rag_file_config=vertex_rag_data.UploadRagFileConfig(rag_file_transformation_config=vertex_rag_data.RagFileTransformationConfig(rag_file_chunking_config=vertex_rag_data.RagFileChunkingConfig(fixed_length_chunking=vertex_rag_data.RagFileChunkingConfig.FixedLengthChunking(chunk_size=1075)))),
        )
        ...
        mock_val = vertex_rag_data.UploadRagFileConfig(rag_file_transformation_config=vertex_rag_data.RagFileTransformationConfig(rag_file_chunking_config=vertex_rag_data.RagFileChunkingConfig(fixed_length_chunking=vertex_rag_data.RagFileChunkingConfig.FixedLengthChunking(chunk_size=1075))))
        assert arg == mock_val
...
async def test_import_rag_files_async(request_type, transport: str = 'grpc_asyncio'):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_rag_file_async(request_type, transport: str = 'grpc_asyncio'):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_rag_files_async(request_type, transport: str = 'grpc_asyncio'):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_delete_rag_file_async(request_type, transport: str = 'grpc_asyncio'):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_update_rag_engine_config_async(request_type, transport: str = 'grpc_asyncio'):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_rag_engine_config_async(request_type, transport: str = 'grpc_asyncio'):
    client = VertexRagDataServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_create_rag_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/ragCorpora" % client.transport._host, args[1])
...
def test_update_rag_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{rag_corpus.name=projects/*/locations/*/ragCorpora/*}" % client.transport._host, args[1])
...
def test_get_rag_corpus_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/ragCorpora/*}" % client.transport._host, args[1])
...
def test_upload_rag_file_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles:upload" % client.transport._host, args[1])
...
def test_import_rag_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles:import" % client.transport._host, args[1])
...
def test_get_rag_file_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/ragCorpora/*/ragFiles/*}" % client.transport._host, args[1])
...
def test_list_rag_files_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles" % client.transport._host, args[1])
...
def test_update_rag_engine_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{rag_engine_config.name=projects/*/locations/*/ragEngineConfig}" % client.transport._host, args[1])
...
def test_get_rag_engine_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/ragEngineConfig}" % client.transport._host, args[1])
...
def test_update_rag_engine_config_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'rag_engine_config': {'name': 'projects/sample1/locations/sample2/ragEngineConfig'}}
    request_init["rag_engine_config"] = {'name': 'projects/sample1/locations/sample2/ragEngineConfig', 'rag_managed_db_config': {'scaled': {}, 'basic': {}, 'unprovisioned': {}}}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_vertex_rag_data_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.vertex_rag_data_service.transports.VertexRagDataServiceTransport.__init__') as Transport:
...
def test_vertex_rag_data_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.vertex_rag_data_service.transports.VertexRagDataServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_vertex_rag_data_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.vertex_rag_data_service.transports.VertexRagDataServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.VertexRagDataServiceTransport()
        adc.assert_called_once()
