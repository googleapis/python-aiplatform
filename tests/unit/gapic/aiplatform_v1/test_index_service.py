...
def test__get_default_mtls_endpoint():
  ...
  assert (IndexServiceClient._get_default_mtls_endpoint(api_endpoint) ==
          api_mtls_endpoint)
  assert (IndexServiceClient._get_default_mtls_endpoint(api_mtls_endpoint) ==
          api_mtls_endpoint)
  assert (IndexServiceClient._get_default_mtls_endpoint(sandbox_endpoint) ==
          sandbox_mtls_endpoint)
  assert (IndexServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
          == sandbox_mtls_endpoint)
  assert IndexServiceClient._get_default_mtls_endpoint(
...
@mock.patch.object(IndexServiceClient, "DEFAULT_ENDPOINT",
                   modify_default_endpoint(IndexServiceClient))
@mock.patch.object(
    IndexServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(IndexServiceAsyncClient),
)
def test_index_service_client_client_options(client_class, transport_class,
                                             transport_name):
...
def test_index_service_client_mtls_env_auto(client_class, transport_class,
                                            transport_name,
                                            use_client_cert_env):
...
def test_index_service_client_client_options_scopes(client_class,
                                                    transport_class,
                                                    transport_name):
...
def test_create_index(request_type, transport: str = "grpc"):
  ...
  with mock.patch.object(type(client.transport.create_index),
                         "__call__") as call:
...
def test_list_indexes(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.list_indexes),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
async def test_list_indexes_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_indexes(request={}
...
def test_update_index(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.update_index),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_index_endpoint_path():
  ...
  actual = IndexServiceClient.index_endpoint_path(project, location,
                                                  index_endpoint)
  assert expected == actual
...
def test_client_with_default_client_info():
  ...
  with mock.patch.object(transports.IndexServiceTransport,
