...
def test_persistent_resource_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.aiplatform_v1.services.persistent_resource_service.transports.PersistentResourceServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_create_persistent_resource_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/persistentResources"
...
def test_get_persistent_resource_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/persistentResources/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_persistent_resource_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{persistent_resource.name=projects/*/locations/*/persistentResources/*}"
            % client.transport._host,
            args[1],
        )
...
def test_reboot_persistent_resource_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/persistentResources/*}:reboot"
            % client.transport._host,
            args[1],
        )
...
def test_persistent_resource_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.aiplatform_v1.services.persistent_resource_service.transports.PersistentResourceServiceTransport.__init__"
    ) as Transport:
...
def test_persistent_resource_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.aiplatform_v1.services.persistent_resource_service.transports.PersistentResourceServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
