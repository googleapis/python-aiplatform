...
from google.cloud.aiplatform_v1.services.featurestore_service import FeaturestoreServiceAsyncClient
...
def test_featurestore_service_client_client_options_from_dict():
    with mock.patch('google.cloud.aiplatform_v1.services.featurestore_service.transports.FeaturestoreServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_featurestore_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/featurestores" % client.transport._host, args[1])
...
def test_get_featurestore_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/featurestores/*}" % client.transport._host, args[1])
...
def test_update_featurestore_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{featurestore.name=projects/*/locations/*/featurestores/*}" % client.transport._host, args[1])
...
def test_create_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/featurestores/*}/entityTypes" % client.transport._host, args[1])
...
def test_get_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/featurestores/*/entityTypes/*}" % client.transport._host, args[1])
...
def test_update_entity_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{entity_type.name=projects/*/locations/*/featurestores/*/entityTypes/*}" % client.transport._host, args[1])
...
def test_create_feature_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/featurestores/*/entityTypes/*}/features" % client.transport._host, args[1])
...
def test_batch_create_features_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/featurestores/*/entityTypes/*}/features:batchCreate" % client.transport._host, args[1])
...
def test_get_feature_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/featurestores/*/entityTypes/*/features/*}" % client.transport._host, args[1])
...
def test_update_feature_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{feature.name=projects/*/locations/*/featurestores/*/entityTypes/*/features/*}" % client.transport._host, args[1])
...
def test_import_feature_values_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{entity_type=projects/*/locations/*/featurestores/*/entityTypes/*}:importFeatureValues" % client.transport._host, args[1])
...
def test_batch_read_feature_values_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{featurestore=projects/*/locations/*/featurestores/*}:batchReadFeatureValues" % client.transport._host, args[1])
...
def test_export_feature_values_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{entity_type=projects/*/locations/*/featurestores/*/entityTypes/*}:exportFeatureValues" % client.transport._host, args[1])
...
def test_delete_feature_values_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{entity_type=projects/*/locations/*/featurestores/*/entityTypes/*}:deleteFeatureValues" % client.transport._host, args[1])
...
def test_search_features_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{location=projects/*/locations/*}/featurestores:searchFeatures" % client.transport._host, args[1])
...
def test_create_entity_type_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/featurestores/sample3'}
    request_init["entity_type"] = {'name': 'name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'etag': 'etag_value', 'monitoring_config': {'snapshot_analysis': {'disabled': True, 'monitoring_interval_days': 2586, 'staleness_days': 1506}, 'import_features_analysis': {'state': 1, 'anomaly_detection_baseline': 1}, 'numerical_threshold_config': {'value': 0.541}, 'categorical_threshold_config': {}}, 'offline_storage_ttl_days': 2554, 'satisfies_pzs': True, 'satisfies_pzi': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_entity_type_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'entity_type': {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4'}}
    request_init["entity_type"] = {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'etag': 'etag_value', 'monitoring_config': {'snapshot_analysis': {'disabled': True, 'monitoring_interval_days': 2586, 'staleness_days': 1506}, 'import_features_analysis': {'state': 1, 'anomaly_detection_baseline': 1}, 'numerical_threshold_config': {'value': 0.541}, 'categorical_threshold_config': {}}, 'offline_storage_ttl_days': 2554, 'satisfies_pzs': True, 'satisfies_pzi': True}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_update_feature_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'feature': {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4/features/sample5'}}
    request_init["feature"] = {'name': 'projects/sample1/locations/sample2/featurestores/sample3/entityTypes/sample4/features/sample5', 'description': 'description_value', 'value_type': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'etag': 'etag_value', 'disable_monitoring': True, 'monitoring_stats_anomalies': [{'objective': 1, 'feature_stats_anomaly': {'score': 0.54, 'stats_uri': 'stats_uri_value', 'anomaly_uri': 'anomaly_uri_value', 'distribution_deviation': 0.23700000000000002, 'anomaly_detection_threshold': 0.28750000000000003, 'start_time': {}, 'end_time': {}}}], 'version_column_name': 'version_column_name_value', 'point_of_contact': 'point_of_contact_value'}
    # The version of a generated dependency at test runtime may differ from the version used during generation.
    # Delete any fields which are not present in the current runtime dependency
    # See https://github.com/googleapis/gapic-generator-python/issues/1748
...
def test_featurestore_service_base_transport():
    ...
    with mock.patch('google.cloud.aiplatform_v1.services.featurestore_service.transports.FeaturestoreServiceTransport.__init__') as Transport:
...
def test_featurestore_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.aiplatform_v1.services.featurestore_service.transports.FeaturestoreServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_featurestore_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.aiplatform_v1.services.featurestore_service.transports.FeaturestoreServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.FeaturestoreServiceTransport()
        adc.assert_called_once()
