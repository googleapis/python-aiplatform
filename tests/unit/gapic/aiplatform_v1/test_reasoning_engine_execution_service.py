...
def test_reasoning_engine_execution_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.aiplatform_v1.services.reasoning_engine_execution_service.transports.ReasoningEngineExecutionServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_query_reasoning_engine_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.query_reasoning_engine] = (
            mock_rpc
        )
        request = {}
...
def test_async_query_reasoning_engine(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.async_query_reasoning_engine), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
def test_async_query_reasoning_engine_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._transport.async_query_reasoning_engine
            in client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_async_query_reasoning_engine_async_use_cached_wrapped_rpc(
    transport: str = "grpc_asyncio",
):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert (
            client._client._transport.async_query_reasoning_engine
            in client._client._transport._wrapped_methods
        )
...
@pytest.mark.asyncio
async def test_async_query_reasoning_engine_async(
    transport: str = "grpc_asyncio",
    request_type=reasoning_engine_execution_service.AsyncQueryReasoningEngineRequest,
):
    client = ReasoningEngineExecutionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
...
def test_async_query_reasoning_engine_rest_required_fields(
    request_type=reasoning_engine_execution_service.AsyncQueryReasoningEngineRequest,
):
    transport_class = transports.ReasoningEngineExecutionServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).async_query_reasoning_engine._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_async_query_reasoning_engine_rest_bad_request(
    request_type=reasoning_engine_execution_service.AsyncQueryReasoningEngineRequest,
):
    client = ReasoningEngineExecutionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
...
def test_async_query_reasoning_engine_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        transports.ReasoningEngineExecutionServiceRestInterceptor,
        "post_async_query_reasoning_engine",
    ) as post, mock.patch.object(
        transports.ReasoningEngineExecutionServiceRestInterceptor,
...
@pytest.mark.asyncio
async def test_async_query_reasoning_engine_rest_asyncio_bad_request(
    request_type=reasoning_engine_execution_service.AsyncQueryReasoningEngineRequest,
):
    if not HAS_ASYNC_REST_EXTRA:
        pytest.skip(
...
def test_reasoning_engine_execution_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.aiplatform_v1.services.reasoning_engine_execution_service.transports.ReasoningEngineExecutionServiceTransport.__init__"
    ) as Transport:
...
def test_reasoning_engine_execution_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.aiplatform_v1.services.reasoning_engine_execution_service.transports.ReasoningEngineExecutionServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
