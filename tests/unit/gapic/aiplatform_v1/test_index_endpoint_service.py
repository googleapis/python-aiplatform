...
def test_create_index_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/indexEndpoints"
...
def test_get_index_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/indexEndpoints/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_index_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{index_endpoint.name=projects/*/locations/*/indexEndpoints/*}"
            % client.transport._host,
            args[1],
        )
...
def test_deploy_index_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:deployIndex"
            % client.transport._host,
            args[1],
        )
...
def test_undeploy_index_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:undeployIndex"
            % client.transport._host,
            args[1],
        )
...
def test_mutate_deployed_index_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:mutateDeployedIndex"
            % client.transport._host,
            args[1],
        )
