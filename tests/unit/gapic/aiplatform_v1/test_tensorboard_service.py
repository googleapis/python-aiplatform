...
def test__get_default_mtls_endpoint():
  ...
  assert (TensorboardServiceClient._get_default_mtls_endpoint(api_endpoint) ==
          api_mtls_endpoint)
  assert (TensorboardServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
          == api_mtls_endpoint)
  assert (TensorboardServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
          == sandbox_mtls_endpoint)
  assert (TensorboardServiceClient._get_default_mtls_endpoint(
      sandbox_mtls_endpoint) == sandbox_mtls_endpoint)
  assert (TensorboardServiceClient._get_default_mtls_endpoint(non_googleapi) ==
          non_googleapi)
...
def test_tensorboard_service_client_client_options(client_class,
                                                   transport_class,
                                                   transport_name):
  # Check that if channel is provided we won't create a new one.
  with mock.patch.object(TensorboardServiceClient,
...
def test_tensorboard_service_client_mtls_env_auto(client_class, transport_class,
                                                  transport_name,
                                                  use_client_cert_env):
...
def test_tensorboard_service_client_get_mtls_endpoint_and_cert_source(
    client_class):
...
def test_create_tensorboard(request_type, transport: str = "grpc"):
  ...
  with mock.patch.object(type(client.transport.create_tensorboard),
                         "__call__") as call:
...
def test_get_tensorboard(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.get_tensorboard),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_update_tensorboard(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.update_tensorboard),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_list_tensorboards(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.list_tensorboards),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_delete_tensorboard(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(type(client.transport.delete_tensorboard),
                         "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_create_tensorboard_experiment_flattened():
  ...
  with mock.patch.object(
    ...
    mock_val = gca_tensorboard_experiment.TensorboardExperiment(
        name="name_value")
    assert arg == mock_val
...
def test_get_tensorboard_experiment(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.get_tensorboard_experiment), "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_update_tensorboard_experiment(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.update_tensorboard_experiment), "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = gca_tensorboard_experiment.TensorboardExperiment(
        name="name_value",
        display_name="display_name_value",
...
async def test_list_tensorboard_experiments_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_tensorboard_experiments(
...
def test_delete_tensorboard_experiment(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.delete_tensorboard_experiment), "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_create_tensorboard_run(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.create_tensorboard_run), "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_batch_create_tensorboard_runs(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.batch_create_tensorboard_runs), "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_update_tensorboard_run(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.update_tensorboard_run), "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = gca_tensorboard_run.TensorboardRun(
        name="name_value",
        display_name="display_name_value",
...
async def test_list_tensorboard_runs_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_tensorboard_runs(
        request={})).pages:  # pragma: no branch
      pages.append(page_)
    for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
      assert page_.raw_page.next_page_token == token
...
def test_batch_create_tensorboard_time_series(request_type,
                                              transport: str = "grpc"):
  client = TensorboardServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.batch_create_tensorboard_time_series),
      "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = (
    ...
    _, args, _ = call.mock_calls[0]
    assert args[
        0] == tensorboard_service.BatchCreateTensorboardTimeSeriesRequest()
...
def test_create_tensorboard_time_series(request_type, transport: str = "grpc"):
  ...
  with mock.patch.object(
    ...
    call.return_value = gca_tensorboard_time_series.TensorboardTimeSeries(
        ...
        display_name="display_name_value",
        description="description_value",
        value_type=gca_tensorboard_time_series.TensorboardTimeSeries.ValueType
        .SCALAR,
        etag="etag_value",
...
def test_create_tensorboard_time_series_flattened():
  ...
  with mock.patch.object(
    ...
    client.create_tensorboard_time_series(
        ...
        .TensorboardTimeSeries(name="name_value"),
    )
    ...
    mock_val = gca_tensorboard_time_series.TensorboardTimeSeries(
        name="name_value")
    assert arg == mock_val
...
def test_get_tensorboard_time_series(request_type, transport: str = "grpc"):
  ...
  with mock.patch.object(
    ...
    call.return_value = tensorboard_time_series.TensorboardTimeSeries(
        ...
        display_name="display_name_value",
        description="description_value",
        value_type=tensorboard_time_series.TensorboardTimeSeries.ValueType
        .SCALAR,
        etag="etag_value",
        plugin_name="plugin_name_value",
        plugin_data=b"plugin_data_blob",
...
async def test_list_tensorboard_time_series_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.list_tensorboard_time_series(
        request={})).pages:  # pragma: no branch
      pages.append(page_)
    for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
      assert page_.raw_page.next_page_token == token
...
def test_batch_read_tensorboard_time_series_data(request_type,
                                                 transport: str = "grpc"):
  client = TensorboardServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.batch_read_tensorboard_time_series_data),
      "__call__") as call:
    # Designate an appropriate return value for the call.
    call.return_value = (
...
def test_read_tensorboard_time_series_data(request_type,
                                           transport: str = "grpc"):
  client = TensorboardServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
...
def test_read_tensorboard_blob_data(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.read_tensorboard_blob_data), "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_write_tensorboard_experiment_data(request_type,
                                           transport: str = "grpc"):
  client = TensorboardServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.write_tensorboard_experiment_data),
      "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_write_tensorboard_run_data(request_type, transport: str = "grpc"):
  ...
  # Mock the actual call within the gRPC stub, and fake the request.
  with mock.patch.object(
      type(client.transport.write_tensorboard_run_data), "__call__") as call:
    # Designate an appropriate return value for the call.
...
def test_export_tensorboard_time_series_data(request_type,
                                             transport: str = "grpc"):
  client = TensorboardServiceClient(
      credentials=ga_credentials.AnonymousCredentials(),
      transport=transport,
  ...
  with mock.patch.object(
    ...
    _, args, _ = call.mock_calls[0]
    assert args[
        0] == tensorboard_service.ExportTensorboardTimeSeriesDataRequest()
...
def test_export_tensorboard_time_series_data_pager(
  ...
  with mock.patch.object(
    ...
    assert len(results) == 6
    assert all(
        isinstance(i, tensorboard_data.TimeSeriesDataPoint) for i in results)
...
async def test_export_tensorboard_time_series_data_async_pages():
  ...
  with mock.patch.object(
    ...
    pages = []
    async for page_ in (await client.export_tensorboard_time_series_data(
        request={})).pages:  # pragma: no branch
      pages.append(page_)
    for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
      assert page_.raw_page.next_page_token == token
...
def test_tensorboard_service_transport_create_channel(transport_class,
                                                      grpc_helpers):
  # If credentials and host are not provided, the transport class should use
  # ADC credentials.
  with mock.patch.object(
...
def test_tensorboard_path():
  ...
  actual = TensorboardServiceClient.tensorboard_path(project, location,
                                                     tensorboard)
...
def test_client_with_default_client_info():
  ...
  with mock.patch.object(transports.TensorboardServiceTransport,
