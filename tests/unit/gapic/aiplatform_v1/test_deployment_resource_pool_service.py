...
def test_deployment_resource_pool_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.aiplatform_v1.services.deployment_resource_pool_service.transports.DeploymentResourcePoolServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_create_deployment_resource_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/deploymentResourcePools"
...
def test_get_deployment_resource_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/deploymentResourcePools/*}"
            % client.transport._host,
            args[1],
        )
...
def test_update_deployment_resource_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{deployment_resource_pool.name=projects/*/locations/*/deploymentResourcePools/*}"
            % client.transport._host,
            args[1],
        )
...
def test_query_deployed_models_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{deployment_resource_pool=projects/*/locations/*/deploymentResourcePools/*}:queryDeployedModels"
            % client.transport._host,
            args[1],
        )
...
def test_deployment_resource_pool_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.aiplatform_v1.services.deployment_resource_pool_service.transports.DeploymentResourcePoolServiceTransport.__init__"
    ) as Transport:
...
def test_deployment_resource_pool_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.aiplatform_v1.services.deployment_resource_pool_service.transports.DeploymentResourcePoolServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
