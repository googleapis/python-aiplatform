...
class TestAutoMLTextTrainingJob:
  ...
  def test_init_all_parameters_sentiment(self):
    ...
    assert (job._training_task_inputs_dict == training_job_inputs
            .AutoMlTextSentimentInputs(sentiment_max=_TEST_SENTIMENT_MAX))
  ...
  def test_init_aiplatform_with_encryption_key_name_and_create_training_job(
    ...
    """
        ...
        Create and run an AutoML Text Classification training job, verify calls
        and return value
        """
  ...
  def test_run_raises_if_pipeline_fails(
      self, mock_pipeline_service_create_and_get_with_fail, mock_dataset_text,
      sync):
