...
class TestAutoMLTabularTrainingJob:
  ...
  def test_run_call_pipeline_service_create_with_column_specs_not_auto(
    ...
    column_specs[_TEST_TRAINING_COLUMN_NAMES_ALTERNATIVE[
        0]] = training_jobs.AutoMLTabularTrainingJob.column_data_types.NUMERIC
    column_specs[_TEST_TRAINING_COLUMN_NAMES_ALTERNATIVE[
        1]] = training_jobs.AutoMLTabularTrainingJob.column_data_types.CATEGORICAL
    column_specs[_TEST_TRAINING_COLUMN_NAMES_ALTERNATIVE[
        2]] = training_jobs.AutoMLTabularTrainingJob.column_data_types.TEXT
