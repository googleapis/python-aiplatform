...
def sampled_shapley_explainer_mock():
  with mock.patch.object(
      explainable_ai_sdk, "SampledShapleyConfig", create=True) as config_mock:
    yield config_mock
...
def load_model_from_local_path_mock():
  with mock.patch.object(
      explainable_ai_sdk, "load_model_from_local_path",
      autospec=True) as explainer_mock:
...
class TestExplainLit:
  ...
  @pytest.mark.usefixtures("sampled_shapley_explainer_mock",
  ...
  @pytest.mark.usefixtures("predict_client_predict_dict_mock",
  ...
  @pytest.mark.usefixtures("predict_client_predict_list_mock",
                           "get_endpoint_with_models_mock")
  @pytest.mark.parametrize("model_id", [None, _TEST_ID])
  ...
  @pytest.mark.usefixtures("init_lit_widget_mock")
  def test_set_up_and_open_lit(self, set_up_sequential,
                               set_up_pandas_dataframe_and_columns,
                               widget_render_mock):
    pd_dataset, lit_columns = set_up_pandas_dataframe_and_columns
    feature_types, label_types, saved_model_path = set_up_sequential
