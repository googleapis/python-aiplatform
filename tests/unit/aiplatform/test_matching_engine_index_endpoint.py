...
def get_index_endpoint_mock():
  with patch.object(index_endpoint_service_client.IndexEndpointServiceClient,
                    "get_index_endpoint") as get_index_endpoint_mock:
    ...
    index_endpoint.deployed_indexes = [
        gca_index_endpoint.DeployedIndex(
            ...
            deployed_index_auth_config=gca_index_endpoint
            .DeployedIndexAuthConfig(
                auth_provider=gca_index_endpoint.DeployedIndexAuthConfig
                .AuthProvider(
...
def list_index_endpoints_mock():
  with patch.object(index_endpoint_service_client.IndexEndpointServiceClient,
                    "list_index_endpoints") as list_index_endpoints_mock:
...
class TestMatchingEngineIndexEndpoint:
  ...
  @pytest.mark.parametrize("index_endpoint_name",
                           [_TEST_INDEX_ENDPOINT_ID, _TEST_INDEX_ENDPOINT_NAME])
  ...
  def test_list_index_endpoints(self, list_index_endpoints_mock):
    ...
    list_index_endpoints_mock.assert_called_once_with(request={
        "parent": _TEST_PARENT,
        "filter": None
    })
  ...
  def test_delete_index_endpoint_with_force(self, undeploy_index_mock,
                                            delete_index_endpoint_mock, sync):
