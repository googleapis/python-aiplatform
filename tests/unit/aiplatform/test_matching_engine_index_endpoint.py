...
_TEST_PSC_AUTOMATION_CONFIGS = [
    ("project1", "projects/project1/global/networks/network1"),
    ("project2", "projects/project2/global/networks/network2"),
    ("project3", "projects/project3/global/networks/network3"),
]
