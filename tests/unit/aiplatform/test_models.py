...
_TEST_MODEL_RESOURCE_NAME_CUSTOM_PROJECT = (
    model_service_client.ModelServiceClient.model_path(_TEST_PROJECT_2,
                                                       _TEST_LOCATION,
                                                       _TEST_ID))
_TEST_MODEL_RESOURCE_NAME_CUSTOM_LOCATION = (
    model_service_client.ModelServiceClient.model_path(_TEST_PROJECT,
                                                       _TEST_LOCATION_2,
                                                       _TEST_ID))
...
_TEST_MODEL_EVAL_LIST = [
    gca_model_evaluation.ModelEvaluation(name=_TEST_MODEL_EVAL_RESOURCE_NAME,),
    gca_model_evaluation.ModelEvaluation(name=_TEST_MODEL_EVAL_RESOURCE_NAME,),
    gca_model_evaluation.ModelEvaluation(name=_TEST_MODEL_EVAL_RESOURCE_NAME,),
]
...
def update_model_mock(mock_model):
  with patch.object(model_service_client.ModelServiceClient,
                    "update_model") as mock:
...
@pytest.fixture
def get_model_mock():
  with mock.patch.object(model_service_client.ModelServiceClient,
                         "get_model") as get_model_mock:
...
def upload_model_mock():
  with mock.patch.object(model_service_client.ModelServiceClient,
                         "upload_model") as upload_model_mock:
...
def export_model_mock():
  with mock.patch.object(model_service_client.ModelServiceClient,
                         "export_model") as export_model_mock:
...
def delete_model_mock():
  with mock.patch.object(model_service_client.ModelServiceClient,
                         "delete_model") as delete_model_mock:
...
def get_training_job_non_existent_mock():
  with patch.object(
      ...
      "get_training_pipeline") as get_training_job_non_existent_mock:
    get_training_job_non_existent_mock.side_effect = api_exceptions.NotFound(
        "404")
...
def mock_storage_blob_upload_from_filename():
  with patch("google.cloud.storage.Blob.upload_from_filename"
...
def mock_model_eval_get():
  with mock.patch.object(model_service_client.ModelServiceClient,
                         "get_model_evaluation") as mock_get_model_eval:
...
def list_model_evaluations_mock():
  with mock.patch.object(
      ...
      "list_model_evaluations") as list_model_evaluations_mock:
...
def list_model_versions_mock():
  with mock.patch.object(model_service_client.ModelServiceClient,
                         "list_model_versions") as list_model_versions_mock:
...
def list_models_mock():
  with mock.patch.object(model_service_client.ModelServiceClient,
                         "list_models") as list_models_mock:
...
def delete_model_version_mock():
  with mock.patch.object(model_service_client.ModelServiceClient,
                         "delete_model_version") as delete_model_version_mock:
    mock_lro = mock.Mock(ga_operation.Operation)
...
def merge_version_aliases_mock():
  with mock.patch.object(model_service_client.ModelServiceClient,
                         "merge_version_aliases") as merge_version_aliases_mock:
...
class TestModel:
  ...
  def test_upload_uploads_and_gets_model(self, upload_model_mock,
                                         get_model_mock, sync):
  ...
  @pytest.mark.parametrize("sync", [True, False])
  def test_upload_with_timeout_not_explicitly_set(self, upload_model_mock,
                                                  get_model_mock, sync):
    my_model = models.Model.upload(
        display_name=_TEST_MODEL_NAME,
        serving_container_image_uri=_TEST_SERVING_CONTAINER_IMAGE,
  ...
  @pytest.mark.parametrize("sync", [True, False])
  def test_upload_uploads_and_gets_model_with_labels(self, upload_model_mock,
                                                     get_model_mock, sync):
  ...
  def test_upload_raises_with_impartial_explanation_spec(self):
    ...
    assert e.match(
        regexp=r"`explanation_parameters` should be specified or None.")

  @pytest.mark.parametrize("sync", [True, False])
  def test_upload_uploads_and_gets_model_with_all_args(self, upload_model_mock,
                                                       get_model_mock, sync):
  ...
  @pytest.mark.usefixtures("get_endpoint_mock", "get_model_mock",
                           "create_endpoint_mock")
  @pytest.mark.parametrize("sync", [True, False])
  def test_deploy_with_timeout_not_explicitly_set(self, deploy_model_mock,
                                                  sync):
  ...
  @pytest.mark.usefixtures("get_endpoint_mock", "get_model_mock",
                           "create_endpoint_mock")
  @pytest.mark.parametrize("sync", [True, False])
  def test_deploy_no_endpoint_dedicated_resources(self, deploy_model_mock,
                                                  sync):
  ...
  @pytest.mark.parametrize("sync", [True, False])
  @pytest.mark.usefixtures("get_model_with_version",
                           "get_batch_prediction_job_mock")
  def test_batch_predict_with_version(self, sync,
                                      create_batch_prediction_job_mock):
  ...
  def test_upload_xgboost_model_file_uploads_and_gets_model(
    ...
    assert (upload_model_model.container_spec.image_uri ==
    ...
    staged_model_file_path = mock_storage_blob_upload_from_filename.call_args[
        1]["filename"]
  ...
  def test_get_model_evaluation_without_id(
    ...
    list_model_evaluations_mock.assert_called_once_with(request={
  ...
  def test_init_with_version_in_resource_name(self, get_model_with_version):
    ...
    assert model.version_aliases == [
        _TEST_VERSION_ALIAS_1, _TEST_VERSION_ALIAS_2
    ]
  ...
  @pytest.mark.parametrize(
      ...
      [
          ...
          (None, True, ["default"]),
          (["alias1", "alias2", "default"
           ], True, ["alias1", "alias2", "default"]),
          (["alias1", "alias2", "default"
           ], False, ["alias1", "alias2", "default"]),
  ...
  def test_upload_new_version(
    ...
    assert (upload_model_request.model.version_description ==
  ...
  def test_list_versions(self, list_model_versions_mock,
                         get_model_with_version):
  ...
  def test_delete_version(self, delete_model_version_mock,
                          get_model_with_version):
    my_model = models.Model(_TEST_MODEL_NAME, _TEST_PROJECT, _TEST_LOCATION)
    my_model.versioning_registry.delete_version(_TEST_VERSION_ALIAS_1)

    delete_model_version_mock.assert_called_once_with(
        name=models.ModelRegistry._get_versioned_name(_TEST_MODEL_PARENT,
                                                      _TEST_VERSION_ALIAS_1))

  def test_add_versions(self, merge_version_aliases_mock,
                        get_model_with_version):
    my_model = models.Model(_TEST_MODEL_NAME, _TEST_PROJECT, _TEST_LOCATION)
  ...
  def test_remove_versions(self, merge_version_aliases_mock,
                           get_model_with_version):
    my_model = models.Model(_TEST_MODEL_NAME, _TEST_PROJECT, _TEST_LOCATION)
