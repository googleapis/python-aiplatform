...
class TestModelEvaluation:
  ...
  def test_init_model_evaluation_with_only_resource_name(
  ...
  def test_init_model_evaluation_with_eval_id_and_model_id(
      self, mock_model_eval_get):
    aiplatform.init(project=_TEST_PROJECT)
  ...
  def test_get_model_evaluation_metrics(self, mock_model_eval_get):
    ...
    eval_metrics = aiplatform.ModelEvaluation(
        evaluation_name=_TEST_MODEL_EVAL_RESOURCE_NAME).metrics
