...
from google.cloud.aiplatform.compat.services import schedule_service_client_v1beta1 as schedule_service_client
...
_TEST_PIPELINE_JOB_SCHEDULE_CRON_TZ_EXPRESSION = "America/New_York * * * * *"
