...
class SavedModelMetadataBuilderTF2Test(tf.test.TestCase):
  ...
  def test_get_metadata_sequential(self):
    ...
    expected_md = {
        "outputs": {
            "dense_2": {
                "outputTensorName": "dense_2"
            }
        },
        "inputs": {
            "dense_input": {
                "inputTensorName": "dense_input"
            }
        },
    }
  ...
  def test_get_metadata_functional(self):
    ...
    expected_md = {
        "inputs": {
            "model_input1": {
                "inputTensorName": "model_input1"
            },
            "model_input2": {
                "inputTensorName": "model_input2"
            },
        },
        "outputs": {
            "dense_2": {
  ...
  def test_non_keras_model(self):
    ...
    expected_md = {
        ...
        "outputs": {
            "custom_output_name": {
                "outputTensorName": "custom_output_name"
            }
        },
    }
    assert expected_md == generated_md
