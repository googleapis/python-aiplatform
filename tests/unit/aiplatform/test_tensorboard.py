...
def update_tensorboard_mock():
  with patch.object(tensorboard_service_client.TensorboardServiceClient,
                    "update_tensorboard") as update_tensorboard_mock:
...
def delete_tensorboard_mock():
  with mock.patch.object(tensorboard_service_client.TensorboardServiceClient,
                         "delete_tensorboard") as delete_tensorboard_mock:
    delete_tensorboard_lro_mock = mock.Mock(operation.Operation)
    delete_tensorboard_lro_mock.result.return_value = (
        gca_tensorboard_service.DeleteTensorboardRequest(name=_TEST_NAME,))
...
class TestTensorboard:
  ...
  def test_init_tensorboard_with_project_and_location(self,
  ...
  def test_init_tensorboard_with_alt_project_and_location(
      self, get_tensorboard_mock):
    aiplatform.init(project=_TEST_PROJECT)
    tensorboard.Tensorboard(
        tensorboard_name=_TEST_NAME,
  ...
  def test_init_tensorboard_with_location_override(self, get_tensorboard_mock):
    ...
    tensorboard.Tensorboard(
        tensorboard_name=_TEST_ID, location=_TEST_ALT_LOCATION)
    get_tensorboard_mock.assert_called_once_with(
...
class TestTensorboardExperiment:
  ...
  def test_create_tensorboard_experiment_with_timeout(
      self, create_tensorboard_experiment_mock,
      get_tensorboard_experiment_mock):
  ...
  def test_delete_tensorboard_experiement(self,
                                          delete_tensorboard_experiment_mock):
    aiplatform.init(project=_TEST_PROJECT)
  ...
  def test_list_tensorboard_experiments(self, list_tensorboard_experiment_mock):
    ...
    list_tensorboard_experiment_mock.assert_called_once_with(request={
        "parent": _TEST_NAME,
        "filter": None
    })
...
class TestTensorboardRun:
  ...
  def test_init_tensorboard_run_with_id_only_with_project_and_location(
    ...
    get_tensorboard_run_mock.assert_called_once_with(
        name=_TEST_TENSORBOARD_RUN_NAME, retry=base._DEFAULT_RETRY)
    list_tensorboard_time_series_mock.assert_called_once_with(request={
  ...
  @pytest.mark.usefixtures("list_tensorboard_time_series_mock")
  def test_create_tensorboard_run_with_timeout(self,
                                               create_tensorboard_run_mock,
                                               get_tensorboard_run_mock):
  ...
  def test_list_tensorboard_runs(self, list_tensorboard_run_mock,
    ...
    list_tensorboard_run_mock.assert_called_once_with(request={
        "parent": _TEST_TENSORBOARD_EXPERIMENT_NAME,
        "filter": None
    })
...
class TestTensorboardTimeSeries:
  ...
  def test_delete_tensorboard_time_series(self,
  ...
  def test_list_tensorboard_time_series(self,
                                        list_tensorboard_time_series_mock):
    aiplatform.init(project=_TEST_PROJECT)
