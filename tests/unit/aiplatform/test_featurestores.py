...
_TEST_BQ_DESTINATION = gca_io.BigQueryDestination(
    output_uri=_TEST_BQ_DESTINATION_URI)
_TEST_CSV_DESTINATION = gca_io.CsvDestination(
    gcs_destination=gca_io.GcsDestination(
        output_uri_prefix=_TEST_GCS_OUTPUT_URI_PREFIX))
...
def _get_entity_type_spec_proto_with_feature_ids(entity_type_id,
                                                 feature_ids,
                                                 feature_destination_fields=None
                                                ):
  ...
  entity_type_spec_proto = gca_featurestore_service.BatchReadFeatureValuesRequest.EntityTypeSpec(
      ...
      settings=[
          gca_featurestore_service.DestinationFeatureSetting(
              ...
              destination_field=feature_destination_field) for feature_id,
          feature_destination_field in feature_destination_fields.items()
      ] or None,
  )
...
def _get_header_proto(feature_ids):
  ...
  header_proto.feature_descriptors = [
      ...
      .FeatureDescriptor(id=feature_id) for feature_id in feature_ids
  ]
  return header_proto
...
def _get_entity_view_proto(entity_id, feature_value_types, feature_values):
  ...
  entity_view_data = []
  for feature_value_type, feature_value in zip(feature_value_types,
                                               feature_values):
...
def get_project_mock():
  with patch.object(resourcemanager.ProjectsClient,
                    "get_project") as get_project_mock:
...
def bq_load_table_from_dataframe_mock(bq_client_mock):
  with patch.object(
      bq_client_mock,
      "load_table_from_dataframe") as bq_load_table_from_dataframe_mock:
...
def bqs_init_client_mock(bqs_client_mock):
  with patch.object(bigquery_storage,
                    "BigQueryReadClient") as bqs_init_client_mock:
...
def bqs_create_read_session(bqs_client_mock):
  with patch.object(bqs_client_mock,
...
def get_featurestore_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "get_featurestore") as get_featurestore_mock:
...
def update_featurestore_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "update_featurestore") as update_featurestore_mock:
...
def list_featurestores_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "list_featurestores") as list_featurestores_mock:
...
def delete_featurestore_mock():
  with mock.patch.object(featurestore_service_client.FeaturestoreServiceClient,
                         "delete_featurestore") as delete_featurestore_mock:
...
def search_features_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "search_features") as search_features_mock:
...
def create_featurestore_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "create_featurestore") as create_featurestore_mock:
    ...
    create_featurestore_lro_mock.result.return_value = (
        gca_featurestore.Featurestore(
            ...
            .OnlineServingConfig(fixed_node_count=_TEST_ONLINE_SERVING_CONFIG),
            encryption_spec=_TEST_ENCRYPTION_SPEC,
        ))
...
def get_entity_type_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "get_entity_type") as get_entity_type_mock:
...
def update_entity_type_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "update_entity_type") as update_entity_type_mock:
...
def list_entity_types_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "list_entity_types") as list_entity_types_mock:
...
def delete_entity_type_mock():
  with mock.patch.object(featurestore_service_client.FeaturestoreServiceClient,
                         "delete_entity_type") as delete_entity_type_mock:
...
def create_entity_type_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "create_entity_type") as create_entity_type_mock:
...
def import_feature_values_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "import_feature_values") as import_feature_values_mock:
...
def get_feature_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "get_feature") as get_feature_mock:
...
def update_feature_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "update_feature") as update_feature_mock:
...
def list_features_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "list_features") as list_features_mock:
...
def delete_feature_mock():
  with mock.patch.object(featurestore_service_client.FeaturestoreServiceClient,
                         "delete_feature") as delete_feature_mock:
...
def create_feature_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "create_feature") as create_feature_mock:
...
def batch_create_features_mock():
  with patch.object(featurestore_service_client.FeaturestoreServiceClient,
                    "batch_create_features") as batch_create_features_mock:
...
class Test_FeatureConfig:
  ...
  def test_feature_config_create_feature_request_raises_invalid_feature_id(
      self):
    featureConfig = featurestore_utils._FeatureConfig(
...
class TestFeaturestore:
  ...
  @pytest.mark.parametrize("featurestore_name",
                           [_TEST_FEATURESTORE_ID, _TEST_FEATURESTORE_NAME])
  ...
  def test_list_featurestores(self, list_featurestores_mock):
    ...
    list_featurestores_mock.assert_called_once_with(request={
        "parent": _TEST_PARENT,
        "filter": None
    })
  ...
  def test_list_entity_types(self, list_entity_types_mock):
    ...
    list_entity_types_mock.assert_called_once_with(request={
  ...
  @pytest.mark.usefixtures("get_featurestore_mock")
  @pytest.mark.parametrize("sync", [True, False])
  def test_create_featurestore_with_timeout(self, create_featurestore_mock,
                                            sync):
    aiplatform.init(project=_TEST_PROJECT)
  ...
  @pytest.mark.parametrize(
      ...
      [
          (
              {
                  "my_entity_type_id_1":
                      ["my_feature_id_1_1", "my_feature_id_1_2"],
                  "my_entity_type_id_2":
                      ["my_feature_id_2_1", "my_feature_id_2_2"],
              },
              None,
              [
          ...
          (
              ...
              {
                  f"{_TEST_FEATURESTORE_NAME}/entityTypes/my_entity_type_id_1/features/my_feature_id_1_1":
                      "my_feature_id_1_1_dest",
                  f"{_TEST_FEATURESTORE_NAME}/entityTypes/my_entity_type_id_1/features/my_feature_id_1_2":
                      "my_feature_id_1_2_dest",
              },
              [
                  _get_entity_type_spec_proto_with_feature_ids(
                      entity_type_id="my_entity_type_id_1",
          ...
          (
              ...
              },
              {
                  f"{_TEST_FEATURESTORE_NAME}/entityTypes/my_entity_type_id_1/features/my_feature_id_1_1":
                      "my_feature_id_1_1_dest",
                  f"{_TEST_FEATURESTORE_NAME}/entityTypes/my_entity_type_id_2/features/my_feature_id_2_1":
                      "my_feature_id_2_1_dest",
              },
              [
                  _get_entity_type_spec_proto_with_feature_ids(
                      entity_type_id="my_entity_type_id_1",
  ...
  def test_validate_and_get_read_instances(self, read_instances_uri,
                                           expected_read_instances):
    aiplatform.init(project=_TEST_PROJECT)
    my_featurestore = aiplatform.Featurestore(
        featurestore_name=_TEST_FEATURESTORE_NAME)
    assert (expected_read_instances ==
  ...
  @pytest.mark.parametrize("sync", [True, False])
  @pytest.mark.usefixtures("get_featurestore_mock")
  def test_batch_serve_to_bq_with_timeout(self, batch_read_feature_values_mock,
                                          sync):
    aiplatform.init(project=_TEST_PROJECT)
    my_featurestore = aiplatform.Featurestore(
        featurestore_name=_TEST_FEATURESTORE_NAME)
  ...
  @pytest.mark.skipif(
      _USE_BQ_STORAGE is False,
      reason="batch_serve_to_df requires bigquery_storage")
...
class TestEntityType:
  ...
  def test_init_entity_type(self, entity_type_name, featurestore_id,
  ...
  @pytest.mark.parametrize("featurestore_name",
                           [_TEST_FEATURESTORE_NAME, _TEST_FEATURESTORE_ID])
  ...
  def test_list_features(self, list_features_mock):
    ...
    list_features_mock.assert_called_once_with(request={
  ...
  @pytest.mark.usefixtures("get_entity_type_mock")
  def test_validate_and_get_import_feature_values_request_with_source_fields(
      self):
    aiplatform.init(project=_TEST_PROJECT)
  ...
  @pytest.mark.usefixtures("get_entity_type_mock")
  def test_validate_and_get_import_feature_values_request_without_source_fields(
      self):
    aiplatform.init(project=_TEST_PROJECT)
  ...
  def test_get_bq_schema_field(self, feature_value_type, expected_field_type,
                               expected_mode):
  ...
  def test_read_multiple_entities(self, streaming_read_feature_values_mock):
    ...
    expected_streaming_read_feature_values_request = (
        gca_featurestore_online_service.StreamingReadFeatureValuesRequest(
            ...
            feature_selector=gca_feature_selector.FeatureSelector(
                id_matcher=gca_feature_selector.IdMatcher(
                    ids=[_TEST_FEATURE_ID])),
        ))
    result = my_entity_type.read(
        entity_ids=_TEST_READ_ENTITY_IDS,
    ...
    entity_views = [
        _get_entity_view_proto(
            ...
            feature_values=entity_feature_values,
               ...
               entity_feature_values) in zip(entity_ids, feature_values)
    ]
...
class TestFeature:
  ...
  def test_init_feature(self, feature_name, entity_type_id, featurestore_id,
                        get_feature_mock):
    aiplatform.init(project=_TEST_PROJECT)
    aiplatform.Feature(
  ...
  def test_list_features(self, entity_type_name, featurestore_id,
                         list_features_mock):
    aiplatform.init(project=_TEST_PROJECT)
  ...
  def test_search_features(self, search_features_mock):
    ...
    search_features_mock.assert_called_once_with(request={
        "location": _TEST_PARENT,
        "query": None
    })
    assert len(my_feature_list) == len(_TEST_FEATURE_LIST)
    for my_feature in my_feature_list:
