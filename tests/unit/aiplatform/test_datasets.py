...
def delete_dataset_mock():
  with mock.patch.object(dataset_service_client.DatasetServiceClient,
                         "delete_dataset") as delete_dataset_mock:
...
def import_data_mock():
  with patch.object(dataset_service_client.DatasetServiceClient,
                    "import_data") as import_data_mock:
...
def export_data_mock():
  with patch.object(dataset_service_client.DatasetServiceClient,
                    "export_data") as export_data_mock:
...
def update_dataset_mock():
  with patch.object(dataset_service_client.DatasetServiceClient,
                    "update_dataset") as update_dataset_mock:
...
def list_datasets_mock():
  with patch.object(dataset_service_client.DatasetServiceClient,
                    "list_datasets") as list_datasets_mock:
...
def bigquery_table_schema_mock():
  with patch.object(
      ...
      new_callable=mock.PropertyMock) as bigquery_table_schema_mock:
        ...
        bigquery.SchemaField(
            ...
            (
                bigquery.SchemaField(
                    ...
                    "",
                    (
                        bigquery.SchemaField("nested_3_1_1", "FLOAT",
                                             "NULLABLE", "", (), None),
                        bigquery.SchemaField("nested_3_1_2", "FLOAT",
                                             "NULLABLE", "", (), None),
                    ),
                    None,
                ),
                bigquery.SchemaField("nested_3_2", "FLOAT", "NULLABLE", "",
                                     (), None),
                bigquery.SchemaField(
                    "nested_3_3",
                    "RECORD",
...
class TestDataset:
  ...
  def test_init_dataset_with_alt_location(self, get_dataset_tabular_gcs_mock):
    ...
    assert (ds.api_client._clients[compat.DEFAULT_VERSION]._client_options
            .api_endpoint == f"{_TEST_LOCATION}-{constants.API_BASE_PATH}")
  ...
  @pytest.mark.usefixtures("get_dataset_mock")
  @pytest.mark.parametrize("sync", [True, False])
  def test_create_dataset_nontabular_with_timeout(self, create_dataset_mock,
                                                  sync):
    aiplatform.init(project=_TEST_PROJECT)
  ...
  @pytest.mark.usefixtures("get_dataset_mock")
  @pytest.mark.parametrize("sync", [True, False])
  def test_create_and_import_dataset(self, create_dataset_mock,
                                     import_data_mock, sync):
    aiplatform.init(project=_TEST_PROJECT)
  ...
  @pytest.mark.usefixtures("get_dataset_mock")
  @pytest.mark.parametrize("sync", [True, False])
  def test_import_data_with_timeout_not_explicitly_set(self, import_data_mock,
                                                       sync):
    aiplatform.init(project=_TEST_PROJECT)
  ...
  @pytest.mark.parametrize("sync", [True, False])
  def test_create_then_import(self, create_dataset_mock, import_data_mock,
                              get_dataset_mock, sync):
...
class TestTabularDataset:
  ...
  @pytest.mark.usefixtures("get_dataset_tabular_bq_mock")
  @pytest.mark.parametrize("sync", [True, False])
  def test_create_dataset_with_default_encryption_key(self, create_dataset_mock,
                                                      sync):
    aiplatform.init(
        project=_TEST_PROJECT,
        encryption_spec_key_name=_TEST_ENCRYPTION_KEY_NAME,
  ...
  @pytest.mark.usefixtures("get_dataset_tabular_bq_mock")
  @pytest.mark.parametrize("sync", [True, False])
  def test_create_dataset_with_default_display_name(self, create_dataset_mock,
                                                    sync):
  ...
  def test_list_dataset(self, list_datasets_mock):
    ...
    list_datasets_mock.assert_called_once_with(request={
        "parent": _TEST_PARENT,
  ...
  def test_tabular_dataset_column_name_gcs_with_creds(self, gcs_client_mock):
    ...
    my_dataset = datasets.TabularDataset(
        dataset_name=_TEST_NAME, credentials=creds)
...
class TestTextDataset:
  ...
  @pytest.mark.usefixtures("create_dataset_mock", "get_dataset_text_mock",
                           "import_data_mock_fail")
  @pytest.mark.parametrize("sync", [True, False])
