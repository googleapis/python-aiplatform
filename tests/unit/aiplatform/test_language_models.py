...
_TEST_GROUNDING_WEB_SEARCH = WebSearch()

_TEST_GROUNDING_VERTEX_AI_SEARCH_DATASTORE = VertexAISearchDatastore(
    name="test_datastore", vertex_ai_search_location="global"
)
...
_TEST_TEXT_GENERATION_PREDICTION_GROUNDING = {
    ...
    "groundingMetadata": {
        "citations": [
            ...
            {"url": "url2", "startIndex": 1, "endIndex": 2},
        ]
    },
    "content": """
Ingredients:
    ...
    def test_text_generation_multiple_candidates_grounding(self):
        ...
        for test_grounding_source, expected_grounding_source in zip(
            ...
            assert (
                ...
                == _TEST_TEXT_GENERATION_PREDICTION_GROUNDING["groundingMetadata"]
            )
