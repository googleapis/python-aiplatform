...
_TEST_TRAINING_COLUMN_TRANSFORMATIONS = [
    ...
    {
        "auto": {
            "column_name": "time_series_identifier"
        }
    },
    {
        "auto": {
...
_TEST_TRAINING_TASK_INPUTS_DICT = {
    ...
    "availableAtForecastColumns":
        _TEST_TRAINING_AVAILABLE_AT_FORECAST_COLUMNS,
    "forecastHorizon":
        _TEST_TRAINING_FORECAST_HORIZON,
    "dataGranularity": {
    ...
    "trainBudgetMilliNodeHours":
        _TEST_TRAINING_BUDGET_MILLI_NODE_HOURS,
    # optional inputs
    "weightColumn":
        _TEST_TRAINING_WEIGHT_COLUMN,
    "contextWindow":
        _TEST_TRAINING_CONTEXT_WINDOW,
    ...
    "quantiles":
        _TEST_TRAINING_QUANTILES,
    "validationOptions":
        _TEST_TRAINING_VALIDATION_OPTIONS,
    "optimizationObjective":
        _TEST_TRAINING_OPTIMIZATION_OBJECTIVE_NAME,
    "hierarchyConfig": {
    ...
    "holidayRegions":
        _TEST_TRAINING_HOLIDAY_REGIONS,
}
...
class TestForecastingTrainingJob:
  ...
  def test_splits_fraction(
    ...
    """
        ...
        Create and run an Forecasting training job, verify calls and return
        value
        """
