...
class TestObservabilityDataConverter:
    """Unit tests for the _ObservabilityDataConverter class."""

    def setup_method(self):
        self.converter = _evals_data_converters._ObservabilityDataConverter()
    ...
    def test_convert_with_conversation_history(self):
        ...
        assert eval_case.prompt == genai_types.Content(
            parts=[genai_types.Part(text="What's the meaning of life?")],
            role="user"
        )
...
class TestEvaluationDataset:
    ...
    def test_load_from_observability_eval_cases(self, mock_gcs_utils):
        ...
        def read_file_contents_side_effect(src: str) -> str:
            match src:
                case "gs://project/input.json":
                    return "input"
                case "gs://project/output.json":
                    return "output"
                case "gs://project/system_instruction.json":
    ...
    def test_load_from_observability_eval_cases_multiple_cases(self, mock_gcs_utils):
        ...
        def read_file_contents_side_effect(src: str) -> str:
            match src:
                case "gs://project/input_1.json":
                    return "input_1"
                case "gs://project/input_2.json":
                    return "input_2"
                case "gs://project/output_1.json":
                    return "output_1"
                case "gs://project/output_2.json":
                    return "output_2"
                case "gs://project/system_instruction_1.json":
                    return "system_instruction_1"
                case "gs://project/system_instruction_2.json":
