...
class TestTextsAccumulator:
    ...
    def test_function_declaration(self):
        ...
        assert self.texts_accumulator.texts == [
    ...
    def test_function_call(self):
        ...
        assert self.texts_accumulator.texts == ["test_function_call"] + _STRUCT_TEXTS
    ...
    def test_function_response(self):
        ...
        assert (
            self.texts_accumulator.texts == ["test_function_response"] + _STRUCT_TEXTS
        )
