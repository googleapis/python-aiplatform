...
TEST_RAG_RETRIEVAL_ERROR_CONFIG = RagRetrievalConfig(
    top_k=2,
    filter=Filter(
        vector_distance_threshold=0.5, vector_similarity_threshold=0.5
    ),
)
...
TEST_GROUNDING_SUPPORTS = [
    content.GroundingSupport(
        segment=content.Segment(
            end_index=85, text="You can activate the parking radar using a switch or through the infotainment system."
        ),
