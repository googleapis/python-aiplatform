...
def test_pipeline_service_client_client_options():
    ...
    assert PipelineServiceClient.DEFAULT_OPTIONS.api_endpoint == 'aiplatform.googleapis.com'

    # Check that options can be customized.
    options = client_options.ClientOptions(api_endpoint="squid.clam.whelk")
    with mock.patch('google.cloud.aiplatform_v1beta1.services.pipeline_service.PipelineServiceClient.get_transport_class') as gtc:
...
def test_create_training_pipeline(transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client._transport.create_training_pipeline),
            '__call__') as call:
...
def test_get_training_pipeline(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_training_pipeline),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_training_pipeline_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.get_training_pipeline(
            name='name_value',
        )
...
def test_list_training_pipelines(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_training_pipelines),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_training_pipelines_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.list_training_pipelines(
            parent='parent_value',
        )
...
def test_list_training_pipelines_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.list_training_pipelines(
            request={},
        )]
...
def test_delete_training_pipeline(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.delete_training_pipeline),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_training_pipeline_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.delete_training_pipeline(
            name='name_value',
        )
...
def test_cancel_training_pipeline(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.cancel_training_pipeline),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_cancel_training_pipeline_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.cancel_training_pipeline(
            name='name_value',
        )
