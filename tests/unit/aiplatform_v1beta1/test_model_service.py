...
def test_model_service_client_client_options():
    ...
    assert ModelServiceClient.DEFAULT_OPTIONS.api_endpoint == 'aiplatform.googleapis.com'

    # Check that options can be customized.
    options = client_options.ClientOptions(api_endpoint="squid.clam.whelk")
    with mock.patch('google.cloud.aiplatform_v1beta1.services.model_service.ModelServiceClient.get_transport_class') as gtc:
...
def test_upload_model(transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client._transport.upload_model),
            '__call__') as call:
...
def test_get_model(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_models(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_models),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_models_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.list_models(
            request={},
        )]
...
def test_update_model(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.update_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_model(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.delete_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_export_model(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.export_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_get_model_evaluation(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_model_evaluation),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_model_evaluations(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_model_evaluations),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_model_evaluations_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.list_model_evaluations(
            request={},
        )]
        assert len(results) == 6
...
def test_get_model_evaluation_slice(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_model_evaluation_slice),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_model_evaluation_slice_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.get_model_evaluation_slice(
            name='name_value',
        )
...
def test_list_model_evaluation_slices(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_model_evaluation_slices),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_model_evaluation_slices_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.list_model_evaluation_slices(
            parent='parent_value',
        )
...
def test_list_model_evaluation_slices_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.list_model_evaluation_slices(
            request={},
        )]
        assert len(results) == 6
