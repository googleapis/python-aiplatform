...
def test_job_service_client_client_options():
    ...
    with mock.patch('google.cloud.aiplatform_v1beta1.services.job_service.JobServiceClient.get_transport_class') as gtc:
...
def test_create_custom_job(transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client._transport.create_custom_job),
            '__call__') as call:
...
def test_get_custom_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_custom_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_custom_job_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.get_custom_job(
            name='name_value',
        )
...
def test_list_custom_jobs(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_custom_jobs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_custom_jobs_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.list_custom_jobs(
            parent='parent_value',
        )
...
def test_list_custom_jobs_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.list_custom_jobs(
            request={},
        )]
...
def test_delete_custom_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.delete_custom_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_custom_job_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.delete_custom_job(
            name='name_value',
        )
...
def test_cancel_custom_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.cancel_custom_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_cancel_custom_job_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.cancel_custom_job(
            name='name_value',
        )
...
def test_create_data_labeling_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.create_data_labeling_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_data_labeling_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_data_labeling_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_data_labeling_job_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.get_data_labeling_job(
            name='name_value',
        )
...
def test_list_data_labeling_jobs(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_data_labeling_jobs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_data_labeling_jobs_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.list_data_labeling_jobs(
            parent='parent_value',
        )
...
def test_list_data_labeling_jobs_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.list_data_labeling_jobs(
            request={},
        )]
        assert len(results) == 6
...
def test_delete_data_labeling_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.delete_data_labeling_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_cancel_data_labeling_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.cancel_data_labeling_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_create_hyperparameter_tuning_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.create_hyperparameter_tuning_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_hyperparameter_tuning_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_hyperparameter_tuning_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_hyperparameter_tuning_jobs(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_hyperparameter_tuning_jobs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_hyperparameter_tuning_jobs_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.list_hyperparameter_tuning_jobs(
            parent='parent_value',
        )
...
def test_list_hyperparameter_tuning_jobs_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.list_hyperparameter_tuning_jobs(
            request={},
        )]
        assert len(results) == 6
...
def test_delete_hyperparameter_tuning_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.delete_hyperparameter_tuning_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_hyperparameter_tuning_job_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.delete_hyperparameter_tuning_job(
            name='name_value',
        )
...
def test_cancel_hyperparameter_tuning_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.cancel_hyperparameter_tuning_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_create_batch_prediction_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.create_batch_prediction_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_batch_prediction_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_batch_prediction_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_batch_prediction_job_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.get_batch_prediction_job(
            name='name_value',
        )
...
def test_list_batch_prediction_jobs(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_batch_prediction_jobs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_batch_prediction_jobs_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.list_batch_prediction_jobs(
            request={},
        )]
        assert len(results) == 6
...
def test_delete_batch_prediction_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.delete_batch_prediction_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_cancel_batch_prediction_job(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.cancel_batch_prediction_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
