...
def test_endpoint_service_client_client_options():
    ...
    assert EndpointServiceClient.DEFAULT_OPTIONS.api_endpoint == 'aiplatform.googleapis.com'

    # Check that options can be customized.
    options = client_options.ClientOptions(api_endpoint="squid.clam.whelk")
    with mock.patch('google.cloud.aiplatform_v1beta1.services.endpoint_service.EndpointServiceClient.get_transport_class') as gtc:
...
def test_create_endpoint(transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client._transport.create_endpoint),
            '__call__') as call:
...
def test_get_endpoint(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_endpoint),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_endpoints(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_endpoints),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_endpoints_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.list_endpoints(
            request={},
        )]
...
def test_update_endpoint(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.update_endpoint),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_endpoint(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.delete_endpoint),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_deploy_model(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.deploy_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_undeploy_model(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.undeploy_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
