...
def test_dataset_service_client_client_options():
    ...
    assert DatasetServiceClient.DEFAULT_OPTIONS.api_endpoint == 'aiplatform.googleapis.com'

    # Check that options can be customized.
    options = client_options.ClientOptions(api_endpoint="squid.clam.whelk")
    with mock.patch('google.cloud.aiplatform_v1beta1.services.dataset_service.DatasetServiceClient.get_transport_class') as gtc:
...
def test_create_dataset(transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client._transport.create_dataset),
            '__call__') as call:
...
def test_get_dataset(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_dataset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_dataset(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.update_dataset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_datasets(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_datasets),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_datasets_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.list_datasets(
            request={},
        )]
...
def test_delete_dataset(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.delete_dataset),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_import_data(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.import_data),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_export_data(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.export_data),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_data_items(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_data_items),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_data_items_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.list_data_items(
            parent='parent_value',
        )
...
def test_list_data_items_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.list_data_items(
            request={},
        )]
        assert len(results) == 6
...
def test_get_annotation_spec(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.get_annotation_spec),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_annotation_spec_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.get_annotation_spec(
            name='name_value',
        )
...
def test_list_annotations(transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client._transport.list_annotations),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_annotations_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.list_annotations(
            request={},
        )]
        assert len(results) == 6
