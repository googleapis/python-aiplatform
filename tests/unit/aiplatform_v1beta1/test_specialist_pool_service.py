...
def test_specialist_pool_service_client_from_service_account_file():
    ...
    with mock.patch.object(
        ...
        client = SpecialistPoolServiceClient.from_service_account_file(
            "dummy/file/path.json"
        )
        assert client._transport._credentials == creds

        client = SpecialistPoolServiceClient.from_service_account_json(
            "dummy/file/path.json"
        )
        assert client._transport._credentials == creds
...
def test_specialist_pool_service_client_client_options():
    ...
    assert (
        SpecialistPoolServiceClient.DEFAULT_OPTIONS.api_endpoint
    ...
    with mock.patch(
        "google.cloud.aiplatform_v1beta1.services.specialist_pool_service.SpecialistPoolServiceClient.get_transport_class"
    ) as gtc:
        transport = gtc.return_value = mock.MagicMock()
        client = SpecialistPoolServiceClient(client_options=options)
...
def test_get_specialist_pool_field_headers():
    ...
    request = specialist_pool_service.GetSpecialistPoolRequest(name="name/value",)
...
def test_get_specialist_pool_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.get_specialist_pool(name="name_value",)
...
def test_list_specialist_pools_field_headers():
    ...
    # Any value that is part of the HTTP/1.1 URI should be sent as
    # a field header. Set these to a non-empty value.
    request = specialist_pool_service.ListSpecialistPoolsRequest(parent="parent/value",)
...
def test_list_specialist_pools_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.list_specialist_pools(parent="parent_value",)
...
def test_list_specialist_pools_pager():
    ...
    with mock.patch.object(
        ...
        results = [i for i in client.list_specialist_pools(request={},)]
...
def test_delete_specialist_pool_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = client.delete_specialist_pool(name="name_value",)
...
def test_specialist_pool_service_grpc_transport_channel():
    ...
    transport = transports.SpecialistPoolServiceGrpcTransport(channel=channel,)
