...
_TEST_RESPONSE_STOPPING.name = tc.ClusterConstants._TEST_VERTEX_RAY_PR_ADDRESS
...
_TEST_RESPONSE_ERROR.name = tc.ClusterConstants._TEST_VERTEX_RAY_PR_ADDRESS
resource_runtime = ResourceRuntime()
...
def get_project_number_mock():
    with mock.patch.object(
        ...
        test_project.name = f"projects/{tc.ProjectConstants._TEST_GCP_PROJECT_NUMBER}"
